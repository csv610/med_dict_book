...
\medterm{Pervasive Developmental Disorders} Historical diagnostic group; see \textit{Autism Spectrum Disorder}.
...
\medterm{Pneumococcal Vaccine} Active immunization formulations directed against capsular polysaccharides of \textit{Streptococcus pneumoniae}, available as the 23-valent pneumococcal polysaccharide vaccine (PPSV23) and multi-valent pneumococcal conjugate vaccines (PCV15, PCV20), protecting against invasive pneumococcal bacteremia, meningitis, and pneumonia.
...
\medterm{Pneumocystis Carinii Pneumonia} Historical name; see \textit{Pneumocystis Jirovecii Pneumonia}.
...
\medterm{Postpericardiotomy Syndrome} An immune-mediated inflammation of the pericardium and sometimes the pleura that develops days to weeks after heart surgery or another injury involving the heart. It may cause fever, chest pain that changes with breathing or position, and fluid around the heart or lungs.
...
\medterm{Purulent Meningitis} Historical descriptive term; see \textit{Bacterial Meningitis}.
