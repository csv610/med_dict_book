...
\synonyms
Artificial Pacemaker; Cardiac Pacemaker

\medterm{Pacemaker Complications} Problems after pacemaker placement can include bleeding, infection, a collapsed lung, heart or blood-vessel injury, movement or breakage of a lead, blood clots, battery failure, or an abnormal heartbeat. New chest pain, fainting, fever, or worsening breathlessness may signal a serious problem.

\medterm{Pacemaker Malfunction} Failure of a pacemaker system to sense, pace, capture, or communicate as intended. Causes include lead displacement or fracture, battery depletion, programming problems, electromagnetic interference, and myocardial or metabolic factors.

\medterm{Pacemaker-Mediated Tachycardia} A rapid reentrant rhythm involving a dual-chamber pacemaker and the patient’s cardiac conduction system. It can cause palpitations, dizziness, or reduced device effectiveness and is managed by device reprogramming or other therapy.

\medterm{Pacemakers and Implantable Cardioverter-Defibrillators} Implantable devices that provide bradycardia pacing, resynchronization, or detection and treatment of dangerous ventricular arrhythmias. Assessment includes indications, programming, leads, battery status, complications, and follow-up.

\medterm{Pacemaker Syndrome} An adverse hemodynamic and symptomatic consequence of ventricular pacing (typically VVI mode) resulting from loss of physiological atrioventricular synchrony, retrograde ventriculoatrial conduction, and cannon A waves, producing fatigue, syncope, dizziness, and neck pulsations.
...
\medterm{Pachydermoperiostosis} The primary form of hypertrophic osteoarthropathy, usually inherited and characterized by thickened oily or furrowed facial skin, enlargement of the fingers and toes, clubbing, and painful periosteal new bone formation. Severity varies and specialist evaluation is needed.
...
\medterm{Pachymetry} Measurement of the thickness of the cornea, the clear front surface of the eye. It is used to assess corneal disease and helps place eye-pressure readings in context.
...
\medterm{PAES} Alternate name; see \textit{Popliteal artery entrapment}.
...
\medterm{Paget Disease Of The Nipple} A rare form of breast cancer affecting the skin of the nipple and areola. It can cause persistent one-sided redness, scaling, crusting, itching, discharge, or an ulcer. An underlying ductal cancer is present in many cases. Diagnosis uses breast imaging and a skin biopsy; treatment depends on the underlying cancer.

\synonyms
Mammary Paget's Disease; Paget's Disease of the Breast; Nipple Paget Disease
...
\medterm{Paget-Schroetter Syndrome} An effort-induced deep vein thrombosis (effort thrombosis) of the axillary-subclavian venous system, typically occurring in young, athletic individuals following repetitive, strenuous upper-extremity overhead exertion (e.g., throwing or weightlifting), caused by extrinsic compression of the vein at the thoracic outlet.
\synonyms
Effort Thrombosis of Subclavian Vein; Upper Extremity DVT
...
\medterm{Paget's Disease of the Nipple} A rare breast cancer involving the skin of the nipple and areola. It may cause redness, scaling, itching, discharge, or a lump.
...
\medterm{Painful Bladder Syndrome} Alternate name; see \textit{Interstitial cystitis}.
...
\medterm{PA/IVS} Alternate name; see \textit{Pulmonary atresia with intact ventricular septum}.
...
\medterm{Pale or Clay-Colored Stools} Light-colored stool caused by reduced bile pigment reaching the intestine, potentially indicating bile-duct obstruction, gallbladder disease, liver disease, or certain transient conditions.
...
\medterm{Palla Sign} A chest radiographic sign of acute pulmonary embolism consisting of an enlarged, dilated descending right pulmonary artery (diameter greater than 16 mm on PA projection) terminating abruptly due to a large impacted thromboembolus and downstream vasoconstriction.
\synonyms
Palla's Sign; Descending Pulmonary Artery Sign
...
\medterm{Palmar} Relating to the palm or palmar surface of the hand, including the palmar sides of the fingers.

\medterm{Palmar Erythema} A persistent, symmetrical reddening of the thenar and hypothenar eminences of the palms with sparing of the central palm, often accompanied by warmth. It results from localized microvascular dilatation driven by elevated circulating estrogen levels or altered hepatic metabolism in chronic liver disease, cirrhosis, pregnancy, and thyrotoxicosis.
...
\medterm{Palmar Hyperhidrosis} Alternate name; see \textit{Hyperhidrosis}.
...
\medterm{Palmoplantar Keratoderma (Keratosis Palmaris et Plantaris)} Excessive thickening of the skin on the palms and soles. It may be inherited or acquired and can cause fissures, pain, impaired walking, sweating problems, or secondary infection.
...
\medterm{Palpable Purpura} Raised, indurated, non-blanching purpuric papules or plaques resulting from transmural inflammation and fibrinoid necrosis of post-capillary venules with red cell extravasation, serving as the clinical hallmark of cutaneous small-vessel leukocytoclastic vasculitis and IgA vasculitis (Henoch-Schönlein purpura).
...
\medterm{Palpebral Slant} The direction and inclination of the axis between the inner and outer canthi of the eyes. An upward (upslanting) or downward (downslanting) palpebral slant may represent normal familial variation or serve as a dysmorphic feature in genetic syndromes such as Down syndrome or Noonan syndrome.

\synonyms
Palpebral Fissure Slant; Upslanting Palpebral Fissures; Downslanting Palpebral Fissures
...
\synonyms
Cardiac Palpitations; Palpitations
...
\medterm{Pampiniform Plexus} A network of veins in the spermatic cord that drains the testis and helps cool blood entering the testicular artery.
...
\synonyms
Isolated Dorsal Pancreatic Duct
...
\medterm{Pancreas Inflammation} Alternate name; see \textit{Pancreatitis}.
...
\medterm{Pancreas Transplantation} Alternate name; see \textit{Pancreas Transplant}.
...
\synonyms
Pancreatic Carcinoma; Pancreatic Adenocarcinoma; Cancer of the Pancreas
...
\synonyms
Pancreatic Pseudocysts; Mucinous Cystic Neoplasms; Serous Cystadenomas
...
\medterm{Pancreatic Exocrine Insufficiency} Alternate name; see \textit{Exocrine Pancreatic Insufficiency}.
...
\medterm{Pancreatic Inflammatory Cysts} Alternate name; see \textit{Pancreatic Cysts}.
...
\medterm{Pancreatic IPMN} Alternate name; see \textit{Pancreatic Cysts}.

\medterm{Pancreatic IPMN Entry} Alternate name; see \textit{Pancreatic Cysts}.
...
\synonyms
pNETs; Islet Cell Tumors; Pancreatic Endocrine Neoplasms

\medterm{Pancreatic Non-Inflammatory Cysts} Alternate name; see \textit{Pancreatic Cysts}.
...
\medterm{Pancreatic Serous Cystadenoma} Alternate name; see \textit{Pancreatic cysts}.
...
\synonyms
Pancreatic Inflammation; Acute or Chronic Pancreatitis
...
\medterm{Panic Attack} A sudden surge of intense fear or discomfort that usually reaches peak intensity within minutes. Symptoms may include a racing or pounding heart, sweating, trembling, breathlessness, chest pain, nausea, dizziness, tingling, a sense of losing control, or fear of dying. A first or atypical episode—especially with chest pain or breathing difficulty—should not be assumed to be panic until urgent medical causes are considered.

\medterm{Panic Attacks} Plural of panic attack; see \textit{Panic Attack}.
...
\medterm{Panophthalmitis} Severe infection and inflammation involving the entire eye and its surrounding tissues. It can cause intense pain, redness, swelling, discharge, and major vision loss.
...
\medterm{Panuveitis} Inflammation affecting all the main internal layers around the eye, including the iris, the gel inside the eye, and the tissues near the retina. It can cause pain, redness, light sensitivity, floaters, and vision loss.
...
\medterm{Papilloma With Atypia / DCIS Pathology} Evaluation of an intraductal papillary breast lesion for fibrovascular cores, epithelial atypia, and ductal carcinoma in situ. The key distinction is between benign papilloma, atypical proliferation, in situ carcinoma, and invasive carcinoma.
...
\medterm{Papule} A solid, elevated, circumscribed primary skin lesion measuring up to one centimetre in diameter, containing no visible fluid. Papules may be dome-shaped, flat-topped, umbilicated, or verrucous, and arise from localized cellular infiltration, epidermal hyperplasia, metabolic deposition, or dermal edema in conditions such as acne vulgaris, lichen planus, molluscum contagiosum, viral warts, and psoriasis.

\synonyms
Papules; Primary Skin Lesion

\medterm{Papules} Alternate name; see \textit{Papule}.

\medterm{PAPVR} Alternate name; see \textit{Partial anomalous pulmonary venous return}.
...
\medterm{Paracetamol Overdose} Taking too much paracetamol, also called acetaminophen, can seriously damage the liver even before symptoms appear. The risk depends on the amount, timing, repeated doses, and health of the person; an antidote can reduce the risk of liver failure when given promptly.
...
\medterm{Paraffin Poisoning} Harm from swallowing or breathing paraffin wax or liquid paraffin. Small swallowed amounts may cause stomach upset, but liquid entering the lungs can cause chemical pneumonia.
...
\medterm{Paraneoplastic Autonomic Neuropathy} Autoimmune injury to autonomic nerves associated with cancer, causing problems such as abnormal blood-pressure control, sweating, heart-rate variability, gastrointestinal motility, bladder function, or sexual function. It may accompany broader paraneoplastic neurologic syndromes.

\medterm{Paraneoplastic Cerebellar Degeneration} A subacute, debilitating autoimmune paraneoplastic neurological disorder characterized by progressive pancerebellar ataxia, truncal instability, dysarthria, nystagmus, and oscillopsia. Mediated by cytotoxic T cells and cross-reactive circulating onconeural antibodies (such as anti-Yo in ovarian/breast cancer, anti-Hu in small cell lung cancer, or anti-Tr in Hodgkin lymphoma) causing extensive Purkinje cell loss.
...
\medterm{Paraneoplastic Encephalomyelitis} An autoimmune inflammatory disorder of the brain, spinal cord, or peripheral nervous system triggered by an underlying cancer rather than direct tumor invasion. It may cause multifocal neurologic symptoms and requires evaluation for neural antibodies and an occult malignancy.

\medterm{Paraneoplastic Endocrine Syndromes} Hormonal disorders caused by a cancer or by the body's response to it rather than by direct tumor growth in an endocrine gland. Examples include inappropriate antidiuretic hormone secretion, ectopic adrenocorticotropic hormone production, and hypercalcemia caused by tumor-related factors.

\medterm{Paraneoplastic Neurological Disorder} Alternate name; see \textit{Paraneoplastic syndromes of the nervous system}.

\medterm{Paraneoplastic Neurological Syndrome} Alternate name; see \textit{Paraneoplastic syndromes of the nervous system}.
...
\medterm{Paraphilic Disorder} Alternate name; see \textit{Paraphilic Disorders}.
...
\medterm{Paraphimosis} Paraphimosis occurs when a retracted foreskin cannot be returned over the glans, causing painful swelling and possible loss of blood flow. Treatment involves promptly returning the foreskin to its normal position.
...
\medterm{Parapneumonic Pleural Effusions and Empyema Thoracis} Fluid that accumulates beside a pneumonia is a parapneumonic effusion; infected, purulent, or loculated fluid is empyema. Assessment uses imaging and pleural-fluid analysis, and complicated infection often requires antibiotics plus drainage.

\medterm{Parapsoriasis} A group of chronic scaly patches or thin plaques that resemble psoriasis but have different causes and risks. Some forms remain stable, while large-plaque disease can rarely evolve into cutaneous T-cell lymphoma and needs follow-up.
...
\medterm{Paraquat Poisoning} A medical emergency caused by swallowing or significant exposure to the herbicide paraquat. It can burn the mouth and digestive tract and later cause lung, kidney, or liver failure.
...
\medterm{Parasternal Heave} A palpable lifting or thrusting sensation felt over the left parasternal border during systole, examined using the heel of the examiner's hand. It is a sign of right ventricular hypertrophy or right ventricular volume overload, commonly seen in severe pulmonary hypertension or congenital heart defects.
...
\medterm{Parathyroid Crisis} A life-threatening rise in blood calcium caused by severe overactivity of the parathyroid glands. It may cause extreme thirst, vomiting, constipation, confusion, weakness, abnormal heart rhythm, kidney injury, or coma.
...
\medterm{Parietal Cell Antibodies} Circulating autoimmune antibodies directed against the gastric parietal cell H+/K+-ATPase proton pump, detected in over 90 percent of patients with autoimmune atrophic gastritis and pernicious anemia.
...
\medterm{Parkinsonian Gait} A characteristic abnormal gait seen in Parkinson disease, characterized by universal stooped posture, diminished reciprocal arm swing, shuffling short steps (marche a petits pas), difficulty initiating movement (freezing), and involuntary acceleration forward (festination).
...
\synonyms
Idiopathic Parkinsonism; Paralysis Agitans; PD
...
\medterm{Parotid Neoplasm} An abnormal growth in a parotid salivary gland in front of or below the ear. Most are noncancerous, but some are cancerous; a painless lump, facial weakness, pain, or rapid growth may occur.
...
\medterm{Paroxysmal Atrial Fibrillation} A clinical subtype of atrial fibrillation in which recurrent, uncoordinated atrial tachyarrhythmias terminate spontaneously or with pharmacological/electrical intervention within seven days of onset (usually within 48 hours).
...
\medterm{Paroxysmal Cold Hemoglobinuria} A rare immune disorder in which cold temperatures trigger destruction of red blood cells when the blood warms again. It can cause sudden anemia, fever, back pain, jaundice, or dark urine, often after an infection.
...
\medterm{Paroxysmal Nocturnal Dyspnea} Sudden breathlessness that wakes a person after they have been asleep for a while, often improving after sitting or standing. It commonly occurs with heart failure but may have other heart or lung causes.
...
\medterm{Parsonage-Turner Syndrome} An acute neuro-inflammatory disorder affecting the brachial plexus, typically presenting with the abrupt onset of excruciating, unremitting, burning shoulder and periscapular pain, followed days to weeks later by patchy multifocal muscle weakness, flaccid paresis, and rapid denervation atrophy of the shoulder girdle and arm muscles. Often triggered by prior viral infection, vaccination, trauma, or surgical stress.

\synonyms
Neuralgic Amyotrophy; Acute Brachial Radiculitis; Brachial Plexitis
...
\medterm{Partial Anomalous Pulmonary Venous Connection} Alternate name; see \textit{Partial anomalous pulmonary venous return}.
...
\medterm{Partogram} A graphic record of cervical change, fetal descent, contractions, and maternal or fetal observations during
...
\synonyms
Labor Progress Chart; Partographic Curve
...
\medterm{Parvovirus B19 Infection} An infection that may cause fever, a slapped-cheek rash, joint pain, or temporary reduction in red-blood-cell production. It can be serious in people with certain blood disorders or weakened immunity and can affect pregnancy after significant exposure.
...
\medterm{Pastia Lines} Darker red lines that appear in skin creases during some rashes, especially scarlet fever. They support the diagnosis when other signs fit but are not specific by themselves.
\synonyms
Pastia's Sign; Pastia Lines of Scarlet Fever
...
\medterm{Patella} The largest sesamoid bone in the human body, embedded within the quadriceps tendon
...
\medterm{Patellar Apprehension Test} A knee examination used to look for kneecap instability. The examiner gently moves the kneecap outward while the knee is slightly bent. Fear, pain, or a muscle tightening response may support instability, but the test is interpreted with the history and other findings.

\synonyms
Fairbank Apprehension Test

\medterm{Patellar Bulge Test} A physical examination manoeuvre used to detect small intra-articular effusions in the knee joint. The examiner sweeps the medial aspect of the knee upward to displace fluid, then sweeps downward on the suprapatellar and lateral aspects; a visible fluid bulge or wave returning to the medial hollow indicates a small effusion.

\synonyms
Brush Test; Stroke Test; Sweep Test
...
\medterm{Patellar Reflex} A monosynaptic deep tendon stretch reflex elicited by sharply tapping the patellar tendon beneath the patella with a reflex hammer, producing involuntary quadriceps contraction and knee extension; tests the integrity of the L3-L4 spinal nerve roots and femoral nerve.

\synonyms
Knee-Jerk Reflex

\medterm{Patellar Tap Test} A clinical examination technique used to detect moderate to large knee joint effusions. The examiner compresses the suprapatellar pouch with one hand and pushes the patella downward against the femoral condyles with the other; a floating sensation followed by a distinct tap or click against the femur confirms fluid accumulation.
...
\medterm{Patellofemoral Osteoarthritis} Degenerative disease affecting the cartilage and bone surfaces between the kneecap and the femoral groove. It commonly causes pain at the front of the knee with stairs, squatting, kneeling, or prolonged sitting.
...
\medterm{Patent} Patent means open, unobstructed, or functioning, as in a patent airway, vessel, duct, or congenital fetal channel.
...
\medterm{Paternal Uniparental Disomy 14} A rare genetic condition resulting from inheritance of both copies of chromosome 14 from
...
\medterm{Pathological Laughter And Crying} Alternate name; see \textit{Pseudobulbar affect}.

\medterm{Pathological Stealing} Alternate name; see \textit{Kleptomania}.
...
\medterm{Patlak-Rutland Analysis} A graph used with some nuclear-medicine scans to estimate how quickly a tracked substance moves from the blood into tissue and stays there. It can help measure tissue activity, including activity in some tumors.

\medterm{Patrick Test} A physical examination maneuver (FABER test: Flexion, ABduction, External Rotation) used to evaluate sacroiliac joint dysfunction or hip joint pathology; with the patient supine, the foot of the tested leg is placed on the opposite knee in a 'figure-4' position while the examiner gently presses downward on the tested knee; anterior groin pain indicates hip pathology, whereas posterior pain localizes to the sacroiliac joint.
\synonyms
FABER Test; Patrick's FABER Maneuver
...
\medterm{Pauci-Immune Glomerulonephritis} A necrotizing and crescentic glomerulonephritis characterized on renal biopsy by focal glomerular capillary necrosis and cellular crescent formation with minimal or absent deposition of immunoglobulins or complement on immunofluorescence, strongly associated with antineutrophil cytoplasmic antibodies (ANCA-associated vasculitis).
\synonyms
ANCA-Associated Glomerulonephritis; Pauci-Immune Crescentic GN
...
\medterm{PBA} Alternate name; see \textit{Pseudobulbar affect}.
...
\medterm{PCP} Alternate name; see \textit{Pneumocystis Jirovecii Pneumonia}.

\medterm{PCP and Ketamine Toxicity} Dissociative-drug toxicity causing agitation, hallucinations, impaired coordination, nystagmus, analgesia, tachycardia, hypertension, hyperthermia, seizures, or coma. PCP often produces severe behavioral disturbance, whereas ketamine can cause profound sedation; reduce stimulation, protect the airway, use benzodiazepines when needed, and treat hyperthermia or complications.

\medterm{PDA} Alternate name; see \textit{Patent ductus arteriosus}.

\medterm{PDE5 Inhibitors} Medicines that improve blood flow into the penis by relaxing blood vessels and are mainly used for erectile dysfunction. Combining them with nitrate medicines can cause a dangerous fall in blood pressure.
...
\synonyms
Peanut Hypersensitivity; Peanut Anaphylaxis
...
\synonyms
PALS; Pediatric Resuscitation Protocol
...
\medterm{Pediatric Apnea} A pause or cessation of breathing in an infant or child. Causes include prematurity, infection, airway obstruction, seizures, metabolic disease, medication exposure, and central or obstructive sleep disorders.
...
\synonyms
PAT; Pediatric Visual Triage Triangle

\medterm{Pediatric Brain Tumor} A primary neoplasm originating within the parenchyma of the brain or surrounding meninges and cranial nerves during childhood or adolescence. Common histologic types include pilocytic astrocytoma, medulloblastoma, ependymoma, and diffuse intrinsic pontine glioma.
...
\medterm{Pediatric Dehydration} A deficit of body water and electrolytes in a child, commonly caused by vomiting, diarrhea, fever, poor intake, or excessive losses. Signs include reduced urination, dry mucosa, lethargy, tachycardia, and altered perfusion.
...
\medterm{Pediatric Diabetic Ketoacidosis} A life-threatening complication of diabetes in which very high blood sugar and a lack of insulin make the blood acidic. A child may urinate and drink excessively, vomit, have abdominal pain, deep breathing, fruity-smelling breath, sleepiness, or coma.
...
\medterm{Pediatric Echocardiogram} A noninvasive ultrasound examination of the heart in infants and children used to evaluate congenital structural heart defects, valve function, and cardiac blood flow.

\synonyms
Pediatric Echo; Congenital Echocardiography; Pediatric Cardiac Ultrasound
...
\medterm{Pediatric Feeding Tube} A small, flexible plastic tube inserted through the nose (nasogastric/nasojejunal) or directly into the stomach (gastrostomy) to deliver breast milk, formula, or medications to infants unable to feed adequately by mouth.

\synonyms
Infant Feeding Tube; Pediatric NG Tube; Infant Enteral Tube
...
\medterm{Pediatric Foreign Body Ingestion} Swallowing of a nonfood object by a child, with risk determined by the object, location, size, symptoms, and time since ingestion. Batteries, magnets, sharp objects, and obstructing objects require urgent evaluation.

\medterm{Pediatric Gastroesophageal Reflux Disease} Chronic reflux of gastric contents into the esophagus in pediatric patients, resulting in symptoms such as regurgitation, vomiting, feeding difficulties, irritability, and poor weight gain. Management includes positional therapy, thickened feeds, dietary adjustments, and acid-suppressive medications when indicated.

\synonyms
Pediatric GERD; Childhood Acid Reflux; Pediatric Gastroesophageal Reflux

\synonyms
Pediatric GERD; Infant Acid Reflux
...
\medterm{Pediatric Growth Hormone Deficiency} Inadequate secretion of growth hormone by the anterior pituitary gland in infants and children, leading to deceleration of growth velocity, proportionate short stature, delayed bone age, and abnormal body composition. Causes include pituitary hypoplasia, genetic defects, midline cranial defects, intracranial tumors, radiation therapy, or idiopathic hypopituitarism.

\synonyms
Pediatric GH Deficiency; Childhood Hypopituitarism; Growth Hormone Deficiency in Children

\synonyms
Pediatric GH Deficiency; Pituitary Dwarfism
...
\medterm{Pediatric Limp} An abnormal walking pattern or refusal to walk in a child. Causes range from minor injury and transient synovitis to infection, fracture, inflammatory disease, neuromuscular disease, or malignancy; fever, severe pain, swelling, or inability to bear weight requires prompt assessment.

\medterm{Pediatric Meningitis} Inflammation or infection of the coverings of a child’s brain and spinal cord. Fever, headache, stiff neck, vomiting, light sensitivity, confusion, seizures, or a rash may occur; babies may be irritable, feed poorly, or have a bulging soft spot. It can progress quickly and is life-threatening.
...
\medterm{Pediatric Nasal Congestion} A stuffy or runny nose in a child is usually caused by a viral infection or allergy; breathing difficulty, dehydration, prolonged fever, or symptoms in an infant need prompt assessment.
...
\medterm{Pediatric Pancreatitis} Acute or chronic inflammatory disease of the pancreas in infants, children, and adolescents. Common pediatric etiologies include abdominal blunt trauma, viral infections (mumps, Coxsackie, EBV), medications, systemic illness, gallstones, and genetic mutations (\textit{PRSS1}, \textit{SPINK1}, \textit{CFTR}).

\synonyms
Childhood Pancreatitis; Pediatric Pancreatic Inflammation; Acute Pediatric Pancreatitis
...
\medterm{Pediatric Poisoning} Toxic exposure in an infant, child, or adolescent, most often from medicines, household products, plants, gases, or recreational substances. Risk depends on the agent, dose per kilogram, route, formulation, age, and time since exposure; symptoms may include vomiting, altered consciousness, respiratory depression, seizures, or organ injury. Obtain poison-center guidance and do not induce vomiting unless specifically directed.

\medterm{Pediatric Ptosis} Congenital or acquired drooping of the upper eyelid in infants and children, most commonly caused by developmental dysgenesis of the levator palpebrae superioris muscle. Timely surgical correction is indicated to prevent deprivation amblyopia.

\synonyms
Congenital Ptosis; Pediatric Blepharoptosis; Childhood Drooping Eyelid

\medterm{Pediatric Pump Gastrostomy Feeding} Continuous or intermittent enteral nutrition delivered to pediatric patients through a gastrostomy tube using an electronic feeding pump. Provides precise, controlled flow rates and volumes for children who cannot tolerate bolus feeding.

\synonyms
Pediatric Enteral Pump Feeding; Pediatric G-Tube Pump Feeding

\synonyms
Pediatric G-Tube Pump Feeding; Continuous Enteral Infusion

\medterm{Pediatric Rash Evaluation} Systematic clinical assessment of acute cutaneomucosal eruptions in infants and young children under two years of age. Etiologies encompass benign viral exanthems (roseola infantum, enteroviral hand-foot-mouth disease), common inflammatory dermatoses (atopic dermatitis, seborrheic dermatitis, diaper dermatitis), and life-threatening dermatologic emergencies (meningococcemia, Kawasaki disease).

\synonyms
Infant Rash Assessment; Toddler Dermatitis; Childhood Exanthem Evaluation
...
\medterm{Pedicle Skin Graft} A piece of skin moved to cover a wound while remaining attached to its original blood supply through a tissue bridge.
...
\medterm{Pediculosis and Pthiriasis (Lice Infestation)} Infestation of scalp, body, or pubic hair by lice. It causes itching, visible lice or attached eggs, and sometimes excoriations or secondary infection; treatment requires an effective pediculicide plus measures to limit reinfestation.
...
\medterm{Pel-Ebstein Fever} A cyclical, recurring fever pattern observed in a subset of patients with Hodgkin lymphoma, characterized by regular episodes of high fever lasting 1 to 2 weeks alternating with afebrile intervals of similar duration.
\synonyms
Pel-Ebstein Pattern; Cyclical Lymphoma Fever
...
\medterm{Pelvic Fracture} A break in one or more bones of the pelvic ring, often caused by major trauma but sometimes occurring in weakened bone. The injury may be stable or unstable and can be associated with bleeding or damage to nearby organs, nerves, or blood vessels.
...
\medterm{Pelvic Ring Fracture} A high-energy traumatic skeletal disruption of the pelvic ring structure (involving the sacrum, sacroiliac joints, and pubic rami), classified by Young-Burgess mechanism (lateral compression, anteroposterior compression, vertical shear); frequently complicated by life-threatening retroperitoneal venous plexus hemorrhage.
...
\medterm{Pemphigus Erythematosus} A localized superficial pemphigus variant with fragile blisters, erosions, and crusted plaques, often in seborrheic areas such as the face, scalp, and upper chest. Autoantibodies disrupt epidermal cell adhesion; diagnosis generally requires biopsy and immunofluorescence.
...
\synonyms
Brazilian Pemphigus Foliaceus; Endemic Pemphigus Foliaceus; Fogo Selvagem; South American Pemphigus
...
\medterm{Pendred Syndrome} An autosomal recessive genetic disorder caused by biallelic mutations in the SLC26A4 gene encoding the anion exchanger pendrin, characterized by congenital bilateral sensorineural hearing loss, temporal bone malformations (enlarged vestibular aqueduct), and euthyroid or hypothyroid multinodular goiter.
\synonyms
Pendred's Syndrome; Goiter and Sensorineural Deafness Syndrome

\medterm{Pendular} Moving or swinging freely like a pendulum; pendular nystagmus has a similar speed in both directions.

\medterm{Pendular Nystagmus} Involuntary, rhythmic, sinusoidal oscillations of the eyes in which the movements in both directions occur at equal velocity without distinct fast or slow phases. It most commonly arises from congenital visual deprivation, optic nerve abnormalities, or demyelinating brainstem diseases.
...
\synonyms
Penicillin Hypersensitivity; Beta-Lactam Allergy
...
\synonyms
PeIN; Erythroplasia of Queyrat; Bowen Disease of the Penis
...
\medterm{Penile Lichen Sclerosus} A chronic inflammatory and sclerosing disorder of the penile skin and foreskin, causing pale tight skin, itching, fissures, pain, or narrowing. It can scar the foreskin or urethral opening and requires treatment and surveillance for complications.
...
\medterm{Pentalogy of Cantrell} A rare congenital thoracoabdominal malformation syndrome characterized by the constellation of five midline defects: midline supraumbilical abdominal wall defect (omphalocele), lower sternal cleft defect, anterior diaphragmatic defect, diaphragmatic pericardial defect, and congenital intracardiac anomalies (such as ectopia cordis and VSD).
\synonyms
Thoracoabdominal Syndrome; Cantrell Pentalogy
...
\medterm{Peptic Stricture} A circumferential, fibrotic luminal narrowing of the distal esophagus resulting from chronic, untreated acid peptic injury and collagen deposition in severe gastroesophageal reflux disease (GERD), presenting with progressive solid food dysphagia.
...
\synonyms
Gastric or Duodenal Ulcer; Peptic Ulcer Disease; PUD
...
\medterm{Peptic Ulcer Cross-Reference} Alternate name; see \textit{Peptic ulcer}.
...
\medterm{Percussion Myotonia} A muscle that stays contracted briefly after it is tapped. This may occur in myotonic dystrophy, myotonia congenita, and some other muscle disorders; the finding is interpreted with the rest of the examination.
...
\medterm{Percutaneous Nephrostomy} A procedure that places a drainage tube through the skin of the back into the kidney. Urine drains into a bag when the normal path to the bladder is blocked or needs to be bypassed. It may be used for stones, tumors, infection, or a narrowed urine passage and requires follow-up care.
...
\synonyms
PTCA; Balloon Angioplasty; Percutaneous Coronary Intervention
...
\medterm{Perforated Eardrum} Alternate name; see \textit{Ruptured eardrum (perforated eardrum)}.

\medterm{Perforating Folliculitis} A rare follicular disorder in which itchy keratotic papules develop around follicles and abnormal keratin is expelled through the epidermis. It is associated with chronic kidney disease, diabetes, and other systemic illness and may need treatment of both the skin and underlying disease.
...
\medterm{Pericardial Effusion} Abnormal accumulation of fluid in the sac around the heart. Small or slowly developing effusions may cause no symptoms, while rapid or large accumulation can impair heart filling and cause cardiac tamponade; significance depends on the amount, rate of accumulation, and cause.
...
\medterm{Pericardial Fluid Analysis} Laboratory examination of fluid removed from the pericardial space, usually during pericardiocentesis. Cell counts, chemistry, cytology, cultures, and targeted tests help investigate infection, cancer, tuberculosis, inflammation, or bleeding; results must be interpreted with the clinical context.
...
\medterm{Pericardial Friction Rub} A scratchy or grating sound heard when the inflamed layers around the heart rub together. It can support a diagnosis of acute pericarditis, especially when heard along the left side of the breastbone, but it may come and go and is not present in every case.
\synonyms
Pericardial Rub; Triphasic Pericardial Sound

\medterm{Pericardial Inflammation} Alternate name; see \textit{Pericarditis}.
...
\medterm{Pericardial Knock Sound} An early diastolic, high-pitched, sharp, knocking extra heart sound heard on auscultation in patients with chronic constrictive pericarditis. Occurs 0.08 to 0.12 seconds after aortic valve closure ($S_2$), earlier than a standard third heart sound ($S_3$), caused by the sudden abrupt cessation of ventricular filling when the expanding ventricular myocardium collides with the rigid, non-compliant, calcified pericardium.

\synonyms
Pericardial Knock; Constrictive Knock Sound
...
\medterm{Pericardial Rub} A high-pitched, superficial, grating or scratching heart sound produced by the friction between inflamed parietal and visceral pericardial layers. It characteristically has up to three components per cardiac cycle (atrial systole, ventricular systole, and early ventricular diastole) and is best heard at the lower left sternal border with the patient leaning forward in expiration.
...
\medterm{Pericardial Tamponade} A life-threatening buildup of fluid, blood, or pus in the sac around the heart. The pressure prevents the heart from filling properly and can cause low blood pressure, breathlessness, fainting, shock, or cardiac arrest. Bedside ultrasound can support the diagnosis, but the examination and cause are also important. Emergency drainage with a needle or surgery may be needed.
\synonyms{Cardiac Tamponade; Pericardial Compression; Hemopericardium with Tamponade}
...
\synonyms
Pericardial Sac Inflammation; Acute Pericarditis
...
\medterm{Periductal Mastitis} A chronic inflammatory condition of the subareolar breast ducts primarily seen in young women and strongly associated with cigarette smoking. Toxins in tobacco smoke damage the ductal lining, causing squamous metaplasia and keratin plugging of the lactiferous ducts. The blocked duct dilates, ruptures, and incites chronic inflammation and secondary infection, presenting as a painful periareolar mass, nipple retraction, or recurrent subareolar abscesses that frequently drain and form a chronic fistula (Zuska's disease). Treatment includes smoking cessation, targeted antibiotics, abscess drainage, or surgical duct excision.

\synonyms
Zuska's Disease; Subareolar Abscess; Squamous Metaplasia of Lactiferous Ducts; Periareolar Breast Abscess

\medterm{Perifolliculitis Capitis Abscedens et Suffodiens} A severe chronic scalp folliculitis, also called dissecting cellulitis, in which deep nodules, abscesses, and interconnected tunnels cause purulent drainage and permanent scarring alopecia. It is part of the follicular-occlusion spectrum and requires specialist treatment.
...
\medterm{Perimysium} A layer of connective tissue that surrounds groups of muscle fibers, forming bundles called fascicles. It carries small blood vessels and nerves within the muscle.
...
\medterm{Perineal Needle Holder} A surgical instrument used to hold and guide a suture needle while repairing tissues of the perineum. Its locking handle allows controlled needle placement and helps protect the surgeon’s hands.
\synonyms
Perineorrhaphy Needle Holder; Perineal Needle Holder
...
\medterm{Perineal Suture} A thread or strand of material used to approximate tissues (bring wound edges together)
and hold them in place until healing occurs. See Suture.

\synonyms
Perineal Suture; Perineorrhaphy Suture
...
\synonyms
PLMD; Periodic Leg Movements in Sleep; Nocturnal Myoclonus

\medterm{Periodic Limb Movement Sleep Disorder} Alternate name; see \textit{Periodic limb movement disorder}.
...
\medterm{Periodontal Graft} Tissue placed around a tooth to cover an exposed root, thicken the gum, or repair gum loss. The tissue may come from the person’s mouth, a donor, or a processed substitute.

\synonyms
Periodontal Soft Tissue Graft; Gingival Graft
...
\synonyms
Pyorrhea; Periodontal Gum Disease; Advanced Gum Disease
...
\medterm{Periosteal Reaction} The non-specific radiographic and histological response of the periosteum to cortical bone irritation, injury, infection, or underlying malignancy, manifesting as solid, laminated ("onion-skin"), spicular ("sunburst"), or Codman triangle bone formation.
...
\medterm{Peripartum Cardiomyopathy} A usually dilated cardiomyopathy that develops toward the end of pregnancy or during the postpartum period and may cause systolic heart failure. Features can include breathlessness, difficulty lying flat, swelling, fatigue, or chest discomfort.

\synonyms
PPCM; Pregnancy-Associated Cardiomyopathy
...
\medterm{Peripartum (Postpartum) Cardiomyopathy (PPCM)} A form of heart-muscle failure developing toward the end of pregnancy or in the months after delivery. It may cause breathlessness, orthopnea, swelling, chest discomfort, palpitations, or fatigue and requires urgent cardiac evaluation and pregnancy-compatible treatment planning.
...
\medterm{Peripheral Angioplasty} A percutaneous vascular intervention that dilates stenosed or occluded peripheral arteries—primarily in the lower extremities, renal arteries, or carotid vessels—using balloon dilation and optional stent placement.
...
\synonyms
PAD; Peripheral Arterial Occlusive Disease; PAOD
...
\medterm{Peripheral Cyanosis} A bluish or gray-blue discoloration of the fingers, toes, hands, or feet caused by reduced peripheral blood flow or increased oxygen extraction in tissues. The lips and tongue are usually not affected, distinguishing it from central cyanosis.
...
\medterm{Peripheral Neuritis} Alternate name; see \textit{Peripheral Neuropathy}.

\medterm{Peripheral Neurofibromatosis} Alternate name; see \textit{Neurofibromatosis type 1}.
...
\synonyms
Peripheral Nerve Damage; Polyneuropathy; Neuritis
...
\medterm{Peripheral Vascular Disease} A broad term for disease of blood vessels outside the heart and brain. It is often used to mean peripheral artery disease, in which narrowed leg arteries cause pain with walking, coldness, wounds that heal slowly, or tissue loss; the vessel involved should be specified because venous disorders are different.
...
\medterm{Peritoneal Cancer} Cancer arising from or involving the peritoneum, the membrane lining the abdominal cavity and covering many abdominal organs. It may be primary or metastatic and can cause abdominal swelling, pain, bowel symptoms, or ascites; imaging, fluid analysis, and tissue diagnosis help determine the origin.
...
\synonyms
Biermer Disease; Addisonian Anemia

\medterm{Pernio} Alternate name; see \textit{Chilblains}.

\medterm{Peroneal} Relating to the fibula or the muscles and nerve on the outer side of the lower leg.

\medterm{Peroneal Muscular Atrophy} Alternate name; see \textit{Charcot-Marie-Tooth disease}.
...
\medterm{Peroneal Nerve Palsy} A peripheral lower motor neuropathy caused by trauma or compression of the common fibular (peroneal) nerve as it courses superficially around the neck of the fibula, presenting with foot drop (loss of ankle dorsiflexion and eversion) and sensory numbness over the anterolateral lower leg and dorsum of the foot.

\synonyms
Common Fibular Nerve Palsy; Foot Drop Palsy

\medterm{Peroneal Tendon Syndromes} Disorders of the peroneal tendons, including tendinopathy, subluxation, and tears, usually causing pain or swelling behind the outer ankle and sometimes ankle instability. They may follow overuse, an inversion injury, or structural abnormalities.
...
\medterm{Persistent Depressive Disorder} A long-lasting depressive disorder with depressed mood or irritability for at least two years in adults or one year in children and adolescents. Other symptoms may include low energy, low self-esteem, sleep or appetite changes, poor concentration, or hopelessness.
...
\medterm{Persistent Generalized Lymphadenopathy} The chronic enlargement of lymph nodes measuring greater than one centimetre in diameter across two or more extra-inguinal anatomical sites persisting for at least three months, serving as a recognized clinical manifestation of chronic human immunodeficiency virus (HIV) infection.
...
\medterm{Persistent Vegetative State} A disorder of consciousness lasting more than one month following severe acute brain injury, characterized by complete wakefulness without awareness (spontaneous eye opening, sleep-wake cycles, and intact brainstem autonomic reflexes) in the total absence of purposeful, voluntary behavioral responses to sensory stimuli.
...
\medterm{Personality Disorder} Alternate name; see \textit{Personality Disorders}.
...
\medterm{Pertussis} Alternate name; see \textit{Whooping Cough}.
...
\medterm{Pes Cavus} A high-arched foot deformity characterized by an abnormally elevated medial longitudinal arch that does not flatten with weight-bearing, frequently associated with neuromuscular disorders including Charcot-Marie-Tooth disease, Friedreich ataxia, and spinal dysraphism.
\synonyms
High-Arched Foot; Talipes Cavus

\medterm{Pes Planus} Alternate name; see \textit{Flatfoot (Pes Planus)}.
...
\medterm{Pesticide Poisoning} Toxic exposure to an insecticide, herbicide, fungicide, rodenticide, or related agricultural chemical. Clinical findings and treatment depend on the active ingredient: cholinergic toxidromes, corrosive injury, methemoglobinemia, hepatic or renal injury, seizures, shock, and coagulopathy are possible. Identify the product, decontaminate safely, and use agent-specific toxicology guidance.
...
\synonyms
Animal Dander Allergy; Pet Dander Hypersensitivity
...
\medterm{Petechia} Alternate name; see \textit{Petechiae}.

\medterm{Petechiae} Pinpoint, flat, non-blanching red, purple, or brown macules measuring less than two to three millimetres in diameter, caused by minor capillary hemorrhage and extravasation of erythrocytes into the skin or mucous membranes. Major causes include thrombocytopenia (such as immune thrombocytopenia, leukemia, or aplastic anemia), platelet dysfunction, life-threatening infections (meningococcemia, infective endocarditis, viral hemorrhagic fevers), vasculitis, and acute mechanical elevation of venous pressure from violent coughing or vomiting.
...
\medterm{Petit Mal Seizure} Alternate name; see \textit{Absence seizure}.
...
\medterm{Petrosal Sinus} Paired dural venous sinuses draining the cavernous sinus: the superior petrosal sinus courses along the crest of the petrous temporal bone into the transverse sinus, while the inferior petrosal sinus travels in the petro-occipital fissure through the anterior jugular foramen into the internal jugular vein.
...
\medterm{PET Scan} Nuclear medicine imaging using radioactive tracers (most commonly FDG, a glucose analog)
...
\synonyms
Ileal Lymphoid Nodules; Aggregated Lymphoid Nodules
...
\medterm{PFAPA Syndrome} A recurrent fever syndrome, usually beginning in childhood, characterized by periodic fever with some combination of mouth ulcers, sore throat, and swollen neck lymph nodes; it is commonly abbreviated PFAPA.
...
\medterm{Phacoemulsification} The standard modern microsurgical technique for cataract extraction in which an ultrasonic handpiece vibrating at high frequencies (28--40~kHz) emulsifies (fragments and liquefies) the cataractous crystalline lens nucleus and cortex, which are simultaneously aspirated while balanced salt solution irrigates the anterior chamber to maintain intraocular pressure and cool the tip. Performed through a micro-incision (typically 1.8--2.8~mm) via a continuous curvilinear capsulorhexis (CCC), it preserves the crystalline lens capsule (capsular bag) to allow immediate in-the-bag implantation of a foldable artificial intraocular lens (IOL). Compared with traditional extracapsular cataract extraction (ECCE), phacoemulsification offers self-sealing sutureless incisions, minimal surgically induced astigmatism, rapid visual recovery, and lower complication rates. Key surgical complications include posterior capsule rupture (PCR), vitreous loss, dropped nucleus, and corneal endothelial decompensation.

\synonyms
Phaco; Ultrasonic Cataract Extraction; Small-Incision Cataract Surgery; Phacoemulsification with IOL Implantation

\medterm{Phacomatosis} A broad group of congenital hereditary neurocutaneous syndromes characterized by widespread hamartomatous developmental lesions simultaneously involving structures of ectodermal origin (central nervous system, retina, and skin), including neurofibromatosis, tuberous sclerosis, and von Hippel-Lindau disease.
...
\medterm{Phalangeal Fractures} Breaks in the bones of the fingers or toes, usually caused by crushing, direct impact, or twisting. Pain, swelling, bruising, deformity, and difficulty moving the digit may occur; alignment and nail-bed injury should be assessed.
...
\medterm{Phalen Maneuver} A diagnostic physical examination provocative test for carpal tunnel syndrome; the patient rests both elbows on a flat surface and maintains full passive wrist flexion (at 90 degrees) by pressing the dorsal surfaces of the hands together for 60 seconds; reproduction of paresthesias or pain in the median nerve distribution indicates a positive test.
\synonyms
Phalen's Test; Wrist Flexion Test

\medterm{Phalen Sign} Tingling or numbness in the fingers after pressing the backs of the hands together with wrists bent down for one minute, used to check for carpal tunnel syndrome.
...
\medterm{Pharyngitis} Acute inflammation of the mucous membranes of the pharynx, commonly producing sore throat, odynophagia, pharyngeal erythema, and cervical lymphadenopathy. Caused primarily by respiratory viruses or Group A \textit{Streptococcus}.

\synonyms
Sore Throat; Acute Pharyngitis; Pharyngeal Inflammation
...
\medterm{Phencyclidine Substance Use} Phencyclidine is a dissociative drug that can cause agitation, hallucinations, loss of coordination, high blood pressure, seizures, dangerous behavior, or coma.
...
\medterm{Phenytoin Overdose} Too much phenytoin can cause nausea, severe dizziness, double vision, involuntary eye movements, poor coordination, confusion, abnormal heart rhythms, or coma. Significant or intentional overdoses can be life-threatening.
...
\medterm{Phenytoin Toxicity} Dose-related toxicity causing horizontal nystagmus, ataxia, dysarthria, lethargy, confusion, or coma; severe overdose can cause hypotension, dysrhythmias, or seizures, particularly after rapid intravenous administration. Serial serum levels, ECG, and neurologic assessment guide supportive care; there is no routine specific antidote.
...
\synonyms
Chromaffin Cell Tumor; Adrenal Medullary Tumor; Pheo
...
\medterm{Philodendron Poisoning} Chewing philodendron leaves releases irritating crystals that can cause immediate burning and swelling of the mouth, tongue, or throat. Breathing or swallowing difficulty may occur.

\medterm{Phimosis} Tightness of the foreskin that prevents it from being pulled back over the head of the penis. It can be normal in young children, but pain, repeated infection, scarring, or difficulty passing urine may indicate a problem.

\medterm{Phimosis and Paraphimosis} Alternate name; see \textit{Penis Disorders}.

\medterm{Phlebitis} Inflammation of a vein causing pain, warmth, redness, or tenderness along its course. It may follow irritation from an intravenous line or occur with a clot in a surface vein; sudden limb swelling or breathlessness may indicate a more serious clot.
...
\medterm{Phlegmasia Alba Dolens} Painful, marked swelling and pallor of a limb caused by extensive deep-vein thrombosis, usually involving major venous outflow. It can threaten the limb and circulation.

\synonyms
Milk Leg; Femoral Thrombophlebitis
...
\medterm{Photosensitizing Drugs} Alternate name; see \textit{Photosensitivity to drugs}.
...
\medterm{Phrenic Nerve Palsy} Paresis or complete paralysis of the phrenic nerve (arising from cervical roots C3, C4, C5), leading to denervation, elevated position, and paradoxical movement of the ipsilateral hemidiaphragm during inspiration. Common etiologies include mediastinal malignancy (bronchogenic carcinoma), thoracic surgical trauma (cardiac or pulmonary resections), cervical spine trauma, and severe neuralgic amyotrophy.

\synonyms
Diaphragmatic Hemiparalysis; Phrenic Nerve Injury

\medterm{PHT} Alternate name; see \textit{Portal hypertension}.
...
\medterm{Phyllodes Tumor} A rare breast tumor that can be benign, borderline, or cancerous. It often appears as a painless lump that grows quickly. Treatment usually involves removing the tumor with a safe margin; the operation depends on the tumor's size, type, and location.
\synonyms{Phyllodes Tumor of the Breast; Cystosarcoma Phyllodes; Periductal Fibroadenoma}

\medterm{Phyllodes Tumors} Alternate name; see \textit{Phyllodes Tumor}.
...
\medterm{Physical Therapy} Alternate name; see \textit{Physiotherapy}.
...
\medterm{Physiotherapy} A healthcare profession dedicated to restoring, maintaining, and maximizing movement, physical strength, and functional independence in people affected by injury, illness, surgery, or disability. Treatment is tailored to individual needs and utilizes therapeutic exercise (strengthening, stretching, and aerobic conditioning), hands-on manual therapy (joint mobilization and soft-tissue release), gait and balance retraining, and physical modalities (heat, cold, ultrasound, and electrical stimulation). Specialized branches include orthopedic rehabilitation (e.g., post-fracture and joint replacement recovery), neurological rehabilitation (e.g., stroke and Parkinson disease recovery), cardiopulmonary physiotherapy (e.g., chest clearance and cardiac rehab), and pediatric and geriatric care.
\synonyms{Physical Therapy; PT; Movement Rehabilitation Therapy}
...
\medterm{Phytophotodermatitis} A phototoxic reaction caused when psoralens or related furocoumarins from plants such as limes, celery, or wild parsnip contact the skin and are followed by ultraviolet-A exposure. Burning, sharply patterned redness, streaks, or blisters may be followed by prolonged postinflammatory hyperpigmentation; it is not an immune-mediated sun allergy.
...
\medterm{PICC Line Dressing Care} A sterile clinical procedure for replacing the transparent semipermeable dressing and securement device over a peripherally inserted central catheter insertion site to prevent catheter-related bloodstream infections (CRBSI).

\synonyms
PICC Dressing Change; Central Line Dressing Care; PICC Sterile Maintenance

\medterm{PICC Line Flushing} The routine pulsatile push-pause administration of sterile normal saline or heparin lock solution through a PICC lumen to clear intraluminal blood, maintain catheter patency, and prevent thrombotic occlusion.

\synonyms
PICC Flush Protocol; Central Catheter Heparinization; PICC Patency Flushing

\medterm{PICC Line Insertion} Ultrasound-guided percutaneous cannulation of a deep peripheral vein (such as the basilic, cephalic, or brachial vein) in the upper arm, advancing the radiopaque catheter tip under fluoroscopic or electrocardiographic guidance to the cavoatrial junction.

\synonyms
PICC Placement; Peripherally Inserted Central Catheterization; PICC Cannulation

\medterm{Pick Disease} A distinct subtype of frontotemporal lobar degeneration (FTLD-tau) characterized pathologically by circumscribed knife-edge frontotemporal cortical lobar atrophy and intracellular round, silver-staining, tau-positive inclusions (Pick bodies), presenting with progressive behavioral disinhibition, personality change, and language impairment.
\synonyms
Frontotemporal Dementia with Pick Bodies; FTLD-Tau
...
\medterm{PID} Alternate name; see \textit{Pelvic inflammatory disease}.
...
\medterm{Piedra} A superficial fungal infection of hair shafts producing hard or soft nodules attached to the hair. Black piedra is caused by Piedraia hortae, while white piedra is caused by Trichosporon species; treatment may include hair trimming and antifungal therapy.
...
\medterm{Piezogenic Pedal Papules} Small, soft skin-colored papules caused by fat herniating through connective tissue at the edges of the heels when standing. They are common and usually harmless, but may be painful with prolonged standing or in people with connective-tissue disorders.

\medterm{Pigeon Breast} A congenital structural deformity of the anterior chest wall characterized by an abnormal anterior protrusion of the sternum and adjacent costal cartilages, giving the chest a prominent, pouter-pigeon appearance.
...
\medterm{Pigmentary Glaucoma} A secondary open-angle glaucoma caused by dispersion of iris pigment, which accumulates in the trabecular meshwork and impairs aqueous outflow. It may cause raised intraocular pressure and progressive optic-nerve damage.
...
\medterm{Pigment Dispersion Syndrome} An ocular condition characterized by the mechanical shedding of pigment granules from the posterior surface of the iris (due to rubbing against lens zonules), which deposit on the corneal endothelium (Krukenberg spindle) and obstruct the trabecular meshwork, predisposing to pigmentary glaucoma.

\medterm{Pigmented Birthmarks} Congenital cutaneous lesions characterized by localized melanin accumulation or melanocytic hyperplasia present at birth or emerging during early infancy, encompassing congenital melanocytic nevi, café-au-lait macules, dermal melanocytosis (Mongolian spots), and lentigines.

\synonyms
Congenital Melanocytic Nevi; Pigmented Nevi; Birthmarks, Pigmented

\medterm{Pigmented Purpuric Dermatosis} A group of chronic harmless eruptions caused by leakage of small amounts of blood from superficial vessels. They produce reddish-brown or copper-colored speckles and patches, commonly on the lower legs, and usually do not cause systemic illness.
...
\medterm{Pilomatrixoma (Pilomatricoma)} A usually benign, firm skin tumor arising from hair-matrix cells, most often on the head, neck, or upper limbs of children and young adults. It may be mistaken for a cyst; excision confirms the diagnosis and is usually curative.
...
\synonyms
Pilonidal Sinus; Sacrococcygeal Fistula

\medterm{Pilonidal Dimple} Alternate name; see \textit{Sacral dimple}.
...
\synonyms
Compressed Nerve; Nerve Compression; Radiculopathy
...
\medterm{Pinealoma} A primary neoplasm arising within the pineal gland region, predominantly including germ cell tumors (germinomas, non-germinomatous germ cell tumors) and pineal parenchymal tumors (pineocytoma, pineoblastoma); commonly presents with obstructive hydrocephalus and Parinaud dorsal midbrain syndrome.
...
\medterm{Pine Oil Poisoning} Swallowing or inhaling concentrated pine oil can irritate the mouth and stomach and may cause drowsiness, seizures, or lung injury if it enters the lungs.
...
\synonyms
Conjunctival Inflammation; Acute Conjunctivitis
...
\medterm{Pinworm Infestation} Alternate name; see \textit{Pinworm Infection}.
...
\synonyms
Piriformis Muscle Spasm; Deep Gluteal Syndrome
...
\medterm{Piroxicam Overdose} Taking too much piroxicam, an anti-inflammatory pain medicine, can cause stomach pain, vomiting, bleeding, kidney injury, drowsiness, seizures, or breathing problems. Large or intentional overdoses can be life-threatening.
...
\medterm{Pitted Keratolysis} A superficial, non-inflammatory bacterial infection of the stratum corneum of the plantar foot (most commonly caused by \textit{Kytococcus sedentarius} or \textit{Corynebacterium} species), presenting with punched-out superficial crateriform pits, hyperhidrosis, and severe sulfurous malodor (bromhidrosis).
...
\medterm{Pituitary Insufficiency} Alternate name; see \textit{Hypopituitarism}.

\medterm{Pituitary Macroadenoma} A pituitary adenoma measuring at least 10 mm. It may compress the optic chiasm and cause visual-field loss or headache, or alter pituitary hormone production; MRI, visual-field testing, and endocrine assessment are central to evaluation.

\medterm{Pituitary Microadenoma} A pituitary adenoma smaller than 10 mm. It may be hormonally inactive and found incidentally or may produce prolactin, ACTH, growth hormone, or other hormones; evaluation depends on imaging and endocrine findings.
...
\medterm{Pituitary Neuroendocrine Tumor} Alternate name; see \textit{Pituitary tumors and adenomas}.
...
\medterm{Pituitary Tumors Pathology} Pathologic assessment of pituitary neuroendocrine tumors, including cell lineage, hormone production, reticulin architecture, cytologic features, proliferative activity, and invasion. Immunohistochemistry helps classify the tumor.
...
\synonyms
Pityriasis Rosea of Gibert; Christmas Tree Rash
...
\medterm{Pityriasis Versicolor} Alternate name; see \textit{Tinea versicolor}.
...
\medterm{Pivot Joint} A joint in which one bone rotates around another bone. The joints between the first two neck bones and parts of the forearm are examples.
...
\medterm{PJI} Alternate name; see \textit{Periprosthetic joint infection}.

\medterm{PJS} Alternate name; see \textit{Peutz-Jeghers syndrome}.

\medterm{PKD} Alternate name; see \textit{Polycystic kidney disease}.
...
\synonyms
Sham Treatment; Inactive Control
...
\medterm{Placental Abruption} Premature detachment of a normally implanted placenta from the uterine myometrium prior to delivery of the fetus, classically presenting with painful dark vaginal bleeding, uterine hypertonicity, and fetal distress.

\synonyms
Abruptio Placentae; Premature Placental Separation; Accidental Antepartum Hemorrhage
...
\medterm{Plane Joint} A joint with mostly flat surfaces that slide over one another. Small movements occur in several directions, as in some wrist and foot joints.

\medterm{Plantar} Relating to the sole or underside of the foot, including the plantar surfaces of the toes.
...
\medterm{Plantar Fibromatosis} A benign overgrowth of fibrous tissue in the plantar fascia that forms firm nodules in the sole of the foot. It may be painless or cause pressure pain while walking; treatment depends on symptoms and can include footwear changes, injections, or surgery.
...
\medterm{Plantar Hyperhidrosis} Alternate name; see \textit{Hyperhidrosis}.
...
\medterm{Plantar Neuroma} Alternate name; see \textit{Morton neuroma}.
...
\medterm{Plantar Wart} A wart on the sole of the foot caused by human papillomavirus. Pressure from standing and walking can push it inward and make it painful; small black dots may represent tiny clotted blood vessels.
...
\synonyms
Thorn-Induced Arthritis; Foreign Body Synovitis
...
\medterm{Plastic and Reconstructive Surgery} Surgery that restores form or function after congenital difference, injury, disease, or removal of tissue.
...
\medterm{Platelet Function Assay} An automated in vitro laboratory test measuring primary platelet-related hemostasis under high shear stress conditions, determining the closure time required for platelets in citrated whole blood to occlude an aperture coated with collagen/epinephrine or collagen/ADP.
...
\medterm{Platelets} Small cell fragments made in the bone marrow that circulate in the blood and help stop bleeding. They attach to damaged blood vessels, become activated, and join together to form an initial plug.

\synonyms
Blood Platelets; Coagulation Fragments
...
\medterm{Platypnea-Orthodeoxia Syndrome} A clinical syndrome characterized by dyspnea (platypnea) and arterial oxygen desaturation (orthodeoxia) that are precipitated or worsened when assuming an upright seated or standing posture and relieved in the recumbent (supine) position, typically caused by a posture-dependent intracardiac right-to-left shunt through a patent foramen ovale or pulmonary AVMs.
\synonyms
Orthodeoxia; Postural Shunt Hypoxemia
...
\medterm{Pleomorphic Adenoma Pathology} A usually benign salivary-gland neoplasm containing variable epithelial and myoepithelial elements in a chondromyxoid, myxoid, or cartilaginous-appearing stroma. Incomplete excision and long duration increase recurrence or malignant-transformation risk.
...
\medterm{Pleural Rub} A rough, creaking or grating auscultatory sound heard during both inspiration and expiration, caused by the friction between roughened, inflamed visceral and parietal pleura. It is heard in pleuritis, pulmonary infarction, or pneumonia and ceases when the patient holds their breath.
...
\synonyms
Pleuritic Chest Pain; Pleural Inflammation; Pleuritis
...
\medterm{Pleuritis} Alternate name; see \textit{Pleurisy}.
...
\medterm{PLS} Alternate name; see \textit{Primary lateral sclerosis}.
...
\medterm{PMBCL} Alternate name; see \textit{Primary mediastinal large B-cell lymphoma}.

\medterm{PMBL} Alternate name; see \textit{Primary mediastinal large B-cell lymphoma}.
...
\medterm{PN} Alternate name; see \textit{Plexiform neurofibroma}.
...
\medterm{Pneumatosis Cystoides Intestinalis} Gas-filled cysts within the bowel wall. They may be harmless and found incidentally, but can also result from poor blood flow, infection, blockage, lung disease, or medicines. Severe pain, fever, or shock may indicate bowel injury.

\medterm{Pneumatosis Intestinalis} Gas within the wall of the intestine, seen as small bubbles or lines on an imaging test. It may be harmless, but pain, fever, shock, or signs of poor blood flow may indicate bowel injury.
...
\medterm{Pneumococcal Infections (Streptococcus pneumoniae)} Infections caused by Streptococcus pneumoniae, ranging from otitis and sinusitis to pneumonia, bloodstream infection, and meningitis. Risk is increased by young or older age, absent spleen, chronic disease, smoking, or immune compromise; vaccination and prompt treatment reduce complications.
...
\medterm{Pneumonia in Immunocompromised Patients} Lung infection in a person with impaired immune defenses from disease, medicines, transplantation, cancer, or other causes. The organism spectrum is broad, symptoms may be muted, and evaluation often requires early imaging, microbiologic testing, and tailored antimicrobial or supportive treatment.
...
\medterm{PNF} Alternate name; see \textit{Plexiform neurofibroma}.
...
\medterm{Poison} A substance that can cause injury, illness, or death when enough enters the body. Harm depends on the substance, amount, route, timing, and person's health.
...
\medterm{Poison Control Emergency Services} Specialized regional 24-hour telephone triage and emergency clinical toxicological consultation services staffed by toxicologists and specialist nurses to guide immediate management of toxic ingestions, overdoses, bites, and chemical exposures.

\synonyms
Poison Helpline; Poison Control Hotline; Toxicological Emergency Consultation

\medterm{Poisoning} Harmful effects caused by swallowing, inhaling, injecting, or absorbing a toxic substance. The effects depend on the substance, amount, route, timing, and person’s health; inducing vomiting can worsen some poisonings.

\medterm{Poisoning First Aid} Basic actions used after exposure to a toxic substance, such as leaving contaminated air and removing chemicals from skin or eyes. The correct response depends on the substance and route of exposure; inducing vomiting or giving food can worsen some poisonings.

\medterm{Poison Ivy, Oak, and Sumac} Plant species belonging to the genus \textit{Toxicodendron} that contain the lipophilic antigenic resin urushiol, which triggers a type IV cell-mediated allergic contact dermatitis upon epidermal contact.

\synonyms
Toxicodendron Plants; Urushiol-Containing Plants; Poison Ivy Oak Sumac Species
...
\medterm{Poliomyelitis} Alternate name; see \textit{Polio}.
...
\medterm{Polyarticular Joint Pain} Pain affecting multiple joints, caused by systemic inflammatory disease, infection, osteoarthritis, crystal disease, medication, or other conditions. The pattern, duration, swelling, and associated symptoms guide evaluation.
...
\medterm{Polygenic Hypercholesterolemia} Elevated low-density lipoprotein cholesterol caused by the combined effect of multiple genetic variants and environmental factors rather than one dominant pathogenic variant. Levels and cardiovascular risk vary, and secondary causes should also be assessed.
...
\medterm{Polyglandular Autoimmune Syndrome Type 1} An inherited autoimmune syndrome, usually beginning in childhood, involving chronic mucocutaneous candidiasis and autoimmune damage to the parathyroid and adrenal glands. Other organs may be affected, and the exact combination varies.

\medterm{Polyglandular Autoimmune Syndrome Type 2} An autoimmune syndrome, usually beginning in adulthood, characterized by autoimmune adrenal insufficiency together with autoimmune thyroid disease and/or type 1 diabetes. Other autoimmune disorders may coexist.
...
\medterm{Polymorphic Eruption of Pregnancy} An itchy inflammatory eruption of pregnancy, usually beginning in abdominal stretch marks late in pregnancy and spreading to the trunk or limbs while sparing the umbilicus. It is uncomfortable but generally does not harm the fetus and usually resolves after delivery.
...
\medterm{Polymorphous Light Eruption} An acquired, usually seasonal photodermatosis in which ultraviolet exposure causes an itchy eruption of papules, plaques, vesicles, or other morphologies in susceptible people. It often appears hours to days after sun exposure, especially in spring or early summer, and may improve as the skin becomes repeatedly exposed.

\synonyms
PMLE; Sun Poisoning; Polymorphic Light Eruption
...
\synonyms
PM; Idiopathic Inflammatory Myopathy
...
\medterm{Pontine Myelinolysis} A severe non-inflammatory demyelinating neurological disorder of the central pons caused by rapid, overly aggressive intravenous correction of chronic hyponatremia, presenting with spastic quadriparesis, pseudobulbar palsy, dysarthria, dysphagia, and the "locked-in" syndrome.
...
\medterm{Poor Color Vision} Alternate name; see \textit{Color blindness}.
...
\medterm{Popliteal Artery Entrapment Syndrome} An uncommon vascular cause of exertional lower extremity claudication in young, athletic individuals without cardiovascular risk factors, resulting from an anomalous anatomical relationship between the popliteal artery and the medial head of the gastrocnemius muscle that compresses the artery during plantarflexion.
...
\medterm{Popliteal Fossa} Diamond-shaped space behind the knee, bounded superolaterally by the biceps femoris,
superomedially by the semimembranosus and semitendinosus, and inferiorly by the two heads of the
gastrocnemius. It contains the popliteal artery and vein, tibial nerve, and common fibular nerve;
the popliteal pulse is palpated with the knee slightly flexed.
...
\medterm{Porphyrias} Alternate name; see \textit{Porphyria}.
...
\medterm{Portal Circulation} The flow of blood from the digestive organs and spleen through the portal vein to the liver before it returns to the general circulation.
...
\medterm{Portal Vein Obstruction} Partial or complete blockage of blood flow through the portal vein or its branches, caused by thrombosis, tumor, compression, inflammation, or scarring. It may produce portal hypertension, enlarged veins, abdominal fluid, intestinal injury, or gastrointestinal bleeding.
...
\medterm{Post-Cardiac Injury Syndrome} Alternate name; see \textit{Dressler syndrome}.

\medterm{Post-Chemotherapy Cognitive Impairment} Alternate name; see \textit{Chemo brain}.
...
\synonyms
Contact Bleeding; Postcoital Vaginal Bleeding
...
\medterm{Posterior Cord Syndrome} An incomplete spinal cord injury syndrome resulting from selective damage to the posterior columns (fasciculus gracilis and cuneatus), caused by posterior spinal artery infarction, tabes dorsalis, or subacute combined degeneration, characterized by loss of proprioception, vibration sense, and two-point discrimination below the lesion with preserved motor strength and pain/temperature sensation.
\synonyms
Dorsal Column Syndrome; Posterior Column Myelopathy
...
\medterm{Posterior Mediastinum} The back part of the lower mediastinum, in front of the thoracic spine. It contains the esophagus, descending aorta, azygos veins, thoracic duct, and nerves.
...
\medterm{Posterior Prolapse} Alternate name; see \textit{Posterior vaginal prolapse (rectocele)}.
...
\medterm{Posterior Synechiae} Abnormal fibrous adhesions between the posterior surface of the iris and the anterior lens capsule, commonly formed during episodes of acute or chronic iritis and causing an irregular, non-reactive pupil.
...
\medterm{Post-Finasteride Syndrome} A controversial set of symptoms, chiefly sexual, that reportedly persist or begin after stopping treatment with finasteride or other 5-alpha-reductase inhibitors used for hair loss or prostate symptoms. Reported features include reduced libido, erectile or ejaculatory difficulties, decreased genital sensation, depression, anxiety, fatigue, and difficulty thinking. Its cause is uncertain and its existence is disputed; evaluation excludes hormonal, psychiatric, and other medical causes, and management is supportive.
...
\synonyms
PHN; Shingles-Related Nerve Pain
...
\medterm{Postmortem Changes} Changes that occur after death, including cooling, livor mortis, rigor mortis, drying, autolysis, and putrefaction. Their timing varies with temperature, environment, body condition, and other factors and cannot alone establish an exact time of death.
...
\medterm{Postmortem Lividity} Purplish-red discoloration of dependent body parts following death, caused by
...
\synonyms
Cadaveric Lividity; Postmortem Suggillation
...
\medterm{Postmortem Vitreous Analysis} Laboratory examination of vitreous humor for electrolytes, glucose, ketones, drugs, alcohols, and other analytes. Vitreous potassium may provide a rough postmortem interval estimate, but results require cautious interpretation.
...
\medterm{Postmyocardial Infarction Syndrome} Alternate name; see \textit{Dressler syndrome}.

\medterm{Post-Nasal Drip} Alternate name; see \textit{Chronic Rhinitis}.
...
\medterm{Postoperative Corneal Edema} Swelling of the cornea after eye surgery, caused by endothelial dysfunction, inflammation, elevated intraocular pressure, or surgical trauma. It can blur vision and may resolve or persist depending on the injury.
...
\medterm{Postpartum Infections} Infections occurring after birth, including endometritis, wound infection, urinary infection, mastitis, and sepsis. Fever, worsening pelvic or wound pain, foul discharge, heavy bleeding, rapid heart rate, confusion, or weakness require prompt assessment.
...
\medterm{Postpericardiotomy Syndrome} An immune-mediated post-cardiac-injury syndrome that develops days to weeks after heart surgery. It may cause fever, pleuritic or positional chest pain, shortness of breath, and fluid around the heart or lungs; symptoms can recur.
...
\medterm{Post-Polio Syndrome} Progressive muscle weakness, fatigue, and pain that begin many years after recovery from acute poliomyelitis. It typically affects muscles previously weakened by polio, and sometimes regions thought to have been spared, and is thought to result from slow decline of overworked surviving motor neurons. There is no specific diagnostic test, so other causes of new weakness are excluded first; management is supportive and includes adjusted exercise, energy conservation, and symptom control.
...
\medterm{Poststreptococcal Glomerulonephritis} Immune-mediated inflammation of the glomeruli that develops after a streptococcal throat or skin infection. It can cause dark urine, swelling, high blood pressure, and reduced kidney function and is more common in children; follow-up is needed until recovery.
...
\medterm{Postsynaptic Potential} A graded, local change in the electrical membrane potential of a postsynaptic neuron or muscle cell generated by the binding of neurotransmitters to ligand-gated receptors, classified as depolarizing excitatory postsynaptic potentials (EPSP) or hyperpolarizing inhibitory postsynaptic potentials (IPSP).

\synonyms
PSP

\medterm{Post-Term Infant} An infant born at or after 42 weeks of gestation, beyond the usual term-pregnancy period; risks depend on placental function, fetal condition, and circumstances of delivery.
...
\medterm{Postterm Pregnancy} A pregnancy continuing to 42 weeks or longer. Risks may include reduced placental function, low amniotic fluid, fetal overgrowth, meconium passage, stillbirth, and difficult delivery, so fetal surveillance and delivery planning are considered.
...
\medterm{Postural Tremor} An involuntary, rhythmic oscillation that appears when an affected body part is actively maintained against gravity, such as holding the arms outstretched. It is the characteristic tremor of essential tremor and physiologic tremor exaggerated by thyrotoxicosis, stress, or medications.
...
\medterm{Potassium} The chemical symbol for potassium, a major intracellular electrolyte needed for nerve signaling, muscle contraction, and cardiac electrical activity.
...
\medterm{Potter Sequence} A cascade of neonatal physical anomalies resulting directly from severe oligohydramnios in utero (frequently caused by bilateral renal agenesis or posterior urethral valves), comprising pulmonary hypoplasia, compressed dysmorphic facial features (Potter facies), and extremity limb positioning deformities.
...
\medterm{Pott Puffy Tumor} A subperiosteal abscess of the frontal bone associated with underlying frontal bone osteomyelitis, arising as a severe suppurative complication of untreated frontal sinusitis or direct cranial trauma, presenting with fluctuant forehead swelling and headache.
\synonyms
Frontal Subperiosteal Abscess; Frontal Bone Osteomyelitis
...
\medterm{Pouch of Douglas} A space in the pelvis between the uterus and rectum. In a person without a uterus, the comparable space lies between the bladder and rectum; fluid or blood can collect there.
...
\synonyms
Explosive Strength Training; Ballistic Training
...
\medterm{Prader-Labhart-Willi Syndrome} Alternate name; see \textit{Prader-Willi syndrome}.
...
\medterm{Preauricular Sinuses} Small congenital pits or channels near the front of the ear caused by incomplete fusion during development. They may remain harmless or become infected, swollen, painful, or draining; recurrent infection may require surgical excision.
...
\medterm{Precapillary Sphincter} A ring of muscle at the entrance to some capillaries that helps control how much blood flows into a capillary network.
...
\medterm{Precipitate Labor} An abnormally rapid labor and childbirth characterized by the expulsion of the fetus within less than three hours from the onset of regular, painful uterine contractions. It results from unusually intense and frequent uterine contractions (uterine tachysystole or hypertonicity) overcoming low maternal soft-tissue resistance in the birth canal, most commonly occurring in multiparous women or following excessive labor-inducing medications (such as oxytocin). Although brief, it carries significant maternal risks, including severe cervical and perineal lacerations, uterine rupture, amniotic fluid embolism, and acute postpartum hemorrhage from uterine exhaustion (atony). Major fetal and neonatal hazards include fetal distress and hypoxia from restricted placental blood flow during unrelenting contractions, intracranial trauma or hemorrhage from rapid skull compression and decompression, and risk of unassisted delivery (such as cord tearing or fall injury).

\synonyms
Precipitate Labour; Precipitous Labor; Precipitous Labour; Tumultuous Labor; Rapid Delivery
...
\synonyms
Borderline Diabetes; Impaired Glucose Tolerance; Impaired Fasting Glucose
...
\medterm{Preeclampsia and Eclampsia} Alternate name; see \textit{Pregnancy: Preeclampsia and Eclampsia}.
...
\medterm{Pregnancy and Urolithiasis} Kidney or ureteral stones during pregnancy can cause colicky flank pain, hematuria, nausea, obstruction, infection, or preterm contractions. Ultrasound is generally preferred for initial imaging, and treatment balances symptom control, drainage, infection management, and fetal safety.
...
\medterm{Pregnancy Diagnosis} Confirmation of pregnancy using a urine or blood test for human chorionic gonadotropin, followed by ultrasound when needed to establish location, viability, and gestational age. A positive test with pain or bleeding requires assessment for ectopic pregnancy.
...
\medterm{Pregnancy-Related Hypertension} Alternate name; see \textit{Preeclampsia}.
...
\medterm{Pregnancy Trauma} Physical injury during pregnancy, including falls, motor-vehicle crashes, assault, or abdominal impact. Maternal stabilization comes first, followed by assessment for placental abruption, bleeding, uterine injury, fetal compromise, and preterm labor.
...
\synonyms
High-Normal Blood Pressure; Elevated Blood Pressure

\medterm{Preimplantation Genetic Diagnosis} Genetic testing of embryos created through in-vitro fertilization before transfer to the uterus, used to identify selected inherited disorders or chromosomal abnormalities. It requires genetic counseling and does not guarantee implantation, a healthy pregnancy, or absence of all disease.
...
\medterm{Premalignant Lesions of the Endometrium} Abnormal endometrial gland growth, usually endometrial hyperplasia with atypia, that can precede endometrial carcinoma. Diagnosis requires sampling of the uterine lining; treatment depends on fertility goals, cancer risk, and whether invasion is present.
...
\medterm{Premature Ejaculation} A persistent or recurrent pattern of ejaculation that occurs sooner than desired,
...
\medterm{Premature Puberty} Alternate name; see \textit{Precocious puberty}.
...
\synonyms
PVCs; Premature Ventricular Complexes; Ventricular Extrasystoles
...
\medterm{Premolar Tooth} One of the permanent teeth between the canine teeth and molars. Premolars usually have two raised points and help tear and crush food; decay, crowding, or infection may require dental treatment.
...
\medterm{Prescription Drug Misuse} Use of prescription medicines in a way not directed by a clinician, including taking someone else’s medicine, taking extra doses, or using them for intoxication; dependence, overdose, and interactions may result.
...
\medterm{Pressure Sore} Alternate name; see Bedsores (pressure ulcers). A localized injury to skin and underlying tissue caused by prolonged pressure or shear, also called a pressure ulcer.
...
\medterm{Pressure Ulcer} Localized damage to the skin and underlying soft tissue resulting from sustained, unrelieved mechanical pressure, often compounded by shear forces and friction over bony prominences (most commonly the sacrum, ischial tuberosities, greater trochanters, and heels) in immobilized or debilitated individuals. Compressive occlusion of microvascular capillary beds produces localized ischemia, hypoxia, and tissue necrosis. Clinical severity is classified from Stage I (non-blanchable erythema of intact skin) through Stage IV (full-thickness skin and tissue loss with exposed fascia, muscle, tendon, or bone), along with unstageable wounds and deep tissue pressure injuries.
\synonyms{Pressure Sore; Decubitus Ulcer; Bedsore; Pressure Injury}
...
\medterm{Preterm Labor and Birth} Regular uterine contractions causing cervical change before 37 completed weeks, potentially leading to preterm birth. Management depends on gestational age, membranes, infection, fetal status, and cause and may include corticosteroids, magnesium sulfate, antibiotics, or transfer to specialist care.
...
\synonyms
Persistent Penile Erection; Low-Flow or High-Flow Priapism
...
\synonyms
Skin-Prick Test; Percutaneous Allergy Test
...
\medterm{Primary Adrenal Insufficiency} Alternate name; see \textit{Addison's disease}.
...
\medterm{Primary Amenorrhea} Failure to establish menarche by age 15 in the presence of normal secondary sexual development, or by age 13 in the absence of secondary sexual characteristics. Causes include gonadal dysgenesis, mullerian agenesis, hypothalamic-pituitary disorders, or anatomical outflow tract obstruction.
...
\medterm{Primary and Secondary Fibrinolysis} The physiologic enzymatic breakdown of fibrin blood clots by plasmin. Primary fibrinolysis occurs without preceding clotting, whereas secondary fibrinolysis is a reactive response to widespread clot formation, as seen in disseminated intravascular coagulation (DIC).

\synonyms
Hyperfibrinolysis; Clot Dissolution; Fibrinolytic System
...
\medterm{Primary Biliary Cirrhosis} Alternate name; see \textit{Primary biliary cholangitis}.

\medterm{Primary Biliary Cirrhosis Treatment} Alternate name; see \textit{PBC}.
...
\medterm{Primary Ciliary Dyskinesia (Kartagener Syndrome)} An inherited disorder of motile cilia that impairs clearance of airway secretions. It causes chronic wet cough, recurrent sinus and ear disease, bronchiectasis, infertility in some patients, and sometimes situs inversus; long-term airway care and infection prevention are important.

\medterm{Primary Vulvar Clear Cell Adenocarcinoma} A rare cancer of the vulva made up of clear-looking cells. Diagnosis requires examination of a tissue sample and tests that distinguish it from cancer that has spread from the kidney or another organ.

\medterm{Primary CNS Lymphoma} An aggressive lymphoma confined to the brain, spinal cord, meninges, cerebrospinal fluid, or eyes at diagnosis. It often causes focal neurologic deficits, cognitive change, seizures, or raised intracranial pressure and requires specialist imaging, biopsy, and systemic evaluation.
...
\medterm{Primary Hyperparathyroidism} An endocrine disorder caused by autonomous, excessive secretion of parathyroid hormone (PTH) from one or more parathyroid glands, leading to hypercalcemia and hypophosphatemia. It is most commonly caused by a single benign parathyroid adenoma (~85\% of cases), four-gland parathyroid hyperplasia (~15\%), or rarely parathyroid carcinoma (<1\%), and may occur sporadically or as part of MEN1, MEN2A, or MEN4 syndromes. Many patients are asymptomatic, detected on routine blood testing, but symptomatic disease classically manifests as ``stones, bones, abdominal groans, and psychiatric moans'' (nephrolithiasis, osteoporosis or osteitis fibrosa cystica, peptic ulcers and pancreatitis, and depression or lethargy). Diagnosis is established by elevated serum calcium alongside inappropriately elevated intact PTH. Definitive curative treatment is surgical parathyroidectomy guided by preoperative localization imaging (such as Tc-99m sestamibi scanning or 4D-CT).

\synonyms
PHPT; Primary Hyperparathyroid Disease; Parathyroid Hyperactivity
...
\synonyms
PID; Inborn Errors of Immunity; IEI
...
\medterm{Primary Lymphoid Organs} The bone marrow and thymus, where lymphocytes are made and mature.
...
\medterm{Primary Polycythemia} Alternate name; see \textit{Polycythemia Vera}.
...
\medterm{Primary Systemic Amyloidosis} A form of AL amyloidosis in which abnormal immunoglobulin light chains made by a plasma-cell clone deposit in organs such as the heart, kidneys, nerves, liver, or gastrointestinal tract. Symptoms depend on the organs involved and require hematology evaluation.
...
\medterm{Prinzmetal Angina} An atypical form of angina pectoris (vasospastic angina) caused by transient, focal epicardial coronary artery vasospasm rather than fixed atherosclerotic plaque obstruction, presenting with episodic ischemic chest pain occurring at rest (characteristically between midnight and early morning) accompanied by transient ST-segment elevation on ECG.
\synonyms
...
\medterm{Proctalgia Fugax} A benign functional anorectal disorder characterized by sudden, severe, fleeting, cramp-like spasms of intense pain localized to the rectum and anus lasting from seconds to several minutes (maximum 30 minutes) and resolving completely, occurring predominantly at night due to levator ani and anal sphincter spasm.
\synonyms
Fugacious Rectal Pain; Nocturnal Rectal Spasm
...
\medterm{Progesterone Receptor} A protein inside or on a cell that binds progesterone. Some breast cancers have these receptors, which helps describe the cancer's biology.
...
\medterm{Progestogen-Only Pill} Oral contraceptive tablets formulated solely with a progestin without an estrogen component. They prevent conception primarily by thickening cervical mucus to impede sperm penetration, altering endometrial receptivity, and in certain formulations inhibiting the mid-cycle luteinizing hormone surge.
...
\medterm{Prolactin Deficiency} Inadequate production of prolactin by the pituitary, most clearly recognized by failure to produce breast milk after delivery. It may occur with broader pituitary disease, surgery, hemorrhage, or injury and is evaluated with other pituitary hormones.
...
\synonyms
Prolactin-Secreting Adenoma; Lactotroph Adenoma
...
\medterm{Prolapsed Bladder} Alternate name; see \textit{Anterior Vaginal Prolapse}.
...
\synonyms
Herniated Nucleus Pulposus; Slipped Disc; Herniated Disc

\medterm{Prolapsed Uterus} Alternate name; see \textit{Uterine prolapse}.
...
\medterm{Proliferating Pilar Tumor} A usually low-grade follicular tumor arising from a trichilemmal cyst, most often on the scalp. It may be large, ulcerated, recurrent, or locally aggressive, so complete excision and histologic assessment are important.
...
\medterm{Prolonged Capillary Refill Time} A delay of greater than two to three seconds for normal skin color to return after moderate digital blanching pressure is applied to a distal nail bed or pulp and released. It is a bedside indicator of reduced peripheral microvascular perfusion, shock, dehydration, or hypothermia.
...
\medterm{Pronator Drift} A subtle test for nerve or brain weakness where holding the arms straight out with palms up and eyes closed causes one hand to turn inward and slowly drift down.
...
\medterm{Proptosis} The abnormal forward protrusion or displacement of one or both eyeballs from the orbit. Major causes include thyroid eye disease (Graves ophthalmopathy), orbital cellulitis, orbital tumors, idiopathic orbital inflammation, and vascular malformations such as carotid-cavernous fistulas.

\synonyms
Exophthalmos; Ocular Proptosis; Proptosis of Eye; Bulging Eyes

\medterm{Proptosis of Eye} Alternate name; see \textit{Proptosis}.
...
\medterm{Prostate Enlargement} Alternate name; see \textit{Benign prostatic hyperplasia}.
...
\medterm{Prostate Gland Enlargement} Alternate name; see \textit{Benign prostatic hyperplasia}.
...
\medterm{Prosthetic Heart Valve} An artificial valve that replaces a diseased heart valve and keeps blood moving in the correct direction. Mechanical valves are durable but usually require lifelong anticoagulation; tissue valves generally avoid lifelong anticoagulation unless another indication exists but can degenerate over time.
...
\medterm{Prosthetic Valve Endocarditis} A severe endocardial infection affecting an artificial mechanical or bioprosthetic heart valve, categorized as early (within one year of implantation, predominantly caused by \textit{Staphylococcus epidermidis} or \textit{Staphylococcus aureus}) or late (more than one year post-surgery, mimicking native valve endocarditis).
...
\medterm{Protein} A large molecule made of one or more chains of amino acids folded into a specific three-dimensional shape. Proteins provide structure and perform functions such as catalyzing reactions, transporting substances, sending signals, regulating cells, and defending against infection; their amino-acid sequence helps determine their shape and function.
...
\synonyms
Protozoan Disease; Protozoiasis
...
\medterm{Proximal Deep Vein Thrombosis} A blood clot in a major deep vein of the leg at or above the knee, such as the popliteal, femoral, or iliac vein. It has a higher risk of traveling to the lungs than a clot limited to the calf. It may cause one-sided swelling, warmth, redness, or pain, but some people have no symptoms. Ultrasound and the clinical assessment help establish the diagnosis, and treatment usually includes anticoagulation when safe.
\synonyms{Proximal DVT; Above-Knee Deep Vein Thrombosis; Proximal Lower Extremity DVT}

\medterm{Proximal DVT} Alternate name; see \textit{Proximal Deep Vein Thrombosis}.
...
\medterm{Pruritis Ani} Alternate name; see \textit{Anal itching}.
...
\medterm{Pruritus and Systemic Disease} Generalized or persistent itching can be a manifestation of kidney or liver disease, iron deficiency, thyroid disease, hematologic disease, diabetes, infection, or malignancy. Examination and targeted tests are guided by the history and associated findings.
...
\medterm{PSA Test} A laboratory blood test that measures prostate-specific antigen (PSA), a protein made mainly by prostate cells. An elevated level may occur with prostate cancer, benign prostate enlargement, or infection or inflammation of the prostate, so the result does not diagnose cancer by itself and must be interpreted with the clinical context and other findings.
...
\synonyms
PBA; Emotional Incontinence; Pathological Laughter and Crying

\medterm{Pseudocholinesterase Deficiency} Reduced activity of butyrylcholinesterase, inherited or acquired, causing prolonged paralysis after medicines such as succinylcholine or mivacurium. People may need extended breathing support after anesthesia; enzyme or genetic testing can help confirm the condition.
...
\medterm{Pseudo-Cushing Syndrome} A reversible state with clinical or biochemical features resembling cortisol excess without autonomous Cushing disease. Severe alcohol use, depression, obesity, sleep disorders, or acute illness may contribute, and repeat or specialized testing may be needed.
...
\medterm{Pseudofolliculitis of the Beard} An inflammatory reaction caused by shaved or trimmed hairs curling back into the skin, producing itchy or tender papules and pustules in the beard area. Avoiding close shaving, changing shaving technique, and treating inflammation can reduce recurrence and scarring.
...
\medterm{Pseudogynecomastia} Bilateral enlargement of male breasts due to excessive subareolar and chest wall adipose tissue accumulation without true glandular or ductal tissue proliferation, commonly observed in obesity and distinguishable from true gynecomastia by the absence of a firm, distinct subareolar glandular disc on palpation.
...
\medterm{Pseudohypoglycemia} A falsely low glucose measurement that does not reflect the blood glucose available to tissues. It may result from poor peripheral circulation, shock, severe edema, or delayed processing of a blood sample and should be checked with a reliable venous or alternative-site measurement.
...
\medterm{Pseudo-Kaposi Sarcoma (Acroangiodermatitis)} A benign vascular eruption, usually on the lower legs or feet, that can resemble Kaposi sarcoma. It is often associated with chronic venous insufficiency, arteriovenous malformations, or dialysis access and may cause violaceous plaques or ulcers.
...
\synonyms
Clostridioides Difficile Colitis; Antibiotic-Associated Colitis
...
\medterm{Pseudomonas Folliculitis} An infection of hair follicles by Pseudomonas aeruginosa, often after exposure to contaminated hot tubs or pools. It causes itchy red papules and pustules under swimwear and usually resolves, although severe or recurrent disease may need medical treatment.
...
\medterm{Pseudoporphyria} A blistering and skin-fragility disorder that resembles porphyria cutanea tarda but occurs without the characteristic porphyrin excess. It may be triggered by kidney failure, dialysis, medicines, or ultraviolet exposure and usually affects the backs of the hands.

\medterm{Pseudopseudohypoparathyroidism} An inherited condition caused by paternally transmitted mutations in the \textit{GNAS} gene, characterized by the somatic phenotype of Albright hereditary osteodystrophy (short stature, round face, brachydactyly, subcutaneous ossifications) in the presence of completely normal calcium, phosphorus, and parathyroid hormone levels due to intact maternal allele expression in renal tubules.
...
\medterm{Psittacosis (Parrot Fever)} A systemic infection caused by Chlamydia psittaci, usually acquired from infected birds or their dried secretions. It commonly causes atypical pneumonia with fever, headache, cough, and sometimes hepatitis or neurologic disease; exposure history is diagnostically important.
...
\medterm{Psoas Sign} An abdominal physical examination sign elicited by passive hyperextension of the right hip with the patient in the left lateral decubitus position, or active right hip flexion against resistance; exacerbation of right lower quadrant abdominal pain indicates retrocecal appendicitis inflaming the underlying psoas muscle.
...
\synonyms
PsA; Arthropathia Psoriatica

\medterm{Psoriatic Plaque} The characteristic cutaneous lesion of plaque psoriasis (psoriasis vulgaris), consisting of a sharply demarcated, erythematous, indurated plaque covered with adherent, silvery-white micaceous scales, typically distributed symmetrically over extensor surfaces (elbows, knees, scalp, lumbosacral region).
...
\medterm{Psychomotor Retardation} A noticeable slowing of mental processes, speech output, and physical movements, manifested by decreased spontaneous gestures, prolonged latency in answering questions, sluggish gait, and reduced facial expressiveness. It is a core feature of severe major depressive disorder and melancholia.
...
\medterm{Psychotic Disorder} Alternate name; see \textit{Psychotic Disorders}.
...
\medterm{PTCL} Alternate name; see \textit{Peripheral T-cell lymphoma}.
...
\medterm{PTSD} Alternate name; see \textit{Post-Traumatic Stress Disorder}.

\medterm{Ptyalin} An older name for salivary amylase, the enzyme that begins starch digestion in the mouth.

\medterm{Ptyalism} Excessive saliva or drooling. It may result from increased saliva production or difficulty swallowing, and can occur with pregnancy, mouth irritation, reflux, medicines, or disorders affecting the brain, nerves, or muscles.
...
\medterm{Pubic Symphysis} The joint at the front of the pelvis where the two pubic bones meet. A strong pad of cartilage joins the bones and allows very little movement.
...
\medterm{Pudendal Nerve Block} A regional obstetric anesthesia technique in which local anesthetic is infiltrated transvaginally near the ischial spine and sacrospinous ligament to block the pudendal nerve (S2-S4), providing sensory anesthesia to the perineum, vulva, and lower vagina for forceps delivery or episiotomy repair.
...
\medterm{Puffy Eyes} Alternate name; see \textit{Bags under eyes}.
...
\medterm{Pull Test} A standardized clinical test used to evaluate postural stability and balance recovery. The examiner stands behind the patient and delivers a brisk, backward tug to the patient's shoulders; an inability to recover balance within one or two steps indicates impaired postural reflexes in Parkinson's disease or atypical parkinsonism.
...
\medterm{Pulmonary Acinus} The smallest part of the lung that exchanges gases. It begins after a small airway and contains respiratory bronchioles, alveolar ducts, and alveoli where oxygen enters blood and carbon dioxide leaves it.
...
\medterm{Pulmonary Arterial Hypertension} Group 1 pulmonary hypertension caused by increased resistance in the small pulmonary arteries, which become narrowed, remodeled, or obstructed. It may be idiopathic, heritable, drug- or toxin-induced, or associated with connective-tissue disease, HIV, portal hypertension, congenital heart disease, or schistosomiasis. Symptoms include exertional breathlessness, fatigue, chest discomfort, dizziness, fainting, or swelling; diagnosis requires right-heart catheterization.
...
\synonyms
Main Pulmonary Trunk; Right and Left Pulmonary Arteries
...
\medterm{Pulmonary Artery Wedge Pressure} An indirect hemodynamic measure of left atrial pressure and left ventricular end-diastolic filling pressure, obtained by inflating a balloon at the tip of a pulmonary artery catheter (Swan-Ganz) until it occludes a small pulmonary arterial branch.
...
\synonyms
Pulmonic Valve Atresia; PA-IVS; PA-VSD
...
\medterm{Pulmonary Disease and Pregnancy} Lung disease can worsen during pregnancy or be affected by pregnancy-related changes in oxygen demand and ventilation. Asthma, pneumonia, pulmonary embolism, and chronic lung disease require prompt assessment when breathlessness is severe, new, or associated with chest pain or low oxygen.
...
\synonyms
Fluid in the Lungs; Pulmonary Congestion; Alveolar Flooding
...
\synonyms
PE; Pulmonary Thromboembolism; Blood Clot in Lungs
...
\medterm{Pulmonary Emphysema} Alternate name; see \textit{Emphysema}.

\medterm{Pulmonary Eosinophilia} A group of disorders in which eosinophils accumulate in lung tissue or air spaces, causing infiltrates, cough, wheezing, breathlessness, or low oxygen. Causes include parasites, medicines, asthma, allergic disease, and eosinophilic lung syndromes; treatment targets the cause and inflammation.
...
\synonyms
PH; Pulmonary Arterial Hypertension; High Blood Pressure in Lungs
...
\medterm{Pulmonary Regurgitation (Pulmonic Regurgitation)} Backward flow from the pulmonary artery into the right ventricle during diastole because the pulmonary valve does not close completely. Mild regurgitation may be asymptomatic, whereas severe or long-standing regurgitation can enlarge or weaken the right ventricle and cause exercise intolerance, arrhythmias, or right-sided heart failure.
...
\medterm{Pulmonary Stenosis} Narrowing that obstructs blood leaving the right ventricle on its way to the lungs, usually at the pulmonary valve. It is often congenital and increases right-ventricular pressure; severe disease may cause a murmur, fatigue, breathlessness, fainting, or right-heart failure.
...
\synonyms
PTE; Pulmonary Endarterectomy; PEA
...
\synonyms
Pulmonic Regurgitation; Pulmonary Incompetence; PR

\medterm{Pulmonary Valve Stenosis} Alternate name; see \textit{Pulmonary valve stenosis}.
...
\medterm{Pulmonic Valve Stenosis} Narrowing of the valve between the right ventricle and pulmonary artery, usually present from birth, that creates right-ventricular outflow obstruction. Echocardiography assesses severity; selected symptomatic or severe cases can be treated with catheter balloon valvuloplasty or surgery.
...
\medterm{Pulsatile Proptosis} An abnormal forward protrusion of the eyeball characterized by visible or palpable pulsations synchronous with the arterial pulse, classically accompanied by an audible orbital bruit. It is a cardinal sign of a direct carotid-cavernous fistula or congenital sphenoid wing dysplasia in neurofibromatosis type 1.
...
\medterm{Pulseless Electrical Activity} Cardiac arrest in which an organized electrical rhythm appears on the ECG but there is no palpable pulse or effective mechanical cardiac output. It is a non-shockable rhythm requiring high-quality CPR, epinephrine, and rapid evaluation for reversible causes, including the Hs and Ts.
...
\medterm{Pulsus Alternans} A pulse rhythm where strong and weak beats alternate back and forth, showing that the main heart pump is weak and struggling.

\medterm{Pulsus Bisferiens} An abnormal peripheral arterial pulse waveform characterized by two distinct systolic peaks per cardiac cycle separated by a midsystolic dip, classic for severe aortic regurgitation, combined aortic stenosis and regurgitation, or hypertrophic obstructive cardiomyopathy (HOCM).
\synonyms
Biphasic Pulse; Bisferious Pulse
...
\medterm{Pulsus Parvus et Tardus} A weak, slow-rising pulse in the neck. It may occur with severe narrowing of the aortic valve, but it is not specific and must be assessed with the heart examination and tests.
\synonyms
Anacrotic Pulse; Slow-Rising Arterial Pulse
...
\synonyms
Cardiogenic Shock; Acute Ventricular Failure
...
\medterm{Punch Biopsy} A dermatological procedure in which a circular, hollow blade instrument is rotated through the skin into the subcutaneous fat to obtain a full-thickness cylindrical specimen of skin tissue for histopathological examination.
...
\medterm{Puncture Biopsy} Alternate name; see \textit{needle biopsy: removal of cells or tissue through a percutaneous puncture for microscopic, molecular, or microbiologic examination; imaging may guide the target and route}.
...
\medterm{Pupillary Light Reflex} The normal narrowing of the pupil when light enters the eye. It tests the eye, optic nerve, brain pathways, and nerves that control the pupil.
...
\medterm{Purpura} Non-blanching red, purple, or violaceous macules, papules, or patches produced by the extravasation of erythrocytes into the dermis or submucosa. It is classified by lesion size into petechiae (less than three millimetres), purpura (three to ten millimetres), and ecchymoses (greater than one centimetre), and divided clinically into palpable purpura (indicating small-vessel vasculitis) and non-palpable purpura (caused by thrombocytopenia, platelet dysfunction, vascular fragility, or coagulation disorders).
...
\medterm{Pustular Psoriasis} A form of psoriasis characterized by sterile pus-filled pustules on inflamed skin. It may be localized to the palms and soles or generalized with fever and systemic illness; generalized disease can be an emergency requiring urgent specialist care.
...
\medterm{PVD} Alternate name; see \textit{Peripheral artery disease}.

\medterm{PVI} Alternate name; see \textit{Pulmonary Vein Isolation}.

\medterm{PVPS} Alternate name; see \textit{Post-vasectomy pain syndrome}.
...
\medterm{Pyloric Canal} The narrow passage between the pyloric antrum and the pyloric sphincter. It carries stomach contents toward the duodenum.
...
\synonyms
Infantile Hypertrophic Pyloric Stenosis; IHPS; Gastric Outlet Obstruction
...
\medterm{Pyogenic Granuloma} A common benign vascular proliferation (lobular capillary hemangioma) of the skin or mucous membranes that arises rapidly following minor trauma or during pregnancy ('pregnancy tumor' / granuloma gravidarum), presenting as an erythematous, smooth or lobulated, pedunculated or sessile vascular papule prone to profuse bleeding.
\synonyms
Lobular Capillary Hemangioma; Granuloma Gravidarum

\medterm{Pyogenic Granuloma (Lobular Capillary Hemangioma)} A rapidly growing, benign vascular nodule of skin or mucosa that often follows minor trauma or occurs during pregnancy. It is bright red, friable, and prone to bleeding; treatment may include curettage, cautery, excision, or other local therapy.
...
\medterm{Pyridoxine Deficiency} Deficiency of vitamin B6, which is needed for amino-acid metabolism, neurotransmitter synthesis, hemoglobin production, and normal nerve function. It may cause dermatitis, glossitis, anemia, seizures, neuropathy, or immune dysfunction.
...
\medterm{Pyruvate Carboxylase Deficiency} An inherited disorder caused by deficient pyruvate carboxylase, an enzyme needed for gluconeogenesis and other metabolic pathways. It can cause lactic acidosis, low blood glucose, poor growth, seizures, abnormal movements, developmental impairment, or liver failure.
...
\medterm{Pyruvate Dehydrogenase Complex Deficiency (PDCD)} An inherited disorder in which the pyruvate dehydrogenase complex cannot efficiently convert pyruvate into acetyl-CoA. It may cause lactic acidosis, poor growth, developmental impairment, seizures, low muscle tone, ataxia, or other neurologic disease.
...
\medterm{Panic And Anxiety Disorders} Alternate name; see \textit{Anxiety Disorders}.

\medterm{Parathyroid, Underactivity Of} Alternate name; see \textit{Hypoparathyroidism}.

\medterm{Parkinson's Disease Center} Alternate name; see \textit{Parkinson's Disease}.

\medterm{Paroxysmal Nocturnal Hemoglobinuria (PNH)} Alternate name; see \textit{Paroxysmal Nocturnal Hemoglobinuria}.

\medterm{Pediatric ADHD} Attention-deficit/hyperactivity disorder in children or adolescents, involving developmentally inappropriate inattention, hyperactivity, and/or impulsivity that persist across settings and impair functioning.

\medterm{Physical Allergy Urticaria} Hives triggered by a physical stimulus such as pressure, cold, heat, sunlight, vibration, water, or exercise. The trigger causes mast-cell activation and itchy raised welts; severe breathing or circulation symptoms require emergency care.

\medterm{PID (Pelvic Inflammatory Disease)} Alternate name; see \textit{Pelvic Inflammatory Disease}.

\medterm{Pimples (Acne)} Alternate name; see \textit{Acne}.

\medterm{PMS} Abbreviation; see \textit{Premenstrual Syndrome}.

\medterm{Porcelain Inlay} A tooth-colored ceramic restoration bonded into a prepared cavity within a tooth. It can repair selected areas of decay or damage while preserving more tooth structure than a full crown.

\medterm{Postcoital Test} A fertility test that examines cervical mucus after intercourse for sperm presence and movement. It is rarely used now because results are variable and better-established fertility evaluations are available.

\medterm{Posttraumatic Stress Disorder (PTSD)} Alternate name; see \textit{Post-Traumatic Stress Disorder}.

\medterm{Posttraumatic Stress Syndrome} Older or alternate name for \textit{Post-Traumatic Stress Disorder}.

\medterm{Preeclampsia And High Blood Pressure} Alternate name; see \textit{Preeclampsia}.

\medterm{Pregnancy With Asthma} Asthma during pregnancy may change as hormone, breathing, and immune conditions change. Poorly controlled asthma can reduce oxygen for the pregnant person and fetus, so prescribed controller treatment and regular obstetric and respiratory follow-up are important.

\medterm{Pregnancy, Ectopic} Alternate name; see \textit{Ectopic Pregnancy}.

\medterm{Pregnancy, Extrauterine} Alternate name; see \textit{Extrauterine Pregnancy}.

\medterm{Pregnancy, Tubal} Alternate name; see \textit{Tubal Pregnancy}.

\medterm{Premenstrual Syndrome (PMS)} Alternate name; see \textit{Premenstrual Syndrome}.

\medterm{Prevention Of Liver Cancer} Measures that lower the risk of liver cancer, especially preventing or treating chronic hepatitis B or C, limiting alcohol, avoiding tobacco, maintaining a healthy weight, and managing metabolic liver disease. People at high risk may need regular surveillance.

\medterm{Prostate Enlargement/BPH} Alternate name; see \textit{Benign Prostatic Hyperplasia}.

\medterm{Purpura, Henoch-Schonlein} Alternate name; see \textit{IgA Vasculitis}.

\medterm{Paroxysmal Positional Nystagmus} Involuntary, rhythmic eye movements triggered by a change in head position. It may accompany benign paroxysmal positional vertigo or arise from another vestibular or neurologic disorder; persistent, atypical, or neurologic-associated nystagmus needs evaluation.

\medterm{Pfeiffer Syndrome Type I} The milder form of Pfeiffer syndrome, a genetic craniosynostosis disorder usually associated with broad or deviated thumbs and great toes and premature fusion of some skull sutures. Severity and developmental effects vary.

\medterm{Phakomatosis TS} Alternate name; see \textit{Tuberous Sclerosis Complex}.

\medterm{Pharmacogenic Myopathy} Muscle weakness or muscle injury caused by a medicine or drug. The presentation can include pain, cramps, elevated creatine kinase, or rhabdomyolysis, and evaluation considers the timing, dose, interactions, and other causes.

\medterm{Phenylketonuria (PKU)} Alternate name; see \textit{Phenylketonuria}.

\medterm{PPS (Post-Polio Syndrome)} Alternate name; see \textit{Post-Polio Syndrome}.

\medterm{Prader Willi Syndrome} Alternate spelling; see \textit{Prader-Willi Syndrome}.

\medterm{Prealbumin Tyr-77 Amyloidosis} A rare hereditary transthyretin amyloidosis caused by a Tyr77 transthyretin variant. Misfolded protein can deposit in nerves, the heart, or other organs and may cause neuropathy, cardiomyopathy, or gastrointestinal symptoms.

\medterm{Pregnancy, Cervical} Alternate name; see \textit{Cervical Pregnancy}.

\medterm{Premature Senility Syndrome} An outdated term for dementia beginning unusually early in life. Modern assessment identifies the specific cause, such as Alzheimer disease, frontotemporal dementia, vascular disease, or an inherited disorder, rather than using this label as a diagnosis.

\medterm{Presenile Tremor Syndrome} An uncommon or historical label for tremor beginning before older adulthood; the cause should be assessed for essential tremor, medication effects, dystonia, Parkinson disease, metabolic disease, or another neurologic disorder.

\medterm{Pressure Sores} Alternate name; see \textit{Pressure Sore}.

\medterm{Primary Biliary Cirrhosis (PBC)} Alternate name; see \textit{Primary Biliary Cholangitis}.

\medterm{Primary Cutaneous Amyloidosis} Deposition of amyloid proteins limited mainly to the skin, causing itchy rippled, lichen-like, or darker patches. It differs from systemic amyloidosis, although assessment may be needed when symptoms or findings suggest disease beyond the skin.

\medterm{Pudendal Neuralgia} Pain caused by irritation or entrapment of the pudendal nerve, often felt in the perineum and worsened by sitting. It may include burning, tingling, altered sensation, or sexual and urinary symptoms and requires assessment for other pelvic causes.

\medterm{Pulmonary Hypertension, Primary} Pulmonary hypertension occurring without an identified secondary cause. Modern classification distinguishes idiopathic, heritable, and other forms of pulmonary arterial hypertension from pulmonary hypertension caused by heart, lung, clotting, or systemic disease.

\medterm{Pulmonary Hypertension, Secondary} Pulmonary hypertension caused by another condition, such as left-heart disease, chronic lung disease, low oxygen, chronic blood clots, or systemic disease. Treatment focuses on the cause and specialist classification.

\medterm{Pulmonary Lymphangioleiomyomatosis} Alternate name; see \textit{Lymphangioleiomyomatosis}.

\medterm{Pump Lung} An older occupational term for byssinosis, a work-related airway disease caused by inhalation of cotton, flax, or hemp dust. Symptoms may include chest tightness, cough, wheezing, and breathlessness that worsen during or after workplace exposure.

\medterm{Pure Cutaneous Histiocytosis} A rare disorder in which abnormal histiocytes accumulate in the skin without recognized internal-organ involvement. It can produce papules, nodules, or plaques and must be distinguished from systemic histiocytic disease.

\medterm{Purpura Hemorrhagica ITP} Alternate name; see \textit{Immune Thrombocytopenia}.

\medterm{Purpura, Idiopathic Thrombocytopenic} Alternate name; see \textit{Immune Thrombocytopenia}.

\medterm{Purpura, Thrombotic Thrombocytopenic} Alternate name; see \textit{Thrombotic Thrombocytopenic Purpura}.

\medterm{PVD (Peripheral Vascular Disease)} Alternate name; see \textit{Peripheral Vascular Disease}.

\medterm{Polycystic Ovary Syndrome (PCOS)} Alternate name; see \textit{Polycystic Ovary Syndrome}.

\medterm{PPH} Abbreviation; see \textit{Postpartum Hemorrhage}.

\medterm{Prostate Enlargement/BPH} Alternate name for benign prostatic hyperplasia, noncancerous enlargement of the prostate that can obstruct urine flow and cause weak stream, urgency, frequency, nighttime urination, or incomplete emptying.

\medterm{Physical Abuse} Deliberate use of physical force that causes or risks injury, pain, disability, or death. In clinical care, suspected abuse requires attention to immediate safety, documentation, and reporting duties under local law.

\medterm{Physical Urticaria, Cholinergic Type} Hives triggered by increased body temperature, sweating, exercise, stress, or hot water. Small itchy wheals often begin on the trunk and spread; breathing or circulation symptoms may indicate anaphylaxis.

\medterm{PI} Abbreviation for primary immunodeficiency, a group of inherited or acquired disorders in which immune defenses are absent, reduced, or dysfunctional, leading to recurrent or unusual infections and sometimes autoimmune disease.

\medterm{Pick’s Disease} A historical name for a subtype of frontotemporal dementia characterized by progressive changes in behavior, personality, language, or executive function and, on pathology, characteristic Pick bodies in affected neurons.

\medterm{Prader-Labhart-Willi Fancone Syndrome} Historical or variant naming for Prader-Willi syndrome, a chromosome 15 imprinting disorder causing infantile hypotonia and feeding difficulty followed by hyperphagia, obesity risk, hypogonadism, developmental differences, and short stature.

\medterm{Pulmonary Lymphangiomyomatosis} Alternate spelling for lymphangioleiomyomatosis, a rare cystic lung disease that mainly affects women and can cause progressive breathlessness, recurrent pneumothorax, chylous effusions, and abnormal growth of smooth-muscle-like cells.
