...
\medterm{Paraphilic Disorder} A mental disorder in which a paraphilia causes significant personal distress or problems in daily life, apart from distress caused only by social disapproval, or involves harm, risk of harm, or people who do not or cannot consent. Recognized examples include voyeuristic disorder, exhibitionistic disorder, frotteuristic disorder, fetishistic disorder, sexual masochism disorder, sexual sadism disorder, pedophilic disorder, and transvestic disorder. A paraphilia without these consequences is not, by itself, a paraphilic disorder.
...
\medterm{Prion Disease} Alternate index label; see \textit{Prion Diseases}.
\medterm{Prion Diseases} A group of rare diseases in humans and animals caused by prions, which are proteins folded into an abnormal shape. A prion can cause normal proteins to misfold and build up, damaging and killing brain cells. The diseases may develop only after a long symptom-free period, but once symptoms begin they usually worsen quickly and lead to death over months or years. Human examples include Creutzfeldt--Jakob disease, variant Creutzfeldt--Jakob disease, fatal familial insomnia, Gerstmann--Sträussler--Scheinker disease, and kuru. There is currently no cure or vaccine.
...
\medterm{Progeria} A rare genetic condition in which signs that resemble aging begin rapidly during childhood. The most common form is Hutchinson--Gilford progeria syndrome, usually caused by a change in the \textit{LMNA} gene. Children are often healthy-looking at birth but later grow slowly and may develop hair loss, thin aged-looking skin, loss of fat under the skin, stiff joints, and a characteristic facial appearance. The condition causes early hardening of the arteries, which can lead to serious heart or blood-vessel disease. Intellectual development is usually not affected.
...
\medterm{Psychiatric Emergency} A mental-health condition requiring immediate assessment because of serious risk to life, safety, basic functioning, or the safety of others. Examples include imminent suicide risk, severe psychosis, dangerous agitation, catatonia, or severe substance intoxication or withdrawal.
...
\medterm{PTSD} Post-traumatic stress disorder, a mental health condition that may develop after exposure to actual or threatened death, serious injury, sexual violence, or another traumatic event. Symptoms may include intrusive memories, nightmares, flashbacks, avoidance of reminders, persistent negative changes in mood or thinking, emotional detachment, sleep problems, irritability, exaggerated startle, or increased alertness. Symptoms persist beyond the expected immediate response to the event and may substantially interfere with relationships, work, school, or daily activities.
