...
\medterm{Patlak Plot (Patlak-Rutland Analysis)} A graph used with certain nuclear medicine scans to estimate how quickly a tracer moves from the blood into tissue and remains there. It can help measure tissue activity, including tumor metabolism.
...
\medterm{Pelvic Organ Prolapse Quantification System} A standardized examination and measurement system used to record how far the vagina, uterus, bladder, or rectum has moved downward. Measurements are taken while bearing down and classify prolapse from no visible descent to the most advanced stage. The result helps describe severity and plan treatment.
