...
\medterm{P Arm Of A Chromosome} The shorter of the two arms of a chromosome. It is labeled p, from the French word for “small,” while the longer arm is labeled q.
...
\medterm{Parkinson Disease} A progressive brain disorder that affects movement. It may cause slowness, shaking when at rest, stiffness, balance problems, smaller handwriting, reduced facial expression, and changes in sleep, mood, or thinking.



\medterm{Parkinson'S Disease} A progressive disorder in which brain cells that help control movement become damaged. Symptoms may include slowness, stiffness, tremor, balance difficulty, and non-movement problems such as constipation or sleep changes.
