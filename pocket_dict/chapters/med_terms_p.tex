\medterm{Abdominal Point Tenderness} Well-localized sharp pain elicited by gentle palpation over a specific anatomical point of the abdomen, such as McBurney's point in acute appendicitis, Murphy's sign in acute cholecystitis, or localized peritoneal irritation.

\synonyms
Focal Abdominal Tenderness; Localized Peritoneal Tenderness; Point Pain in Abdomen

\medterm{Acne Vulgaris} Alternate name; see \textit{Acne}.
...
\medterm{Alopecia Areata} Alternate name; see \textit{Alopecia Areata}.

\medterm{Analgesia} Reduction of pain using medicines, procedures, physical treatment, psychological support, or a combination. The best approach depends on the cause, duration, severity, function, other health conditions, and risks of treatment.
\synonyms
Pain Control; Pain Management

\medterm{Antisocial Personality Disorder} Alternate name; see \textit{Antisocial Personality Disorder}.

\medterm{Arsenic Poisoning} Alternate name; see \textit{Arsenic Poisoning}.

\medterm{Back Pain} Alternate name; see \textit{Back pain}.
...
\medterm{Baker's Cyst} Alternate name; see \textit{Baker Cyst}.

\medterm{Balanitis} Alternate name; see \textit{Balanitis (Penis Disorder)}.

\medterm{Bell's Palsy} Alternate name; see \textit{Bell's palsy}.

\medterm{Bilateral Pneumonia} Pneumonia affecting both lungs. Because more lung tissue may be involved, it can cause greater breathing difficulty and lower oxygen levels than disease limited to one lung, although severity depends on the cause and person’s health.

\medterm{Borderline Personality Disorder} Alternate name; see \textit{Borderline personality disorder}.
...
\medterm{Breast Pain} Alternate name; see \textit{Breast pain}.

\medterm{Brief Psychotic Disorder} Alternate name; see \textit{Brief Psychotic Disorder}.

\medterm{Broken Little Finger} Alternate name; see \textit{Broken Finger}.

\medterm{Bullous Pemphigoid} Alternate name; see \textit{Bullous Pemphigoid}.

\medterm{Cancer Pain} Alternate name; see \textit{Cancer Pain}.

\medterm{Cauliflower Ear} Alternate name; see \textit{Cauliflower Ear}.

\medterm{Cerebral Palsy} Alternate name; see \textit{Cerebral Palsy}.
...
\synonyms
Labor and Delivery; Accouchement

\medterm{Chronic Pelvic Pain} Alternate name; see \textit{Chronic pelvic pain}.

\medterm{Ciguatera Poisoning} Alternate name; see \textit{Ciguatera Poisoning}.
...
\medterm{Coccydynia} Alternate name; see \textit{Coccydynia}.

\medterm{Colon Polyps} Alternate name; see \textit{Colon Polyps}.
...
\medterm{Constrictive Pericarditis} A chronic form of pericardial disease characterized by fibrous thickening, rigidity, and calcification of the pericardium, creating a non-compliant shell that impedes normal diastolic filling of the cardiac ventricles and produces right-sided heart failure.

\synonyms
Chronic Constrictive Pericarditis; Pericardial Constriction; Calcific Pericarditis

\medterm{Dementia Pugilistica} Alternate name; see \textit{Dementia}.
...
\medterm{Diabetic Peripheral Neuropathy} Alternate name; see \textit{Diabetic Neuropathy}.

\medterm{Diffuse Parenchymal Lung Disease} Alternate name; see \textit{Interstitial Lung Disease (Interstitial Pneumonia)}.

\medterm{Dysgeusia} An altered sense of taste in which food may taste metallic, bitter, salty, unpleasant, or different from usual. Causes include infections, medicines, nutritional deficiencies, head injury, and mouth, nerve, or salivary-gland problems.

\medterm{Dyspareunia} Persistent or recurrent genital pain before, during, or after sexual intercourse, with physical, hormonal, emotional, or relationship-related causes.
...
\medterm{Ectopic Pregnancy} Alternate name; see \textit{Ectopic Pregnancy}.

\medterm{Elbow Pain} Alternate name; see \textit{Elbow Pain}.

\medterm{Endometrial Polyps} Alternate name; see \textit{Uterine polyps}.
...
\medterm{Facial Palsy} Alternate name; see \textit{Bell's palsy}.

\synonyms
Fertile Window Estimation; Ovulation Timing; Natural Family Planning Fertility Charting

\medterm{Fever} An abnormally high body temperature, usually $38^\circ\text{C}$ ($100.4^\circ\text{F}$) or higher. Fever is a controlled response in which the brain raises the body’s temperature setting, often because of infection or inflammation. It differs from hyperthermia, in which temperature rises without that change in setting, such as during heat stroke. Treatment depends on the cause and the person’s symptoms.

\medterm{Gallbladder Pain} Alternate name; see \textit{Gallbladder Pain (Gall Bladder Pain)}.

\medterm{Gastric Polyps} Alternate name; see \textit{Stomach polyps}.

\medterm{Gastroparesis} Stomach paralysis, or gastroparesis, is delayed gastric emptying without a mechanical blockage, causing early fullness, nausea, vomiting, bloating, and variable glucose control.

\medterm{Gingivitis} Alternate name; see \textit{Gingivitis}.

\medterm{Guillain-Barré Syndrome} Sudden inflammation or dysfunction of several peripheral nerves without an identified cause. It may cause tingling, weakness, pain, or loss of reflexes in the limbs and can sometimes affect breathing or swallowing. Rapidly worsening weakness requires urgent assessment because an immune nerve disorder such as Guillain--Barré syndrome may be responsible.

\medterm{Hamstring Strain} Alternate name; see \textit{Hamstring Injury}.

\medterm{Heel Pain} Alternate name; see \textit{Heel Spurs}.

\medterm{Hemolytic Jaundice} Jaundice caused by excessive breakdown of red blood cells before bilirubin reaches the liver, producing increased unconjugated bilirubin.

\synonyms
Hemolytic Jaundice; Acholuric Jaundice

\medterm{High-Risk Pregnancy Factors} Preexisting maternal medical conditions, obstetric complications, or fetal conditions (such as advanced maternal age, chronic hypertension, gestational diabetes, preeclampsia, or fetal growth restriction) that increase morbidity or mortality for mother or child.

\synonyms
Maternal-Fetal Health Risks; High-Risk Gestation; Pregnancy Complication Risk Factors

\medterm{ICU Psychosis} Outdated term; see \textit{Delirium}.

\medterm{Immune Thrombocytopenia} An acquired autoimmune hematologic disorder characterized by antibody-mediated destruction of platelets and impaired megakaryocyte thrombopoiesis, producing isolated thrombocytopenia with petechiae, purpura, and mucocutaneous bleeding.

\synonyms
ITP; Immune Thrombocytopenic Purpura; Autoimmune Thrombocytopenia
...
\medterm{Kidney Pain} Alternate name; see \textit{Kidney Pain}.

\medterm{Leukocoria} An abnormal white pupillary reflex (cat's-eye reflex) observed instead of the normal red reflex on ophthalmoscopic examination or flash photography in an infant or young child, indicating life- or vision-threatening pathology such as retinoblastoma, congenital cataract, or retinopathy of prematurity.

\synonyms
White Pupillary Reflex; Cat's Eye Reflex; Amaurotic Cat's Eye
...
\medterm{Micropenis} A penis that is substantially below expected stretched length for age, usually assessed as micropenis in a newborn or child after excluding measurement and developmental variation.
...
\medterm{Mitral Valve Prolapse} Alternate name; see \textit{Mitral valve prolapse}.
...
\medterm{Narcissistic Personality Disorder} Alternate name; see \textit{Narcissistic personality disorder}.

\medterm{Nasal Polyps} Alternate name; see \textit{Nasal polyps}.
...
\medterm{Neonatal Polycythemia} A venous hematocrit $\ge 65\%$ or venous hemoglobin $\ge 22\text{ g/dL}$ in a newborn infant, which can increase whole-blood viscosity and impair capillary microcirculation, leading to lethargy, hypotonia, cyanosis, and hypoglycemia.

\synonyms
Neonatal Plethora; Newborn Hyperviscosity Syndrome; Infantile Polycythemia

\medterm{Neuropathic Pain} Alternate name; see \textit{Neuropathic Pain (Nerve Pain)}.

\medterm{Night Terrors} Episodes of sudden intense fear, screaming, and autonomic arousal during sleep, usually arising from deep non-REM sleep and often followed by little or no memory.

\synonyms
Sleep Terrors; Incubus
...
\medterm{Opioid Analgesic Medications} A class of potent analgesic agents that bind to central and peripheral $\mu$-opioid receptors to modulate nociceptive transmission. Used for moderate-to-severe acute pain and cancer-related pain; carries significant risks of respiratory depression, sedation, physical dependence, tolerance, and constipation.

\synonyms
Opioid Analgesics; Narcotic Analgesics; Opiate Pain Relievers
...
\medterm{Paget Disease Of The Nipple} A rare manifestation of breast malignancy characterized by the migration of malignant glandular epithelial cells (Paget cells) into the epidermis of the nipple and areola. It presents with persistent unilateral eczema-like erythema, scaling, crusting, itching, or ulceration of the nipple that does not heal with topical creams. In more than 85\% to 90\% of cases, it is accompanied by an underlying ductal carcinoma in situ (DCIS) or invasive ductal carcinoma deeper within the breast. Diagnosis is confirmed by full-thickness skin punch biopsy showing large, atypical Paget cells with clear cytoplasm; treatment entails breast imaging, oncologic surgery (lumpectomy or mastectomy), and systemic therapy based on the underlying cancer stage.
...
\medterm{Paint Stripper Poisoning} Poisoning caused by ingestion, inhalation, or skin or eye exposure to solvents and other chemicals in paint, lacquer, or varnish removers. Effects may include irritation, central nervous system depression, respiratory injury, metabolic abnormalities, or organ damage; severity depends on the substance, dose, route, and timing.
...
\medterm{Pastia Lines} Confluent, linear, pink-to-violaceous petechial streaks occurring along the skin creases and flexural folds (especially the antecubital fossae, axillae, and groins) that do not blanch on pressure, pathognomonic for the exanthem of scarlet fever (Streptococcus pyogenes).
\synonyms
...
\medterm{Patellar Apprehension Test} A clinical test used to assess for patellofemoral instability or recurrent patellar subluxation. With the patient supine and the knee slightly flexed, the examiner applies lateral pressure to the patella; marked discomfort, involuntary quadriceps contraction, or patient apprehension confirms patellar instability.
...
\medterm{Percussion Myotonia} A sustained, involuntary muscle contraction followed by delayed relaxation elicited by direct mechanical percussion of a muscle belly (such as the thenar eminence or tongue) with a reflex hammer. It is a diagnostic hallmark of myotonic dystrophy and myotonia congenita.
...
\medterm{Pericardial Friction Rub} A superficial, high-pitched, scratchy or grating auscultatory sound produced by friction between inflamed visceral and parietal pericardial layers, best heard along the left sternal border with the patient leaning forward in end-expiration, pathognomonic for acute pericarditis.
\synonyms
...
\medterm{Pericardial Tamponade} A life-threatening medical emergency caused by the rapid accumulation of fluid, blood, or pus in the sac surrounding the heart (the pericardium). The elevated pressure prevents the heart chambers from relaxing and filling properly, drastically reducing blood flow to the body and causing shock. Common causes include chest trauma, aortic dissection, cancer, pericarditis, and complications of heart surgery. Hallmark findings include Beck's triad (low blood pressure, swollen neck veins, and muffled heart sounds) along with pulsus paradoxus (a sharp drop in pulse and blood pressure during inhalation). Diagnosis is confirmed by bedside ultrasound (echocardiogram) showing fluid compressing the heart. Immediate emergency treatment involves pericardiocentesis (inserting a needle to drain the fluid) or surgical drainage to relieve pressure.
...
\medterm{Phyllodes Tumor} A rare fibroepithelial breast neoplasm characterized by exaggerated stromal proliferation with leaf-like architectural projections into epithelial clefts (from Greek \textit{phyllon}, leaf). Typically presenting in women aged 40--50 as a painless, rapidly enlarging, mobile breast mass, it is histologically graded by the WHO into benign, borderline, or malignant based on stromal cellularity, nuclear atypia, mitotic rate, and margin invasiveness. Unlike epithelial breast carcinomas, malignant phyllodes tumors behave like sarcomas, spreading hematogenously (predominantly to the lungs and bones) rather than through lymphatic channels. Definitive treatment requires complete surgical excision with wide margins ($\ge 1\,\text{cm}$) or mastectomy to prevent local recurrence; routine axillary lymph node dissection is not indicated.
...
\medterm{Proximal Deep Vein Thrombosis} A blood clot located in the major deep veins of the lower limb at or above the level of the knee, including the popliteal, femoral, or iliac veins. Proximal DVT carries a significantly higher risk of embolization causing life-threatening pulmonary embolism and chronic post-thrombotic syndrome compared to distal (calf) vein thrombosis. Typical symptoms include marked unilateral leg and thigh swelling, warmth, erythema, and tenderness. Diagnosis is confirmed by venous compression duplex ultrasound. Standard management requires immediate therapeutic anticoagulation (such as direct oral anticoagulants or low-molecular-weight heparin) for at least three to six months to prevent thrombus extension and embolization.
...
\medterm{Pulsus Parvus et Tardus} A diminished-amplitude (parvus) and delayed, slow-rising (tardus) carotid arterial pulse with a flattened peak, pathognomonic on physical examination for severe calcific aortic valve stenosis.
\synonyms
...
\medterm{Schizoid Personality Disorder} Alternate name; see \textit{Schizoid personality disorder}.

\medterm{Schizotypal Personality Disorder} Alternate name; see \textit{Schizotypal personality disorder}.

\medterm{Scrotal Pain} Alternate name; see \textit{Testicular Disorders}.
...
\medterm{Serum Protein Electrophoresis} A laboratory screening technique that fractions serum proteins into albumin, alpha-1, alpha-2, beta, and gamma globulin zones to detect monoclonal gammopathies (M-protein spike) in multiple myeloma, Waldenström macroglobulinemia, or amyloidosis.

\synonyms
SPEP; Serum Protein Gel Electrophoresis; Monoclonal Protein Screen
...
\medterm{Specific Phobia} An anxiety disorder characterized by marked, unreasonable, and persistent fear or anxiety provoked by the presence or anticipation of a specific object or situation (such as flying, heights, animals, injections, or blood).

\synonyms
Simple Phobia; Isolated Phobia; Situational Phobia

\medterm{Spontaneous Bacterial Peritonitis} An acute bacterial infection of ascitic fluid in patients with advanced cirrhosis and portal hypertension, occurring in the absence of an identifiable surgically treatable intra-abdominal focus. Diagnosed by ascitic fluid polymorphonuclear (PMN) count $\ge 250/\mu\text{L}$.

\synonyms
SBP; Primary Peritonitis in Cirrhosis; Spontaneous Ascitic Infection

\medterm{Succenturiate Placenta} A succenturiate placenta has one or more accessory placental lobes separate from the main placenta, which can cause retained tissue or fetal-vessel complications after delivery.
...
\medterm{Thrombocytopenia} Alternate name; see \textit{Thrombocytopenia (Low Platelet Count)}.
...
\medterm{Tubal Pregnancy} Alternate name; see \textit{Ectopic Pregnancy}.

\medterm{Uterine Fibroids} Alternate name; see \textit{Uterine Fibroids}.

\medterm{Uterine Polyps} Alternate name; see \textit{Uterine polyps}.

\medterm{Uterine Prolapse} Descent of the uterus into the vaginal canal due to weakening of pelvic floor supports,
most commonly the uterosacral and cardinal ligaments.

\synonyms
Descensus Uteri; Pelvic Organ Prolapse

\medterm{Vascular Embolic Particles} A small material placed into a blood vessel to block it during a procedure. Particles may be used to control bleeding or reduce blood flow to a tumor, fibroid, or other abnormal area and must be directed carefully to avoid harming healthy tissue.
...
\medterm{Vulvodynia} Alternate name; see \textit{Vaginal Pain (Vulvodynia)}.

\medterm{Weber-Christian Disease} Alternate name; see \textit{Weber-Christian Disease}.

\medterm{Whiplash} Alternate name; see \textit{Whiplash}.
