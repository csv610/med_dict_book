...
\medterm{Paenibacillus Polymyxa} A soil bacterium used in agriculture and biotechnology that rarely causes human infection. When it is recovered from a patient, its importance depends on the specimen, symptoms, repeated cultures, and the person’s immune status.
