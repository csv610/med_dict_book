...
\medterm{Paenibacillus Polymyxa} A soil bacterium used in agriculture and biotechnology that rarely causes opportunistic infection. A soil bacterium used in agriculture and biotechnology that rarely causes infection, usually in vulnerable patients.
...
\medterm{Pain Relief (Analgesia)} Achieved through pharmacologic, interventional, physical, and psychologic modalities targeting nociceptive transmission and pain perception.
\synonyms
Analgesia
...
\medterm{Panacea} A supposed cure for every disease. No single treatment safely cures all illnesses, so claims of universal remedies should be viewed cautiously and discussed with a qualified healthcare professional.
...
\medterm{Pancolitis} Inflammation affecting the entire colon, often as an extensive form of ulcerative colitis. Inflammation affecting the entire colon, often due to extensive ulcerative colitis, causing diarrhea, pain, and bleeding.
...
\medterm{Pancreatic Cysts} Fluid-filled sacs in or around the pancreas; some are harmless, while others may become cancerous and require follow-up.
...
\medterm{Pancytopenia} Simultaneous reduction of red cells, white cells, and platelets, indicating bone marrow failure or infiltration.
...
\medterm{Pandemic} An epidemic spreading across multiple countries or continents and affecting many people. A pandemic may arise when a new infectious agent spreads widely among populations with limited previous immunity.
HIV/AIDS.
...
\medterm{Pannus} An abnormal layer of inflamed, blood-vessel-rich tissue that grows over a joint or the cornea. It can damage cartilage or impair vision and is associated with conditions such as rheumatoid arthritis or trachoma.
...
\medterm{Papule} Papule examines papule; interpretation depends on the specimen or body region, test method, reference range, and clinical question. arise from epidermal, dermal, inflammatory, infectious, or neoplastic processes.
...
\medterm{Parasitic Infections} Illnesses caused by parasites such as protozoa, worms, or organisms living on the skin. They may affect the intestine, blood, lungs, liver, or other tissues and can cause diarrhea, fever, anemia, itching, or organ damage; diagnosis and treatment depend on the parasite.
...
\medterm{Paroxysmal Nocturnal Haemoglobinuria} An acquired blood-forming stem cell disorder causing red-cell destruction, blood clots, and sometimes bone marrow failure.
...
\medterm{Paroxysmal Supraventricular Tachycardia} Sudden-onset and sudden-termination episodes of rapid regular tachycardia arising above the ventricles, usually involving an atrioventricular re-entry or nodal re-entry circuit. Palpitations, dizziness, chest discomfort, or syncope may occur.
\synonyms
...
\medterm{Partial Volume Artifact} An imaging error that occurs when one small image unit contains more than one type of tissue. Their signals are averaged, which can blur edges or hide a small abnormality; thinner slices or higher-resolution imaging may reduce the problem.
...
\medterm{Pasteurella Pneumotropica} Pasteurella pneumotropica is mainly an animal-associated bacterium that rarely causes opportunistic human infection. An animal-associated bacterium that rarely infects people, but can cause opportunistic illness in vulnerable patients.
...
\medterm{Pathogenesis} Mechanism of disease development. Steps: initiation, promotion, progression. The biological process by which a disease begins and develops, including its causes, cellular changes, and progression.
...
\medterm{Pathognomonic} Describes a finding so strongly linked to a disease that its presence identifies that disease.
...
\medterm{Pediatric Obesity} Excess body fat in a child or adolescent assessed using Body Mass Index compared with children of the same age and sex. It can affect physical and emotional health.
...
\medterm{Pediatric Toxicology} Poisoning in children. Common: iron, medications, household cleaners, plants. Prevention: child-proof containers, education. The study and treatment of poisoning in children, including medicine, household chemical, plant, and other exposures.
...
\medterm{Pediococcus Pentosaceus} A lactic-acid-producing bacterium used in some fermented foods that rarely infects people. Reported infections are usually opportunistic and occur in individuals with serious illness, weakened defenses, or invasive medical devices.
...
\medterm{Penile Intraepithelial Neoplasia} A precancerous change in the surface cells of the penis. It may be linked to human papillomavirus or to long-term inflammation and skin disease. It can appear as a red, scaly, or wart-like patch, often on the glans or foreskin. Without treatment it can become invasive penile cancer. Treatment may include prescribed creams, freezing or laser treatment, or surgery, with regular follow-up.
...
\medterm{Pentaerythritol Tetranitrate} A nitrate medicine that widens blood vessels and may reduce heart strain; now mainly historical or specialized.
...
\medterm{Pepsin} A stomach enzyme that begins digestion of proteins. A stomach enzyme that breaks proteins into smaller fragments. It is released as inactive pepsinogen and activated by stomach acid.
...
\medterm{Peptichemio} An investigational or historical name for an anticancer medicine related to peptide-linked chemotherapy compounds. Because the name is uncommon, the exact substance, evidence, dose, and safety information must be confirmed from reliable product records.

\medterm{Peptidase} An enzyme that breaks peptide bonds in proteins or peptides.
\medterm{Peptide} peptide is a defined chemical or biologic substance involved in peptide and studied in physiology, pharmacology, laboratory medicine, or treatment. A short chain of amino acids linked by peptide bonds.
...
\medterm{Peptide Library} A collection of many different peptides used in research to find sequences that bind to a target, affect a biological process, or may be useful in a diagnostic test or medicine.
...
\medterm{PERC Rule} A checklist used in the emergency department to identify some patients with very low risk of pulmonary embolism who may not need further testing. All eight must be absent: age 50 or older, pulse 100 or more, oxygen level below 95 percent, one-sided leg swelling, coughing blood, recent surgery or trauma, previous blood clots, and estrogen use. It should be used only when the clinician has already judged the starting risk to be very low.
...
\medterm{Pericardial Cavity} The narrow, fluid-filled space between the layers of the pericardium surrounding the heart. The thin fluid-containing space between pericardial layers surrounding the heart, allowing it to move with less friction.
...
\medterm{Pericardial Wall} The layered wall of the pericardial sac that surrounds and protects the heart. The layered wall of the sac around the heart that protects it and contains lubricating fluid.
...
\medterm{Periodontal Flap Surgery} Surgical access for deep debridement. Flap reflected, calculus removed, bone contoured, flap repositioned. Dental surgery lifting gum tissue to clean deep infection and reshape accessible bone before replacing the tissue.
...
\medterm{Peritoneal Diseases} Disorders affecting the peritoneum, including infection, inflammation, malignancy, hemorrhage, adhesions, and fluid accumulation. Conditions affecting the abdominal lining, including infection, inflammation, cancer, bleeding, scar tissue, or fluid buildup.
...
\medterm{Persistent Organic Pollutant} A harmful carbon-based chemical that remains in the environment, travels far, and builds up in living organisms. Examples include some pesticides, industrial chemicals, polychlorinated biphenyls, and dioxins.
...
\medterm{Pertussis} Pertussis is a contagious Bordetella pertussis infection causing prolonged coughing fits, inspiratory whoop, vomiting, and dangerous apnea in infants. Whooping cough, a contagious respiratory infection caused by Bordetella pertussis.
...
\medterm{Pharynx} A muscular tube extending from the base of the skull (clivus) to the level of the cricoid cartilage (C6), where it continues as the esophagus.
...
\medterm{Phenoxodiol} Phenoxodiol is an experimental cancer compound studied for its effects on cell signals and programmed cell death. It is not an established routine treatment, and its benefits and risks require further clinical research.

\medterm{Phenoxybenzamine} Phenoxybenzamine is an irreversible alpha-adrenergic blocker used mainly before surgery for catecholamine-secreting tumors and sometimes for urinary symptoms. An irreversible alpha-adrenergic blocker used mainly before surgery for pheochromocytoma.
...
\medterm{Photoelectric Effect} An interaction in which an atom absorbs an X-ray photon and ejects an inner-shell electron. It contributes to image contrast and radiation absorption, especially at lower energies and in dense materials.
...
\medterm{Phytomedicine} The evidence-based use of plant-derived products to prevent or treat disease. Plant medicines can have useful effects and harmful interactions, so quality, dose, safety, and scientific evidence must be considered.
...
\medterm{Pink Eye (Conjunctivitis)} Inflammation or infection of the thin covering over the eye and inner eyelids. It can cause redness, discharge, itching, burning, tearing, or swollen eyelids and may spread when infectious.
...
\medterm{Planococcus Bacteria} Bacteria in the Planococcus genus, usually round, gram-positive organisms found in soil, water, or other environments. They rarely cause human infection, but illness is possible in people with weakened immunity.
...
\medterm{Pleurisy} Inflammation of the thin layers around the lungs, often causing sharp chest pain that worsens with deep breathing or coughing. Causes include viral infection, pneumonia, a blood clot, autoimmune disease, or injury and must be assessed with other symptoms.
...
\medterm{Plozalizumab} An experimental antibody studied as a targeted treatment for inflammatory or cancerous disease. Its intended target, benefits, risks, and possible uses depend on clinical research and regulatory review.
...
\medterm{Pneumatosis} Gas within a tissue or organ wall, especially the intestines; its significance ranges from harmless to life-threatening.
...
\medterm{Polymyositis} An idiopathic inflammatory myopathy characterized by symmetric, proximal muscle weakness (shoulders, hips) with elevated muscle enzymes (CK, aldolase, LDH). More common in women, peaks at 30-50 years.
\synonyms
PM (Polymyositis)
...
\medterm{Polyploid} Having more than two complete chromosome sets, a condition common in plants and sometimes seen in human cells or tumors.
...
\medterm{Polyunsaturated Fat} A type of fat usually liquid at room temperature, found in fish, vegetable oils, nuts, and seeds. Some are essential because the body cannot make them, and replacing saturated fats may benefit heart health.
...
\medterm{Positive Feedback} A regulatory mechanism in which an output amplifies the initiating stimulus, producing an accelerating or self-reinforcing response that drives the system away from equilibrium and toward completion of an event.
...
\medterm{Post-Concussion Syndrome} Persistent physical, cognitive, or emotional symptoms after a concussion. Persistent symptoms after concussion: headache, dizziness, cognitive difficulties, sleep disturbance, mood changes. Management: symptom-directed, gradual return to activity.
...
\medterm{Posterior Keyhole Foraminotomy} A minimally invasive operation that enlarges a spinal nerve opening to relieve compression. A minimally invasive back-of-spine operation enlarging an opening for a spinal nerve to relieve pressure and pain.
...
\medterm{Postural Drainage} Positioning the body so gravity helps move respiratory secretions toward the larger airways for clearance. Positioning a person so gravity assists drainage of secretions from selected parts of the lungs.
...
\medterm{Potentiometry} A laboratory method that measures electrical potential between electrodes to determine the concentration of an ion, such as sodium, potassium, or hydrogen, in a solution or body sample.
...
\medterm{Pre-Cancerous} Describing abnormal cells likely to become cancer but not yet invasive; monitoring or removal may prevent progression.
...
\medterm{Pregnancy Test} A urine or blood test detecting hCG, a hormone produced after implantation to identify pregnancy.
...
\medterm{Preload Reduction} Lowering the amount of blood returning to the heart to reduce cardiac workload. Treatment that decreases blood returning to the heart, reducing filling pressure and workload, especially in heart failure.
...
\medterm{Preparing For Surgery When You Have Diabetes} Planning surgery with the diabetes team to keep blood sugar safe before, during, and after the operation. The plan may adjust food, insulin, or other medicines and includes monitoring for low sugar, high sugar, infection, and delayed healing.
...
\medterm{Prepuce} The fold of skin covering the glans penis; it is also called the foreskin. The fold of skin covering the glans penis or clitoris; penile prepuce is the foreskin.
...
\medterm{Primary Metabolism} The essential biochemical processes by which cells produce energy, synthesize molecules, and maintain their functions.
...
\medterm{Procedure} A planned medical or surgical action performed for diagnosis, treatment, prevention, or palliation. A planned medical or surgical action done to diagnose, treat, prevent, or relieve a health problem.
...
\medterm{Proclivity} A tendency or predisposition toward a particular behavior, response, disease, or outcome. A proclivity may reflect inherited traits, learning, environment, medical conditions, or repeated exposure and does not guarantee a result.
...
\medterm{Proctoclysis} An obsolete method of giving fluid or medicine through the rectum. It was once used when other routes were unavailable, but modern treatment generally uses safer, more reliable oral, intravenous, or tube-based methods.
...
\medterm{Proctoscopy} Proctoscopy is examination of the anal canal and rectum with a proctoscope to evaluate bleeding, pain, lesions, inflammation, or masses. Examination of the anal canal and rectum with a proctoscope.
...
\medterm{Product Liability} Legal responsibility of a maker or seller when a defective or unsafe product causes injury, illness, or damage.
...
\medterm{Professional} Relating to a trained occupation or the behavior expected from a qualified practitioner. In healthcare, professional conduct includes competence, honesty, privacy, respectful communication, ethical decisions, and responsibility for patient safety.
...
\medterm{Progeria} A rare inherited condition causing features of accelerated aging during childhood. Children may develop poor growth, hair loss, stiff joints, thin skin, and heart or blood-vessel disease while intelligence is usually preserved.
...
\medterm{Program} A planned set of related activities or services designed to achieve a health goal. Examples include screening, vaccination, education, treatment, research, prevention, rehabilitation, and support programs delivered to defined groups.
...
\medterm{Prolindac} Prolindac is an experimental prodrug designed to release an active cancer medicine inside tumors. It has been studied to improve targeted treatment, but its safety, effectiveness, and approved uses remain under investigation.
...
\medterm{Pronation} Rotation of the forearm so that the palm faces posteriorly in anatomical position, or downward when the elbow is flexed. The radius crosses over the ulna.
...
\medterm{Pronephros} The earliest embryonic kidney structure, nonfunctional in humans and later largely replaced as development continues.
...
\medterm{Prostate Brachytherapy} Radiation treatment in which radioactive sources are placed inside or near the prostate to destroy cancer cells. It is suitable for selected prostate cancers and may cause urinary irritation, bowel symptoms, erectile difficulty, or temporary radiation exposure precautions.
...
\medterm{Prostatitis} Inflammation or infection of the prostate gland that may cause pelvic pain, painful urination, difficulty passing urine, sexual pain, fever, or feeling unwell. Treatment depends on whether bacteria or another cause is responsible.
...
\medterm{Prostrate} Lying flat or exhausted and unable to stand or move normally. This word is different from prostate, the gland below the bladder in many people with male reproductive anatomy.
...
\medterm{Protective Factor} A characteristic or behavior that lowers the chance of disease or harm. Examples include vaccination, physical activity, protective equipment, healthy nutrition, safe environments, and effective control of chronic conditions.
...
\medterm{Proximate Cause} A legally recognized cause that directly contributes to an injury or outcome. Determining it requires considering the facts, foreseeability, other contributing events, and applicable law rather than medical evidence alone.
...
\medterm{Pscyhiatry} A misspelling of psychiatry, the medical field concerned with mental health and mental disorders. The correct spelling is psychiatry; psychiatrists assess symptoms and may provide talking treatments, medicines, or other care.
...
\medterm{PSMA} A protein found in high amounts on many prostate cancer cells and some normal tissues. It can be targeted for imaging or radiation treatment, but results and side effects depend on the specific therapy.
...
\medterm{Psoriasis} A long-lasting skin condition in which an overactive immune system makes skin cells grow too quickly. It causes well-defined red or darker patches with scale and may also affect the nails or joints; treatment reduces symptoms and inflammation.
...
\medterm{Psychedelic} Causing changes in perception, thoughts, emotions, and awareness, as some hallucinogenic drugs do. Effects can include unusual sights or sounds, fear, confusion, or unsafe behavior; research uses require controlled settings and medical supervision.
...
\medterm{Psychotic} Describing a loss of contact with reality. A person may have fixed false beliefs, hear or see things others do not, speak in a confused way, or behave in a very disorganized or unusually still manner. Psychosis can occur with schizophrenia, severe mood disorders, drugs, medicines, delirium, brain disease, or other medical problems. Urgent assessment is needed when safety, self-care, or basic functioning is affected.
...
\medterm{Puberty} Developmental period during which sexual maturation and reproductive capability are attained. A stage of development when hormonal changes cause physical sexual maturation and the ability to reproduce.
...
\medterm{Public Health Research Bias} A consistent error in a public-health study that shifts results away from the truth. It may arise from who is selected, how information is measured, missing data, or unrecognized differences between groups.
...
\medterm{Pulex Irritans} The human flea, an insect that feeds on blood and causes itchy bites. It usually lives on people or in their surroundings and can rarely carry infections; control requires treating the person, clothing, bedding, and environment when necessary.
...
\medterm{Pulmonary Stenosis} A right ventricular outflow tract obstruction at the valvular, subvalvular, or supravalvular level. Valvular pulmonary stenosis (most common) is often congenital, frequently associated with Noonan syndrome.
...
\medterm{Pulmonary Thromboendarterectomy} Major surgery to remove old, organized blood clots and scar tissue from the lung arteries in selected people with long-term clot-related high blood pressure in the lungs. It can greatly improve or cure the condition, but requires specialist assessment and carries serious risks such as bleeding, stroke, or breathing failure.
...
\medterm{Pulsus} A Latin word meaning pulse, used in names describing unusual pulse patterns. Such patterns may reflect changes in heart rhythm, pumping strength, blood-vessel resistance, breathing, or circulation.
...
\medterm{Purine Nucleotides} Nucleotides containing purine bases, including ATP, GTP, and their metabolic precursors and products. Molecules containing purine bases that help store energy, carry signals, and build genetic material in cells.
...
\medterm{Putrid Throat} An older nonspecific term for a foul-smelling or ulcerated throat infection; modern evaluation should identify the cause.
...
\medterm{Pyoderma} A bacterial skin infection producing pus-filled lesions, crusts, ulcers, or deeper inflammation, commonly caused by Staphylococcus or Streptococcus species. A bacterial skin infection producing pus, crusts, erosions, or ulcers.
...
\medterm{Pyridoxine} One form of vitamin B6, a vitamin needed for processing food, making red blood cells, and supporting nerves and the immune system. It is found in many foods; deficiency can cause anemia or nerve problems, while excessive supplements can damage nerves.
...
\medterm{Pyrosequencing} A DNA-sequencing method that detects light released when a nucleotide is added to a growing DNA strand. It can identify selected genetic variants or microbial sequences but has technical limits.
...
\medterm{Pyruvate} The three-carbon alpha-keto acid produced at the end of glycolysis from phosphoenolpyruvate by pyruvate kinase.
