...
\medterm{Fertility Window Identification} Methods utilized to determine the optimal periconceptional period during a woman's menstrual cycle (the 5 days preceding ovulation and the day of ovulation), based on basal body temperature charting, cervical mucus consistency, and urinary luteinizing hormone (LH) surge kits.
...
\medterm{ICU Psychosis} Alternate name; see \textit{ICU Psychosis}.
...
\medterm{Obstructive Jaundice} Jaundice caused by obstruction of bile flow after bilirubin has been processed by the liver, commonly from gallstones, strictures, or tumours.

\synonyms
Cholestatic Jaundice; Surgical Jaundice
...
\medterm{Peripartum Cardiomyopathy} A dilated cardiomyopathy causing heart failure toward
