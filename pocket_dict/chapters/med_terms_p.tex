...
\medterm{Pancreatic Diseases} Disorders affecting the pancreas, including inflammation, cysts, tumors, diabetes, and poor digestive-enzyme production. They may cause abdominal pain, vomiting, weight loss, jaundice, abnormal blood sugar, or digestive problems.
...
\medterm{Pancreatic Pseudocyst} Alternate name; see \textit{Pancreatic Cysts}.
...
\medterm{Pancreatitis} Alternate name; see \textit{Pancreatitis}.
...
\medterm{Pap Smear} A screening test that collects cells from the cervix and examines them for abnormal changes. It can detect precancerous cells and cancer early, allowing treatment before serious disease develops.
...
\medterm{Paresthesia} An abnormal sensation such as tingling, prickling, burning, or numbness. Temporary pressure on a nerve is common, but persistent or spreading symptoms may indicate nerve, metabolic, vascular, or spinal disease.
...
\medterm{Parkinson's Disease} Alternate name; see \textit{Parkinson's Disease}.
...
\medterm{Paroxysmal Nocturnal Hemoglobinuria} Alternate name; see \textit{Paroxysmal Nocturnal Hemoglobinuria PNH}.
...
\medterm{Pelvic Inflammatory Disease} Infection and inflammation of the upper female reproductive organs, often caused by sexually transmitted bacteria. Untreated PID can cause chronic pelvic pain, infertility, or ectopic pregnancy.
...
\medterm{Penile Erection} Penile rigidity produced by increased arterial inflow and reduced venous outflow after sexual or reflex stimulation; persistent difficulty is erectile dysfunction.
...
\medterm{Penile Intraepithelial Neoplasia} Abnormal precancerous cells in the surface lining of the penis. It may appear as a persistent red, white, or thickened patch and can progress to invasive cancer if untreated.
...
\medterm{Pericarditis} Alternate name; see \textit{Pericarditis}.
...
\medterm{Periodontitis} Alternate name; see \textit{Periodontitis}.
...
\medterm{Periodontitis} Alternate name; see \textit{Gum Disease}.
...
\medterm{Pes Planus} Alternate name; see \textit{Flatfeet}.
...
\medterm{Pharyngitis} Alternate name; see \textit{Sore Throat (Pharyngitis)}.
...
\medterm{Piles} Alternate term; see \textit{Hemorrhoids}.

\medterm{Piles} Alternate spelling; see \textit{Hemorrhoids}.
...
\medterm{Pilonidal Cyst} Alternate name; see \textit{Pilonidal Cyst}.
...
\medterm{Piriformis Syndrome} Alternate name; see \textit{Piriformis Syndrome}.
...
\medterm{Pityriasis Rosea} Alternate name; see \textit{Pityriasis Rosea}.
...
\medterm{Pleural Effusion} Alternate name; see \textit{Fluid In the Chest or On Lung}.
...
\medterm{Pleurisy} Alternate name; see \textit{Pleurisy}.
...
\medterm{Polycythemia} Alternate name; see \textit{High Red Blood Cell Count}.
...
\medterm{Polyphagia} An unusually strong or excessive appetite. It may occur with diabetes, an overactive thyroid, certain medicines, genetic disorders, or some eating and mental health conditions.
...
\medterm{Polysomnography} An overnight recording of sleep, breathing, body movement, heart rhythm, and blood oxygen. It helps diagnose sleep apnea and other sleep disorders by showing how breathing and body functions change during sleep.
...
\medterm{Posttraumatic Stress Disorder} Alternate name; see \textit{Post-Traumatic Stress Disorder}.

\synonyms
PTSD; Traumatic Neurosis

\medterm{Post-Traumatic Stress Disorder} Alternate name; see \textit{Post-Traumatic Stress Disorder}.
...
\medterm{Premature Ovarian Insufficiency} Alternate name; see \textit{Medical Procedural Causes}.
...
\medterm{Premature Ventricular Contractions} Early extra heartbeats originating in the heart's ventricles, often felt as fluttering, skipped beats, or pounding and frequently benign.

\synonyms
Ventricular Extrasystoles; Ventricular Premature Beats; VPCs
...
\medterm{Presbycusis} Age-related, usually gradual sensorineural hearing loss, particularly affecting the ability to hear high-frequency sounds and understand speech in noise.
...
\medterm{Preterm Labor} Labour that begins before 37 completed weeks of pregnancy and may result in preterm birth.
\synonyms
...
\medterm{Priapism} Alternate name; see \textit{Priapism (Penis Disorder)}.
...
\medterm{Priapism} Alternate name; see \textit{Penis Disorder}.
...
\medterm{Prolactinoma} Alternate name; see \textit{Prolactinoma}.
...
\medterm{Prostate Cancer} Alternate name; see \textit{Prostate Cancer}.
...
\medterm{Proteinuria} An abnormal amount of protein in the urine, which may be temporary or indicate kidney disease, diabetes, high blood pressure, infection, or another condition.
...
\medterm{Pruritus} Alternate name; see \textit{Itch}.
...
\medterm{Pubic Lice} Infestation of coarse body hair by lice, usually causing intense itching and requiring treatment and contact precautions.
...
\medterm{Pyridoxine} Alternate name; see \textit{Pyridoxine}.
...
\medterm{Uterine Prolapse} Alternate name; see \textit{Uterine prolapse}.
