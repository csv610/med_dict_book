...
\medterm{Nail-Fold Capillaroscopy} A non-invasive in vivo microvascular diagnostic imaging technique used to examine the periungual nailfold capillary loops under magnification, essential for distinguishing primary Raynaud phenomenon from secondary systemic sclerosis, dermatomyositis, or mixed connective tissue disease.
\synonyms
...
\medterm{Nystagmus Retractorius} A pathological ocular motility sign characterized by rhythmic, irregular retraction of the eyeballs backward into the orbit accompanied by convergence movements on attempted upward gaze, pathognomonic for dorsal midbrain syndrome (Parinaud syndrome / pineal region lesions).
\synonyms
