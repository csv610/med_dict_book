...
\medterm{Niacin (Nicotinic Acid, Vitamin B3)} Alternate index label; see \textit{Niacin}.

\medterm{Niacin (Vitamin B3)} Alternate index label; see \textit{Niacin}.
...
\medterm{Nicotinamide} Alternate index label; see \textit{Niacinamide}.
