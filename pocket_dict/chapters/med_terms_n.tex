...
\medterm{N-Acetylglutamate Synthetase Deficiency} An inherited urea-cycle disorder in which deficient N-acetylglutamate synthetase fails to activate carbamoyl phosphate synthetase I. Ammonia can accumulate and cause vomiting, sleepiness, confusion, seizures, coma, or developmental injury.
...
\medterm{Naegeli-Franceschetti-Jadassohn Syndrome} A rare inherited ectodermal disorder causing reticulate skin pigmentation, reduced sweating, abnormal teeth or nails, and sometimes loss of fingerprints. Heat intolerance and dental problems may be important; genetic and multidisciplinary care is useful.
...
\medterm{Nail Bed Injury} Trauma to the tissue beneath a nail that may cause bleeding under the nail, laceration, nail separation, fracture of the fingertip, or permanent nail deformity. Assessment is important when the nail is badly disrupted or the fingertip is crushed.
...
\medterm{Nail Surgery} A procedure on the nail plate, nail bed, nail fold, or matrix to treat ingrown nails, tumors, infection, trauma, or painful deformity. Risks include bleeding, infection, scarring, altered nail growth, and recurrence.
...
\medterm{Nasal Foreign Bodies} Objects lodged in a nasal passage, most often in children. Unilateral obstruction, foul-smelling discharge, bleeding, pain, or difficulty breathing may occur; button batteries and paired magnets require urgent removal.

\medterm{Nasal Fracture} A break in one or more bones or cartilaginous structures of the nose, usually caused by facial trauma. Pain, swelling, bruising, deformity, bleeding, and nasal obstruction may occur; a septal hematoma requires prompt treatment.
...
\medterm{Nasopharyngeal Cancer} Cancer arising in the upper throat behind the nose, most often a carcinoma associated with Epstein-Barr virus in endemic regions. Nasal obstruction, nosebleeds, hearing loss, neck nodes, or cranial-nerve symptoms may occur; endoscopy, biopsy, and imaging establish extent.
...
\medterm{Navicular Fracture} A break in the navicular bone of the foot, caused by acute trauma or repetitive loading. Midfoot pain, swelling, and tenderness over the navicular may occur, and some fractures are difficult to detect without advanced imaging.
...
\medterm{Nerve Fiber} The long, thread-like part of a nerve cell that carries signals. Most nerve fibers are axons, sometimes covered by a fatty insulating layer called myelin.
...
\medterm{Nerve Impulse} An electrical signal that travels along a nerve cell or nerve fiber to carry information.
...
\medterm{Nerve Plexus} A network where nerves join and branch to supply a body region. The brachial plexus, for example, supplies much of the arm.

\medterm{Nerve Root} The beginning part of a spinal nerve where it connects with the spinal cord. Sensory and motor roots carry signals into and out of the cord.
...
\medterm{Neural Pathway} A connected route of nerve cells and nerve fibers that carries signals between different parts of the nervous system.
...
\medterm{Neurocutaneous Syndromes Pathology} Pathologic features of inherited disorders affecting the skin, nervous system, eyes, and sometimes other organs. Findings vary by syndrome and may include hamartomas, vascular malformations, neural tumors, or characteristic pigmentary lesions.
...
\medterm{Neurogenesis} The formation of new nerve cells. It happens mainly before birth but can continue in limited areas of the adult brain.
...
\medterm{Neuroleptic Agent Toxicity} Overdose or adverse effects from an antipsychotic or other dopamine-blocking agent, causing sedation, hypotension, anticholinergic effects, seizures, QT prolongation, or other dysrhythmias. Neuroleptic malignant syndrome is a distinct delayed reaction with hyperthermia and rigidity; ECG, airway, temperature, and neurologic monitoring guide supportive treatment.
...
\medterm{Nevi of Ota and Ito} Benign dermal melanocytic nevi causing blue-gray pigmentation around the eye and forehead in nevus of Ota or over the shoulder and upper back in nevus of Ito. They may persist for life; ocular examination and monitoring of changing lesions are appropriate.
...
\medterm{Nevus Araneus (Spider Nevus)} A small central red vessel with radiating branches that blanch with pressure and refill from the center. It is common in children, pregnancy, and liver disease; numerous or new lesions may prompt assessment for an underlying condition.
...
\medterm{NF2-Related Schwannomatosis} A genetic tumor-predisposition disorder, usually involving pathogenic variants in NF2, characterized by schwannomas, especially bilateral vestibular schwannomas, with possible hearing loss, tinnitus, balance problems, meningiomas, or other nerve tumors.
...
\medterm{Nipple-Areola Complex} The nipple together with the darker skin around it, called the areola. It contains ducts, smooth muscle, glands, and sensory nerves.
...
\medterm{Nodular Localized Cutaneous Amyloidosis} A localized cutaneous amyloidosis presenting as one or more firm, waxy, skin-colored or yellow-brown nodules. It is usually confined to the skin, but examination may be needed to distinguish it from systemic amyloidosis or other nodular disorders.
...
\medterm{Non-Alcoholic Steatohepatitis} An aggressive, progressive form of metabolic dysfunction-associated steatotic liver disease (MASLD), now called metabolic dysfunction-associated steatohepatitis (MASH), characterized by liver fat with inflammation and cell injury, with or without scarring. It can progress to cirrhosis and liver cancer.
\synonyms
NASH; Metabolic Dysfunction-Associated Steatohepatitis (MASH)

\medterm{Nonalcoholic Steatohepatitis Pathology} Steatotic liver disease with hepatocyte ballooning, lobular inflammation, and variable perisinusoidal or portal fibrosis, usually in the absence of a history sufficient to explain the injury by alcohol alone. The modern term MASH is also used.
...
\medterm{Nonarticular Rheumatism/Regional Pain Syndrome} A broad clinical category of pain arising outside the joints, including disorders of muscles, tendons, bursae, fascia, nerves, or other regional soft tissues. The cause may be overuse, injury, inflammation, nerve dysfunction, or altered pain processing.
...
\medterm{Noncandidal Fungal Infections of the Mouth} Fungal infections of the oral cavity caused by organisms other than Candida, including selected dermatophytes, molds, and endemic fungi. They may produce plaques, ulcers, swelling, or deep tissue disease and often require culture, biopsy, or systemic treatment.
...
\medterm{Nongenital Warts} Common benign skin growths caused by cutaneous human papillomaviruses, usually appearing as rough papules on the hands, fingers, elbows, or knees; plantar warts affect the soles. They spread by direct contact or self-inoculation, may persist for months or years, and are distinct from anogenital warts.
...
\medterm{Nonseminomatous Testicular Tumors} Testicular germ-cell tumors containing or resembling embryonal carcinoma, yolk-sac tumor, choriocarcinoma, teratoma, or mixed components. They may produce elevated AFP or hCG and require staging with tumor markers, imaging, and examination of the contralateral testis.
...
\medterm{Nonsteroidal Anti-inflammatory Drug (NSAID) Toxicity} Overdose causing nausea, vomiting, abdominal pain, gastrointestinal bleeding, tinnitus, drowsiness, acute kidney injury, metabolic acidosis, seizures, or coma in severe cases. Assess renal function, acid-base status, and coingestants; treatment is mainly supportive, with activated charcoal considered soon after a potentially serious ingestion.
...
\medterm{Nontuberculous Mycobacterial (NTM) Diseases} Infections caused by environmental mycobacteria other than the tuberculosis complex and M. leprae. They may affect the lungs, skin, lymph nodes, or multiple organs, particularly in people with structural lung disease or impaired immunity.
...
\medterm{Normal and Abnormal Puerperium} The puerperium is the weeks after birth while the uterus and other body systems recover. Normal findings include lochia, uterine involution, breast changes, fatigue, and emotional fluctuation; heavy bleeding, fever, severe pain, headache, breathlessness, or profound mood change may signal a complication.
...
\medterm{Normal Labor and Delivery} Spontaneous labor with progressive cervical dilation, descent and birth of the fetus, delivery of the placenta, and stable maternal and newborn adaptation. Monitoring remains important because labor can become prolonged or complicated by fetal distress, malposition, bleeding, or infection.
...
\medterm{Notalgia Paresthetica} A localized neuropathic itch or burning sensation, usually between or just below the shoulder blades, caused by irritation or entrapment of thoracic sensory nerves. Scratching may produce a persistent darkened patch; treatment focuses on reducing itch and addressing contributing spine or nerve disease when present.
...
\medterm{Novel Biomarkers of Kidney Function} Emerging blood, urine, or tissue measurements intended to detect kidney injury or altered filtration earlier or more specifically than serum creatinine alone. Examples include selected tubular-injury proteins, but clinical usefulness depends on validation, timing, and the patient’s context.
...
\medterm{Nursing Home Acquired Pneumonia} Pneumonia in a nursing-home or long-term-care resident, often associated with frailty, swallowing impairment, immobility, chronic disease, or viral exposure. Evaluation should consider severity, aspiration, goals of care, and recent healthcare or antibiotic exposure rather than assuming resistant infection.
...
\medterm{Nail-Biting} Repetitive biting of the fingernails or surrounding skin, often associated with stress, habit, or a body-focused repetitive behavior. It can damage the nail, skin, teeth, or jaw and may introduce infection.

\medterm{Narcoleptic Syndrome} Alternate name for narcolepsy, a neurologic sleep disorder causing excessive daytime sleepiness and, in some people, cataplexy, sleep paralysis, or vivid hallucinations; see \textit{Narcolepsy}.

\medterm{Nasal Septal Perforation Repair} A procedure to close or reconstruct a hole in the nasal septum, using local tissue, grafts, or other techniques when symptoms or progressive damage justify repair.

\medterm{Naturopathic Medicine} A system of complementary or alternative health practices that may use diet, supplements, herbs, and other treatments. Products can interact with medicines or cause harm, and naturopathic care should not replace proven treatment for serious disease.

\medterm{Navicular Fracture of the Wrist} A fracture of the wrist navicular, more commonly called the scaphoid. It may cause pain in the anatomic snuffbox after a fall and can heal poorly because part of the bone has limited blood supply.

\medterm{NDI} Abbreviation for nephrogenic diabetes insipidus, in which the kidneys do not respond adequately to vasopressin and produce excessive dilute urine; see \textit{Nephrogenic Diabetes Insipidus}.

\medterm{Nearsightedness (Myopia)} Alternate name; see \textit{Nearsightedness}.

\medterm{Necrotizing Fasciitis of the Perineum} Necrotizing soft-tissue infection of the perineum or genital region, commonly called Fournier gangrene. Severe pain, swelling, skin discoloration, fever, or rapid progression requires emergency surgery and antibiotics.

\medterm{Needle Aspiration Biopsy} A biopsy that uses a thin needle to remove cells or fluid from a lump, organ, or lesion for laboratory examination. Results are interpreted with imaging and clinical findings and may require a larger biopsy.

\medterm{Neonatal Listeriosis} Listeria infection acquired before birth or during delivery that can cause sepsis, pneumonia, meningitis, or other serious illness in a newborn; see \textit{Listeriosis}.

\medterm{Nephrocarcinoma} A carcinoma arising in the kidney, usually referring to renal cell carcinoma; see \textit{Renal Cell Carcinoma}.

\medterm{Nephropathy Diabetic} Alternate name; see \textit{Diabetic Nephropathy}.

\medterm{Nicotine Withdrawal} Symptoms occurring after reducing or stopping nicotine, such as irritability, craving, anxiety, low mood, restlessness, poor concentration, increased appetite, and sleep disturbance. Symptoms usually improve with time and can be treated with behavioral and medication support.

\medterm{Night Eating} A pattern of eating after dinner or waking to eat during the night, sometimes with reduced morning appetite; persistent distress or impairment may indicate night eating syndrome or another eating disorder.

\medterm{Nitroglycerin for Chest Pain} Nitroglycerin may relieve angina caused by reduced coronary blood flow, but new, severe, persistent, or unexplained chest pain requires emergency evaluation rather than repeated self-treatment.

\medterm{Noninfectious Uveitis} Inflammation inside the eye not caused by an active infection, often related to autoimmune or inflammatory disease. It can threaten vision and requires prompt ophthalmic assessment.

\medterm{Non-Scarring Epidermolysis Bullosa} An epidermolysis bullosa subtype in which genetic fragility causes blisters or erosions without primary scarring; severity and complications depend on the subtype.

\medterm{Nonthrombocytopenic Idiopathic Purpura} Purpura or easy bruising with a normal platelet count and no identified cause; the evaluation considers vessel fragility, medicines, coagulation disorders, nutritional deficiency, and systemic disease.

\medterm{Nontraditional Medicine} Treatments outside conventional evidence-based medical practice, including some complementary, alternative, or traditional systems. Safety and effectiveness vary, and interactions or delayed diagnosis are possible.

\medterm{Normal Menstrual Cycle} The recurring hormonal and uterine changes that usually produce menstrual bleeding at a predictable interval; cycle length, flow, and symptoms vary, and persistent changes require evaluation.

\medterm{Noroviruses} A group of highly contagious viruses that cause acute gastroenteritis with vomiting, diarrhea, cramps, and dehydration; see \textit{Norovirus}.

\medterm{Norrbottnian Gaucher Disease} A rare northern-European genetic form of Gaucher disease, usually a non-neuronopathic type caused by inherited glucocerebrosidase deficiency; see \textit{Gaucher Disease}.

\medterm{NPS} Abbreviation for nail-patella syndrome, an inherited disorder affecting nails, kneecaps, elbows, pelvis, eyes, and sometimes kidneys; see \textit{Nail Patella Syndrome}.

\medterm{NS} Abbreviation commonly used for Noonan syndrome, a genetic condition with characteristic facial features, short stature, congenital heart disease, bleeding tendency, or developmental differences; see \textit{Noonan Syndrome}.

\medterm{Nutritional Rickets} Defective bone mineralization in a growing child caused by inadequate vitamin D, calcium, phosphate, or absorption, leading to bone pain, growth problems, or deformity; see \textit{Rickets}.

\medterm{Nystagmus Benign Paroxysmal Positional} Positional nystagmus caused by movement of displaced inner-ear crystals, usually as part of benign paroxysmal positional vertigo; see \textit{Benign Paroxysmal Positional Vertigo}.
