...
\medterm{Diabetic Autonomic Neuropathy} Alternate name; see \textit{Diabetic Neuropathy}.
...
\medterm{Geriatric Nutrition} Nutrition care for older adults, including assessment of food intake, weight change, hydration, swallowing, dental problems, and medicines. Care may address undernutrition, obesity, vitamin deficiencies, dehydration, reduced appetite, or difficulty shopping, cooking, or feeding.
...
\medterm{Necrolytic Acral Erythema} A rare necrolytic cutaneous eruption characterized by well-demarcated, dusky erythematous to violaceous hyperkeratotic plaques and flaccid blisters, predominantly localized over the dorsal aspects of the feet, ankles, and toes. It is considered a pathognomonic cutaneous marker of chronic Hepatitis C Virus (HCV) infection, although it can also be associated with zinc dysregulation and metabolic disturbances. Histopathologically, it exhibits epidermal acanthosis, upper epidermal necrotic keratinocytes, and prominent confluent parakeratosis.
...
\medterm{Nephrolithiasis} Alternate medical name; see \textit{Kidney Stones}.
...
\medterm{Neuralgia, Postherpetic} Alternate name; see \textit{Postherpetic Neuralgia}.

\medterm{Neuralgia, Trigeminal} Alternate name; see \textit{Trigeminal Neuralgia}.
...
\medterm{Neurofibromatosis Type 2} A genetic disorder characterized by tumors involving nerves, especially bilateral vestibular schwannomas, with possible hearing loss, balance problems, and other nerve tumors.
...
\medterm{Neuroma, Acoustic} Alternate name; see \textit{Acoustic Neuroma}.

\medterm{Neuroma, Plantar} Alternate name; see \textit{Morton's Neuroma}.
...
\medterm{Neuropathic Pain} Alternate name; see \textit{Nerve Pain}.
...
\medterm{Neuropathy, Autonomic} Alternate name; see \textit{Autonomic Neuropathy}.

\medterm{Neuropathy, Diabetic} Alternate name; see \textit{Diabetic Neuropathy}.

\medterm{Neuropathy, Peripheral} Alternate name; see \textit{Peripheral Neuropathy}.
...
\medterm{Nevus, Congenital} Alternate name; see \textit{Congenital Nevus}.
...
\medterm{Newborn Jaundice} Alternate name; see \textit{Neonatal Jaundice}.
...
\medterm{Non-Celiac Gluten Sensitivity} Symptoms that improve after avoiding gluten or wheat even though testing does not show celiac disease or wheat allergy. Diagnosis requires careful assessment because other foods and illnesses can cause similar symptoms.
...
\medterm{Nonsteroidal Anti-Inflammatory Drugs} Medicines that reduce substances causing pain, fever, and inflammation. Examples include ibuprofen and naproxen; they can also cause stomach bleeding, kidney injury, fluid retention, heart problems, or allergic reactions.
...
\medterm{Non-Tuberculous Mycobacteria} Alternate spelling; see \textit{Nontuberculous Mycobacteria}.
...
\medterm{Peripheral Nervous System} The peripheral nervous system includes nerves and ganglia outside the brain and spinal cord and carries sensory, motor, and autonomic signals.

\medterm{Peripheral Neuropathy} Damage to nerves outside the brain and spinal cord. It may cause numbness, tingling, burning pain, weakness, balance problems, or changes in sweating, digestion, blood pressure, or bladder function. Diabetes, alcohol, vitamin deficiencies, medicines, and inherited disorders are common causes.

\synonyms
Peripheral Nerve Damage; Polyneuropathy; Neuritis

\medterm{Sodium} The chemical symbol for sodium, a mineral that helps control fluid balance, blood pressure, nerve signals, and muscle contraction. Blood sodium that is too low or too high can cause headache, confusion, seizures, or other serious problems. Results are interpreted with fluid status and other tests.

\medterm{Thymic Neoplasm} Alternate name; see \textit{Thymoma}.

\medterm{Thyroid Nodule} Alternate singular form; see \textit{Thyroid Nodules}.

\medterm{Trigeminal Nerve} The fifth cranial nerve, which carries feeling from the face, teeth, mouth, and part of the head and controls the main muscles used for chewing. Irritation can cause severe electric-shock-like facial pain.
...
\medterm{Vitamin B3} Alternate name; see \textit{Niacin}.
