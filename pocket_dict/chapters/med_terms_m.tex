...
\medterm{Milan System (Salivary Gland Cytopathology)} A six-level system for reporting results from a needle sample of a salivary-gland lump. Results range from an insufficient sample or noncancerous finding to a finding suspicious for or showing cancer. The system helps estimate cancer risk and guide further care.
