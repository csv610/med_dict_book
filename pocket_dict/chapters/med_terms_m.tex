...
\medterm{Macrocytic Anemia} Anemia in which red blood cells are larger than usual. Common causes include vitamin B12 or folate deficiency, alcohol use, liver disease, underactive thyroid, some bone-marrow disorders, and recovery from blood loss. It may cause tiredness, pale skin, shortness of breath, or tingling.
\synonyms{Macrocytosis; Large-Cell Anemia; High-MCV Anemia}

\medterm{Macrocytosis} An abnormal enlargement of mature circulating red blood cells defined by a mean corpuscular volume (MCV) exceeding 100 fL, commonly resulting from vitamin B12 or folate deficiency (megaloblastic anemia), alcoholism, chronic liver disease, reticulocytosis, or myelodysplastic syndrome.
\synonyms
Macrocytic Erythrocytes; Elevated MCV
...
\medterm{Macula Densa} A specialized plaque of densely packed columnar epithelial cells located in the wall of the distal convoluted tubule adjacent to the afferent and efferent arterioles of its originating glomerulus; senses luminal sodium chloride concentrations and modulates renin secretion via tubuloglomerular feedback.
...
\medterm{Macular Amyloidosis} A localized cutaneous amyloidosis characterized by mottled or rippled brown-gray patches, usually on the upper back. It is often associated with chronic friction or rubbing and is distinct from systemic amyloidosis.
...
\medterm{Macular Sparing} Retention of central visual acuity and central visual field representation in the presence of an otherwise complete homonymous hemianopia, classically resulting from occlusion of the posterior cerebral artery sparing the occipital pole due to collateral blood flow from the middle cerebral artery or bilateral cortical macular representation.
...
\medterm{Maddrey Discriminant Function} A validated mathematical prognostic scoring index used in hepatology to assess the severity of acute alcoholic hepatitis and predict short-term mortality. Calculated as $4.6 \times (\text{patient PT} - \text{control PT in seconds}) + \text{serum total bilirubin in mg/dL}$; a score of 32 or greater defines severe acute alcoholic hepatitis carrying an approximate 30- to 50-percent 30-day mortality, identifying patients who benefit significantly from corticosteroid therapy.

\synonyms
MDF; Maddrey DF Score

\medterm{Madelung Deformity} A developmental or post-traumatic wrist deformity resulting from premature physeal arrest of the medial and volar aspects of the distal radius, leading to shortening and volar bowing of the radius with prominent dorsal subluxation of the ulnar head.
\synonyms
Madelung Wrist; Radial Dyschondrosteosis Deformity
...
\medterm{Magnetic Resonance Urography} An MRI scan of the kidneys, ureters, and bladder. It shows the urinary tract without X-rays and may be performed with or without contrast material.
...
\medterm{Maisonneuve Fracture} A spiral fracture of the proximal third of the fibula associated with disruption of the distal tibiofibular syndesmosis, interosseous membrane, and either an avulsion fracture of the medial malleolus or rupture of the deep deltoid ligament of the ankle.
...
\medterm{Majocchi Granuloma} A deep follicular infection caused by dermatophyte fungi, producing inflamed papules, pustules, or nodules and sometimes abscesses. It often follows shaving or topical steroid use and requires systemic antifungal treatment rather than topical therapy alone.
...
\medterm{Major Depressive Episode} A period of at least two weeks with depressed mood or loss of interest or pleasure plus additional emotional, cognitive, physical, or behavioral symptoms that cause significant distress or impairment. It may occur in major depressive disorder, bipolar disorder, or other conditions and must be distinguished from symptoms caused by substances or another medical condition.
...
\medterm{Malaria} A serious infection caused by \textit{Plasmodium} parasites and spread by infected \textit{Anopheles} mosquitoes. The parasites first multiply in the liver and then enter red blood cells, causing fever, chills, sweating, headache, and weakness. Severe malaria can cause seizures, coma, severe anemia, kidney failure, or breathing problems. Some species can remain in the liver and cause later recurrences.
...
\medterm{Malassezia (Pityrosporum) Folliculitis} An overgrowth of Malassezia yeast in hair follicles causing many small, itchy, fairly uniform papules and pustules, usually on the chest, back, shoulders, or forehead. Heat, sweating, antibiotics, oils, and immune suppression can contribute.
...
\medterm{Malathion Poisoning} Poisoning caused by the insecticide malathion. It can produce sweating, excess saliva, vomiting, diarrhea, wheezing, slow heartbeat, muscle twitching, weakness, seizures, or breathing failure.
...
\medterm{Male Breast Cancer} Cancer developing in breast tissue in a man. It is uncommon and may cause a new lump, nipple discharge, skin change, or nipple retraction.
...
\medterm{Male Genital Sores} Ulcerations, blisters, or skin lesions on the penis, scrotum, or perianal region. Major causes include sexually transmitted infections (such as genital herpes, syphilis, and chancroid), infectious balanitis, inflammatory skin diseases, fixed drug eruptions, trauma, or penile neoplasia.

\synonyms
Male Genital Ulcers; Penile Lesions; Penile Ulcers

\synonyms
Male Genital Ulcers; Penile Ulcerations

\medterm{Male Groin Pain} Pain in the groin or adjacent lower abdomen, hip, or testicle in a male; causes include muscle strain, hernia, infection, urinary stones, or referred pain.
...
\medterm{Male Self-Catheterization} Intermittent insertion and removal of a catheter through the male urethra to drain the bladder when neurologic, obstructive, or other conditions prevent adequate emptying.

\medterm{Male Urethritis} Inflammation of the male urethra, commonly caused by sexually transmitted infection but also by irritation or other infection. Dysuria, urethral discharge, itching, or meatal irritation may occur.
...
\medterm{Malignant Hyperthermia} A rare, life-threatening reaction to certain anesthetic medicines that causes rapidly rising body temperature, severe muscle stiffness, fast heart rate, and dangerous chemical changes. It affects people with certain inherited susceptibilities.
...
\medterm{Malignant Vulvar Lesions} Cancerous or potentially invasive lesions of the vulva, most commonly squamous-cell carcinoma but also melanoma, adenocarcinoma, basal-cell carcinoma, or sarcoma. Persistent, ulcerated, pigmented, bleeding, painful, or changing lesions require examination and biopsy.
...
\medterm{Mallory Bodies} Irregular, ropey, eosinophilic cytoplasmic inclusions within degenerating hepatocytes composed of tangled, ubiquitinated cytokeratin intermediate filaments (cytokeratins 8 and 18), characteristically observed in alcoholic hepatitis, non-alcoholic steatohepatitis (MASH), and Wilson disease.
...
\medterm{Mallory-Weiss Syndrome} Non-transmural, longitudinal mucosal tears localized to the gastroesophageal junction or gastric cardia, typically provoked by severe, forceful retching, vomiting, or coughing, presenting clinically as acute upper gastrointestinal hemorrhage and hematemesis.
\synonyms
Mallory-Weiss Tear; Gastroesophageal Laceration
...
\medterm{Malposition of the Uterus} A uterus tilted or oriented differently from the usual position, such as retroversion or retroflexion. It is often a normal variant, but pain, pressure, infertility, urinary symptoms, or a mass may indicate an underlying condition requiring evaluation.
...
\medterm{Mammary Duct Ectasia} A noncancerous inflammation in which milk ducts beneath the nipple become widened and filled with thick material. It may cause sticky green, brown, or creamy discharge, nipple tenderness, nipple pulling inward, or a lump that can look like breast cancer on examination or imaging.
...
\medterm{Mammillary Bodies} A pair of small, spherical hypothalamic nuclei situated at the posterior termination of the anterior columns of the fornix on the ventral surface of the diencephalon, forming an essential component of the Papez circuit for memory consolidation; severely damaged in Wernicke encephalopathy.
...
\medterm{Mammographic Calcifications} Mineral deposits seen in breast tissue on a mammogram. Large deposits are usually noncancerous, while the shape and arrangement of very small deposits can be linked to early breast cancer or other changes and may lead to further imaging or biopsy.
...
\medterm{Management of Third-Stage Labor} Care from birth of the baby until delivery of the placenta, including monitoring, uterotonic medication when indicated, controlled cord traction by trained clinicians, and assessment for retained placenta or postpartum hemorrhage.
...
\medterm{Manubrium} The broad, upper quadrangular segment of the sternum articulating superiorly with the clavicles (sternoclavicular joints) and first costal cartilages, and joining inferiorly with the sternal body at the sternal angle of Louis (level of T4-T5 intervertebral disc).
...
\medterm{MAOIs} A class of medicines used mainly for depression and some other conditions. They slow the breakdown of certain brain chemical messengers and can have important interactions with foods and other medicines.
...
\medterm{Marasmus} Severe undernutrition caused by prolonged lack of calories and protein. It leads to marked loss of body fat and muscle, poor growth in children, weakness, and increased vulnerability to infection.
...
\medterm{Marcus Gunn Jaw-Winking Phenomenon} An uncommon congenital synkinetic neuro-ophthalmological anomaly characterized by unilateral upper eyelid retraction or elevation occurring synchronously with movements of the lower jaw (such as chewing, sucking, or lateral jaw excursion). Caused by aberrant congenital innervation of the ipsilateral levator palpebrae superioris muscle (cranial nerve III) by motor branches of the trigeminal nerve (cranial nerve $V_3$) supplying the pterygoid muscles.

\synonyms
Jaw-Winking Syndrome; Marcus Gunn Ptosis

\medterm{Marcus Gunn Pupil} A relative afferent pupillary defect (RAPD) detected during the swinging-flashlight test, wherein the affected pupil displays paradoxical dilation (or reduced constriction) when the light source is shifted from the unaffected eye to the abnormal eye, indicating unilateral or asymmetric optic nerve or retinal pathology.
\synonyms
...
\medterm{Marijuana Intoxication} Temporary changes after using cannabis, including impaired attention, memory, coordination, judgment, or perception. Anxiety, panic, drowsiness, vomiting, or psychosis may occur. Severe symptoms or accidental ingestion by a child can be dangerous.

\medterm{Marijuana Substance Use} Marijuana or cannabis can impair attention, memory, coordination, and driving and may cause dependence, anxiety, psychosis, or respiratory harm when smoked.
...
\medterm{Marjolin Ulcer} A rare, aggressive cutaneous squamous cell carcinoma arising within longstanding chronic non-healing wounds, burn scars (cicatrices), chronic venous stasis ulcers, or chronic osteomyelitis sinus tracts.
\synonyms
Scar Carcinoma; Burn Scar Squamous Cell Carcinoma
...
\medterm{Mason Fracture} A clinical and radiographic classification system for fractures of the radial head: Type I is non-displaced; Type II is a displaced partial-head marginal fracture; Type III is a severely comminuted fracture involving the entire head; and Type IV is a radial head fracture associated with elbow dislocation.
\synonyms
Radial Head Fracture; Mason Classification of Radial Head Fracture
...
\medterm{Massive Pulmonary Embolism} A high-risk, life-threatening pulmonary embolism characterized by extensive clot obstruction causing acute right ventricular strain and hemodynamic collapse (systolic blood pressure $< 90\text{ mmHg}$ or obstructive shock). See \textit{Massive Pulmonary Embolus}.

\medterm{Massive Pulmonary Embolus} A severe blockage of the main blood vessels to the lungs by a blood clot. It can suddenly strain or stop the right side of the heart and cause very low blood pressure, severe breathlessness, fainting, bluish skin, or cardiac arrest. Treatment may include clot-dissolving medicine or removal of the clot.
...
\medterm{Mastodynia} Pain or tenderness in one or both breasts, also called mastalgia. It may follow the menstrual cycle or result from injury, infection, medicines, cysts, or other breast conditions; a new persistent lump, skin change, or bloody discharge may indicate another breast problem.
...
\medterm{Maturation Disorders Of Erythropoiesis} Anemia categories caused by ineffective development or maturation of red-cell precursors in the bone marrow. They include disorders of hemoglobin synthesis, such as iron deficiency and thalassemia, and disorders of nuclear maturation, such as vitamin B12 or folate deficiency and myelodysplasia.
...
\medterm{Mayer-Rokitansky-Kuster-Hauser Syndrome} A congenital disorder of female reproductive tract development (Müllerian agenesis) characterized by congenital absence or severe hypoplasia of the uterus and upper two-thirds of the vagina in an individual with a 46,XX karyotype, normal functional ovaries, and normal secondary sexual characteristics, presenting as primary amenorrhea.
\synonyms
...
\medterm{McBurney Point} A specific anatomical surface point situated one-third of the distance along an imaginary line drawn from the right anterior superior iliac spine (ASIS) to the umbilicus, corresponding to the anatomical base of the vermiform appendix and the site of maximal tenderness in acute appendicitis.
\synonyms
McBurney's Point; Appendiceal Surface Landmark
...
\medterm{MDMA Toxicity} Serotonergic and sympathomimetic toxicity from MDMA, with agitation, hyperthermia, diaphoresis, tachycardia, hypertension, jaw clenching, seizures, rhabdomyolysis, and potentially severe hyponatremia from excess water intake. Treatment includes rapid cooling, benzodiazepines, electrolyte assessment, and careful management of complications.
...
\medterm{Meckel Diverticulum} A small pouch present from birth on the lower small intestine, caused by a leftover connection from early development. It often causes no symptoms, but it can bleed, become inflamed, or cause blockage or twisting of the bowel. A Meckel scan may help find it when bleeding is suspected; treatment depends on symptoms and complications.
...
\medterm{Medial Gastrocnemius Strain} Overstretching or tearing of the medial head of the gastrocnemius muscle, often during sudden acceleration or push-off. It causes abrupt calf pain, tenderness, swelling, and pain with walking or ankle movement.

\medterm{Medial Geniculate Nucleus} A specialized thalamic relay nucleus that receives ascending auditory inputs from the inferior colliculus via the brachium of the inferior colliculus and projects auditory radiations to the primary auditory cortex in the superior temporal gyrus (Brodmann areas 41 and 42).

\synonyms
MGN; Medial Geniculate Body

\medterm{Medial Lemniscus} A prominent ascending sensory white matter tract in the brainstem formed by the decussating internal arcuate fibers from the contralateral gracile and cuneate nuclei of the medulla, conveying conscious proprioception, vibration, and discriminative fine touch to the ventral posterolateral (VPL) nucleus of the thalamus.

\medterm{Medial Medullary Syndrome} A brainstem stroke syndrome (Dejerine syndrome) caused by infarction of the anteromedial medulla oblongata (typically due to occlusion of the anterior spinal artery or vertebral artery), characterized by ipsilateral hypoglossal nerve (CN XII) palsy (tongue deviates toward lesion), contralateral hemiparesis sparing the face, and contralateral loss of vibration and proprioception.
\synonyms
Dejerine Anterior Bulbar Syndrome; Inferior Alternating Hemiplegia
...
\medterm{Median Neuropathy} Dysfunction of the median nerve caused by compression, trauma, inflammation, or another lesion. Numbness, tingling, pain, or weakness may affect the thumb, index, middle, and radial half of the ring finger or related muscles.
...
\medterm{Mediastinal Lymphadenopathy} Enlargement of lymph nodes in the mediastinum. It may occur with infection, inflammation, lymphoma, or cancer that has spread from another organ.

\medterm{Mediastinal Lymph Nodes} Lymph nodes in the central chest that filter lymph from the lungs, heart, esophagus, and nearby tissues.

\medterm{Mediastinal Lymphoma} Lymphoma involving lymph nodes or other lymphoid tissue in the mediastinum. It may cause cough, chest pressure, breathlessness, superior vena cava obstruction, or constitutional symptoms; CT, PET, biopsy, and immunophenotyping establish the type and extent.
...
\medterm{Mediastinotomy} A surgical opening into the mediastinum to examine or reach structures in the central chest.
...
\medterm{Medicinal} Relating to a substance or treatment used for the prevention, diagnosis, relief, or treatment of disease.
...
\medterm{Medullary Cavity} The hollow space inside the shaft of a long bone. It contains bone marrow and blood vessels.
...
\medterm{Mees' Lines} True leukonychia characterized by single or multiple paired, non-blanching transverse white bands across the nail plate that migrate distally as the nail grows. Classically associated with acute arsenic or thallium poisoning, Hodgkin lymphoma, and severe systemic illness.
...
\medterm{Meibomian Gland Dysfunction} A chronic, diffuse abnormality of the modified sebaceous tarsal glands of the eyelids, characterized by terminal duct obstruction and qualitative or quantitative alterations in lipid secretion (meibum), representing the leading cause of evaporative dry eye syndrome.
...
\medterm{Meigs Syndrome} The benign clinical triad of an ovarian fibroma (or other benign solid pelvic ovarian tumor), ascites, and pleural effusion (typically right-sided), which resolves completely and permanently following surgical resection of the ovarian neoplasm.
...
\medterm{Meissner Corpuscle} An encapsulated, rapidly adapting mechanoreceptor located in the dermal papillae of glabrous (hairless) skin (fingertips, palms, soles, lips), sensitive to low-frequency vibrations (30 to 50 Hz), light touch, and dynamic skin flutter.

\synonyms
Tactile Corpuscle

\medterm{Meissner Plexus} A network of unmyelinated autonomic nerve fibers and parasympathetic postganglionic neuronal cell bodies located within the submucosa of the gastrointestinal tract, primarily regulating local glandular secretions, mucosal absorption, and submucosal blood flow.
...
\medterm{Melanocytic CNS Tumor} A tumor showing melanocytic differentiation within the CNS or meninges, ranging from benign melanocytoma to malignant melanoma. Evaluation includes imaging, histology, and molecular assessment to determine behavior.
...
\medterm{Melanoma Skin Cancer} Alternate name; see \textit{Melanoma}.
...
\medterm{Melanonychia} Brown, gray, or black pigmentation of a nail plate caused by increased melanin or pigment-producing cells. It may affect several nails from medicines or systemic disease, but a new or changing single-nail band requires assessment for nail-unit melanoma.
...
\medterm{MELD-Na Score} An updated mathematical scoring model derived from the Model for End-Stage Liver Disease (MELD), incorporating serum sodium alongside serum creatinine, total bilirubin, and international normalized ratio (INR). It improves 90-day mortality prediction in patients with decompensated cirrhosis and severe hyponatremia, utilized internationally as the primary objective scoring metric for donor liver transplant allocation.

\synonyms
MELD-Sodium Score; Sodium-Adjusted MELD
...
\medterm{Melkersson-Rosenthal Syndrome} A rare neuromucocutaneous disorder characterized by the classic clinical triad of recurrent orofacial edema (especially granulomatous cheilitis of the lips), relapsing peripheral facial nerve (CN VII) palsy, and a fissured tongue (lingua plicata).
\synonyms
Cheilitis Granulomatosa Triad; Fissured Tongue and Facial Palsy Syndrome
...
\medterm{Membranous Labyrinth} A continuous system of communicating, endolymph-filled epithelial sacs and ducts lodged within the bony labyrinth of the inner ear, comprising the cochlear duct (hearing) and the vestibular apparatus (utricle, saccule, and three semicircular ducts for balance and equilibrium).
...
\medterm{Memory Loss} Reduced ability to recall past information, form new memories, or both. Causes include normal aging, medicines, head injury, seizures, stroke, infection, substance use, neurocognitive disorders, and psychological conditions; sudden memory loss can occur with serious illness.
...
\medterm{Menetrier Disease} A rare hypertrophic gastropathy characterized by massive enlargement and tortuosity of the gastric rugal folds in the fundus and body of the stomach, profound foveolar epithelial hyperplasia with glandular atrophy, mucus hypersecretion, hypochlorhydria, and protein-losing gastropathy leading to hypoalbuminemia and anasarca.
\synonyms
Hypertrophic Protein-Losing Gastropathy; Giant Hypertrophic Gastritis
...
\medterm{Meningioma Pathology} A usually extra-axial tumor showing meningothelial cells in syncytial sheets, whorls, or other patterns, sometimes with psammoma bodies. Histologic grade reflects mitotic activity, invasion, and other atypical or anaplastic features.
...
\medterm{Meningitis} Inflammation of the meninges around the brain and spinal cord, caused by bacteria, viruses, fungi, parasites, medicines, or immune disease. Fever, headache, neck stiffness, photophobia, vomiting, altered mental status, or seizures may occur, but the classic triad is often incomplete. Suspected bacterial meningitis is an emergency requiring blood tests and cerebrospinal-fluid evaluation when safe.
...
\medterm{Meningococcal Disease} A serious infection caused by Neisseria meningitidis that can produce meningitis or rapidly spreading bloodstream infection. Fever, severe headache, stiff neck, confusion, vomiting, or a purple rash may occur.
...
\medterm{Meningococcus} Neisseria meningitidis, a bacterium that can cause meningitis or rapidly spreading bloodstream infection. It spreads through respiratory secretions and may cause fever, headache, rash, shock, or death.
...
\medterm{Menopause and Mood Disorders} Mood symptoms can occur during the menopausal transition because of hormonal fluctuation, sleep disruption, vasomotor symptoms, life stress, or an independent depressive or anxiety disorder. Persistent, severe, or suicidal symptoms require mental-health assessment; treatment is individualized.
...
\medterm{Menthol Poisoning} Poisoning after swallowing, inhaling, or having substantial skin exposure to menthol. It may cause nausea, abdominal pain, dizziness, drowsiness, agitation, seizures, coma, or breathing problems.
...
\medterm{Meprobamate Overdose} Taking too much meprobamate can cause severe drowsiness, confusion, poor coordination, low blood pressure, slowed breathing, coma, or death. Alcohol and other sedatives increase the danger.
...
\medterm{Mercuric Oxide Poisoning} Poisoning from mercuric oxide, an inorganic mercury compound that can irritate or burn tissues and damage the kidneys and nervous system. Swallowing or inhalation can cause severe poisoning.

\medterm{Mercury} A metal used in some industrial and laboratory products. Its chemical symbol is Hg; mmHg denotes millimeters of mercury, a unit of pressure. Exposure can harm the nervous system, kidneys, lungs, or digestive tract, so it must be handled and disposed of safely.
...
\medterm{Mesangial Cell} Specialized contractile pericyte-like cells located in the central stalk (mesangium) of the renal glomerulus between capillary loops, responsible for phagocytosing macromolecules, synthesizing mesangial matrix, and contracting in response to angiotensin II to regulate glomerular capillary filtration surface area.
...
\medterm{Mesenchymal CNS Tumor} A rare tumor arising from connective or supporting tissue in or around the brain or spinal cord rather than from nerve cells. Its behavior is determined by examination of tissue, imaging, and sometimes genetic testing.
...
\medterm{Mesenteric Cyst} A rare, usually noncancerous, fluid-filled sac in the tissue that supports the intestines. Small cysts may cause no symptoms, while larger ones can cause swelling, pain, infection, twisting, or bowel blockage. Imaging helps locate the cyst, and treatment depends on its size, symptoms, and cause.

\synonyms
Mesenteric Lymphangioma; Chylolymphatic Cyst; Enteric Mesenteric Cyst

\medterm{Mesenteric Ischemia} Reduced blood flow to the intestines, caused suddenly by a clot or gradually by narrowed arteries. It can cause severe abdominal pain, bowel injury, infection, or death.
...
\medterm{Mesenteric Lymph Nodes} Lymph nodes in the tissue that supports the intestines. They filter lymph from the bowel and help the immune system respond to infection or other abnormal changes.
...
\medterm{Mesometrium} The portion of the broad ligament of the uterus that extends from the lateral uterus toward the pelvic wall and contains associated vessels, nerves, and connective tissue.
...
\medterm{Metabolic Acidosis} A primary fall in plasma bicarbonate causing acidemia unless respiratory compensation or another process changes the pH. It is classified by anion gap and may result from lactic or ketoacidosis, kidney failure, toxins, or bicarbonate loss from the gastrointestinal tract or kidneys; assessment includes pH, bicarbonate, respiratory compensation, electrolytes, and the cause.

\medterm{Metabolic Alkalosis} A primary increase in plasma bicarbonate causing alkalemia unless respiratory compensation or another process changes the pH. Common causes include vomiting, gastric suction, diuretics, mineralocorticoid excess, and alkali administration; hypokalemia and chloride depletion are frequent, and urine chloride helps distinguish chloride-responsive from chloride-resistant forms.
...
\medterm{Metabolic Bone Disease of Prematurity} Reduced bone mineral density and defective postnatal skeletal mineralization in very-low-birth-weight or extremely preterm infants. Results from inadequate accretion of calcium, phosphorus, and vitamin D typically transferred during the third trimester, exacerbated by prolonged total parenteral nutrition or diuretic therapy.

\synonyms
Osteopenia of Prematurity; Neonatal Rickets; Metabolic Bone Disease in Preterm Infants
...
\medterm{Metabolic Equivalent of Task} A physiological measure expressing the energy cost of physical activities, defined as the ratio of metabolic rate during activity to resting metabolic rate, standardized as the consumption of 3.5 mL of oxygen per kilogram of body weight per minute ($1\text{ MET}$).
...
\medterm{Metacarpophalangeal Joint Dislocation} Displacement of a finger or thumb's metacarpophalangeal joint, usually after trauma or forced hyperextension. Pain, deformity, swelling, and restricted movement occur; associated fractures, tendon injury, or neurovascular damage must be assessed.
...
\medterm{Metastatic Cancer With Unknown Primary Site} Cancer proven to have spread but for which the original primary tumor cannot be identified after appropriate evaluation. Pathology, immunohistochemistry, imaging, and molecular testing may suggest the origin and guide site-directed or empiric treatment.
...
\medterm{Metatarsophalangeal Joint} A joint between a metatarsal bone of the foot and the first bone of a toe. It helps the toes bend and supports walking.
...
\medterm{Methadone Overdose} Taking too much methadone can cause profound sleepiness, pinpoint pupils, slow or stopped breathing, coma, and death. Effects may be delayed or prolonged, and abnormal heart rhythms can occur.
...
\medterm{Methamphetamine Overdose} Taking too much methamphetamine can cause agitation, dangerously high temperature, fast heartbeat, high blood pressure, chest pain, seizures, stroke, abnormal rhythms, or severe confusion. It is a life-threatening poisoning.
...
\medterm{Methamphetamine Toxicity} Severe stimulant toxicity causing agitation, paranoia or psychosis, mydriasis, diaphoresis, tachycardia, hypertension, hyperthermia, seizures, myocardial ischemia, stroke, or rhabdomyolysis. Benzodiazepines, active cooling, ECG monitoring, and treatment of hyperthermia, seizures, ischemia, and complications are central.
...
\medterm{Methanol} A poisonous alcohol whose breakdown products can cause severe acid buildup, blindness, brain injury, or death. Serious poisoning can develop even before symptoms appear.

\medterm{Methanol Poisoning} Poisoning by methanol, a type of alcohol found in some industrial products. Its breakdown can cause severe acid buildup, blindness, brain injury, or death, sometimes before symptoms appear.
...
\medterm{Methylcellulose} A plant-fiber product used as a bulk-forming laxative and as a thickener in medicines and foods. It absorbs water and adds bulk to stool; it can be unsafe when a bowel blockage is present.
...
\medterm{Methylmercury Poisoning} Poisoning caused by methylmercury, usually through contaminated food. It primarily injures the nervous system and may cause numbness, poor coordination, vision or hearing changes, and impaired fetal brain development.
...
\medterm{Metrorrhagia} Uterine bleeding that occurs at unexpected times, including between menstrual periods. Causes include pregnancy, hormonal changes, fibroids, polyps, infection, medicines, and cancer. New, heavy, prolonged, or postmenopausal bleeding can have an underlying medical cause.
...
\medterm{Michaelis-Menten Kinetics} A mathematical model describing the rate of enzyme-catalyzed reactions by relating reaction velocity ($V$) to substrate concentration ($[S]$), defined by the maximal velocity ($V_{max}$) and the Michaelis constant ($K_m$, the substrate concentration at half-maximal velocity).
...
\medterm{Microcytic Anemia} Anemia in which red blood cells are smaller than usual. Common causes include iron deficiency, thalassemia, long-term inflammation, lead exposure, and some bone-marrow disorders. Blood counts and iron tests help find the cause; symptoms may include tiredness, weakness, pale skin, or shortness of breath.
...
\medterm{Microdiscectomy} A spinal operation that removes part of a herniated disc pressing on a nerve, usually in the lower back. It may reduce pain, numbness, or weakness caused by nerve pressure. Possible complications include infection, bleeding, nerve injury, or a return of the disc problem.
...
\medterm{Microvilli} Tiny finger-like projections on the surface of cells. In the small intestine, they increase the area available for absorbing nutrients.
...
\medterm{Middle Ear Implant} An implanted hearing device that electrically or mechanically stimulates middle-ear structures to improve sound transmission in selected hearing loss. It differs from a cochlear implant, which directly stimulates the inner-ear auditory nerve pathway.

\medterm{Middle Ear Infection} Infection or inflammation in the space behind the eardrum. It often follows a cold and may cause ear pain, fever, temporary hearing loss, fluid behind the eardrum, or irritability in children.
...
\medterm{Middle Mediastinum} The central part of the lower mediastinum that contains the heart, pericardium, roots of the great vessels, and phrenic nerves.
...
\medterm{Miliaria Profunda} Alternate name; see \textit{Heat Rash}.
...
\medterm{Milkman Syndrome} Multiple small weak areas or incomplete breaks in bones, also called Looser zones. They can occur in severe osteomalacia or rickets and may cause bone pain, weakness, or fractures.
\synonyms
Looser-Milkman Syndrome; Pseudofracture Syndrome
...
\medterm{Millard-Gubler Syndrome} A ventral pontine stroke syndrome caused by an ischemic or hemorrhagic lesion in the lower pontine tegmentum, characterized by ipsilateral abducens nerve (CN VI) palsy, ipsilateral peripheral facial nerve (CN VII) palsy, and contralateral hemiparesis of the upper and lower extremities.
\synonyms
Ventral Pontine Syndrome; Facial Abducens Hemiplegia Syndrome

\medterm{Miller Fisher Syndrome} Alternate name; see \textit{Fisher Syndrome}.
...
\medterm{Mineral Oil Overdose} Swallowing a large amount of mineral oil is dangerous mainly because it can enter the lungs during vomiting or reflux and cause lipoid pneumonia.
...
\medterm{Mineral Spirits Poisoning} Poisoning from mineral spirits, petroleum-based solvents used in paints and cleaning products. Swallowing or inhalation may cause dizziness, drowsiness, chemical pneumonitis, or breathing failure, especially after liquid enters the lungs.
...
\medterm{Minimal-Change Disease} A glomerular disorder in which the kidney looks nearly normal on routine microscopy but podocyte changes cause heavy protein loss in the urine. It is a common cause of nephrotic syndrome in children and often responds to corticosteroids.

\medterm{Minimally Invasive Esophagectomy} Surgical resection of part or all of the esophagus performed using thoracoscopy and laparoscopy or robotic assistance through small keyhole incisions, reducing postoperative recovery time.

\synonyms
MIE; Thoracolaparoscopic Esophagectomy; Robotic Esophagectomy
...
\medterm{Minimally Invasive Prostate Resection} Endoscopic or robotic transurethral procedures (such as holmium laser enucleation of the prostate [HoLEP], transurethral resection of the prostate [TURP], or robotic simple prostatectomy) performed to remove obstructive adenomatous tissue in benign prostatic hyperplasia.

\synonyms
TURP; HoLEP; Endoscopic Prostatectomy; Minimally Invasive BPH Resection
...
\medterm{Mitral Annular Calcification} Chronic calcium and fibrous deposition in the ring supporting the mitral valve. It is more common with older age and chronic kidney disease and can restrict leaflet motion, causing or worsening mitral regurgitation or degenerative mitral stenosis; echocardiography and sometimes CT assess its extent and consequences.
...
\medterm{Mitral Stenosis} Narrowing of the mitral valve opening, obstructing flow from the left atrium to the left ventricle. It is usually rheumatic but can result from degenerative mitral annular calcification; raised left-atrial pressure may cause breathlessness, atrial fibrillation, pulmonary hypertension, or right-sided heart failure.
...
\medterm{Mitral Valve Prolapse} Displacement of one or both mitral-valve leaflets backward into the left atrium during ventricular systole, often because of myxomatous or other degenerative valve changes. It may be harmless, but can cause mitral regurgitation, palpitations, arrhythmias, or rarely infective endocarditis or sudden cardiac death.
...
\medterm{Mobitz Type I} A form of second-degree atrioventricular (AV) block characterized on electrocardiography by progressive PR interval prolongation in successive beats until a single P wave fails to conduct to the ventricles (dropped QRS), after which the cycle repeats (Wenckebach periodicity), typically localized within the AV node.
\synonyms
Wenckebach Block; Second-Degree AV Block Mobitz I

\medterm{Mobitz Type I Block} A form of second-degree atrioventricular block characterized electrocardiographically by progressive lengthening of the PR interval in consecutive cardiac cycles until an atrial P wave fails completely to conduct to the ventricles (dropped QRS complex). The cycle then resets with a shorter PR interval. Typically localized to physiological or pathological fatigue within the atrioventricular node, often benign and reversible.

\synonyms
Wenckebach Block; Mobitz I AV Block

\medterm{Mobitz Type II} A high-grade form of second-degree atrioventricular (AV) block characterized on electrocardiography by intermittent, non-conducted P waves (dropped QRS complexes) occurring without prior PR interval prolongation, typically localized in the infranodal His-Purkinje system and carrying a high risk of progression to complete heart block.
\synonyms
Second-Degree AV Block Mobitz II; Infranodal AV Block

\medterm{Mobitz Type II Block} A heart rhythm problem in which some signals from the upper chambers fail to reach the lower chambers without the warning lengthening of the PR interval. It can suddenly worsen into complete heart block and usually needs urgent specialist assessment; a pacemaker is often recommended when the cause is not reversible.

\synonyms
Mobitz II AV Block; Infranodal Second-Degree AV Block
...
\medterm{Molluscum Contagiosum} A benign superficial skin infection caused by a molluscum poxvirus. It produces small, pearly, firm papules with a central depression, spreads through close skin contact, sexual contact, or shared objects, and usually resolves spontaneously; lesions may be numerous, large, or persistent in people with weakened immunity.
...
\medterm{Molybdenum Cofactor Deficiency} An inherited disorder in which cells cannot make or use the molybdenum cofactor required by enzymes such as sulfite oxidase and xanthine dehydrogenase. Severe neonatal disease may cause feeding difficulty, seizures, abnormal muscle tone, encephalopathy, and progressive brain injury.
...
\medterm{Monckeberg Medial Calcific Sclerosis} A benign, non-inflammatory form of arteriosclerosis characterized by dystrophic ring-like calcification localized within the tunica media of medium and small muscular arteries without luminal obstruction or intimal ulceration, producing palpable 'lead-pipe' rigidity of peripheral vessels.
\synonyms
Mönckeberg Arteriosclerosis; Medial Calcific Sclerosis

\medterm{Mondor Disease} A benign, self-limited superficial thrombophlebitis affecting the subcutaneous veins of the anterior chest wall and breast (lateral thoracic, thoracoepigastric, or superior epigastric veins), presenting as a palpable, painful, cord-like indurated subcutaneous band under tension.
...
\medterm{Monkeypox} Former name; see \textit{Mpox}.

\medterm{Monkeypox (Mpox)} Alternate name; see \textit{Mpox}.

\medterm{Mono} Alternate name; see \textit{Infectious Mononucleosis}.

\medterm{Monoamine Oxidase Inhibitor (MAOI) Toxicity} Poisoning or interaction involving an MAOI that may cause severe hypertension, tachycardia, agitation, hyperthermia, seizures, or serotonin syndrome with clonus and hyperreflexia. Stop serotonergic or sympathomimetic drugs, provide benzodiazepines and supportive care, and manage rapidly changing blood pressure and temperature in an intensive setting.

\medterm{Monoamine Oxidase Inhibitors} Alternate form; see \textit{Monoamine Oxidase Inhibitor}.

\medterm{Monoarticular Joint Pain} Pain affecting one joint, caused by trauma, infection, crystal arthritis, osteoarthritis, or inflammatory arthritis. Acute pain with swelling, warmth, fever, or inability to bear weight can occur with septic arthritis.
...
\medterm{Monoclonal Gammopathy of Undetermined Significance (MGUS)} An asymptomatic clonal plasma-cell or B-cell disorder with a small monoclonal immunoglobulin, limited marrow involvement, and no myeloma-defining organ damage. It can progress to a related malignancy and requires monitoring.
...
\medterm{Mononeuritis Multiplex} A painful, asymmetrical, asynchronous sensory and motor peripheral neuropathy affecting at least two separate, non-contiguous named peripheral nerves, classically provoked by systemic necrotizing vasculitides (such as polyarteritis nodosa, microscopic polyangiitis, or cryoglobulinemia).
...
\medterm{Monteggia Fracture} A traumatic fracture of the proximal third of the ulnar shaft accompanied by dislocation or subluxation of the radial head at the proximal radioulnar joint (PRUJ), classified into four types by Bado.
\synonyms
Monteggia Fracture-Dislocation; Proximal Ulnar Fracture with Radial Dislocation

\medterm{Monteggia Fracture-Dislocation} A traumatic forearm injury consisting of a fracture of the proximal third of the ulna associated with anterior, posterior, or lateral dislocation of the radial head at the proximal radioulnar joint.
...
\medterm{Moro Reflex} A normal newborn startle response that causes the baby to spread out the arms, open the hands, and then draw the arms inward. It usually fades by about 3 to 6 months; an absent or unequal response may indicate a nerve or developmental problem.
...
\medterm{Morphine Overdose} Taking too much morphine can cause extreme sleepiness, pinpoint pupils, slow or stopped breathing, low blood pressure, coma, and death. Naloxone can sometimes reverse opioid-related breathing suppression.
...
\medterm{Motor Endplate} The specialized, highly folded post-synaptic sarcolemmal region of a skeletal muscle fiber directly underlying an axon terminal at the neuromuscular junction, densely packed with nicotinic acetylcholine receptors and acetylcholinesterase enzymes.
...
\medterm{Motor Neuron Disorders Pathology} Pathologic changes affecting upper or lower motor neurons, which may include neuronal loss, chromatolysis, gliosis, corticospinal-tract degeneration, muscle denervation atrophy, and variable involvement of brainstem or spinal motor nuclei.
...
\medterm{Mouthwash Overdose} Swallowing too much mouthwash may cause alcohol poisoning, vomiting, drowsiness, low blood sugar, breathing problems, or coma; products containing fluoride or other ingredients can cause additional toxicity.
...
\medterm{Mpox} A viral disease caused by monkeypox virus, an orthopoxvirus. It spreads mainly through close contact with lesions, body fluids, respiratory particles, or contaminated objects and may cause fever, swollen lymph nodes, fatigue, and painful lesions on the skin or mucosal surfaces; severe disease is more likely in children, pregnancy, and immunocompromise.
...
\medterm{Mucha-Habermann Disease} An acute, severe, self-limiting variant of pityriasis lichenoides (PLEVA) characterized by the sudden eruption of widespread erythematous macules that rapidly evolve into necrotic, papulovesicular, and hemorrhagic crusted lesions that heal leaving small varioliform (pox-like) scars.
\synonyms
...
\medterm{Mucocele and Ranula} Mucus-filled lesions caused by leakage or blockage of a salivary gland duct. A mucocele usually affects the lower lip, while a ranula arises in the floor of the mouth; persistent, recurrent, or large lesions may need dental or oral-surgery treatment.

\medterm{Mucociliary Escalator} A critical pulmonary innate defense mechanism consisting of ciliated pseudo-stratified columnar epithelial cells and goblet-cell-derived mucus lining the conducting tracheobronchial tree, whose coordinated rhythmic upward ciliary beating sweeps inhaled particulate matter and pathogens out of the respiratory tract toward the pharynx.
...
\medterm{Mucosa-Associated Lymphoid Tissue} Collections of immune tissue in the moist linings of the digestive, breathing, and urinary or reproductive tracts. They help detect and respond to substances and germs entering through these surfaces.
...
\medterm{Mucosal Candidiasis} Candida yeast infection of a mucous membrane, commonly producing white plaques, soreness, redness, or burning in the mouth or genital tract. Antibiotics, diabetes, inhaled steroids, immune suppression, and moisture can increase risk.
...
\medterm{Mucous Membrane (Cicatricial) Pemphigoid (MMP)} A group of autoimmune subepidermal blistering disorders affecting mucous membranes, especially the mouth, eyes, nose, and genitals. Repeated inflammation can scar and threaten vision, airway function, or other organ function, so specialist diagnosis and treatment are important.
...
\medterm{Muehrcke Lines} Paired, white, non-palpable, transverse parallel bands spanning the width of the nail bed, separated by normal pink nail bed, which do not migrate with nail growth and blanch with digital pressure (apparent leukonychia), characteristic of severe hypoalbuminemia (serum albumin less than 2 g/dL).
\synonyms
Muehrcke's Lines; Paired White Bands of Hypoalbuminemia

\medterm{Muehrcke Lines of the Fingernails} Paired transverse white bands in the nail bed that remain fixed as the nail grows. They may occur with low blood protein, severe illness, chemotherapy, or other systemic stress and usually improve when the underlying problem resolves.
...
\medterm{Muir-Torre Syndrome} An autosomal dominant cancer predisposition syndrome (a variant of Lynch syndrome) caused by germline mutations in DNA mismatch repair genes (MSH2, MLH1), characterized by the combination of at least one sebaceous gland neoplasm (sebaceous adenoma, sebaceoma) or keratoacanthomas with internal visceral malignancies (especially colorectal and genitourinary carcinomas).
\synonyms
MTS; Sebaceous Neoplasm and Visceral Cancer Syndrome
...
\medterm{Mullerian Agenesis} A congenital developmental anomaly in 46,XX females resulting from embryonic failure of the paramesonephric (Müllerian) ducts to develop, causing congenital absence of the upper two-thirds of the vagina, cervix, and uterus, with normal functional ovaries and secondary sexual characteristics.

\synonyms
Mayer-Rokitansky-Kuster-Hauser Syndrome; MRKH Syndrome

\medterm{Mullerian Duct Anomalies} Congenital differences in development of the uterus, cervix, fallopian tubes, or upper vagina. Examples include septate, bicornuate, didelphys, unicornuate, and agenesis patterns; they may cause menstrual obstruction, infertility, pregnancy loss, or preterm birth.
...
\medterm{Multicentric Reticulohistiocytosis} A rare systemic non-Langerhans cell histiocytosis characterized by papulonodular skin or mucosal lesions and often destructive inflammatory arthritis. It may involve other organs and can be associated with an underlying malignancy, so evaluation is multidisciplinary.
...
\medterm{Multifocal Motor Neuropathy} A rare, chronic, acquired autoimmune peripheral neuropathy characterized by slowly progressive, asymmetric, distal lower motor neuron weakness and muscle atrophy predominantly affecting the upper extremities without sensory loss. Characterized electrophysiologically by persistent multifocal motor conduction blocks outside usual entrapment sites, with high circulating titers of IgM anti-GM1 ganglioside antibodies in over 50 percent of patients; responds selectively to intravenous immunoglobulin.
...
\medterm{Multiple Endocrine Neoplasia} A group of inherited, usually autosomal dominant cancer-predisposition syndromes causing tumors or overactivity in two or more hormone-making glands during a person's lifetime. Types include MEN1, MEN2, and related subtypes with different gene associations and tumor risks.
...
\medterm{Multiple Endocrine Neoplasia Type 2 (MEN2)} An inherited cancer-predisposition syndrome, usually caused by a pathogenic RET variant, featuring medullary thyroid carcinoma and, in some people, pheochromocytoma and parathyroid disease. Genetic counseling, biochemical testing, and preventive thyroid surgery may be needed.
...
\medterm{Mumps Orchitis} Acute inflammation of the testis occurring in approximately 20 to 30 percent of post-pubertal males infected with the mumps paramyxovirus, presenting with sudden severe testicular pain, unilateral or bilateral scrotal edema, high fever, and risking subsequent testicular atrophy and impaired spermatogenesis.

\medterm{Mumps Parotitis} Alternate name; see \textit{Mumps}.
...
\medterm{Muscle Belly} The thick, fleshy middle part of a muscle between its attached ends. It contains most of the muscle fibers that shorten to produce force.
...
\medterm{Muscle Fascicle} A bundle of muscle fibers surrounded by connective tissue. Several fascicles join to form a muscle.
...
\medterm{Muscle Insertion} The attachment of a muscle to the body part that usually moves when the muscle contracts. The insertion is often farther from the body’s center than the muscle’s origin.
...
\medterm{Muscle Origin} The attachment of a muscle to the body part that usually stays more fixed when the muscle contracts. It is often closer to the body’s center than the muscle’s insertion.
...
\medterm{Muscle Relaxation} The return of a muscle to a less tense state after contraction, when calcium levels inside the muscle cell fall and the contractile proteins stop generating force.
...
\medterm{Muscle-Tendon Unit} The connected working unit made of a muscle and its tendon. It produces force and transfers that force to a bone or other structure.
...
\medterm{Muscle Tone} The slight, continuous activity present in resting muscles that gives them some resistance to being stretched. Abnormally high or low muscle tone can occur with disorders of the brain, spinal cord, nerves, or muscles.
...
\medterm{Muscular System} The body system made up mainly of skeletal, smooth, and heart muscle. It produces movement, maintains posture, moves substances through organs, pumps blood, and generates heat.
...
\medterm{Mushroom Toxicity} Poisoning from an edible-looking or otherwise toxic mushroom, with syndromes ranging from early gastrointestinal illness or hallucinations to delayed hepatic or renal failure. The species, amount, and time to symptoms are important; contact a poison center, preserve a specimen or photograph, and provide syndrome-specific supportive treatment.
...
\medterm{Myasthenia Crisis} A life-threatening complication of myasthenia gravis characterized by severe exacerbation of respiratory muscle weakness producing impending acute ventilatory failure, often triggered by systemic infection, surgery, or medication withdrawal, requiring endotracheal intubation and treatment with plasmapheresis or intravenous immunoglobulin.
...
\medterm{Myasthenia Gravis and Pregnancy} Pregnancy and the postpartum period can alter autoimmune neuromuscular weakness, while some medicines and anesthesia may worsen respiratory or swallowing function. Neurology and obstetric planning addresses medication safety, delivery, neonatal weakness, and crisis risk.

\medterm{Myasthenic Crisis} A life-threatening worsening of myasthenia gravis that weakens the muscles needed for breathing or swallowing. Infection, surgery, stress, pregnancy, or certain medicines may trigger it. Severe breathlessness, choking, inability to swallow, or rapidly worsening weakness may occur.
...
\medterm{Mycoses} Plural of mycosis; see \textit{Mycosis}.

\medterm{Mycosis} An infection caused by a fungus, including a yeast or mold. Mycoses may be superficial, cutaneous, subcutaneous, or systemic, depending on the tissues involved; the site and organism determine symptoms and treatment.
...
\medterm{Myelitis} Myelitis is inflammation of the spinal cord or, less commonly, other neural tissue described by the term. Transverse myelitis can cause weakness, sensory changes, and bladder or bowel dysfunction and may result from infection, immune disease, reduced blood flow, or pressure on the spinal cord.

\medterm{Myeloablative Agonist} A nonstandard expression that most likely means \textit{myeloablative agent}, a drug or treatment that severely or completely destroys blood-forming cells in the bone marrow. Myeloablative therapy may be used before a stem-cell transplant and causes profound, temporary low blood counts; ``agonist'' is not the usual term in this context.
...
\medterm{Myelofibrosis} A group of bone-marrow disorders in which fibrous tissue disrupts normal blood-cell production. It includes primary myelofibrosis and secondary forms caused by other blood or marrow diseases.
...
\medterm{Myeloma Cast Nephropathy} Kidney damage caused by abnormal proteins from multiple myeloma blocking and injuring the kidney's filtering tubes. It can cause sudden kidney failure and is treated by addressing the myeloma and supporting kidney function.
...
\medterm{Myelopathy} Spinal-cord dysfunction caused by compression, ischemia, inflammation, infection, trauma, degeneration, or tumor. It may produce bilateral weakness or upper-motor-neuron signs, a sensory level, gait disturbance, pain, and bowel or bladder dysfunction; MRI and urgent evaluation are important when compression or rapid progression is suspected.
...
\medterm{Myocardial Infarction} Death of part of the heart muscle because its blood supply is suddenly reduced or blocked, usually by a blood clot on an artery plaque. It may cause chest pressure or pain, breathlessness, sweating, nausea, or no clear symptoms. Diagnosis uses symptoms, ECG findings, and heart-damage blood tests. STEMI and NSTEMI describe different ECG patterns and do not simply mean complete versus partial blockage. Emergency treatment aims to restore blood flow and prevent further clots.
...
\medterm{Myocarditis Pathology} Inflammatory infiltrates with associated cardiomyocyte injury or necrosis that is not explained by ischemia. The pattern may be lymphocytic, eosinophilic, giant-cell, granulomatous, or mixed depending on the cause.
...
\medterm{Myoepithelial Carcinoma Pathology} An infiltrative malignant neoplasm composed predominantly of myoepithelial cells, which may be clear, epithelioid, spindle, or plasmacytoid and show variable immunoreactivity for myoepithelial markers. It most often arises in salivary tissue or soft tissue.
...
\medterm{Myoma} A usually benign tumor made of muscle tissue. The term often refers to a leiomyoma, especially a uterine fibroid, but myomas can arise from smooth or skeletal muscle in other sites.
...
\medterm{Myomas} Plural of myoma; see \textit{Myoma}.
...
\medterm{Male Sexual Problems} Sexual symptoms in men, including erectile dysfunction, reduced desire, ejaculation disorders, infertility, or penile curvature; causes may be vascular, hormonal, neurologic, medication-related, psychological, or mixed.

\medterm{Malignant Appendical Tumor} Malignant tumor arising in the appendix; see \textit{Appendiceal Cancer}.

\medterm{Malignant Carcinoid Syndrome} Severe carcinoid syndrome caused by hormone-releasing neuroendocrine cancer, potentially producing flushing, diarrhea, bronchospasm, right-sided heart-valve disease, and hemodynamic complications; see \textit{Carcinoid Syndrome}.

\medterm{Malignant Large Bowel Tumor} Cancer arising in the colon or rectum; see \textit{Colorectal Cancer}.

\medterm{Mallet Toes} Alternate plural form; see \textit{Mallet Toe}.

\medterm{Malocclusion and Orthodontics} Misalignment of the teeth or jaws and the dental treatment used to improve bite, spacing, function, or facial balance; see \textit{Malocclusion}.

\medterm{Mammary Paget's Disease} A rare breast cancer involving the nipple and areola, often associated with underlying ductal carcinoma; see \textit{Paget Disease Of The Nipple}.

\medterm{Mandibular Ameloblastoma} An ameloblastoma arising in the lower jaw, usually a slow-growing locally invasive odontogenic tumor; see \textit{Ameloblastoma}.

\medterm{Manic Depression in Children and Teens} Older name for bipolar disorder beginning in childhood or adolescence; episodes of mania, hypomania, or depression require specialist assessment.

\medterm{Manic-Depressive Disorder} Older name for bipolar disorder, characterized by episodes of mania or hypomania and episodes of depression; see \textit{Bipolar Disorder}.

\medterm{Metabolic Dysfunction-Associated Steatohepatitis (MASH)} Alternate name; see \textit{Metabolic Dysfunction-Associated Steatohepatitis}.

\medterm{Metastatic Melanoma} Melanoma that has spread from the skin or another primary site to lymph nodes or distant organs; treatment depends on molecular findings, extent, symptoms, and overall health.

\medterm{Micropolygyria with Muscular Dystrophy} A rare congenital syndrome combining abnormal folding of the cerebral cortex with muscular dystrophy, causing developmental, seizure, movement, and muscle weakness findings.

\medterm{Migraine Headaches} Alternate name; see \textit{Migraine}.

\medterm{Milk Allergy} An immune reaction to milk proteins that may cause hives, vomiting, wheezing, abdominal symptoms, or anaphylaxis; it differs from lactose intolerance.

\medterm{Milk Intolerance} Difficulty tolerating milk, often because of lactose malabsorption, causing bloating, cramps, gas, or diarrhea; it is not the same as milk-protein allergy.

\medterm{Mini-Stroke (TIA)} Alternate name for a transient ischemic attack, a temporary episode of focal neurologic dysfunction caused by reduced brain, spinal-cord, or retinal blood flow without lasting infarction; urgent evaluation is required because stroke risk is increased.

\medterm{Missed Period} Absence of an expected menstrual period. Pregnancy is common, but stress, weight change, endocrine disease, medications, perimenopause, and other conditions can also contribute.

\medterm{Mitchell Disease} Alternate name for erythromelalgia, a disorder causing attacks of burning pain, warmth, and redness in the extremities; see \textit{Erythromelalgia}.

\medterm{Mixed Connective Tissue Disease (MCTD)} Alternate name; see \textit{Mixed Connective Tissue Disease}.

\medterm{Mixed Hepatic Porphyria} An acute hepatic porphyria in which inherited impairment of heme synthesis can cause episodic abdominal and neurologic symptoms and, in some people, photosensitive skin disease.

\medterm{Monomodal Visual Amnesia} A rare visual-memory disorder in which a person has marked difficulty recognizing or recalling visual information while other memory modalities may be relatively preserved; neurologic evaluation is needed to identify the cause.

\medterm{Morgagni-Turner-Albright Syndrome} Alternate name for Turner syndrome, a chromosomal condition involving complete or partial loss of one X chromosome and characteristic growth, ovarian, heart, kidney, and hearing findings; see \textit{Turner Syndrome}.

\medterm{Morvan Disease -- Syringomyelia} Historical or imprecise index label combining Morvan syndrome and syringomyelia, which are distinct neurologic disorders; see \textit{Morvan's Disease} and \textit{Syringomyelia}.

\medterm{Mountain Fever} A feverish illness associated with high-altitude exposure or, in some contexts, a tick-borne infection; the exposure history and clinical findings determine the specific diagnosis.

\medterm{Mountain Sickness, Acute} Alternate name; see \textit{Acute Mountain Sickness}.

\medterm{Mouth (Oral) Cancer} Alternate name; see \textit{Mouth Cancer}.

\medterm{MPS} Abbreviation for mucopolysaccharidosis, a group of inherited lysosomal storage disorders; see \textit{Mucopolysaccharidosis}.

\medterm{MPS Disorder} Alternate name; see \textit{Mucopolysaccharidosis}.

\medterm{MPS Disorder I} Alternate name; see \textit{Mucopolysaccharidosis Type I}.

\medterm{MPS Disorder II} Alternate name; see \textit{Mucopolysaccharidosis Type II}.

\medterm{MPS I} Abbreviation; see \textit{Mucopolysaccharidosis Type I}.

\medterm{MPS II} Abbreviation; see \textit{Mucopolysaccharidosis Type II}.

\medterm{MS (Multiple Sclerosis)} Alternate name; see \textit{Multiple Sclerosis}.

\medterm{MSA} Abbreviation for multiple system atrophy, a progressive neurodegenerative disorder affecting movement, autonomic function, and coordination; see \textit{Multiple System Atrophy}.

\medterm{MSL} Abbreviation for multiple symmetric lipomatosis, a disorder with symmetric deposits of fatty tissue around the neck, shoulders, or trunk; see \textit{Multiple Symmetric Lipomatosis}.

\medterm{Mud Fever} A historical name used for certain febrile illnesses associated with muddy or wet environments; the exact disease depends on the clinical and exposure context.

\medterm{Multiple Endocrine Deficiency Syndrome} A syndrome involving deficiency of more than one endocrine hormone, caused by autoimmune, genetic, pituitary, hypothalamic, or other disease; evaluation identifies which glands are affected.

\medterm{Multiple Lentigines Syndrome} An inherited disorder causing numerous lentigines with variable heart, endocrine, eye, hearing, or developmental abnormalities; it may overlap with Noonan-spectrum syndromes.

\medterm{Multiple Peripheral Neuritis} Inflammation or injury affecting multiple peripheral nerves, causing pain, numbness, weakness, or autonomic symptoms; see \textit{Peripheral Neuritis}.

\medterm{Multiple Polyposis of the Colon} Development of many colorectal polyps, which may be inherited or acquired and may increase colorectal cancer risk; see \textit{Polyposis}.

\medterm{Multiple Pregnancy: Twins or More} Alternate name; see \textit{Multiple Pregnancy}.

\medterm{Multiple Sclerosis (MS)} Alternate name; see \textit{Multiple Sclerosis}.

\medterm{Multiple Sulfatase Deficiency} A rare inherited lysosomal-storage disorder caused by deficient activation of multiple sulfatase enzymes, producing progressive neurologic, skeletal, skin, and organ disease.

\medterm{Multiple Symmetric Lipomatosis} A disorder characterized by symmetric, usually nonencapsulated fatty deposits around the neck, shoulders, upper trunk, or proximal limbs; see \textit{Multiple Symmetric Lipomatosis}.

\medterm{Munchausen Syndrome by Proxy} Older name for factitious disorder imposed on another, in which a caregiver falsifies, exaggerates, or induces illness in another person; see \textit{Factitious Disorder Imposed on Another}.

\medterm{Murk Jansen Metaphyseal Chondrodysplasia} Alternate name for Jansen metaphyseal chondrodysplasia; see \textit{Jansen Metaphyseal Chondrodysplasia}.

\medterm{Muscular Dystrophies} Alternate plural form; see \textit{Muscular Dystrophy}.

\medterm{Myelodysplastic Syndrome (MDS)} Alternate name; see \textit{Myelodysplastic Syndrome}.

\medterm{Maltreatment, Child} Alternate name for child abuse or neglect; see \textit{Child Abuse}.

\medterm{Manual Therapy or Bodywork} Hands-on treatment involving mobilization, manipulation, massage, or soft-tissue techniques to address pain, stiffness, or movement limitations; risks and suitability depend on the condition and technique.

\medterm{Melanoma/Skin Cancer} Alternate name; see \textit{Melanoma}.

\medterm{Mono (Infectious Mononucleosis)} Alternate name; see \textit{Infectious Mononucleosis}.
