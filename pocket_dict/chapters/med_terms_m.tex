...
\medterm{Machine, CPM} A device that gently moves a limb through a set range of motion while the person relaxes. It may be used after selected operations, especially knee surgery, but does not replace active rehabilitation.
...
\medterm{Macrocytic Anemia} Anemia in which red blood cells are larger than normal. Causes include vitamin B12 or folate deficiency, alcohol use, liver disease, thyroid disease, bone-marrow disorders, and some medicines.
...
\medterm{Macular Degeneration} Progressive damage to the macula, the central part of the retina, causing blurred or distorted central vision. The dry form usually worsens gradually; the wet form can cause faster vision loss.
...
\medterm{Male Menopause} A nonmedical term sometimes used for age-related decline in testosterone. Unlike menopause, it usually develops gradually and does not affect all men; tiredness, low sexual desire, or erection problems require evaluation for other causes.
...
\medterm{Mania} A period of unusually high or irritable mood and increased energy that lasts at least a week, or any length of time if hospital care is needed. It may include little need for sleep, rapid speech, racing thoughts, grand ideas, or risky behavior.
...
\medterm{Maternal Pushing (Second Stage)} The pregnant person's efforts to push the baby down and out during the second stage of labor. Pushing may follow the body's urge or be guided by the birth team, depending on the situation and chosen pain relief.
...
\medterm{Meckel Diverticulum} A small pouch present from birth that projects from the lower small intestine. It is often harmless but can bleed, become inflamed, cause blockage, or rarely cause a perforation.
...
\medterm{Meningitis - Cryptococcal} A fungal infection of the coverings around the brain and spinal cord, usually caused by Cryptococcus. It often develops gradually with headache, fever, nausea, or confusion and is more common when immunity is severely weakened.

\medterm{Meningitis - Tuberculous} A serious infection of the coverings around the brain and spinal cord caused by tuberculosis bacteria. Symptoms may develop over days or weeks with headache, fever, vomiting, confusion, or weakness and require urgent prolonged treatment.
...
\medterm{Midline Venous Catheters - Infants} A soft intravenous catheter placed in an infant’s arm, with its tip ending in a peripheral vein rather than near the heart. It can provide medicines or fluids for longer than a short peripheral cannula and requires monitoring for infection, blockage, or leakage.
...
\medterm{Mpox (Monkeypox)} A viral disease caused by monkeypox virus, an orthopoxvirus related to smallpox. It usually causes a rash or lesions, fever, swollen lymph nodes, and body aches; spread occurs mainly through close contact, and severity varies with the virus type and the person’s health.
...
\medterm{MUGA Scan (Multigated Acquisition Scan)} A heart scan that uses a small radioactive tracer and records the heart's pumping with each heartbeat. It measures how much blood the main chambers pump and can assess wall movement.
...
\medterm{Multiplex PCR (BioFire, FilmArray)} A laboratory test that looks for genetic material from several germs in one sample. Different panels test respiratory, intestinal, blood, or other specimens; a detected germ may represent infection, harmless carriage, or material left after an infection.
...
\medterm{Mumps} A contagious viral infection that commonly causes fever, headache, and painful swelling of the salivary glands near the cheeks. It can rarely cause meningitis, testicular inflammation, pancreatitis, or hearing loss; vaccination helps prevent it.
...
\medterm{Myasthenic (Lambert-Eaton) Syndrome} An autoimmune disorder in which antibodies interfere with nerve signals reaching muscles. It causes weakness, especially in the hips and shoulders, and may cause dry mouth, reduced reflexes, or problems with automatic body functions.
...
\medterm{Myocardial Infarction} Permanent injury or death of heart muscle because part of the heart does not receive enough blood and oxygen. It may cause pressure or pain in the chest, breathlessness, sweating, nausea, or sudden collapse and requires emergency care.
...
\medterm{Myocarditis} Inflammation of the heart muscle, often after an infection or because of an immune reaction. It can cause chest pain, breathlessness, abnormal heart rhythms, reduced pumping, or sudden severe illness and needs medical assessment.
...
\medterm{Myxedema Coma} A rare, life-threatening worsening of severe untreated underactive thyroid disease. It can cause extreme sleepiness or coma, low body temperature, slow heartbeat, slow breathing, low blood pressure, and confusion and requires emergency treatment.
