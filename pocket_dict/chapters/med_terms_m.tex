...
\medterm{Mad Cow Disease} Alternate index label; see \textit{Bovine spongiform encephalopathy}.
...
\medterm{Major Depression} Alternate index label; see \textit{Major Depressive Disorder}.
...
\medterm{MASH} Alternate index label; see \textit{Nonalcoholic steatohepatitis}.
...
\medterm{MASLD} Alternate index label; see \textit{Nonalcoholic fatty liver disease}.
...
\medterm{Menstruation Disturbance} Alternate index label; see \textit{Menstrual Disorders}.
...
\medterm{Mental Health} Mental health encompasses emotional, psychologic, and social well-being, affecting how individuals think, feel, behave, and handle stress, relationships, and decision-making.

\medterm{Mental Health Crisis} A period of severe emotional, behavioral, or psychological distress in which a person’s usual ability to cope or remain safe is overwhelmed. It may involve suicidal thoughts, severe agitation, psychosis, substance intoxication, or inability to care for basic needs.
...
\medterm{Mortons Neuroma (Morton's Neuroma)} Alternate spelling; see \textit{Morton neuroma}.
...
\medterm{Myasthenia Gravis} A chronic autoimmune disease that weakens the muscles used for movement. Normally, nerves release a chemical message that tells muscles to contract. In myasthenia gravis, antibodies interfere with this message, so muscles do not respond normally. Weakness usually worsens with activity and improves with rest. It commonly affects the eyelids and eye movements, but may also affect facial expression, chewing, speech, swallowing, the neck, arms, legs, or breathing muscles. Sensation is usually normal, and symptoms vary over time.
...
\medterm{Myocardial Infarction} Alternate technical term; see \textit{Heart attack}.
