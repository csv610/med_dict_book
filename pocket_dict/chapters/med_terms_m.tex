...
\medterm{Marfan's Syndrome} Alternate index label for Marfan Syndrome.
...
\medterm{Metabolic Disorders} Alternate index label for Metabolic Disease.
...
\medterm{Movement Disorders} Alternate index label for Movement Disorder.
