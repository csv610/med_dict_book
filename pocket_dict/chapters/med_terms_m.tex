...
\medterm{Macroscopic} Large enough to be seen without a microscope. A macroscopic examination describes the appearance, size, shape, and surface of a specimen.
...
\medterm{Magnetism} The physical property associated with magnetic fields and their effects on materials and charged particles. In MRI, strong static and changing magnetic fields help generate images; screening is required for ferromagnetic objects and implants because they may become projectiles, move, heat, malfunction, or distort the image.
...
\medterm{Mebrofenin Scan} A hepatobiliary nuclear-medicine scan using technetium-99m mebrofenin to follow liver uptake and bile flow. It can evaluate gallbladder function, obstruction, leaks, and selected causes of jaundice or abdominal pain.
obstruction.
...
\medterm{Monocytosis} An abnormally high number of monocytes in the blood. It may occur with infection, inflammation, recovery from low blood counts, or some blood cancers.
...
\medterm{Myasthenia} Muscle weakness, often becoming worse with activity and improving with rest. It may refer generally to weakness or to conditions such as myasthenia gravis; drooping eyelids, trouble swallowing, or breathing difficulty require prompt assessment.
...
\medterm{Myofibrils} Long contractile structures inside muscle fibers, made of repeating sarcomeres containing actin and myosin. Their shortening produces muscle contraction.
...
\medterm{Marburg Virus} A virus that can cause severe viral hemorrhagic fever, with fever, weakness, vomiting, diarrhea, bleeding, and shock. It spreads through contact with infected body fluids and requires strict infection control.
...
\medterm{Meal Timing} The schedule and spacing of meals and snacks during the day. Timing can influence blood glucose, appetite, sleep, and medication effects, but recommendations depend on health needs and lifestyle.

\medterm{Meat} Animal muscle tissue eaten as food, providing protein, iron, zinc, and other nutrients. Health effects depend on portion size, preparation, and whether the meat is processed; excessive processed meat intake is associated with health risks.

\medterm{Mechanobiology} The study of how physical forces, such as stretch, pressure, and flow, affect cells, tissues, and disease. It helps explain processes including bone remodeling, wound healing, and cancer invasion.

\medterm{Meckel's Diverticulum} A small pouch present from birth in the small intestine, left over from an embryonic connection. It is often harmless but can cause bleeding, inflammation, obstruction, or intussusception.
...
\medterm{Medical Devices} Tools, implants, equipment, or software intended to diagnose, prevent, monitor, or treat disease without working mainly through a drug effect. Examples include pacemakers, imaging devices, prostheses, and test kits.

\medterm{Medical Imaging} Methods that create pictures of body structures or function, including X-ray, ultrasound, computed tomography, magnetic resonance imaging, and nuclear medicine. The best test depends on the clinical question and possible risks.

\medterm{Medical Research} Systematic study of health, disease, prevention, diagnosis, and treatment. It includes laboratory, observational, and clinical research and should follow ethical review and informed-consent requirements when people are involved.

\medterm{Medical Tourism} Traveling to another region or country to receive medical or dental care. It may involve lower cost or shorter waits but carries risks related to quality, infection, follow-up, complications, and travel after surgery.
...
\medterm{Men's Health} Healthcare addressing conditions and risks that affect men, including heart disease, cancers, sexual and reproductive health, mental health, and preventive screening. Needs vary with age, anatomy, genetics, and lifestyle.
...
\medterm{Microdosing} Taking very small amounts of a substance, often a psychoactive drug, with the intention of producing subtle effects. Benefits and safety are not established for many substances, and legal, interaction, and toxicity risks remain.
...
\medterm{Moringa oleifera} A tree whose leaves, seeds, and pods are used as food or in supplements. It provides nutrients, but claims that it treats disease are not well established and supplements can interact with medicines.
...
\medterm{Multiomics} The combined study of several biological data types, such as genomics, transcriptomics, proteomics, and metabolomics. Integrating these layers can help investigate disease mechanisms and support precision medicine.
