...
\medterm{Major Depression} A depressive illness causing persistent sadness or loss of interest, with changes in sleep, appetite, energy, concentration, movement, guilt, or thoughts of death that impair daily life.
\synonyms
...
\medterm{Malacia} Abnormal softening or loss of strength in a tissue. It may affect cartilage, bone, or brain tissue and can result from poor development, injury, infection, lack of blood flow, or other disease; the effects depend on the tissue involved.
...
\medterm{Mammary Disease} Any disorder affecting breast tissue, including infection, cysts, benign growths, hormonal changes, injury, or cancer. Symptoms such as a persistent lump, skin change, nipple discharge, or pain require evaluation.
...
\medterm{Mandible (Lower Jaw)} The large movable bone forming the lower face and holding the lower teeth. It supports chewing and speech and contains nerves and blood vessels that supply the teeth, gums, and lip.
...
\medterm{Margaric Acid} A saturated fatty acid containing 17 carbon atoms. It occurs in small amounts in some animal fats and dairy products and is mainly a biochemical or nutrition research measurement rather than a routine clinical test.
...
\medterm{MCF-7 Cell} A laboratory breast-cancer cell line used to study hormone-responsive cancer biology and possible treatments.
...
\medterm{Medical Ethics} Moral principles that guide decisions in healthcare, including respect for a person's choices, helping rather than harming, fairness, privacy, and honest communication. Ethical decisions consider the patient's wishes, likely benefits and harms, professional duties, and relevant law.
...
\medterm{Meigs' Syndrome} The triad of benign ovarian fibroma, ascites, and pleural effusion. The effusions typically resolve after removal of the ovarian tumour and should be distinguished from malignant ovarian disease.
...
\medterm{Meissner'S Corpuscles} Small sensory receptors in hairless skin that detect light touch and low-frequency vibration. They help the nervous system recognize gentle contact, texture, and movement across the fingertips, palms, and soles.
...
\medterm{Mental Illness} A broad term for health conditions affecting mood, thinking, behavior, perception, or daily functioning. Examples include depression, anxiety disorders, psychosis, bipolar disorder, trauma-related conditions, and substance-use disorders.
...
\medterm{Mesothelioma} A cancer arising from the mesothelium, most often affecting the lining of the lungs. A malignant tumor of mesothelial surfaces, most often the pleura and commonly associated with asbestos exposure.
...
\medterm{Metabolic Equivalents} Units estimating how much energy an activity uses compared with resting quietly. They help describe exercise intensity and estimate physical activity, but individual energy use varies with body size, fitness, and health.
...
\medterm{Methantheline} An older medicine that reduces the action of a nerve chemical and can relax the gut or reduce sweating. It is rarely used because it may cause dry mouth, blurred vision, constipation, difficulty urinating, confusion, or worsening of glaucoma.
...
\medterm{Methisazone} An older antiviral compound that was studied or used historically against some poxvirus infections. It is not a routine modern treatment, and its safety and usefulness should not be assumed for a current infection without specialist advice.
...
\medterm{Michaelis-Menten Kinetics} A mathematical model describing how an enzyme’s reaction rate changes as the concentration of its target substance increases. It helps estimate maximum reaction speed and enzyme affinity in laboratory and biological studies.
...
\medterm{Microbiology} The study of microorganisms, including bacteria, viruses, fungi, and parasites, and their relationships with humans and the environment. The study of microorganisms, including bacteria, viruses, fungi, and parasites.
...
\medterm{Micrococcus} A group of Gram-positive round bacteria commonly found on skin and in the environment. They are usually harmless but can rarely cause opportunistic infection in people with weakened defenses or devices.
...
\medterm{Micrograms} A unit of mass equal to one millionth of a gram, written as \textbackslash\{\}(g\textbackslash\{\}). A unit of mass equal to one millionth of a gram, written as \textbackslash\{\}(\textbackslash\{\}mu\textbackslash\{\}mathrm\{g\}\textbackslash\{\}).
...
\medterm{Microsporum Equinum} An animal-associated fungus that can infect keratin-containing tissues but rarely infects people. Human infection may cause ringworm of the skin or scalp and is confirmed by examination or laboratory testing.

\medterm{Microsporum Ferrugineum} Microsporum ferrugineum is a dermatophyte that can cause scalp ringworm, particularly in children. A fungus that can cause ringworm infections, especially on the scalp and skin of children.
...
\medterm{Mid-Sized} Of intermediate size between smaller and larger examples. It is a descriptive term, not a diagnosis; its precise meaning depends on what is being measured, such as an organ, lesion, tumor, or cell.
...
\medterm{Midriff} An informal term for the middle part of the body around the diaphragm and upper abdomen. The area includes the lower chest and upper belly and contains structures such as the diaphragm, stomach, liver, and spleen.
...
\medterm{Milliequivalent} A chemical-equivalent unit used to express the amount of charged substances such as electrolytes. A unit expressing the chemical combining power of an ion, equal to one-thousandth of an equivalent.
\medterm{Milligram} A metric unit of mass equal to one-thousandth of a gram; its abbreviation is mg. A unit of mass equal to one-thousandth of a gram.
...
\medterm{Mitral Valve Surgery - Minimally Invasive} Repair or replacement of the mitral valve through smaller chest openings or a catheter-based approach rather than a full breastbone incision. It may treat severe leakage or narrowing; suitability and risks depend on valve anatomy and overall health.

\medterm{Mitral Valve Surgery - Open} Repair or replacement of the mitral valve through an operation using a larger chest incision, usually with a heart-lung machine. It can correct severe leakage or narrowing but may cause bleeding, infection, stroke, rhythm problems, or valve failure.

\medterm{Mitral Valvotomy} A procedure that opens a narrowed mitral heart valve, allowing blood to flow more easily through the heart.
...
\medterm{Mixed Urinary Incontinence} Involuntary leakage of urine, significantly affecting psychological, social, and physical well-being. See urinary incontinence.
...
\medterm{Moellerella} Moellerella is a rare gram-negative bacterium that can occasionally cause opportunistic human infection. A rare Gram-negative bacterium that can occasionally cause urinary, bloodstream, or other infections, especially in vulnerable people.
...
\medterm{Moraxella Bovis} A bacterium that causes infectious keratoconjunctivitis, or pinkeye, mainly in cattle. It is not a usual human pathogen, but occupational or animal-health exposure may require appropriate hygiene and veterinary care.
...
\medterm{Moraxella Nonliquefaciens} A bacterium that may colonize the upper airway and rarely cause respiratory or invasive infection. A laboratory isolate is clinically important only when it matches the symptoms and specimen findings.
...
\medterm{Motilin} A hormone that helps regulate contractions and movement in the upper gastrointestinal tract. A hormone made in the small intestine that helps move food through the digestive tract between meals.
...
\medterm{Mucocele} Mucus extravasation cyst of minor salivary gland. Lower lip most common. Treatment: excision. A mucus-filled swelling, usually from a blocked or injured small salivary gland, often on lower lip.
...
\medterm{Mucosal Warts} HPV-associated warts arising on mucous membranes, including the oral, genital, or anorectal mucosa. Warts caused by human papillomavirus on moist lining tissues, including the mouth, genitals, or anus.
...
\medterm{Muscle-Contraction Headache} A pressure-like headache related to sustained contraction of scalp, neck, or jaw muscles. A pressure-like headache caused by prolonged tightening of scalp, neck, or jaw muscles, often linked with stress.
\synonyms
...
\medterm{Muscularis} A smooth-muscle layer in the wall of a hollow organ, especially the intestine. A layer of smooth muscle in hollow organs that helps move contents through the organ.
\synonyms
Muscular layer
...
\medterm{MuSK-Positive Myasthenia Gravis} An autoimmune form of myasthenia gravis causing weakness because antibodies disrupt muscle signaling, especially during swallowing, speaking, or breathing.
...
\medterm{Mycobacterium Flavescens} An environmental, usually rapidly growing mycobacterium that rarely causes human disease. When infection occurs, it is generally opportunistic and may involve the lungs, skin, wounds, or medical devices.
...
\medterm{Mycobacterium Infection} Infection caused by a Mycobacterium species, including tuberculosis, leprosy, and nontuberculous mycobacterial disease. An infection caused by bacteria of the Mycobacterium group, including tuberculosis, leprosy, and other illnesses.
...
\medterm{Mycobacterium Smegmatis} A rapidly growing environmental bacterium found in soil and water. It rarely causes infections, but may affect wounds, catheters, or other sites in people with weakened immunity or medical devices.
...
\medterm{Mycobacterium Terrae} A nontuberculous mycobacterium found in soil and water that rarely causes human disease. A soil- and water-associated bacterium that rarely causes human infection, usually in people with weakened immunity.
...
\medterm{Mycoplasma Pneumoniae} A wall-less bacterium that causes atypical respiratory infection, including tracheobronchitis and community-acquired pneumonia. A bacterium without a cell wall that can cause bronchitis, pneumonia, and other breathing infections.
...
\medterm{Myogenesis} The formation and development of muscle tissue. It involves precursor cells joining and maturing into muscle fibers during embryonic growth, muscle repair, and some laboratory tissue-engineering processes.
...
\medterm{Myoglobin} An oxygen-binding protein found mainly in skeletal and cardiac muscle. An oxygen-binding protein in skeletal and cardiac muscle; it can enter blood and urine after muscle injury.
...
\medterm{Myosis (Miosis)} Abnormally small pupils. It may result from bright light, medicines such as opioids, eye disease, nerve disorders, or poisoning.
...
\medterm{Myringotomy} A small incision in the eardrum to drain middle-ear fluid or relieve pressure. A small incision in the eardrum, often used to drain middle-ear fluid and insert a ventilation tube.
...
\medterm{Myxosarcoma} Myxosarcoma is a rare malignant soft-tissue tumor containing abundant gelatinous or myxoid material. A rare cancer of soft tissue containing abundant jelly-like material, which may grow and spread.
\synonyms
