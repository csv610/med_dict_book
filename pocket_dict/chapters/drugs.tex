...
\medterm{Oriental Medicine (Traditional)} An outdated broad label for traditional medical practices from East and Southeast Asia. It may include herbal medicines, acupuncture, and other approaches; safety and effectiveness must be assessed for each specific treatment, and the term is less precise than naming the practice.
