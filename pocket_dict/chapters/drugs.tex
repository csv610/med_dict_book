...
\medterm{A\&E Medicine} The medical specialty concerned with the immediate assessment, resuscitation, diagnosis, and initial treatment of acute illness and injury.
...
\medterm{Cold/Cough Medicines in Children} Many nonprescription cold and cough medicines are unsafe or ineffective for young children and can cause sedation, agitation, abnormal heart rate, overdose, or breathing problems. Age-appropriate fluids, saline, humidification, and clinician-guided treatment are safer approaches.
...
\medterm{Pneumococcal Vaccine} A vaccine that protects against selected serotypes of \textit{Streptococcus pneumoniae} (pneumococcus), which can cause pneumonia, meningitis, bloodstream infection, sinusitis, and otitis media. Available products include pneumococcal conjugate vaccines and pneumococcal polysaccharide vaccine; the product and schedule depend on age, previous doses, and medical risk.
