...
\medterm{Carubicin} An experimental anthracycline cancer medicine that damages DNA and interferes with cancer-cell division. It has been studied in leukemia and other cancers but is not a routine treatment; heart and bone-marrow toxicity are important potential risks.
...
\medterm{Carzelesin} An experimental cancer medicine that attaches to DNA and damages it, preventing cancer cells from copying their genetic material. It has been studied in clinical research but is not a routine treatment and can also injure healthy cells.

\medterm{Caspase Inhibitor} A substance that blocks caspases, enzymes involved in programmed cell death and some inflammatory reactions. Caspase inhibitors are mainly research tools; their possible medical uses depend on the disease and target enzyme.
