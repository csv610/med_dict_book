...
\medterm{Me-Too Drug} A medicine developed to work in the same way as an existing medicine, usually in the same drug class. It may offer differences in dosing, effectiveness, side effects, or cost, but requires its own evidence and safety review.
