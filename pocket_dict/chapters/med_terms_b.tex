...
\medterm{Bacillary Angiomatosis} A vascular infection caused mainly by \textit{Bartonella henselae} or \textit{Bartonella quintana}, usually in people with weakened immunity. It produces friable red-to-purple papules or nodules and may involve lymph nodes, liver, spleen, bone, or other organs; biopsy and special stains or molecular testing may help distinguish it from Kaposi sarcoma. Antibiotic treatment is usually effective.
...
\medterm{Bacille Calmette-Guérin Vaccine} A weakened vaccine made from a related type of germ. In many countries it helps protect children from severe tuberculosis. A related treatment is also placed into the bladder for some early bladder cancers.
...
\medterm{Bacterial Infection} An illness caused by bacteria entering, multiplying, or spreading in body tissues. Many harmless bacteria normally live on the skin and in the gut, but disease-causing bacteria can invade the body or enter places that are usually free of germs, such as the bloodstream. They can damage tissue, make harmful substances, or trigger inflammation. Examples include strep throat, urinary infections, pneumonia, skin infections, and some food poisoning. Some bacterial infections need antibiotics, but not all do; the correct treatment depends on the infection and the test results.

\synonyms
Bacterial Disease; Bacterial Illness; Bacteriosis

\medterm{Bacterial Infections and Pregnancy} Bacterial infections during pregnancy can affect the urinary tract, vagina, cervix, placenta, membranes, fetus, or newborn. Diagnosis and antibiotic selection account for symptoms, culture results, gestational age, resistance, allergies, and maternal-fetal safety.
...
\medterm{Bacterial Prostatitis} A bacterial infection of the prostate gland. It may cause pain in the pelvis or lower back, painful or frequent urination, fever, chills, or difficulty passing urine. Treatment usually requires medical assessment and antibiotics.
...
\medterm{Bactericidal} Pertaining to an antimicrobial agent or physical process capable of directly killing bacteria, rather than merely inhibiting their cellular growth or replication. Classic bactericidal classes include beta-lactams, aminoglycosides, and fluoroquinolones.
...
\medterm{Bag-Valve-Mask Ventilation} A method of giving breathing support with a hand-squeezed bag and face mask. It is used when a person is not breathing or is not breathing well enough. The rescuer keeps the airway open and gives gentle breaths using room air or added oxygen until normal breathing returns or more advanced airway support is provided.
...
\medterm{Balamuthia Mandrillaris Infection} A rare, often severe and sometimes fatal infection caused by the free-living amoeba Balamuthia mandrillaris. It may
...
\medterm{Balo Disease} A rare inflammatory demyelinating disease of the brain and spinal cord, also called Balo concentric sclerosis. MRI typically shows lesions made of alternating rings of damaged and relatively preserved myelin. It may cause progressive weakness, speech or thinking problems, seizures, or other neurologic deficits and requires specialist assessment.
...
\medterm{Balanoposthitis} Inflammation of both the glans penis and foreskin. It may cause redness, swelling, itching, pain, discharge, unpleasant odour, or difficulty retracting the foreskin. Causes include irritants, poor moisture control, Candida or bacterial infection, sexually transmitted infections, diabetes, and inflammatory skin disease; recurrent or persistent cases need examination, and inability to return a retracted foreskin over the glans is an emergency.
...
\medterm{Ball-And-Socket Joint} A joint in which the rounded end of one bone fits into a cup-shaped part of another bone. It allows movement in many directions, as in the hip and shoulder.
...
\medterm{Bamboo Spine} An X-ray appearance in advanced ankylosing spondylitis in which new bone bridges the spinal bones, making the spine look like a bamboo stalk. The spine may become stiff and more likely to break after injury.
...
\medterm{Band Heterotopia} A rare birth-related brain-development condition in which a band of extra brain tissue forms below the brain's outer layer. It can cause seizures, learning problems, and developmental delay. Some cases are linked to changes in the \textit{DCX} gene.
...
\medterm{Barbiturate Toxicity} Dose-related central nervous system depression from a barbiturate, ranging from ataxia and slurred speech to coma, respiratory failure, hypotension, hypothermia, and loss of protective reflexes. Management is supportive with airway and cardiovascular support, glucose assessment, and selected decontamination or enhanced elimination for severe long-acting-drug poisoning.
...
\medterm{Barrier Nursing} Care practices used to stop infections from spreading between patients, staff, and visitors. They may include hand cleaning, protective clothing, masks, gloves, and keeping a person with a contagious infection separate when needed.
...
\medterm{Bartholin Gland Cyst} A fluid-filled lump caused by blockage of a Bartholin gland duct near the vaginal opening. Small cysts may be painless, but an infected cyst can become a painful abscess and may need drainage.
...
\medterm{Basal Cell Carcinoma} The most common skin cancer, arising from basal keratinocytes and associated mainly with cumulative ultraviolet exposure. It may appear as a pearly or translucent papule, a sore that repeatedly bleeds or does not heal, or a scar-like patch; local invasion can destroy nearby tissue, although distant spread is uncommon. Diagnosis requires biopsy, and treatment commonly involves excision, Mohs surgery, or selected nonsurgical or targeted therapies.
...
\medterm{Basilar Artery Migraine} A variant of migraine with aura originating from brainstem or bilateral occipital cortex dysfunction, presenting with symptoms such as vertigo, bilateral visual disturbances, dysarthria, ataxia, tinnitus, and decreased consciousness followed by headache.

\synonyms
Migraine with Brainstem Aura; Basilar Migraine

\medterm{Basilar Invagination} A craniocervical junction anomaly in which the margins of the foramen magnum and upper cervical spine (odontoid process) migrate superiorly into the posterior cranial fossa, potentially compressing the brainstem, upper cervical cord, and lower cranial nerves.
...
\medterm{Basilar Skull Fracture} A traumatic fracture involving the bones forming the base of the skull (ethmoid, sphenoid, temporal, or occipital bones). Clinical hallmarks include cerebrospinal fluid rhinorrhea or otorrhea, hemotympanum, Battle sign, and raccoon eyes.
...
\medterm{Batson Venous Plexus} A valveless network of epidural and vertebral veins connecting the deep pelvic and thoracic veins to the internal vertebral venous plexuses and intracranial venous sinuses. Because it lacks valves, retrograde flow occurs during increases in intra-abdominal or intrathoracic pressure (such as coughing or straining), providing a direct pathway for the hematogenous dissemination of infections and metastases (notably prostate and breast carcinoma) to the vertebral column and brain.

\synonyms
Batson Plexus; Vertebral Venous Plexus
...
\medterm{B-Cell Acute Lymphoblastic Leukemia} A rapidly progressive cancer of immature B-lymphocyte precursors in the bone marrow. Abnormal cells crowd out normal blood-forming cells and may enter the blood, lymph nodes, central nervous system, or other organs; diagnosis and treatment require specialist hematology care.

\synonyms
B-Cell ALL; B-Cell Acute Lymphocytic Leukemia; Adult B-Cell Acute Lymphoblastic Leukemia
...
\medterm{Becker Muscular Dystrophy} An X-linked recessive muscle disease caused by reduced or abnormal dystrophin, a protein that supports muscle fibres. It usually causes slowly progressive weakness beginning in childhood or adulthood and may also affect the heart.
...
\medterm{Beckwith-Wiedemann Spectrum} An epigenetic overgrowth disorder classically characterized by the clinical triad of macrosomia, macroglossia, and abdominal wall defects (omphalocele or umbilical hernia), accompanied by hemihyperplasia, neonatal hypoglycemia secondary to hyperinsulinism, and an elevated predisposition to pediatric embryonal malignancies (notably Wilms tumor and hepatoblastoma).
...
\medterm{Bedbug Bites} Itchy skin reactions caused by bedbugs feeding at night. Bites may appear as red, swollen, itchy marks in clusters or lines on exposed skin, sometimes days after exposure; some people have no visible reaction. Bedbugs are not known to spread disease, but scratching can cause secondary infection and rare allergic reactions need medical care.
...
\medterm{Bedsore} A pressure injury, also called a pressure sore or pressure ulcer, caused by prolonged pressure or pressure combined with shear and friction. It usually develops over a bony area such as the heel, hip, elbow, or tailbone; limited movement, moisture, poor nutrition, and reduced sensation increase risk.

\medterm{Bedsores} Plural of bedsore; see \textit{Bedsore}.
...
\medterm{Beer-Drinker's Heart} Historical and informal term; see \textit{Alcoholic Cardiomyopathy}. It is not a preferred modern term because alcohol-related cardiomyopathy is associated with chronic alcohol exposure, not specifically beer.
...
\synonyms
Bell's Palsy; Idiopathic Facial Palsy; Facial Nerve Palsy

\medterm{Bell's Palsy} Alternate spelling; see \textit{Bell Palsy}.

\medterm{Bells Palsy} Alternate spelling without an apostrophe; see \textit{Bell Palsy}.
...
\medterm{Bendopnea} The onset of shortness of breath occurring within thirty seconds of bending forward at the waist (such as when putting on socks or tying shoes). It serves as a specific physical examination sign of heart failure, reflecting an acute increase in ventricular filling pressures and pulmonary capillary wedge pressure superimposed on already elevated baseline hemodynamics.

\synonyms
Forward-Bending Dyspnea
...
\medterm{Benign Essential Tremor} A common movement disorder causing involuntary shaking, usually of the hands and sometimes the head or voice. The shaking is most noticeable when holding a position or using the affected body part. Family history is common, but not required, and alcohol is not a safe treatment.

\synonyms
Essential Tremor

\medterm{Benign Fasciculation Syndrome} A neurological condition characterized by persistent, involuntary muscle twitching (fasciculations) in the absence of motor weakness, muscle denervation, sensory neuropathy, or an underlying motor neuron disease such as amyotrophic lateral sclerosis.
...
\medterm{Benign Lesions of the Ovaries} Noncancerous ovarian growths or cysts, including functional cysts, endometriomas, dermoids, fibromas, and cystadenomas. Evaluation uses symptoms, examination, pregnancy testing, ultrasound, and sometimes tumor markers or surgery to distinguish benign disease from malignancy.
...
\medterm{Benign Melanocytic Nevi Pathology} Well-circumscribed proliferations of benign melanocytes arranged in nests or cords at the dermoepidermal junction and/or dermis. Typical lesions show maturation with depth and lack significant cytologic atypia or destructive growth.
...
\medterm{Benign Vulvar Lesions} Noncancerous growths or skin disorders of the vulva, including cysts, warts, inflammatory lesions, fibromas, and pigmentary lesions. Persistent, changing, bleeding, painful, or atypical lesions may require biopsy.
...
\medterm{Benzodiazepine Toxicity} Excess benzodiazepine effect causing drowsiness, slurred speech, ataxia, impaired coordination, and sometimes coma or respiratory depression, especially with opioids or alcohol. Treatment is usually airway and supportive care; flumazenil is reserved for carefully selected patients because it can precipitate seizures or withdrawal.
...
\medterm{Berloque Dermatitis} A phototoxic skin reaction caused when perfume or cosmetics containing psoralens, classically bergamot oil, are followed by ultraviolet-A exposure. It may produce burning, redness, or blisters and then a pendant- or drip-shaped area of hyperpigmentation on the face or neck.
...
\medterm{Bernard-Soulier Syndrome} A rare autosomal recessive bleeding disorder caused by a deficiency or qualitative defect in the platelet glycoprotein Ib-IX-V complex, the primary receptor for von Willebrand factor. Patients present with mucocutaneous hemorrhage, prolonged bleeding time, thrombocytopenia, and abnormally large giant platelets on peripheral blood smear, with impaired platelet aggregation to ristocetin that does not correct with normal plasma.

\synonyms
Giant Platelet Syndrome; Glycoprotein Ib Deficiency
...
\medterm{Best Disease} An inherited macular disorder, usually caused by variants in BEST1, with abnormal accumulation of yellow material at the macula. Vision loss varies and may progress to atrophy, neovascularization, or scarring.
...
\medterm{Beta-Agonist} A pharmacological agent that stimulates beta-adrenergic receptors. Beta-2 selective agonists (such as albuterol and salmeterol) induce bronchial smooth muscle relaxation and bronchodilation in asthma and chronic obstructive pulmonary disease.
...
\medterm{Beta-Blocker Toxicity} Overdose causing bradycardia, hypotension, atrioventricular block, cardiogenic shock, hypoglycemia, bronchospasm, seizures, or altered mental status. Propranolol may widen the QRS or cause seizures; severe poisoning may require vasopressors, glucagon, high-dose insulin with glucose, bicarbonate for sodium-channel blockade, and intensive monitoring.
...
\synonyms
Beta Cells; Pancreatic Beta Cell; Pancreatic Beta Cells
...
\medterm{Beta-Lactamase Inhibitor} A compound that binds irreversibly to and inactivates bacterial beta-lactamase enzymes, thereby protecting co-administered beta-lactam antibiotics from enzymatic hydrolysis. Examples include clavulanic acid, sulbactam, tazobactam, and avibactam.

\medterm{Beta-Mannosidosis} A rare autosomal recessive disorder in which cells cannot break down certain complex sugars. The stored material can cause developmental delay, hearing loss, repeated infections, seizures, or skeletal and skin problems.
...
\medterm{Beta-Thalassemia} An autosomal recessive disorder in which the body makes too little or no beta-globin, a part of haemoglobin. Severity ranges from mild carrier status to severe anaemia requiring regular transfusions and monitoring for iron overload.
...
\medterm{Beta-Thalassemia Major} The severe, transfusion-dependent form of beta-thalassemia resulting from homozygous or compound heterozygous mutations that completely abolish beta-globin chain production, leading to profound microcytic anemia, extramedullary hematopoiesis, skeletal deformities, and secondary hemochromatosis.
...
\medterm{BH4 Deficiency} An inherited deficiency of tetrahydrobiopterin, a cofactor needed to process phenylalanine and make several neurotransmitters. It can cause high phenylalanine, seizures, movement or developmental problems, and neurologic disease; treatment depends on the specific defect.
...
\medterm{Bicarbonate Buffer System} The primary extracellular chemical buffer system in the human body, consisting of carbonic acid and bicarbonate ion in equilibrium with dissolved carbon dioxide, regulated by the lungs (via carbon dioxide excretion) and the kidneys (via bicarbonate reabsorption and excretion).
...
\medterm{Bicipital Tendinitis} Irritation and degeneration of the long-head biceps tendon near the shoulder, causing pain in the front of the shoulder that may worsen with lifting, reaching overhead, or resisted elbow flexion.
...
\medterm{Bielschowsky Head Tilt Test} A clinical diagnostic test used to evaluate trochlear nerve (cranial nerve IV) palsy causing superior oblique muscle paresis. Hypertropia and vertical diplopia worsen when the patient tilts the head toward the ipsilateral (paretic) side and improve when tilted toward the contralateral side, as the intact vestibular ocular reflex attempts intorsion.

\synonyms
Bielschowsky Phenomenon; Head Tilt Test
...
\medterm{Bilateral Acoustic Neuroma} Tumours affecting both vestibular nerves, usually representing bilateral vestibular schwannomas associated with NF2-related schwannomatosis. They may cause hearing loss, tinnitus, balance problems, or other cranial-nerve symptoms and require specialist neurologic and genetic assessment.

\synonyms
Bilateral Vestibular Schwannoma; Bilateral Acoustic Neurinoma
...
\medterm{Bile Reflux Gastritis} Inflammation and mucosal erythema of the stomach caused by the retrograde flow of duodenal contents, including alkaline bile acids and pancreatic enzymes, into the gastric cavity, frequently occurring following gastric resection or cholecystectomy.
...
\medterm{Biliary Stasis} Impairment, delay, or cessation of normal bile flow through intrahepatic or extrahepatic biliary channels, predisposing to biliary sludge, cholelithiasis, jaundice, and secondary bacterial cholangitis.
...
\medterm{Biliary Tree} The anatomical conduit system of ducts and vessels that channels bile from intrahepatic bile canaliculi through segmental ducts, right and left hepatic ducts, common hepatic duct, cystic duct, and common bile duct into the second part of the duodenum.
...
\medterm{Billroth II Operation} A surgical reconstruction procedure following partial gastrectomy in which the duodenal stump is oversewn closed and the gastric remnant is anastomosed directly to the side of a loop of proximal jejunum (gastrojejunostomy).

\medterm{Billroth I Operation} A surgical reconstruction procedure following partial gastrectomy (antrectomy) in which the remaining gastric remnant is anastomosed directly to the duodenal stump (gastroduodenostomy).
...
\medterm{Binge Eating Disorder} Alternate form; see \textit{Binge-Eating Disorder}.
...
\medterm{Biological Valve} A prosthetic cardiac valve fabricated from animal or human donor tissue (such as porcine aortic valves or bovine pericardial leaflets), which carries a low thrombogenicity and does not require lifelong anticoagulation, though with limited long-term durability compared to mechanical valves.
...
\medterm{Birbeck Granules} Small rod- or tennis-racket-shaped structures found inside Langerhans cells. They are associated with these cells but are not by themselves proof of Langerhans cell histiocytosis.
...
\medterm{Birth Defect} A problem in the body’s structure or function that is present at birth. It may result from genetic or chromosome changes, infections, medicines, alcohol, poor nutrition, or other causes; sometimes no cause is found.
...
\medterm{Birt-Hogg-Dube Syndrome} An autosomal dominant genodermatosis caused by germline mutations in the \textit{FLCN} gene, characterized by benign cutaneous fibrofolliculomas, pulmonary cysts predisposing to spontaneous pneumothorax, and an elevated risk of renal cell carcinomas.

\synonyms
BHD Syndrome

\medterm{Birt-Hogg-Dube Syndrome (BHDS)} Alternate spelling and abbreviation; see \textit{Birt-Hogg-Dubé Syndrome}.
...
\medterm{Birth Spacing} The practice of planning the time between giving birth and becoming pregnant again. Recommended spacing varies by person and health guidance, but waiting about 18 months or longer may reduce some risks for the parent and baby.
...
\medterm{Bisphosphonate-Related Osteonecrosis of the Jaw} A severe adverse reaction characterized by exposed, necrotic bone in the maxillofacial region persisting for more than eight weeks in patients receiving bisphosphonate therapy without prior craniofacial radiation therapy.

\synonyms
BRONJ; Medication-Related Osteonecrosis of the Jaw
...
\medterm{Bitemporal Hemianopsia} A visual field deficit in which vision is lost in the outer (temporal) halves of both the right and left visual fields, classically caused by compression of crossing decussating nerve fibers at the optic chiasm by a pituitary adenoma or craniopharyngioma.
...
\medterm{Bitot's Spots} Foamy, white or grey patches on the white part of the eye, usually near the cornea. They are commonly linked to vitamin A deficiency and may occur with dry eyes or poor night vision. They need medical assessment because untreated vitamin A deficiency can damage the eye; vitamin A treatment should follow clinical advice.
...
\synonyms
Black Widow Spider Bite; Latrodectism
...
\medterm{Blalock-Taussig Shunt} A palliative surgical procedure designed to augment pulmonary blood flow in infants with cyanotic congenital heart defects characterized by restricted pulmonary flow (such as tetralogy of Fallot or pulmonary atresia). The classic procedure anastomosed the subclavian artery directly to the pulmonary artery, whereas the modified technique uses a synthetic Gore-Tex graft between the subclavian and pulmonary arteries.

\synonyms
BT Shunt; Blalock-Thomas-Taussig Shunt
...
\medterm{Blastema} A mass of undifferentiated, highly proliferating embryonic cells capable of growth and cellular differentiation into organs, tissues, or specialized structures; in nephroblastoma (Wilms tumor), blastemal cells constitute a primitive malignant component.
...
\medterm{Blast Injuries} Injuries caused by an explosive pressure wave and its associated fragments, heat, displacement, or toxic exposure. They may affect the lungs, ears, brain, abdomen, eyes, bones, and soft tissues.
...
\medterm{Blastocystis} A common microscopic organism that may be found in the digestive tract after contaminated food or water is swallowed. Many people have no symptoms, and it is not always clear whether it causes illness. Diarrhoea, stomach cramps, bloating, or nausea may occur. Stool testing can detect it, but a positive result does not prove that it caused the symptoms; treatment is considered only in selected persistent cases.
...
\medterm{Blepharitis} A common, usually chronic inflammation of the eyelid margins that can cause itchy or burning eyelids, redness, tearing, dry-eye symptoms, and crusting at the base of the eyelashes. Anterior blepharitis affects the skin, lash follicles, and lash bases; posterior blepharitis affects the meibomian oil glands and often accompanies rosacea or dry eye. Lid hygiene and warm compresses may help, but pain, marked swelling, light sensitivity, or vision change needs prompt eye assessment.
...
\medterm{Blister} A raised pocket of fluid within or beneath the outer layer of skin. Small blisters are called vesicles; larger ones are called bullae. Blisters can result from rubbing, burns, heat, infection, allergy, or inflammatory skin disease and commonly affect the hands and feet.

\medterm{Blisters} Plural of blister; see \textit{Blister}.
...
\medterm{Blood-Air Barrier} The thin anatomical partition in the lung consisting of alveolar type I epithelium, fused capillary endothelial basement membrane, and capillary endothelium across which alveolar gases diffuse into and out of pulmonary blood flow.
...
\medterm{Blood Dyscrasia} A nonspecific clinical term designating any abnormal condition, imbalance, or disease involving the cellular elements (erythrocytes, leukocytes, platelets) or clotting factors of the blood, such as aplastic anemia, leukopenia, or thrombocytopenia.
...
\medterm{Blood Flow Velocity} The speed at which blood moves through a vessel. It is usually fastest in large arteries and slowest in capillary networks, allowing time for exchange with tissues.
...
\medterm{Blood Glucose Monitors} Portable devices that measure capillary blood glucose, usually with a lancet, test strip, and meter. Correct sampling, strip storage, calibration, and interpretation are important because readings can be affected by technique, circulation, or device limitations.
...
\medterm{Blood Group Incompatibility} An immunological mismatch between the blood types of a donor and recipient, or between mother and fetus (such as ABO or Rh incompatibility), leading to antibody-mediated hemolysis, acute hemolytic transfusion reactions, or hemolytic disease of the newborn.
...
\medterm{Blood Pressure Regulation} The body’s control of blood pressure through the heart, blood vessels, kidneys, hormones, and nervous system. These systems adjust heart pumping, blood-vessel width, and body-fluid balance.
...
\medterm{Blood-Retinal Barrier} A physiological and anatomical barrier consisting of retinal capillary endothelial tight junctions (inner barrier) and retinal pigment epithelial tight junctions (outer barrier), regulating the microenvironment of neural retinal tissue.
...
\medterm{Blood-Testis Barrier} A specialized physiological barrier formed by tight junctions between adjacent Sertoli cells near the base of seminiferous tubules, partitioning spermatogonia from developing spermatocytes and preventing autoimmune destruction of haploid germ cells.
...
\medterm{Bloom Syndrome} A rare autosomal-recessive disorder caused by pathogenic changes in both copies of the \textit{BLM} gene, which encodes a DNA helicase. It causes marked short stature, a sun-sensitive telangiectatic facial rash, recurrent infections, and a greatly increased risk of multiple cancers, often at unusually young ages; specialist surveillance and strong sun protection are important.
...
\medterm{Blue Nevi} Usually benign melanocytic lesions formed by pigment-producing cells deep in the skin, giving them a blue, blue-gray, or blue-black colour. Common blue nevi are usually small and stable; cellular blue nevi may be larger or deeper and rarely undergo malignant change. A new, enlarging, bleeding, or changing lesion requires examination and sometimes biopsy.
...
\medterm{Blue Rubber Bleb Nevus Syndrome} A rare disorder with multiple slow-flow venous malformations, typically soft blue or purple compressible skin nodules and lesions in the gastrointestinal tract. Gastrointestinal bleeding can cause iron-deficiency anaemia, and other organs may be involved; evaluation may include imaging, endoscopy, and blood counts.
...
\medterm{Blue Toe Syndrome} The acute onset of localized cyanosis, purplish discoloration, and painful ischemia of one or more toes in the presence of intact distal pulses, caused by microembolization of atheromatous debris or small cholesterol crystals from proximal arterial sources.

\synonyms
Trash Foot; Digital Atheroembolism
...
\medterm{Body Fluid Exposures} Occupational or accidental contact with blood or potentially infectious body fluids through the eyes, mouth, broken skin, or a penetrating injury. Risk assessment determines testing, wound care, vaccination, and postexposure prophylaxis.
...
\medterm{Body Of The Epididymis} The middle part of the epididymis, where sperm continue to mature as they move from the head toward the tail.

\medterm{Body Of The Sternum} The broad middle part of the breastbone between the manubrium and xiphoid process. It joins most of the ribs through their costal cartilages.
...
\medterm{Bone Markers in Osteoporosis} Blood or urine measurements reflecting bone formation or resorption. They can help assess turnover and response or adherence to therapy in selected patients, but they do not replace fracture-risk assessment or bone-density testing.
...
\medterm{Bone Morphogenetic Protein} A family of growth factors belonging to the transforming growth factor-beta (TGF-beta) superfamily that orchestrate osteogenesis, chondrogenesis, and bone remodeling, utilized therapeutically in spinal fusion and non-union fracture repair.
...
\medterm{Borderline Ovarian Cancer} An ovarian epithelial tumor with atypical proliferating cells but no destructive stromal invasion on examination. It generally behaves less aggressively than invasive ovarian cancer, but can recur and requires appropriate staging and long-term follow-up.
...
\medterm{Boston Criteria} Clinical and brain-imaging rules used to estimate the likelihood of cerebral amyloid angiopathy in living people. Age, symptoms, and MRI findings such as bleeding in certain parts of the brain are considered. The criteria classify cases as possible or probable; definite diagnosis generally requires examination of brain tissue.
...
\medterm{Bowditch Effect} The intrinsic autoregulatory property of cardiac muscle whereby an increase in heart rate leads to a progressive, stepwise increase in the force of myocardial contraction due to intracellular accumulation of calcium ions.

\synonyms
Treppe Phenomenon; Frequency-Dependent Inotropy
...
\medterm{Bowel Habits} A person’s usual pattern of passing stool, including how often it happens and the stool’s form and ease of passage. Changes may include new constipation, diarrhea, urgency, or a different pattern.
...
\medterm{Bowel Movement} The passing of stool from the rectum through the anus. Stool frequency and form vary among healthy people.
...
\medterm{Bowenoid Papulosis} An HPV-associated squamous intraepithelial lesion of genital or perianal skin, usually presenting as multiple reddish-brown or violaceous papules. Biopsy shows atypical cells resembling squamous-cell carcinoma in situ, but many lesions behave indolently; diagnosis, treatment, and follow-up are important because progression can occur.

\medterm{Bowen's Disease} Squamous cell carcinoma in situ, an early skin cancer confined to the epidermis. It usually appears as a slowly enlarging, persistent scaly red or brown patch or plaque, often on sun-exposed skin; biopsy confirms the diagnosis, and untreated disease can progress to invasive squamous cell carcinoma.
...
\medterm{Brachiocephalic Artery} The first and largest arterial branch arising from the aortic arch, which ascends obliquely behind the manubrium of the sternum before bifurcating into the right common carotid and right subclavian arteries.
...
\medterm{Brachioradial Pruritus} A localized neuropathic itch, burning, or tingling affecting the outer forearms, usually related to irritation or compression of cervical nerve roots, often C4--C6. The skin may look normal or show scratch marks; cooling can temporarily relieve symptoms, but persistent cases need evaluation for cervical spine or other neurologic causes.
...
\medterm{Bradyarrhythmia} Any cardiac rhythm disorder characterized by an abnormally slow heart rate (typically fewer than 60 beats per minute in adults), resulting from sinus node dysfunction, sinus arrest, sinoatrial block, or high-grade atrioventricular block.
...
\medterm{BRAF Gene} A gene that encodes a signaling protein in the RAS-RAF-MEK-ERK pathway, which regulates cell growth and division. Activating BRAF variants can drive cancers such as melanoma, thyroid cancer, and colorectal cancer and may guide targeted treatment.
...
\medterm{Brain Neoplasms} Tumors arising in the brain, its coverings, or nearby central nervous system structures. They may be benign or malignant and can cause headache, seizures, cognitive or behavioral change, weakness, sensory loss, or hormonal or visual problems; MRI and tissue diagnosis guide classification.
...
\medterm{Brainstem Auditory Evoked Potential} An electrophysiological test measuring the neural transmission of acoustic signals from the eighth cranial nerve through the brainstem pathways to the auditory cortex, used to assess hearing acuity and brainstem integrity.

\synonyms
BAEP; Brainstem Auditory Evoked Response; BAER
...
\medterm{Brainstem Death} Irreversible cessation of all functions of the brainstem, certified clinically by persistent deep coma, total absence of brainstem reflexes, and documented apnea during formal apnea testing in the presence of a known, irreversible intracranial cause.
...
\medterm{Brainstem Gliomas} Gliomas arising in the midbrain, pons, or medulla. They may affect eye movements, facial function, swallowing, balance, strength, or breathing; imaging and tumor biology guide diagnosis and management, which differs between children and adults.
...
\medterm{Branchial Cleft Anomalies} Congenital developmental defects resulting from incomplete obliteration of the embryonic branchial apparatus, manifesting as cervical cysts, sinuses, or fistulae, most commonly arising along the anterior border of the sternocleidomastoid muscle from the second branchial cleft.
...
\medterm{Branchial Cleft Cyst} A congenital, usually lateral neck cyst caused by persistence of embryonic branchial-arch tissue, most often a second-branchial remnant. It may enlarge or become painful after an upper-respiratory infection and can cause drainage or swallowing difficulty; a new lateral neck mass in an adult requires evaluation to exclude malignancy before it is assumed to be a cyst.

\medterm{Branchial Cyst} A usually harmless, birth-related fluid-filled lump on the side of the neck caused by leftover tissue from early development. It may become larger or painful during an infection. A new cyst-like neck lump in an adult needs careful assessment because cancer can look similar. Treatment depends on the cause and may include surgical removal.
...
\medterm{Breakthrough Bleeding} Unscheduled, unexpected uterine bleeding or spotting occurring during the active hormonal phase of combined oral contraceptive use or hormone replacement therapy, frequently seen during early months of initiation.
...
\medterm{Breast Cancer Grade} A description of how abnormal breast-cancer cells look under a microscope and how quickly they are likely to grow. Grade is different from cancer stage, which describes the cancer's size and spread.
...
\medterm{Breast Quadrant} One of four areas used to describe where a finding is located in the breast: upper or lower, and inner or outer. The location helps describe examination and imaging findings.
...
\medterm{Breech Delivery} Birth when the fetus presents buttocks or feet first rather than head first. The safest plan depends on fetal type and size, gestational age, maternal and pelvic factors, provider skill, and whether vaginal breech birth or cesarean delivery is appropriate.
...
\medterm{Brittle Nail Syndrome} A pattern of nails that split, peel, crack, or break easily, often because of repeated wetting and drying, detergents, trauma, ageing, or inflammatory nail disease. Iron deficiency, thyroid disease, fungal infection, and inherited disorders can contribute; persistent, painful, or widespread changes need assessment.
...
\medterm{Broad Casts} Wide, waxy or granular urinary microscopic casts that form in dilated, atrophic collecting ducts of chronically damaged nephrons with sluggish urinary flow. Their presence in the urine sediment is a hallmark of advanced chronic kidney disease and end-stage renal disease.

\synonyms
Renal Failure Casts; Wide Casts

\medterm{Broad-Complex Tachycardia} A fast heart rhythm with wide QRS beats on an ECG, usually 120 milliseconds or longer. It may come from the lower heart chambers or from an upper-chamber rhythm conducted abnormally. Because it may be dangerous, it is generally treated as ventricular tachycardia until proven otherwise.
...
\medterm{Brodmann Area} A region of the cerebral cortex anatomically defined and numbered (1 through 52) based on its distinct cellular architecture (cytoarchitectonics), with specific areas corresponding to distinct functional neurological roles (such as area 4 for primary motor cortex).
...
\medterm{Broken Bone} A partial or complete break in a bone caused by injury, repeated stress, or weakened bone. Pain, swelling, bruising, deformity, or loss of function may occur. Examination and imaging are often needed, but some fractures are not visible on the first X-ray.
...
\medterm{Bromhidrosis} Unusually strong or unpleasant body odour produced when skin microorganisms break down apocrine or eccrine sweat and other secretions. It commonly affects the armpits, feet, or groin and may be worsened by hyperhidrosis, occlusion, infection, or retained skin debris; treatment addresses hygiene, moisture, and any underlying cause.
...
\medterm{Bronchial Circulation} The systemic arterial blood supply providing oxygenated blood and nutrients to the conducting airways, supporting stroma, and visceral pleura of the lungs, arising from bronchial arteries branching off the thoracic aorta or intercostal arteries.
...
\medterm{Bronchial Hyperresponsiveness} An abnormal state of airway sensitivity in which conducting airways undergo exaggerated bronchoconstriction in response to low concentrations of non-allergic chemical stimuli (such as methacholine or histamine) or physical triggers; a physiological hallmark of asthma.
...
\medterm{Bronchocentric Granulomatosis} A rare, non-necrotizing or necrotizing granulomatous inflammatory disorder centered primarily on conducting bronchi and bronchioles, frequently associated with tissue eosinophilia and severe asthma or allergic bronchopulmonary aspergillosis.
...
\medterm{Bronchoprovocation Test} A breathing test used to look for airways that narrow too easily, often when asthma is suspected but routine spirometry is normal. A substance such as methacholine is inhaled in increasing amounts while breathing is measured. A significant fall in airflow supports airway sensitivity, but does not by itself prove asthma.
...
\medterm{Brown Adipose Tissue} A specialized type of adipose tissue characterized by multilocular lipid droplets, abundant mitochondria, and high levels of uncoupling protein 1 (UCP1, thermogenin), specialized for non-shivering thermogenesis in newborns and hibernating mammals.
...
\medterm{Brown-Sequard Syndrome} A neurological syndrome caused by hemisection or unilateral damage to the spinal cord, characterized by ipsilateral loss of motor function (corticospinal tract) and proprioception/vibration (dorsal column), and contralateral loss of pain and temperature sensation (spinothalamic tract) below the lesion level.
...
\medterm{Brugada ECG Pattern Type 1} A characteristic ECG pattern with raised ST segments and an inverted T wave in certain right-sided chest leads. It may occur with Brugada syndrome, fever, medicines, or other conditions. The ECG pattern alone does not establish the inherited syndrome or predict the same risk in every person.

\synonyms
Type 1 Brugada Pattern; Coved ST Elevation Pattern
...
\medterm{Brunner Glands} Compound branched tubuloalveolar submucosal glands located exclusively in the duodenum, concentrated primarily in the bulb and proximal descending portions. They secrete an alkaline, bicarbonate-rich, mucin-containing fluid that protects the duodenal mucosa from gastric acid erosion and optimizes luminal pH for pancreatic digestive enzymes.
...
\medterm{Bruns Syndrome} Episodic, sudden attacks of severe headache, vomiting, vertigo, and syncope triggered by abrupt neck movements, caused by transient obstruction of cerebrospinal fluid flow in the fourth ventricle by a mobile mass, such as a cysticercal cyst or ependymoma.
...
\medterm{Bruton Agammaglobulinemia} An X-linked primary immunodeficiency disorder caused by mutations in the Bruton tyrosine kinase (\textit{BTK}) gene, resulting in failure of pre-B cells to differentiate into mature B lymphocytes, profound pan-hypogammaglobulinemia, and recurrent pyogenic bacterial infections beginning after maternal antibodies wane.
...
\medterm{Buffer System} A chemical solution consisting of a weak acid and its conjugate base (or a weak base and its conjugate acid) that resists changes in hydrogen ion concentration and pH upon the addition of small amounts of acidic or basic substances.
...
\synonyms
Bulimia; Bulimic Disorder; Binge-Purge Disorder
...
\medterm{Bullous Disease of Diabetes (Bullosis Diabeticorum)} A rare diabetes-related blistering disorder producing spontaneous, usually painless tense blisters on the feet or lower legs. Lesions often heal without scarring, but wound care and evaluation for infection or another blistering disease are needed.

\medterm{Bullous Emphysema} A severe manifestation of chronic obstructive pulmonary disease characterized by the formation of large, thin-walled air-filled spaces (bullae) exceeding one centimeter in diameter within the lung parenchyma, predisposing to compression of healthy lung and pneumothorax.
...
\medterm{Bullous Pemphigoid} An autoimmune subepidermal blistering disease, usually in older adults, causing severe itch and tense blisters on normal, urticarial, or eczematous skin. Antibodies target basement-membrane proteins such as BP180 and BP230; mucosal involvement is less common than skin disease. Diagnosis is confirmed with lesional biopsy and perilesional direct immunofluorescence, with blood tests sometimes supporting it.

\synonyms
BP

\medterm{Bullous Systemic Lupus Erythematosus (BSLE)} A rare autoimmune subepidermal blistering disease occurring in people with systemic lupus erythematosus, often producing tense vesicles or bullae on normal or inflamed, sometimes sun-exposed skin. Diagnosis uses skin biopsy with direct immunofluorescence and serologic testing to distinguish it from bullous pemphigoid and other blistering disorders; dapsone and treatment of SLE are commonly considered by specialists.
...
\medterm{Bundle Branch Reentry Tachycardia} A form of monomorphic ventricular tachycardia occurring in patients with severe underlying structural heart disease and conduction system disease, in which the reentrant electrical circuit involves the bundle of His and the right and left bundle branches.
...
\medterm{Bundle of Kent} An abnormal, congenital accessory muscular conduction pathway directly connecting atrial myocardium to ventricular myocardium, bypassing the physiological delay of the atrioventricular node; the anatomical substrate of Wolff-Parkinson-White syndrome.
...
\medterm{BUN-to-Creatinine Ratio} The ratio of blood urea nitrogen to serum creatinine, used clinically to differentiate etiologies of acute kidney injury. A ratio greater than 20:1 suggests prerenal azotemia, whereas a ratio less than 15:1 is characteristic of intrinsic renal damage (such as acute tubular necrosis).
...
\medterm{Buprenorphine/Naloxone Toxicity} Opioid toxicity from excessive buprenorphine exposure, characterized by somnolence, miosis, hypoventilation, hypoxia, or coma; risk increases with alcohol, benzodiazepines, or other sedatives. Buprenorphine binds tightly to opioid receptors, so airway support and repeated or prolonged naloxone treatment may be required.
...
\medterm{Buried Penis} A normally developed penis that is concealed by surrounding skin, scar tissue, or excess suprapubic fat. It may cause hygiene problems, recurrent inflammation, difficulty urinating, or sexual difficulties; causes can be congenital, obesity-related, inflammatory, or associated with circumcision complications.
...
\medterm{Burn Shock} A complex form of combined distributive, hypovolemic, and cellular shock developing after extensive cutaneous burn injury (typically greater than 20 percent total body surface area), characterized by massive capillary leak, progressive plasma extravasation into interstitial tissues, and systemic hypoperfusion.
...
\medterm{Burn Wound Infections} Infection of damaged skin or deeper tissue after a burn. Concerning changes include increasing pain, redness or swelling spreading beyond the burn, pus, foul odour, delayed healing or graft loss, fever, or other systemic illness; prompt assessment may require wound sampling, cleaning or debridement, and topical or systemic antimicrobial treatment.
...
\medterm{Burton Line} A thin, purplish-blue or black discoloration line along the gingival margin at the base of the teeth. Caused by the precipitation of lead sulfide following the chemical reaction between circulating lead and hydrogen sulfide produced by oral bacterial decay; it represents a classical physical sign of chronic lead poisoning (plumbism).

\synonyms
Burtonian Line; Lead Line

\medterm{Buruli Ulcer} A chronic skin infection caused by \textit{Mycobacterium ulcerans}, usually affecting an arm or leg. Its toxin, mycolactone, causes a painless nodule, plaque, or swelling that can progress to an undermined ulcer with extensive tissue destruction and little early inflammation; antibiotic treatment, wound care, and selected surgery can prevent disability.
...
\medterm{Bacterial Arthritis} Infection of a joint by bacteria, causing pain, swelling, warmth, restricted movement, and often fever. It is a medical emergency because cartilage can be rapidly damaged and bloodstream infection may develop.

\medterm{Bacterial Meningococcal Meningitis} Meningitis caused by invasive \textit{Neisseria meningitidis}. Fever, severe headache, neck stiffness, confusion, vomiting, or a rapidly spreading purpuric rash requires immediate emergency treatment and public-health contact tracing.

\medterm{B-Cell Acute Lymphoblastic Leukemia for Adults} Acute lymphoblastic leukemia arising from immature B-cell precursors in an adult. It can cause anemia, infection, bleeding, bone pain, and abnormal blood counts and requires urgent hematology care.

\medterm{Bilateral Polycystic Ovarian Syndrome} A nonstandard patient-facing name for polycystic ovary syndrome, a hormonal and metabolic disorder characterized by ovulatory dysfunction, androgen excess, and sometimes polycystic ovarian morphology. The syndrome is not defined simply by cysts in both ovaries.

\medterm{Biliary Atresia, Extrahepatic} A serious infant disorder in which the bile ducts outside the liver are absent, scarred, or blocked. Bile cannot drain normally, causing persistent jaundice, pale stools, dark urine, liver injury, and progressive cirrhosis without treatment.

\medterm{Binge-Purge Disorder} An older or patient-facing name for bulimia nervosa, an eating disorder involving recurrent binge eating followed by compensatory behaviors such as self-induced vomiting, fasting, or excessive exercise.

\medterm{Bipolar Disorder in Child and Teens} Bipolar disorder beginning during childhood or adolescence, with episodes of unusually elevated or irritable mood and increased energy alternating with depression. Diagnosis requires careful assessment because symptoms overlap with other developmental and psychiatric conditions.

\medterm{Birth Defects Testing} Prenatal or newborn testing used to screen for or diagnose structural, genetic, chromosomal, metabolic, or functional conditions present at birth. Tests may include ultrasound, serum screening, cell-free DNA, diagnostic procedures, and newborn screening.

\medterm{Black Widow Spider Bite} Envenomation by a \textit{Latrodectus} spider. It may cause local pain followed by severe muscle cramps, abdominal rigidity, sweating, nausea, hypertension, or autonomic symptoms; severe cases need urgent medical care.

\medterm{Bladder Infections in Children} Urinary tract infections involving a child’s bladder, usually caused by bacteria. Symptoms may include painful urination, frequent urination, new wetting, abdominal or back pain, fever, or vomiting; infants may have only fever or poor feeding.

\medterm{Bladder Infections in Teens and Adults} Bacterial infection of the bladder, commonly called cystitis. Burning urination, urgency, frequency, lower-abdominal discomfort, or blood in the urine are typical; fever, flank pain, or vomiting may indicate kidney involvement.

\medterm{Blocked Tear Ducts} Obstruction of the nasolacrimal drainage system, causing excessive tearing, discharge, or recurrent infection. In infants it often improves as the duct develops; persistent or painful obstruction may require ophthalmic treatment.

\medterm{Bone Tumor-Epidermoid Cyst-Polyposis} A historical descriptive name for Gardner syndrome, an inherited adenomatous polyposis condition associated with numerous colorectal polyps, osteomas, epidermoid cysts, and a high risk of colorectal cancer.

\medterm{Bowen’s Disease} Squamous cell carcinoma in situ, a cancer limited to the epidermis. It usually appears as a persistent scaly or crusted red patch and can progress to invasive squamous cell carcinoma if untreated.

\medterm{BPH (Benign Prostatic Hyperplasia)} Enlargement of the prostate that can obstruct urine flow. Symptoms include weak stream, hesitancy, incomplete emptying, urgency, frequency, and nighttime urination; severe retention or kidney effects require medical care.

\medterm{Bradycardia (Slow Heart Rate)} A slower-than-expected heart rate. It may be normal in some people or result from conduction disease, medicines, metabolic problems, or heart disease; fainting, chest pain, breathlessness, or confusion requires urgent assessment.

\medterm{Brain Tumors in Adults} Tumors arising in or near the adult brain, including primary gliomas, meningiomas, metastases, and other lesions. Symptoms depend on location and may include headache, seizures, weakness, personality change, vision problems, or cognitive decline.

\medterm{Brain Tumors, General} Abnormal growths of cells within the brain or its coverings. They may be benign or malignant, primary or metastatic, and can cause symptoms by invading tissue, blocking fluid flow, bleeding, or increasing intracranial pressure.

\medterm{Brazilian Pemphigus Foliaceus} An endemic form of superficial pemphigus seen especially in parts of Brazil, also called fogo selvagem. Autoimmune attack on epidermal cell connections causes fragile superficial blisters and erosions without the deep mucosal disease typical of pemphigus vulgaris.

\medterm{Brazilian Trypanosomiasis} Chagas disease, a parasitic infection caused by \textit{Trypanosoma cruzi}. It is transmitted mainly by triatomine insects or congenitally and may later cause cardiomyopathy, arrhythmias, megaesophagus, or megacolon.

\medterm{Breast Cancer and Pregnancy} Breast cancer diagnosed during pregnancy or shortly after delivery. Evaluation and treatment are individualized to the cancer stage and gestational age; some surgery and chemotherapy can be given during pregnancy, while radiation and certain targeted medicines are generally deferred.

\medterm{Breast Cancer and Your Genes} The role of inherited genetic variants in breast-cancer risk, including changes in \textit{BRCA1}, \textit{BRCA2}, PALB2, and other genes. Genetic counseling helps determine whether testing and enhanced screening are appropriate.

\medterm{Breast Cancer in Men} Breast cancer arising in male breast tissue. It is uncommon but may present as a painless lump, nipple retraction, discharge, or skin change and requires prompt diagnostic imaging and biopsy.

\medterm{Breast Cancer, Metastatic or Recurrent} Breast cancer that has returned after treatment or spread to distant organs. Treatment is guided by the site of disease, hormone-receptor and HER2 status, prior therapy, symptoms, and the person’s goals.

\medterm{Breast Development in Boys} Enlargement or development of breast tissue in a boy, most often gynecomastia caused by a temporary imbalance between estrogen and androgen effects. Persistent, painful, asymmetric, or rapidly enlarging tissue needs assessment.

\medterm{Breast Infection (Mastitis)} Inflammation or infection of breast tissue, often during breastfeeding but also possible in other settings. Pain, redness, warmth, swelling, fever, and a lump may occur; an abscess can develop if infection persists.

\medterm{Breast Lumps (Benign)} Noncancerous breast masses such as cysts, fibroadenomas, fat necrosis, or fibrocystic changes. A new, persistent, hard, fixed, enlarging, or otherwise concerning lump requires clinical evaluation and appropriate imaging.

\medterm{Breast Pain (Mastalgia)} Pain or tenderness in one or both breasts. It may be cyclic, related to hormones, injury, cysts, infection, medicines, or chest-wall structures; a new mass, skin change, discharge, or persistent focal pain warrants assessment.

\medterm{Buerger’s Disease} Thromboangiitis obliterans, an inflammatory clotting disease of small and medium arteries and veins, strongly associated with tobacco or nicotine exposure. It can cause painful fingers or toes, ulcers, and tissue loss; complete nicotine cessation is essential.

\medterm{Bulbospinal Muscular Atrophy, X-linked} Kennedy disease, an inherited androgen-receptor disorder that causes gradually progressive lower motor-neuron weakness, muscle wasting, cramps, tremor, swallowing or speech difficulty, and sometimes endocrine changes.

\medterm{Bullosa Hereditaria} A broad historical term for inherited epidermolysis bullosa, a group of genetic disorders in which minor friction causes skin or mucosal blistering. Severity ranges from mild localized disease to multisystem complications.

\medterm{Bunyavirus Infection} Infection caused by a bunyavirus, a group that includes viruses responsible for illnesses such as hantavirus disease, Rift Valley fever, and some mosquito- or tick-borne febrile syndromes. Symptoms and treatment depend on the specific virus.
