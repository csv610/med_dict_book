...
\medterm{Bacterial Metabolism} The chemical reactions bacteria use to obtain energy, build cell material, grow, and survive. Different bacteria use oxygen, fermentation, light, or other chemical substances, and some of these reactions are targets for antibiotics.
...
\medterm{Bacterial Pathogenesis} The ways bacteria enter the body, attach to cells, invade tissues, avoid immune defenses, and cause damage. Harm may result from direct invasion, toxins, inflammation, or disruption of normal body functions.
...
\medterm{Bacterial Virulence Factors} Features that help bacteria cause disease, such as attaching to cells, entering tissues, avoiding immune defenses, producing toxins, or obtaining nutrients. Examples include surface proteins, capsules, enzymes, and toxins.
...
\medterm{Bacteriocin} A protein or small protein-like substance made by some bacteria that inhibits or kills susceptible bacteria, often competing strains living nearby.
...
\medterm{Bacteriophage Lambda} A virus that infects the bacterium Escherichia coli. It may make copies of itself and break open the bacterial cell, or insert its DNA into the bacterial chromosome and remain inactive.
...
\medterm{Bacteroidaceae} A family of bacteria that commonly live in the intestine and grow without oxygen. They are usually harmless in the gut but can cause abscesses or other infections if they enter normally sterile tissues.
...
\medterm{Ballistocardiography} A method of recording tiny movements of the body caused by blood being pumped with each heartbeat. It has mainly been used in research to study heart function and circulation.
...
\medterm{Band Cell} An immature neutrophil, a type of white blood cell, whose nucleus has a curved band-like shape rather than separate segments. Increased numbers may occur when the bone marrow responds to infection or inflammation.

\medterm{Band Keratopathy} A horizontal strip of calcium deposits in the clear front surface of the eye. It may result from long-term eye inflammation or high calcium levels and can cause irritation, blurred vision, or reduced sight.
...
\medterm{Bankart Lesion} A tear in the front-lower rim of the shoulder socket, usually caused by the upper arm coming out of the socket. It can make the shoulder unstable and increase the chance of repeated dislocation.
...
\medterm{Banti Syndrome} An older term for enlargement of the spleen and low blood-cell counts caused by high pressure in the portal vein system. Modern evaluation looks for the liver, vein, or blood disorder causing these findings.
...
\medterm{Barakat Syndrome} An inherited disorder involving low parathyroid hormone, hearing loss, and kidney abnormalities. These features may occur together because of changes affecting development of several organs.
...
\medterm{Barium-133} A radioactive form of barium used mainly as a calibration source for radiation detectors and imaging equipment. It is not a routine diagnostic or treatment medicine.
...
\medterm{Basal Body} A small structure at the base of a cilium or flagellum that anchors it to the cell and helps start the internal framework responsible for movement.
...
\medterm{Batroxobin} An enzyme derived from snake venom that changes fibrinogen, a blood protein, into fibrin and promotes clot formation. It has been studied or used in selected bleeding and clotting settings and can affect bleeding risk.
...
\medterm{Bayes Theorem} A mathematical rule for updating the chance of a diagnosis after new evidence. It combines how likely the disease was beforehand with how strongly the test result supports or argues against it.
...
\medterm{Beam Hardening Artifact} An inaccurate area on a CT image caused when bone or metal removes some X-ray energies before the beam reaches the detector. It may appear as dark bands or streaks and can obscure nearby structures.
...
\medterm{Belinostat} Belinostat is a histone-deacetylase inhibitor used for selected relapsed or refractory peripheral T-cell lymphomas. A cancer medicine that inhibits histone deacetylases, used for selected relapsed or treatment-resistant peripheral T-cell lymphomas.
...
\medterm{Bence Jones Protein} An abnormal antibody fragment, called a free light chain, made by some plasma-cell disorders. It may appear in urine or blood and can help diagnose these disorders, but it can also damage the kidneys.
...
\medterm{Bends} A form of decompression sickness caused by gas bubbles forming in the body after pressure falls too quickly, usually during or after diving. It commonly causes deep joint or muscle pain but may also affect the brain, spinal cord, or lungs.

\medterm{Benedikt'S Syndrome} A rare pattern of neurological problems caused by damage in the midbrain. It may produce a drooping eyelid or double vision on one side and tremor, poor coordination, or involuntary movements on the opposite side.
...
\medterm{Beta 2-Microglobulin} A small protein released by most cells. Blood or urine levels may rise with inflammation, some blood cancers, or reduced kidney clearance; the test is interpreted with other findings.
...
\medterm{Beta Globulin} A group of blood proteins that move together in one region during protein electrophoresis. They include transferrin, complement proteins, and some fat-carrying proteins; abnormal levels can occur with inflammation, liver disease, or immune disorders.

\medterm{Beta Particle} A fast-moving electron or its positively charged counterpart released by some radioactive atoms. Beta particles can damage tissue and are used in selected radiation treatments and laboratory applications.

\medterm{Beta Radiation} Radiation made of fast electrons or positrons released by unstable atoms. It can injure living tissue but can also be directed at selected tissues for treatment or used in medical testing.
...
\medterm{Beta-Chemokines} Small immune-signalling proteins that attract white blood cells to areas of infection or inflammation. They help coordinate immune responses, but excessive activity can contribute to chronic inflammation and tissue damage.

\medterm{Beta-Endorphin} A natural pain-relieving chemical made in the brain and pituitary gland. It acts on opioid receptors and helps influence pain, stress responses, mood, and some hormone functions.
...
\medterm{Biomechanical Compliance} How much a body structure changes size or shape when pressure or force is applied. Lung and blood-vessel compliance affect breathing and blood flow; joint compliance affects movement and stability.
...
\medterm{Bitemporal Hemianopia} Loss of the outer half of the visual field in both eyes. It usually results from pressure or damage at the point where the optic nerves cross, often from a pituitary or nearby brain lesion.
