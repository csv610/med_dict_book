...
\medterm{Breathlessness} The subjective sensation of breathing discomfort or heightened work of breathing consisting of qualitatively distinct sensations (such as air hunger or chest tightness) triggered by respiratory, cardiovascular, neuromuscular, metabolic, or psychological disorders.

\synonyms
Dyspnea; Dyspnoea; Shortness of Breath; Breathlessness
...
\medterm{Dental Bridge} A fixed prosthodontic appliance used to replace one or more missing teeth by permanently joining an artificial tooth (pontic) to adjacent natural abutment teeth or osseointegrated dental implants.

\synonyms
Fixed Partial Denture; Bridge, Dental; Dental Prosthesis
