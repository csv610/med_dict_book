...
\medterm{B Cell (B Lymphocyte)} Alternate name; see \textit{B Cell}.
...
\medterm{Barretts Esophagus (Barrett's Esophagus)} Alternate spelling; see \textit{Barrett Esophagus}.
...
\medterm{Blood In The Semen} Alternate name; see \textit{Blood In Semen}.

\medterm{Blood In The Stool (Rectal Bleeding)} Alternate index label for Rectal Bleeding.

\medterm{Blood In The Urine} Alternate name; see \textit{Blood In Urine (Hematuria)}.

\medterm{Blood In Urine} Alternate name; see \textit{Blood In Urine (Hematuria)}.
...
\medterm{Bone Cancer Overview} Alternate name; see \textit{Bone Cancer}.
...
\medterm{Bowlegs} Alternate name; see \textit{Bow Legs (Genu Varum)}.
...
\synonyms
Beta Thalassemia Trait; beta-thalassemia minor; thalassemia minor
\medterm{Breast Lumps} Alternate index label; see \textit{Breast Lumps In Women}.
