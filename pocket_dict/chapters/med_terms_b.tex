...
\medterm{Benign Positional Vertigo} Alternate index label for Benign Paroxysmal Positional Vertigo.
...
\medterm{Binge Eating Disorder} Alternate index label for Binge-Eating Disorder.
...
\medterm{Bleeding Disorders} Alternate index label for Bleeding Disorder.
...
\medterm{Bulimia Nervosa} An eating disorder involving repeated binge-eating episodes followed by vomiting, laxative misuse, fasting, excessive exercise, or other behaviors intended to compensate. Body shape or weight strongly influences self-worth, and medical complications can be serious.
