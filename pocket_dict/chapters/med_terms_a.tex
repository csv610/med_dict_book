...
\medterm{Acetaminophen Poisoning} Alternate index label; see \textit{Acetaminophen overdose}.
...
\medterm{Adenoid Hypertrophy} Enlargement of the adenoids, immune tissue behind the nose. It can block nasal breathing and the openings of the eustachian tubes, causing mouth breathing, snoring, sleep apnea, nasal speech, or repeated middle-ear problems.
...
\medterm{Antinuclear Antibodies (ANA)} Blood antibodies directed against substances inside cell nuclei. They may support evaluation of autoimmune disease but can also occur in healthy people or with infections, so a positive result is not diagnostic by itself.
...
\medterm{Apnea Sleep (Sleep Apnea)} Alternate index label for Sleep Apnea.
...
\medterm{Asperger Syndrome} A former diagnostic term for a pattern of autistic traits involving social-communication differences and restricted or repetitive interests or behaviors, traditionally without major intellectual or early language delay. Current diagnostic systems generally include it within autism spectrum disorder.

\medterm{Asperger's Syndrome} Alternate index label; see \textit{Asperger syndrome}.
...
\medterm{Aspirin} A medicine also called acetylsalicylic acid that reduces pain, fever, and inflammation and makes platelets less likely to clump. It can affect the stomach, cause bleeding or allergic reactions, and produce toxicity in excessive amounts.
...
\medterm{Aspirin Overdose} Poisoning after taking too much aspirin. It may cause ringing in the ears, vomiting, rapid breathing, confusion, fever, seizures, coma, or dangerous changes in blood acidity.

\medterm{Aspirin Poisoning} Alternate index label; see \textit{Aspirin overdose}.
...
\medterm{Attention Deficit Hyperactivity Disorder (ADHD)} Alternate index label; see \textit{Attention-Deficit/Hyperactivity Disorder}.
...
\medterm{Avoidant/Restrictive Food Intake Disorder} An eating disorder in which a person persistently avoids or restricts food because of sensory sensitivity, low interest in eating, or fear of choking, vomiting, or another harmful consequence. It can lead to poor nutrition, weight loss, dependence on supplements, or problems with daily functioning without being driven by body-image concerns.
