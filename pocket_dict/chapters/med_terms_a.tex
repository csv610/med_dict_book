...
\medterm{Acantholysis} Loss of attachment between epidermal cells, causing cells to separate. Loss of attachment between cells in the outer layer of the skin, causing the cells to separate.
...
\medterm{Adherens Junction} A connection between neighboring cells using cadherin proteins and actin fibers, helping hold tissues together and maintain their shape, strength, and coordinated function.
...
\medterm{ADME} Abbreviation for absorption, distribution, metabolism, and excretion—the processes that determine how a medicine enters the body, moves through it, is chemically changed, and leaves.
\synonyms
Pharmacokinetics
...
\medterm{Anti-NMDA Receptor Encephalitis} A serious autoimmune inflammation of the brain caused by antibodies that disrupt a brain receptor involved in learning and communication. It may cause psychiatric changes, memory problems, seizures, abnormal movements, reduced consciousness, and unstable heart rate or blood pressure.
...
\medterm{Apoptosis Extrinsic Pathway} A route to controlled cell death that begins when outside signals attach to specific death receptors on a cell surface. These signals activate internal enzymes that dismantle the cell.
