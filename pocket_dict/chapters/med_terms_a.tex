...
\medterm{Abdomen - Swollen} Alternate name; see \textit{Abdominal Distension}.
...
\medterm{Acanthocytes (Spur Cells)} Alternate name; see \textit{Acanthocyte}.
...
\medterm{Adult Rickets} An older or usually inaccurate term for poor mineralization of adult bone, which is more correctly called osteomalacia. It may cause bone pain, muscle weakness, fractures, or difficulty walking and can result from vitamin-D deficiency, poor absorption, kidney disease, or phosphate loss.
...
\medterm{Aspirin (Salicylate) Toxicity} Poisoning caused by too much aspirin or another salicylate. Early symptoms may include ringing in the ears, vomiting, sweating, and fast breathing; severe poisoning can cause confusion, high temperature, seizures, coma, or dangerous changes in the blood's acid level.
...
\medterm{Atherectomy (Vascular)} Alternate name; see \textit{Atherectomy}.
