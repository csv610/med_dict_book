...
\medterm{Anti-Double-Stranded DNA (Anti-dsDNA) Antibody} An antibody directed against a form of DNA inside cells. A blood test for it can support a diagnosis of lupus and may be higher when lupus is active, especially when the kidneys are affected, but it is not diagnostic alone.
...
\medterm{Antibody-Dependent Cell-Mediated Cytotox.} An immune process in which killer immune cells recognize antibodies attached to an infected, abnormal, or cancerous cell and then destroy the marked cell.
...
\medterm{Antimicrobial Pharmacodynamics} The study of how an infection-fighting medicine affects a microorganism at different amounts and exposure times. It helps clinicians choose a dose and schedule that suppress the infection while limiting harm and resistance.

\medterm{Antimicrobial Pharmacokinetics} The study of how the body absorbs, distributes, breaks down, and removes an infection-fighting medicine. Kidney or liver disease, age, body size, and other medicines can change the dose or timing needed.
