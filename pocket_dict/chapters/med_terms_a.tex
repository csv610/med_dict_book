...
\medterm{Anaplasia} A change in which cells lose the specialized appearance and organized arrangement expected for their tissue. It is often found in high-grade cancers and may indicate that the cells are behaving aggressively.
...
\medterm{Ancillary Test (Pathology)} An additional test used with routine microscopic examination of a tissue sample to clarify a diagnosis. It may use special stains, antibody markers, chromosome analysis, or genetic testing to identify the tissue or disease more precisely.
