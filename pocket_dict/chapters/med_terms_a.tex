...
\medterm{Aminotransferase} An enzyme that transfers a chemical group from one amino acid to another molecule. Blood levels of enzymes such as ALT and AST may rise when liver, muscle, or other cells are injured.
...
\medterm{AMPK} A system inside cells that detects when energy is low. When activated, it encourages energy production and reduces energy-consuming activities such as making fat and proteins until the cell’s energy supply improves.
