...
\medterm{ACC (Adenoid Cystic Carcinoma)} Abbreviation; see \textit{Adenoid Cystic Carcinoma}.
...
\medterm{Acute Coronary Syndrome} A sudden reduction in blood flow to the heart muscle, usually caused by a blood clot at a break in a fatty artery plaque. It includes unstable angina and heart attacks and needs urgent medical assessment.
...
\medterm{Acute Pericarditis} Rapid-onset inflammation of the pericardial sac surrounding the heart, commonly caused by viral infections, autoimmune conditions, or myocardial infarction. Typical features include sharp pleuritic chest pain relieved by sitting forward, a pericardial friction rub on auscultation, and widespread ST-segment elevation on electrocardiogram.
...
\medterm{Acceptable Daily Intake (ADI)} The estimated amount of a substance that a person can consume every day throughout life without a meaningful health risk, based on available evidence and safety margins. It is usually expressed per kilogram of body weight.
...
\medterm{Affective Disorder} A broad category of psychiatric and mood conditions characterized primarily by persistent disturbances in mood, affect, and emotional regulation, encompassing major depressive disorder, bipolar disorders, and persistent depressive disorder (dysthymia).
