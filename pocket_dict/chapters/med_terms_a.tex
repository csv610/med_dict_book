...
\medterm{Adrenal Insufficiency} A condition in which the body does not make enough cortisol and sometimes not enough aldosterone. It may result from adrenal-gland damage, problems with pituitary signals, or prolonged steroid treatment, causing fatigue, low blood pressure, weight loss, or an adrenal crisis.
...
\medterm{Adrenomedullin} A hormone-like substance made by many tissues that widens blood vessels and helps control blood pressure, circulation, fluid balance, kidney function, and the body’s response to injury.
