...
\medterm{Amotivational Syndrome} A descriptive and debated term for reduced drive, initiative, concentration, or goal-directed activity, historically associated with prolonged cannabis use but also seen with depression, psychosis, substance use, medication effects, or other conditions. It is not a standalone diagnosis in current major classifications.
...
\medterm{Analgesic} A medicine that reduces or relieves pain; see \textit{Analgesics}.
...
\medterm{Anesthetic} A medicine that temporarily reduces sensation, awareness, or pain during a procedure. Local, regional, and general anesthetics differ in the tissues and brain functions they affect.
...
\medterm{Antibiotic} A medicine that kills bacteria or stops them from multiplying; see \textit{Antibiotics}.
...
\medterm{Anticoagulant} A medicine that reduces the formation or growth of blood clots by slowing the clotting process; see \textit{Anticoagulation}.
...
\medterm{Antidepressant} A medicine used mainly to treat depression; see \textit{Antidepressants}.
...
\medterm{Antifungal} A medicine that kills fungi or stops their growth. Antifungal medicines are used for infections of the skin, nails, mucous membranes, or internal organs.
...
\medterm{Antihypertensive} A medicine used to lower high blood pressure. Major groups include diuretics, medicines that affect the renin–angiotensin system, calcium-channel blockers, and medicines that reduce sympathetic activity.
...
\medterm{Antipsychotic} A medicine used to reduce psychosis; see \textit{Antipsychotic Medicine}.
...
\medterm{Antiviral} A medicine that inhibits the multiplication of viruses or limits their effects. Antiviral medicines are directed at particular viruses or stages of viral replication.
