...
\medterm{Tangier Disease} A rare inherited disorder caused by harmful changes in both copies of the \textit{ABCA1} gene, which normally helps move cholesterol and phospholipids out of cells to form HDL. It causes extremely low HDL and apolipoprotein A-I levels and cholesterol buildup in tissues. Features may include enlarged yellow-orange tonsils, an enlarged liver or spleen, peripheral neuropathy, mild high triglycerides, low platelets, or corneal clouding; cardiovascular risk is increased in some people. Diagnosis uses lipid and apolipoprotein testing plus genetic testing, and care focuses on cardiovascular-risk reduction and treatment of complications.
...
\medterm{Teratogenesis} The process by which an embryo or fetus develops a structural birth defect, impaired growth, abnormal function, or pregnancy loss after harmful genetic, infectious, nutritional, environmental, or medicine exposure. Risk depends on the agent, dose, route, timing, and genetic susceptibility; the first trimester is especially important because major organs are forming. Exposure does not automatically mean that a birth defect will occur, so suspected exposure should be discussed with a clinician or teratology service.
...
\medterm{Transplant Immunology} The study of how the immune system recognizes and responds to transplanted organs, tissues, or cells. Donor-recipient blood type, human leukocyte antigen (HLA) matching, and antibody crossmatching help estimate rejection risk. Hyperacute rejection results from pre-existing donor-specific antibodies and can occur within minutes to hours; acute rejection is usually driven by T cells or newly formed antibodies, while chronic rejection causes gradual scarring and loss of graft function. Immunosuppressive medicines reduce rejection but increase infection and some cancer risks, so drug levels and graft function need regular monitoring.
