...
\medterm{Trachoma} Trachoma is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{Traction} Traction examines traction; interpretation depends on the specimen or body region, test method, reference range, and clinical question.
...
\medterm{tacrine} tacrine is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tacrolimus} tacrolimus is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tactile agnosia} tactile agnosia is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tadalafil} tadalafil is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{taenia} taenia is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{taenia saginata} taenia saginata is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{taenia solium} taenia solium is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{taeniasis} Intestinal infection with adult Taenia tapeworms acquired by eating undercooked infected beef or pork, often causing few symptoms but sometimes abdominal discomfort or passage of segments.
...
\medterm{tamoxifen} tamoxifen is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tamoxifen citrate} tamoxifen citrate is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tamsulosin} tamsulosin is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tamsulosin hydrochloride} tamsulosin hydrochloride is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tandutinib} tandutinib is a medication or pharmacologic agent; its indication, dose, interactions, contraindications, and adverse effects depend on the specific product and patient.
...
\medterm{tapentadol} tapentadol is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{taq polymerase} taq polymerase is a biochemical, genetic, or cellular term used in medicine; its significance depends on its structure, function, concentration, pathway, or clinical context.
...
\medterm{taste bud} taste bud is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{taste disorder} taste disorder describes a clinical disorder or finding in the body system or process named by the term. Evaluation identifies the underlying mechanism, affected site, severity, and clinically relevant complications.
...
\medterm{tenericutes} tenericutes is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{teniposide} Teniposide is a podophyllotoxin-derived antineoplastic drug that inhibits topoisomerase II and is used in selected leukemia or lymphoma regimens.
...
\medterm{terazosin} terazosin is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{terazosin hydrochloride} terazosin hydrochloride is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{terbufos} Terbufos is a highly toxic organophosphate pesticide that inhibits acetylcholinesterase and can cause severe cholinergic poisoning.

\medterm{terbutaline} terbutaline is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{terfenadine} terfenadine is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{terlipressin} Terlipressin is a vasopressin analogue that constricts splanchnic vessels and is used in selected cases of variceal bleeding or hepatorenal syndrome.
...
\medterm{tick} tick is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tigecycline} tigecycline is a medication or pharmacologic agent; its indication, dose, interactions, contraindications, and adverse effects depend on the specific product and patient.
...
\medterm{tinea favosa} tinea favosa is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tinidazole} tinidazole is a medication or pharmacologic agent; its indication, dose, interactions, contraindications, and adverse effects depend on the specific product and patient.

\medterm{tinzaparin} tinzaparin is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tinzaparin sodium} tinzaparin sodium is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tiopronin} tiopronin is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tipifarnib} tipifarnib is a medication or pharmacologic agent; its indication, dose, interactions, contraindications, and adverse effects depend on the specific product and patient.
...
\medterm{tirofiban} tirofiban is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tissierella} tissierella is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tissierella praeacuta} tissierella praeacuta is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tissue adhesions} Bands of fibrous scar tissue that abnormally connect surfaces or organs, often after surgery, inflammation, infection, or bleeding and potentially causing pain, infertility, or obstruction.
...
\medterm{tolazamide} tolazamide is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tolcapone} tolcapone is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tolmetin} tolmetin is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tolnaftate} tolnaftate is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tolonium chloride} Tolonium chloride, or toluidine blue, is a dye used in laboratory and selected clinical procedures to highlight cells or tissue changes.
...
\medterm{tolvaptan} tolvaptan is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{tomography} tomography is a diagnostic test, specimen, imaging method, score, instrument, or measurement used to answer a clinical or laboratory question; results must be interpreted with the method and reference range.
...
\medterm{topiramate} topiramate is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{topoisomerase ii} topoisomerase ii is a biochemical, genetic, or cellular term used in medicine; its significance depends on its structure, function, concentration, pathway, or clinical context.

\medterm{topoisomerase inhibitors} topoisomerase inhibitors is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{topotecan} topotecan is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{topotecan hydrochloride} topotecan hydrochloride is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{toremifene} toremifene is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{torsade de pointes} Torsade de pointes is a potentially fatal polymorphic ventricular tachycardia associated with prolonged QT, electrolyte disturbance, medicines, or inherited channel disorders.

\medterm{torsemide} torsemide is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{torsion dystonia} A movement disorder causing sustained or repetitive muscle contractions that twist the body or limbs into abnormal postures; it may be inherited, acquired, focal, or generalized.

\medterm{torulaspora} torulaspora is a medical term describing the named concept; its precise interpretation depends on its defining features, associated findings, and clinical context.\medterm{torulaspora delbrueckii} torulaspora delbrueckii is a biological organism or infectious agent; its clinical importance depends on the species, host, site, exposure, and evidence of infection or colonization.
