...
\medterm{Torticollis} Torticollis is abnormal neck posture with head tilt or rotation, caused by muscle spasm, injury, congenital shortening, neurologic disease, or other conditions.
...
\medterm{Tracheitis} Tracheitis is inflammation or infection of the windpipe, causing cough, pain, fever, noisy breathing, and occasionally dangerous airway narrowing.
...
\medterm{Tremor} A tremor is involuntary rhythmic shaking caused by alternating muscle activity, occurring at rest, with posture, or during movement.
...
\medterm{Trichinosis} Trichinosis is infection with Trichinella larvae after eating undercooked infected meat, causing gastrointestinal symptoms followed by muscle pain, fever, or swelling around the eyes.
...
\medterm{Tuberous sclerosis} Tuberous sclerosis complex is an inherited disorder causing benign tumors or malformations in the brain, skin, kidneys, heart, lungs, and other organs, often with seizures or developmental effects.
...
\medterm{tactile agnosia} tactile agnosia is a defined medical or biomedical term describing a specific process, finding, measurement, structure, or research concept; its identifying features depend on the named context.
...
\medterm{taste bud} taste bud is a defined medical or biomedical term describing a specific process, finding, measurement, structure, or research concept; its identifying features depend on the named context.
...
\medterm{t-lymphocyte} A T lymphocyte is an immune cell that recognizes antigen and coordinates immune responses or directly kills infected or abnormal cells.
...
\medterm{tomography} tomography is a diagnostic test, specimen, imaging method, score, instrument, or measurement used to answer a clinical or laboratory question; results must be interpreted with the method and reference range.
...
\medterm{tonsil} A tonsil is a mass of lymphoid tissue at the entrance to the throat that participates in immune surveillance; enlarged or infected tonsils can obstruct breathing or swallowing.
...
\medterm{Thromboangiitis obliterans} Thromboangiitis obliterans, or Buerger disease, is inflammatory clotting and narrowing of small and medium vessels strongly associated with tobacco use and risking limb ischemia.
...
\medterm{Tubercle} A tubercle is a small rounded projection or nodule, commonly a normal bony prominence or a lesion associated with infection or inflammation.
...
\medterm{Tactile} Tactile is a defined medical, biological, or research term; it describes the named process, measurement, structure, or finding and is interpreted with the surrounding clinical information.
...
\medterm{Tartar} Tartar, or dental calculus, is mineralized plaque firmly attached to teeth and capable of contributing to gingivitis, periodontitis, and bad breath.
...
\medterm{Temple} The temple is the side of the head between the forehead and ear, overlying the temporal bone and superficial temporal vessels.

\medterm{Temporal} Temporal means relating to the temple, temporal bone, temporal lobe, or time, depending on the clinical context.
...
\medterm{Tenormin} Tenormin is the brand name for atenolol, a beta blocker used for selected cardiovascular conditions and requiring attention to heart rate, blood pressure, and asthma risk.
...
\medterm{Thrombocyte} A thrombocyte, or platelet, is a blood-cell fragment that helps form clots and stop bleeding after vessel injury.
...
\medterm{Tic} A tic is a sudden, recurrent, nonrhythmic motor movement or vocalization that is difficult to suppress and commonly occurs in tic disorders.
...
\medterm{Titre} Titre is a laboratory test, imaging method, instrument, score, or measurement used to characterize a specimen or clinical finding; interpretation depends on the method and clinical context.
...
\medterm{Transverse} Transverse means lying across or perpendicular to a long axis, such as a transverse body plane dividing upper and lower portions.
...
\medterm{Trimox} Trimox is a brand name for amoxicillin, a penicillin-family antibiotic used for selected susceptible bacterial infections.
...
\medterm{Trochanter} A trochanter is a bony projection of the femur that serves as an attachment site for muscles and tendons around the hip.
...
\medterm{Turgor} Turgor is the firmness or elasticity of tissue produced by fluid and pressure; reduced skin turgor can suggest dehydration but is an imperfect sign.
...
\medterm{Tylenol} Tylenol is a brand name for acetaminophen, a pain reliever and fever reducer whose overdose can cause severe liver injury.
