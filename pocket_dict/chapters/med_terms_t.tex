...
\medterm{Thiamin} Alternate index label; see \textit{Thiamine}.
...
\medterm{Thiamine (Vitamin B1)} Alternate index label; see \textit{Thiamine}.
...
\medterm{Thyroid-Stimulating Hormone} Alternate index label; see \textit{Thyroid Stimulating Hormone}.
...
\synonyms
Short Lingual Frenulum; Anchyloglossia
...
\medterm{Tricuspid Valve Disease} Alternate index label; see \textit{Tricuspid regurgitation} and \textit{Tricuspid stenosis}.
...
\synonyms
Enteric Fever; Salmonella Typhi Infection
