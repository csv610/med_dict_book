...
\medterm{Tactile} Pertaining to, perceived by, or relating to the sense of touch (\textit{tactus}). Mediated by specialized cutaneous mechanoreceptors embedded within the dermis and epidermis: Meissner corpuscles (low-frequency vibration, light dynamic touch), Merkel discs (static pressure, fine tactile edge and form discrimination), Pacinian corpuscles (high-frequency vibration), and Ruffini endings (skin stretch). Sensory tactile signals ascend via large myelinated $A\beta$ primary afferents through the dorsal column-medial lemniscal (DCML) pathway to the contralateral primary somatosensory cortex. Assessed clinically using two-point discrimination tests, monofilament testing in diabetic peripheral neuropathy, and tactile fremitus during thoracic lung examination.
...
\medterm{Tandutinib} An investigational tyrosine-kinase inhibitor studied mainly for myeloproliferative disorders and cancer.
...
\medterm{Targeted Radiation Therapy} Radiation treatment aimed closely at a tumor or other abnormal area to damage it while limiting exposure to nearby healthy tissue.
...
\medterm{Tarui Disease} An autosomal recessive metabolic myopathy (Glycogen Storage Disease Type VII [GSD VII]) caused by deficiency of the muscle isoform of phosphofructokinase (\textit{PFKM}), the key rate-limiting enzyme of glycolysis catalyzing the conversion of fructose-6-phosphate to fructose-1,6-bisphosphate. Impairs energy generation from both muscle glycogen and blood-borne glucose. Characterized clinically by exercise-induced muscle fatigue, weakness, painful cramping, and rhabdomyolysis, exacerbated by high-carbohydrate meals (which paradoxically lower exercise tolerance by suppressing fatty acid oxidation), accompanied by compensated non-spherocytic hemolytic anemia and hyperuricemia.
...
\medterm{Taussig-Bing Anomaly} A rare, complex cyanotic congenital heart malformation categorized as a form of double outlet right ventricle (DORV), characterized anatomically by both great arteries arising predominantly or entirely from the right ventricle, with the aorta positioned side-by-side or anterior to the pulmonary artery, accompanied by a committed, subpulmonic ventricular septal defect (VSD). Hemodynamically resembles D-transposition of the great arteries with a large VSD, wherein oxygenated pulmonary venous blood preferentially streams from the left ventricle across the subpulmonic VSD directly into the pulmonary artery, and systemic venous blood enters the right ventricle and aorta, resulting in severe early cyanosis, pulmonary arterial hypertension, and congestive heart failure, corrected surgically in infancy by an arterial switch operation and VSD closure.
...
\medterm{Tay-Sachs Disease} An inherited autosomal-recessive lysosomal storage disease
caused by disease-causing variants in both copies of the HEXA gene. Reduced
beta-hexosaminidase A activity causes GM2 ganglioside to accumulate in nerve cells.
The infantile form causes developmental regression, exaggerated startle, weakness,
seizures, and often a cherry-red spot on the retina, with severe progression and death
usually in early childhood. Juvenile and adult forms can begin later and progress more
slowly, with variable movement, coordination, speech, or psychiatric problems. Carrier
frequency is higher in some populations, including Ashkenazi Jewish, French Canadian,
and Cajun communities, but the disease can occur in any ancestry. There is currently
no curative treatment; supportive care, genetic counseling, and appropriate carrier or
diagnostic testing are important.
...
\medterm{Tele Radiology (Teleradiology)} The medical practice and technology of transmitting digital radiological patient images (such as plain radiographs, CT scans, MRIs, and ultrasonograms) across telecommunication networks from the site of acquisition to off-site, remote radiologists for the purposes of primary interpretation, emergency triage, or secondary expert subspecialty consultation. Utilizes standardized Picture Archiving and Communication Systems (PACS) and Digital Imaging and Communications in Medicine (DICOM) data transmission protocols with secure encryption compliant with healthcare privacy regulations. Essential for providing continuous 24/7 overnight emergency coverage to community hospitals and rural trauma centers.
...
\medterm{Tenascin} A family of extracellular-matrix proteins involved in cell adhesion, tissue development, wound healing, and tumor biology.
...
\medterm{Tenotomy} The surgical cutting, division, or transection of a tendon, performed through open, percutaneous, or endoscopic approaches. Utilized in orthopedic, pediatric, and ophthalmic surgery to relieve severe muscle contractures, eliminate pathological spastic deforming forces, or rebalance joint kinematics. Classic applications include percutaneous Achilles tenotomy (a key step in the Ponseti method for correcting congenital talipes equinovarus / clubfoot), extraocular muscle tenotomy (to adjust alignment in strabismus surgery), and release of contracted flexor tendons in cerebral palsy or stroke spasticity.
...
\medterm{Tet Spell} An acute, paroxysmal, life-threatening hypercyanotic episode occurring in infants and young children with unrepaired Tetralogy of Fallot. Triggered by crying, defecation, feeding, pain, or exertion, which causes catecholamine release and infundibular spasm of the right ventricular outflow tract, resulting in a dramatic increase in right-to-left intracardiac shunting through the ventricular septal defect, hypoxemia, metabolic acidosis, and profound cyanosis. Emergency management includes calming the child, placing the patient in a knee-to-chest position (which increases systemic vascular resistance and reduces right-to-left shunting), administering supplemental oxygen, intravenous fluids, and morphine or beta-blockers (propranolol).
...
\medterm{Theca Lutein Cyst} A benign, functional ovarian cyst characteristically occurring bilaterally and filled with clear straw-colored fluid, resulting from hyperstimulation and marked luteinization of thecal cells driven by abnormally high circulating levels of human chorionic gonadotropin ($\beta$-hCG). Strongly associated with gestational trophoblastic disease (hydatidiform mole and choriocarcinoma), multiple gestations, and clomiphene or gonadotropin therapy, typically resolving spontaneously once $\beta$-hCG levels normalize.
...
\medterm{Thermoreceptor} A specialized free sensory nerve ending or receptive ending that detects physiological variations in local temperature and thermal gradients, classified into cool/cold receptors and warm/heat receptors. Cold receptors are primarily mediated by transient receptor potential (TRP) channels such as TRPM8 (activated at $10{-}25^\circ\text{C}$ and by menthol) transmitting via thinly myelinated $A\delta$ fibers, whereas warm receptors are mediated by channels such as TRPV1 (activated by temperatures $>43^\circ\text{C}$ and capsaicin) transmitting via unmyelinated C fibers. Afferent signals ascend through the spinothalamic tract to the preoptic area of the hypothalamus to regulate systemic autonomic thermoregulation (sweating, shivering, cutaneous vasodilation, and vasoconstriction).
...
\medterm{ThinPrep Pap Test} A cervical cancer screening test in which cells collected from the cervix are placed in a liquid preservative and examined for abnormal changes.
...
\medterm{Third-Degree Perineal Tear} A severe perineal laceration sustained during vaginal birth that involves the perineal muscles and extends into the anal sphincter complex, classified under Obstetric Anal Sphincter Injuries (OASIS). Subdivided internationally into 3a (<50\% thickness of the external anal sphincter torn), 3b ($\ge 50\%$ thickness of the external anal sphincter torn), and 3c (both external and internal anal sphincters torn). It requires prompt identification, layered surgical repair in an operating room under adequate regional anesthesia, and proactive postpartum management with laxatives, pelvic floor therapy, and antibiotics to prevent anal incontinence and rectovaginal fistula.
...
\medterm{Thomsen Disease} The classic autosomal dominant form of myotonia congenita caused by heterozygous mutations in the \textit{CLCN1} gene on chromosome 7q35, which encodes the skeletal muscle voltage-gated chloride channel ClC-1. Characterized by delayed muscle relaxation following voluntary contraction (myotonia) with childhood onset, commonly affecting the hands, legs, eyelids, and jaw. A defining clinical feature is the ``warm-up phenomenon,'' wherein muscle stiffness significantly diminishes with repeated, consecutive muscle contractions; patients develop diffuse, athletic muscular hypertrophy and action/percussion myotonia, typically experiencing a benign, non-progressive course with normal life expectancy.
...
\medterm{Thrombocyte (Platelet)} A small ($2{-}4~\mu\text{m}$), anucleate, discoid cellular fragment shed from the cytoplasm of mature polyploid megakaryocytes in the bone marrow under the regulation of thrombopoietin (TPO). Normal circulating platelet counts range from $150{,}000$ to $450{,}000/\mu\text{L}$, with a circulating lifespan of 7 to 10 days. Essential for primary hemostasis: upon vascular endothelial disruption, platelets adhere to exposed subendothelial collagen via von Willebrand factor (vWF) and glycoprotein Ib/IX receptors, undergo activation and shape change to release granule contents (ADP, thromboxane $\text{A}_2$), and aggregate via fibrinogen cross-linking of activated glycoprotein IIb/IIIa receptors to form a primary hemostatic plug. Quantitative or qualitative defects lead to thrombocytopenia or platelet dysfunction, presenting with mucocutaneous bleeding, petechiae, and purpura.
...
\medterm{Thrombotic Thrombocytopenic Purpura (TTP)} A life-threatening hematologic emergency and thrombotic microangiopathy caused by severe deficiency ($<10\%$ activity) of the metalloprotease ADAMTS13, most often mediated by acquired autoantibodies. Loss of ADAMTS13 impairs cleavage of ultra-large von Willebrand factor (vWF) multimers, promoting widespread platelet-rich microvascular thrombosis in arterioles and capillaries. Clinically characterized by the classic pentad (seen completely in $<10\%$ of patients): microangiopathic hemolytic anemia (MAHA with schistocytes on blood smear), severe consumptive thrombocytopenia, fluctuating neurologic deficits, renal impairment, and fever. Mandates immediate emergency therapeutic plasma exchange (PEX) with corticosteroids and the anti-vWF nanobody caplacizumab; platelet transfusions are strictly contraindicated.
...
\medterm{Thyrotoxic Myopathy} A neuromuscular complication of severe, uncontrolled hyperthyroidism, occurring in up to 60--80\% of patients with thyrotoxicosis. Characterized by insidious, progressive, painless proximal muscle weakness and striking muscle wasting, predominantly involving the shoulder and pelvic girdles, accompanied by muscle fatigue and hyperreflexia. Serum creatine kinase levels are typically normal or mildly reduced; muscle biopsy shows non-specific type II fiber atrophy with normal sarcolemma, and all symptoms resolve rapidly within weeks of medical restoration of the euthyroid state.
...
\medterm{TIMI Risk Score} A clinical prognostic scoring system developed by the Thrombolysis in Myocardial Infarction study group to risk-stratify patients presenting with acute coronary syndromes. For unstable angina and NSTEMI, the score assigns one point each to seven variables: age $\ge 65$ years, $\ge 3$ CAD risk factors, known CAD with stenosis $\ge 50$ percent, aspirin use in past 7 days, severe angina ($\ge 2$ episodes in 24h), ST-segment deviation $\ge 0.5\text{ mm}$, and elevated cardiac biomarkers; higher scores predict significantly elevated 14-day risks of all-cause mortality, new or recurrent myocardial infarction, or severe recurrent ischemia requiring urgent revascularization.
...
\medterm{Tipifarnib} An investigational farnesyl-transferase inhibitor studied for cancers and certain blood disorders.
...
\medterm{Toddler's Fracture} A subtle, non-displaced spiral or oblique hairline fracture of the distal third of the tibial shaft in ambulatory young children between 9 months and 3 years of age, typically occurring after a low-energy rotational or twisting injury (such as stumbling, catching the foot in a crib slat, or going down a slide on a parent's lap). Characterized by sudden refusal to bear weight or limp without outward signs of severe trauma, erythema, or deformity. Initial radiographs may appear normal or show an faint hairline fracture line, with subperiosteal bone formation and callus becoming visible on follow-up radiographs after 10 to 14 days.
...
\medterm{Toes (Digits of the Foot)} The five terminal articulated digits of the human foot (digits I through V), consisting of the medial hallux (great toe) and four lateral lesser toes. The hallux contains two robust phalanges and two constant plantar sesamoid bones beneath the first metatarsal head, functioning as a critical biomechanical fulcrum during the push-off phase of normal bipedal gait. Lesser toes contain three phalanges each (proximal, middle, distal); prone to structural deformities including hallux valgus (bunions), hammer toes, claw toes, and mallet toes resulting from neuromuscular imbalances, poorly fitting footwear, or inflammatory arthritis.
...
\medterm{Topotecan Hydrochloride} The hydrochloride salt of topotecan, a topoisomerase-I inhibitor used for selected cancers.
...
\medterm{Torsion of the Appendix Testis} Acute twisting and infarction of the appendix testis (hydatid of Morgagni), a small embryonic remnant of the paramesonephric (M\"ullerian) duct attached to the upper pole of the testis. It represents the single most common cause of acute scrotum in prepubertal boys, peaking between ages 7 and 12 years. Patients present with sudden, localized upper-pole scrotal tenderness with a normal-sized, non-tender lower testis and an intact cremasteric reflex. In early stages, a pathognomonic hard, blue-tinged nodule visible through the thin scrotal skin (the ``blue dot sign'') may be present. Scrotal color Doppler ultrasonography confirms normal testicular perfusion and visualizes an avascular, enlarged, hyperechoic nodule adjacent to the testis. It is benign and self-limiting, managed conservatively with rest, scrotal elevation, and nonsteroidal anti-inflammatory drugs.
...
\medterm{Torus Fracture} An incomplete, stable compression fracture of pediatric bone (also known as a buckle fracture), representing the most frequent skeletal injury in childhood. Characterized by compaction and outward bulging of the porous, trabecular metaphyseal cortex (most commonly in the distal radius) in response to an axial compressive load on a fall onto an outstretched hand, with an intact periosteum and without disruption of the opposite cortex. It carries an excellent prognosis, heals rapidly, and is typically treated conservatively with a removable wrist splint or short-arm cast for 3 to 4 weeks.
...
\medterm{Tracheitis} Inflammation or infection of the mucous membranes of the trachea. While mild tracheitis frequently accompanies viral upper respiratory tract infections (tracheobronchitis), acute bacterial tracheitis (bacterial croup / pseudomembranous croup) is a life-threatening pediatric airway emergency. Typically caused by secondary bacterial superinfection (\textit{Staphylococcus aureus}, \textit{Streptococcus pneumoniae}, \textit{Haemophilus influenzae}) following a viral prodrome, presenting with high fever, toxic appearance, barking cough, and severe inspiratory and expiratory stridor refractory to racemic epinephrine. Mandates urgent airway visualization and stabilization via endotracheal intubation, deep tracheal suctioning of thick mucopurulent pseudomembranes, and broad-spectrum intravenous antibiotic therapy.
...
\medterm{Transabdominal Cerclage} A surgical procedure in which a permanent, non-absorbable synthetic band or braided suture is placed around the uterine cervico-isthmic junction via laparotomy or laparoscopy. Indicated in high-risk pregnant or pre-conceptional women with severe cervical insufficiency in whom standard transvaginal cerclage (McDonald or Shirodkar) is technically impossible or has repeatedly failed due to congenital cervical hypoplasia, cervical amputation, or extensive prior trachelectomy.
...
\medterm{Transcatheter Aortic Valve Replacement} A minimally invasive catheter-based cardiac intervention in which a collapsible bioprosthetic aortic valve (balloon-expandable or self-expanding) is delivered percutaneously (most commonly via the transfemoral artery, or via transaxillary, carotid, or transapical routes) and deployed within the diseased native calcified aortic valve under fluoroscopic guidance. Established as the standard of care for severe, symptomatic aortic stenosis across patients at high, intermediate, and low surgical risk, it avoids median sternotomy, cardiopulmonary bypass, and cardiac arrest, resulting in reduced recovery times and mortality comparable or superior to surgical aortic valve replacement.

\synonyms
TAVR; TAVI; Transcatheter Aortic Valve Implantation

\medterm{Transcatheter Edge-to-Edge Repair} A minimally invasive percutaneous catheter-based intervention for patients with severe symptomatic mitral regurgitation who are at high or prohibitive surgical risk, or who have secondary (functional) mitral regurgitation despite guideline-directed medical therapy. Under real-time transesophageal echocardiographic guidance via transfemoral transseptal access, a mechanical implant (such as the MitraClip or PASCAL device) is navigated into the left atrium and deployed to grasp and approximate the middle scallops of the anterior and posterior mitral valve leaflets (Alfieri stitch equivalent), creating a permanent double-orifice mitral valve that significantly reduces regurgitant volume.
...
\medterm{Transcranial Doppler Ultrasound} Transcranial Doppler ultrasound measures blood-flow speed and direction in major arteries inside the skull.
...
\medterm{Transient Synovitis} A benign, self-limited inflammation of the synovial lining of the hip joint, representing the most common cause of acute hip pain and limping in children aged 3 to 8 years. Typically follows a viral upper respiratory tract infection by 1 to 2 weeks and presents with acute or insidious groin, thigh, or knee pain, antalgic limp, and mild restriction of hip abduction and internal rotation, with normal or slightly elevated inflammatory markers. It must be carefully distinguished from septic arthritis of the hip using the Kocher criteria (fever, non-weight-bearing, ESR >40 mm/hr, WBC >12,000/uL); treatment is supportive with rest and oral nonsteroidal anti-inflammatory drugs (NSAIDs).
...
\medterm{Transjugular Intrahepatic Portosystemic Shunt (TIPS)} A radiologically created channel between a portal vein branch and a hepatic vein that lowers portal pressure, used for complications such as variceal bleeding or refractory ascites; encephalopathy and shunt dysfunction can occur.
...
\medterm{Transthyretin Amyloidosis} A progressive, infiltrative systemic amyloidosis caused by the dissociation and misfolding of tetrameric transthyretin (TTR) into amyloid fibrils that deposit in the myocardium and peripheral nervous system. Occurs in two forms: hereditary (variant ATTR, caused by pathogenic \textit{TTR} mutations such as Val122Ile or Val30Met) and wild-type (senile systemic amyloidosis, predominantly causing restrictive cardiomyopathy in elderly men). Diagnosed by technetium-99m pyrophosphate scintigraphy or tissue biopsy and treated with TTR tetramer stabilizers (such as tafamidis) or TTR-gene-silencing agents.
...
\medterm{Transverse Vaginal Septum} A congenital obstructive anomaly caused by incomplete canalization and failure of fusion between the caudal end of the paired Müllerian ducts and the cranial evagination of the urogenital sinus. Creates a horizontal partition across the vagina (most commonly at the junction of the upper and middle thirds), which when complete causes primary amenorrhea, cyclic pelvic pain, cryptomenorrhea, hematocolpos, and hematometra upon menarche, treated by surgical septum resection.
...
\medterm{Trapezium (Multangulum Majus)} A carpal bone of the wrist situated on the radial (lateral) aspect of the distal carpal row. Articulates proximally with the scaphoid, medially with the trapezoid, and distally with the first and second metacarpals. Most notably forms the classic saddle-shaped first carpometacarpal (CMC) joint with the base of the first metacarpal, conferring unique multidirectional mobility and opposition to the thumb. Because of high mechanical joint loading forces during gripping and pinching, the trapeziometacarpal articulation is the most common site of disabling degenerative osteoarthritis in the human hand (basal thumb arthritis / rhizarthrosis), frequently managed with splinting, corticosteroid injections, or surgical trapeziectomy.
...
\medterm{Travel Sickness (Motion Sickness / Kinetosis)} A common physiological neurosensory mismatch syndrome provoked by unfamiliar real or perceived passive motion during vehicular, sea, or air travel. Pathophysiologically driven by the sensory conflict theory, where vestibular inputs from the semicircular canals and otolith organs conflict directly with visual cues and proprioceptive inputs regarding body position in space. Triggers central autonomic activation in the vestibular nuclei and chemoreceptor trigger zone, manifesting with pallor, cold diaphoresis, gastric awareness, malaise, nausea, and vomiting. Prevented and managed by visual fixation on the horizon, ginger, antihistamines with anticholinergic properties (dimenhydrinate, meclizine), or transdermal scopolamine patches.
...
\medterm{Triazophos} An organophosphate insecticide that can inhibit acetylcholinesterase and cause cholinergic poisoning after significant exposure.
...
\medterm{Tricuspid Annular Plane Systolic Excursion} A quantitative echocardiographic measurement used as the primary, standard bedside index of right ventricular (RV) longitudinal systolic function. Obtained using M-mode echocardiography aligned along the lateral tricuspid annulus in the apical four-chamber view, it measures the maximum total systolic displacement of the tricuspid annulus toward the RV apex in millimeters. A TAPSE value of $<17\text{ mm}$ indicates right ventricular systolic dysfunction and carries strong prognostic significance in pulmonary hypertension, heart failure, and acute pulmonary embolism.
...
\medterm{Triple X Syndrome} A sex chromosome aneuploidy characterized by the presence of an additional X chromosome in females, resulting in a 47,XXX karyotype, arising from non-disjunction during maternal meiosis I or II. Phenotypically, affected females are typically tall with normal sexual development and preserved fertility; clinical features may include mild motor, speech, and language delays, auditory processing difficulties, increased prevalence of learning disabilities and anxiety, mild epicanthal folds, and clinodactyly.
...
\medterm{Tuber} A rounded swelling or growth, often an anatomical prominence or a plant storage organ; clinical meaning depends on the site and context.
...
\medterm{Tuberculosis, MDR} Multidrug-resistant tuberculosis is TB caused by bacteria resistant to at least isoniazid and rifampin, requiring specialized prolonged treatment.
...
\medterm{Tubes} Hollow structures that carry air, fluid, food, or instruments; the clinical meaning depends on the specific tubes being described.
...
\medterm{Turcot Syndrome} A clinical descriptor for the rare concurrent occurrence of primary colorectal polyposis or colorectal cancer and primary central nervous system neoplasms. Genetically classified into two distinct molecular entities: Type 1 Turcot syndrome, associated with hereditary nonpolyposis colorectal cancer (Lynch syndrome) carrying germline DNA mismatch repair gene mutations (\textit{MLH1}, \textit{PMS2}, \textit{MSH2}) and predisposing to high-grade glioblastoma multiforme; and Type 2 Turcot syndrome, associated with familial adenomatous polyposis (FAP) caused by germline mutations in the \textit{APC} gene and predisposing to cerebellar medulloblastomas.
