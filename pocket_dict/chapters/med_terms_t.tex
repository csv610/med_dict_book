...
\medterm{Trachoma} Trachoma is chronic conjunctival infection with Chlamydia trachomatis spread by close contact or flies; repeated inflammation causes eyelid scarring, inward-turning lashes, corneal damage, and preventable blindness.
...
\medterm{tacrolimus} Tacrolimus is a calcineurin inhibitor used systemically to prevent transplant rejection and topically for eczema; nephrotoxicity, hypertension, tremor, infection, and drug interactions require monitoring.
...
\medterm{tamoxifen} Tamoxifen is a selective oestrogen-receptor modulator used to treat or prevent hormone-receptor-positive breast cancer; hot flushes, thromboembolism, and endometrial cancer risk are important considerations.
...
\medterm{terbutaline} Terbutaline is a beta-2 adrenergic agonist bronchodilator used for reversible bronchospasm; tremor, tachycardia, hypokalaemia, and hyperglycaemia may occur, and prolonged obstetric use has serious maternal risks.
...
\medterm{tobramycin} Tobramycin is an aminoglycoside antibiotic that inhibits bacterial protein synthesis and treats selected serious Gram-negative infections; nephrotoxicity and ototoxicity require dose and level monitoring.
...
\medterm{triamcinolone} Triamcinolone is a synthetic corticosteroid used topically, by injection, or in other formulations to reduce inflammation and immune activity; local tissue injury and systemic steroid effects depend on route, dose, and duration.
...
\medterm{tyrosine} Tyrosine is an amino acid synthesized from phenylalanine and used to make thyroid hormones, melanin, and catecholamines; inherited metabolic defects can cause tyrosinaemia or related disease.
