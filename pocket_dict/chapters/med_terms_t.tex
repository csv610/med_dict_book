...
\medterm{Tactile} Pertaining to, perceived by, or relating to the sense of touch (\textit{tactus}). Mediated by specialized cutaneous mechanoreceptors embedded within the dermis and epidermis: Meissner corpuscles (low-frequency vibration, light dynamic touch), Merkel discs (static pressure, fine tactile edge and form discrimination), Pacinian corpuscles (high-frequency vibration), and Ruffini endings (skin stretch). Sensory tactile signals ascend via large myelinated $A\beta$ primary afferents through the dorsal column-medial lemniscal pathway to the contralateral primary somatosensory cortex. Assessed clinically using two-point discrimination tests, monofilament testing in diabetic peripheral neuropathy, and tactile fremitus during thoracic lung examination.
...
\medterm{Taussig-Bing Anomaly} A rare, complex cyanotic congenital heart malformation categorized as a form of double outlet right ventricle, characterized anatomically by both great arteries arising predominantly or entirely from the right ventricle, with the aorta positioned side-by-side or anterior to the pulmonary artery, accompanied by a committed, subpulmonic ventricular septal defect. Hemodynamically resembles D-transposition of the great arteries with a large VSD, wherein oxygenated pulmonary venous blood preferentially streams from the left ventricle across the subpulmonic VSD directly into the pulmonary artery, and systemic venous blood enters the right ventricle and aorta, resulting in severe early cyanosis, pulmonary arterial hypertension, and congestive heart failure, corrected surgically in infancy by an arterial switch operation and VSD closure.
...
\medterm{Tele Radiology (Teleradiology)} The medical practice and technology of transmitting digital radiological patient images (such as plain radiographs, CT scans, MRIs, and ultrasonograms) across telecommunication networks from the site of acquisition to off-site, remote radiologists for the purposes of primary interpretation, emergency triage, or secondary expert subspecialty consultation. Utilizes standardized Picture Archiving and Communication Systems and Digital Imaging and Communications in Medicine data transmission protocols with secure encryption compliant with healthcare privacy regulations. Essential for providing continuous 24/7 overnight emergency coverage to community hospitals and rural trauma centers.
...
\medterm{Temporomandibular Joint Syndrome} Alternate index label for TMJ.

\medterm{Temporomandibular Joint Syndrome} Alternate index label for Temporomandibular Joint Syndrome.
...
\medterm{Thoracic Outlet Syndrome} Alternate index label for Thoracic Outlet Syndrome.
...
\medterm{Thrombocyte (Platelet)} A small ($2{-}4~\mu\text{m}$), anucleate, discoid cellular fragment shed from the cytoplasm of mature polyploid megakaryocytes in the bone marrow under the regulation of thrombopoietin. Normal circulating platelet counts range from $150{,}000$ to $450{,}000/\mu\text{L}$, with a circulating lifespan of 7 to 10 days. Essential for primary hemostasis: upon vascular endothelial disruption, platelets adhere to exposed subendothelial collagen via von Willebrand factor (vWF) and glycoprotein Ib/IX receptors, undergo activation and shape change to release granule contents (ADP, thromboxane $\text{A}_2$), and aggregate via fibrinogen cross-linking of activated glycoprotein IIb/IIIa receptors to form a primary hemostatic plug. Quantitative or qualitative defects lead to thrombocytopenia or platelet dysfunction, presenting with mucocutaneous bleeding, petechiae, and purpura.
...
\medterm{Thrombophilia} A tendency to develop venous thromboembolism due to inherited or acquired
...
\medterm{Thyrotrophin-Releasing Hormone} A hypothalamic hormone that stimulates pituitary release of TSH and prolactin.
...
\medterm{Tissue Plasminogen Activator} An enzyme or recombinant medicine that converts plasminogen to plasmin and dissolves clots.
...
\medterm{Total Intravenous Anesthesia} Total intravenous anesthesia uses intravenous agents exclusively for induction
...
\medterm{Toxic Epidermal Necrolysis} Toxic epidermal necrolysis is a life-threatening severe skin reaction, usually to a medicine, causing widespread epidermal death and skin detachment with mucosal injury.
...
\medterm{Toxic Shock Syndrome} Alternate index label for TSS.

\medterm{Toxic Shock Syndrome} Alternate index label for Toxic Shock Syndrome.
...
\medterm{Transcervical Resection Of Endometrium} An endoscopic procedure that removes or ablates the endometrium to reduce heavy menstrual bleeding.
...
\medterm{Transcutaneous Electrical Nerve Stimulation} Electrical stimulation delivered through skin electrodes to modulate pain.
...
\medterm{Transient Ischaemic Attacks Or Episodes} Brief focal neurologic episodes caused by temporary ischemia without persistent infarction.
...
\medterm{Transplant Immunology} Hyperacute rejection: preformed anti-donor antibodies -> immediate graft
...
\medterm{Transthyretin Amyloidosis} A progressive, infiltrative systemic amyloidosis caused by the dissociation and misfolding of tetrameric transthyretin into amyloid fibrils that deposit in the myocardium and peripheral nervous system. Occurs in two forms: hereditary (variant ATTR, caused by pathogenic \textit{TTR} mutations such as Val122Ile or Val30Met) and wild-type (senile systemic amyloidosis, predominantly causing restrictive cardiomyopathy in elderly men). Diagnosed by technetium-99m pyrophosphate scintigraphy or tissue biopsy and treated with TTR tetramer stabilizers (such as tafamidis) or TTR-gene-silencing agents.
...
\medterm{Troponin} Cardiac-specific troponin I and T, the preferred biomarkers for myocardial injury.
...
\medterm{Tubuloglomerular Feedback} A feedback mechanism at the juxtaglomerular apparatus that adjusts GFR based on
