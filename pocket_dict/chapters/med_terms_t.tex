...
\medterm{Tonometry} Measurement of pressure inside the eye, commonly used to screen for glaucoma.
\textbf{Synonyms}:
...
\medterm{Testes} The paired male reproductive glands that produce sperm and secrete testosterone.
...
\textbf{Synonyms}:
\medterm{Thromboangiitis obliterans} Alternate index label; see \textit{Buerger disease}.
\textbf{Synonyms}:
...
\textbf{Synonyms}:
\medterm{Tongue tie} Alternate index label; see \textit{Tongue-tie (ankyloglossia)}.
\textbf{Synonyms}:
