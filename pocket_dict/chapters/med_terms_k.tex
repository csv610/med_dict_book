...
\medterm{Kahler Disease} A clonal plasma cell malignancy (multiple myeloma) characterized by the neoplastic proliferation of monoclonal plasma cells within the bone marrow, resulting in excessive production of monoclonal immunoglobulin (M protein), osteolytic 'punched-out' bone lesions, pathologic fractures, hypercalcemia, renal failure, and anemia.
\synonyms
...
\medterm{Kallikrein-Kinin System} An endogenous enzymatic cascade in which plasma or tissue kallikrein enzymes cleave high-molecular-weight kininogen to release potent vasoactive peptides (bradykinin and kallidin), inducing profound arteriolar vasodilation, increased microvascular permeability, and smooth muscle contraction.
\synonyms
...
\medterm{Kasabach-Merritt Syndrome} A life-threatening consumptive coagulopathy occurring in infants with rapidly enlarging vascular neoplasms (kaposiform hemangioendothelioma or tufted angioma), characterized by profound intralesional platelet trapping, severe thrombocytopenia, microangiopathic hemolytic anemia, and consumptive hypofibrinogenemia.
\synonyms
...
\medterm{Kehr Sign} Sharp pain felt at the tip of the left shoulder caused by blood or irritation touching the underside of the breathing muscle (diaphragm), classic for a damaged or torn spleen.
...
\medterm{Keratic Precipitates} Inflammatory cellular aggregates deposited on the corneal endothelium in anterior uveitis, categorized as fine (non-granulomatous) or large, greasy mutton-fat deposits (granulomatous uveitis, as in sarcoidosis or tuberculosis).
...
\medterm{Keratoacanthoma} A rapidly growing cutaneous neoplasm characterized by a symmetric, dome-shaped, crateriform nodule with a distinctive central hyperkeratotic keratin plug, occurring predominantly on sun-exposed skin of elderly, fair-skinned individuals. It exhibits a unique triphasic evolution: rapid proliferative growth over 4--8 weeks, a stable plateau phase, and subsequent spontaneous involution over several months, frequently leaving a depressed, atrophic scar. Histologically and biologically, it is considered a well-differentiated variant of cutaneous squamous cell carcinoma (SCC) with which it shares significant clinical, genetic, and microscopic overlap. Because clinical and biopsy differentiation from invasive SCC can be unreliable and aggressive behavior is possible, complete surgical excision with histological margin control (or Mohs micrographic surgery) is the standard definitive treatment.
...
\medterm{Keratosis, Actinic} Alternate name; see \textit{Actinic Keratosis}.
...
\medterm{Keratosis, Seborrheic} Alternate name; see \textit{Seborrheic Keratosis}.
...
\medterm{Kerley A Lines} Fine linear radiopacities on chest radiography measuring 2 to 6 cm in length that radiate diagonally from the pulmonary hila toward the periphery in the upper lung zones, representing distended deep interlobular lymphatic channels and pulmonary interstitial fluid accumulation.
\synonyms
Kerley's A Lines; Upper Zone Interstitial Edema Lines

\medterm{Kerley B Lines} Short (1 to 2 cm), horizontal, delicate radiopaque lines located at the lung bases perpendicular to the lateral pleural surface on chest radiography, reflecting fluid engorgement and thickening of interlobular septa in acute hydrostatic pulmonary edema and left heart failure.
\synonyms
Kerley's B Lines; Septal Lines

\medterm{Kernicterus} A severe, permanent neurological condition caused by the deposition of toxic unconjugated bilirubin into the basal ganglia and brainstem nuclei of neonates with extreme hyperbilirubinemia. Manifestations include choreoathetoid cerebral palsy, sensorineural hearing loss, upward gaze palsy, and dental enamel dysplasia.
...
\medterm{Kernig's Sign} Alternate spelling; see \textit{Kernig's Sign}.
...
\medterm{Kidney Disease, Chronic} Alternate name; see \textit{Chronic Kidney Disease}.
...
\medterm{Kidney Failure, Chronic} Alternate name; see \textit{Chronic Kidney Disease}.
...
\medterm{Kikuchi-Fujimoto Disease} A benign, self-limiting necrotizing lymphadenitis affecting predominantly young women, presenting clinically with painful cervical lymphadenopathy, fever, night sweats, and leukopenia, characterized on histopathology by focal cortical necrosis with abundant histiocytes and karyorrhectic debris without neutrophils.
\synonyms
...
\medterm{Kimmelstiel-Wilson Lesion} Nodular glomerulosclerosis characterized by the formation of rounded, periodic acid-Schiff (PAS)-positive, eosinophilic, acellular hyaline nodules within the intercapillary mesangium of the renal glomerulus, pathognomonic for advanced diabetic nephropathy.
\synonyms
...
\medterm{Kinesia Paradoxa} A sudden, transient, unexpected ability of a severely akinetic or bradykinetic patient with advanced Parkinson disease to perform rapid, smooth, coordinated motor movements, typically triggered by urgent environmental cues or intense emotional stimuli.
\synonyms
...
\medterm{Klinefelter Syndrome} A genetic disorder in males caused by the presence of one or more extra X chromosomes, most commonly characterized by a 47,XXY karyotype. It is the leading genetic cause of primary hypogonadism (hypergonadotropic hypogonadism). The extra chromosome impairs testicular development, resulting in small, firm testes, low testosterone production, and azoospermia (infertility). Clinical features typically become prominent during puberty and include tall stature with disproportionately long limbs (eunuchoid proportions), reduced facial and body hair, decreased muscle mass, gynecomastia, low bone mineral density, and occasional language or learning difficulties. Definitive diagnosis is established by chromosomal karyotype analysis. Management involves lifelong testosterone replacement therapy, monitoring for metabolic and breast disorders, and fertility evaluation via testicular sperm extraction (micro-TESE) when desired.
...
\medterm{Klippel Trenaunay Weber Syndrome} Alternate spelling; see \textit{Klippel-Trenaunay-Weber Syndrome}.
...
\medterm{Klippel-Trenaunay-Weber Syndrome} A historical term often used interchangeably with Klippel-Trenaunay syndrome; modern classifications distinguish Klippel-Trenaunay syndrome (slow-flow venous and lymphatic malformations) from Parkes Weber syndrome (which features high-flow arteriovenous fistulas). See \textit{Klippel-Trenaunay Syndrome}.
...
\medterm{Krukenberg Spindle} A vertical, spindle-shaped brownish melanin pigment deposition on the posterior corneal endothelium, oriented by aqueous convection currents, pathognomonic for pigment dispersion syndrome and pigmentary glaucoma.
\synonyms
...
\medterm{Kveim-Siltzbach Test} An intradermal diagnostic skin test for sarcoidosis in which a sterilized suspension prepared from sarcoidal human spleen or lymph node tissue is injected intradermally; biopsy of a nodule at the injection site 4 to 6 weeks later demonstrating non-caseating sarcoid granulomas confirms a positive test.
\synonyms
