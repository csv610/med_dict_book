...
\medterm{Kleihauer-Betke Test} An acid-elution diagnostic blood assay performed on maternal peripheral blood to quantify the volume of fetal-maternal hemorrhage, exploiting the resistance of fetal hemoglobin (HbF) to acid elution compared to adult hemoglobin (HbA); used to calculate the required dose of Rh immune globulin (RhoGAM).

\synonyms
KB Test; Acid Elution Test
...
\medterm{Kostmann Syndrome} A severe congenital neutropenia syndrome inherited in an autosomal recessive pattern (often due to \textit{HAX1} mutations), characterized by profound absolute neutropenia (fewer than 200 neutrophils/microliter) with promyelocytic maturation arrest in the bone marrow and recurrent life-threatening pyogenic bacterial infections in infancy.

\synonyms
Severe Congenital Neutropenia Type 3; SCN3
