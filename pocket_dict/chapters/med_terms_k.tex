...
\medterm{Kava} A plant-derived product traditionally used in the Pacific and marketed for anxiety or relaxation. It can cause sedation, drug interactions, and serious liver injury and should not be treated as risk-free because it is herbal.

\medterm{KC} Common abbreviation for keratoconus, a progressive thinning and cone-shaped bulging of the cornea; see \textit{Keratoconus}.

\medterm{Kegel Exercises} Alternate plural form; see \textit{Kegel Exercise}.

\medterm{Keratosis Seborrheic} Alternate word order; see \textit{Seborrheic Keratosis}.

\medterm{Kidney Disease, Chronic} Alternate name; see \textit{Chronic Kidney Disease}.

\medterm{Kidney Disease, Diabetic} Kidney damage caused by diabetes, often first detected by increased albumin in urine and later by reduced filtration; see \textit{Diabetic Nephropathy}.

\medterm{Kidney Disease, Hypertension-Related} Kidney damage caused or worsened by long-standing high blood pressure; see \textit{Hypertensive Nephropathy}.

\medterm{Kidney Failure, Acute} Alternate name; see \textit{Acute Kidney Failure}.

\medterm{Knee Replacement Surgery} Surgery that replaces part or all of a damaged knee joint with an artificial joint to reduce pain and improve function; see \textit{Knee Replacement}.

\medterm{Kneecap Instability} Recurrent or persistent abnormal movement of the patella within or out of the femoral groove, causing pain, giving way, or dislocation; assessment may include examination and imaging.

\medterm{Kneecap Tracking Disorder} Abnormal alignment or movement of the patella during knee bending and straightening, sometimes causing front-of-knee pain, grinding, or instability.

\medterm{Kratom} A plant product containing mitragynine and related compounds that can have stimulant or opioid-like effects. It can cause dependence, withdrawal, sedation, seizures, liver injury, and dangerous interactions, especially with other sedatives or opioids.

\medterm{KTW Syndrome} Abbreviation; see \textit{Klippel-Trenaunay-Weber Syndrome}.
