...
\medterm{H1N1 Flu (Swine Flu)} Influenza A infection caused by an H1N1 virus. It spreads through respiratory droplets and commonly causes sudden fever, cough, sore throat, muscle aches, headache, and tiredness; some people develop pneumonia or severe breathing problems.

\medterm{H1N1 Influenza} Alternate index label; see \textit{H1N1 Flu (Swine Flu)}.

\medterm{H1N1 Influenza (Swine Flu)} Alternate index label; see \textit{H1N1 Flu (Swine Flu)}.
...
\medterm{Hampton's Hump} Alternate index label; see \textit{Hampton Hump}.
...
\medterm{Hermanski-Pudlak Syndrome} Alternate index label; see \textit{Hermansky-Pudlak Syndrome}.
...
\medterm{Hot Flash} Alternate index label; see \textit{Hot Flashes}.
...
\medterm{Hot Flushes} Alternate index label; see \textit{Hot Flashes}.
...
\medterm{Hyponatraemia} Alternate index label; see \textit{Hyponatremia}.
...
\medterm{Hypophosphataemia} Alternate index label; see \textit{Hypophosphatemia}.
...
\medterm{Hypothalamic Tumor} Alternate index label; see \textit{Hypothalamic Neoplasm}.
