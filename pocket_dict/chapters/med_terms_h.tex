...
\medterm{Hermaphroditism} Historical term; see \textit{Differences Of Sex Development}.
...
\medterm{High Altitude Pulmonary Edema} A non-cardiogenic pulmonary edema developing in unacclimatized individuals rapidly ascending to altitudes exceeding 2,500 to 3,000 meters, caused by exaggerated, patchy hypoxic pulmonary vasoconstriction that induces pulmonary capillary stress failure and protein-rich alveolar flooding.
...
\medterm{His Disease} Historical term for \textit{Bartonella quintana} infection; see \textit{Trench Fever}. It should not be confused with the bundle of His in the cardiac conduction system.
...
\medterm{Homan Sign} Pain or discomfort elicited in the calf or popliteal fossa upon forceful, passive dorsiflexion of the ankle with the knee extended, historically described as a physical sign of deep vein thrombosis of the lower extremity, though possessing low diagnostic sensitivity and specificity.
...
\medterm{Hyperkalemia} An abnormally high level of potassium in the blood, often caused by kidney disease, medicines, tissue damage, or a problem with body acidity. It may cause weakness, numbness, or abnormal heart rhythms; severe cases can stop the heart.
