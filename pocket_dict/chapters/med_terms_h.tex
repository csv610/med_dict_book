...
\medterm{H2 Receptor Antagonists Overdose} Taking too much of an H2 blocker medicine. It may cause drowsiness, confusion, agitation, abnormal heartbeat, or rarely seizures.

\medterm{H5N1} A subtype of avian influenza A virus that mainly infects birds but can occasionally infect mammals and humans after close contact with infected animals or contaminated environments. Human illness can be severe.
...
\medterm{Haberland Syndrome (Encephalocraniocutaneous Lipomatosis)} A rare congenital mosaic disorder characterized by unilateral scalp and facial lipomas or hairless skin lesions, eye abnormalities, and sometimes seizures, developmental differences, or brain malformations.
...
\medterm{Haematemesis} Vomiting blood or material that looks like coffee grounds, usually from bleeding in the esophagus, stomach, or upper small intestine. It can be life-threatening.
...
\medterm{Haematosalpinx} Blood collected inside a fallopian tube, often from ectopic pregnancy, endometriosis, pelvic injury, or blockage. It may cause pelvic pain and can affect fertility.
...
\medterm{Haemochromatosis} Alternate spelling; see \textit{Hemochromatosis}.
...
\medterm{Haemoperitoneum} Bleeding into the abdominal cavity, commonly after injury, a ruptured ectopic pregnancy, or a bleeding liver, spleen, artery, or other organ. It can cause shock.
...
\medterm{Haemophilus Ducreyi} A fastidious, facultatively anaerobic Gram-negative coccobacillus that is the causative etiological agent of chancroid, characterized by painful, non-indurated genital ulcers with purulent bases and prominent suppurative inguinal lymphadenopathy (buboes).
...
\medterm{Haemoptysis} Coughing up blood or blood-stained mucus from the airways or lungs. Causes include infection, bronchiectasis, a blood clot, cancer, or irritation; larger amounts may occur with breathlessness or chest pain.

\medterm{Haemorrhage} British spelling of Hemorrhage; see Hemorrhage.

\medterm{Haemorrhagic Fever} A group of severe infections caused by certain viruses that can damage blood vessels and disrupt clotting. Fever, weakness, bleeding, shock, and organ failure may occur.
...
\medterm{Haglund Deformity} An anatomical prominence (posterosuperior calcaneal exostosis) of the heel bone causing mechanical friction and chronic inflammation of the retrocalcaneal bursa and Achilles tendon, exacerbated by rigid shoes ('pump bump').
\synonyms
...
\medterm{Hair Bleach Poisoning} Illness after swallowing or inhaling hair-bleaching chemicals, which may contain peroxide or persulfates. They can irritate or burn the mouth, throat, skin, eyes, or lungs.
...
\medterm{Hair Dye Poisoning} Harm caused by swallowing or inhaling hair-dye chemicals. Depending on the ingredients and amount, symptoms may include vomiting, swelling, breathing difficulty, allergic reaction, kidney injury, or muscle damage.
...
\medterm{Hair-Pulling Syndrome} Alternate name; see \textit{Trichotillomania}.

\medterm{Halushi-Behcet's Syndrome} Alternate name; see \textit{Behcet Disease}.
...
\medterm{Hair Spray Poisoning} Illness after swallowing or inhaling hair spray. Small accidental exposures may irritate the mouth or lungs, while larger exposures can cause vomiting, drowsiness, breathing problems, or chemical injury.

\medterm{Hair Straightener Poisoning} Harm after swallowing a hair-straightening product, which may contain corrosive chemicals. It can burn the mouth, throat, esophagus, or stomach and cause breathing or swallowing problems.

\medterm{Hair Tonic Poisoning} Illness after swallowing or inhaling a hair-tonic product. Ingredients such as alcohols or solvents may cause vomiting, drowsiness, low blood sugar, or breathing problems; the product and amount determine severity.
...
\medterm{Hairy Leukoplakia} A benign, painless, white, corrugated mucosal lesion occurring predominantly along the lateral margins of the tongue that cannot be scraped off, caused by opportunistic infection of epithelial cells by Epstein-Barr virus (EBV) in immunocompromised patients (especially HIV infection).
\synonyms
...
\medterm{Hallpike Test} A clinical vestibular provocative maneuver used to diagnose benign paroxysmal positional vertigo (BPPV) of the posterior semicircular canal; the patient is rapidly lowered from a sitting position to supine with the head extended and turned 45 degrees, provoking rotational upbeat nystagmus and vertigo.
\synonyms
...
\medterm{Halo Sign} A chest computed tomography finding characterized by a ground-glass attenuation perimeter surrounding a dense pulmonary nodule or consolidation, representing alveolar hemorrhage surrounding a fungal focus, highly suggestive of early invasive aspergillosis in neutropenic patients.
...
\medterm{Hamman-Rich Syndrome} An acute, fulminant idiopathic interstitial pneumonia characterized by sudden onset of cough, rapidly progressive dyspnea, hypoxemic respiratory failure, and diffuse alveolar damage on lung biopsy in the absence of a known cause or preexisting lung disease.
\synonyms
...
\medterm{Hammer, Claw and Mallet Toes} Deformities in which one or more toes bend abnormally at the middle or end joints. They may cause pain, rubbing, corns, calluses, or difficulty wearing shoes.

\medterm{Hammertoes} Alternate plural form; see \textit{Hammertoe}.
...
\medterm{Hampton Line} A distinct radiological finding identified on a barium meal examination of the stomach, consisting of a thin, sharply demarcated radiolucent line measuring approximately one millimeter in width that traverses the neck of a benign gastric ulcer crater. It represents the undermined mucosal edge of a benign peptic ulcer, distinguishing it from an ulcerated gastric malignancy.

\synonyms
Hampton's Radiolucent Line; Peptic Hampton Line
...
\medterm{Hand-Foot-And-Mouth Disease} A contagious enteroviral illness, most common in young children, causing fever, painful mouth sores, and a rash or small blisters on the hands and feet, sometimes the buttocks. It spreads through respiratory secretions, blister fluid, contaminated surfaces, and stool and is usually self-limited.
...
\medterm{Hand-Held Retractor} A handheld surgical instrument used to hold tissue or an organ away from the operative field.

\synonyms
Manual Retractor; Handheld Retractor; Senn Retractor
...
\medterm{Hand Infections} Infections involving the skin, tendon sheaths, joints, bones, or deep spaces of the hand. Pain, swelling, redness, impaired movement, fever, or a flexed finger may indicate a condition requiring urgent assessment.
...
\medterm{Hand-Schuller-Christian Disease} A multifocal, chronic form of Langerhans cell histiocytosis occurring predominantly in young children, classically defined by the clinical triad of multifocal lytic bone lesions ('punched-out' skull defects), diabetes insipidus, and exophthalmos.
\synonyms
Multifocal Unisystem LCH; Schuller-Christian Triad
...
\medterm{Hanging Injuries and Strangulation} Injuries caused by constriction of the neck or suspension of the body, with potential airway, vascular, neurologic, and cervical-spine damage. Serious internal injury may occur even when external findings are limited.

\medterm{Hangman Fracture} A traumatic bilateral fracture passing through the neural arch, pedicles, or pars interarticularis of the second cervical vertebra (axis, C2), classically caused by sudden violent hyperextension and axial loading or distraction of the cervical spine.
\synonyms
Traumatic Spondylolisthesis of the Axis; C2 Pedicle Fracture
...
\medterm{Hantavirus Cardiopulmonary Syndrome} A severe zoonotic infection that can progress from fever and muscle aches to capillary leak, pulmonary edema, hypoxemic respiratory failure, shock, and cardiac dysfunction.
...
\medterm{Hartmann Pouch} An anatomical outpouching or dilatation of the inferior wall of the gallbladder neck adjacent to the junction with the cystic duct; gallstone impaction here may cause acute calculous cholecystitis or compress the adjacent common hepatic duct (Mirizzi syndrome).
...
\medterm{Hashimoto Encephalopathy} A rare, steroid-responsive neurocognitive encephalopathy associated with autoimmune thyroiditis, characterized by fluctuating cognitive impairment, stroke-like episodes, myoclonus, seizures, and high titers of antithyroid antibodies (anti-TPO) independent of thyroid functional status.
...
\medterm{Hassall Corpuscles} Concentrically laminated, eosinophilic epithelial structures located within the medulla of the human thymus gland, composed of degenerate thymic epithelial cells that secrete thymic stromal lymphopoietin (TSLP) and assist in regulatory T cell maturation.
\synonyms
...
\medterm{Haversian Canal} A central longitudinal microscopic channel running through the core of each osteon (Haversian system) in compact cortical bone, carrying neurovascular structures (capillaries, postcapillary venules, and unmyelinated nerve fibers) to supply osteocytes embedded within surrounding concentric lamellae.

\synonyms
Central Canal of Bone

\medterm{Hawkins Test} A physical examination maneuver used to identify subacromial shoulder impingement; the examiner flexes the patient's arm and elbow to 90 degrees and forcefully performs internal rotation of the humerus, compressing the supraspinatus tendon against the coracoacromial ligament.
\synonyms
Hawkins-Kennedy Impingement Test; Hawkins Sign
...
\medterm{Head Impulse Test} A bedside examination of the vestibulo-ocular reflex (VOR); the clinician delivers rapid, unpredictable, small-amplitude passive rotations of the patient's head toward one side while the patient fixates on a central target; a corrective saccade indicates ipsilateral peripheral vestibular hypofunction.
\synonyms
Halmagyi-Curthoys Test; Video Head Impulse Test (vHIT)

\medterm{Head Injury} Damage to the scalp, skull, or brain caused by a blow, fall, collision, or penetrating object. It may cause a wound, skull fracture, concussion, bleeding, or brain damage. Worsening headache, repeated vomiting, seizure, confusion, weakness, or loss of consciousness may occur.
...
\medterm{Head Of The Epididymis} The upper part of the epididymis, connected to the testis by small ducts and receiving newly made sperm.

\medterm{Head Thrust Test} A bedside neuro-otological examination of the vestibulo-ocular reflex (VOR) performed by rapidly rotating the patient's head horizontally while the patient fixates on the examiner's nose; a corrective catch-up saccade indicates peripheral vestibular hypofunction (such as vestibular neuritis).

\synonyms
Head Impulse Test; Halmagyi-Curthoys Test

\medterm{Head Trauma} An injury to the scalp, skull, brain, or other tissues of the head. Concussion, bleeding, skull fracture, and brain injury can result; worsening headache, repeated vomiting, seizure, confusion, weakness, or loss of consciousness may occur.
...
\medterm{HD} Abbreviation; see \textit{Huntington Disease}.
...
\medterm{Heart Chambers} The four spaces inside the heart: the right and left atria, which receive blood, and the right and left ventricles, which pump blood out.
...
\medterm{Heart Palpitations} Alternate name; see \textit{Palpitation}.
...
\medterm{Heart Rate Variability} The physiological variation and fluctuation in consecutive RR intervals between heartbeats over time, reflecting the autonomic balance and dynamic regulatory modulation between sympathetic and parasympathetic (vagal) nervous system inputs on the sinoatrial node.
...
\medterm{Heart-Smart Substitutions} Easy food changes that may support heart health, such as choosing unsaturated oils instead of butter, whole grains instead of refined grains, and less processed or salty food.
...
\medterm{Heerfordt Syndrome} A specific clinical presentation of acute sarcoidosis characterized by the classic tetrad of anterior uveitis, bilateral parotitis (parotid gland enlargement), low-grade pyrexia, and unilateral or bilateral lower motor neuron facial nerve (CN VII) palsy.
\synonyms
Uveoparotid Fever; Heerfordt-Waldenström Syndrome
...
\medterm{Helicobacter Pylori-Associated Active Gastritis Pathology} Chronic active gastritis with lymphoplasmacytic inflammation, neutrophils in pits or surface epithelium, lymphoid aggregates, and curved organisms along the surface mucus or foveolar epithelium.

\medterm{Helicobacter Pylori Eradication} Pharmacological combination therapy designed to eliminate gastric \textit{H. pylori} infection, traditionally utilizing triple therapy (proton pump inhibitor, clarithromycin, amoxicillin) or bismuth quadruple therapy (PPI, bismuth subsalicylate, metronidazole, tetracycline) to heal peptic ulcers and reduce gastric cancer risk.
...
\medterm{Helicotrema} The narrow anatomical communication aperture located at the apex of the cochlea where the scala vestibuli meets and continues into the scala tympani, allowing pressure equilibration of perilymph between the two compartments.
...
\medterm{Heliotrope Rash} A purple or lilac rash around the eyelids, often with swelling. It is a characteristic sign of dermatomyositis, but other findings and tests are needed for diagnosis.
\synonyms
Heliotrope Erythema; Dermatomyositis Eyelid Sign
...
\medterm{HELLP syndrome} A pregnancy-associated syndrome named for hemolysis, elevated liver enzymes, and low platelet count. It is a form of microangiopathic disease that may occur with preeclampsia and can involve upper-abdominal pain, nausea, headache, or high blood pressure.
...
\medterm{Hemangioma} A usually noncancerous growth made of blood vessels. It may be present at birth or appear during infancy, and can be a small skin mark or a deeper mass. Some become smaller over time; others can cause bleeding, ulceration, or pressure on nearby structures.
...
\medterm{Hematemesis} Vomiting blood or material that looks like coffee grounds, usually from bleeding in the esophagus, stomach, or first part of the small intestine. It can be life-threatening.
...
\medterm{Hematochezia} Passing bright-red or maroon blood from the rectum. It often comes from the large intestine, rectum, or anus, but heavy bleeding higher in the digestive tract can look the same.
...
\medterm{Hematogenous Osteomyelitis} An invasive bone infection arising from bacteremic seeding of the vascular marrow spaces, classically affecting the metaphyses of long bones in growing children (due to slow sinusoidal capillary blood flow) and the vertebral bodies (spondylodiscitis) in older adults, most frequently caused by \textit{Staphylococcus aureus}.
...
\medterm{Hematomyelia} Bleeding inside the spinal cord, usually after a serious injury or from an abnormal blood vessel or bleeding disorder. It may cause sudden neck or back pain, weakness, numbness, or loss of bladder or bowel control.
...
\medterm{Hemianesthesia} The complete loss of tactile, thermal, or nociceptive somatic sensation affecting one vertical half of the body, classically caused by an ischemic or hemorrhagic lesion disrupting the contralateral primary somatosensory cortex or the ventral posterolateral (VPL) nucleus of the thalamus.

\medterm{Hemianopia} Loss of vision in half of the area a person can see, affecting one or both eyes. It often results from a problem in the brain’s visual pathways, such as a stroke or tumor; sudden onset can occur with a serious brain disorder.
...
\medterm{Hemineglect} A neurological attentional disorder classically resulting from an acute lesion of the non-dominant (usually right) posterior parietal cortex, in which the patient fails to orient toward, respond to, or perceive sensory stimuli presented in the hemispace contralateral to the brain lesion.

\synonyms
Spatial Neglect; Unilateral Neglect
...
\medterm{Hemiparesis with Conjugate Gaze Deviation} Weakness on the left side with both eyes looking to the right. This pattern can occur with a serious injury to the right side of the brain, including stroke, but examination and brain imaging are needed to identify the cause.
...
\medterm{Hemiplegia} Complete or near-complete paralysis of one side of the body, including the face, arm, or leg. It usually results from injury to movement pathways in the brain, commonly a stroke; sudden onset can occur with a serious brain disorder.
...
\medterm{Hemobilia} Bleeding originating within the hepatobiliary tree that enters the gastrointestinal tract via the ampulla of Vater, classically presenting with the triad of biliary colic, upper gastrointestinal bleeding, and obstructive jaundice (Sandblom triad), frequently following liver trauma, biopsy, or instrumentation.

\medterm{Hemochromatosis} A disorder in which too much iron builds up in the body and can damage the liver, pancreas, heart, joints, skin, and hormone-producing organs. The common HFE-related form is usually autosomal recessive; other inherited forms can have different patterns, and iron overload can also develop from another illness or repeated transfusions.
...
\medterm{Hemoglobin A1c} A blood test that shows the average blood sugar level over the past 2 to 3 months. It is used to help diagnose and monitor diabetes and prediabetes, but it may be less reliable in some blood disorders, pregnancy, or conditions that change red blood cell life span.
\synonyms
...
\medterm{Hemoglobinopathies} A group of inherited disorders affecting the structure or production of hemoglobin. They include sickle-cell disorders and thalassemias and may cause anemia, hemolysis, abnormal oxygen transport, or blood-vessel complications.
...
\medterm{Hemolytic Anemia From Toxins} Anemia caused by accelerated destruction of red blood cells after exposure to a chemical or toxin; evaluation identifies hemolysis and removes or treats the responsible exposure.
...
\medterm{Hemopericardium} Accumulation of blood in the pericardial sac around the heart. If pressure rises and prevents the heart from filling, cardiac tamponade can occur.
...
\medterm{Hemophagocytic Lymphohistiocytosis} A rare, life-threatening illness in which the immune system remains excessively active and injures the body’s organs. It may be inherited or triggered by infection, cancer, or immune disease. Persistent fever, enlarged spleen, low blood counts, liver problems, bleeding, or confusion may occur.
...
\medterm{Hemoptysis} Coughing up blood or blood-stained mucus from the airways or lungs. Causes include infection, irritated or widened airways, a blood clot, or cancer. Larger amounts may occur with breathlessness or chest pain.
...
\medterm{Henderson-Hasselbalch Equation} A mathematical derivation expressing the relationship between blood pH, the dissociation constant (pKa) of carbonic acid (6.1), and the ratio of serum bicarbonate concentration to dissolved arterial carbon dioxide tension (0.03 times PaCO2), forming the quantitative framework for clinical acid-base interpretation.
...
\medterm{Henle Loop} The U-shaped hairpin segment of a renal nephron connecting the proximal convoluted tubule to the distal convoluted tubule, consisting of a water-permeable descending limb and an active sodium-potassium-chloride-transporting ascending limb that generates a hypertonic medullary interstitial gradient for urine concentration.
...
\medterm{Henoch-Schonlein Purpura (HSP)} Alternate name; see \textit{Henoch-Schonlein Purpura}.
...
\medterm{Heparin Resistance} The clinical situation in which unusually high doses of unfractionated heparin (exceeding 35,000 units per 24 hours) are required to achieve a therapeutic activated partial thromboplastin time (aPTT) or anti-factor Xa level, most commonly caused by antithrombin deficiency, acute-phase reactant elevations, or high factor VIII levels.
...
\medterm{Hepatic Adenoma} A benign, well-demarcated primary epithelial liver neoplasm occurring predominantly in young women with prolonged exposure to oral contraceptives or anabolic steroids, carrying risks of life-threatening spontaneous rupture with intraperitoneal hemorrhage and malignant transformation into hepatocellular carcinoma.
...
\medterm{Hepatic Artery Embolization} A minimally invasive transcatheter interventional radiological procedure in which particulate emboli or chemoembolic agents are delivered directly into hepatic arterial branches feeding hypervascular liver tumors (such as hepatocellular carcinoma) to induce selective ischemic tumor necrosis.
...
\medterm{Hepatitis B Window Period} The interval during acute resolving hepatitis B virus infection between the disappearance of detectable hepatitis B surface antigen (HBsAg) and the appearance of protective anti-HBs antibodies, during which IgM antibody to hepatitis B core antigen (anti-HBc IgM) serves as the sole serological marker of acute infection.
...
\medterm{Hepatoduodenal Ligament} The thickened free right margin of the lesser omentum extending between the liver and the first part of the duodenum, transmitting the portal triad (common bile duct anterolaterally, proper hepatic artery anteromedially, and portal vein posteriorly) and forming the anterior boundary of the epiploic foramen.
...
\medterm{Hepatorenal Recess} The deep peritoneal space located posteroinferiorly between the visceral surface of the right hepatic lobe and the right kidney, representing the most gravity-dependent recess of the upper abdomen in the supine position where free intraperitoneal fluid or blood preferentially collects.
...
\medterm{Hereditary and Acquired Ichthyosis Vulgaris} Ichthyosis vulgaris is a scaling disorder that may be inherited, commonly related to filaggrin deficiency, or acquired with systemic disease, medicines, or nutritional problems. It produces dry fish-like scale that is often worse on the limbs and improves with moisturizers and keratolytics.

\medterm{Hereditary Angioedema} An inherited, usually autosomal dominant and bradykinin-mediated disorder causing repeated episodes of swelling in the skin, hands, feet, stomach or bowel wall, or throat. Types 1 and 2 commonly result from deficiency or dysfunction of C1 inhibitor, often due to variants in the \textit{SERPING1} gene; other forms may have normal C1-inhibitor levels. Attacks may cause severe abdominal pain or swelling that narrows the upper airway and often occur without itchy hives.

\medterm{HAE} Abbreviation; see \textit{Hereditary Angioedema}.
...
\medterm{Hereditary Diseases} Alternate name; see \textit{Inherited Disease}.
...
\medterm{Hereditary Motor and Sensory Neuropathy} Alternate name; see \textit{Charcot-Marie-Tooth Disease}.
...
\medterm{Hereditary Neuropathy with Liability to Pressure Palsies} An autosomal dominant peripheral neuropathy caused by a 1.5-megabase microdeletion of chromosome 17p11.2 encompassing the \textit{PMP22} gene. Characterized by recurrent, painless, transient mononeuropathies (such as peroneal, ulnar, or radial nerve palsies) triggered by minor compressive trauma or prolonged mechanical pressure, with nerve biopsy showing focal myelin sheath thickening termed tomacula.

\synonyms
HNPP; Tomaculous Neuropathy; Pressure Palsy Neuropathy

\medterm{Hereditary Nonpolyposis Colorectal Cancer (Lynch Syndrome)} An inherited cancer-predisposition syndrome usually caused by impaired DNA mismatch repair. It increases the risk of colorectal, endometrial, ovarian, gastric, urinary-tract, and other cancers; genetic counseling and risk-based surveillance are important.
...
\medterm{Hereditary Periodic Fever Syndromes} A group of inherited autoinflammatory disorders causing recurrent episodes of fever and inflammation without a usual infection. Examples include familial Mediterranean fever, tumor-necrosis-factor-receptor-associated periodic syndrome, mevalonate kinase deficiency, and cryopyrin-associated periodic syndromes.
...
\medterm{Hereditary Spherocytosis} Usually an autosomal dominant inherited blood disorder in which red blood cells are round rather than disc-shaped and are broken down too quickly, mainly in the spleen; less often it is autosomal recessive. It may cause anemia, jaundice, gallstones, and an enlarged spleen.
...
\medterm{Heroin} A highly addictive opioid that is converted to morphine in the body. Repeated use can cause opioid dependence, tolerance, and withdrawal; excessive exposure can cause opioid overdose with respiratory depression, coma, and death.

\medterm{Heroin Toxicity} Opioid poisoning characterized by marked drowsiness or coma, pinpoint pupils, slow or absent breathing, hypoxia, and sometimes noncardiogenic pulmonary edema. Immediate airway support and naloxone are central; recurrent respiratory depression can occur because the opioid effect may outlast a naloxone dose.
...
\medterm{Herpes Zoster} A reactivation of varicella-zoster virus in a sensory nerve ganglion causing pain, tingling, and a blistering rash in one or two adjacent dermatomes, usually on one side and not crossing the midline. Complications include postherpetic neuralgia, eye or ear disease, encephalitis, and pneumonia; lesions can transmit VZV to susceptible people until crusted.
...
\medterm{Herpetic Keratitis} A herpes simplex infection of the clear front surface of the eye. It may cause one-sided eye pain, redness, light sensitivity, tearing, or blurred vision. A branching ulcer seen with a special dye supports the diagnosis; repeated or deep infection can scar the cornea and damage vision.
...
\medterm{Herring Bodies} Microscopic dilations and neurosecretory terminal swellings of unmyelinated axons within the posterior lobe of the pituitary gland (neurohypophysis) that store oxytocin and antidiuretic hormone (vasopressin) bound to neurophysin carrier proteins.
\synonyms
Neurosecretory Bodies; Neurohypophyseal Axonal Swellings

\medterm{Hertel Exophthalmometer} An optical instrument used to measure the anterior-posterior distance between the lateral orbital rim and the corneal apex to quantify proptosis or exophthalmos.
...
\medterm{Heterotopic Breast Tissue Of The Vulva} Breast-like glandular tissue located in the vulva outside the normal breast. It may respond to hormonal changes and develop benign lesions, inflammation, or rarely malignancy; histopathologic examination may be needed for diagnosis.
...
\medterm{Hexose Monophosphate Shunt} A cytosolic metabolic alternative pathway to glycolysis that oxidizes glucose-6-phosphate to generate NADPH (essential for reductive biosynthesis and maintaining reduced glutathione in erythrocytes) and ribose-5-phosphate for nucleotide synthesis.
...
\medterm{Heyde Syndrome} A clinical association and triad comprising calcific aortic valve stenosis, acquired type 2A von Willebrand syndrome (caused by shear stress-induced degradation of high-molecular-weight vWF multimers across the stenotic valve), and gastrointestinal hemorrhage from intestinal angiodysplasias.
\synonyms
Heyde's Syndrome; Aortic Stenosis and Angiodysplasia Triad

\medterm{Heyde Syndrome Triad} The clinical association between calcific aortic valve stenosis, acquired type 2A von Willebrand disease, and recurrent gastrointestinal bleeding from intestinal angiodysplasia. High shear stress across the stenotic aortic valve uncoils and cleaves high-molecular-weight von Willebrand factor multimers via the plasma protease ADAMTS13, predisposing mucosal angiodysplasias to recurrent hemorrhage; typically resolves completely following aortic valve replacement.

\synonyms
Heyde Syndrome; Aortic Stenosis-Angiodysplasia Syndrome
...
\medterm{High Altitude Cerebral Edema} A severe, life-threatening manifestation of acute altitude illness typically occurring above 2,500 to 3,000 meters, caused by hypoxemia-induced cerebral vasodilation, blood-brain barrier disruption, and vasogenic edema, presenting with ataxia, confusion, altered mental status, and coma.

\synonyms
HACE

\medterm{High-Altitude Cerebral Edema} A severe, potentially fatal form of acute altitude sickness characterized by vasogenic brain edema, elevated intracranial pressure, and neuronal dysfunction occurring in unacclimatized individuals ascending rapidly to altitudes exceeding 2,500 to 3,000 meters. Cardinal signs include severe progressive headache, truncal ataxia, altered mental status, confusion, and eventually stupor or coma.

\synonyms
HACE; Mal de Montagne Cerebral
...
\medterm{High Blood Pressure} Persistently elevated arterial blood pressure. Diagnosis generally requires properly obtained readings on more than one occasion or other appropriate confirmation. It often causes no symptoms but increases the risk of cardiovascular, cerebrovascular, kidney, and eye disease. Medicines used to lower it include diuretics, ACE inhibitors, angiotensin-receptor blockers, calcium-channel blockers, beta blockers, and other agents selected according to comorbidities and risk.

\medterm{High Blood Pressure (Hypertension)} Alternate name; see \textit{High Blood Pressure}.
...
\medterm{High-Density Lipoprotein Cholesterol} A lipoprotein class synthesized by the liver and intestine containing apolipoproteins A-I and A-II that mediates reverse cholesterol transport by extracting excess cholesterol from peripheral tissues and vascular macrophages and transporting it to the liver for excretion; inversely correlated with atherosclerotic cardiovascular risk.
...
\medterm{High HDL Cholesterol (Hyperalphalipoproteinemia)} An unusually high concentration of high-density lipoprotein cholesterol, caused by genetic traits, medicines, or other conditions. Its effect on cardiovascular risk depends on the underlying cause and the person’s complete lipid profile.
...
\medterm{Highly Selective Vagotomy} A type of vagotomy that cuts the vagus-nerve branches that stimulate acid production in the upper stomach while preserving the branches that help the lower stomach empty.

\synonyms
Parietal Cell Vagotomy; Proximal Gastric Vagotomy
...
\medterm{High-Output Heart Failure} A clinical heart failure syndrome occurring in the setting of an elevated resting cardiac output exceeding 8 liters per minute, driven by severely reduced systemic vascular resistance or excessive metabolic demands (such as thyrotoxicosis, severe chronic anemia, systemic arteriovenous fistulas, beriberi, or Paget disease).
...
\medterm{High Potassium} Alternate name; see \textit{Hyperkalemia}.
...
\medterm{Hilar Lymphadenopathy} Pathological enlargement of the bronchopulmonary (hilar) lymph nodes located at the hilum of the lungs, identifiable on chest radiography and CT, classically presenting as bilateral symmetrical hilar adenopathy in sarcoidosis or unilateral enlargement in tuberculosis and lung malignancies.
\synonyms
Hilar Adenopathy; Bronchopulmonary Lymphadenopathy
...
\medterm{Hinge Joint} A joint that mainly allows bending and straightening in one direction, like a door hinge. The elbow and knee are examples.
...
\medterm{Hippocampal Sclerosis} Severe selective neuronal cell loss and astrocytic gliosis involving the pyramidal cell layer of the CA1 and CA4 subfields and the dentate gyrus of the hippocampus, representing the most common histopathological finding in medically refractory temporal lobe epilepsy.
...
\medterm{Hirata Disease} An uncommon autoimmune disorder characterized by recurrent episodes of severe hyperinsulinemic hypoglycemia triggered by high circulating titers of endogenous polyclonal autoantibodies directed against native human insulin. Occurs without prior exogenous insulin therapy, strongly associated with HLA-DR4 alleles and exposure to sulfhydryl-containing medications.
...
\medterm{Hirsutism} The excessive growth of coarse, pigmented terminal hair in females in an androgen-dependent, male-pattern distribution, including the face, chest, linea alba, lower back, and inner thighs. It is most commonly caused by polycystic ovary syndrome (PCOS), followed by idiopathic hirsutism (enhanced 5-alpha reductase activity), non-classic congenital adrenal hyperplasia, Cushing syndrome, androgen-secreting ovarian or adrenal neoplasms, and medications such as anabolic steroids.

\synonyms
Male-Pattern Hair Growth in Women; Androgenic Hair Excess
...
\medterm{HIV-Related Kidney Disease} Kidney disease associated with HIV infection, its immune effects, or treatment. It may include collapsing focal segmental glomerulosclerosis, immune-complex disease, thrombotic microangiopathy, or drug toxicity; antiretroviral therapy and kidney-protective care are important.
...
\medterm{HIV in Pregnancy} HIV infection during pregnancy can affect maternal health and can be transmitted to the fetus or newborn without effective care. Antiretroviral treatment, viral-load monitoring, obstetric planning, and newborn prophylaxis greatly reduce perinatal transmission; treatment decisions require specialist guidance.
...
\medterm{Holiday Heart Syndrome} An episode of atrial or other cardiac arrhythmia occurring after heavy or binge alcohol intake, often in someone without known structural heart disease. Atrial fibrillation is the most common presentation.
...
\medterm{Hollenhorst Plaque} A bright, glistening, refractile, golden-orange cholesterol crystal embolus observed on ophthalmoscopic examination lodged at a retinal arterial bifurcation, originating from an ulcerated atheromatous plaque in the ipsilateral carotid artery or aortic arch.
\synonyms
Hollenhorst's Plaque; Retinal Cholesterol Embolus
...
\medterm{Honeycomb Lung} The characteristic advanced radiographic and histopathological pattern of end-stage diffuse pulmonary fibrosis, consisting of cystic air spaces (3 to 10 mm in diameter) bounded by thickened fibrotic walls, classic for usual interstitial pneumonia (UIP) and idiopathic pulmonary fibrosis.
\synonyms
Honeycombing; Pulmonary Honeycombing

\medterm{Honeycomb Lung Pathology} End-stage fibrotic remodeling with multiple irregular cystic airspaces, often subpleural and lined by bronchiolar-type epithelium, accompanied by architectural distortion and interstitial fibrosis.
...
\medterm{Horizontal Pursuit} Smooth, coordinated movement of both eyes horizontally to follow a slowly moving visual target while maintaining fixation.
...
\medterm{Hospital- and Ventilator-Associated Pneumonia} Pneumonia developing during hospitalization, including ventilator-associated pneumonia after mechanical ventilation. Diagnosis considers new infiltrates or respiratory decline plus clinical evidence of infection; antimicrobial selection depends on local resistance, prior antibiotics, and patient risk factors.
...
\medterm{Hospital Latex Allergy Precautions} Clinical protocols and institutional safety measures implemented to protect sensitized hospital patients and healthcare workers from natural rubber latex exposure. Includes using non-latex gloves, latex-free medical devices, and clear allergy identification band protocols.

\synonyms
Latex Allergy Protocol; Latex-Safe Environment; Natural Rubber Latex Precautions
...
\medterm{Howship-Romberg Sign} Pain and paresthesias radiating along the medial and inner aspect of the thigh to the knee, caused by compression of the obturator nerve within the obturator canal by an obturator hernia, exacerbated by extension, abduction, and internal rotation of the hip.
\synonyms
Howship-Romberg Symptom; Obturator Nerve Compression Sign

\medterm{HPA (Hypothalamic-Pituitary-Adrenal Axis)} A hormone system linking parts of the brain with the adrenal glands. It helps the body respond to stress by controlling the release of cortisol, which affects blood pressure, blood sugar, immune activity, sleep, and energy.
...
\medterm{HPV (Human Papillomavirus)} Human papillomavirus is a group of viruses that infect the skin and moist body linings. Some types cause warts, while long-lasting infection with high-risk types can cause precancerous changes and cancers of the cervix, anus, genitals, or throat.
...
\medterm{H. Pylori} Alternate spelling; see \textit{Helicobacter Pylori}.

\medterm{H. Pylori Stool Antigen} A non-invasive enzymatic immunoassay that detects active gastrointestinal colonization by \textit{Helicobacter pylori} by identifying bacterial cell-wall protein antigens in stool, recommended for primary diagnosis and post-treatment eradication confirmation.

\synonyms
HpSA; Stool Antigen Test for H. Pylori

\medterm{HRCT (High-Resolution Computed Tomography)} Alternate name; see \textit{High-Resolution Computed Tomography}.

\medterm{H-Reflex} An electrophysiological monosynaptic reflex recorded during electromyography and nerve conduction studies, elicited by low-intensity submaximal electrical stimulation of sensory afferent fibers (group Ia) of a mixed peripheral nerve (such as the tibial nerve in the popliteal fossa). It bypasses the muscle spindle to evoke a delayed motor response in the corresponding muscle (soleus), providing a physiological measurement of S1 radicular and spinal reflex arc integrity.

\synonyms
Hoffmann Reflex; Electrophysiological Monosynaptic Reflex
...
\medterm{HRT (Hormone Replacement Therapy)} Hormone replacement therapy uses estrogen, with a progestogen when needed, to treat selected menopausal
...
\medterm{Ht (Hematocrit)} Common abbreviation for hematocrit, the percentage of blood volume occupied by red blood cells; in other contexts it may mean height.
...
\medterm{Hughes-Stovin Syndrome} An extremely rare condition involving blood clots in deep veins and several aneurysms in the lung arteries. It may be related to Beh\c{c}et disease and can cause life-threatening bleeding in the lungs.

\synonyms
HSS; Pulmonary Artery Aneurysm-Thrombosis Syndrome

\medterm{Human Bites} Injuries caused by human teeth that can inoculate mixed oral bacteria into skin, joints, tendons, or bone. Bites to the hand, deep punctures, delayed presentation, or signs of infection require urgent medical assessment, wound care, and consideration of antibiotics and tetanus prevention.
...
\medterm{Humerus Fracture} A break in the upper-arm bone caused by trauma, falls, overuse, or weakened bone. Pain, swelling, deformity, and impaired movement may occur, with assessment for nerve and vascular injury.
...
\medterm{Hunter's Syndrome} Alternate spelling; see \textit{Hunter Syndrome}.
...
\medterm{Huntington's Chorea (HD)} Alternate name; see \textit{Huntington Disease}.

\medterm{Huntington's Disease (HD)} Alternate name; see \textit{Huntington Disease}.
...
\medterm{Hurthle Cell Carcinoma (Oncocytic Carcinoma)} A differentiated thyroid cancer composed predominantly of oncocytic, or Hurthle, cells. It may behave more aggressively than some other differentiated thyroid cancers and is evaluated with thyroid imaging, cytology or histology, staging, and molecular findings.

\medterm{Hutchinson-Gilford Progeria Syndrome} An extremely rare, fatal autosomal dominant progeroid disorder caused by a de novo point mutation in the \textit{LMNA} gene that produces an aberrant, farnesylated lamin A protein called progerin, resulting in accelerated nuclear instability, premature aging, alopecia, atherosclerosis, and death from stroke or myocardial infarction in adolescence.

\synonyms
Progeria; HGPS

\medterm{Hutchinson Sign} The presence of herpetic cutaneous vesicles on the tip, side, or root of the nose in herpes zoster ophthalmicus, indicating viral involvement of the nasociliary branch of the ophthalmic nerve (cranial nerve V1) and carrying a high risk of ocular complications.
\synonyms
Hutchinson's Sign; Nasociliary Zoster Sign
...
\medterm{Hutchinson Teeth} A classic dental developmental abnormality occurring in congenital syphilis, characterized by permanent upper central incisors that are small, peg-shaped, or screwdriver-shaped with a distinctive central semilunar notch on their biting edge.
\synonyms
Hutchinson's Teeth; Notched Syphilitic Incisors

\medterm{Hutchinson Triad} The classic diagnostic clinical triad of late congenital syphilis, consisting of chronic interstitial keratitis, eighth cranial nerve sensorineural deafness, and Hutchinson notched central incisors.
\synonyms
...
\medterm{Hydatid Disease} A parasitic infection caused by \textit{Echinococcus} tapeworms. People usually become infected by swallowing eggs from infected dogs or contaminated food, water, or soil. Slow-growing fluid-filled cysts can form, most often in the liver or lungs. A leaking or burst cyst can cause a severe allergic reaction and spread the infection; treatment depends on the cyst and may include medicine, a procedure, or surgery.
...
\medterm{Hydrocarbon Toxicity} Poisoning from petroleum distillates or other hydrocarbons, with the greatest danger often being aspiration and chemical pneumonitis after ingestion. Cough, choking, hypoxia, respiratory failure, central nervous system depression, or dysrhythmias may occur; do not induce vomiting or perform routine gastric lavage, and provide respiratory and supportive care.

\medterm{Hydrocele} A collection of fluid around a testicle. It may be present from birth or develop after infection, injury, or another problem. It often causes painless swelling; examination and, when needed, ultrasound help confirm the cause.
...
\medterm{Hydroxylase Deficiency (21-Hydroxylase)} An inherited condition in which the adrenal glands cannot make enough of certain hormones. It can cause salt loss, low blood pressure, and excess male-type hormones, and is the most common cause of congenital adrenal hyperplasia.
...
\medterm{Hypercalcemia} An abnormally high level of calcium in the blood. It may be caused by overactive parathyroid glands, cancer, medicines, or other conditions. Symptoms can include thirst, frequent urination, constipation, nausea, weakness, confusion, kidney stones, or abnormal heart rhythms.
\synonyms{High Blood Calcium; Hypercalcaemia; Elevated Serum Calcium}

\medterm{Hypercalcemia Of Malignancy} A high blood-calcium level caused by cancer. It may occur because the cancer releases substances that raise calcium or damages bone. Severe cases can cause thirst, vomiting, weakness, confusion, kidney injury, or abnormal heart rhythms.

\medterm{Hypercalcemic Small Cell Ovarian Carcinoma} A rare, highly aggressive ovarian tumor in young patients, often associated with alterations in SMARCA4 and sometimes presenting with hypercalcemia.
...
\medterm{Hyperchloremic Acidosis} A normal-anion-gap metabolic acidosis in which bicarbonate loss is accompanied by a relative rise in chloride. Causes include gastrointestinal bicarbonate loss, renal tubular acidosis, certain medicines, and excessive chloride administration.
...
\medterm{Hyper IgM Syndrome} A primary immunodeficiency disorder characterized by normal or elevated serum IgM concentrations accompanied by severe deficiencies in IgG, IgA, and IgE, most commonly inherited as an X-linked defect in the \textit{CD40LG} gene encoding CD40 ligand on activated T-cells, preventing B-cell immunoglobulin isotype class switching.
...
\medterm{Hyperinsulinemia} An abnormally high insulin level in the blood, often caused by insulin resistance, excess insulin medicine, or rarely an insulin-producing tumor. It may occur with normal or low glucose.
...
\medterm{Hyperkalemia} An abnormally high serum potassium level, commonly from impaired kidney excretion, medicines, tissue breakdown, adrenal insufficiency, or acidosis; pseudohyperkalemia from hemolysis must be excluded. ECG changes may progress from peaked T waves and PR prolongation to QRS widening, sine-wave morphology, ventricular fibrillation, or asystole, making severe or rapidly rising potassium an emergency requiring myocardial stabilization and rapid potassium shifting or removal.
...
\medterm{Hypermetropia} Long-sightedness, in which the eye focuses light behind the retina instead of on it. Close objects may look blurred, and children may develop eye strain or an inward-turning eye.
\synonyms{Hyperopia; Farsightedness; Long-sightedness}

\medterm{Hypermobile Ehlers-Danlos Syndrome} An inherited connective-tissue disorder marked by unusually flexible or unstable joints, long-term muscle or joint pain, and other variable features involving the skin, automatic body functions, or digestion.
...
\medterm{Hypernatraemia} An abnormally high level of sodium in the blood, usually because the body has too little water. It may cause thirst, weakness, confusion, seizures, or coma.

\medterm{Hypernatremia} A high blood-sodium level, usually because the body has lost too much water or cannot obtain enough. It can cause intense thirst, weakness, confusion, seizures, or coma.
...
\medterm{Hyperosmolar Hyperglycemic State} A life-threatening condition in which very high blood glucose causes severe dehydration and concentrated body fluids, usually with little or no ketone buildup. It may cause extreme thirst, weakness, confusion, seizures, or coma.

\medterm{Hyperosmolar Non-Ketotic Coma} A life-threatening complication of very high blood glucose, usually in type 2 diabetes, causing severe dehydration and sometimes confusion, seizures, or coma.
...
\medterm{Hypertension and Pregnancy} High blood pressure before or during pregnancy ranges from chronic or gestational hypertension to preeclampsia and eclampsia. It can affect the brain, kidneys, liver, placenta, and fetal growth; blood-pressure monitoring, appropriate medicines, laboratory tests, and fetal surveillance are essential.

\medterm{Hypertension and the Kidney} High blood pressure can damage renal arteries and glomeruli, while kidney disease can activate salt-retaining and hormonal pathways that raise blood pressure. Their interaction can accelerate chronic kidney disease, so both blood pressure and kidney function require monitoring.
...
\medterm{High Triglycerides} Alternate name; see \textit{Hypertriglyceridemia}.
...
\medterm{Hypertrophic Osteoarthropathy} A syndrome of digital clubbing, periosteal new-bone formation, and joint pain or swelling. It may be primary and inherited or secondary to conditions such as lung cancer, chronic lung infection, cyanotic heart disease, or inflammatory disorders.
...
\medterm{Hyperventilation} Abnormally rapid, deep, or otherwise excessive breathing that removes more carbon dioxide than the body produces, often causing respiratory alkalosis. It may cause breathlessness, dizziness, tingling, chest tightness, muscle spasms, or fainting. Anxiety or panic can trigger it, but new or severe hyperventilation may reflect heart or lung disease, infection, bleeding, metabolic illness, or another emergency.
...
\medterm{Hypochloremic Alkalosis} A chloride-depletion form of metabolic alkalosis, commonly associated with vomiting, gastric suction, or diuretic use. Low chloride reflects loss of hydrogen and chloride ions and helps guide assessment of the cause and response to treatment.
...
\medterm{Hypoglossal Canal} A paired bony opening situated in the occipital bone above the anterolateral margin of the foramen magnum, directed laterally and forward to transmit the hypoglossal nerve (cranial nerve XII) and a meningeal branch of the ascending pharyngeal artery out of the posterior cranial fossa.
...
\medterm{Hypophosphatasia (HPP)} A rare inherited disorder caused by deficient tissue-nonspecific alkaline phosphatase, usually because of \textit{ALPL} variants. Poor bone and tooth mineralization can cause rickets or osteomalacia, fractures, bone pain, premature loss of teeth, or respiratory problems in severe infantile disease.
...
\medterm{Hypoproliferative Anemia} Anemia caused by inadequate red-cell production, usually with an inappropriately low reticulocyte response. Causes include iron deficiency, inflammation, kidney disease, endocrine or nutritional disorders, and bone-marrow failure or infiltration.
...
\medterm{Hyporeninemic Hypoaldosteronism} Reduced aldosterone production associated with inappropriately low renin activity, often occurring with diabetic kidney disease or other chronic kidney disorders. Hyperkalemia and a mild normal-anion-gap metabolic acidosis are common findings.
...
\medterm{Hypotony Maculopathy} A vision-threatening complication of persistent low intraocular pressure characterized by chorioretinal wrinkling and macular folds, optic disc edema, and decreased visual acuity.
...
\medterm{Hypoventilation Syndromes} Disorders in which alveolar ventilation is inadequate, causing elevated carbon dioxide, often with low oxygen. Causes include obesity hypoventilation, neuromuscular weakness, chest-wall disease, medicines, and impaired respiratory control; evaluation includes sleep and blood-gas assessment.
...
\medterm{Hypovolemic Shock} Circulatory failure from loss of intravascular volume, reducing venous return, cardiac output, and tissue perfusion. Hemorrhage is the most dangerous cause; other causes include vomiting, diarrhea, burns, third-spacing, and severe dehydration. Tachycardia, narrow pulse pressure, cool clammy skin, delayed capillary refill, oliguria, confusion, and elevated lactate may occur.
...
\medterm{Hypoxia-Inducible Factor} A heterodimeric master transcription factor complex (composed of an oxygen-regulated alpha subunit and a constitutive beta subunit) that under cellular hypoxic conditions escapes von Hippel-Lindau-mediated proteasomal degradation to upregulate target genes encoding erythropoietin, VEGF, and glycolytic enzymes.
...
\medterm{HANE} Historical abbreviation for hereditary angioneurotic edema, an older name for hereditary angioedema; see \textit{Hereditary Angioedema}.

\medterm{HHT} Abbreviation; see \textit{Hereditary Hemorrhagic Telangiectasia}.

\medterm{Hemorrhagic Telangiectasia, Hereditary (HHT)} Alternate name; see \textit{Hereditary Hemorrhagic Telangiectasia}.

\medterm{Hereditary Nonspherocytic Hemolytic Anemia (HNHA)} An inherited hemolytic anemia in which red blood cells are destroyed without the spherical shape typical of hereditary spherocytosis. Causes include red-cell enzyme defects, membrane disorders, and hemoglobin abnormalities; severity varies by the underlying genetic defect.

\medterm{Headaches, Tension-type} Alternate name; see \textit{Tension Headache}.

\medterm{Headaches/Migraines} Alternate consumer label for headache disorders, especially \textit{Migraine}; recurrent or new severe headaches require appropriate clinical evaluation.

\medterm{Heartburn/GERD} Alternate name; see \textit{Gastroesophageal Reflux Disease}.

\medterm{Hip Dysplasia, Congenital} Developmental or congenital abnormal formation of the hip joint that can make the femoral head unstable or dislocated; see \textit{Hip Dysplasia}.

\medterm{Histiocytosis X} Historical name for Langerhans cell histiocytosis, a disorder in which abnormal Langerhans cells accumulate in tissues; see \textit{Langerhans Cell Histiocytosis}.

\medterm{HLHS} Abbreviation; see \textit{Hypoplastic Left Heart Syndrome}.

\medterm{Hodgkin's Disease} Alternate name; see \textit{Hodgkin Lymphoma}.

\medterm{Homozygous Alpha-1-Antitrypsin Deficiency} Severe inherited alpha-1 antitrypsin deficiency caused by disease-associated variants in both gene copies, increasing risk of early emphysema and liver disease; see \textit{Alpha-1 Antitrypsin Deficiency}.

\medterm{Homozygous Familial Hypercholesterolemia} Severe familial hypercholesterolemia caused by pathogenic variants affecting both copies of a relevant lipid-clearance gene; LDL cholesterol can be extremely high and atherosclerotic disease may occur early.

\medterm{Hormone Therapy for Endometriosis} Hormonal treatment used to suppress ovarian cycling and reduce endometriosis-related pain or lesion activity. Options include combined hormonal contraceptives, progestins, or other ovarian-suppressing medicines selected according to symptoms, pregnancy plans, and risks.

\medterm{HPV/Genital Warts} Alternate name; see \textit{Human Papillomavirus} and \textit{Genital Warts}.

\medterm{Human Cyclic Neutropenia} Alternate name; see \textit{Cyclic Neutropenia}.

\medterm{Human Cytomegalovirus Infection} Alternate name; see \textit{Cytomegalovirus Infection}.

\medterm{Human Immunodeficiency Virus (HIV)} Alternate name; see \textit{Human Immunodeficiency Virus}.

\medterm{Human Papillomavirus (HPV/Genital Warts)} Alternate name; see \textit{Human Papillomavirus}.

\medterm{Hurler Disease} Alternate name for severe mucopolysaccharidosis type I; see \textit{Mucopolysaccharidosis Type I}.

\medterm{Hutchinson-Gilford Progeria Syndrome (HGPS)} Alternate name; see \textit{Hutchinson-Gilford Progeria Syndrome}.

\medterm{Hutchinson-Gilford Syndrome (HGPS)} Alternate name; see \textit{Hutchinson-Gilford Progeria Syndrome}.

\medterm{Hydrocephalus, Congenital} Hydrocephalus present at birth or caused by a developmental abnormality, genetic condition, or congenital infection; see \textit{Hydrocephalus}.

\medterm{Hygroma Colli} Alternate name for a cystic hygroma, a congenital lymphatic malformation usually involving the neck; see \textit{Cystic Hygroma}.

\medterm{Hyperactivity, ADHD} Hyperactive or impulsive behavior occurring as part of attention-deficit/hyperactivity disorder; diagnosis requires persistent symptoms and impairment across appropriate settings, not activity level alone.

\medterm{Hyperammonemia due to Ornithine Transcarbamylase Deficiency} An inherited urea-cycle disorder in which ornithine transcarbamylase deficiency causes ammonia to accumulate, potentially producing vomiting, confusion, seizures, brain swelling, or coma.

\medterm{Hypercalcemia-Supravalvar Aortic Stenosis} A combination of high blood calcium and narrowing above the aortic valve, classically associated with Williams syndrome; see \textit{Williams Syndrome}.

\medterm{Hypoplastic Left Heart Syndrome (HLHS)} Alternate name; see \textit{Hypoplastic Left Heart Syndrome}.

\medterm{Hypotonia-Hypomentia-Hypogonadism-Obesity Syndrome (HHHO)} Historical descriptive name for Prader--Willi syndrome, a genetic disorder involving infantile hypotonia, developmental or intellectual disability, hypogonadism, and later hyperphagia with obesity; see \textit{Prader-Willi Syndrome}.
