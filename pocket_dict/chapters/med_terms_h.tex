...
\synonyms
Helminth Infection; Helminth Infections; Helminthic Infections
...
\medterm{Hemorrhoids (Piles)} Alternate term; see \textit{Hemorrhoids}.
...
\medterm{Hepatitis (Viral Hepatitis)} Alternate term; see \textit{Viral hepatitis}.
...
\medterm{Hepatitis D (Delta Agent)} Another name for hepatitis D, a liver infection caused by HDV. HDV needs HBV to reproduce. It may occur as coinfection with HBV or as superinfection in someone who already has HBV; superinfection is more likely to cause long-term liver disease, cirrhosis, liver failure, or death.
...
\medterm{Herpes Labialis} Alternate index label; see \textit{Cold sore}.
...
\medterm{Hiccough (Hiccup)} Alternate spelling; see \textit{Hiccups}.
...
\medterm{Hiccups (Singultus)} Medical term; see \textit{Hiccups}.
...
\medterm{Hodgkin Lymphoma (Hodgkin Disease)} Alternate term; see \textit{Hodgkin lymphoma}.
...
\medterm{Hordeolum} Alternate index label for Stye.
...
\medterm{Human Papillomavirus Infection} Alternate index label; see \textit{Human Papillomavirus}.
