...
\medterm{Urine Calcium Test} A diagnostic urinalysis quantifying urinary calcium excretion, typically measured in a 24-hour urine collection. It is utilized in the evaluation and metabolic workup of nephrolithiasis, hyperparathyroidism, osteomalacia, and idiopathic hypercalciuria.
...
\medterm{Cardiac Tamponade} A life-threatening buildup of fluid or blood around the heart that prevents the heart chambers from filling properly. It can cause low blood pressure, breathlessness, fainting, shock, or cardiac arrest. Bedside echocardiography can support the diagnosis, but doctors also use the examination and the cause. Emergency drainage with a needle or surgery may be needed.
...
\medterm{Fatal Catatonia} A severe, life-threatening form of catatonia with extreme motor disturbance, fever, unstable blood pressure or heart rate, dehydration, and risk of organ failure. It requires emergency treatment.
...
\medterm{Plasma / Urine Catecholamine Assay} Blood or urine tests measuring catecholamines or their breakdown products. They may help investigate pheochromocytoma or paraganglioma, but medicines, stress, posture, diet, and collection conditions can affect results.

\synonyms
Fractionated Catecholamines; Free Metanephrines

\medterm{Urine Catecholamine Test} A diagnostic biochemical assay measuring 24-hour urinary excretion of epinephrine, norepinephrine, dopamine, and their metanephrine metabolites to diagnose neuroendocrine tumors such as pheochromocytoma, paraganglioma, and neuroblastoma.
...
\medterm{Male Chlamydial Infection} A sexually transmitted infection in men caused by \textit{Chlamydia trachomatis} (serovars D--K), most frequently manifesting as non-gonococcal urethritis, epididymo-orchitis, or proctitis, characterized by dysuria, mucoid urethral discharge, and testicular tenderness.
...
\medterm{Serum Chloride Test} A clinical laboratory measurement of chloride ($\text{Cl}^-$) concentration in serum or plasma, essential for calculating the serum anion gap and evaluating acid-base balance, hydration status, and renal tubular function.

\synonyms
Serum Chloride; Blood Chloride Test; Serum Electrolytes Chloride

\medterm{Urine Chloride Test} A diagnostic urinalysis quantifying urinary chloride excretion, crucial in differentiating chloride-responsive (e.g., vomiting, diuretic use) from chloride-resistant (e.g., hyperaldosteronism) metabolic alkalosis.
...
\medterm{Blood Cholinesterase Test} A clinical enzymatic assay measuring erythrocyte acetylcholinesterase (true cholinesterase) or plasma butyrylcholinesterase (pseudocholinesterase) activity to diagnose organophosphate or carbamate pesticide toxicity and evaluate inherited pseudocholinesterase deficiency.
...
\medterm{Toxoplasma Chorioretinitis} Alternate name; see \textit{Ocular Toxoplasmosis}.
...
\medterm{Blood Chromium Test} A specialized trace element assay quantifying whole blood or serum chromium concentrations to assess occupational exposure, evaluate metal-on-metal orthopedic implant wear and systemic metallosis, or monitor trace element balance in total parenteral nutrition.
...
\medterm{Hospital Code} An announcement used in a hospital to summon staff for an emergency. The number or color and the required response depend on that hospital's policy.
...
\medterm{Collagen Vascular Disease} Outdated umbrella term; use the specific connective-tissue or autoimmune diagnosis.
