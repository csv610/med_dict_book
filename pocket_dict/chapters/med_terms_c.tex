...
\medterm{Candidiasis} Alternate index label for Yeast Infection.
...
\medterm{Cardiogenic Shock Management} Emergency treatment of shock caused by severe heart failure. Care supports breathing and circulation, treats the cause—such as a heart attack—and may include medicines to raise blood pressure, restore blood flow, or temporarily support pumping.
...
\synonyms
CES; Compression of Cauda Equina
...
\medterm{Cephalgia} Alternate index label for Headache.
...
\medterm{Cervical Intraepithelial Neoplasia (Cervical Dysplasia)} Alternate name; see \textit{Cervical Dysplasia}.
...
\medterm{Cervical Screening (Pap Smear)} Testing cells from the cervix to find human papillomavirus infection or early changes that could become cancer. Screening may use HPV testing, cell examination, or both according to age, risk, and local guidance; an abnormal result is not itself cancer.
...
\medterm{Charcot Triad (Cholangitis)} The combination of fever, pain in the upper-right abdomen, and jaundice. It is a classic pattern of infection in blocked bile ducts, but many people with serious infection do not have all three signs.
...
\medterm{Chilblains (Pernio)} Alternate name; see \textit{Chilblains}.
...
\synonyms
Lipid Management; Dyslipidemia Therapy
...
\medterm{Chorea, Huntington's} Alternate index label for Huntington Disease.
...
\medterm{Chronic Spontaneous Urticaria} Hives occurring repeatedly for more than six weeks without a consistent external trigger. Individual welts usually fade within 24 hours, although deeper swelling called angioedema may also occur.
...
\medterm{Chronic Obstructive Pulmonary Disorder (COPD)} A long-term lung disease in which damaged or narrowed airways make it difficult to move air out of the lungs. It commonly causes breathlessness, cough, mucus, and wheezing and is often related to smoking or other inhaled exposures.
...
\medterm{Citric Acid Cycle (Krebs Cycle)} A series of chemical reactions inside mitochondria that breaks down products of food and produces energy for cells. It also supplies building blocks needed to make proteins, fats, and other cell components.
...
\medterm{Clavicle Fracture (Intentional)} A deliberate fracture of a baby's collarbone during an emergency delivery when the shoulders are stuck and other measures have failed. It creates more room for birth and usually heals, but is used only as a last-resort obstetric procedure.
...
\medterm{Cluster Headaches} Alternate index label for Cluster Headache.
...
\medterm{Colorectal Cancer (Colon Cancer)} Alternate index label; see \textit{Colorectal cancer}.
...
\medterm{Conjunctivitis Or Pink Eye} Alternate index label for Pink Eye.
...
\medterm{Conversion Disorder (Functional Neurological Symptom Disorder)} A condition causing genuine problems such as weakness, abnormal movements, loss of sensation, or seizure-like episodes because of altered nervous-system functioning. The symptoms are not intentionally produced and can interfere with daily life.
...
\medterm{Cow's Milk - Infants} Cow's milk should not replace breast milk or iron-fortified infant formula before 12 months. It does not provide enough iron for infants and may increase the risk of intestinal blood loss and kidney strain.
...
\medterm{Crackles (Rales)} Brief popping or bubbling sounds heard in the lungs, usually while breathing in. They may occur when small airways reopen or when air moves through fluid, as in pneumonia, heart failure, or scarring.
...
\medterm{Crepitation (Crepitus)} Alternate name; see \textit{Crepitus}.
...
\medterm{CT Scan (Computed Tomography)} Alternate index label; see \textit{CT Scan}.

\medterm{Ctenocephalides Flea Bite (Flea Bites In Humans)} Alternate index label for Flea Bites in Humans.
...
\medterm{Cutting For The Stone} An old term for an operation that opens part of the urinary tract to remove a stone. Modern stone treatment usually uses less invasive procedures when suitable.
...
\medterm{Cyclothymia (Cyclothymic Disorder)} Alternate index label for Cyclothymic Disorder.
...
\medterm{Cyst (Giardia Lamblia)} Alternate index label for Giardia Lamblia.
...
\medterm{Cystine And Triple Phosphate (Struvite) Crystals} Two types of crystals that may appear in urine. Cystine crystals can indicate an inherited tendency to form stones, while struvite crystals may occur with some urinary infections; results need clinical interpretation.
...
\medterm{Cystitis - Acute} Sudden inflammation of the bladder, most often from a bacterial urinary infection. It can cause burning when urinating, frequent or urgent urination, lower abdominal discomfort, or blood in the urine; fever or flank pain may indicate kidney infection.
...
\medterm{Cytogenetics (Karyotype)} A laboratory examination that arranges a person's chromosomes to check their number and large structural changes. It can help investigate inherited conditions, developmental differences, infertility, pregnancy concerns, and some cancers.
