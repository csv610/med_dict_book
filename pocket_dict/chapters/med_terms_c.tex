...
\medterm{Calorie} A unit of energy. In nutrition, a food Calorie is a kilocalorie, equal to 1,000 small calories, and describes the energy supplied by food or used by the body.
...
\medterm{Cancer Risk} Alternate index label; see \textit{Causes of Cancer}.
...
\medterm{Cardiospasm} Alternate name; see \textit{Achalasia}.
...
\medterm{Celiac Disease} Alternate name; see \textit{Celiac Sprue}.
...
\medterm{Centimeter} A unit of length equal to one hundredth of a meter, or ten millimeters, commonly used to measure body structures and objects.
...
\medterm{Cerebrovascular Accident} Sudden brain dysfunction caused by interrupted blood flow or bleeding in the brain. See Stroke.
\synonyms
Stroke
...
\medterm{Cervical Intraepithelial Neoplasia} Alternate name; see \textit{Cervical Dysplasia}.
...
\medterm{Cervical Vertebrae} The seven vertebrae of the neck, numbered C1 through C7; they support the head, protect the cervical spinal cord, and allow neck movement.
...
\medterm{Chigger Bites} Alternate name; see \textit{Chiggers}.
...
\medterm{Chilblains} Alternate name; see \textit{Pernio}.
...
\medterm{Chloasma} Alternate name; see \textit{Melasma}.
...
\medterm{Chloride Ion} The chemical symbol for chloride, the negatively charged ion of chlorine and a major extracellular electrolyte.
...
\medterm{Cholelithiasis} Alternate name; see \textit{Gallstones}.
...
\medterm{Chorioretinitis} Alternate name; see \textit{Posterior Uveitis}.
...
\medterm{Chronic Lymphocytic Thyroiditis} Alternate name; see \textit{Hashimoto's Disease}.
...
\medterm{Churg-Strauss Syndrome} Alternate name; see \textit{Eosinophilic Granulomatosis with Polyangiitis}.
...
\medterm{Citric Acid Cycle} A series of chemical reactions inside mitochondria that breaks down products of food and produces energy for cells. It also supplies building blocks needed to make proteins, fats, and other cell components.
...
\medterm{Clinical Depression} Alternate name; see \textit{Major Depressive Disorder}.
...
\medterm{Clubfoot} Alternate name; see \textit{Talipes Equinovarus}.
...
\medterm{Coats Disease} Alternate name; see \textit{Coats' Disease}.
...
\medterm{Colitis, Microscopic} Alternate name; see \textit{Microscopic Colitis}.
...
\medterm{Colitis, Ulcerative} Alternate name; see \textit{Ulcerative Colitis}.
...
\medterm{Collapsed Lung} Air trapped between the lung and chest wall, causing part or all of the lung to collapse. It may cause sudden chest pain and breathlessness; pressure that shifts the heart and other structures is immediately life-threatening.
...
\medterm{Colorectal Cancer} Alternate name; see \textit{Colorectal Cancer}.
...
\medterm{Congenital Megacolon} Alternate name; see \textit{Hirschsprung Disease}.
...
\medterm{Conjunctivitis} Alternate name; see \textit{Pink Eye}.
...
\medterm{Constipation} Alternate name; see \textit{Constipation Management}.
...
\medterm{Conversion Disorder} Alternate name; see \textit{Conversion Disorder}.
...
\medterm{Costochondritis} Alternate name; see \textit{Costochondritis and Tietze Syndrome}.
...
\medterm{Cramps, Menstrual} Alternate name; see \textit{Dysmenorrhea}.
...
\medterm{CT Scan} Alternate name; see \textit{Computed Tomography}.
...
\medterm{Cyclospora Infection} Alternate name; see \textit{Cyclosporiasis}.
...
\medterm{Cyclosporiasis} An intestinal infection caused by Cyclospora parasites, typically producing prolonged watery diarrhea, cramps, nausea, and fatigue.

\medterm{Cyclothymia} Historical or alternate term; see \textit{Cyclothymic Disorder}.

\medterm{Cyclothymia} Alternate name; see \textit{Cyclothymic Disorder}.
