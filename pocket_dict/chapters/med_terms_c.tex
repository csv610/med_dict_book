\medterm{C-11 Hydroxylase Deficiency} A form of congenital adrenal hyperplasia caused by impaired 11-beta-hydroxylase activity. Reduced cortisol synthesis increases adrenal androgens and deoxycorticosterone, which may cause androgen excess, virilization, hypertension, and low potassium.

\medterm{C-17 Hydroxylase Deficiency} A form of congenital adrenal hyperplasia caused by impaired 17-alpha-hydroxylase activity. It reduces cortisol and sex-steroid production and may cause hypertension, low potassium, undervirilization, or absent puberty.
...
\medterm{Caffeine Toxicity} Stimulant poisoning causing nausea, vomiting, agitation, tremor, tachycardia, hypertension, hypokalemia, hyperglycemia, and sometimes seizures or ventricular dysrhythmias. Severe cases require ECG and electrolyte monitoring, benzodiazepines for agitation or seizures, supportive care, and occasionally activated charcoal or extracorporeal removal.
...
\medterm{Calcaneal Valgus} An outward tilting of the heel so that the foot rolls toward the body's midline. It may occur with flat feet, altered lower-limb alignment, or developmental and neuromuscular conditions and can affect walking or cause pain.
...
\medterm{Calcarine Sulcus} An anatomical fissure located on the medial surface of the occipital lobe of the brain, running horizontally from the parieto-occipital sulcus to the occipital pole; its upper and lower banks constitute the primary visual cortex (Brodmann area 17).
...
\medterm{Calcinosis} Abnormal deposition of insoluble calcium salts in the skin or deeper soft tissues, often associated with autoimmune connective-tissue disease, kidney disease, trauma, or an abnormal calcium-phosphate balance. Firm white or yellow nodules or plaques may be painful, restrict movement, ulcerate, or release chalky material.

\medterm{Calcinosis Cutis} Deposition of calcium salts in the skin or subcutaneous tissue, producing firm white or yellow papules, nodules, or plaques. Lesions may be painless or tender, restrict movement, ulcerate, or discharge chalky material; the cause and blood calcium or phosphate levels guide evaluation.
...
\medterm{Calcium Channel Blocker Toxicity} Overdose causing vasodilatory or cardiogenic shock with hypotension, bradycardia, atrioventricular block, hyperglycemia, and sometimes pulmonary edema or cardiac arrest. Treatment may include intravenous calcium, vasopressors, high-dose insulin with glucose, and selected lipid emulsion or mechanical support under toxicology guidance.
...
\medterm{Campylobacter Enteritis} An acute bacterial foodborne or waterborne diarrheal illness caused predominantly by \textit{Campylobacter jejuni}, presenting with fever, severe cramping abdominal pain mimicking appendicitis, and inflammatory bloody diarrhea, with potential post-infectious Guillain-Barre syndrome.
...
\medterm{Campylobacter Food Poisoning} A foodborne infection caused by Campylobacter bacteria, often from undercooked poultry, unpasteurized milk, or contaminated water. It causes diarrhea, cramps, and fever and may rarely trigger bloodstream infection or nerve inflammation.
...
\medterm{Cancers of the Oral Mucosa} Malignant tumors arising in the moist lining of the mouth, most commonly squamous cell carcinoma. Persistent ulcers, red or white patches, lumps, bleeding, pain, numbness, or swallowing difficulty require prompt examination and biopsy; tobacco, alcohol, HPV, and other factors can contribute.
...
\medterm{Canker Sores} Alternate name; see \textit{Aphthous stomatitis}.
...
\medterm{Cannabis-Related Disorders} Clinically significant problems related to cannabis use, including intoxication, withdrawal, cannabis use disorder, and substance-induced psychiatric or medical effects.
...
\medterm{Capacitation} The final physiological maturation process that mammalian spermatozoa undergo within the female reproductive tract, involving the removal of glycoprotein coats and seminal plasma proteins from the acrosome, enabling the sperm to undergo the acrosome reaction and fertilize an oocyte.
...
\medterm{Capgras Delusion} A psychiatric misidentification syndrome in which an individual maintains a fixed, unshakeable delusion that a close relative, spouse, or companion has been replaced by an identical-looking imposter, double, or clone. Hypothesized to stem from a neuroanatomical disconnection between visual facial recognition pathways in the fusiform gyrus and emotional familiarity processing in the amygdala.
...
\medterm{Capillary Blood Gas} A test of blood acidity and carbon dioxide using a small sample from a heel or finger. It is often used in babies and children when an arterial sample is difficult; oxygen results may not match an arterial blood gas.
...
\medterm{Capillary Exchange} The movement of oxygen, carbon dioxide, nutrients, fluid, hormones, and waste between blood in capillaries and nearby tissues.

\medterm{Capillary Hemangioma} A usually harmless growth made of small blood vessels, common in infancy. It often appears during the first weeks of life, grows for a time, and then slowly becomes smaller. Some lesions near the eye, airway, or other important areas need treatment. Medicines such as propranolol may be used for high-risk lesions, while small superficial lesions may need only observation or local treatment.
...
\medterm{Capillary Malformation} A congenital difference in small skin blood vessels that produces a flat pink, red, or violaceous patch, such as a port-wine stain. It usually persists and may darken or thicken over time; location and associated findings determine whether eye, brain, or other specialist evaluation is needed.
...
\medterm{Capillary Permeability} How easily fluid and dissolved substances pass through the walls of small blood vessels. Increased permeability can allow extra fluid and proteins to enter nearby tissues and cause swelling.
...
\medterm{Caplan Syndrome} The coexistence of rheumatoid arthritis with occupational pneumoconiosis (most commonly coal workers' pneumoconiosis or silicosis), characterized by the development of multiple discrete, round, peripheral pulmonary nodules measuring 0.5 to 5 centimeters on chest radiography. Histologically, the nodules resemble enlarged rheumatoid nodules with central necrotic debris surrounded by chronic inflammatory cells and dust-laden macrophages.

\synonyms
Rheumatoid Pneumoconiosis; Silicoarthritis
...
\medterm{Capsular Warning Syndrome} A clinical syndrome characterized by recurrent, stereotyped episodes of transient focal motor or sensory deficits affecting the face, arm, and leg without cortical signs (such as aphasia or visual neglect). Occurring repeatedly within a 24- to 72-hour window, it indicates impending lacunar infarction of the internal capsule due to branch atheromatous disease of a lenticulostriate artery.

\synonyms
Internal Capsule Warning Syndrome; Fluctuating Lacunar TIA
...
\medterm{Capsulotomy} A procedure that makes an opening in a capsule. In the eye, a laser may open a cloudy capsule after cataract surgery; in other surgery, a capsule around an implant or joint may be opened to reduce tightness. The method and risks depend on the body part.
...
\medterm{Carbamazepine Toxicity} Overdose causing drowsiness, ataxia, nystagmus, anticholinergic effects, hypotension, seizures, coma, or sodium-channel-mediated QRS widening and dysrhythmias. Serial drug levels and ECGs help guide care; activated charcoal, sodium bicarbonate for cardiotoxicity, and hemodialysis may be used in severe cases.
...
\medterm{Carbamoyl Phosphate Synthetase Deficiency} An inherited urea-cycle disorder caused by deficient carbamoyl phosphate synthetase I. The liver cannot efficiently convert ammonia into urea, so hyperammonemia may cause poor feeding, vomiting, sleepiness, seizures, coma, or developmental injury.
...
\medterm{Carbohydrate} One of the three main macronutrients, found in sugars, starches, fruits, grains, vegetables, legumes, and milk. Sugars and most starches are digested into simple sugars, mainly glucose, for energy; dietary fiber is a carbohydrate that is not fully digested.
...
\medterm{Carbohydrates} Sugars, starches, and fiber that form one of the three main macronutrients in food. Sugars and most starches are broken down into simple sugars, mainly glucose, for energy, while fiber is not fully digested and can support bowel function, fullness, cholesterol levels, and blood-glucose control.
...
\medterm{Carbon Monoxide Toxicity} Tissue hypoxia caused by inhaled carbon monoxide binding hemoglobin and impairing cellular oxygen use. Headache, dizziness, nausea, confusion, syncope, myocardial ischemia, seizures, or coma may occur; pulse oximetry can be misleading, so co-oximetry and exposure history are important. Give 100\% oxygen and consider hyperbaric therapy for selected severe cases.
...
\medterm{Carcinoembryonic Antigen Tumor Marker} Carcinoembryonic antigen, a substance measured mainly in blood to help monitor some colorectal and other cancers. Levels can also rise from smoking or noncancerous conditions, so CEA cannot diagnose cancer by itself.
...
\medterm{Carcinoid Flushing} Sudden, transient cutaneous erythema and warmth, predominantly affecting the face, neck, and upper chest, provoked by systemic release of serotonin, bradykinin, and histamine from a metastatic neuroendocrine (carcinoid) tumor with hepatic metastases.
...
\medterm{Cardiac Contractility} The strength of heart-muscle contraction at a given level of filling and resistance. It affects how much blood the heart can pump with each beat.
...
\medterm{Cardiac Glycoside Plant Poisoning} Poisoning by oleander, foxglove, or similar plants containing digoxin-like cardiac glycosides. Nausea, vomiting, visual disturbances, bradycardia, atrioventricular block, ventricular dysrhythmias, and hyperkalemia may occur; ECG, potassium, and renal function should be monitored, and digoxin-specific antibody fragments are used for life-threatening toxicity.
...
\medterm{Cardiac Markers} Blood tests used to detect myocardial injury or cardiac stress, including troponin, creatine kinase-MB, and natriuretic peptides. Results are interpreted with symptoms, electrocardiography, imaging, timing, and other causes of abnormal values.
...
\medterm{Cardiac Septum} The wall separating the right and left chambers of the heart, consisting of atrial and ventricular portions and preventing normal mixing of oxygenated and deoxygenated blood.
...
\medterm{Cardiac Tamponade} A life-threatening state in which pressure from fluid, blood, or pus in the sac around the heart impairs cardiac filling and reduces cardiac output. It can cause low blood pressure, breathlessness, fainting, raised neck veins, shock, or cardiac arrest. Echocardiography supports the diagnosis, but clinical assessment and the cause are also important; urgent drainage with a needle or surgery is often required.
...
\medterm{Cardiovascular Disease and Pregnancy} Heart disease may worsen during pregnancy because blood volume and cardiac output increase, while pregnancy can reveal previously unrecognized disease. Risk depends on the specific lesion and ventricular function; coordinated cardiology and maternal-fetal care guides monitoring, medicines, and delivery.
...
\medterm{Cardiovascular-Kidney-Metabolic (CKM) Syndrome} A framework describing interconnected cardiovascular, kidney, and metabolic dysfunction, often involving obesity, diabetes, hypertension, dyslipidemia, or chronic kidney disease. Risk is assessed across stages to guide prevention and coordinated care.
...
\medterm{Cardiovascular Prevention in Diabetes} Medical and lifestyle strategies to reduce the high risk of heart attacks and strokes in diabetic patients, including blood pressure control, statin therapy, glucose management, smoking cessation, and healthy diet.

\synonyms
Diabetic Cardiovascular Risk Reduction; Heart Disease Prevention in Diabetes
...
\medterm{Cardiovascular System} The heart, blood, and network of arteries, arterioles, capillaries, venules, and veins that circulate blood through the pulmonary and systemic circuits. It delivers oxygen, nutrients, hormones, and immune cells, carries carbon dioxide and other waste for removal, and helps regulate temperature and blood pressure.
...
\medterm{C-Arm Fluoroscopy} A movable X-ray system that gives live images during a medical procedure. It helps show bones, instruments, blood vessels, or other body parts while the procedure is being performed.
...
\medterm{Carnitine Deficiency} An abnormally low amount of carnitine, which transports long-chain fatty acids into mitochondria for energy production. Primary inherited or secondary deficiency can cause muscle weakness, low blood sugar, cardiomyopathy, or episodes of metabolic decompensation.
...
\medterm{Carotenemia} Yellow-orange discoloration of the skin caused by increased carotene in the blood, usually from eating large amounts of carotene-rich foods or supplements. The whites of the eyes remain white, which helps distinguish it from jaundice; persistent or unexplained discoloration needs assessment.
...
\medterm{Carotid Artery Dissection} A tear in the inner lining of a carotid artery that lets blood split the arterial wall and form an intramural hematoma. It may cause sudden neck or head pain, partial Horner syndrome, transient ischemic attack, or ischemic stroke; urgent vascular imaging is needed.
...
\medterm{Carotid Cavernous Fistula} An abnormal connection between blood vessels near the carotid artery and a large vein behind the eye. It may cause a bulging or red eye, a pulsing noise, double vision, high eye pressure, or reduced vision. Brain and blood-vessel imaging is used for diagnosis. Treatment depends on the type and may include endovascular closure.
...
\medterm{Carotid Glomus} A specialized peripheral chemoreceptor sensory organ located in the adventitia of the carotid bifurcation, containing glomus type I cells that detect arterial hypoxemia, hypercapnia, and acidosis to reflexively stimulate respiration via the glossopharyngeal nerve.
...
\medterm{Carotid Sinus Hypersensitivity} An exaggerated reflex response to tactile mechanical stimulation of the carotid sinus baroreceptors, producing marked bradycardia (cardioinhibitory type), profound hypotension (vasodepressor type), or both, predisposing to presyncope or syncope.

\synonyms
Carotid Sinus Syndrome

\medterm{Carotid Sinus Massage} A medical test in which a clinician gently presses over a neck artery to see how the heart rhythm responds. It may help assess or stop some fast heart rhythms, but it can be dangerous and must only be done by a trained clinician after checking for risks.
\synonyms
...
\medterm{Cast Nephropathy} A classic renal manifestation of multiple myeloma in which excessive circulating monoclonal immunoglobulin free light chains (Bence-Jones proteins) precipitate with Tamm-Horsfall mucoprotein in distal tubules, forming dense casts that obstruct tubules and induce giant cell inflammation.
...
\medterm{Catheter-Associated Urinary Tract Infection} A hospital-acquired infection of the urinary tract occurring in a patient with an indwelling urinary catheter within the prior 48 hours, characterized by bacteriuria, pyuria, fever, or suprapubic tenderness.
...
\medterm{CAT Scan} Older name; see \textit{Computed Tomography}.
...
\medterm{Cauda Equina Syndrome} An emergency caused by severe pressure on the bundle of nerves at the bottom of the spine, often from a large slipped disc. Warning signs include numbness around the groin or buttocks, difficulty urinating, loss of bladder or bowel control, severe leg pain, or leg weakness. Urgent assessment and MRI are needed; some people need emergency surgery to reduce the risk of lasting nerve damage.
\synonyms{CES; Cauda Equina Compression; Spinal Nerve Root Compression}

\medterm{Cauda Equina Syndrome Cross-Reference} Alternate name; see \textit{Cauda equina syndrome}.
...
\medterm{Cell-Free DNA} Non-encapsulated extracellular DNA fragments circulating freely in blood plasma or other biofluids, released from apoptotic or necrotic cells; analyzed in non-invasive prenatal screening (NIPT) and oncology liquid biopsies.
...
\medterm{Central Cyanosis} A bluish or purplish discoloration of the skin, mucous membranes, tongue, and lips resulting from an abnormally elevated concentration of deoxygenated hemoglobin (greater than 5 g/dL) in systemic arterial blood, typically reflecting severe respiratory compromise or right-to-left cardiac shunting.
...
\medterm{Central Nervous System Germinoma} A malignant germ-cell tumor usually arising in the brain, often near the pineal or suprasellar region. It may cause headache, visual or endocrine abnormalities, hydrocephalus, or impaired puberty; MRI, tumor markers, and specialist evaluation are important.
...
\medterm{Central Sleep Apnea Syndromes} Repeated pauses or reductions in breathing during sleep caused by diminished respiratory drive rather than upper-airway blockage. Causes include heart failure, opioids, neurologic disease, high altitude, and treatment-emergent patterns; evaluation and therapy depend on the underlying mechanism.



\medterm{Central Sulcus} A prominent anatomical landmark on the lateral cerebral cortex separating the precentral gyrus of the frontal lobe (primary motor cortex) from the postcentral gyrus of the parietal lobe (primary somatosensory cortex).

\synonyms
Rolandic Fissure; Sulcus of Rolando
...
\medterm{Central Vertigo} Dizziness or an illusion of motion caused by dysfunction in the brainstem, cerebellum, or central vestibular pathways. It may occur with neurologic signs, severe imbalance, or less position-dependent symptoms.
...
\medterm{Cephalhematoma} A traumatic subperiosteal collection of blood over a neonatal cranial bone, commonly the parietal bone, resulting from rupture of periosteal blood vessels during delivery; clinically distinguished from caput succedaneum by remaining strictly bounded by cranial suture lines.
...
\medterm{Cerebellar Peduncle} One of three pairs of large, compact white matter fiber tracts (superior, middle, and inferior cerebellar peduncles) that physically and functionally connect the cerebellum to the midbrain, pons, and medulla oblongata, respectively.

\medterm{Cerebellar Tonsillar Herniation} The life-threatening downward displacement of the cerebellar tonsils through the foramen magnum into the upper cervical spinal canal, causing direct compression of the cardiorespiratory and vasomotor centers of the medulla oblongata.
...
\medterm{Cerebral Palsy Entry} Alternate name; see \textit{Cerebral palsy}.
...
\medterm{Cerebral Salt-Wasting Syndrome} A clinical disorder of hyponatremia and extracellular fluid volume depletion occurring in acute central nervous system disease (such as subarachnoid hemorrhage or head trauma), characterized by renal natriuresis, polyuria, and true intravascular hypovolemia.
...
\medterm{Cerebrotendinous Xanthomatosis (CTX)} A rare inherited disorder of bile-acid synthesis, usually caused by \textit{CYP27A1} variants. Cholesterol-derived substances accumulate in the brain, tendons, and other tissues and may cause cataracts, chronic diarrhea, tendon xanthomas, seizures, ataxia, or progressive neurologic disease.
...
\medterm{Cervical Plexus} A network of nerves in the neck that carries sensation from the neck and part of the head and helps control some neck muscles and the diaphragm.
...
\medterm{Cervical Ripening} Softening, thinning, and early opening of the cervix before or during labor. It may occur naturally or be induced with medicines or mechanical methods when labor needs to be started; the method depends on cervical findings, pregnancy factors, and uterine-scar history.
...
\medterm{Cervical Screening} Testing used to detect high-risk human papillomavirus infection and precancerous or cancerous changes of the cervix. The method and interval depend on age, prior results, vaccination, immune status, and local guidelines.
...
\medterm{Cervical Spine Involvement in Rheumatoid Arthritis} Rheumatoid inflammation affecting the upper cervical joints, especially the atlantoaxial joint. Instability or bone erosion can cause neck pain, occipital headache, nerve symptoms, or spinal-cord compression and may require imaging before procedures or surgery.
...
\medterm{Cervical Spondylotic Myelopathy} Progressive spinal cord compression resulting from age-related degenerative osteoarthritic changes in the cervical spine (intervertebral disc herniation, osteophytic spurring, ligamentum flavum hypertrophy), presenting with clumsy hands, spastic gait ataxia, hyperreflexia, and Hoffman sign.
...
\medterm{Cervical Squamous Intraepithelial Lesion} Alternate name; see \textit{Cervical dysplasia}.
...
\medterm{Cervical Strain (Whiplash)} Injury to the neck muscles, ligaments, and other soft tissues caused by rapid flexion and extension, commonly during a motor-vehicle collision. Neck pain, stiffness, headache, and shoulder or arm symptoms may occur.
...
\medterm{Cesarean Delivery} Alternate name; see \textit{Cesarean section}.
...
\medterm{Chaddock Reflex} An alternative neurological test for corticospinal tract upper motor neuron dysfunction, elicited by stroking the skin of the lateral foot around the lateral malleolus from posterior to anterior, producing an extensor plantar response (great toe dorsiflexion).
...
\medterm{Chanarin-Dorfman Disease} A rare inherited lipid-storage disorder, usually caused by changes in the \textit{ABHD5} gene, in which triglycerides accumulate in skin, liver, muscle, blood cells, and other tissues. It commonly causes congenital ichthyosis and may also cause liver disease, cataracts, hearing loss, muscle weakness, or developmental problems.

\synonyms
Chanarin-Dorfman Syndrome; Dorfman-Chanarin Disease; Neutral Lipid Storage Disease With Ichthyosis
...
\medterm{Chamberlain Procedure} An anterior mediastinotomy surgical technique involving an incision through the second or third left anterior intercostal space with resection of cartilage, designed to biopsy anterior mediastinal masses or aortopulmonary window lymph nodes that are inaccessible via cervical mediastinoscopy.
...
\medterm{Chancroid} A sexually transmitted infection caused by \textit{Haemophilus ducreyi}, producing one or more painful, ragged genital ulcers with a purulent base and tender, sometimes suppurative groin lymph nodes. Clinical diagnosis requires excluding syphilis and genital herpes; antibiotic treatment and partner evaluation are important.
...
\medterm{Charcot-Bouchard Aneurysm} A minute microaneurysm arising on small (100 to 300 micrometer) lenticulostriate penetrating arteries of the basal ganglia and thalamus in patients with chronic hypertension; its rupture is the classic cause of primary intracerebral hemorrhage.
...
\medterm{Charcot-Marie-Tooth Disease} A group of inherited peripheral-nerve disorders that damage nerves supplying the feet, legs, hands, and arms. Symptoms usually include gradually worsening weakness, muscle wasting, numbness, foot deformity, and difficulty walking. It is genetically heterogeneous and may follow autosomal dominant, autosomal recessive, or X-linked inheritance.
...
\medterm{Checkpoint Inhibitor} A class of monoclonal antibody immunotherapies that block negative inhibitory regulators of T-cell activation (such as PD-1, PD-L1, or CTLA-4), thereby relieving immune suppression and unleashing antitumor cytotoxic T-lymphocyte responses.
...
\medterm{Cheilitis Glandularis} A rare inflammatory disorder of minor salivary glands in the lips, usually the lower lip, causing enlarged gland openings, swelling, mucus or saliva discharge, and sometimes eversion of the lip. Persistent lesions need biopsy or specialist assessment because chronic inflammation can mimic or coexist with neoplasia.

\medterm{Cheilitis Granulomatosa} Persistent swelling of one or both lips caused by granulomatous inflammation. It may occur alone or as part of Melkersson--Rosenthal syndrome or Crohn disease; recurrent swelling, facial palsy, or a fissured tongue requires evaluation.
...
\medterm{Chemical Burns} Tissue injury caused by contact with corrosive acids, alkalis, oxidizers, or other chemicals. Damage may continue until the substance is removed and can involve the skin, eyes, airway, or gastrointestinal tract.
...
\medterm{Chemical Pleurodesis} A therapeutic procedure in which a sclerosing chemical agent (such as sterile talc slurry, doxycycline, or bleomycin) is instilled into the pleural space via a chest tube to induce intense parietal and visceral pleural inflammation, obliterating the pleural cavity to prevent recurrent pneumothorax or malignant pleural effusion.
...
\medterm{Chemoreceptor Reflex} An autonomic homeostatic reflex initiated by peripheral (carotid and aortic bodies) or central (medullary) chemoreceptors in response to hypoxia, hypercapnia, or acidosis, driving increases in minute ventilation, sympathetic vasomotor tone, and blood pressure.
...
\medterm{Chemotherapy-Induced Nausea and Vomiting} A common and debilitating adverse effect of antineoplastic therapy mediated by central neurokinin-1 (NK1) and peripheral/central serotonin (5-HT3) receptor pathways, categorized as acute, delayed, anticipatory, or breakthrough emesis.

\synonyms
CINV

\medterm{Chemotherapy-Induced Oral Mucositis} Painful inflammation and ulceration of the mouth caused by injury to rapidly dividing oral lining cells during chemotherapy or some cancer treatments. It can impair eating, drinking, and speech and increase infection risk; oral care, pain control, nutrition, and treatment of infection are important.
...
\medterm{Chewing Tobacco} Alternate name; see \textit{Smokeless tobacco}.
...
\medterm{Chickenpox} An acute, highly contagious primary infection with varicella-zoster virus. An itchy generalized rash appears in successive crops as spots, blisters, and crusts, often with fever and malaise; adults, pregnant people, newborns, and immunocompromised people have higher risk of pneumonia or other severe complications.
...
\medterm{Chief Cell} A cell in the stomach lining that makes pepsinogen, an inactive substance that becomes the protein-digesting enzyme pepsin in stomach acid.
...
\medterm{CHIK} Alternate name; see \textit{Chikungunya}.

\medterm{Chikungunya Fever} An acute arboviral febrile illness caused by the Chikungunya virus (genus \textit{Alphavirus}) transmitted by \textit{Aedes} mosquitoes, characterized by high fever, maculopapular rash, and severe, often incapacitating bilateral polyarthralgia and polyarthritis that may persist chronically.
...
\medterm{Chilaiditi Syndrome} The symptomatic clinical presentation of Chilaiditi sign, defined as the anatomical interposition of a loop of colon or small intestine between the superior surface of the liver and the right hemidiaphragm. Manifests with intermittent abdominal pain, constipation, nausea, vomiting, or abdominal distention, occasionally mimicking a perforated hollow viscus with pseudo-pneumoperitoneum on abdominal radiography.

\synonyms
Hepatodiaphragmatic Interposition Syndrome
...
\medterm{Child-Pugh Score} A widely used clinical staging system assessing the prognosis, surgical mortality, and necessity of liver transplantation in patients with cirrhosis, incorporating total bilirubin, serum albumin, prothrombin time/INR, ascites severity, and hepatic encephalopathy grade.
...
\medterm{Chlamydia (Chlamydial Genitourinary Infections)} Genitourinary infection caused by Chlamydia trachomatis, often without symptoms. Untreated infection can cause cervicitis, pelvic inflammatory disease, ectopic pregnancy, infertility, or neonatal infection; testing, treatment, and partner management are important.
...
\medterm{Chlamydial Pneumonias} Pneumonia caused by Chlamydia species, including C. pneumoniae and C. psittaci. Illness is often gradual with cough, fever, headache, and atypical chest findings; exposure history and targeted testing help distinguish it from other community-acquired pneumonias.
...
\medterm{Chloride Shift} An electrochemical exchange process in red blood cells mediated by the anion exchanger 1 (band 3 protein), wherein bicarbonate generated by carbonic anhydrase exits the erythrocyte in exchange for an incoming plasma chloride ion in systemic capillaries, reversed in pulmonary capillaries.
...
\medterm{Cholecystectomy} Surgery to remove the gallbladder, a small organ under the liver that stores bile. It may be needed for painful gallstones, gallbladder inflammation, gallstone-related pancreatitis, or selected polyps. It is often done through small cuts using a camera, but open surgery may be needed when this is not safe. Bile still flows from the liver into the intestine after surgery.
...
\medterm{Cholecystostomy} The creation of an opening into the gallbladder lumen for tube decompression and drainage of infected bile, frequently performed percutaneously under image guidance in critically ill patients with acute cholecystitis who are unfit for urgent cholecystectomy.
...
\medterm{Cholinergic Urticaria} A chronic inducible urticaria triggered by increased body temperature or sweating, such as during exercise, hot bathing, spicy food, or emotional stress. It causes numerous small, short-lived itchy wheals, sometimes with flushing or angioedema; rare breathing or circulatory symptoms require emergency care.
...
\medterm{Chondrodermatitis Nodularis Helicis} A painful inflammatory nodule affecting the skin and cartilage of the ear’s helix or antihelix, often related to repeated pressure, sleeping on one side, cold, sun, or local trauma. A firm tender crusted lesion can resemble skin cancer, so persistent or atypical lesions may need biopsy; pressure relief is an important treatment.
...
\medterm{Choroid Plexus} A network of tissue inside the brain’s ventricles that produces most of the cerebrospinal fluid.
...
\medterm{Chromhidrosis} A rare disorder in which coloured sweat, often yellow, green, blue, or black, appears because pigment is produced in apocrine glands. Similar discoloration can result when ordinary sweat becomes coloured by surface bacteria or chemicals, a process called pseudochromhidrosis; evaluation distinguishes these causes and looks for an underlying medicine or skin disorder.
...
\medterm{Chromoblastomycosis} A chronic implantation infection caused by pigmented fungi, usually after minor trauma introduces the organism into skin. It produces slowly enlarging warty, scaly, or tumorous plaques, most often on the legs; biopsy may show muriform bodies, and prolonged antifungal treatment is often required.
...
\medterm{Chromosomal Breakage Syndromes} A group of inherited DNA-repair disorders in which chromosomes are unusually fragile or break easily. They may cause congenital anomalies, growth or developmental problems, bone-marrow failure, immune abnormalities, and increased cancer risk.
...
\medterm{Chronic Ear Infection} A persistent, recurrent, or long-standing infection of the middle ear, often associated with a persistent eardrum perforation and painless or foul-smelling ear drainage.
...
\medterm{Chronic Fever} A fever that continues or repeatedly returns over a long period. Causes include infection, inflammatory disease, cancer, and medicines; persistent unexplained fever needs medical evaluation based on its pattern and accompanying symptoms.
...
\medterm{Chronic Hypertension} Persistently elevated systemic arterial blood pressure present over time, whether due to an identified underlying cause or without an identifiable secondary cause. It is distinct from hypertension arising only during pregnancy.
...
\medterm{Chronic Interstitial Nephritis} Long-term inflammation and scarring of the kidney tissue between the tubules. It may result from medicines, repeated infection, urinary obstruction, toxins, autoimmune disease, or inherited disorders and can gradually reduce kidney function.
...
\medterm{Chronic Kidney Disease-Mineral and Bone Disorder} A systemic disorder of mineral and bone metabolism resulting from chronic kidney disease, characterized by abnormalities of calcium, phosphorus, parathyroid hormone, or vitamin D metabolism; abnormalities in bone turnover, mineralization, linear growth, or strength (renal osteodystrophy); and extra-skeletal vascular or soft-tissue calcification.

\synonyms
CKD-MBD; Renal Mineral and Bone Disorder
...
\medterm{Chronic Low Back Pain} Persistent or recurring pain in the lumbar or lumbosacral region lasting longer than 12 weeks. Multifactorial etiologies include degenerative disc disease, lumbar spinal stenosis, spondylosis, facet arthropathy, and central pain sensitization.

\synonyms
Chronic Lumbago; Degenerative Lumbar Spine Disease; Long-Term Back Pain
...
\medterm{Chronic Megacolon} Persistent abnormal enlargement and impaired propulsion of the colon. Causes include severe constipation, aganglionosis, neurologic disease, metabolic disorders, medications, or chronic intestinal obstruction.

\medterm{Chronic Meningitis} Persistent inflammation of the membranes around the brain and spinal cord, usually lasting four weeks or longer. Causes include tuberculosis, fungal or other infections, cancer, autoimmune disease, and medication reactions; symptoms may develop gradually or fluctuate.
...
\medterm{Chronic Mitral Regurgitation} Long-standing leakage through the mitral valve during left-ventricular contraction. It may be primary, such as from prolapse, rheumatic disease, or endocarditis, or secondary to left-ventricular enlargement or ischemia; chronic volume overload can enlarge the left atrium and ventricle and lead to atrial fibrillation, pulmonary hypertension, or heart failure.
...
\medterm{Chronic Mucocutaneous Candidiasis} Persistent or recurrent \textit{Candida} infections of the skin, nails, and mucous membranes, often beginning in childhood. It may reflect a specific inherited T-cell or IL-17 pathway defect, or occur with autoimmune or endocrine disease; persistent disease requires evaluation for an underlying immune problem.
...
\medterm{Chronic Pelvic Pain in Women} Pain in the pelvis lasting or recurring for months and affecting daily life, sexual activity, urination, bowel function, or mood. Causes may include endometriosis, pelvic floor disorders, bladder or bowel disease, adhesions, neuropathic pain, or no single identifiable cause.
...
\medterm{Chronic Spontaneous Urticaria} The persistent occurrence of itchy, erythematous wheals (hives), angioedema, or both for six weeks or longer without an identifiable external physical or allergic trigger, frequently driven by autoimmune autoantibodies against IgE or its high-affinity receptor (Fc-epsilon-RI).

\synonyms
CSU; Chronic Idiopathic Urticaria

\medterm{Chronic Stiff Neck} Persistent reduced movement or tightness in the neck. Muscle strain, arthritis, disc disease, inflammation, or nerve problems may be responsible; fever, injury, weakness, numbness, or a severe headache requires prompt medical assessment.
...
\medterm{Churg-Strauss Disease} Former name; see \textit{Eosinophilic Granulomatosis With Polyangiitis}.
...
\medterm{Chylous Ascites} Accumulation of lymphatic fluid rich in triglycerides within the abdominal cavity. It can result from lymphatic obstruction, malignancy, trauma, surgery, infection, or congenital disease and may cause abdominal distention, malnutrition, or immune-cell loss.
...
\medterm{Cigarette Smoking} Alternate form; see \textit{Smoking}.
...
\medterm{Ciguatera Toxicity} Food poisoning from ciguatoxins in contaminated reef fish. It typically causes early nausea, vomiting, diarrhea, and abdominal pain followed by perioral or distal paresthesias, itching, weakness, and temperature reversal; bradycardia or hypotension can occur. Treatment is supportive because no reliably proven antidote exists.

\medterm{Ciguatera Toxin} Alternate name; see \textit{Ciguatera poisoning}.
...
\medterm{Ciliary Body Melanoma} A melanoma arising in the uveal tract behind the iris. It may be asymptomatic or cause blurred vision, floaters, pain, or a visible change in the pupil or iris; ophthalmic examination and imaging guide diagnosis and eye-preserving or surgical treatment.
...
\medterm{Circadian Rhythm Sleep Disorder} A family of sleep disturbances arising from a persistent misalignment between an individual's endogenous biological circadian rhythm and external societal light-dark cycles, including delayed sleep phase disorder, advanced sleep phase disorder, shift-work disorder, and jet lag.
...
\medterm{Circumduction} A compound, sequential circular joint movement combining flexion, abduction, extension, and adduction such that the distal end of an extremity moves in a circle while the proximal shaft delineates a cone, seen at ball-and-socket joints such as the shoulder and hip.
...
\medterm{Cisterna Chyli} A widened, sac-like part of the lymphatic system in the upper abdomen. It receives lymph from the lower body and intestines and continues upward as the thoracic duct.

\medterm{Cisterna Magna} The largest subarachnoid cistern, located in the posterior cranial fossa between the inferior surface of the cerebellum and the dorsal aspect of the medulla oblongata, which receives cerebrospinal fluid directly from the fourth ventricle via the median aperture (foramen of Magendie).
...
\medterm{Clagett Procedure} A staged surgical procedure for chronic pleural empyema with bronchopleural fistula, consisting of open thoracic fenestration (open window thoracostomy) to drain the pleural space, followed by sequential cavity debridement, antibiotic irrigation, and eventual secondary chest wall closure.

\synonyms
Open Window Thoracostomy Closure; Clagett Window

\medterm{Clammy Skin} Skin that feels cool, damp, or unusually sweaty. It may occur with heat, anxiety, pain, low blood sugar, shock, or other illness.
...
\medterm{Clathrin} A major polymeric coat protein composed of three heavy and three light chains forming a three-legged triskelion, which self-assembles into a polyhedral basket-like lattice that coats and internalizes endocytic vesicles during receptor-mediated endocytosis.
...
\medterm{Clear Cell Renal Cell Carcinoma Pathology} A renal carcinoma composed of clear cells containing lipid and glycogen, commonly arranged in nests or sheets separated by a delicate branching vasculature. Diagnosis and grading depend on architecture, cytology, necrosis, and invasion.
...
\medterm{Clinical Psychologist} A licensed mental-health professional who assesses and treats psychological, emotional, behavioral, and cognitive problems using psychotherapy and other evidence-based interventions within local scope of practice.
...
\medterm{Clivus} A central, sloped bony surface on the floor of the posterior cranial fossa formed by the fusion of the basilar part of the sphenoid bone and the basiocciput, extending anterior to the foramen magnum and providing a bed for the pons and basilar artery.
...
\medterm{Clonidine Toxicity} Alpha-2-adrenergic agonist poisoning causing somnolence, miosis, bradycardia, hypotension, respiratory depression, and sometimes transient hypertension early after ingestion. Management is supportive with airway and cardiovascular monitoring; naloxone may improve opioid-like central depression in selected cases.
...
\medterm{Closed Surgical Wound Care} Care of an incision whose edges are closed with sutures, staples, adhesive, or strips, including keeping it clean and dry as instructed and watching for infection or separation.
...
\medterm{Clostridium Difficile} Former taxonomic name; see \textit{Clostridioides Difficile}.
...
\medterm{Clubbing of the Nails} Rounding and widening of the fingertips or toes with increased nail curvature and loss of the normal nail-fold angle. It may be inherited or associated with lung, heart, gastrointestinal, liver, or other disease and warrants assessment when new or progressive.
...
\medterm{Coagulation Factor V Leiden} An autosomal dominant genetic variant (G1691A point mutation in the factor V gene) that confers resistance to proteolytic cleavage and inactivation by activated protein C (APC resistance), representing the most common inherited thrombophilia in Caucasian populations.
...
\medterm{Coal Workers' Pneumoconiosis (Black Lung Disease)} An occupational lung disease caused by long-term inhalation of coal mine dust. It can produce small nodules and progressive massive fibrosis, leading to cough, breathlessness, impaired lung function, pulmonary hypertension, or respiratory failure; exposure prevention is central.
...
\medterm{Cocaine-Associated Cardiomyopathy} Cardiac muscle dysfunction associated with cocaine exposure, which may involve ischemia, myocarditis, arrhythmia, hypertension, or direct myocardial toxicity. Presentation ranges from chest pain and reduced ejection fraction to heart failure or sudden death.
...
\medterm{Cocaine Substance Use} Use of cocaine, a stimulant that can cause dependence, agitation, seizures, heart attack, stroke, dangerous overheating, and severe psychiatric or cardiovascular complications.
...
\medterm{Coccidioidomycosis and Valley Fever} Infection caused by Coccidioides fungi, acquired by inhaling spores from disturbed soil in endemic regions. It may cause a self-limited respiratory illness, but dissemination to skin, bone, joints, or meninges can occur, especially in pregnancy or immunosuppression.
...
\medterm{Cochlear Duct} The coiled, endolymph-filled membranous tube of the inner ear, situated between the scala vestibuli and scala tympani, housing the organ of Corti along its basilar membrane for auditory sensory transduction.
...
\medterm{Coefficient of Inbreeding} The probability that the two copies of a gene at a locus in an individual are identical by descent from a common ancestor; it is used in population and medical genetics.
...
\medterm{Cognitive Symptoms} Changes in thinking abilities such as attention, memory, processing speed, language, judgment, planning, or problem solving. They may occur with neurologic disease, mental-health conditions, medicines, sleep problems, substance use, or other medical conditions.
...
\medterm{Cohort Study} An observational study that identifies groups based on an exposure or other characteristic and compares the incidence of disease or other outcomes between them over time. It may be prospective or retrospective and commonly estimates relative risk.
...
\medterm{Cold Ischemia Time} The duration during organ transplantation between the initiation of hypothermic organ preservation perfusion in the donor and the re-establishment of warm arterial blood reperfusion in the recipient, an important determinant of primary graft function.
...
\medterm{Cold Panniculitis} Inflammation of subcutaneous fat after exposure to cold, producing firm, red or violaceous, sometimes tender plaques or nodules. It is most often seen on the cheeks of infants or on exposed areas and usually improves with warming and avoidance of further cold.
...
\medterm{Collapsing Glomerulopathy} An aggressive and histologically distinctive variant of focal segmental glomerulosclerosis (FSGS) characterized by global or segmental collapse of the glomerular capillary tuft accompanied by marked hypertrophy and hyperplasia of overlying visceral epithelial cells (podocytes). Associated with human immunodeficiency virus infection (HIV-associated nephropathy), high-risk \textit{APOL1} genotypes, interferon therapy, and severe parvovirus B19 infection.

\synonyms
Collapsing FSGS; Collapsing Focal Segmental Glomerulosclerosis
...
\medterm{Colonic Mucosa} The inner lining of the colon. It absorbs water and salts, makes mucus, and contains cells that help protect the colon.

\medterm{Colonic Polyps} Alternate name; see \textit{Colon polyps}.

\medterm{Colonic Pseudo-Obstruction} Massive clinical and radiological dilation of the colon, predominantly involving the cecum and right colon, in the complete absence of a mechanical or physical obstructing lesion; associated with severe non-operative medical illnesses or recent surgery.
...
\medterm{Colostomy} Surgery that brings part of the large intestine through an opening in the abdomen, called a stoma. Stool and gas leave through the stoma into a pouch. A colostomy may be temporary or permanent and may be needed for cancer, bowel blockage, severe infection, injury, or other bowel disease. Stoma nurses can teach people how to care for it and return to usual activities.
...
\medterm{Combined Oral Contraceptive Pill} Oral contraceptive formulations containing both an estrogen (typically ethinylestradiol) and a progestin that prevent pregnancy primarily through feedback inhibition of gonadotropins to suppress ovulation, accompanied by thickening of cervical mucus and endometrial thinning.

\synonyms
Combined Oral Contraceptives; COCP; Combination Birth Control Pills; The Pill
...
\medterm{Comedonal Acne} A form of acne in which open comedones (blackheads) and closed comedones (whiteheads) predominate, with little inflammatory redness or swelling. It results from blockage of hair follicles by sebum and keratin.
...
\medterm{Common Fibular Nerve} A major nerve that passes around the outer side of the knee into the lower leg and foot. It helps lift and turn the foot and carries feeling from much of the lower leg and top of the foot.
...
\medterm{Common Variable Immunodeficiency} A primary antibody-deficiency disorder characterized by low immunoglobulin G with low immunoglobulin A and/or M and impaired responses to vaccines. It causes recurrent sinus, ear, and lung infections and may also cause chronic gastrointestinal disease, autoimmunity, enlarged lymph nodes, granulomas, or increased lymphoma risk.
...
\medterm{Community Mental-Health Treatment} Mental-health assessment, treatment, rehabilitation, and support delivered outside a hospital, such as in clinics, homes, schools, or community programs. It may include medication management, psychotherapy, crisis support, peer support, and help with housing, work, or daily functioning.
...
\medterm{Compartment Syndrome Cross-Reference} Alternate name; see \textit{Compartment syndrome}.
...
\medterm{Complement Component Deficiency} A genetically determined deficiency in one of the proteins of the complement cascade, predisposing to recurrent pyogenic infections (early classical components), severe autoimmune immune-complex disorders (C1q, C2, C4), or disseminated \textit{Neisseria} infections (terminal membrane attack complex C5-C9).
...
\medterm{Compound Muscle Action Potential} The summated electrical voltage recorded over a muscle belly during a motor nerve conduction study, reflecting the near-simultaneous depolarization of all innervated muscle fibers following supramaximal electrical stimulation of its motor nerve.
...
\medterm{Compound Presentations} A fetal presentation in which an extremity, usually a hand or arm, lies beside the presenting head or breech. It may resolve spontaneously, but persistent obstruction, cord prolapse, or fetal distress can require urgent obstetric intervention.
...
\medterm{Computed Tomography Urography} A CT scan of the kidneys, ureters, and bladder, usually using contrast material to show the urinary tract. It can show stones, blockage, bleeding, tumors, or structural changes.
...
\medterm{Concentric Muscle Action} Muscle action in which a muscle produces force while becoming shorter, such as when lifting an object.
...
\medterm{Conduction Aphasia} A fluent aphasic syndrome resulting from a lesion disrupting the arcuate fasciculus connecting Broca area and Wernicke area, characterized by intact auditory comprehension and fluent spontaneous speech, but profound impairment in verbal repetition and prominent phonemic paraphasias.
...
\medterm{Condyloid Joint} A joint in which an oval surface of one bone fits into an oval depression in another bone. It allows bending, straightening, and side-to-side movement, but little rotation.
...
\medterm{Confluent and Reticulated Papillomatosis} An uncommon skin disorder causing asymptomatic or mildly itchy brown, papillomatous papules and plaques that merge centrally and form a net-like pattern, usually on the upper trunk, neck, or axillae. Diagnosis is clinical after excluding fungal infection and other causes of hyperpigmentation; treatment may include specialist-prescribed antibiotics.
...
\medterm{Congenital Adrenal Hyperplasia} A group of usually autosomal recessive disorders in which the adrenal glands cannot make hormones normally. The most common form can cause salt loss, excess androgen effects, early puberty, or genital differences and may be life-threatening in newborns.
...
\medterm{Congenital Hypertrichosis Lanuginosa} A very rare form of congenital hypertrichosis in which fine, soft lanugo-like hair covers much of the body from birth or early infancy. It may occur alone or as part of a genetic syndrome; examination looks for associated dental, skeletal, neurologic, or developmental findings.
...
\medterm{Congenital Myopathies} A group of inherited muscle disorders whose weakness or low muscle tone is present at birth or begins in infancy or childhood. They differ in their genetic cause and biopsy features and may affect movement, breathing, swallowing, the spine, or the heart.
...
\medterm{Congenital Nevi} Multiple melanocytic nevi present at birth or appearing soon afterward. Most are benign, but melanoma risk rises with larger or numerous lesions, so changes in colour, size, surface, or symptoms should prompt specialist review.


\medterm{Congenital Nevus} A dark or raised mole present at birth or soon after. Most are harmless, but larger or unusual moles have a higher risk of melanoma and should be checked from time to time. Imaging or removal is considered only for selected high-risk moles.
...
\medterm{Congenital Tracheomalacia} Congenital tracheomalacia is weakness of the infant tracheal cartilage causing dynamic airway collapse, noisy breathing, cough, or recurrent respiratory symptoms.
...
\medterm{Congestive Hepatopathy} Liver injury caused by chronically elevated venous pressure, usually from right-sided heart failure or constrictive pericardial disease. It may cause liver enlargement, abnormal liver tests, ascites, and eventually cardiac cirrhosis.
...
\medterm{Conjugated Hyperbilirubinemia} An elevation of direct, water-soluble bilirubin in the blood, usually caused by impaired bile formation or excretion, bile-duct obstruction, or hepatocellular injury. Jaundice, dark urine, pale stools, or itching may occur.
...
\medterm{Conjunctival Melanoma} A rare malignant melanoma of the conjunctiva, often appearing as a pigmented or occasionally amelanotic lesion on the eye surface. It can recur locally or spread to lymph nodes and distant organs, so ophthalmic examination, biopsy, and surveillance are important.
...
\medterm{CTD-Associated Interstitial Lung Disease} Interstitial lung disease occurring with autoimmune connective-tissue disease such as systemic sclerosis, rheumatoid arthritis, myositis, or Sjögren disease. Symptoms, lung function, high-resolution CT, antibodies, and disease activity guide monitoring and immunomodulatory or antifibrotic treatment.

\medterm{Connexin 26 Deficiency} An inherited change in the \textit{GJB2} gene that can cause hearing loss present from birth. The severity and whether one or both ears are affected can vary.

\synonyms
GJB2-Related Deafness; DFNB1 Hearing Loss
...
\medterm{Constitutional Growth Delay} A normal variant in which height growth and bone maturation are temporarily behind average, often with a family history of late puberty. Most affected children continue growing and enter puberty later than peers but reach a typical adult height.

\synonyms
Constitutional Delay of Growth and Puberty; CGD
...
\medterm{Constrictive Pericarditis} A chronic condition in which a thickened or scarred, noncompliant sac around the heart restricts diastolic filling. It can cause breathlessness, fatigue, leg or abdominal swelling, enlarged neck veins, and liver congestion; causes include infection, surgery, radiation, or unknown disease.
...
\medterm{Contact Urticaria} Hives, itching, or swelling that develop within minutes to about an hour after a substance touches the skin or mucosa. It may be immunoglobulin-E-mediated, such as with latex or foods, or caused by direct irritation; widespread symptoms, wheezing, throat swelling, or faintness suggest anaphylaxis.
...
\medterm{Contraceptive Implant} A small medicine-releasing device placed under the skin, usually in the upper arm, to prevent pregnancy for an extended period. It releases a progestogen and can cause irregular bleeding or other hormone-related effects.
...
\medterm{Contrast-Enhanced Computed Tomography} A CT scan performed after contrast material makes selected organs, blood vessels, or abnormal areas easier to see.

\medterm{Contrast-Enhanced Magnetic Resonance Imaging} An MRI scan performed after contrast material makes selected tissues, blood vessels, or abnormal areas easier to see.
...
\medterm{Controlled-Substance Schedule I} A United States controlled-substance category for drugs with high misuse potential and no accepted medical use
under federal law.

\medterm{Controlled-Substance Schedule II} A United States legal category for medicines with accepted medical uses but high misuse, dependence, or overdose potential. Prescribing, dispensing, refills, and storage are subject to strict rules.

\medterm{Controlled-Substance Schedule III} A United States legal category for medicines with accepted medical uses and less misuse potential than Schedule II substances, although dependence and misuse remain possible. Rules vary by medicine and jurisdiction.

\medterm{Controlled-Substance Schedule IV} A United States controlled-substance category for drugs with accepted medical uses and lower misuse potential
than Schedule III drugs.

\medterm{Controlled-Substance Schedule V} A United States controlled-substance category for drugs with the lowest level of misuse potential among the
federal schedules.
...
\medterm{Corneal Endothelium} The innermost layer of cells in the cornea. It moves extra fluid out of the cornea and helps keep it clear.

\medterm{Corneal Epithelium} The thin outer layer of the cornea that protects the eye and helps keep its surface smooth.
...
\medterm{Corneal Laceration} A cut through part or all of the cornea, usually caused by sharp trauma or a foreign object. It can cause pain, tearing, light sensitivity, reduced vision, and leakage of aqueous humor.
...
\medterm{Corneal Stroma} The thick middle layer of the cornea. It gives the cornea much of its strength and helps keep it clear.
...
\medterm{Cornual Pregnancy} An ectopic pregnancy that implants in the part of the fallopian tube passing through the muscular wall of the uterus. It may grow silently before rupturing and causing life-threatening internal bleeding.

\synonyms
Cornual Pregnancy; Interstitial Ectopic Pregnancy
...
\medterm{Coronary Angioplasty} A procedure that opens a narrowed or blocked artery supplying the heart. A thin tube with a small balloon is guided to the blockage. The balloon is inflated to widen the artery, and a small mesh tube called a stent is often left in place to help keep it open.
...
\medterm{Coronary Artery Calcium Score} A non-invasive computed tomography measurement of calcified atheromatous plaque within the epicardial coronary arteries, quantified using the Agatston scoring method. It serves as an independent predictor of future major adverse cardiovascular events and aids in cardiovascular risk stratification for borderline- or intermediate-risk asymptomatic adults.
...
\medterm{Coronary Perfusion Pressure} The physiological net pressure gradient driving myocardial blood flow through coronary capillary beds, calculated as the difference between aortic diastolic pressure and left ventricular end-diastolic pressure.

\synonyms
CPP

\medterm{Coronary Revascularization} Restoration of blood flow through the coronary arteries, usually by percutaneous coronary intervention (angioplasty with or without stenting) or coronary artery bypass grafting. It is used to treat selected obstructive coronary artery disease and acute coronary syndromes.
...
\medterm{Coronary Steal Syndrome} A hemodynamic phenomenon in which pharmacologically induced vasodilation (such as with dipyridamole or adenosine) diverts blood flow away from an already maximally dilated, stenotic coronary vascular bed toward well-perfused non-stenotic vessels, worsening regional myocardial ischemia.
...
\medterm{Corpus Albicans} A dense, white fibrous scar tissue mass within the ovary formed by the regression and involution of an unfertilized corpus luteum, consisting of hyalinized collagen and degenerated luteal cells.
...
\medterm{Corticospinal Tract} The primary descending somatic motor pathway originating from pyramidal neurons in layer V of the cerebral motor cortex, descending through the internal capsule, brainstem, and medullary pyramids (where 85 to 90 percent decussate) to synapse on spinal lower motor neurons for voluntary fine motor control.
...
\medterm{Costal Cartilage} Flexible cartilage that connects the front ends of the ribs to the sternum or to the cartilage of the rib above. It gives the chest wall flexibility during breathing.

\medterm{Costal Groove} A shallow groove along the lower inner border of a rib that contains an intercostal nerve and blood vessels.

\medterm{Costal Margin} The lower curved edge of the rib cage, formed mainly by the cartilage of the lower ribs.
...
\medterm{Costochondritis} Inflammation of the cartilage where one or more ribs join the breastbone (sternum), causing localized chest-wall pain and tenderness that may worsen with movement, deep breathing, coughing, or pressing the area. Because similar pain can result from heart or lung emergencies, new or severe chest pain needs prompt assessment.
...
\medterm{Costotransverse Joint} A joint where the tubercle of a rib meets the transverse process of a thoracic vertebra. It helps guide rib movement during breathing.
...
\medterm{Costovertebral Joint} A joint where a rib meets a vertebra in the spine. It helps the ribs move during breathing.

\medterm{Cotard Syndrome} A rare syndrome involving a fixed belief that one is dead, missing body parts, or no longer exists, sometimes accompanied by severe depression, psychosis, or other psychiatric or neurologic illness. It is a descriptive syndrome rather than a standalone diagnosis.
...
\medterm{Cough Syncope} A brief faint caused by coughing, which raises chest pressure, reduces venous return and cardiac output, and transiently lowers cerebral blood flow.
...
\medterm{COVID-19-Associated Anosmia and Ageusia} COVID-19 can temporarily impair smell and taste through infection or inflammation of nasal and olfactory pathways. Most people improve, but persistent loss, distortion, poor nutrition, or neurologic symptoms warrants follow-up and smell-retraining advice.
...
\medterm{Cowden Disease (Multiple Hamartoma Syndrome)} Alternate names; see \textit{Cowden Syndrome}.

\medterm{Cowden Syndrome} An inherited PTEN-hamartoma tumour syndrome, usually caused by a pathogenic \textit{PTEN} variant. It may cause multiple hamartomas, characteristic mucocutaneous lesions, and increased risks of breast, thyroid, endometrial, kidney, and colorectal cancers; lifelong organ-specific surveillance is important.
...
\medterm{Craniofacial Disorder} A broad category of congenital anomalies, genetic syndromes, or acquired conditions that affect the structural development, growth, and morphology of the skull, facial bones, jaws, and associated soft tissues. Major congenital forms arise from abnormal cranial neural crest cell migration or pharyngeal arch morphogenesis and include craniosynostosis (premature cranial suture fusion, as in Crouzon, Apert, and Pfeiffer syndromes), orofacial clefts (cleft lip and palate), branchial arch malformations (Treacher Collins syndrome, craniofacial microsomia, Goldenhar syndrome), and sequence disorders (Pierre Robin sequence). Clinical consequences frequently involve upper airway obstruction, feeding difficulty, elevated intracranial pressure, vision and hearing impairment, dental malocclusion, and speech articulation defects. Optimal management requires coordinated multidisciplinary care combining specialized reconstructive surgery, neurosurgery, orthodontics, audiology, and speech-language therapy.

\synonyms
Craniofacial Anomaly; Craniofacial Malformation; Craniofacial Condition
...
\medterm{Cranioplasty} Surgery to repair a missing or damaged part of the skull, often after a head injury or earlier brain surgery. A stored piece of bone or an artificial material may be used. It protects the brain and may improve skull shape or symptoms, but results and risks vary.
\synonyms
...
\medterm{Craniotomy} An operation in which a surgeon temporarily removes a piece of the skull to reach the brain or its coverings. It may be used to remove a tumor, stop bleeding, repair an aneurysm, or treat another brain problem. The bone is usually put back and secured at the end of the operation.
\synonyms
...
\medterm{CREST Syndrome} A limited cutaneous form of systemic sclerosis named for Calcinosis, Raynaud phenomenon, Esophageal dysfunction, Sclerodactyly, and Telangiectasia. It may also affect the lungs, heart, kidneys, or digestive tract; monitoring for pulmonary hypertension and other organ involvement is important.
...
\medterm{Cribriform Plate} The horizontal, sieve-like bony lamina of the ethmoid bone situated in the floor of the anterior cranial fossa, perforated by numerous small foramina transmitting the olfactory nerve (CN I) fascicles from the nasal olfactory mucosa into the anterior cranial cavity.
...
\medterm{Cricothyroid Membrane} A tough fibroelastic ligament located in the anterior neck between the inferior border of the thyroid cartilage and the superior border of the cricoid cartilage; the target anatomical landmark for emergency airway cricothyroidotomy.

\synonyms
Cricothyroid Ligament; Conus Elasticus

\medterm{Cricothyroidotomy} An emergency surgical airway procedure in which an incisional opening is made through the skin and cricothyroid membrane to introduce an endotracheal or tracheostomy tube, indicated in catastrophic "cannot intubate, cannot ventilate" scenarios.

\synonyms
Cricothyroidectomy; Emergency Surgical Airway
...
\medterm{Crista Galli} A vertical, crest-like bony projection of the ethmoid bone rising upward from the cribriform plate into the anterior cranial fossa, serving as the anterior intracranial attachment site for the falx cerebri.
...
\medterm{Crohn Disease Pathology} Patchy, chronic, often transmural intestinal inflammation with architectural distortion, fissures, creeping fat, and possible noncaseating granulomas. The disease may involve any part of the gastrointestinal tract and commonly produces skip lesions.

\medterm{Crohn Ileitis} Crohn disease involving the ileum, the final part of the small intestine, causing chronic or relapsing inflammation that may produce abdominal pain, diarrhea, weight loss, strictures, or fistulas.

\medterm{Crohn Ileocolitis} Crohn disease affecting both the ileum and colon, causing patchy chronic inflammation that may lead to abdominal pain, diarrhea, weight loss, strictures, fistulas, or perianal disease.
...
\medterm{Crouzon Syndrome} A craniosynostosis syndrome, usually caused by a pathogenic \textit{FGFR2} variant, in which skull sutures fuse too early. It changes the shape of the skull and face and may cause shallow eye sockets, vision problems, airway obstruction, dental abnormalities, hearing loss, or raised pressure around the brain.

\medterm{Crowe Sign} Small freckles in the armpits or groin. They are one finding that can support neurofibromatosis type 1, but they are not enough to make the diagnosis alone.
\synonyms
...
\medterm{Cryptococcal Infection} Alternate name; see \textit{Cryptococcosis}.
...
\medterm{Cutaneous and Oral Melanocytic Nevi} Usually benign moles composed of melanocytes in the skin or oral mucosa. Most remain stable, but a lesion that changes in size, colour, border, surface, or symptoms should be examined for atypia or melanoma.
...
\medterm{Cutaneous B-Cell Lymphoma} A group of non-Hodgkin lymphomas in which clonal B lymphocytes primarily involve the skin. Primary cutaneous follicle-centre and marginal-zone lymphomas often behave indolently, whereas diffuse large B-cell lymphoma, leg type, is more aggressive; biopsy, staging, and immunophenotyping guide treatment.
...
\medterm{Cutaneous Candidiasis} A Candida yeast infection of the skin, often affecting warm, moist folds such as the groin, armpits, or under the breasts. It causes red, itchy, moist plaques with small satellite spots; diabetes, antibiotics, occlusion, and immune suppression increase risk.
...
\medterm{Cutaneous Horn} A cone-shaped, hard projection of compacted keratin arising from the skin. The underlying lesion may be benign, precancerous, or cancerous, especially when the base is broad, indurated, painful, or inflamed, so removal or biopsy is usually needed.
...
\medterm{Cutaneous Leiomyoma} A usually benign smooth-muscle tumour of the skin, often presenting as firm, painful papules or nodules that may be triggered by cold or pressure. Multiple lesions can be associated with hereditary leiomyomatosis and renal-cell cancer, so extensive or familial disease needs genetic and renal-risk assessment.
...
\medterm{Cutaneous Lipomas} Multiple benign tumors of mature fat cells arising in or beneath the skin, usually soft, mobile, and painless. A rapidly growing, painful, fixed, or deep mass needs imaging or biopsy because not every fatty-appearing lump is a simple lipoma.
...
\medterm{Cutaneous Manifestations of HIV} Skin findings associated with HIV infection may reflect acute HIV, opportunistic infections, inflammatory disease, medicine reactions, or cancers such as Kaposi sarcoma. Conditions including herpes zoster, molluscum contagiosum, candidiasis, and extensive or recurrent eruptions may become more severe as immune function declines; effective antiretroviral therapy often improves HIV-related skin disease.

\medterm{Cutaneous Melanoma} A malignant tumor of melanocytes, the pigment-producing cells of skin. It may arise in a new lesion or a changing mole and can spread if not treated; the ABCDE changes, an evolving lesion, bleeding, or a nonhealing pigmented spot requires prompt dermatologic assessment and biopsy.
...
\medterm{Cutaneous Pseudolymphoma} A benign reactive lymphoid proliferation in the skin that can resemble cutaneous lymphoma clinically or under the microscope. It may follow an insect bite, tattoo, medicine, infection, or other stimulus; biopsy and sometimes additional studies are needed to distinguish it from true lymphoma.
...
\medterm{Cutaneous Squamous Cell Carcinoma} A malignant tumor of keratinocytes, often arising on chronically sun-damaged skin. It may appear as a rough, scaly, crusted, tender, or ulcerated growth and can invade locally or metastasize, particularly when high-risk features are present.
...
\medterm{Cutis Verticis Gyrata} A rare condition in which thickened scalp skin forms deep folds and furrows resembling the surface of the brain. It may be primary or associated with neurologic, endocrine, inflammatory, or genetic conditions; persistent scalp changes warrant assessment.
...
\medterm{Cyanide Toxicity} Cellular asphyxiation caused by inhibition of mitochondrial oxidative phosphorylation. Rapid agitation or confusion, seizures, cardiovascular collapse, severe lactic acidosis, and coma may develop after smoke inhalation or ingestion; treatment must not await confirmatory testing when suspicion is high, and hydroxocobalamin is the preferred antidote in many settings.
...
\medterm{CyberKnife Radiosurgery} CyberKnife is a robotic system that delivers many precisely aimed radiation beams to a tumor or other target without an open operation.
...
\medterm{Cyclic Vomiting Syndrome Cross-Reference} Alternate name; see \textit{Cyclic vomiting syndrome}.
...
\medterm{Cyclist's Syndrome} Pain, numbness, tingling, or altered sensation in the perineum caused by prolonged pressure on the pudendal nerve during cycling. It is a form of pudendal nerve irritation or entrapment and may improve with changes in saddle fit, riding position, activity, and specialist treatment.

\synonyms
Cyclist Syndrome; Pudendal Neuralgia Associated With Cycling
...
\medterm{Cyprus Fever} An older regional name for brucellosis, a bacterial infection acquired from infected animals or unpasteurised animal products. It may cause prolonged or recurring fever, sweats, fatigue, joint pain, and involvement of other organs.
...
\medterm{Cylindroma and Spiradenoma} Usually benign skin appendage tumors arising from sweat-gland-related structures. Cylindromas are often firm scalp or facial nodules, while spiradenomas are characteristically painful; multiple lesions may occur in Brooke-Spiegler syndrome and a rapidly enlarging or ulcerated lesion needs review.
...
\medterm{CYP2C9 Polymorphism} An inherited variation in the CYP2C9 drug-metabolizing enzyme that can make some medicines, especially warfarin, break down more slowly or quickly. Genotype may help inform dosing in selected settings, alongside clinical factors and monitoring.
...
\medterm{Cystic Diseases of the Kidney} Disorders in which fluid-filled cysts develop in one or both kidneys. They may be inherited or acquired and can cause enlargement, pain, infection, bleeding, stones, high blood pressure, or progressive loss of kidney function.
...
\medterm{Cystic Fibrosis} An autosomal recessive disorder caused by disease-causing changes in both copies of the \textit{CFTR} gene. The abnormal CFTR protein disrupts the movement of salt and water across cell surfaces, making mucus thick and sticky. This mucus can block the airways and cause repeated lung infections, inflammation, and permanent lung damage. It can also block pancreatic ducts, preventing digestive enzymes from reaching the intestine and causing poor digestion, poor absorption of nutrients, or poor growth. Cystic fibrosis may also affect the liver, intestines, sweat glands, and reproductive system. People with cystic fibrosis usually have unusually salty sweat.

\synonyms
CF

\medterm{Cystic Hygroma} A congenital or early-childhood lymphatic malformation consisting of thin-walled, fluid-filled spaces, usually in the neck or upper chest. It may be detected before birth and can cause swelling, difficulty breathing, or feeding problems when large.

\synonyms
Cystic Lymphangioma; Lymphatic Malformation

\medterm{Cystic Lung Disease} A group of disorders in which multiple air- or fluid-filled cysts develop in the lungs. Causes include lymphangioleiomyomatosis, pulmonary Langerhans-cell histiocytosis, Birt-Hogg-Dubé syndrome, lymphoid interstitial pneumonia, congenital abnormalities, infection, and smoking-related disease; high-resolution CT helps classify the pattern.

\synonyms
Multiple Cystic Lung Disease; Pulmonary Cystic Disease
...
\medterm{Cysts, Ovarian, Functional} Ovarian cysts related to the normal menstrual cycle, usually a follicular cyst or corpus-luteum cyst. They commonly resolve without treatment but may cause pain, bleeding, rupture, or ovarian torsion.

\synonyms
Functional Ovarian Cysts; Physiologic Ovarian Cysts
...
\medterm{Cystic Teratoma} A germ-cell tumor containing tissues derived from more than one embryonic layer, commonly occurring in the ovary as a mature cystic teratoma or dermoid cyst. Most are benign, but torsion, rupture, infection, or rare malignant transformation can occur.
...
\medterm{Cystitis Pathology} Inflammatory injury of the urinary bladder mucosa and wall. Acute cases may show edema, congestion, and neutrophils, while chronic or specialized forms show lymphocytes, fibrosis, ulceration, or characteristic epithelial changes.
...
\medterm{Cysts} Closed sacs or tissue cavities containing fluid, air, pus, blood, cells, or semisolid material. They can occur in the skin, organs, glands, or other tissues; many are harmless, but some result from infection, developmental or inherited disease, or a tumor. A new, growing, painful, changing, or infected cyst-like lump should be medically assessed.
...
\medterm{C1-INH} Abbreviation for C1 esterase inhibitor, a complement-regulating protein. Inherited or acquired deficiency or dysfunction can cause recurrent episodes of bradykinin-mediated angioedema affecting the skin, abdomen, or airway.

\medterm{CAD (Coronary Artery Disease)} Abbreviation for coronary artery disease, narrowing or blockage of the heart’s arteries by atherosclerotic plaque. It can cause angina, heart attack, heart failure, arrhythmia, or sudden death.

\medterm{Calcium for Osteoporosis} Calcium intake is part of osteoporosis prevention and treatment, together with vitamin D, resistance exercise, fall prevention, and medicines when indicated. Excess supplementation can cause kidney stones, constipation, or other harm.

\medterm{Calluses and Corns} Localized areas of thickened skin caused by repeated pressure or friction. Calluses are broader; corns are more focal and often painful. Diabetes, poor circulation, or infection requires professional foot care rather than self-cutting.

\medterm{Cancer of the Tongue} Malignant tumor arising in the tongue, most often squamous cell carcinoma. A persistent sore, lump, bleeding area, numbness, difficulty swallowing, or unexplained tongue pain needs prompt examination.

\medterm{Canefield Fever} An older name for leptospirosis, a bacterial infection acquired through water or soil contaminated with urine from infected animals. It can cause fever, headache, muscle pain, jaundice, kidney injury, meningitis, or bleeding.

\medterm{CF (Cystic Fibrosis)} Abbreviation for cystic fibrosis, an inherited disorder caused by CFTR variants that produce thick secretions, chronic lung infection, pancreatic insufficiency, infertility in many males, and other organ complications.

\medterm{CFS (Chronic Fatigue Syndrome)} Abbreviation for myalgic encephalomyelitis/chronic fatigue syndrome, a complex illness involving substantial reduction in activity, post-exertional malaise, unrefreshing sleep, and often cognitive impairment or orthostatic intolerance.

\medterm{CGD -- Growth Delay, Constitutional} Abbreviation for constitutional growth delay, a normal-variant pattern in which a child grows more slowly and enters puberty later than peers but generally continues to grow and reaches an expected adult height consistent with family potential.

\medterm{CHH} Abbreviation for congenital or central hypogonadotropic hypogonadism, in which deficient hypothalamic or pituitary signaling leads to low sex-hormone production and absent or incomplete puberty. Some forms also cause reduced or absent sense of smell.

\medterm{Chickenpox (Varicella)} A contagious infection caused by varicella-zoster virus, producing an itchy blistering rash, fever, and malaise. Complications include bacterial skin infection, pneumonia, cerebellitis, and severe disease in pregnancy or immunocompromise.

\medterm{CHILD Naevus} A congenital skin and limb disorder named for congenital hemidysplasia with ichthyosiform erythroderma and limb defects. It causes one-sided scaly skin changes with asymmetrical limb or skeletal abnormalities and may involve other organs.

\medterm{Childhood ADHD} Attention-deficit/hyperactivity disorder beginning in childhood, with persistent developmentally inappropriate inattention, hyperactivity, or impulsivity that causes impairment across one or more settings.

\medterm{Childhood Cyclic Vomiting} Recurrent stereotyped episodes of intense nausea and vomiting separated by periods of normal health. It is a functional gut-brain disorder diagnosed after other causes are considered and may be associated with migraine.

\medterm{Childhood Depression} Depressive illness in a child, which may present as persistent sadness, irritability, loss of interest, withdrawal, sleep or appetite change, low energy, poor concentration, or physical complaints. Suicidal thoughts require immediate emergency help.

\medterm{Childhood Giant Axonal Neuropathy} The childhood-onset form of giant axonal neuropathy, a rare inherited neurodegenerative disorder causing progressive peripheral neuropathy, ataxia, weakness, developmental or cognitive changes, and characteristic tightly curled hair in many affected people.

\medterm{Childhood Muscular Dystrophy} A group of inherited disorders causing progressive muscle weakness and wasting beginning in childhood. Different types vary in inheritance, muscles affected, heart and breathing involvement, and rate of progression.

\medterm{Classic Galactosemia} A serious inherited disorder caused by severe deficiency of galactose-1-phosphate uridyltransferase. Milk feeding can rapidly cause jaundice, liver dysfunction, hypoglycemia, infection, and neurologic injury; lifelong galactose restriction is required.

\medterm{Classic Type Pfeiffer Syndrome} A genetic craniosynostosis syndrome, usually related to an \textit{FGFR2} variant, causing early fusion of skull sutures, broad or deviated thumbs and great toes, and variable facial, airway, neurologic, or developmental problems.

\medterm{CMTC} Abbreviation for cutis marmorata telangiectatica congenita, a congenital vascular skin anomaly causing persistent reticulated red or purple mottling. It may be isolated or associated with limb asymmetry, ulcers, or other vascular abnormalities.

\medterm{Cochlear Implants} Surgically implanted devices that convert sound into electrical signals delivered to the auditory nerve. They can provide hearing access for selected people with severe or profound sensorineural hearing loss when hearing aids are insufficient.

\medterm{Cold Sores} Recurrent fluid-filled sores, usually on or around the lips, caused by herpes simplex virus, most often HSV-1. They are contagious from tingling or blister formation until healing and can be severe in immunocompromised people or newborns.

\medterm{Coronavirus (COVID-19), Complications} Complications of SARS-CoV-2 infection can include pneumonia, hypoxemic respiratory failure, blood clots, myocarditis, acute kidney injury, neurologic disease, multisystem inflammatory syndrome, and persistent post-COVID symptoms.

\medterm{Coronavirus (COVID-19) and Asthma} COVID-19 in a person with asthma may worsen breathing symptoms or trigger an exacerbation, although risk varies with asthma control and severity. Usual prescribed controller treatment should not be stopped without medical advice.

\medterm{Coronavirus (COVID-19) and High Blood Pressure} COVID-19 in a person with hypertension may carry higher risk when other cardiovascular or age-related risk factors are present. Prescribed blood-pressure medicines should generally be continued unless the treating clinician advises otherwise.

\medterm{Coronavirus (COVID-19) and Pregnancy} SARS-CoV-2 infection during pregnancy can increase the risk of severe maternal illness, hospitalization, preterm birth, and other complications. Vaccination, prompt assessment, and individualized treatment are important.

\medterm{Coronavirus (COVID-19) in Children, Infants} COVID-19 in children and infants is often mild but can cause pneumonia, dehydration, croup-like illness, or multisystem inflammatory syndrome in children. Breathing difficulty, poor feeding, unusual sleepiness, or dehydration requires urgent assessment.

\medterm{Coronavirus (COVID-19), Recovery} Recovery after COVID-19 varies from days to months. Persistent fatigue, breathlessness, cognitive symptoms, loss of smell or taste, and post-exertional worsening may represent post-COVID condition and warrant appropriate evaluation.

\medterm{Coronavirus (COVID-19), Symptoms} Symptoms of COVID-19 may include fever, cough, sore throat, congestion, fatigue, headache, muscle aches, nausea, diarrhea, and loss or change of smell or taste. Severe breathing difficulty, chest pain, confusion, or bluish skin is an emergency.

\medterm{Coronavirus (COVID-19), Testing at Home} At-home testing for COVID-19 commonly uses a rapid antigen test from a nasal sample. A negative result does not always exclude early infection; repeat testing or a molecular test may be needed when suspicion remains high.

\medterm{Coronavirus (COVID-19), Testing} Testing for SARS-CoV-2 uses antigen or nucleic-acid methods on respiratory samples. Test timing, symptoms, exposure, and the purpose of testing affect interpretation and the need for repeat testing.

\medterm{Coronavirus, Types} Coronaviruses are a family of viruses that infect humans and animals. Human disease ranges from common-cold syndromes to severe illnesses caused by SARS-CoV, MERS-CoV, and SARS-CoV-2.

\medterm{COVID-19, Antibody Testing} A blood test that detects antibodies produced after SARS-CoV-2 infection or vaccination. It may show prior immune exposure but does not reliably establish current infection or guarantee protection.

\medterm{CP} A commonly used abbreviation for cerebral palsy, a group of permanent disorders of movement and posture caused by injury or abnormal development of the developing brain. Associated problems may involve sensation, communication, cognition, seizures, or feeding.

\medterm{Crabs (Pubic Lice)} Infestation of coarse body hair by pubic lice, causing itching and visible nits or lice. It is usually sexually transmitted but can spread through close contact; sexual partners and possible coexisting infections should be assessed.

\medterm{Cribriform Carcinoma} A carcinoma with a sieve-like microscopic growth pattern. The term may describe several tumors, including adenoid cystic carcinoma or cribriform breast carcinoma, so the organ of origin and pathology report determine its meaning.

\medterm{Cross-Eyes (Strabismus)} Misalignment of the eyes so they do not point in the same direction. Persistent strabismus in a child can impair visual development and cause amblyopia; sudden adult onset may indicate neurologic or ocular disease.

\medterm{Crosti-Gianotti Syndrome} A self-limited papular rash of childhood, also called papular acrodermatitis of childhood. It may follow viral infection or vaccination and causes symmetric papules on the face, buttocks, and limbs, usually resolving over weeks.

\medterm{Crow-Fukase Syndrome} Another name for POEMS syndrome, a rare plasma-cell disorder associated with polyneuropathy, organ enlargement, endocrinopathy, monoclonal protein, and characteristic skin changes.

\medterm{Cryptococcic Meningitis} Meningitis caused by \textit{Cryptococcus} fungi, especially in people with advanced HIV or other immune suppression. Headache, fever, confusion, nausea, and visual symptoms may develop gradually and require urgent antifungal treatment.

\medterm{Curvature of the Spine (Scoliosis)} Abnormal sideways curvature and rotation of the spine. It may be idiopathic, congenital, neuromuscular, or degenerative and can cause asymmetry, pain, reduced function, or impaired breathing when severe.

\medterm{Cyclic Edema} Recurrent swelling, often of the legs or hands, that changes with the menstrual cycle or other regular hormonal pattern. The diagnosis requires exclusion of heart, kidney, liver, venous, lymphatic, medication-related, and other causes of edema.

\medterm{Cyclic Migraines} Migraine attacks that recur in a predictable pattern, sometimes around menstruation or at regular intervals. They may include headache, nausea, light or sound sensitivity, and aura; preventive treatment may be considered when attacks are frequent or disabling.

\medterm{Cystic Fibrosis Carrier Screening} Genetic testing to identify a person who carries one disease-causing CFTR variant and usually has no cystic-fibrosis symptoms. Results help estimate reproductive risk and guide partner testing or genetic counseling.
