...
\medterm{Cavum} A cavity or hollow space in the body. The full anatomical name identifies the structure—for example, the cavum septi pellucidi is a fluid-containing space between parts of the brain.
...
\medterm{Coagulative Necrosis} A pattern of tissue death, usually caused by loss of blood supply, in which the basic outline of the tissue remains for a time. It occurs in most solid organs but generally not in the brain.
...
\medterm{Concealed Pregnancy} A pregnancy that remains hidden from others or is not recognized by the pregnant person until late in pregnancy or delivery. Reasons may include deliberate concealment, denial, or few noticeable symptoms.
...
\medterm{Corneitis} Inflammation of the clear front surface of the eye. It may cause pain, redness, watering, sensitivity to light, or blurred vision and can result from infection, injury, immune disease, or exposure.
...
\medterm{Coronary Steal Phenomenon} A fall in blood flow to an area of heart muscle that is already poorly supplied when nearby vessels widen. It can worsen chest pain during some medicines or stress tests.
...
\medterm{CPK Isoenzymes Test} A blood test that separates forms of creatine kinase to help show whether increased enzyme levels come mainly from skeletal muscle, heart muscle, or brain. Other tests are usually preferred for diagnosing a heart attack.
...
\medterm{CT Dose-Length Product} A measurement of the radiation output from a CT scan that accounts for both the scan strength and the length of the area scanned. It helps staff compare and improve scanning protocols but does not directly predict personal risk.
...
\medterm{Cystic Medial Necrosis} An older term for weakening of the wall of the aorta caused by loss of its supporting tissue. It can increase the risk of a bulge or tear in the aorta, especially with inherited disorders or aging.
...
\medterm{Comet Assay} A laboratory research test that estimates DNA damage in individual cells. The damaged DNA forms a comet-like pattern during testing; it is mainly used in research and toxicology, not routine patient care.
