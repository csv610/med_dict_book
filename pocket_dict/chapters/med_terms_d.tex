...
\medterm{Day-Sickness} An uncommon, nonspecific term for feeling ill mainly during the day. It is not a diagnosis; the cause may be identified only by assessing the particular symptoms, their timing, medicines, sleep, and other health conditions.
...
\medterm{Dcmp Deaminase} Deoxycytidylate deaminase, an enzyme that converts deoxycytidylate into deoxyuridylate. This reaction helps balance the building blocks used to copy DNA; abnormal activity is mainly relevant to biochemical and cancer research.
...
\medterm{Declopramide} An experimental chemical studied for possible anticancer activity. Laboratory research suggests it may promote cancer-cell death, but it is not an established routine treatment and should not be confused with metoclopramide.
