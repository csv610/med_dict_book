...
\medterm{Autonomic Dysreflexia} A dangerous sudden rise in autonomic nervous-system activity, usually after spinal-cord injury above the upper chest. A full bladder, bowel problem, skin irritation, or other stimulus may cause severe high blood pressure, headache, sweating, and slow heartbeat.
...
\medterm{Darier Sign} An objective cutaneous sign in which rubbing, gentle stroking, or mechanical friction on a lesion leads rapidly (within minutes) to localized erythema, wheal formation, and intense pruritus due to the physical degranulation of mast cells and release of histamine, pathognomonic for cutaneous mastocytosis (urticaria pigmentosa).
\synonyms
...
\medterm{Dawson Fingers} Distinctive demyelinating perivenular white matter plaques radiating perpendicularly along medullary venules from the ventricular margins and corpus callosum, seen on sagittal FLAIR and T2-weighted brain MRI in multiple sclerosis.
\synonyms
...
\medterm{Defense Wounds, Forensic} Injuries to the hands, arms, or other body areas that may occur when a person tries to protect against an assault. Their meaning must be assessed with the history and all other evidence.
\synonyms
Forensic Defense Injuries

\medterm{Defense Wounds, Sharp Force} Cuts or other injuries on the hands or forearms that may occur when a person attempts to protect against an attack.
...
\medterm{Dengue} A mosquito-borne viral infection caused by four types of dengue virus (DENV 1--4) and spread by daytime-biting \textit{Aedes} mosquitoes. It typically causes sudden high fever, severe headache, pain behind the eyes, intense muscle and joint aches (``breakbone fever''), nausea, and a measles-like rash. When the fever breaks (days 3--7), some patients enter a critical phase where blood vessels become leaky, leading to fluid buildup in the chest and abdomen, a sharp drop in blood platelets, bleeding, or dangerous shock (severe dengue). Diagnosis is confirmed by an NS1 antigen or PCR test in the first 5 days, or antibody tests later. Treatment focuses on careful fluid replacement, and aspirin or NSAIDs like ibuprofen must be strictly avoided because they increase bleeding risk.
...
\medterm{Dependence, Nicotine} Alternate name; see \textit{Nicotine Dependence}.
...
\medterm{Diagnostic Peritoneal Lavage} An emergency diagnostic procedure used in trauma management to detect internal bleeding or hollow organ injury inside the abdominal cavity, particularly in unstable patients following blunt abdominal trauma. A small catheter is inserted through a mini-incision in the lower abdominal wall into the peritoneal cavity. If gross blood (10 mL or more) or enteric contents are aspirated immediately, the test is positive and the patient proceeds directly to emergency surgery (laparotomy). If no gross blood appears, one liter of warm sterile normal saline is infused, gently distributed, and allowed to drain by gravity for laboratory analysis of red blood cells, white blood cells, bile, or bacteria. Although rapid ultrasound (FAST scan) and CT imaging have largely replaced routine DPL, it remains an important diagnostic tool in hemodynamically unstable trauma patients when advanced scanning is unavailable.
...
\medterm{DNA Profiling} A laboratory technique used to identify individuals or establish biological relationships by analyzing highly variable, polymorphic regions of non-coding genomic DNA. Modern DNA profiling utilizes the polymerase chain reaction (PCR) to amplify multiple short tandem repeat (STR) loci across the genome (such as the standard 20 core CODIS loci), which are separated and sized by capillary electrophoresis. Because the combination of STR repeat lengths is virtually unique to each individual (with random match probabilities typically exceeding one in trillions, except in identical twins), it is the gold standard for forensic crime-scene investigation, parentage testing, mass disaster victim identification, and post-bone marrow transplant chimerism monitoring.
...
\medterm{Double Bubble Sign} A classic radiographic finding on neonatal abdominal plain radiographs or prenatal ultrasonography consisting of two distinct gas-filled or fluid-filled cavities representing the distended stomach and proximal duodenal bulb, pathognomonic for congenital duodenal atresia or extrinsic duodenal obstruction.
\synonyms
...
\medterm{Dysdiadochokinesia} An impairment or inability to perform rapid, alternating, antagonistic movements (such as rapid pronation-supination of the hands or rapid foot tapping), characteristic of ipsilateral cerebellar hemisphere lesions or cerebellar tract dysfunction.
\synonyms
Dysdiadochokinesis; Adiadochokinesia

\medterm{Dysdiadochokinesis} An impaired ability to perform rapid, alternating antagonist movements, such as pronation and supination of the forearms or rapid foot tapping. It is a cardinal sign of cerebellar dysfunction, particularly involving the cerebellar hemispheres.
...
\medterm{Geophagia} The intentional and habitual eating of soil, clay, or chalk. It is a specific form of pica that is frequently associated with severe iron deficiency anemia or cultural practices.

\synonyms
Dirt Ingestion; Soil Eating; Earth Eating; Pica for Soil

\medterm{Geriatric Dentistry} Dental care for older adults, who may have dry mouth, root decay, gum disease, tooth loss, denture problems, or oral cancer risk. Care includes medication review, prevention, examination, treatment, and adaptations for mobility or cognition.

\synonyms
Gerodontology; Geriatric Dental Care
...
\medterm{Geriatric Dream Changes} Dreams in older adults may become more vivid or be affected by medicines, sleep disorders, depression, or changes in the sleep cycle. Repeated frightening dreams, acting them out, confusion, or sudden change requires clinical assessment.
...
\medterm{Hemodialysis} A medical procedure for kidney failure in which a machine filters metabolic waste products, toxins, and excess fluid directly from the blood through an external artificial dialyzer membrane.

\synonyms
Renal Hemodialysis; HD; Extracorporeal Dialysis
...
\medterm{Peritoneal Dialysis} A home-based treatment for kidney failure in which a sterile dialysate solution is infused into the abdominal cavity through a soft catheter, using the patient's own peritoneal membrane to filter waste and extra fluid.

\synonyms
PD; Continuous Ambulatory Peritoneal Dialysis; CAPD; Automated Peritoneal Dialysis
...
\medterm{Surgical Drain} A tube placed during or after surgery to remove blood, pus, or other fluid from an operative site. Possible complications include infection, blockage, leakage, bleeding, and movement of the tube.

\synonyms
Wound Drain; Surgical Drainage System
...
\medterm{Toothache} Pain from a tooth or nearby gum and jaw tissues. Common causes include decay, inflammation or infection inside the tooth, a crack, trauma, gum disease, or an impacted tooth.
