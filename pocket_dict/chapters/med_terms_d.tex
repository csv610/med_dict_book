...
\medterm{Dementia (Major Neurocognitive Disorder)} A lasting decline in memory, thinking, language, judgment, or other mental abilities that interferes with independent daily life. Causes include brain diseases, strokes, infections, medicines, and some treatable medical problems.
...
\medterm{Dupuytren'S Disease} A disorder in which tissue beneath the skin of the palm becomes thick and tight, forming cords that gradually pull one or more fingers toward the palm. It may limit hand function and is not caused by a joint problem.
