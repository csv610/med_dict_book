...
\medterm{2,3-Diphosphoglycerate} A substance made in red blood cells that helps hemoglobin release oxygen to body tissues.
...
\medterm{Dacarbazine} A chemotherapy medicine used for Hodgkin lymphoma, melanoma, and some other cancers. It may cause severe nausea, low blood counts, or liver injury.
...
\medterm{Dacrocytes} Teardrop-shaped red blood cells seen on a blood smear. They may occur when red blood cells pass through scarred or crowded bone marrow, and can be seen in myelofibrosis, bone-marrow cancers, and severe thalassemia.
...
\medterm{Dalrymple Sign} A clinical ophthalmologic sign characterized by abnormal widening of the palpebral fissure and retraction of the upper eyelid, revealing a strip of white sclera above the superior corneal limbus in primary gaze, classically seen in Graves ophthalmopathy and thyrotoxicosis.
\synonyms
Dalrymple's Sign; Thyrotoxic Eyelid Retraction
...
\medterm{Dance Sign} A clinical physical examination finding in pediatric intussusception characterized by a palpable emptiness or flattening in the right lower quadrant (ileocecal fossa), resulting from the invagination and distal displacement of the cecum and terminal ileum into the ascending colon.
\synonyms
Dance's Sign; Signe de Dance
...
\medterm{Dantrolene} A muscle relaxant that reduces the release of calcium inside muscle cells. It is the main treatment for malignant hyperthermia and may cause weakness or liver injury.
...
\medterm{Darier Sign} A skin reaction in which rubbing a lesion causes it to become red, swollen, and itchy within minutes. It strongly suggests cutaneous mastocytosis, but the finding must be considered with the rest of the examination.
\synonyms
Darier's Sign; Mastocytoma Stroking Sign
...
\medterm{Daubenton's Plane} A craniometric reference plane passing through the opisthion, the midpoint of the posterior margin of the foramen magnum, and the lower margins of the orbits. It is used in describing skull orientation.
...
\medterm{Dawson Fingers} Long, finger-like areas seen on some brain MRI scans in multiple sclerosis. They form around small veins near the brain's fluid spaces and support, but do not by themselves prove, the diagnosis.
\synonyms
Dawson's Fingers; Perivenular MS Plaques
...
\medterm{Daytime Sleepiness} Alternate name; see \textit{Excessive daytime sleepiness}.
...
\synonyms
D-Dimer Assay; Fibrin Degradation Fragment Test
...
\medterm{Death} The permanent end of life. It may be confirmed when the heart and breathing stop permanently or when all brain function has permanently stopped, according to medical and legal standards.
...
\medterm{Death, Sudden Cardiac} Alternate name; see \textit{Sudden Cardiac Death}.
...
\medterm{Decidua Basalis} The specialized maternal endometrium directly underlying the implanted blastocyst and interacting with chorionic villi, forming the maternal contribution to the mature placenta.
...
\medterm{Decorticate Rigidity} An abnormal stereotyped motor posturing in comatose patients characterized by flexion and adduction of the upper extremities with extension and internal rotation of the lower extremities, reflecting damage to the cerebral hemispheres or internal capsule above the level of the red nucleus (midbrain).
...
\medterm{Decreased Appetite} A pathological or temporary reduction in the desire to ingest food, commonly caused by systemic illness, chronic infection, malignancy, psychological stress, depression, or medications.
...
\medterm{Deep Tendon Reflexes} Involuntary monosynaptic stretch reflexes elicited by tapping a muscle tendon briskly with a reflex hammer (including the biceps, triceps, brachioradialis, patellar, and Achilles reflexes), used clinically to evaluate the structural and functional integrity of peripheral sensory and motor nerve roots and central upper motor neuron pathways.
\synonyms
...
\synonyms
DVT; Deep Venous Thrombosis; Deep Venous Thrombosis (DVT); Phlebothrombosis
...
\medterm{Deficiency, Primary Immunodeficiency} Alternate name; see \textit{Primary Immunodeficiency}.
...
\synonyms
DDD; Degenerative Disc Disease; Spondylosis
...
\medterm{Degenerative Chorea} Progressive involuntary, dance-like movements caused by degeneration of brain circuits that control movement. The term is most closely associated with Huntington disease, which may also cause changes in thinking, mood, behavior, speech, or swallowing.

\synonyms
Huntington's Chorea; Huntington Disease

\synonyms
Degenerative Disorder; Neurodegenerative Disease
...
\medterm{Deglutition} The coordinated process of moving food, liquid, or saliva from the mouth through the throat and esophagus into the stomach. Problems can cause choking, coughing, or food entering the airway.

\synonyms
Swallowing

\medterm{Degos Disease (Malignant Atrophic Papulosis)} A rare occlusive small-vessel disease causing multiple porcelain-white, atrophic skin papules with a surrounding pink or violaceous rim. It may remain limited to the skin or involve the intestine, brain, or other organs; new lesions with abdominal pain, headache, or neurologic symptoms require urgent specialist assessment.
...
\medterm{Delayed Graft Function} A manifestation of acute kidney injury following renal allograft transplantation, classically defined as the requirement for dialysis within the first seven days post-transplantation, commonly attributable to prolonged cold ischemia and acute tubular necrosis.
...
\medterm{Delayed Hemolytic Transfusion Reaction} An extravascular hemolytic immune response occurring typically 3 to 14 days following blood transfusion, mediated by anamnestic IgG alloantibodies (frequently against Kidd or Rh antigens) targeting transfused donor erythrocytes.
...
\synonyms
DSWPD; Delayed Sleep Phase Syndrome (DSPS)
...
\medterm{Delayed Sleep-Wake Phase Sleep Disorder} Alternate name; see \textit{Delayed Sleep Phase Syndrome}.
...
\medterm{Delirium Tremens (DTs)} A severe, potentially fatal form of alcohol withdrawal characterized by delirium, agitation, tremor, autonomic overactivity, hallucinations, and sometimes seizures, usually beginning several days after reduction or cessation of heavy drinking.
...
\medterm{Deltoid Ligament} A strong, fan-shaped triangular ligament complex on the medial aspect of the ankle joint, composed of superficial and deep components originating from the medial malleolus and attaching to the talus, calcaneus, and navicular bones to resist excessive eversion.
...
\medterm{Delusional Infestation} A fixed belief that living or inanimate pathogens are infesting the body despite no convincing medical or microbiological evidence. It may be primary or secondary to a psychiatric, neurologic, medical, medication-related, or substance-related condition; evaluation should exclude real infestation and other causes while avoiding dismissive care.
...
\synonyms
Major Neurocognitive Disorder; Cognitive Decline
...
\medterm{Dementia Behavioral and Sleep Changes} Common behavioral disturbances and sleep-wake cycle disruptions occurring in individuals with dementia, including wandering, sundowning, aggression, agitation, and nighttime restlessness.

\synonyms
Behavioral and Psychological Symptoms of Dementia; BPSD; Sundowning in Dementia
...
\medterm{Dementia, Frontotemporal} Alternate name; see \textit{Frontotemporal Dementia}.

\medterm{Dementia, Lewy Body} Alternate name; see \textit{Lewy Body Dementia}.

\medterm{Dementia, Major Neurocognitive} Alternate name; see \textit{Dementia}.

\medterm{Dementia, Vascular} Alternate name; see \textit{Vascular Dementia}.

\medterm{Dementia with Lewy Bodies} A progressive neurodegenerative dementia characterized pathologically by extensive intracellular alpha-synuclein inclusions (Lewy bodies) in cortical and subcortical neurons, presenting with fluctuating cognitive performance, recurrent well-formed visual hallucinations, REM sleep behavior disorder, and spontaneous parkinsonism.
\synonyms
...
\medterm{Demyelinating CNS Disease} A disorder in which the protective covering of nerves in the brain, spinal cord, or vision pathways is damaged. Causes include immune disease, infection, inherited conditions, toxins, and metabolic problems.
...
\medterm{Dengue} A mosquito-borne viral infection spread mainly by daytime-biting \textit{Aedes} mosquitoes. It commonly causes sudden fever, severe headache, pain behind the eyes, muscle and joint aches, nausea, and sometimes a rash. Some people develop severe dengue with bleeding, fluid leakage, shock, or organ injury. NS1, PCR, or antibody tests can support the diagnosis depending on the timing, but results must be interpreted with symptoms and exposure history. Care focuses on careful fluids and avoiding aspirin or ibuprofen unless a clinician advises otherwise.

\synonyms
Breakbone Fever; Dengue Fever; DENV Infection
...
\medterm{Dennie-Morgan Fold} A prominent, symmetrical single or double skin crease or infraorbital fold immediately below the margin of the lower eyelid, recognized as a characteristic cutaneous hallmark of atopic dermatitis and allergic diathesis.
\synonyms
Dennie-Morgan Line; Dennie Fold
...
\medterm{Dental Bone Graft} An oral and maxillofacial surgical procedure involving the placement of autologous bone, allograft, xenograft, or synthetic osteoconductive matrix into the maxilla or mandible to reconstruct alveolar ridge deficiencies or augment the maxillary sinus prior to dental implant placement.
...
\synonyms
Orthodontic Braces; Orthodontic Appliances
...
\medterm{Dental Polishing} Smoothing restorative surfaces to reduce plaque accumulation. Essential for longevity.

\synonyms
Dental Polishing; Coronal Polish
...
\medterm{Dental Root} The part of a tooth below the gum that anchors it in the jawbone. It contains a canal with nerves and blood vessels and is covered by cementum and supported by a ligament. Infection, decay, cracks, or loss of bone around the root can cause pain and tooth loosening.
...
\medterm{Dental Sleep Apnea Therapy} Alternate name; see \textit{Oral appliance therapy}.

\medterm{Dental Splint} Fixation of mobile teeth or fractured tooth. Wire and composite, orthodontic bracket splint. A dental device or wire used to stabilize loose teeth or a fractured tooth while healing occurs.
\synonyms
Occlusal Guard; Dental Nightguard; Bite Splint

\medterm{Dental Trauma} Alternate name; see \textit{Dental Injuries}.
...
\medterm{Dentate Line} A zigzag transverse anatomical boundary in the anal canal separating the upper two-thirds (endodermal origin, simple columnar epithelium, autonomic visceral innervation) from the lower one-third (ectodermal origin, stratified squamous epithelium, somatic pudendal innervation).
...
\medterm{Dependence, Nicotine} Inverted index label; see \textit{Nicotine Dependence}.
...
\medterm{Depolarizing Neuromuscular Blocker} A paralytic agent, exemplified exclusively by succinylcholine, that acts as an acetylcholine receptor agonist at the neuromuscular junction, inducing persistent membrane depolarization, transient muscle fasciculations, and subsequent flaccid motor paralysis.
...
\medterm{Depression, Postpartum} Alternate name; see \textit{Postpartum Depression}.
...
\medterm{Depression, Teen} Alternate name; see \textit{Teen Depression}.
...
\synonyms
Radial Styloid Tenosynovitis; De Quervain Tendinopathy

\medterm{De Quervain Thyroiditis} A self-limiting subacute granulomatous inflammatory disorder of the thyroid gland, typically occurring following a viral upper respiratory infection, presenting with exquisite anterior neck tenderness, thyroid enlargement, fever, elevated erythrocyte sedimentation rate, and transient thyrotoxicosis followed by recovery.
\synonyms
...
\medterm{Dercum Disease (Adiposis Dolorosa)} Alternate names; see \textit{Dercum's Disease}.
...
\medterm{Dermatitis, Atopic} Alternate name; see \textit{Atopic Dermatitis}.

\medterm{Dermatitis, Cercarial} Alternate name; see \textit{Swimmer's Itch}.

\medterm{Dermatitis, Contact} Alternate name; see \textit{Contact Dermatitis}.
...
\medterm{Dermatitis, Scratch} Alternate name; see \textit{Neurodermatitis}.

\medterm{Dermatitis, Seborrheic} Alternate name; see \textit{Seborrheic Dermatitis}.
...
\medterm{Dermatologic Manifestations of Hematologic Disease} Skin, hair, nail, or mucosal findings caused by a blood or bone-marrow disorder, its treatment, or an associated infection. Examples include pallor, petechiae, purpura, bruising, pruritus, ulcers, nodules, and infiltrative lesions; new or unexplained findings may require blood tests and biopsy.
...
\medterm{Dermatomal} Following or relating to a dermatome—a strip of skin supplied by sensory fibers from a single spinal nerve root. Dermatomal patterns can help localize nerve-root disease and are characteristic of some conditions, such as herpes zoster.
...
\medterm{Dermoid Cyst} A benign congenital choristoma resulting from the entrapment of ectodermal and mesodermal elements along embryonic suture lines during fetal development. The cyst wall is lined by keratinized stratified squamous epithelium containing dermal appendages such as hair follicles, sebaceous glands, and sweat glands, filled with oily keratin debris. In ophthalmology and pediatric surgery, it is the most common congenital orbital mass in children, typically presenting as a painless, firm, smooth, subcutaneous nodule fixed to the underlying bone, most frequently at the superolateral orbital rim along the frontozygomatic suture. A key surgical principle is complete intact en bloc excision; rupture of the cyst wall releases irritant lipid contents that trigger intense, painful granulomatous foreign-body inflammation. The term also encompasses mature cystic teratomas of the ovary containing hair, teeth, and sebaceous material.

\synonyms
Orbital Dermoid Cyst; Periorbital Dermoid; Benign Cystic Teratoma; Epidermoid and Dermoid Choristoma
...
\medterm{Descemet Membrane Endothelial Keratoplasty} An advanced partial-thickness corneal transplantation procedure in which only the diseased recipient corneal endothelium and Descemet membrane are stripped and replaced by an isolated donor Descemet membrane-endothelium sheet. It offers rapid visual recovery and very low allograft rejection rates in corneal endothelial disorders such as Fuchs endothelial dystrophy.
...
\medterm{Desynchronosis} Alternate name; see \textit{Jet Lag}.
...
\medterm{Detrusor Sphincter Dyssynergia} A neurological voiding disorder occurring in patients with suprasacral spinal cord lesions, characterized by involuntary, simultaneous contraction of the urinary bladder detrusor muscle and the external urethral sphincter during micturition, producing functional bladder outlet obstruction.
...
\medterm{Developmental Genital Tract Anomalies} Differences in the formation or structure of the uterus, cervix, vagina, fallopian tubes, or external genitalia that arise before birth. Effects range from none to infertility, pain, menstrual problems, or pregnancy complications.
...
\medterm{Developmental Milestone} Alternate name; see \textit{Developmental Milestones}.

\medterm{Developmental Milestones} A set of functional skills or age-specific behaviors that most children achieve within a predictable developmental window as they grow. Milestones are clinically categorized across four primary domains: gross motor (such as head control, rolling, sitting, and walking), fine motor and adaptive skills (such as pincer grasp, stacking blocks, and drawing), language and communication (such as cooing, single words, phrases, and storytelling), and cognitive/social-emotional development (such as social smiling, pretend play, and interactive sharing). Routine pediatric monitoring tracks milestones from infancy (head steady at 2--4 months, unsupported sitting at 6 months, first steps and single words at 12 months) through toddlerhood and early childhood (running and 2-word phrases at 2 years, conversational sentences at 3 years, and independent dressing and hopping at 4--5 years) to identify developmental delays or regression.

\synonyms
Developmental Milestone; Child Development Milestones; Pediatric Milestones; Developmental Milestones Record

\medterm{Developmental Milestones Record} Alternate name; see \textit{Developmental Milestones}.
...
\synonyms
Deviated Septum; Nasal Septal Deviation
...
\medterm{Devic Disease} An autoimmune demyelinating central nervous system disorder characterized by recurrent, severe bilateral optic neuritis and longitudinally extensive transverse myelitis spanning three or more vertebral segments, typically mediated by pathogenic anti-aquaporin-4 IgG autoantibodies (AQP4-IgG).
\synonyms
...
\medterm{De Winter T-Wave Pattern} An electrocardiographic presentation considered a high-risk ST-segment elevation myocardial infarction (STEMI) equivalent, indicative of acute proximal left anterior descending (LAD) coronary artery occlusion. Characterized by 1- to 3-millimeter upsloping ST-segment depression at the J-point in precordial leads $V_1$ through $V_6$ that transitions into tall, prominent, symmetric, hyperacute T waves, often accompanied by 0.5- to 1-millimeter ST-segment elevation in lead aVR.

\synonyms
De Winter ECG Sign; De Winter Syndrome
...
\medterm{DFSP} Alternate name; see \textit{Dermatofibrosarcoma Protuberans}.
...
\medterm{Diabetes, Gestational} Alternate name; see \textit{Gestational Diabetes}.

\medterm{Diabetes in Pregnancy} Alternate name; see \textit{Gestational Diabetes}.
...
\medterm{Diabetes Mellitus and Pregnancy} Diabetes before or first recognized during pregnancy can increase risks of miscarriage, fetal overgrowth or growth restriction, congenital anomalies, hypertensive disease, stillbirth, and neonatal metabolic problems. Glucose control, retinal and kidney assessment, medication review, and fetal surveillance are important.
...
\medterm{Diabetes, Pre} Alternate name; see \textit{Prediabetes}.
...
\medterm{Diabetes, Type 1} Alternate name; see \textit{Type 1 Diabetes}.

\medterm{Diabetes, Type 2} Alternate name; see \textit{Type 2 Diabetes}.

\medterm{Diabetic Amyotrophy} Alternate name; see \textit{Diabetic Neuropathy}.
...
\synonyms
Diabetic Meal Plan; Medical Nutrition Therapy for Diabetes

\medterm{Diabetic Focal Neuropathy} Alternate name; see \textit{Diabetic Neuropathy}.
...
\medterm{Diabetic Foot Infections} Infection involving the skin, soft tissue, or bone of a diabetic foot. Neuropathy, ischemia, ulceration, and impaired immunity can conceal severity or delay healing, so assessment includes depth, perfusion, systemic illness, and need for antimicrobial therapy or source control.

\medterm{Diabetic Foot Ulcer} A chronic non-healing sore on the foot in a person with diabetes, usually caused by a combination of peripheral neuropathy, poor blood circulation, and localized pressure or minor trauma.

\synonyms
Diabetic Ulcer; Neuropathic Foot Ulcer; Diabetic Foot Sore
...
\medterm{Diabetic Ketoacidosis} A life-threatening hyperglycemic emergency caused by insufficient effective insulin, with diabetes or hyperglycemia, elevated ketones, and metabolic acidosis. Diagnostic criteria generally include glucose at least 200 mg/dL or known diabetes, beta-hydroxybutyrate at least 3 mmol/L or significant ketonuria, and pH below 7.30 or bicarbonate below 18 mmol/L. Polyuria, dehydration, nausea, vomiting, abdominal pain, Kussmaul breathing, and altered mental status may occur; euglycemic DKA is possible, especially with SGLT2 inhibitors.
...
\synonyms
Diabetic Nerve Damage; Peripheral Diabetic Neuropathy

\medterm{Diabetic Neuropathy Entry} Alternate name; see \textit{Diabetic Neuropathy}.
...
\medterm{Diabetic Proximal Neuropathy} Alternate name; see \textit{Diabetic Neuropathy}.
...
\synonyms
Diabetic Eye Disease; Diabetic Microangiopathy of Retina
...
\medterm{Diagnostic Peritoneal Lavage} An older emergency test for serious internal bleeding or injury after major abdominal trauma. A small tube is placed into the abdomen and fluid is put in and then removed for testing. Ultrasound and CT scans are now used more often, but this test may still be used when those scans are not available.

\synonyms
DPL; Peritoneal Lavage; Abdominal Lavage
...
\medterm{Dialysis Complications of Chronic Renal Failure} Acute and chronic problems related to hemodialysis or peritoneal dialysis, including hypotension, disequilibrium, access infection or thrombosis, bleeding, electrolyte shifts, peritonitis, and amyloidosis.
...
\medterm{Dialysis-Related Beta-2m Amyloidosis} Amyloid deposition caused by accumulation of beta-2 microglobulin in people receiving long-term dialysis, especially with inadequate clearance. It can cause shoulder or joint pain, carpal tunnel syndrome, bone cysts, and destructive arthropathy.
...
\medterm{Diamond-Gardner Syndrome} A rare condition in which painful bruises appear repeatedly without a clear injury, most often in women. It is a diagnosis made after other bleeding causes are excluded; old skin tests are not reliable confirmation.
...
\medterm{Diaphragmatic Crus} One of two musculotendinous bundles (right and left crura) originating from the anterior aspects of the upper lumbar vertebral bodies and fibrocartilaginous discs, ascending to insert into the central tendon of the diaphragm and encircling the esophageal hiatus.
...
\medterm{Diaphragmatic Paralysis} Loss of normal diaphragmatic movement from phrenic-nerve injury, neuromuscular disease, surgery, trauma, or idiopathic causes. Symptoms range from none to breathlessness when lying flat and sleep-related hypoventilation; bilateral disease is more likely to cause respiratory failure.
...
\medterm{Diarrhea, Constipation, Gas, and Bloating} A group of digestive symptoms consisting of diarrhea, constipation, gas, and abdominal bloating. They may result from diet, infection, medicines, food intolerance, or disorders such as irritable bowel syndrome; persistent, severe, bloody, or unexplained symptoms require assessment.

\medterm{Diarrhea-Predominant IBS} Alternate name; see \textit{Irritable Bowel Syndrome}.

\medterm{Diarrhea, Traveler's} Alternate name; see \textit{Traveler's Diarrhea}.

\medterm{Diarrhoea} Alternate spelling; see \textit{Diarrhea}.
...
\medterm{Diascopy} A clinical examination technique in which a transparent glass slide or plastic lens is pressed firmly against a skin lesion to assess whether it blanches, allowing differentiation between intravascular blood (erythema, telangiectasias, spider naevi) and extravasated red blood cells (purpura, petechiae, ecchymoses).
...
\medterm{Diastolic Dysfunction} A condition where the heart muscle becomes stiff and cannot relax properly between beats. Although the heart still squeezes with normal strength, the stiffness makes it difficult for the heart chambers to fill with blood. This causes pressure inside the heart to rise, which can make fluid back up into the lungs and legs. Commonly caused by aging, long-term high blood pressure, and diabetes, it typically produces shortness of breath during activity, tiredness, and swollen ankles. It is usually detected using an ultrasound scan of the heart (echocardiogram).

\synonyms
Stiff Heart; Left Ventricular Diastolic Dysfunction; LVDD; Impaired Heart Relaxation
...
\medterm{Dientamoebiasis} An infection of the human large intestine caused by Dientamoeba fragilis, a non-invasive, flagellated trichomonad protozoan that exists solely in a trophozoite stage. It frequently presents as chronic or intermittent gastrointestinal distress characterized by watery or loose diarrhea, abdominal pain, flatulence, anorexia, nausea, and fatigue, particularly in children, travelers, and institutionalized populations.

\synonyms
Dientamoeba Fragilis Infection; Dientamoeba Colitis
...
\medterm{Dietary Sugars} Sugars are simple carbohydrates that provide energy but can raise blood glucose and contribute to dental decay or excess calories when consumed in excess.
...
\medterm{Diet, Diabetic} Alternate name; see \textit{Diabetic Diet}.
...
\medterm{Dietl Crisis} Severe, episodic, colicky flank or abdominal pain accompanied by nausea, vomiting, and oliguria, caused by transient kinking or obstruction of the ureter when a mobile or ptotic kidney shifts position into the pelvis upon standing (nephroptosis), relieved upon lying supine.

\synonyms
Renal Ptosis Crisis; Dietl Syndrome
...
\medterm{Diet, Ulcerative Colitis} Alternate name; see \textit{Ulcerative Colitis Diet}.
...
\medterm{Difficile, Clostridium} Alternate name; see \textit{Clostridioides Difficile Infection}.
...
\medterm{Difficulty Speaking} Alternate name; see \textit{Voice Disorders}.

\medterm{Difficulty Swallowing} Alternate name; see \textit{Dysphagia}.

\medterm{Difficulty Urinating} Trouble starting, maintaining, or emptying urine, often described as hesitancy, weak stream, straining, or incomplete emptying; causes include obstruction, infection, medicines, and nerve or muscle disorders.
...
\medterm{Diffuse Alopecia} Alternate name; see \textit{Diffuse Hair Loss}.

\medterm{Diffuse Alveolar Hemorrhage} A serious condition in which blood leaks into many of the lung’s air sacs. It may cause coughing up blood, breathlessness, low oxygen, falling blood counts, and widespread shadows on a chest scan. Bronchoscopy with increasingly bloody samples can support the diagnosis, but the full clinical picture and cause must be assessed.

\synonyms
DAH; Pulmonary Alveolar Hemorrhage
...
\medterm{Diffuse Hair Loss} A generalized, non-scarring reduction in hair density or widespread shedding affecting the entire scalp, distinguishing it from focal or patchy alopecia. Major causes include telogen effluvium following physiologic stress or childbirth, anagen effluvium induced by cytotoxic chemotherapy, diffuse androgenetic alopecia, systemic endocrinopathies such as hypothyroidism, and nutritional deficiencies in iron or zinc.

\synonyms
Diffuse Alopecia; Generalized Alopecia; Diffuse Effluvium
...
\medterm{Diffuse Parenchymal Lung Disease} Alternate name; see \textit{Interstitial Lung Disease (Interstitial Pneumonia)}.

\medterm{Diffuse Parenchymal Lung Diseases} Alternate index label; see \textit{Interstitial Lung Disease}.

\medterm{Diffuse Proliferative Glomerulonephritis} A pattern of glomerular inflammation in which many glomeruli show increased cellularity and tissue injury. It often produces hematuria, proteinuria, hypertension, and reduced kidney function and may result from immune-complex disease such as lupus or infection.
...
\medterm{DLCO} A pulmonary function test parameter measuring the ease with which inhaled carbon monoxide transfers across the alveolar-capillary barrier into pulmonary erythrocyte hemoglobin, reduced in emphysema, interstitial lung disease, and pulmonary vascular disorders.
...
\medterm{Diffusion Tensor Imaging} An MRI technique that maps the direction of water movement along nerve fibers. It helps show the paths and condition of important nerve connections in the brain.
...
\medterm{Digestive System} The gastrointestinal tract and accessory organs that mechanically and chemically process food, absorb nutrients and water, and eliminate solid waste. It includes the mouth, pharynx, esophagus, stomach, small and large intestines, rectum, anus, liver, gallbladder, and pancreas.
...
\medterm{Digital Anorectal Examination} A physical examination in which a clinician uses a lubricated, gloved finger to evaluate the anal canal, distal rectum, sphincter muscle tone, and adjacent structures such as the prostate.

\synonyms
DARE; Digital Rectal Examination; DRE; Rectal Exam

\medterm{Digital Breast Tomosynthesis} A breast X-ray test that takes pictures from several angles and combines them into thin, layered images. It can show some breast findings more clearly than a single flat image.
...
\medterm{Digital Radiography} X-ray imaging in which the picture is captured electronically instead of on film. The image can be viewed, stored, adjusted, and shared on a computer.
...
\medterm{Digitate Warts} Finger-like or thread-like warts, usually on the face or neck, caused by human papillomavirus infection. They are generally harmless but can spread or recur.
...
\medterm{Digoxin Toxicity} Poisoning from digoxin or a related cardiac glycoside. Nausea, vomiting, confusion, visual changes, slow or fast abnormal rhythms, and dangerous potassium changes may occur; severe cases require emergency treatment.
...
\medterm{Dihydropyrimidine Dehydrogenase Deficiency (DPYD-Related)} Reduced activity of dihydropyrimidine dehydrogenase, usually caused by harmful variants in the DPYD gene. It can impair breakdown of fluorouracil and related medicines and greatly increase the risk of severe or life-threatening toxicity.
...
\medterm{Dilated Pore of Winer} A benign, enlarged opening of a hair follicle that appears as a solitary black or dark keratin-filled pore, usually on the face, neck, or trunk of an adult. It may resemble a skin tumour; complete removal is diagnostic and usually curative.
...
\medterm{Dilation and Curettage} A procedure that opens the cervix and removes tissue from inside the uterus using suction or an instrument. It may treat miscarriage or retained pregnancy tissue, investigate bleeding, or remove abnormal tissue; risks include bleeding, infection, and perforation.
...
\medterm{Dilution Anemia} A pseudoanemia caused by an expansion of plasma volume out of proportion to red blood cell mass, resulting in reduced hemoglobin concentration and hematocrit despite normal total circulating erythrocyte volume, typically seen during pregnancy and aggressive intravenous fluid administration.

\synonyms
Hypervolemic Anemia; Hemodilution
...
\medterm{Dimetilan} A poisonous carbamate insecticide that disrupts nerve signals by blocking acetylcholinesterase. Exposure can cause sweating, vomiting, diarrhea, small pupils, weakness, breathing difficulty, seizures, or coma and needs urgent help.
...
\medterm{Dinoprostone} A prostaglandin medicine used to soften the cervix and help start labor or manage selected pregnancy-related conditions. It requires obstetric monitoring because it can cause contractions that are too frequent, pain, fever, nausea, or fetal heart-rate changes.
...
\medterm{Diphenhydramine} An antihistamine with sedating and anticholinergic effects used in some allergy or sleep products. It can impair alertness and cause dry mouth, confusion, urinary retention, abnormal rhythms, or toxicity in overdose.
...
\medterm{Diplopia} Seeing two images of one object. It may occur with one eye or only when both eyes are open; causes include dry eye, cataract, eye misalignment, nerve disease, muscle disease, or brain disease.
...
\medterm{Direct Acting Antivirals} A modern class of oral antiviral pharmacological agents that target specific non-structural viral proteins (such as NS3/4A protease, NS5A replication complex, and NS5B polymerase inhibitors in hepatitis C virus), achieving sustained virologic cure rates exceeding 95 percent.
...
\medterm{Direct Inguinal Hernia} An abdominal wall hernia in which peritoneal sac contents protrude directly forward through a weakened transversalis fascia within Hesselbach triangle, situated medial to the inferior epigastric vessels.
...
\medterm{Disk Battery Ingestion} Ingestion of a button or coin battery, which can cause rapid electrical and chemical tissue injury, especially when lodged in the esophagus. It is a medical emergency requiring urgent localization and removal.
...
\medterm{Dislocated Ankle} Alternate name; see \textit{Ankle Dislocation}.
...
\medterm{Disorder, Antisocial Personality} Alternate name; see \textit{Antisocial Personality Disorder}.

\medterm{Disorder, Asperger} Alternate name; see \textit{Asperger Syndrome}.
...
\medterm{Disorders of Oral Pigmentation} Conditions causing focal or diffuse dark, brown, blue, or black discoloration of the mouth lining. Causes include normal variation, trauma, inflammation, medicines, smoking, endocrine or systemic disease, and melanocytic or other tumors; new, changing, solitary, or symptomatic lesions need oral examination.

\medterm{Disorders, Sleep} Alternate name; see \textit{Sleep Disorders}.
...
\medterm{Dissecting Aneurysm} Alternate name; see \textit{Aortic Dissection}.
...
\medterm{Dissection, Aortic} Alternate name; see \textit{Aortic Dissection}.
...
\medterm{Disseminated Gonococcal Infection} A systemic complication of Neisseria gonorrhoeae infection resulting from bacteremic dissemination from mucosal surfaces. It classically manifests as an arthritis-dermatitis syndrome (migratory polyarthralgias, tenosynovitis, and painless pustular or hemorrhagic skin lesions) or as acute purulent septic monoarthritis.

\synonyms
DGI; Gonococcal Bacteremia; Gonococcal Arthritis-Dermatitis Syndrome
...
\medterm{Disseminated Zoster} A severe, widespread reactivation of varicella-zoster virus characterized by greater than 20 cutaneous vesicles outside the primary and adjacent dermatomes, occurring predominantly in immunocompromised individuals and carrying a high risk of visceral organ dissemination (pneumonitis, encephalitis, hepatitis).
...
\medterm{Dissociative Disorder} Alternate name; see \textit{Dissociative Disorders}.
...
\medterm{Distal Convoluted Tubule} The segment of the renal nephron located between the macula densa and the cortical collecting duct, responsible for calcium reabsorption under parathyroid hormone regulation and thiazide-sensitive sodium-chloride cotransport.
...
\medterm{Distributive Shock} Shock caused by marked vasodilation and abnormal distribution of blood flow, producing low systemic vascular resistance and inadequate effective tissue perfusion despite normal or high cardiac output early in the course. Sepsis, anaphylaxis, neurogenic shock, and some toxins are causes; skin may be warm initially, with hypotension, tachycardia or bradycardia, altered mentation, oliguria, and rising lactate.
...
\medterm{Disulfiram Toxicity} Poisoning from excessive disulfiram, which may cause nausea, vomiting, abdominal pain, drowsiness, confusion, hypotension, seizures, coma, peripheral neuropathy, or liver injury. A separate disulfiram--alcohol reaction causes flushing, throbbing headache, vomiting, tachycardia, and hypotension; treatment is withdrawal of exposure and supportive care.
...
\medterm{Diuretic Resistance} A clinical failure to achieve expected therapeutic natriuresis, fluid excretion, and decongestion despite escalating doses of loop diuretics, commonly encountered in decompensated heart failure, nephrotic syndrome, and cirrhosis with refractory ascites.
...
\medterm{Diverticula} Alternate name; see \textit{Diverticulosis}.

\medterm{Diverticular Bleeding} The painless, abrupt passage of large volumes of maroon or bright red blood per rectum resulting from transmural erosion or rupture of a weakened vasa recta mucosal arteriole at the neck of a colonic diverticulum; the most frequent cause of massive lower gastrointestinal hemorrhage in adults.
...
\medterm{Diverticulosis} The presence of multiple small, outward-protruding pouches (pseudodiverticula) formed by mucosal herniation through the muscular layer of the colon wall, most commonly occurring in the sigmoid and descending colon. Associated with aging and low-fiber diets, it is typically asymptomatic but represents the leading cause of sudden, painless, massive lower gastrointestinal bleeding (diverticular hemorrhage) when adjacent nutrient blood vessels rupture. It can also progress to diverticulitis if a pouch becomes obstructed, inflamed, or infected. Prevention and management focus on a high-fiber diet, hydration, and maintaining regular bowel habits.
\synonyms{Colonic Diverticulosis; Diverticular Pouching; Diverticular Disease of the Colon}
...
\medterm{Divisum, Pancreas} Alternate name; see \textit{Pancreas Divisum}.
...
\medterm{Dizzy} Alternate name; see \textit{Dizziness}.
...
\medterm{D-Lactic Acidosis} A rare metabolic encephalopathy and high anion gap metabolic acidosis occurring in patients with short bowel syndrome, resulting from colonic bacterial fermentation of unabsorbed carbohydrates into the D-isomer of lactic acid, which humans metabolize slowly.
...
\medterm{DMG} Alternate name; see \textit{Diffuse Midline Glioma}.
...
\medterm{DNA Helicase} An essential adenosine triphosphate-dependent motor enzyme that unwinds and separates double-stranded DNA into single strands ahead of the replication fork, enabling DNA polymerases access for replication, transcription, and recombination.
...
\medterm{DNA Polymerase} A family of cellular enzymes that synthesize new DNA strands by polymerizing deoxynucleotides complementary to a single-stranded template in a 5-prime to 3-prime direction, with many isoforms possessing 3-prime to 5-prime exonucleolytic proofreading activity.
...
\medterm{DNA Profiling} A laboratory test that compares selected parts of a person's DNA. It can help identify a person, assess biological relationships, identify remains, or check whether cells came from a donor or another person. Results are very informative but must be interpreted with the sample quality, testing method, and legal or medical setting.

\synonyms
DNA Fingerprinting; Genetic Fingerprinting; DNA Typing; STR Analysis
...
\synonyms
Canine Bite Trauma; Dog Bite Wound
...
\medterm{Dolichostenomelia} Abnormally long, slender limbs, often used to describe a marfanoid body habitus. It may occur in connective-tissue disorders such as Marfan syndrome and should be interpreted with the person's other skeletal and cardiovascular findings.

\medterm{Doll Eye Reflex} The oculocephalic reflex in which rapid passive rotation or flexion and extension of the head in an unconscious or comatose patient produces conjugately opposed compensatory eye movements when the brainstem pathways linking cranial nerves III, VI, and VIII through the medial longitudinal fasciculus are functionally intact.
\synonyms
Oculocephalic Reflex; Doll's Eyes Phenomenon

\medterm{Doll's Eye Sign} A physical examination finding of the oculocephalic reflex in comatose patients, in which rapid horizontal or vertical rotation of the head produces conjugate eye deviation in the direction opposite to head movement, demonstrating intact midbrain and pontine brainstem pathways.
...
\medterm{Donath-Landsteiner Antibody} An antibody that can attach to red blood cells in cold conditions and destroy them when the blood warms. It is associated with paroxysmal cold hemoglobinuria, a rare cause of red-cell breakdown.

\synonyms
Donath-Landsteiner Hemolysin; Biphasic Hemolysin
...
\synonyms
DNR Order; DNAR Order; Allow Natural Death (AND)

\medterm{Donovan Bodies} Intracellular clusters of deeply staining, encapsulated, pleomorphic gram-negative rod bacteria (Klebsiella granulomatis) located within the cytoplasm of large mononuclear histiocytes, identified on Giemsa or Wright-stained tissue smears from lesions of granuloma inguinale (donovanosis).
\synonyms
Donovan Body; Leishmanoid Granules
...
\synonyms
Granuloma Inguinale; Calymmatobacterium Infection
...
\medterm{Dopaminergic Pathways} Four main nerve pathways that use dopamine to send signals. They help control movement, reward, thinking, emotions, and the release of some hormones.
...
\medterm{Doppler Ultrasound of a Limb} An ultrasound examination measuring blood flow through the arteries and veins of an arm or leg. It can help identify narrowing, blockage, a clot, aneurysm, or other circulation problem without ionizing radiation.
...
\medterm{Dorsal Body Cavity} The body cavity toward the back. It includes the cranial cavity, which contains the brain, and the spinal cavity, which contains the spinal cord.

\medterm{Dorsal Column-Medial Lemniscal Pathway} The major ascending sensory pathway conveying conscious proprioception, discriminative fine touch, and vibratory sensation from peripheral mechanoreceptors through the spinal cord fasciculus gracilis and cuneatus to the medulla, where fibers decussate in the medial lemniscus to ascend to the thalamus.

\synonyms
DCML Pathway; Dorsal Column System
...
\medterm{Dorsal Root} The back root of a spinal nerve. It carries sensory signals from the body into the spinal cord.
...
\synonyms
Double-Masked Study; Double-Blind Protocol
...
\medterm{Double Bubble Sign} An imaging finding in a newborn showing two enlarged, air- or fluid-filled areas representing the stomach and first part of the small intestine. It strongly suggests a blockage near the start of the small intestine, such as duodenal atresia, but other causes are possible.
\synonyms
Duodenal Atresia Sign; Double Bubble Radiographic Appearance
...
\medterm{Dowager Hump} An exaggerated posterior thoracic hyperkyphosis causing an abnormal dorsal hump at the base of the neck, caused by multiple anterior wedge compression fractures of osteoporotic thoracic vertebral bodies in elderly patients.
\synonyms
Senile Kyphosis; Postmenopausal Thoracic Hyperkyphosis
...
\medterm{Dowling-Meara Syndrome} A severe inherited form of epidermolysis bullosa simplex, usually caused by variants in the \textit{KRT5} or \textit{KRT14} gene. Widespread grouped blisters may begin at birth or in infancy and can affect the skin, mouth, nails, and airway.
...
\medterm{DR} Alternate name; see \textit{Diabetic Retinopathy}.
...
\medterm{Draf Procedure} A standardized series of endoscopic endonasal frontal sinus drainage techniques (Draf type I, IIa, IIb, and III) utilized in rhinology. Draf type III (modified endoscopic Lothrop procedure) involves complete resection of the frontal sinus floor, superior nasal septum, and interfrontal sinus septum to create a single large drainage neo-ostium into both frontal sinuses.

\synonyms
Endoscopic Frontal Sinusotomy; Modified Lothrop Procedure
...
\medterm{Drawer Test} An orthopedic manual examination of the flexed knee joint assessing the integrity of the cruciate ligaments; forward tibial translation tests the anterior cruciate ligament (anterior drawer test) and backward tibial translation tests the posterior cruciate ligament (posterior drawer test).
\synonyms
Knee Drawer Sign; Anterior and Posterior Drawer Tests
...
\medterm{Drop Attack} A sudden, unprovoked collapse to the ground resulting from abrupt loss of postural tone in the lower extremities without loss of consciousness, occurring in vertebrobasilar insufficiency, cryptogenic falls of older adults, or inner ear otolithic hydrops (Tumarkin otolithic crisis).
...
\medterm{Drop Foot} Alternate name; see \textit{Foot Drop}.
...
\medterm{Drowning Signs} Alternate name; see \textit{Drowning}. (The terms 'dry drowning' and 'wet drowning' are non-standard clinical descriptions).
...
\medterm{Drug- and Nephrotoxin-Associated Kidney Disorders} Kidney injury caused by medicines, contrast agents, industrial chemicals, supplements, or other toxins. Patterns include acute tubular injury, interstitial nephritis, glomerular disease, crystals, obstruction, and chronic fibrosis; medication review and prompt withdrawal of a culprit may limit damage.
...
\medterm{Drug-Eluting Stent} A vascular stent coated with a medicine that reduces tissue growth and helps keep the treated vessel open. It is used in selected narrowed or blocked arteries and requires appropriate antiplatelet management.

\medterm{Drug Eruptions} Adverse skin or mucosal reactions caused by medicines, ranging from mild morbilliform rashes or hives to fixed drug eruptions and severe cutaneous adverse reactions. Blistering, skin pain or peeling, mouth or eye involvement, fever, facial swelling, or organ symptoms require urgent assessment.
...
\medterm{Drug Hypersensitivity} An abnormal reaction in which the body's immune system mistakenly treats a medicine as a harmful invader. It is different from common side effects, such as mild stomach upset or drowsiness. Reactions can happen quickly (within minutes to an hour of taking the medicine), causing hives, itchy skin, facial or throat swelling, trouble breathing, or a severe whole-body allergic reaction called anaphylaxis. Other reactions develop slowly over several days or weeks, causing widespread red skin rashes, fever, or painful blistering. Common medicines that can trigger these reactions include antibiotics (such as penicillin and sulfa drugs), pain relievers (such as aspirin and ibuprofen), and seizure medications.
\synonyms
Drug Allergy; Medication Allergy; Drug Hypersensitivity Reaction; Allergic Drug Reaction

\medterm{Drug Implant} A solid drug-containing pellet, container, or delivery device placed under the skin or in another tissue to release medicine continuously or slowly over an extended period. It may provide local or whole-body treatment; the product determines whether it biodegrades or requires removal and how it is monitored.

\medterm{Drug Implants} Plural of drug implant; see \textit{Drug Implant}.

\medterm{Drug-Induced Bullous Disorders} Medication-triggered blistering diseases, including bullous pemphigoid, pemphigus, linear IgA disease, bullous fixed drug eruption, and severe reactions such as Stevens--Johnson syndrome or toxic epidermal necrolysis. New widespread blisters, skin tenderness, peeling, fever, or mouth, eye, or genital involvement is an emergency.

\medterm{Drug-Induced Gingival Hyperplasia} Enlargement or overgrowth of gum tissue associated especially with phenytoin, cyclosporine or tacrolimus, and calcium-channel blockers such as nifedipine or amlodipine. It can impair brushing, trap plaque, and promote bleeding or periodontal disease; dental care and review of the medicine with the prescriber are needed, and treatment should not be stopped abruptly.

\medterm{Drug-Induced Glaucoma} Glaucoma or raised intraocular pressure caused or worsened by a medicine, commonly corticosteroids and less often agents that produce pupillary block or secondary inflammation. Treatment involves removing the trigger when possible and controlling pressure.

\medterm{Drug-Induced Hepatotoxicity} Liver injury caused by a medicine, supplement, or other therapeutic exposure. Patterns include hepatocellular injury, cholestasis, or a mixed picture; diagnosis requires exposure review and exclusion of competing causes.

\medterm{Drug-Induced Liver Injury} Acute or chronic hepatic damage provoked by exposure to prescribed medications, herbal products, or dietary supplements, manifesting as hepatocellular, cholestatic, or mixed injury patterns via intrinsic direct hepatotoxicity or idiosyncratic immune mechanisms.

\synonyms
DILI; Toxic Hepatitis
...
\medterm{Drug-Induced Lupus Erythematosus} An autoimmune lupus-like syndrome provoked by prolonged exposure to certain pharmacological agents (most classically procainamide, hydralazine, and isoniazid), characterized by arthralgias, serositis, anti-histone antibodies, and resolution following drug discontinuation.

\synonyms
DILE; Drug-Induced Lupus

\medterm{Drug-Induced Pemphigus} An autoimmune blistering disorder triggered by a medicine, with antibodies disrupting adhesion between epidermal cells and causing fragile blisters or erosions on skin or mucous membranes. Diagnosis uses biopsy and immunofluorescence; the suspected medicine is stopped only with medical guidance, and the eruption may improve after withdrawal.

\medterm{Drug-Induced Photosensitivity} An exaggerated skin reaction after exposure to sunlight or other ultraviolet light while taking or applying a photosensitizing medicine. Phototoxic reactions resemble an intense sunburn and may occur quickly, whereas photoallergic reactions are delayed and eczematous; sun protection and clinician-guided review of the medicine are important.

\medterm{Drug-Induced Pigmentation} Darkening or altered colour of the skin, nails, teeth, or mucous membranes caused by a medicine or its metabolites. Causes include increased melanin, drug or metabolite deposition, and iron deposition; examples include minocycline, amiodarone, clofazimine, antimalarials, and some chemotherapy medicines.

\medterm{Drug-Induced Pulmonary Toxicity} Respiratory injury caused by a medicine, radiation, or treatment-related immune reaction. It may appear as pneumonitis, organizing pneumonia, fibrosis, edema, hemorrhage, bronchospasm, or pulmonary vascular disease; diagnosis requires temporal review and exclusion of infection and other causes.
...
\medterm{Dry Age-Related Macular Degeneration} Alternate name; see \textit{Dry Macular Degeneration}.

\medterm{Dry AMD} Alternate name; see \textit{Dry Macular Degeneration}.

\medterm{Dry Beriberi} The predominantly neurologic form of severe thiamine deficiency. It can cause symmetric peripheral neuropathy, burning or numb feet, muscle weakness, wasting, impaired reflexes, and difficulty walking.
\synonyms
Tumarkin Drop Attack; Cryptogenic Drop Fall
...
\medterm{Dry Drowning} Alternate name; see \textit{Drowning}.
...
\medterm{Dry Gangrene} A form of tissue death (coagulative necrosis) resulting from severe, prolonged insufficiency of arterial blood supply without superimposed bacterial infection. Most commonly affecting the toes, feet, or fingers in individuals with advanced peripheral artery disease, diabetes, or severe frostbite, the tissue becomes cold, dry, shrunken, and black (mummified). A sharp, distinct line of demarcation typically separates the dead tissue from adjacent healthy skin. Unlike wet gangrene, there is minimal swelling or foul odor unless a secondary bacterial infection develops. Management focuses on keeping the area dry and protected, performing urgent vascular evaluation and revascularization to restore blood flow, and elective surgical amputation when necessary.

\synonyms
Ischemic Gangrene; Mummification; Senile Gangrene; Arterial Gangrene
...
\synonyms
Atrophic AMD; Dry AMD; Geographic Atrophy
...
\medterm{Dryness, Vaginal} Alternate name; see \textit{Vaginal Atrophy}.
...
\medterm{DSPS} Alternate name; see \textit{Delayed Sleep Phase Syndrome}.

\medterm{DSRCT} Alternate name; see \textit{Desmoplastic Small Round Cell Tumor}.

\medterm{DSWPD} Alternate name; see \textit{Delayed Sleep Phase Syndrome}.
...
\medterm{Dual Antiplatelet Therapy} The simultaneous clinical administration of two distinct antiplatelet agents with complementary mechanisms of action (typically aspirin paired with a P2Y12 receptor antagonist such as clopidogrel, ticagrelor, or prasugrel), indicated following acute coronary syndrome or percutaneous coronary intervention with stent placement.
...
\synonyms
DR Syndrome; Duane Syndrome; Stilling-Turk-Duane Syndrome
...
\medterm{Duchenne Muscular Dystrophy} An X-linked recessive muscle disease, usually affecting boys, caused by disease-causing changes in the dystrophin gene. Progressive muscle weakness begins in childhood and may affect walking, breathing, the heart, and learning or behavior.

\synonyms
DMD; Duchenne Dystrophy
...
\medterm{Duct Ectasia} Dilation and chronic periductal inflammation of a glandular duct system, most commonly referring to mammary duct ectasia of the subareolar breast ducts. See \textit{Mammary Duct Ectasia}.
...
\medterm{Dugas Sign} A clinical orthopedic test for anterior glenohumeral dislocation; the sign is positive if the patient is unable to touch the opposite shoulder with the hand of the injured extremity while the elbow remains resting in contact with the chest wall.
\synonyms
Dugas' Sign; Anterior Shoulder Dislocation Test
...
\medterm{Dunbar Syndrome} Alternate name; see \textit{Median Arcuate Ligament Syndrome}.

\medterm{Dunphy Sign} A clinical sign of acute appendicitis and localized peritoneal inflammation characterized by a sharp exacerbation of right lower quadrant abdominal pain triggered by coughing.
\synonyms
Dunphy's Sign; Cough Sign of Appendicitis
...
\medterm{Dural Arteriovenous Fistula} An abnormal direct connection between an artery and a vein in the tough covering around the brain or spinal cord. It may cause a pulsing sound in the ear, headache, seizures, vision or other nerve problems, or bleeding.
...
\medterm{Duroziez Sign} An auscultatory vascular sign of severe aortic regurgitation consisting of a double murmur heard over the femoral artery—a systolic murmur generated by proximal compression and a diastolic murmur generated by distal compression with the stethoscope diaphragm.
\synonyms
Duroziez's Sign; Duroziez Double Murmur
...
\synonyms
House Dust Mite Hypersensitivity; Dust Mite Sensitization
...
\medterm{DXA Scan} Alternate name; see \textit{Dual Energy X-Ray Absorptiometry}.
...
\medterm{Dysdiadochokinesia} Difficulty making quick, repeated movements in opposite directions, such as rapidly turning the hands over and back. It can occur with problems in the cerebellum or its nerve pathways.
\synonyms
Dysdiadochokinesis; Adiadochokinesia

\medterm{Dysdiadochokinesis} Difficulty making quick, repeated movements in opposite directions, such as rapidly turning the hands over and back. It can occur with problems in the cerebellum or its nerve pathways.
...
\medterm{Dysentery} Diarrhea with visible blood, often with cramps, fever, mucus, and an urgent need to pass stool. Several bacteria and parasites can cause it, so the cause needs medical assessment.
...
\synonyms
Dyshidrotic Eczema; Pompholyx; Vesicular Hand Dermatitis

\medterm{Dyshidrotic Eczema} A recurrent, intensely pruritic dermatosis affecting the lateral margins of the fingers, palms, and soles, characterized by deep-seated, "tapioca-like" intraepidermal vesicles that subsequently resolve with desquamation and fissuring.


\synonyms
Pompholyx; Dyshidrosis

\medterm{Dyskeratosis Congenita} A rare hereditary telomere biology disorder caused by mutations in telomere maintenance genes, characterized by the classic triad of reticulated reticular skin hyperpigmentation, dystrophic nails, and oral mucosal leukoplakia, associated with a high risk of progressive bone marrow failure and pulmonary fibrosis.
\synonyms
Zinsser-Cole-Engman Syndrome; Telomere Biology Disorder
...
\medterm{Dyspepsia} The medical term for indigestion, describing persistent or recurring discomfort centered in the upper stomach area. Common symptoms include upper abdominal pain or burning, feeling uncomfortably full after normal meals, and feeling full too soon while eating. In the majority of people (around 70\% to 80\%), tests reveal no ulcers or visible physical damage, a condition termed functional dyspepsia. Identifiable causes include peptic ulcers, acid reflux, Helicobacter pylori bacterial infection, and medications such as nonsteroidal anti-inflammatory drugs (NSAIDs). Doctors evaluate persistent symptoms through bacterial breath or stool tests, medication trials, or an upper endoscopy camera examination.

\synonyms
Indigestion; Functional Dyspepsia; Upset Stomach
...
\medterm{Dysphagia} The medical term for difficulty swallowing, describing trouble moving food, liquids, or saliva from the mouth to the stomach. It is divided into two main types: oropharyngeal dysphagia (a mouth or throat problem, often caused by nerve or muscle disorders like stroke or Parkinson's disease, leading to coughing or choking right as swallowing begins) and esophageal dysphagia (a food-pipe problem, caused by narrowings, growths, or muscle spasms, where food feels stuck behind the breastbone). Potential complications include food entering the airways (aspiration) and weight loss. Doctors identify the cause using specialized X-ray video swallow studies (barium swallow) or an upper endoscopy.

\synonyms
Difficulty Swallowing; Deglutition Disorder
...
\medterm{Dysphagia Lusoria} Difficulty swallowing caused by extrinsic esophageal compression from an aberrant right subclavian artery (arteria lusoria) that arises abnormally as the last branch of the aortic arch and crosses retroesophageally to reach the right arm.

\synonyms
Transfer Dysphagia; High Dysphagia
...
\medterm{Dysania} Persistent or excessive difficulty getting out of bed or waking up, often associated with sleep disorders, depression, medication effects, or other medical causes. It is a descriptive symptom rather than a formal diagnosis by itself.

\medterm{Dysmyelogenic Leukodystrophy} An older or nonspecific term for a leukodystrophy in which myelin develops abnormally. Modern diagnosis generally identifies the specific genetic or acquired disorder and its pattern of hypomyelination, dysmyelination, or demyelination.

\synonyms
Dysmyelinating Leukodystrophy

\medterm{Dysphonia Spastica} Alternate name; see \textit{Spasmodic Dysphonia}.
...
\medterm{Dysplasia, Cervical} Alternate name; see \textit{Cervical Dysplasia}.

\medterm{Dysplasia Epiphysealis Hemimelica (Trevor Disease)} A rare developmental overgrowth of cartilage in one side of an epiphysis, usually affecting a lower-limb joint in childhood. It can cause asymmetric bony masses, pain, stiffness, deformity, or restricted movement and is evaluated with radiographs or MRI.

\medterm{Dysplastic Melanocytic Nevi Pathology} Melanocytic nevi with architectural disorder and variable cytologic atypia, often showing bridging of rete ridges, lamellar fibroplasia, and atypical melanocytes. The degree of atypia is graded and must be distinguished from melanoma.
...
\medterm{Dyspnoea} Alternate name; see \textit{Dyspnea}.

\medterm{Dyspraxia} A developmental difficulty planning and coordinating movements that interferes with daily activities, learning, or motor skills. It is not explained by muscle weakness, loss of sensation, or inadequate opportunity to learn.
...
\medterm{Dysthyroid Eye Disease} An autoimmune inflammatory disorder of the orbit most commonly associated with Graves disease (and occasionally Hashimoto thyroiditis or euthyroid states). Autoantibodies targeting TSH receptors on orbital fibroblasts stimulate excessive production of hyaluronic acid and adipogenesis, causing marked enlargement and edema of extraocular muscle bellies (characteristically sparing their tendons) and orbital fat expansion. Symptoms include forward protrusion of the eyes (proptosis), upper eyelid retraction, lid lag, grittiness, double vision (diplopia), and, in severe cases, vision loss from corneal ulceration or compressive optic neuropathy at the orbital apex. It is strongly aggravated by smoking. Management includes smoking cessation, artificial tears, intravenous corticosteroids, targeted biologic therapy (teprotumumab), orbital radiation, and surgical orbital decompression.

\synonyms
Thyroid Eye Disease; Graves' Ophthalmopathy; Graves' Orbitopathy; Dysthyroid Ophthalmopathy; TED
...
\medterm{Dystonia, Cervical} Alternate name; see \textit{Cervical Dystonia}.
...
\medterm{Dystrophin} A large sub-sarcolemmal cytoskeletal structural protein that anchors the internal actin cytoskeleton of skeletal and cardiac muscle fibers to the extracellular matrix through the dystrophin-associated glycoprotein complex; mutations in the \textit{DMD} gene lead to Duchenne and Becker muscular dystrophies.
...
\medterm{D Trisomy Syndrome} An older name for trisomy 13 (Patau syndrome), a chromosome disorder caused by an extra chromosome 13. It can cause severe developmental impairment, brain and facial differences, heart defects, and abnormalities of other organs.

\medterm{Dandy Fever} An older name for dengue fever, a mosquito-borne viral illness that causes fever, headache, muscle and joint pain, nausea, and sometimes bleeding or severe plasma leakage.

\medterm{DBA} Abbreviation for Diamond-Blackfan anemia, an inherited bone-marrow failure syndrome that usually causes anemia in infancy or early childhood and may be associated with characteristic physical differences or other congenital abnormalities.

\medterm{Deerfly Fever} An older name for tularemia, an infection caused by \textit{Francisella tularensis}. It can spread through tick or deerfly bites, infected animals, contaminated water, or inhalation and may cause fever, ulcers, swollen lymph nodes, pneumonia, or severe systemic illness.

\medterm{DH} Abbreviation commonly used for dermatitis herpetiformis, an intensely itchy blistering skin disorder associated with gluten-sensitive enteropathy and celiac disease. The abbreviation can have other meanings and should be interpreted in context.

\medterm{Diabetes in Children: Dealing with Low Blood Sugar} Recognition and treatment of hypoglycemia in a child with diabetes. Symptoms may include sweating, trembling, hunger, irritability, confusion, seizure, or loss of consciousness; fast-acting glucose is used when the child is awake and able to swallow, with emergency glucagon for severe episodes.

\medterm{Diabetes in Children: Preventing Low Blood Sugar} Measures to reduce hypoglycemia in children with diabetes, including individualized insulin dosing, regular meals and snacks, glucose monitoring, planning around activity, and education about symptoms and emergency glucagon.

\medterm{Diabetes in Pregnancy (Gestational Diabetes)} Diabetes first recognized during pregnancy, caused by inadequate insulin response to pregnancy-related metabolic changes. It increases risks for excessive fetal growth, birth complications, preeclampsia, and later type 2 diabetes and requires monitoring and treatment.

\medterm{Diabetic Eye Disease} Eye damage caused by diabetes, including diabetic retinopathy, diabetic macular edema, cataract, glaucoma, and cranial-nerve or optic-nerve complications. Regular dilated eye examinations can detect treatable disease before vision is lost.

\medterm{Difficulty Swallowing (Dysphagia)} Trouble moving food, liquid, or saliva safely from the mouth to the stomach. Causes may involve the throat, esophagus, nerves, muscles, or obstruction; choking, aspiration, weight loss, or progressive symptoms require prompt evaluation.

\medterm{DMD} Abbreviation for Duchenne muscular dystrophy, an X-linked muscle disease caused by deficient dystrophin. It usually begins in childhood with progressive proximal weakness, difficulty running or climbing, calf enlargement, and later heart and respiratory complications.

\medterm{Drooping Eyelids} Ptosis, or abnormal lowering of one or both upper eyelids. Causes include age-related tendon stretching, nerve or muscle disease, congenital weakness, trauma, or a mass; sudden ptosis with double vision, headache, or unequal pupils is urgent.

\medterm{Drug Abuse, Teen} Harmful or risky use of drugs by an adolescent, including nonmedical use of prescription medicines or use of illicit substances. It can impair brain development, increase overdose and injury risk, and signal a substance use disorder requiring confidential, age-appropriate care.

\medterm{Dry Skin and Itching} Xerosis with pruritus, often caused by low humidity, irritating products, eczema, medicines, or systemic disease. Persistent, widespread, severe, or sleep-disrupting itch warrants evaluation for dermatologic, liver, kidney, thyroid, blood, or neurologic causes.

\medterm{Dupuytren’s Disease} A progressive thickening and shortening of tissue in the palm that pulls one or more fingers into flexion. It may limit hand function; treatment ranges from observation and therapy to needle procedures or surgery.
