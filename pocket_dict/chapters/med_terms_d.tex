...
\medterm{22q11.2 Deletion Syndrome} A genetic condition caused by a missing piece of chromosome 22. It includes conditions once called DiGeorge and velocardiofacial syndromes. Features vary but may include heart defects, a cleft or weakly closing palate, reduced immune defenses from an underdeveloped thymus, low calcium from parathyroid problems, distinctive facial features, learning or developmental difficulties, and increased risk of mental illness. Care is tailored to the child’s findings and may involve heart, immune, calcium, speech, and developmental specialists.
...
\medterm{D-Limonene} A citrus-derived chemical found in orange, lemon, and other citrus oils, used in fragrances, cleaning products, foods, and some experimental medical research.
...
\medterm{Dacetuzumab} An investigational antibody that targets CD40 on immune and other cells. It has been studied in some blood cancers but is not an established routine treatment.
...
\medterm{Dactylosymphysis} Joining or fusion of two neighboring fingers or toes, usually present from birth. The connection may involve skin, bone, or both and can affect movement, growth, or hand and foot function.
...
\medterm{Dane Particle} The complete infectious form of hepatitis B virus, consisting of genetic material enclosed by a protein core and outer envelope. It can enter liver cells and reproduce, causing hepatitis B infection.
...
\medterm{De Musset Sign} Repeated nodding of the head in time with the heartbeat. It can occur with severe leakage of the aortic valve, but it is uncommon and cannot diagnose the condition without examination and heart tests.
...
\medterm{De Quervain'S Tendonitis} Painful irritation and narrowing around tendons on the thumb side of the wrist, often worsened by gripping, lifting, or repeated wrist movement.
...
\medterm{Deciduoma} An older term for a mass-like reaction of the uterine lining to pregnancy hormones. It is not a true tumor and usually resolves when the pregnancy-related hormonal stimulus ends.

\medterm{Deciduosis} Pregnancy-related decidual tissue occurring in an unusually extensive area or outside the usual uterine lining. It may involve the cervix or pelvic surfaces and can resemble a tumor during examination or surgery.
...
\medterm{Decompensated Cirrhosis} Advanced liver scarring with complications such as abdominal fluid, internal bleeding, jaundice, or confusion from toxin buildup. It requires specialist care, prevention of further complications, and consideration of liver transplantation.
...
\medterm{Deep} Located further inward from the surface of the body. Located farther from the body's surface or farther inside a structure. For example, deep muscles lie beneath more superficial muscles.
...
\medterm{Defense Mechanisms (Forensic)} Physical findings, such as injuries to the hands or forearms, that may occur when a person tries to protect against an assault. They must be interpreted with the complete history and other evidence.
\synonyms
Forensic
...
\medterm{Deficiency, FAO} An inherited disorder in which cells cannot use fatty acids normally for energy. Fasting or illness may then cause low blood sugar, muscle breakdown, weakness, heart problems, or sudden metabolic illness.
...
\medterm{Deficiency, UDP-Glucuronosyltransferase} Reduced activity of a liver enzyme that makes bilirubin water-soluble for removal. Inherited deficiency can cause intermittent mild jaundice or, in severe forms, dangerous bilirubin buildup.
...
\medterm{Degenerative Disk Disease} Wear-related changes in the cushions between spinal bones. They may cause neck or back pain, stiffness, or nerve pressure, although similar changes can appear on scans in people without symptoms.
\synonyms
...
\medterm{Degranulation} Release of stored chemicals from immune cells, especially mast cells and platelets. The chemicals help defend against injury or infection but may also cause inflammation, allergy, or blood-clotting changes.
...
\medterm{Dehydration} Loss of more body water than is replaced, often from vomiting, diarrhea, fever, sweating, or poor fluid intake. It can cause thirst, dry mouth, reduced urination, dizziness, fast heartbeat, abnormal salts, or shock.
...
\medterm{Dehydroepiandrosterone} A hormone precursor made mainly by the adrenal glands and converted into other sex hormones. Levels change with age and illness; supplements may cause acne, hair changes, mood effects, or drug interactions.
...
\medterm{Deiodinase} An enzyme that removes iodine from thyroid hormones and changes their activity. These enzymes help tissues regulate metabolism, growth, brain development, and the body’s response to thyroid hormone.
...
\medterm{Delayed Hypersensitivity} An immune reaction that develops hours or days after exposure and is driven mainly by T cells rather than antibodies. Examples include allergic contact dermatitis, some medicine rashes, and the tuberculosis skin-test reaction.
...
\medterm{Delftia Acidovorans} An environmental bacterium that rarely causes bloodstream, wound, or other opportunistic infections. Risk is higher in people with weakened immunity, serious illness, or indwelling medical devices.
...
\medterm{Delphi Technique} A research method that uses several rounds of anonymous questionnaires and summarized feedback to develop expert agreement about a question or forecast.
...
\medterm{Delta-ALA Urine Test} A urine test measuring delta-aminolevulinic acid, a substance used to make heme. Increased levels may occur with acute porphyria or lead poisoning and are interpreted with symptoms and other tests.
...
\medterm{Deltaretrovirus} A group of retroviruses that includes human T-cell leukemia viruses. These viruses use RNA and reverse transcriptase to reproduce; some can cause persistent infection, blood-cell disorders, or cancer.
...
\medterm{Densitometry} Measurement of tissue density, most often bone mineral density. A bone-density scan helps diagnose osteoporosis, estimate fracture risk, and monitor response to treatment.
...
\medterm{Dental Articulator} A device that holds models of the upper and lower teeth and imitates jaw movements. Dentists use it to plan, make, and adjust crowns, bridges, dentures, and other restorations.
...
\medterm{Dentatorubral-Pallidoluysian Atrophy} A rare inherited brain disorder caused by an expanded CAG repeat in the \textit{ATN1} gene. Symptoms vary with age and may include seizures, poor coordination, involuntary movements, behavior changes, and progressive cognitive decline.
...
\medterm{Deoxycoformycin} An anticancer medicine that blocks adenosine deaminase, an enzyme needed by some cells to make DNA. It was used for selected blood cancers; bone-marrow suppression and infections are important risks.
...
\medterm{Deoxycytidine Kinase} An enzyme that adds a phosphate group to deoxycytidine and related molecules. This activates some nucleoside-analogue medicines used to treat cancer or viral infections.

\medterm{Deoxyglucose} A molecule resembling glucose that is used in research. When labeled with fluorine-18, it forms a PET imaging tracer that shows tissues using more glucose, such as many tumors or areas of inflammation.
...
\medterm{Deoxyribonuclease} An enzyme that breaks DNA into smaller pieces. Inhaled recombinant forms can thin mucus by breaking down DNA released from damaged cells, especially in cystic fibrosis.
...
\medterm{Deoxyuridine} A molecule made of the DNA sugar deoxyribose joined to uracil instead of the usual DNA base thymine. It can occur during DNA repair or abnormal nucleotide metabolism and is used in research.
...
\medterm{Dependovirus} A group of small DNA viruses that usually need another virus, such as an adenovirus or herpesvirus, to reproduce. They are generally not known to cause major disease in healthy people.
...
\medterm{Dephosphorylation} Removal of a phosphate group from a molecule. This chemical change can switch proteins on or off and alter how cells communicate, use energy, or control growth.
...
\medterm{DepilacióN} Removal of hair above or near the skin surface by shaving, cutting, waxing, or a chemical product. It differs from epilation, which removes the hair root as well.
...
\medterm{Depression} A mental health disorder involving persistent low mood or loss of interest, often with changes in sleep, appetite, energy, concentration, movement, or self-worth. It can impair daily life and may involve thoughts of death or suicide.
...
\medterm{Depression (Major Depressive Disorder)} A disorder with at least two weeks of depressed mood or loss of interest plus symptoms such as sleep, appetite, energy, concentration, movement, guilt, or suicidal thoughts that cause significant distress or impairment.
...
\medterm{Depressive Disorder} A mood disorder involving persistent low mood, loss of interest, or both, with possible changes in sleep, appetite, energy, concentration, movement, or self-worth. Duration, severity, impairment, and safety guide diagnosis and care.

\medterm{Depressive Illness} A condition causing persistent low mood, loss of interest, or both, along with emotional, thinking, physical, or behavioral symptoms that impair life. The cause, duration, severity, and safety risk determine care.
...
\medterm{Dermabacter} A group of bacteria commonly found on human skin and in the environment. They rarely cause opportunistic infection, usually in people with serious illness, weakened immunity, or implanted medical devices.

\medterm{Dermabacter Hominis} A bacterium normally associated with skin that rarely causes opportunistic infection, including wound or bloodstream infection. Its importance depends on the specimen, symptoms, immune status, and whether contamination is likely.
...
\medterm{Dermatan Sulfate} A complex sugar found in connective tissues, skin, blood vessels, and heart valves. It helps organize the tissue framework and can influence blood clotting and wound healing.
...
\medterm{Dermatome} Either a surgical tool that removes a thin layer of skin for grafting or a strip of skin supplied by one spinal nerve. The intended meaning is determined by whether the context is surgery or nerve anatomy.
...
\medterm{Deslorelin} A medicine that stimulates gonadotropin-releasing hormone receptors. Continuous exposure first raises and then suppresses reproductive hormones; it is used mainly in veterinary care to control reproductive function.
...
\medterm{Desmoplasia} Formation of dense scar-like fibrous tissue around a tumor, chronic inflammation, or injury. Around some cancers it can make the lesion feel firm and fixed, but its meaning is determined with the cells, location, and other findings.
...
\medterm{Desmoplastic Small Round Cell Tumors} Rare aggressive cancers that usually arise in the abdomen or pelvis of children, adolescents, or young adults. They often spread within the abdomen and require specialist cancer treatment.
...
\medterm{Desmosine} A chemical cross-link that helps give elastin its strength and flexibility. Desmosine released into body fluids can serve as a research marker of elastin breakdown.
...
\medterm{Desulfovibrio Desulfuricans} A sulfate-reducing bacterium found mainly in the environment and intestine. It rarely causes human disease; a positive sample must be interpreted with symptoms, the collection site, and the possibility of contamination.
\medterm{Desulfovibrio Piger} A sulfate-reducing bacterium associated with the human intestine. It rarely causes infection, and its significance depends on where it was found, the patient’s symptoms, and whether the sample was contaminated.

\medterm{Desulfovibrionaceae} A family of bacteria that can live without oxygen and use sulfate during metabolism. It includes Desulfovibrio species found in soil, water, and the human intestine; human infections are uncommon.
...
\medterm{Deterministic Effects} Tissue injury from radiation that generally occurs only above a threshold dose. Once the threshold is exceeded, greater exposure usually causes more severe injury, such as skin damage, cataracts, or tissue death.
...
\medterm{Detritic Synovitis} Inflammation of the joint lining caused by loose particles such as cartilage, bone, blood, crystals, or worn implant material. It can cause joint swelling, pain, stiffness, and reduced movement.
...
\medterm{Deubiquitinating Enzymes} Enzymes that remove ubiquitin, a regulatory protein tag, from other proteins. This can change protein breakdown, location, activity, cell signaling, DNA repair, and immune responses.
...
\medterm{Deuteranopia} An inherited red-green color-vision deficiency caused by absent green-sensitive cone pigment. People may have difficulty distinguishing some shades of green, red, brown, and orange.
...
\medterm{Deuterium Oxide} Water in which hydrogen atoms are replaced by the heavier isotope deuterium, also called heavy water. It is used in research; large amounts can interfere with cell division and body function.
...
\medterm{Developmental Coordination Disorder} A childhood disorder in which movement skills are substantially below expectations for age and interfere with dressing, writing, sports, school, or daily activities. The difficulty is not explained by another condition alone.
...
\medterm{Developmental Expressive Language Disorder} A childhood disorder in which a child has persistent difficulty expressing ideas using spoken language, words, sentences, or grammar. Hearing loss, intellectual disability, autism, or another medical cause must also be considered.
...
\medterm{Device Embolisation} Movement of a medical device or broken fragment through the bloodstream until it blocks a blood vessel. It can reduce blood flow and may require urgent imaging or removal.
...
\medterm{Dextroposition Of The Heart} Displacement of the heart toward the right side of the chest, usually because surrounding organs, the diaphragm, or lung disease pushes it there. Unlike dextrocardia, the heart itself is not necessarily formed in a reversed position.

\medterm{Dextropropoxyphene} An opioid pain medicine formerly used in some countries. It has limited benefit and can cause dangerous breathing depression, heart-rhythm disturbances, dependence, and fatal overdose, so it has been withdrawn or restricted in many places.
...
\medterm{Dextrothyroxine} A mirror-image form of thyroxine formerly studied to lower cholesterol. It can affect thyroid function and is not a routine modern treatment for high cholesterol.
...
\medterm{DHEA-Sulfate Test} A blood test measuring a hormone made mainly by the adrenal glands. It helps evaluate early or excessive sexual development, excess body hair, adrenal disorders, congenital adrenal hyperplasia, or an adrenal tumor; results depend on age and sex.

\medterm{Diabetes} A group of disorders in which blood glucose remains too high because the body makes too little insulin, cannot use insulin effectively, or both. Over time, high glucose can damage the eyes, kidneys, nerves, heart, and blood vessels.

\medterm{Diabetes (Diabetes Mellitus)} Alternate index label for Diabetes Mellitus.

\medterm{Diabetes - Foot Ulcers} Open sores on the foot associated with diabetes, often caused or worsened by loss of sensation, pressure, deformity, or poor circulation. Prompt wound and infection care helps prevent deep infection and amputation.
...
\medterm{Diabetes And Exercise} Physical activity can improve glucose control, fitness, and cardiovascular health. People using insulin or medicines that lower glucose may need monitoring and adjustments to food or treatment to prevent low glucose.
...
\medterm{Diabetes Eye Care} Eye care for people with diabetes, including regular dilated examinations, glucose and blood-pressure control, and timely treatment of retinopathy or macular swelling to help preserve vision.
...
\medterm{Diabetes Medications} Medicines lower blood glucose in different ways: some reduce liver glucose production, some increase insulin release, some increase glucose loss in urine, some improve hormone signals and reduce appetite, and insulin replaces deficient hormone.

\medterm{Diabetes Mellitus} A disorder in which blood glucose stays too high because the body makes too little insulin, cannot use insulin effectively, or both. Main forms include type 1, type 2, and diabetes during pregnancy.
...
\medterm{Diabetic Cardiomyopathies} Heart-muscle disease associated with diabetes that cannot be explained fully by blocked heart arteries or high blood pressure. It may impair relaxation or pumping and lead to heart failure.
...
\medterm{Diabetic Diet} An individualized eating pattern that considers carbohydrate amount and timing, fiber, overall nutrition, cultural foods, medicines, and health goals to support glucose control and reduce cardiovascular and kidney risk.
...
\medterm{Diabetic Home Care And Monitoring} Daily diabetes care may include checking glucose, taking medicines correctly, inspecting the feet, recognizing low or high glucose, recording results, and following eye, kidney, dental, and cardiovascular care. Sick-day and ketone plans may be needed.
...
\medterm{Diabrosis} An uncommon or obsolete term for breakdown or ulceration of tissue. Because usage varies between sources, its intended meaning must be determined from the clinical context.
...
\medterm{Diacylglycerol} A fat-like molecule made from cell-membrane lipids. It acts as an internal signal that can activate protein kinase C and influence cell growth, movement, secretion, and metabolism.
...
\medterm{Diagnostic Trial} A clinical study that evaluates how accurately a test detects, excludes, or predicts a disease or important health outcome. It may compare the test with an accepted reference method.
...
\medterm{Diakinesis} The final stage of the first phase of meiosis, when paired chromosomes become highly condensed and remain joined at crossover points before separating. It occurs during formation of eggs and sperm.
...
\medterm{Dialister Micraerophilus} A bacterium associated with the mouth and genital tract that grows best with little or no oxygen. It rarely causes disease alone; its significance depends on the specimen, symptoms, and other organisms present.
...
\medterm{Dialysis Adequacy} How well dialysis removes waste and controls fluid, salts, and acid levels while meeting the patient’s treatment goals. Blood tests, treatment records, symptoms, nutrition, and fluid status all help assess adequacy.
...
\medterm{Dianhydrogalactitol} An investigational anticancer compound that damages DNA and has been studied for selected brain tumors and blood cancers. Its effectiveness and safety depend on clinical-trial findings and dosing.
...
\medterm{Diapause} A period when development and activity slow greatly in some animals, allowing them to survive unfavorable conditions. The term is mainly used in biology and has limited direct clinical use.

\medterm{Diapedesis} Movement of blood cells, especially white blood cells, through intact vessel walls into nearby tissue. It allows immune cells to reach sites of infection or injury during inflammation.
...
\medterm{Diarrhea} Passing loose or watery stools more often than usual. Causes include infection, medicines, food intolerance, inflammation, malabsorption, or other illness; blood, fever, dehydration, severe pain, or persistence requires medical assessment.
...
\medterm{Diarrhoea} Passing loose or watery stools more often than usual. Short-term illness is often infectious, while persistent diarrhea may result from inflammation, malabsorption, medicines, altered bowel function, hormone disorders, or other disease.

\medterm{Diarthrosis} A freely movable joint, usually a synovial joint, in which the bones are separated by a fluid-filled joint space. Examples include the knee, hip, shoulder, and elbow.

\medterm{Diastase} An older term for enzymes that break down starch into smaller sugars. In modern medical use, the related enzyme activity is usually described as amylase.
...
\medterm{Diastole} The part of each heartbeat when the heart muscle relaxes and its chambers fill with blood.
...
\medterm{Diathesis} A tendency or susceptibility to develop a particular disease, symptom, or body response. For example, a bleeding diathesis means an increased tendency to bleed.

\medterm{Diatom Test} A forensic test looking for microscopic algae in organs or tissues after suspected drowning. It may support an investigation but is not conclusive by itself because diatoms can enter the body from other sources.
...
\medterm{Diaziquone} An experimental anticancer compound that damages DNA and was studied for selected tumors. It is not a routine treatment; effectiveness and safety depend on research evidence and clinical-trial use.
...
\medterm{Diazooxonorleucine} An experimental compound that blocks the use of glutamine, an amino acid needed for cell metabolism. It has been studied as an anticancer agent but is not routine clinical treatment.
...
\medterm{Dichloralphenazone} A sedative formerly included in some combination headache medicines. It can cause drowsiness, impaired coordination, dependence, and withdrawal, especially with repeated or excessive use.
...
\medterm{Dickeya Dadantii} A bacterium that causes soft rot and wilt in plants. It is not a usual human pathogen, and its presence in a clinical sample requires careful interpretation.
...
\medterm{Dicrotic} Relating to a second small wave or notch in an arterial pulse, usually produced when the aortic valve closes. It may be seen on an arterial pressure tracing.
...
\medterm{Dictation Machine} A device or software that records spoken information for later transcription. In healthcare it may be used for clinical notes, reports, referrals, or administrative documents.

\medterm{Dictyostelium} A group of soil-dwelling social amoebae used to study cell movement, development, and signaling. They are not usual human pathogens.

\medterm{Dicumarol} Another name for dicoumarol, an older vitamin K antagonist anticoagulant. It reduces production of several clotting factors and is rarely used in modern clinical practice.
...
\medterm{Didanosine} An older HIV medicine that blocks reverse transcriptase, an enzyme HIV needs to copy its genetic material. It can cause pancreatitis, nerve damage, diarrhea, and mitochondrial toxicity and is rarely used now.
...
\medterm{Diencephalon} A central part of the brain containing the thalamus, hypothalamus, and related structures. It helps process sensory information and regulate movement, hormones, temperature, appetite, sleep, and other automatic functions.

\medterm{Dienoestrol} A synthetic estrogen formerly used for selected hormone-related conditions. Its use is now limited because estrogen treatment can increase risks such as blood clots and hormone-sensitive cancers.

\medterm{Dientamoeba} A genus of microscopic intestinal organisms. Some species may be found in stool without causing illness; clinical significance depends on the species, symptoms, amount present, and other causes of digestive disease.

\medterm{Dientamoeba Fragilis} A microscopic intestinal parasite that may be found in people with diarrhea, abdominal pain, or bloating, although some people have no symptoms. Its role in illness is assessed with the clinical picture and other test results.
...
\medterm{Diet Therapy} Use of an individualized eating plan to prevent, manage, or treat disease. It may address diabetes, kidney disease, food allergy, malnutrition, digestive disorders, or other needs and should be guided by a qualified professional.
...
\medterm{Diethylnitrosamine} A chemical that can damage the liver and cause cancer in laboratory animals. It is mainly used in research and is not a therapeutic medicine.
...
\medterm{Diethylstilbestrol Dipropionate} An ester form of the synthetic estrogen diethylstilbestrol. It is obsolete in routine care; exposure carries the reproductive, developmental, and cancer risks associated with diethylstilbestrol.
...
\medterm{Difference Threshold} The smallest difference between two sounds, sights, touches, or other stimuli that a person can reliably notice. It varies with the type and strength of the stimulus and the person’s sensory function.
...
\medterm{Difficult Airway} A situation in which a trained clinician may have difficulty keeping a person oxygenated, placing an airway device, or inserting a breathing tube. It may result from anatomy, swelling, injury, illness, or limited movement and requires advance planning.
...
\medterm{Diffusion Anisotropy} Direction-dependent movement of water molecules through tissue, especially along nerve fibers in the brain. Diffusion MRI measures it to help assess white-matter structure and injury.
...
\medterm{Diffusion Restriction} Reduced movement of water molecules on diffusion-sensitive MRI. It may occur in acute stroke, abscess, densely packed tumors, seizures, or other conditions and must be interpreted with the scan and clinical findings.
...
\medterm{DiGeorge Syndrome (22Q11.2 Deletion Syndrome)} A genetic disorder caused by loss of part of chromosome 22. Possible effects include heart defects, reduced immunity, low calcium, palate problems, hearing loss, learning difficulties, and developmental differences.
...
\medterm{Digitonin} A plant-derived chemical used mainly in laboratory research. It binds cholesterol in cell membranes and makes them permeable, allowing scientists to study cell contents.
...
\medterm{Dimethylbenzanthracene} A laboratory chemical used to cause tumors in experimental animals and study cancer development. It is a research carcinogen, not a medicine, and requires strict handling and protective controls.
...
\medterm{Dimethylnitrosamine} A chemical that can severely injure the liver and cause tumors in laboratory animals. It is used in toxicology and cancer research and is not a therapeutic medicine.
...
\medterm{Dinaciclib} An investigational anticancer medicine that blocks enzymes controlling cell division. It has been studied for several cancers and may suppress bone marrow, cause infections, or produce other treatment-related toxicity.

\medterm{Dinitrochlorobenzene} A chemical that stimulates skin sensitivity and is used mainly in research. It can cause severe irritation, blistering, or allergic dermatitis and requires appropriate protective handling.

\medterm{Dinitrofluorobenzene} A reactive chemical used to label proteins in laboratory research. It can irritate or burn the skin, eyes, and airways and is toxic with significant exposure.
...
\medterm{Dinutuximab} An antibody-based cancer medicine that targets GD2, a molecule found on many neuroblastoma cells. It helps the immune system attack the cancer but can cause severe nerve pain, allergic reactions, fever, and capillary-leak problems.
...
\medterm{Diodone} An older iodine-containing contrast substance formerly used for X-ray imaging. It has largely been replaced by newer agents and could cause allergic-like reactions, kidney injury, or thyroid effects.

\medterm{Dioecious} Describing a species in which male and female reproductive organs occur in separate individuals. The term is used mainly in botany and biology and has little direct clinical use.

\medterm{Dionin} An older name for ethylmorphine, an opioid formerly used for cough or pain. It can cause drowsiness, constipation, dependence, and dangerous breathing depression, especially in overdose.
...
\medterm{Dioscorides} A first-century Greek physician and pharmacologist whose work described medicinal plants and substances. His writings influenced the study and practice of medicines for many centuries.

\medterm{Dioxin} A group of persistent environmental chemicals produced by some industrial processes and burning. Long-term exposure can affect the immune, reproductive, developmental, and hormone systems and may increase cancer risk.
...
\medterm{Dipeptidyl Peptidase-4 Inhibitors} Oral diabetes medicines that prolong the action of hormones which increase insulin release after meals and reduce glucagon. They usually have little effect on weight and a low risk of low glucose when used alone.

\medterm{Dipetalonema} A group of thread-like parasitic worms that mainly infect animals and are transmitted by arthropods. Human infection is rare and its significance depends on the species, exposure, and symptoms.
...
\medterm{Dipper} A person whose blood pressure normally falls during sleep, usually by at least about 10\% compared with daytime pressure. The pattern is assessed with ambulatory monitoring and may have cardiovascular significance.
...
\medterm{Dipsomania} An outdated term for episodes of uncontrollable alcohol drinking. Modern assessment describes alcohol use disorder by the pattern of drinking, loss of control, health effects, and impact on daily life.
...
\medterm{Diptheroid Bacillus} A rod-shaped bacterium resembling Corynebacterium under the microscope. Many are normal skin bacteria or contaminants, but some can cause opportunistic infection in people with serious illness or devices.
...
\medterm{Dirty Necrosis} Death of tumor tissue containing abundant broken cell material and white blood cells. It is often seen in some rapidly growing cancers and is interpreted by a pathologist with the rest of the biopsy.
...
\medterm{Discolysis} Chemical breakdown of the inner material of a herniated spinal disc, historically performed with an injected enzyme. It is rarely used now because of limited benefit and possible serious complications.
...
\medterm{Discriminant Analysis} A statistical method that uses measured features to classify people or observations into groups. It can be used in medical research, prediction, and diagnostic modeling.

\medterm{Discrimination Learning} Learning to respond differently to two or more signals because they have different meanings or consequences. It is studied in psychology, education, behavior treatment, and animal learning.
...
\medterm{Disease Nomenclature} The system of names and classification terms used to identify, describe, and organize diseases and related clinical conditions. Consistent names support communication, records, research, and coding.
...
\medterm{Disinfestation} Removal or control of parasites living on the body or in clothing or surroundings, such as lice, fleas, mites, or bedbugs. Treatment may require cleaning belongings and treating close contacts or animals.
...
\medterm{Dissection} Separation of tissue layers, either deliberately during surgery or because of disease. In a blood vessel, a tear in the inner layer can allow blood between the wall layers and form a false channel.
...
\medterm{Dissociative Amnesia} Inability to recall important personal information, often related to trauma or severe stress, beyond ordinary forgetfulness. Memory loss may involve a specific event, period, or broader part of a person’s life.

\medterm{Dissociative Disorder} A mental health disorder involving disruption of normally integrated consciousness, memory, identity, perception, emotions, or behavior. Examples include dissociative amnesia, dissociative identity disorder, and depersonalization-derealization disorder.

\medterm{Dissociative Disorders} Mental health disorders involving disruption in the usual integration of identity, memory, consciousness, emotion, perception, or behavior. Symptoms can cause distress or interfere with relationships, work, learning, or self-care.

\medterm{Dissociative Identity Disorder} A disorder involving two or more distinct identity states or experiences of possession, with gaps in memory and marked changes in sense of self, behavior, emotions, perception, or functioning.
...
\medterm{Distal Renal Tubular Acidosis} A kidney disorder in which the urine cannot be made acidic enough. Acid builds up in the blood and may cause low potassium, kidney stones, bone problems, weakness, or growth problems in children.
...
\medterm{Distal Tubule} A segment of the kidney’s filtering unit that adjusts salt, calcium, and water in the forming urine. It helps regulate blood pressure and body chemistry and is affected by thiazide diuretic medicines.
...
\medterm{Distemper} A serious viral disease mainly affecting animals, especially dogs, and caused by canine distemper virus. It can affect the breathing, digestive, and nervous systems and is not the same as human diphtheria.
...
\medterm{Distraction Osteogenesis} A surgical method of making new bone by slowly separating two bone segments after a controlled cut. A device gradually widens the gap to lengthen or reshape the jaw, limbs, or other bones.
...
\medterm{Distribution} The pattern and body sites affected by a disease, lesion, rash, pain, or other finding. Localized, widespread, symmetrical, flexural, extensor, or nerve-related distribution can help guide diagnosis.
...
\medterm{Diterpenes} A group of natural compounds built from four five-carbon units. They occur in plants, fungi, and some animals and may have varied biological, medicinal, or toxic effects depending on the compound.
...
\medterm{Diutina Rugosa} A yeast that rarely causes opportunistic infection, usually in people with serious illness, weakened immunity, or medical devices. Its clinical importance depends on the specimen and compatible symptoms.

\medterm{Diverticula (Diverticulosis)} Alternate index label; see \textit{Diverticulosis}.

\medterm{Diverticular Disease} A condition in which small pouches in the colon cause symptoms or complications such as pain, bleeding, inflammation, infection, blockage, or perforation.

\medterm{Diverticulitis} Inflammation or infection of one or more small pouches in the colon. It commonly causes lower abdominal pain, fever, and bowel changes and may lead to an abscess, perforation, or blockage.
...
\medterm{Divorce} Legal dissolution of a marriage. It is not a medical condition, but related stress, financial changes, housing, caregiving, social support, and access to healthcare can affect health.
...
\medterm{Dizziness: Causes, Symptoms, And Treatment} Dizziness may feel like spinning, faintness, imbalance, or floating. Causes include inner-ear disease, dehydration, medicines, anemia, heart-rhythm problems, migraine, anxiety, or neurologic disease; treatment depends on the pattern and examination.
...
\medterm{DMFT Index} A dental public-health measure counting permanent teeth that are decayed, missing because of decay, or filled. It estimates a person’s lifetime experience of tooth decay but does not show whether lesions are currently active.
...
\medterm{DNA Fingerprinting} Analysis of variable parts of DNA to distinguish individuals or assess biological relationships. It is used in forensic identification, parentage testing, and research, with results interpreted statistically.

\medterm{DNA Footprinting} A laboratory method that identifies the part of DNA protected when a protein binds to it. The result helps show where regulatory proteins attach and how they may control gene activity.
...
\medterm{Do You Have A Drinking Problem?} A screening question that opens discussion about alcohol amount, control, cravings, consequences, and withdrawal. An affirmative concern can prompt confidential assessment and support; it is not a diagnosis by itself.
...
\medterm{Doctor-Patient Relationship} The professional partnership between a clinician and patient, based on communication, trust, consent, confidentiality, shared decisions, and professional boundaries. A good relationship supports understanding, safety, and participation in care.

\medterm{Doctors' Symbol} The Rod of Asclepius, showing one snake around a staff, is a traditional symbol of medicine. It is often confused with the caduceus, which has two snakes and wings.
...
\medterm{Dodecenoic Acid} An unsaturated fatty acid containing 12 carbon atoms. Its biological properties depend on the position and shape of its double bond; it is found mainly in chemical and metabolic research.
...
\medterm{Dol} A historical unit intended to measure subjective pain intensity. Modern clinical practice uses validated verbal, numerical, visual, or behavioral pain scales instead.
...
\medterm{Dolosigranulum Pigrum} A bacterium commonly found in the upper airways and usually harmless. It rarely causes infection; its significance depends on the specimen, symptoms, immune status, and other organisms present.
...
\medterm{Dorsolateral} Describing a location toward the back and side of a body structure or region.
...
\medterm{Dotage} An outdated, imprecise term for mental or physical decline in old age. It is not a diagnosis; current evaluation identifies specific causes such as dementia, delirium, depression, medicines, or other treatable conditions.
...
\medterm{Dracunculiasis} Guinea-worm disease caused by a parasite acquired by drinking unsafe water containing infected water fleas. About a year later, a painful blister forms, usually on a leg, and the adult worm emerges through the skin.
...
\medterm{Dried Specimen} A biological sample collected and dried on a prepared surface for transport or laboratory testing. Dried blood spots are commonly used for screening, but the test must specify the correct sample type and collection method.
...
\medterm{Drinking Water Safely During Cancer Treatment} During cancer treatment, use water from a safe, regulated source because weakened immunity can make infections more dangerous. Follow the cancer team’s advice if local water may contain germs or chemicals.
...
\medterm{Drops} Liquid medicines given in measured drops, commonly into the eyes, ears, nose, or mouth. The correct product, concentration, route, dose, sterility, and measuring device are important for safe use.

\medterm{Dropsy} An obsolete term for edema, or abnormal fluid accumulation in body tissues or cavities. Modern medical writing uses terms such as edema or generalized edema because they describe the finding more precisely.
\medterm{Drosophila Proteins} Proteins made by fruit flies and studied in laboratory research to understand development, cell signaling, genetics, immunity, and mechanisms that may resemble human disease.

\medterm{Drosophilidae} The insect family that includes fruit flies and vinegar flies. These insects are widely used in genetics research and are not typical human parasites or a usual cause of human infection.
...
\medterm{Drowning (Dry/Wet Signs)} Breathing impairment caused by submersion or immersion in liquid. Terms such as “dry” and “wet” drowning are outdated because visible water in the lungs does not reliably determine severity, treatment, or cause of death.
...
\medterm{Dry Eye Disease} A long-term disorder of the eye surface caused by unstable or insufficient tears and inflammation. It can cause discomfort, fluctuating vision, redness, and surface damage; causes include aging, medicines, eyelid disease, and autoimmune illness.

\synonyms
keratoconjunctivitis sicca, is a multifactorial disorder.

\medterm{Dry Eye Syndrome} Persistent dryness or irritation caused by too few tears, rapid tear evaporation, or both. Common contributors include eyelid or oil-gland problems, aging, contact lenses, environmental exposure, medicines, and autoimmune disease.

\medterm{Dry Eyes} Burning, stinging, grittiness, tiredness, watering, or blurred vision caused by insufficient or rapidly evaporating tears. Aging, medicines, screen use, contact lenses, eyelid disease, inflammation, and some illnesses can contribute.
...
\medterm{Dry Socket (Alveolar Osteitis)} A painful complication of tooth removal caused by early loss or breakdown of the blood clot protecting the socket. Exposed bone can cause severe pain, bad taste, or bad breath several days after extraction.

\synonyms
Alveolar Osteitis

\medterm{Dry Socket Overview} A painful complication of tooth extraction in which the protective clot is lost before the socket heals. Pain often worsens after several days and may spread to the ear; a dentist can clean and protect the socket.
...
\medterm{Duboisin} An older anticholinergic substance related to scopolamine that was formerly used in some eye or neurologic treatments. It can cause dry mouth, blurred vision, fast heartbeat, confusion, urinary retention, and other anticholinergic effects.
...
\medterm{Duck Syndrome} An informal term for appearing successful while privately experiencing severe stress, anxiety, exhaustion, or depression. It is not a formal diagnosis; persistent distress, impaired daily function, or thoughts of self-harm require professional support.
...
\medterm{Duocarmycins} A group of experimental anticancer compounds that can damage DNA after becoming activated inside cells. Their potential uses, dosing, and safety depend on the specific compound and remain matters of specialist research.
...
\medterm{Dysarthria} Slurred, weak, slow, or poorly coordinated speech caused by a problem in the brain, nerves, or muscles used for speaking. Sudden dysarthria can be a sign of stroke and requires emergency assessment.
...
\medterm{Dyspareunia} Recurrent or persistent pain during or after sexual activity. Pain may be at the vaginal opening or deeper in the pelvis and can result from dryness, infection, skin disease, pelvic-floor muscle spasm, endometriosis, inflammation, injury, or emotional factors.
...
\medterm{Dysphasia} Difficulty using or understanding language because of damage or dysfunction in language areas of the brain. It may affect speaking, understanding, reading, or writing and is often used to mean aphasia.
...
\medterm{Dyspnea} The feeling of difficult, uncomfortable, or insufficient breathing. Causes include asthma, lung or heart disease, anemia, infection, muscle weakness, anxiety, and other conditions; sudden or severe dyspnea is an emergency.
...
\medterm{Dysraphism} A birth defect caused by incomplete closure or joining of developing body structures, especially the neural tube or spinal bones. Effects range from minor skin findings to weakness, loss of sensation, or bladder and bowel problems.
...
\medterm{Dysthymia} The former name for persistent depressive disorder, a long-lasting depressed mood with related symptoms. Symptoms may be less intense than major depression but can substantially affect relationships, work, school, and daily life.

\medterm{Dysthymia (Persistent Depressive Disorder)} A depressive disorder in which low mood occurs most of the day, more days than not, for at least two years in adults or one year in children. Low energy, poor sleep, appetite changes, low self-esteem, poor concentration, or hopelessness may occur.
...
\medterm{Dystociais} A misspelling of dystocia. The correct term describes difficult or unusually slow labor caused by problems with contractions, the baby, the birth passage, or the mother’s tissues.

\medterm{Dystonia} A movement disorder in which involuntary muscle contractions cause twisting movements or abnormal, sometimes painful postures. It may affect one body part or many and can result from inherited disease, brain injury, or medicines.
...
\medterm{Dancing} Rhythmic movement performed for enjoyment, exercise, expression, or therapy. It can improve balance, strength, coordination, mood, and social activity, but the risk of falls or other injuries depends on intensity, technique, and health.
...
\medterm{Deep Learning} A computer method that uses layered mathematical networks to find patterns in large datasets. In medicine it may help analyze images or predict outcomes, but it requires testing, privacy protection, and clinical oversight.
...
\medterm{Dieting} Deliberately changing food intake to affect weight, health, symptoms, or performance. A safe plan provides adequate nutrition and can be maintained; extreme restriction may cause deficiencies, loss of muscle, disordered eating, or other complications.
...
\medterm{Dry Drowning} An outdated, nonmedical term sometimes used after a water incident. Drowning means breathing impairment from submersion or immersion; persistent cough, breathing difficulty, confusion, or unusual sleepiness afterward requires urgent assessment.
