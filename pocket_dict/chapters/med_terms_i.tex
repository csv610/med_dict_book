...
\medterm{Immunodeficiency Diseases} Alternate index label for Immunodeficiency.

\medterm{Immunodeficiency Disorders} Alternate index label for Immunodeficiency.
...
\medterm{Inborn Errors Of Metabolism} Alternate index label for Inborn Error Of Metabolism.
...
\medterm{Inclusion-Cell (I-Cell) Disease} A rare inherited disorder in which cells cannot deliver certain digestive enzymes to their waste-processing compartments. Waste then accumulates in cells, causing severe developmental delay, bone abnormalities, unusual facial features, and progressive disease in several organs.
...
\medterm{Incontinence (Urinary)} Involuntary leakage of urine. It may occur with coughing or exercise, a sudden urge, an overfull bladder, difficulty reaching the toilet, or more than one cause; evaluation considers symptoms, medicines, infection, and bladder emptying.
\synonyms
...
\medterm{Infection (Geriatric)} Infection in an older adult may cause confusion, weakness, reduced appetite, or a fall without causing fever. Common sites include the urine, lungs, skin, and bloodstream; prompt assessment is important because illness can worsen quickly.
...
\medterm{Inflammation (Dietary)} Inflammatory activity that may be influenced by long-term eating patterns, excess body fat, and overall health. Diets rich in vegetables, legumes, whole grains, and unsaturated fats generally support lower inflammation than diets high in heavily processed foods.
...
\medterm{Influenza (Flu)} Alternate index label; see \textit{Influenza}.
...
\medterm{Informed Consent (Geriatric)} The process of ensuring that an older patient understands a proposed intervention, its benefits, risks, and alternatives before choosing freely. If decision-making ability is impaired, an authorized decision-maker may help according to local law.
...
\medterm{Injury Classification (Abrasion, Laceration, Contusion, Incised Wounds)} A description of common injury types: an abrasion is a scrape, a laceration is a torn cut, a contusion is a bruise from blunt force, and an incised wound is a clean cut from a sharp object.
...
\medterm{Insomnia} Alternate index label; see \textit{Insomnia Disorder}.
...
\medterm{Insulin And Syringes - Storage And Safety} Insulin should be stored according to its product instructions and protected from extreme heat, freezing, and contamination. Use the correct syringe or device, never share needles, and place used needles in a proper sharps container.
...
\medterm{Interstitial (Cornual) Pregnancy} An ectopic pregnancy that implants in the part of the fallopian tube passing through the muscular wall of the uterus. It may grow silently before rupturing and causing life-threatening internal bleeding.
...
\medterm{Intestinal Gas (Belching, Bloating, Flatulence)} Alternate index label; see \textit{Intestinal Gas}.
...
\medterm{Intraductal Papillary Mucinous Neoplasm Pancreas (Pancreatic Cysts)} Alternate index label; see \textit{Pancreatic Cysts}.

\medterm{Intraductal Papilloma} A usually noncancerous growth inside a breast milk duct. It may cause spontaneous clear or bloody discharge from one nipple or be found on imaging without symptoms; examination and tissue testing guide management.
...
\medterm{Intussusception} A segment of intestine slides inside the next segment like a telescope, causing blockage and possibly cutting off the bowel’s blood supply. It commonly affects infants and young children and requires urgent assessment for intermittent pain, vomiting, or bloody stool.
...
\medterm{Isolation (Social)} Having little contact or meaningful interaction with other people. It may follow bereavement, illness, disability, relocation, or limited transport and can increase the risk of depression, cognitive decline, and poorer overall health.
