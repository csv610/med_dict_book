...
\medterm{Impedance Plethysmography} A test that measures changes in a limb’s electrical resistance as its blood volume changes. It has been used to assess venous blood flow, but ultrasound is generally preferred when a blood clot is suspected.
...
\medterm{Ischemic Stroke} Sudden brain injury caused by a blocked blood vessel that reduces oxygen to part of the brain. It may cause one-sided weakness, facial drooping, speech or vision problems, and requires emergency treatment.
