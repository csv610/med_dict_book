...
\medterm{Idiopathic Pulmonary Fibrosis} Alternate index label for IPF.

\medterm{Idiopathic Thrombocytopenic Purpura} Alternate index label; see \textit{Immune thrombocytopenia}.

\medterm{Idiopathic Thrombocytopenic Purpura} Alternate index label for ITP.

\medterm{Idiopathic Thrombocytopenic Purpura} Alternate index label for Idiopathic Thrombocytopenic Purpura.
...
\medterm{Iliotibial Band Syndrome} Alternate index label for Iliotibial Band Syndrome.
...
\medterm{Immune Thrombocytopenic Purpura} Immune thrombocytopenic purpura is immune-mediated platelet destruction causing isolated thrombocytopenia with bruising, petechiae, mucosal bleeding, or no symptoms.
...
\medterm{Immunodeficiency Disorders} Disorders caused by impaired development or function of the immune system, leading to increased susceptibility to infections and sometimes autoimmunity or malignancy. See \textit{Immunodeficiency Diseases}.
...
\medterm{Immunology} Antigen-presenting cell, an immune cell that processes antigens and displays peptide fragments on major histocompatibility complex molecules to activate T cells.
...
\medterm{India Immunization Schedule} The Universal Immunization Schedule of the Government of India, providing free
...
\medterm{Inflammatory Bowel Disease: Intestinal Problems} Alternate index label for Inflammatory Bowel Disease: Intestinal Problems.
...
\medterm{Insulin Resistance} Alternate index label for Insulin Resistance.
...
\medterm{INTERMACS Profile} A standardized, internationally recognized 7-tier clinical staging classification established by the Interagency Registry for Mechanically Assisted Circulatory Support to stratify the severity of illness and hemodynamic compromise in patients with advanced, end-stage (Stage D) heart failure. Classifies patients from Profile 1 (``crash and burn'': critical cardiogenic shock with persistent severe hypoperfusion despite escalating inotropic support) through Profile 2 (progressive decline on inotropes), Profile 3 (inotrope-dependent stability), Profile 4 (recurrent frequent hospitalizations), Profile 5 (housebound/exertion intolerant), Profile 6 (exertion limited), to Profile 7 (advanced NYHA Class III), guiding clinical urgency, patient selection, and timing for mechanical circulatory support implantation or emergency heart transplantation.
...
\medterm{International Unit} A standardized internationally accepted unit of measurement for quantifying the biological activity, potency, or pharmacological effect of a substance (such as fat-soluble vitamins, insulin, heparin, and vaccines), established by the World Health Organization. Unlike metric mass units (milligrams or micrograms), the exact mass equivalent of one IU varies depending on the specific biological substance and reference preparation.
...
\medterm{Interstitial Cystitis} A chronic bladder pain syndrome with urinary urgency, frequency, or pain without an identifiable infection or other cause sufficient to explain the symptoms.
...
\medterm{Intracranial} Situated or occurring within the bony cranium (skull cavity). The rigid, non-distensible cranial vault contains three physiological volume components: brain parenchyma ($\approx 80\%$), cerebrospinal fluid (CSF; $\approx 10\%$), and intracranial blood ($\approx 10\%$). Governed by the Monro-Kellie doctrine, an increase in any one intracranial volume component (e.g., from cerebral edema, intracranial hemorrhage, or brain tumor) must be compensated by a reciprocal reduction in CSF or venous blood; when compensatory capacity is exhausted, intracranial pressure rises steeply ($>20~\text{mmHg}$), risking cerebral hypoperfusion, ischemic brain injury, and fatal brain herniation syndromes.
...
\medterm{Intraocular Pressure} The pressure of fluid within the eye, usually measured to assess risk for or management of glaucoma and other eye disorders.
...
\medterm{Intraoperative Neuromonitoring} Intraoperative neuromonitoring uses electrophysiological techniques to monitor
...
\medterm{Intrauterine Contraceptive Device} An intrauterine contraceptive device is a small device placed in the uterus to prevent pregnancy; copper and hormone-releasing types are available.
...
\medterm{Intrauterine Device} IUD: a long-acting reversible contraceptive device placed in the uterus. Types:
...
\medterm{Irritable Bowel Syndrome} Alternate index label for IBS.

\medterm{Irritable Bowel Syndrome} Alternate index label for Irritable Bowel Syndrome.
