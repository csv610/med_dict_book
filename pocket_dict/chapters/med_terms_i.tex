...
\medterm{Implantable Cardioverter Defibrillator (ICD)}-- An implanted device that detects dangerous ventricular rhythms and treats them with antitachycardia pacing or an electrical shock.
...
\medterm{Intermittent Auscultation (IA)}-- Periodic assessment of the fetal heart rate with a fetoscope or Doppler device
...
\medterm{Intimate Partner Violence (IPV) in Pregnancy}-- Physical, sexual, or psychological abuse by a current or former
...
\medterm{Intrahepatic Cholestasis of Pregnancy (ICP)}-- A pregnancy-associated liver disorder characterized mainly by
...
\medterm{Intrauterine Fetal Demise (IUFD) / Stillbirth}-- Death of a fetus before complete delivery. The gestational-age
...
\medterm{Intracranial Pressure}-- The pressure created by brain tissue, blood, and cerebrospinal fluid within the skull.
