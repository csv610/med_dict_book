...
\medterm{Immunoradiometric Assay} An immunoradiometric assay uses radiolabelled antibodies to measure a specific substance in a sample.
...
\medterm{Incisors} Incisors are the flat front teeth used mainly for biting and cutting food.
...
\medterm{Infrared Spectrometry} Infrared spectrometry identifies or measures substances by how they absorb infrared light.
...
\medterm{Intercellular} Intercellular means located between cells or occurring in the space between cells.
...
\medterm{Intestine, Diseases Of} Diseases of the intestine include infections, inflammatory disorders, malabsorption, obstruction, polyps, and cancer.
...
\medterm{Intratesticular} Intratesticular means located within a testicle.
...
\medterm{Intrauterine Contraceptive Device (IUCD)} An intrauterine contraceptive device is a small device placed in the uterus to prevent pregnancy; copper and hormone-releasing types are available.
...
\medterm{Ivermectin} Ivermectin is an antiparasitic medicine used for infections such as strongyloidiasis, onchocerciasis, and scabies.
