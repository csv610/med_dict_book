...
\medterm{Idea} A thought, belief, or mental representation; in clinical writing, its significance depends on whether it is ordinary, intrusive, fixed, or associated with impaired reality testing.
...
\medterm{Ideopathic} A misspelling of idiopathic, meaning that no specific cause has been identified.
...
\medterm{Idiot} An obsolete and stigmatizing historical term formerly used for severe intellectual disability; it should not be used in current clinical language.
...
\medterm{Ileostomy And Your Child} Care for a child with an ileostomy includes protecting the skin, measuring output, maintaining hydration, and watching for blockage, leakage, dehydration, or infection.
...
\medterm{Immaturity} Incomplete physical, neurologic, emotional, or developmental maturity relative to the expected stage of life.
...
\medterm{Immunologic Adjuvant} A substance added to an antigen or vaccine to strengthen or shape the immune response.

\medterm{Immunologic Factor} A substance, cell, gene, or process that contributes to immune-system function or regulation.
...
\medterm{Immunologic Surveillance} The immune system’s recognition and removal of abnormal, infected, or damaged cells.
...
\medterm{Immunotherapy: Questions To Ask Your Doctor} Questions about immunotherapy may cover its purpose, expected benefit, schedule, side effects, warning symptoms, monitoring, interactions, and alternative treatments.
...
\medterm{Increment} An increase or stepwise change in an amount, measurement, dose, or treatment intensity.
...
\medterm{Indole} A nitrogen-containing chemical ring found in tryptophan and many biologically active compounds.
...
\medterm{Inducing Labor} The process of starting labor artificially with medicines, membrane rupture, or other obstetric methods.
...
\medterm{Infant Incubators} Enclosed devices that provide controlled warmth, humidity, and monitoring for premature or ill newborns.
...
\medterm{Injury Site} The body location where an injury occurred or where its effects are being evaluated.
...
\medterm{Insane} An obsolete and stigmatizing term that does not describe a specific modern psychiatric diagnosis; current language should name the symptoms or diagnosis.

\medterm{Insanity} A historical legal term whose meaning varies by jurisdiction; it is not a current medical diagnosis.
...
\medterm{Insidious} Developing gradually and subtly, often without obvious early symptoms.
...
\medterm{Instinct} An innate or largely automatic pattern of behavior or response, though human behavior is also shaped by learning and context.


\medterm{Instrument} A tool or device used for examination, measurement, diagnosis, surgery, treatment, or laboratory work.
...
\medterm{Insulinase} An enzyme that breaks down insulin, helping regulate how long insulin remains active.
...
\medterm{Intrapericardial} Located within the pericardial sac surrounding the heart.
...
\medterm{Intrapulmonary} Located within the lung or occurring inside the pulmonary tissue or blood vessels.
...
\medterm{Intrauterine Devices (IUD)} Small devices placed in the uterus to prevent pregnancy; copper and hormonal IUDs are highly effective long-acting reversible contraceptives.
...
\medterm{Intravenous} Administered into a vein, allowing a medicine or fluid to enter the bloodstream directly.
...
\medterm{Invertase} An enzyme that breaks sucrose into glucose and fructose.
...
\medterm{Invertebrate} An animal without a vertebral column, including insects, worms, mollusks, and many other groups.

\medterm{Invertebrate Hormones} Chemical signals that regulate growth, development, reproduction, molting, or metabolism in invertebrate animals.
...
\medterm{Inveterate} Long-standing or deeply established, often referring to a persistent habit, condition, or behavior.
...
\medterm{Iohexol} A nonionic, water-soluble iodinated contrast medium used for CT, angiography, and other imaging studies.
...
\medterm{Iopamidol} A nonionic iodinated contrast medium used in CT, angiography, and other radiologic examinations.
...
\medterm{Irinotecan Hydrochloride} The hydrochloride salt form of irinotecan, a topoisomerase I inhibitor used in cancer treatment.
...
\medterm{Irregular} Not following a regular pattern, rhythm, shape, timing, or expected sequence.
...
\medterm{Isoelectric Point} The pH at which a molecule, especially a protein, has no net electrical charge.
...
\medterm{Isoetharine} A bronchodilator related to beta-adrenergic agonists that was formerly used to relieve airway narrowing.

\medterm{Isofenphos} An organophosphate insecticide that can cause cholinergic poisoning by inhibiting acetylcholinesterase.
...
\medterm{Isoleucine} An essential branched-chain amino acid needed for protein synthesis, energy metabolism, and tissue repair.
...
\medterm{Isothiocyanates} A group of reactive plant compounds formed from glucosinolates, especially in cruciferous vegetables.
