...
\medterm{Anal Itching} Itching around the anus, commonly caused by irritant dermatitis, hemorrhoids, pinworms, infection, inflammatory skin disease, or hygiene-related irritation. Persistent, severe, bleeding, painful, or unexplained symptoms require examination.

\medterm{Avian Influenza} Alternate name; see \textit{Bird Flu}.

\medterm{Bowel Incontinence} Alternate name; see \textit{Fecal Incontinence}.
...
\medterm{Dental Implant} A biocompatible fixture placed in the jawbone to support a dental prosthesis. It may be used for one missing tooth or to support a partial or complete denture; complications include infection, bone loss, and mechanical failure.

\synonyms
Endosseous Implant; Fixture; Tooth Implant

\medterm{Dietary Inflammation} Inflammatory activity that may be influenced by long-term eating patterns, excess body fat, and overall health. Diets rich in vegetables, legumes, whole grains, and unsaturated fats generally support lower inflammation than diets high in heavily processed foods.

\synonyms
Diet-Induced Inflammation; Diet-Associated Systemic Inflammation
...
\medterm{Fecal Incontinence} Inability to control bowel movements, causing accidental leakage of stool or mucus. It may result from diarrhea, constipation, weakened anal muscles, nerve disease, childbirth injury, or medicines. Assessment looks for the cause; treatment may include bowel regulation, exercises, retraining, medicines, or surgery.

\synonyms
Encopresis; Accidental Bowel Leakage

\medterm{Flatus and Bloating} Alternate name; see \textit{Intestinal Gas}.

\medterm{Flu} Alternate name; see \textit{Influenza}.

\medterm{Geriatric Infection} Infection in an older adult may cause confusion, weakness, reduced appetite, or a fall without causing fever. Common sites include the urine, lungs, skin, and bloodstream; prompt assessment is important because illness can worsen quickly.
...
\medterm{H1N1 Influenza} Alternate name; see \textit{Swine Flu}.

\medterm{Hospital-Acquired Infection} An infection acquired during or as a result of healthcare that was not present or incubating at the time of admission; it may be caused by bacteria, viruses, fungi, or other organisms.

\medterm{HPV Infection} Alternate name; see \textit{Human Papillomavirus}.
...
\medterm{Immunomodulators In Dermatology} Medicines that adjust local immune activity to treat conditions such as eczema and other inflammatory skin diseases. Topical calcineurin inhibitors are steroid-sparing options; they may cause burning or irritation and should be used as prescribed.
...
\medterm{Immunosuppression In Transplant} Treatment that reduces immune activity to prevent rejection of a transplanted organ. It requires ongoing monitoring because it can increase infection and cancer risk, affect kidney or liver function, and cause other medicine-related complications.
...
\medterm{Incomplete Abortion} A pregnancy loss in which some pregnancy tissue remains in the uterus. It may cause vaginal bleeding, cramping, and an open cervix and requires clinical assessment and appropriate treatment.
...
\medterm{Infant Botulism} A serious illness in which Clostridium botulinum bacteria grow in an infant’s intestine and make a toxin. Constipation, poor feeding, weak crying, drooping eyelids, limpness, and breathing weakness can develop and require emergency care.
...
\medterm{Infantile Spasm} A brief seizure in an infant, often involving sudden bending or stiffening of the body and occurring in clusters. It may affect development and requires urgent neurologic diagnosis and treatment.
...
\medterm{Inferior Hemifield Loss} Loss of vision in the lower half of the area a person can see with one or both eyes. Causes include retinal disease, a stroke, or another problem along the brain’s visual pathways; sudden loss is an emergency.
...
\medterm{Inguinal Hernia} A bulge formed when fat or intestine pushes through a weak area in the groin. It may cause discomfort or a lump that appears with standing or straining; severe pain, vomiting, or a trapped lump requires urgent care.
...
\medterm{Inhalation Injury} Damage to the airway or lungs from smoke, hot gases, or toxic chemicals. Swelling, cough, wheezing, low oxygen, and poisoning by carbon monoxide or cyanide may develop or worsen over several hours after a fire and require urgent assessment.
...
\medterm{Insulin Tolerance Test} A gold-standard diagnostic endocrine provocation test in which intravenous regular insulin is administered to induce symptomatic hypoglycemia (glucose below 40 mg/dL), used to assess the functional reserve and integrity of the hypothalamic-pituitary-adrenal axis and growth hormone secretion.
\synonyms
...
\medterm{Internal Hernia} A loop of intestine slips through an opening inside the abdominal cavity, often after abdominal surgery. It can cause intermittent or sudden bowel obstruction with abdominal pain, vomiting, and bloating and may require urgent surgery.
...
\medterm{Intraabdominal Hemorrhage} Bleeding inside the abdominal cavity, often after trauma, surgery, rupture of an organ or blood vessel, pregnancy complications, or internal disease. It may cause pain, swelling, dizziness, or shock and needs urgent assessment.
...
\medterm{Intra-Abdominal Hypertension} Abnormally high pressure inside the abdomen, usually caused by swelling, bleeding, fluid, or severe illness. It can reduce blood flow to the organs, impair breathing and kidney function, and may require urgent treatment.
...
\medterm{Intra-Articular Injection} A common outpatient clinical procedure in which a needle is guided directly into the synovial joint cavity (such as the knee, shoulder, hip, ankle, or small joints of the hand) to deliver therapeutic medications or aspirate fluid. Performed using anatomical landmarks or guided with real-time ultrasound, clinicians most commonly inject long-acting corticosteroids combined with local anesthetics to calm acute joint inflammation, swelling, and severe pain caused by osteoarthritis, rheumatoid arthritis, gout, pseudogout, or bursitis. Other therapeutic agents include hyaluronic acid (viscosupplementation to lubricate arthritic knee joints) and platelet-rich plasma (PRP). Delivering medication directly into the joint capsule maximizes local therapeutic concentrations while avoiding the systemic side effects associated with oral steroid medications.
...
\medterm{Intracerebral Hemorrhage} Bleeding directly into brain tissue, usually from a small ruptured artery. It can cause sudden headache, weakness, vomiting, confusion, seizures, or loss of consciousness and requires emergency treatment.
...
\medterm{Intramural Hematoma} Bleeding into the wall of the digestive tract, often in the small intestine. It can follow injury or blood-thinning treatment and may cause abdominal pain, vomiting, or blockage; severe symptoms require urgent assessment.
...
\medterm{Intraocular Tumor} A growth arising within the eye. It may be noncancerous or cancerous; examples include uveal melanoma in adults and retinoblastoma in children. It can affect vision or eye pressure and requires specialist examination and imaging.
...
\medterm{Intraosseous Access} Placement of a special needle into the inner part of a bone to give fluids, blood, or medicines quickly when a vein cannot be reached during an emergency. It is temporary and can cause pain, leakage, infection, or bone injury.
...
\medterm{Intussusception} A medical emergency in which one segment of the intestine slides inside an adjacent segment like a folding telescope (most often the small bowel slipping into the colon), blocking food and cutting off blood flow. Most common in infants between 6 and 36 months of age, it classically presents with sudden waves of severe cramping belly pain (causing the infant to cry and pull knees to the chest), vomiting, and mucus-rich red bloody stool (red currant jelly stool). Diagnosis is typically confirmed by ultrasound showing a target-like ring, and treatment in children usually involves gently pushing the bowel back into place with an air or contrast enema.
...
\medterm{Invasive Procedure} A medical examination, test, or treatment that enters the body by piercing the skin, puncturing a blood vessel, or inserting instruments, tubes, needles, or cameras into internal cavities, tissues, or organs. Invasive procedures range from minimally invasive interventions (such as drawing blood, placing an intravenous line, performing a needle biopsy, or doing a catheterization or endoscopy) to major open surgeries (such as an appendectomy, open-heart bypass, or joint replacement). Because tissues are entered or divided, invasive procedures carry risks of bleeding, infection, pain, tissue damage, and anesthesia complications, requiring strict sterile technique, informed patient consent, and close post-procedure monitoring.
...
\medterm{Iodine Deficiency} A nutritional deficiency of the essential trace element iodine, which serves as a necessary biochemical substrate for the synthesis of thyroid hormones (thyroxine [$T_4$] and triiodothyronine [$T_3$]). Inadequate dietary intake impairs hormone production, prompting sustained compensatory secretion of pituitary thyroid-stimulating hormone (TSH) that leads to thyroid follicular hyperplasia and enlargement (endemic goiter). In pregnant women and developing fetuses, severe deficiency causes congenital iodine deficiency syndrome (cretinism), characterized by irreversible intellectual disability, deaf-mutism, and stunted somatic growth; in adults, it leads to hypothyroidism, cognitive sluggishness, and increased avidity for radioactive iodine.
...
\medterm{Iron Overdose} Poisoning after taking too much iron, especially from supplements. It can cause vomiting, abdominal pain, internal bleeding, severe acid imbalance, shock, liver failure, and death; a large or child ingestion requires emergency poison-control advice.
...
\medterm{Irritable Bowel Syndrome Diet} An individualized eating plan to reduce symptoms of irritable bowel syndrome while maintaining adequate nutrition. A short trial of reducing fermentable carbohydrates may help some people, but foods should be reintroduced systematically with professional guidance.
...
\medterm{Ischemic Gangrene} Death of tissue after a prolonged severe loss of blood supply, most often in a toe, foot, finger, or leg. The tissue may become cold, numb, and black; urgent assessment is needed to restore circulation and prevent infection.
...
\medterm{Isosorbide Dinitrate} A nitrate medicine that widens blood vessels and reduces the heart’s workload. It is used mainly to prevent angina attacks; headache, dizziness, and low blood pressure may occur, and it must not be combined with erectile-dysfunction medicines.
...
\medterm{Listeria Infection} Alternate name; see \textit{Listeriosis}.

\medterm{Motor Incoordination} Impaired coordination of voluntary movement, often caused by disease affecting the cerebellum or other parts of the nervous system.
...
\medterm{Pruritus Ani} Alternate medical name; see \textit{Anal Itching}.
...
\medterm{Scleral Inflammation} Alternate name; see \textit{Scleritis}.

\medterm{Social Isolation} Having little contact or meaningful interaction with other people. It may follow bereavement, illness, disability, relocation, or limited transport and can increase the risk of depression, cognitive decline, and poorer overall health.

\synonyms
Social Disconnection; Loneliness and Social Alienation

\medterm{Swine Flu} Alternate name; see \textit{H1N1 Influenza}.

\medterm{Terminal Ileitis} Alternate name; see \textit{Crohn's Disease}.

\medterm{Testicular Infection} Alternate name; see \textit{Orchitis}.

\medterm{Urinary Incontinence} Involuntary leakage of urine. It may occur with coughing or exercise, a sudden urge, an overfull bladder, difficulty reaching the toilet, or more than one cause; evaluation considers symptoms, medicines, infection, and bladder emptying.
\synonyms
Enuresis; Involuntary Urination; Bladder Incontinence

\medterm{Urinary Tract Infection} Infection of part of the urinary system, commonly the bladder or urethra and sometimes the kidneys, usually caused by bacteria and producing symptoms such as burning urination, urgency, or flank pain.

\medterm{Urine Immunoelectrophoresis} A specialized clinical laboratory test that separates urinary proteins by agarose gel electrophoresis followed by immunodiffusion with monospecific antibodies. Primarily utilized to identify and characterize monoclonal light chains (Bence Jones proteins) in plasma cell dyscrasias such as multiple myeloma.

\synonyms
Urine IEP; Urinary Protein Immunoelectrophoresis; Urine Immunofixation Electrophoresis

\medterm{Urine Immunofixation} An immunochemical laboratory technique combining high-resolution electrophoresis with specific antibody precipitation to identify and type monoclonal free light chains (kappa or lambda) and intact immunoglobulins excreted in urine.

\synonyms
Urine IFE; Urinary Immunofixation Electrophoresis; Bence Jones Protein IFE
...
\medterm{Wound Classification} A description of common injury types: an abrasion is a scrape, a laceration is a torn cut, a contusion is a bruise from blunt force, and an incised wound is a clean cut from a sharp object.
