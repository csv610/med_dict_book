...
\medterm{Immune Thrombocytopenic Purpura} Alternate name; see \textit{Immune Thrombocytopenia}.
...
\medterm{Inhalation} The part of breathing in which air enters the lungs. The diaphragm contracts and moves downward, while the chest muscles expand the chest, lowering pressure inside the lungs and drawing air through the airways into the air sacs.
...
\medterm{Interstitial Pneumonia} Alternate name; see \textit{Interstitial Lung Disease}.
...
\medterm{Intestinal Ischemia} Alternate name; see \textit{Mesenteric Ischemia}.
...
\medterm{Intraaortic Balloon Pump} A temporary heart-support device with a balloon inside the main artery leaving the heart. The balloon inflates between heartbeats and deflates as the heart pumps, helping improve blood flow to the heart and body.
