...
\medterm{Inspection} A clinical condition or finding involving inspection. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Intravenous Pyelogram} A clinical condition or finding involving intravenous pyelogram. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Iatrogenic Disease} A clinical condition or finding involving iatrogenic disease. Its features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Ileal Fistula} A clinical condition or finding involving ileal fistula. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Ileal Hemorrhage} A clinical condition or finding involving ileal hemorrhage. Its features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Ileal Stenosis} A clinical condition or finding involving ileal stenosis. Its features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Iloprost} A clinical condition or finding involving iloprost. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Imatinib Mesylate} A clinical condition or finding involving imatinib mesylate. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Immunochemistry} A clinical condition or finding involving immunochemistry. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Immunoconjugate} A clinical condition or finding involving immunoconjugate. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Immunocytochemistry} A clinical condition or finding involving immunocytochemistry. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Immunologic Memory} A clinical condition or finding involving immunologic memory. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Immunological Synapse} A clinical condition or finding involving immunological synapse. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Implantable Defibrillator} A clinical condition or finding involving implantable defibrillator. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Indwelling Catheter} A clinical condition or finding involving indwelling catheter. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Inflammatory Response} A clinical condition or finding involving inflammatory response. Its features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Inhibin} A clinical condition or finding involving inhibin. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Insulin Detemir} A clinical condition or finding involving insulin detemir. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Insulin Isophane} A clinical condition or finding involving insulin isophane. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Insulin Lispro} A clinical condition or finding involving insulin lispro. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Insulin Receptor} A clinical condition or finding involving insulin receptor. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Interferon-Alpha} A clinical condition or finding involving interferon-alpha. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Interferon-Beta} A clinical condition or finding involving interferon-beta. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Interleukin 1} A clinical condition or finding involving interleukin 1. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Interleukin 13} A clinical condition or finding involving interleukin 13. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Interleukin 7} A clinical condition or finding involving interleukin 7. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Intravenous Catheters} A clinical condition or finding involving intravenous catheters. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Ibuprofen Overdose} A clinical condition or finding involving ibuprofen overdose. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Ileostomy - Caring For Your Stoma} A clinical condition or finding involving ileostomy - caring for your stoma. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Ileostomy - Changing Your Pouch} A clinical condition or finding involving ileostomy - changing your pouch. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Ileostomy - Discharge} A patient-care topic concerning ileostomy - discharge. It addresses the relevant purpose, risks, management, and follow-up.

\medterm{Ileostomy - What To Ask Your Doctor} A patient-care topic concerning ileostomy - what to ask your doctor. It addresses the relevant purpose, risks, management, and follow-up.
...
\medterm{Iliotibial Band Syndrome - Aftercare} A patient-care topic concerning iliotibial band syndrome - aftercare. It addresses the relevant purpose, risks, management, and follow-up.
...
\medterm{Imipramine Overdose} A clinical condition or finding involving imipramine overdose. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Immunoelectrophoresis – Blood} A clinical condition or finding involving immunoelectrophoresis – blood. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Immunoelectrophoresis - Urine} A clinical condition or finding involving immunoelectrophoresis - urine. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Immunofixation - Urine} A clinical condition or finding involving immunofixation - urine. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Immunofixation Blood Test} A diagnostic test or examination used to assess immunofixation blood test. Results are interpreted with the clinical findings, method, and reference range.

\medterm{Immunotherapy For Cancer} A clinical condition or finding involving immunotherapy for cancer. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Implantable Cardioverter Defibrillator - Discharge} A patient-care topic concerning implantable cardioverter defibrillator - discharge. It addresses the relevant purpose, risks, management, and follow-up.
...
\medterm{Incontinence - Resources} A patient-care topic concerning incontinence - resources. It addresses the relevant purpose, risks, management, and follow-up.
...
\medterm{Indium-Labelled WBC Scan} A clinical condition or finding involving indium-labelled wbc scan. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Indoor Fitness Routine} A clinical condition or finding involving indoor fitness routine. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Infant Formula - Buying, Preparing, Storing, And Feeding} A medicine or chemical compound called infant formula - buying, preparing, storing, and feeding. Its uses, effects, interactions, and risks depend on the specific substance and clinical indication.
...
\medterm{Infertility - Resources} A patient-care topic concerning infertility - resources. It addresses the relevant purpose, risks, management, and follow-up.
...
\medterm{Influenza (Flu) Vaccine (Live, Intranasal) - What You Need To Know} A clinical condition or finding involving influenza (flu) vaccine (live, intranasal) - what you need to know. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Ingrown Toenail Removal - Discharge} A medical procedure involving ingrown toenail removal - discharge. Indications, risks, preparation, and follow-up depend on the patient and the specific procedure.
...
\medterm{Inguinal Hernia Repair - Discharge} A medical procedure involving inguinal hernia repair - discharge. Indications, risks, preparation, and follow-up depend on the patient and the specific procedure.
...
\medterm{Insecticide Poisoning} A clinical condition or finding involving insecticide poisoning. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Insulin C-Peptide Test} A diagnostic test or examination used to assess insulin c-peptide test. Results are interpreted with the clinical findings, method, and reference range.
...
\medterm{Intercostal Retractions} A clinical condition or finding involving intercostal retractions. Its defining features, causes, evaluation, and management depend on the clinical context.

\medterm{Interstitial Cystitis - Resources} A patient-care topic concerning interstitial cystitis - resources. It addresses the relevant purpose, risks, management, and follow-up.

\medterm{Interstitial Lung Disease - Adults - Discharge} A patient-care topic concerning interstitial lung disease - adults - discharge. It addresses the relevant purpose, risks, management, and follow-up.

\medterm{Intestinal Leiomyoma} A diagnostic test or examination used to assess intestinal leiomyoma. Results are interpreted with the clinical findings, method, and reference range.

\medterm{Intestinal Obstruction And Ileus} A diagnostic test or examination used to assess intestinal obstruction and ileus. Results are interpreted with the clinical findings, method, and reference range.

\medterm{Intestinal Obstruction Repair} A diagnostic test or examination used to assess intestinal obstruction repair. Results are interpreted with the clinical findings, method, and reference range.

\medterm{Intestinal Or Bowel Obstruction - Discharge} A diagnostic test or examination used to assess intestinal or bowel obstruction - discharge. Results are interpreted with the clinical findings, method, and reference range.

\medterm{Intracardiac Electrophysiology Study (EPS)} A diagnostic test or examination used to assess intracardiac electrophysiology study (eps). Results are interpreted with the clinical findings, method, and reference range.

\medterm{Intracranial Pressure Monitoring} A clinical condition or finding involving intracranial pressure monitoring. Its defining features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Irritable Bowel Syndrome - Aftercare} A patient-care topic concerning irritable bowel syndrome - aftercare. It addresses the relevant purpose, risks, management, and follow-up.
...
\medterm{Icteric} A medical term referring to icteric. Its precise meaning and clinical importance depend on the context in which it is used.
...
\medterm{Imerslund-GräSbeck Syndrome} A clinical condition or finding involving imerslund-gräsbeck syndrome. Its features, causes, evaluation, and management depend on the clinical context.

\medterm{Imidazoles} A medical term referring to imidazoles. Its precise meaning and clinical importance depend on the context in which it is used.
...
\medterm{NIncontinence} A clinical condition or finding involving nincontinence. Its features, causes, evaluation, and management depend on the clinical context.
...
\medterm{Insect Bites} A medical term referring to insect bites. Its precise meaning and clinical importance depend on the context in which it is used.
...
\medterm{Insufficiency} A clinical condition or finding involving insufficiency. Its features, causes, evaluation, and management depend on the clinical context.
