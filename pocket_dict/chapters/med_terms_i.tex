...
\medterm{ICU Psychosis} Outdated term; see \textit{Delirium}.

\synonyms
ICU Delirium; Intensive Care Unit Psychosis
...
\medterm{IgG And Complement Deposition At The Dermis-Epidermis Junction} A laboratory finding in which immune proteins collect where the outer and deeper layers of skin meet. It can occur in lupus and other conditions, but the pattern and symptoms are needed to interpret its meaning.
...
\medterm{Infant Respiratory Distress Syndrome} A serious breathing disorder in a newborn or young infant, usually caused by insufficient lung surfactant and immature lungs. It is also called neonatal respiratory distress syndrome or hyaline membrane disease.
...
\medterm{Infective Endocarditis} A serious infection of the heart’s inner lining, usually involving a heart valve. It can cause fever, tiredness, a new or changed heart murmur, or clots traveling to other organs. Diagnosis uses blood cultures, heart imaging, and clinical findings.
...
\medterm{Inferior Vena Cava Filter} A percutaneously deployed intravascular metallic filtration device placed in the infrarenal inferior vena cava to mechanically intercept and capture migrating venous thromboemboli from the lower extremities, indicated in deep vein thrombosis when therapeutic anticoagulation is contraindicated.
\synonyms
...
\medterm{Ingrown Toenail} A toenail edge grows into the surrounding skin, causing pain, redness, swelling, and sometimes infection. It is promoted by tight shoes, injury, or cutting nails too short; recurrent or severe cases may need a procedure to remove part of the nail.
...
\medterm{Intra-Abdominal Hypertension} Abnormally high pressure inside the abdomen, usually caused by swelling, bleeding, fluid, or severe illness. It can reduce blood flow to the organs and impair breathing and kidney function.
...
\medterm{Intraosseous Infusion} Delivery of fluids, blood, or medicines through a needle placed into the inner space of a bone when a vein cannot be accessed quickly. It is temporary and can cause pain, swelling, leakage, infection, or bone injury.
...
\medterm{Intravascular Ultrasound} Imaging performed with a tiny ultrasound probe inside a blood vessel, usually a coronary artery. It shows the vessel wall, fatty deposits, and the position of a stent, helping guide selected treatments.
