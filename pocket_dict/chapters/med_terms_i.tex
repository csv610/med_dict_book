...
\medterm{ICD} An implantable device that watches heart rhythm and delivers pacing or an electrical shock when dangerous rhythms threaten life.
...
\medterm{Icterus} Yellowing of the skin, whites of the eyes, or other tissues caused by excess bilirubin. It can result from liver disease, blocked bile flow, or increased red-cell breakdown and needs evaluation.
\synonyms
jaundice.
...
\medterm{Idiopathic} Of unknown cause. Examples: idiopathic pulmonary fibrosis, idiopathic thrombocytopenia. Having no identified cause after appropriate evaluation. “Idiopathic” does not mean imaginary or untreatable; it means the cause is currently unknown.
...
\medterm{Igh Gene} A gene segment that contributes to the heavy-chain part of antibodies. Rearrangement of IGH helps immune cells produce antibodies with different target specificities.
...
\medterm{Immunoglobulin Idiotype} The distinctive set of features in the variable region of an antibody that determines what it can recognize. Idiotypes can differ between antibodies made by different B-cell clones and may be studied in immune disorders and antibody treatments.
...
\medterm{Immunologic Adjuvant} A substance added to a vaccine or experimental antigen to strengthen or shape the immune response. It can improve protection while also increasing local pain, swelling, fever, or other reactions.
...
\medterm{Insidious} Developing gradually and subtly, often without obvious early symptoms. Developing slowly and subtly, often without obvious early symptoms. An insidious disease may be advanced before it is recognized.
...
\medterm{Instantaneous Wave-Free Ratio} A measurement taken during heart catheterization that estimates whether a narrowed coronary artery is reducing blood flow. A pressure wire compares pressure beyond the narrowing with pressure before it while the heart is relaxed. A value of 0.89 or less may support treatment to improve blood flow, together with symptoms and other findings.
