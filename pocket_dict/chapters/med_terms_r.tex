...
\medterm{Receiver Operating Characteristic} A graph showing a diagnostic test’s true-positive rate against its false-positive rate at different cutoff values. The area under the curve summarizes how well the test separates people with and without a condition.
