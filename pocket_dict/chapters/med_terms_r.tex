...
\medterm{Raynaud Disease} Alternate name; see \textit{Raynaud's Disease}.

\medterm{Ringworm (Tinea)} Alternate name; see \textit{Ringworm}.

\medterm{Respiratory Syncytial Virus (RSV)} Alternate name; see \textit{Respiratory Syncytial Virus}.

\medterm{Restless Legs Syndrome (RLS)} Alternate name; see \textit{Restless Legs Syndrome}.

\medterm{Rheumatoid Arthritis (RA)} Alternate name; see \textit{Rheumatoid Arthritis}.

\medterm{Willis-Ekbom Disease} Another name for restless legs syndrome, a neurologic sleep-related movement disorder causing an urge to move the legs and uncomfortable sensations that worsen at rest and at night.
