...
\medterm{Allergic Rhinitis} Alternate name; see \textit{Hay Fever}.

\medterm{Aortic Valve Regurgitation} Alternate name; see \textit{Aortic Regurgitation}.

\medterm{Bile Reflux} Alternate name; see \textit{Biliary Reflux}.
...
\medterm{Diabetic Retinopathy} Alternate name; see \textit{Diabetic Retinopathy}.
...
\medterm{Heat Rash} Alternate name; see \textit{Miliaria}.

\medterm{Hydrophobia} Alternate historical name; see \textit{Rabies}.
...
\medterm{Mitral Valve Regurgitation} Alternate name; see \textit{Mitral Regurgitation}.

\medterm{Nonallergic Rhinitis} Alternate name; see \textit{Nonallergic Rhinitis}.
...
\medterm{Perforated Eardrum} A hole or tear in the eardrum that may cause pain, drainage, hearing loss, or ringing and can result from infection, injury, or pressure changes.
...
\medterm{Poison Ivy Rash} Alternate name; see \textit{Toxicodendron Dermatitis}.
...
\medterm{Radiation Dermatitis Skin Care} Clinical dermatological hygiene and barrier protection protocols for irradiated skin fields during and following external beam radiation therapy. Recommended practices include gentle cleansing with mild non-alkaline cleansers, application of hydrophilic unscented moisturizers, avoidance of adhesive tapes or thermal extremes, and prompt management of moist desquamation.
...
\medterm{Rape} Alternate legal and clinical term; see \textit{Sexual Assault}.
...
\medterm{Raynauds Phenomenon} Alternate spelling; see \textit{Raynaud's Phenomenon}.
...
\medterm{Raynaud's Syndrome} Alternate name; see \textit{Raynaud's Phenomenon}.
...
\medterm{Rectal} Rectal means relating to the rectum, the final part of the large intestine before the anal canal.
...
\medterm{Rectal Bleeding} Alternate name; see \textit{Hematochezia}.
...
\medterm{Relocation Test} A clinical examination manoeuvre performed following a positive anterior apprehension test of the shoulder. With the patient supine and the shoulder in ninety degrees of abduction and external rotation, the examiner applies a posterior stabilizing force over the anterior humeral head; relief of apprehension or pain confirms anterior glenohumeral instability.
...
\medterm{Renal Failure} Alternate name; see \textit{Kidney Failure}.
...
\medterm{Respiratory Syncytial Virus} A common virus that causes respiratory infection. It may cause mild cold symptoms in adults but can cause bronchiolitis or pneumonia in infants, older adults, and people with certain health conditions.
...
\medterm{Retinol} A fat-soluble vitamin required for vision, epithelial health, immune function, and normal growth; deficiency may cause night blindness and xerophthalmia.
...
\medterm{Ringworm} Ringworm is a superficial dermatophyte fungal infection of skin, scalp, or nails that produces scaly annular lesions or hair loss; treatment depends on the site and may require topical or oral antifungals.
...
\medterm{Rumpel-Leede Test} Alternate name; see \textit{Tourniquet Test}.
...
\medterm{Schatzki Ring} Alternate name; see \textit{Esophageal Ring}.
...
\medterm{Vasomotor Rhinitis} Alternate name; see \textit{Nonallergic Rhinitis}.

\medterm{Vesicoureteral Reflux} Alternate name; see \textit{Vesicoureteral Reflux}.
