...
\medterm{Radiation Physics} The study of how radiation is produced, travels, interacts with matter, is detected, and affects living tissue. It supports medical imaging, radiation treatment, dose calculation, and protection from unnecessary exposure.
...
\medterm{Radiobiology} Study of radiation effects on biological systems. DNA damage, cell death, repair mechanisms. The study of how radiation affects living cells and tissues, including injury, repair, mutations, and cancer treatment.
...
\medterm{Radionuclide} An unstable atom that emits radiation as it decays. Radionuclides are used in diagnostic imaging and some treatments. A radioactive isotope used as a tracer or therapeutic agent.
...
\medterm{Radionuclide Generator} A device that produces a short-lived radioactive substance from a longer-lived parent substance for use in nuclear imaging or treatment. It allows medical facilities to obtain certain tracers when needed under controlled conditions.
...
\medterm{Radionuclide Imaging Or Scan} A scan that detects radiation from a small amount of radioactive tracer given to a person. The tracer collects in particular organs or tissues, allowing doctors to study their structure or activity and find some diseases.
...
\medterm{Radiosensitization} Making cells more easily damaged by radiation. Some medicines or treatments are used with radiotherapy to make cancer cells more sensitive, but doctors must also limit harm to nearby healthy tissue.
...
\medterm{Rahnella} A group of environmental bacteria usually found in soil or water that rarely infect people. When infection occurs, it may affect blood, urine, lungs, or wounds, especially in vulnerable patients.
...
\medterm{Ralstonia Mannitolilytica} An environmental bacterium that can contaminate water, fluids, or medical products. It occasionally causes bloodstream or breathing infections in healthcare settings, particularly among people with serious illness or weakened immunity.
...
\medterm{Ranpirnase} An investigational anticancer medicine derived from a ribonuclease enzyme. It was studied because it can enter tumor cells and degrade RNA, but it is not an established routine treatment.
...
\medterm{Rapid Sequence Induction} A method for quickly placing a breathing tube after medicines, designed to reduce vomiting and aspiration into the lungs.
...
\medterm{Rauscher Virus} A retrovirus that causes leukemia in mice and is used in research. Scientists study it to understand how viruses alter blood-forming cells and contribute to cancer, immunity, and possible treatments.
...
\medterm{RCT} Randomized controlled trial, a research study that assigns participants by chance to different treatments or comparison groups. It helps test whether an intervention works and whether its benefits outweigh its harms.
...
\medterm{Receiver Operating Characteristic} ROC curve: plot of sensitivity vs. 1-specificity. Area under curve measures test accuracy. A graph showing test sensitivity against false-positive rate, used to compare diagnostic accuracy at different thresholds.
...
\medterm{Recombinational Repair} A way cells repair a broken or damaged DNA strand by using a matching DNA sequence as a template. It helps restore accurate genetic information; inherited defects in this process can increase cancer risk and sensitivity to DNA-damaging treatment.
...
\medterm{Recurrent} Disease returning after remission. Examples: recurrent UTI, herpes. Happening again after improving or stopping. A recurrent disease may return after remission, such as recurrent urinary infection or recurrent herpes.
...
\medterm{Reed-Sternberg Cells} Large abnormal cells derived from B lymphocytes and characteristic of classic Hodgkin lymphoma. Large abnormal cells derived from B lymphocytes, found in classic Hodgkin lymphoma and helpful for confirming diagnosis.
...
\medterm{Rejection} An immune response in which the body attacks transplanted tissue or an organ. An immune response in which the body attacks transplanted tissue, potentially damaging or destroying the transplant.
\synonyms
...
\medterm{Reporting Standards} Standards for structured reporting. ACR guidelines, BI-RADS, LI-RADS, PI-RADS. Agreed rules for recording and communicating clinical or imaging findings. Structured standards improve completeness, consistency, communication, and follow-up recommendations.
...
\medterm{Resorption} The removal and absorption of tissue, especially the breakdown of bone by osteoclasts. Breakdown and removal of tissue, especially old bone, followed by release or reuse of its components.
...
\medterm{Resuscitation} Emergency measures used to restore breathing and circulation. Emergency care used to restore or support breathing and circulation, including airway support, chest compressions, defibrillation, medicines, and treatment of the cause.
\synonyms
CPR; revival
...
\medterm{Retractor} Holds tissue aside for exposure. Types: handheld, self-retaining (Weitlaner, Gelpi). An instrument or muscle that pulls a structure backward or holds tissue aside during examination or surgery.
...
\medterm{Retrograde Degeneration} Breakdown of a nerve cell or its fibre that spreads back toward the cell body after injury to the nerve fibre. It can impair movement, sensation, or organ function depending on the affected nerve and severity of injury.
...
\medterm{Rhabdoviruses} A family of bullet-shaped viruses carrying RNA genetic material. It includes rabies virus and vesicular stomatitis virus; some infect people or animals and may spread through bites, saliva, or other exposures.
...
\medterm{Rheumatoid Arthritis} A chronic autoimmune inflammatory disease that commonly causes symmetric pain, swelling, and progressive damage in the small joints of the hands and feet. It may also affect other organs.
\synonyms
RA
...
\medterm{Rheumatologist} A physician specializing in inflammatory and autoimmune diseases of joints and connective tissue. A doctor who diagnoses and treats inflammatory, autoimmune, and other diseases affecting joints, muscles, and connective tissues.
...
\medterm{Rhodopseudomonas} A group of environmentally adapted bacteria able to use light or other chemicals for energy. They are rarely linked with human infection and are studied in ecology, biotechnology, and waste treatment.
...
\medterm{Rhodospirillales} A broad group of bacteria that includes several environmental families and species. Many use light or other chemical processes for energy, and most are not known to cause human disease.
...
\medterm{Rhytidectomy} Cosmetic surgery, often called a facelift, that removes or repositions some facial skin and tightens deeper tissues. It may reduce sagging but does not stop ageing; bleeding, infection, scarring, numbness, nerve injury, or uneven results can occur.
...
\medterm{Ribonuclease III} An enzyme that cuts double-stranded RNA into smaller pieces. It helps process regulatory RNA molecules and supports control of gene activity in cells and some microorganisms.
...
\medterm{Ribonucleotide Reductase} An enzyme that converts RNA building blocks into DNA building blocks. Cells need this reaction to copy and repair DNA, so the enzyme is important for growth and is studied as a treatment target.
...
\medterm{Ribose} A five-carbon sugar found in RNA, ATP, and many other biologically important molecules. A five-carbon sugar that forms part of RNA, ATP, and many other important molecules used by cells.
...
\medterm{Ribozyme} A molecule made of RNA that can speed up a chemical reaction without a protein enzyme. Natural ribozymes help build proteins and remove certain RNA sections. Researchers also design ribozymes to cut specific disease-related messenger RNA, but most medical uses remain experimental.
...
\medterm{Rickettsia Rickettsii} Rickettsia rickettsii causes Rocky Mountain spotted fever and is transmitted by infected ticks. A bacterium spread by infected ticks that causes Rocky Mountain spotted fever, a potentially serious illness.
...
\medterm{Rilotumumab} An investigational monoclonal antibody targeting hepatocyte growth factor, studied as an anticancer treatment. An investigational antibody medicine designed to block a growth signal and studied for possible cancer treatment.
...
\medterm{Ringworm} Ringworm is a contagious superficial dermatophyte infection of skin, hair, or nails that produces scaly annular lesions, itching, or localized hair loss. by dermatophytes (Trichophyton, Microsporum, Epidermophyton). See Tinea.
\synonyms
...
\medterm{Roseomonas Gilardii} A pink-colored bacterium that rarely causes bloodstream, wound, or other opportunistic infections. It mainly affects people with serious illness, weakened immunity, or medical devices and requires laboratory testing for identification.
...
\medterm{Rubulavirus} A group of viruses in the paramyxovirus family, including mumps virus and related animal viruses. Human infection can spread through respiratory droplets and may cause fever, swollen glands, or other complications.

\medterm{Rule Of Nines} A quick method for estimating the percentage of body surface burned by assigning body regions values of nine or multiples of nine. It guides early fluid treatment but is less precise for children.
...
\medterm{Rural Health} The health and healthcare needs of people living in rural or remote communities. Long travel distances, limited healthcare workers and facilities, transport problems, and local social or environmental conditions can affect access and health outcomes.
