...
\medterm{Renal Cyst} Alternate index label for Kidney Cysts.
...
\medterm{RSV Infection} Alternate index label for Respiratory Syncytial Virus Infection.
...
\medterm{Resuscitative Thoracotomy} An emergency surgical procedure performed immediately in the emergency department resuscitation bay for trauma patients in cardiac arrest or near-death following penetrating chest injuries (such as gunshot or stab wounds). A trauma surgeon rapidly makes an incision along the left fourth or fifth intercostal space (an anterolateral thoracotomy, sometimes extended across the sternum into a bilateral ``clamshell'' thoracotomy) and inserts a rib spreader to expose the heart, lungs, and great thoracic vessels. The procedure has four life-saving objectives: opening the pericardial sac to evacuate trapped blood causing cardiac tamponade, controlling massive active bleeding from the heart or pulmonary vessels, cross-clamping the descending thoracic aorta to redirect limited blood flow preferentially to the brain and heart, and performing direct internal cardiac compressions. If successful, it temporarily restores vital circulation so the patient can be rushed into the operating room for definitive surgical repair.
