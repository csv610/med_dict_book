...
\medterm{Recombinant Protein} A protein made by inserting its gene into a laboratory cell, which then produces the protein. This method is used to make some hormones, vaccines, antibodies, enzymes, and research materials.
...
\medterm{Retinoblastoma Protein} A protein encoded by the RB1 gene that helps control the cell cycle by limiting cell division. Loss or inactivation of both RB1 copies can contribute to retinoblastoma and other cancers.
...
\medterm{Retortamonas Intestinalis} A species of single-celled intestinal parasite found in some humans and animals. It is usually considered harmless, but finding it in stool should be interpreted with symptoms and other possible causes of diarrhea.
...
\medterm{Riboflavin Assay} A laboratory measurement of vitamin B2 or its active forms in blood, urine, or another specimen. It may help investigate suspected deficiency, although results must be interpreted with diet, symptoms, and other tests.
...
\medterm{Ribonucleoprotein} A complex made of RNA and one or more proteins. Ribonucleoproteins help make, process, transport, or regulate RNA; antibodies against some of them occur in autoimmune diseases such as mixed connective-tissue disease.
