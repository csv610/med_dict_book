...
\medterm{Gaskin Maneuver} An emergency maneuver for shoulder dystocia in which the birthing person moves onto hands and knees. The position can change pelvic dimensions and help release the baby’s shoulder; it is performed by trained clinicians.
...
\medterm{Delayed Gastric Emptying} Slowed movement of food from the stomach into the small intestine without a physical blockage. It may cause early fullness, nausea, vomiting, bloating, abdominal pain, and unstable blood-glucose levels.

\synonyms
Gastroparesis; Gastric Stasis

\medterm{Rapid Gastric Emptying} Food moves too quickly from the stomach into the small intestine, sometimes after stomach surgery. Soon after eating it may cause cramps, nausea, diarrhea, dizziness, sweating, weakness, or a fast heartbeat.
...
\medterm{Viral Gastroenteritis} Inflammation of the stomach and intestines caused by a virus such as norovirus or rotavirus. It commonly causes watery diarrhea, vomiting, cramps, fever, and dehydration. Treatment focuses on replacing fluids; severe symptoms require medical assessment.
...
\medterm{Genital Herpes in Women} Herpes simplex virus infection of the female genitalia, causing painful blisters or ulcers. May be asymptomatic. Antiviral treatment reduces symptoms and transmission. Pregnancy requires obstetric planning due to risk of neonatal infection.
...
\medterm{Rubella} Alternate name; see \textit{German Measles}.
...
\medterm{Temporal Arteritis} Alternate name; see \textit{Giant Cell Arteritis}.
...
\medterm{Giardiasis} An intestinal infection caused by Giardia parasites, commonly producing diarrhea, cramps, bloating, gas, and malabsorption.
...
\medterm{Insulin Injection Technique} Technique for administering insulin subcutaneously using a syringe or insulin pen. Includes site selection (abdomen, thigh, upper arm), rotation of injection sites, proper needle insertion, and blood glucose monitoring.
...
\medterm{Oral Glucose Tolerance Test} A standardized diagnostic laboratory test measuring venous blood glucose concentrations after an overnight fast and at timed intervals following the ingestion of a standard 75-gram oral glucose load. Used to diagnose diabetes mellitus and impaired glucose tolerance in non-pregnant individuals.

\synonyms
OGTT; Standard Oral Glucose Tolerance Test; Glucose Tolerance Assay
...
\medterm{Non-Celiac Gluten Sensitivity} Adverse symptoms triggered by gluten ingestion in individuals without celiac disease or wheat allergy. Symptoms include bloating, abdominal pain, diarrhea, and fatigue. Diagnosis is by exclusion. Management involves gluten avoidance.
...
\medterm{Golfer's Elbow} Overuse injury involving tendons on the inside of the elbow, causing pain and tenderness with gripping or wrist movement.
...
\medterm{Gonadotropin-Releasing Hormone} A hormone released in pulses by the hypothalamus that stimulates the pituitary to release follicle-stimulating hormone and luteinizing hormone. It controls puberty, menstrual cycles, ovulation, sperm production, and sex-hormone levels.
...
\medterm{Small Calorie} A small calorie is the energy needed to raise 1 gram of water by 1 degree Celsius; the dietary Calorie, written with a capital C, is a kilocalorie equal to 1,000 small calories.
...
\medterm{Periodontal Disease} A long-term infection and inflammation that destroys the tissues and bone supporting the teeth. It can cause bleeding gums, bad breath, loose teeth, gum recession, and tooth loss. Treatment requires dental care to remove deposits and control the infection.
...
\medterm{Graves' Disease} Alternate spelling; see \textit{Graves Disease}.
