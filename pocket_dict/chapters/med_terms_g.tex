...
\medterm{Genetic Disease} Alternate index label for Genetic Disorder.
...
\medterm{Gluten-Sensitive Enteropathy} Alternate index label for Celiac Disease.

\medterm{Gluten-Sensitive Enteropathy (Celiac Disease)} Alternate index label for Celiac Disease.
