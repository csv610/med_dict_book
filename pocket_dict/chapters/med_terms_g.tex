...
\medterm{Genetic Disease} A health condition caused in whole or in part by a harmful change in genetic material (DNA). The change may affect one or more genes, the number or structure of chromosomes, or mitochondrial DNA, and may alter how cells make or use proteins. It may be inherited from a parent or arise for the first time in a person; some conditions result from the combined effects of changes in several genes and environmental factors. Not every genetic change causes disease.
...
\medterm{Glandular Fever} Alternate term; see \textit{Infectious mononucleosis}.

\medterm{Glandular Fever (Infectious Mononucleosis)} Alternate term; see \textit{Infectious mononucleosis}.
...
\medterm{Graves' Disease} Alternate index label; see \textit{Graves disease}.
