...
\medterm{G6PD Deficiency in the Newborn} Glucose-6-phosphate dehydrogenase deficiency presenting during the neonatal period, most often with jaundice from hemolysis. Early recognition helps avoid oxidant triggers and supports monitoring or treatment of significant hyperbilirubinemia.
...
\medterm{Galactocerebrosidase (GALC) Deficiency} Alternate name; see \textit{Galactocerebrosidase Deficiency}.

\medterm{Galactocerebroside Beta-Galactosidase Deficiency} Alternate name; see \textit{Galactocerebrosidase Deficiency}.
...
\medterm{Galactorrhea-Amenorrhea Syndrome} Alternate name; see \textit{Forbes-Albright Syndrome}.
...
\medterm{Galactose-1-Phosphate Uridyl Transferase Deficiency} A deficiency of the GALT enzyme that causes classic galactosemia, impairing galactose processing and potentially causing liver injury, jaundice, cataracts, poor feeding, infection, and developmental problems in untreated infants.

\medterm{GALT Deficiency} Abbreviation; see \textit{Galactose-1-Phosphate Uridyl Transferase Deficiency}.
...
\medterm{GAN} Abbreviation; see \textit{Giant Axonal Neuropathy}.
...
\medterm{Gamma-Hydroxybutyrate Toxicity} Rapid-onset central nervous system depression from GHB or related compounds, with drowsiness, ataxia, vomiting, bradycardia, respiratory depression, coma, and sometimes agitation or delirium during recovery. There is no specific antidote; protect the airway, support ventilation, and monitor until mental status and breathing recover.
...
\medterm{Ganglions} Alternate plural form; see \textit{Ganglion}.
...
\medterm{Gangliosidosis GM2 Type 2} Alternate name; see \textit{Sandhoff Disease}.
...
\medterm{Gargoylism} Historical name for mucopolysaccharidosis, a group of inherited lysosomal-storage disorders that can affect bones, joints, organs, development, and the nervous system.

\synonyms
Bone Tumor-Epidermoid Cyst-Polyposis; Familial Adenomatous Polyposis With Osteomas
...
\medterm{Gas (Flatus)} Alternate name; see \textit{Gas – Flatulence}.
...
\medterm{Gas Gangrene (Clostridial Myonecrosis)} A rapidly progressive, often fatal infection in which Clostridium species destroy muscle and produce toxins and gas in damaged tissue. Severe pain, swelling, skin discoloration, systemic toxicity, and shock require emergency surgery, antibiotics, and intensive care.
...
\medterm{Gas Poisoning} Illness caused by inhaling a toxic gas, with effects determined by the agent: carbon monoxide and cyanide cause cellular or functional hypoxia, while chlorine, ammonia, and similar irritants injure the airways and lungs. Headache, confusion, cough, bronchospasm, pulmonary edema, seizures, or collapse may occur; identify the gas and provide immediate fresh air, oxygen, and respiratory support.
...
\medterm{Gastroesophageal Reflux Disease (GERD)} Alternate name; see \textit{Gastroesophageal Reflux Disease}.

\synonyms
GERD; Acid Reflux Disease

\medterm{Gastroesophageal Z-Line} The boundary where the lining of the lower food pipe changes to the lining of the stomach. Its position and appearance can help identify conditions such as Barrett esophagus.

\synonyms
Squamocolumnar Junction; SCJ; Ora Serrata of the Esophagus
...
\medterm{Gastrointestinal Disease and Pregnancy} Pregnancy can alter gastrointestinal motility and symptoms, while disorders such as inflammatory bowel disease, reflux, gallbladder disease, liver disease, or bowel obstruction may affect nutrition and pregnancy care. Severe pain, persistent vomiting, bleeding, fever, or dehydration requires assessment.
...
\medterm{Gastrointestinal Foreign Bodies} Objects swallowed or inserted into the gastrointestinal tract that may pass spontaneously or become lodged, cause obstruction, perforation, bleeding, or poisoning. Evaluation and removal depend on the object, location, symptoms, and risk of injury.
...
\medterm{Gastrointestinal Stromal Tumors (GISTs)} Mesenchymal tumors arising most often in the wall of the stomach or small intestine and commonly driven by KIT or PDGFRA pathway abnormalities. They may cause bleeding, pain, obstruction, or an incidental mass; risk assessment uses size, site, mitotic activity, and rupture.

\medterm{Gastrointestinal Stromal Tumors} Alternate name; see \textit{Gastrointestinal Stromal Tumors (GISTs)}.

\medterm{Gastroenteropathy, Protein Losing} Alternate name; see \textit{Protein-Losing Enteropathy}.
...
\medterm{Gaucher-Schlagenhaufer} Alternate name; see \textit{Gaucher Disease}.
...
\medterm{Generalized Essential Telangiectasia} Widespread fine superficial dilated vessels without an identifiable underlying systemic disease or localized cause. They are usually asymptomatic, but a new or rapidly progressive pattern should be assessed for medicines, connective-tissue disease, liver disease, or other secondary causes.
...
\medterm{Genital Herpes in Pregnancy} Genital herpes caused by HSV-1 or HSV-2 can be acquired, recur, or be transmitted to the newborn during pregnancy or delivery. Management considers timing of infection, lesions or prodrome at labor, antiviral therapy, and delivery planning to reduce neonatal transmission.
...
\medterm{Genital Warts} Benign anogenital growths caused most often by low-risk HPV types 6 and 11. They may be flat, raised, or cauliflower-like and may recur after treatment; the HPV types that cause visible warts are not the same high-risk types that cause most HPV-related cancers.
...
\medterm{Germ Cell Tumor Staging} Determination of the extent and risk of a germ-cell tumor using examination, imaging, tumor markers, surgical findings, and pathology. Stage and histologic type guide surgery, chemotherapy, surveillance, and prognosis.
...
\medterm{Gianotti Crosti Syndrome} Alternate spelling; see \textit{Gianotti-Crosti Syndrome}.
...
\medterm{Giant Axonal Disease} Alternate name; see \textit{Giant Axonal Neuropathy}.

\medterm{Giant Axonal Neuropathy} A rare inherited disorder in which abnormal giant nerve fibers develop, causing progressive peripheral neuropathy, weakness, loss of sensation, poor coordination, and sometimes changes in hair or skin. Onset and severity vary.
...
\medterm{Giant Cell Glioblastoma, Astrocytoma} Alternate name; see \textit{Glioblastoma Multiforme}.

\medterm{Giant Cell Glioblastoma, Multiforme} Alternate name; see \textit{Glioblastoma Multiforme}.

\medterm{Giant Cell Interstitial Pneumonia} A rare severe form of interstitial lung inflammation with multinucleated giant cells, causing cough, breathlessness, and low oxygen. It requires specialist evaluation to identify the cause and guide treatment.

\medterm{Giant Cyst of the Retina} A large fluid-filled retinal cystic lesion that can distort or damage the retina and impair vision. Evaluation typically requires a detailed eye examination and retinal imaging.

\medterm{Giant Urticaria} Alternate name; see \textit{Urticaria}.
...
\medterm{Gilbert-Lereboullet Syndrome} Alternate name; see \textit{Gilbert Syndrome}.

\medterm{Gilbert's Disease} Alternate spelling; see \textit{Gilbert Syndrome}.
...
\medterm{Gayet-Wernicke Syndrome} Alternate name; see \textit{Wernicke Encephalopathy}.

\medterm{Glandular Plague} Alternate name; see \textit{Bubonic Plague}.
...
\medterm{Glioma-Polyposis Syndrome} Alternate name; see \textit{Turcot Syndrome}.
...
\medterm{Globoid Cell Leukoencephalopathy} Alternate name; see \textit{Krabbe Disease}.
...
\medterm{Globe Rupture} A full-thickness disruption of the outer wall of the eye caused by blunt or penetrating trauma. It may result in deformity, pain, hemorrhage, loss of vision, and extrusion or prolapse of intraocular contents.
...
\medterm{Glomus Tumors} Usually benign tumors of glomus cells involved in temperature regulation and blood flow, commonly beneath a fingernail or in a fingertip. They characteristically cause severe localized pain and cold sensitivity; excision is often curative.
...
\medterm{Glossitis Areata Migrans} Alternate name; see \textit{Geographic Tongue}.

\medterm{Glossopyrosis} Alternate name; see \textit{Burning Mouth Syndrome}.
...
\medterm{Glucosamine and Chondroitin} Dietary supplements marketed for joint symptoms and cartilage support. Evidence of benefit varies, and products may interact with medicines or affect blood sugar or bleeding risk.
...
\medterm{Glucosyl Ceramide Lipidosis} Alternate name; see \textit{Gaucher Disease}.
...
\medterm{Glutathione Synthetase Deficiency} An inherited disorder caused by deficient glutathione synthetase, the enzyme needed to make glutathione. Severity ranges from hemolytic anemia and excess 5-oxoproline to metabolic acidosis, neurologic impairment, recurrent infection, or seizures.
...
\medterm{Glycogen Storage Disease Type 0 (GSD-0)} An inherited glycogen-synthase deficiency in which the liver or muscles cannot store normal amounts of glycogen. Liver disease may cause fasting ketotic hypoglycemia and post-meal hyperglycemia, while muscle disease may cause exercise intolerance, weakness, or cardiomyopathy.
...
\medterm{Goitrous Autoimmune Thyroiditis} Alternate name; see \textit{Hashimoto Thyroiditis}.
...
\medterm{GVHD} Abbreviation; see \textit{Graft Versus Host Disease}.
...
\medterm{Graham-Little-Piccardi-Lasseur Syndrome} A rare variant of lichen planopilaris characterized by scarring hair loss on the scalp, nonscarring loss of axillary or pubic hair, and follicular papules on the trunk. It is an inflammatory disorder requiring dermatologic assessment and treatment to limit permanent loss.
...
\medterm{Gram-Negative Folliculitis} Folliculitis caused by gram-negative bacteria, often after prolonged antibiotic treatment for acne or in people with impaired immunity. It produces papules and pustules, frequently on the face, and requires culture-directed treatment.
...
\medterm{Gram-Negative Toe Web Infection} Infection of the moist spaces between the toes by gram-negative bacteria, causing maceration, erosions, malodor, pain, or discharge. Moisture, occlusive footwear, and existing tinea pedis predispose; drying and appropriate antimicrobial treatment are important.
...
\medterm{Granular Cell Tumors} Usually slow-growing tumors derived from Schwann-cell-lineage tissue, most often affecting the skin, tongue, or subcutaneous tissue. Most are benign, but some are malignant; persistent or changing nodules require examination and histologic diagnosis.
...
\medterm{Granuloma Fungoides} Alternate spelling; see \textit{Mycosis Fungoides}.

\medterm{Granuloma Gluteale Infantum} A sharply defined reddish-purple inflammatory plaque in the diaper area of an infant, often related to prolonged irritant dermatitis, occlusion, or topical products. Removing irritants and treating the underlying diaper dermatitis usually leads to improvement.
...
\medterm{Granulosa Cell Tumors} Ovarian sex-cord stromal tumors that may produce estrogen or inhibin. They can cause abnormal uterine bleeding, endometrial thickening, or an abdominal mass; treatment usually involves surgical staging and long-term follow-up because late recurrence can occur.
...
\medterm{Gross Anatomy} The study of body structures visible without a microscope, including organs, body regions, bones, muscles, blood vessels, and their relationships.
...
\medterm{Group 1 Pulmonary Hypertension (PAH)} Pulmonary arterial hypertension (PAH), the Group 1 form of pulmonary hypertension, is a pre-capillary pulmonary vascular disease in which narrowed or remodeled pulmonary arteries raise vascular resistance and pressure. Causes include idiopathic or heritable disease, drugs or toxins, connective-tissue disease, HIV, portal hypertension, congenital heart disease, and schistosomiasis; diagnosis requires right-heart catheterization and evaluation for other groups.

\medterm{Group 2 Pulmonary Hypertension} Pulmonary hypertension caused by left-heart disease, including left-ventricular dysfunction, valvular disease, or congenital left-heart disorders. Treatment focuses on the underlying cardiac condition and volume status; pulmonary arterial hypertension-specific drugs are not routinely interchangeable with this group.

\medterm{Group 3 Pulmonary Hypertension} Pulmonary hypertension associated with lung disease or hypoxia, such as COPD, interstitial lung disease, sleep-disordered breathing, or chronic hypoventilation. Management emphasizes treating the lung disorder, correcting hypoxemia, and evaluating for severe or disproportionate vascular disease.

\medterm{Group 4 Pulmonary Hypertension} Pulmonary hypertension caused by pulmonary artery obstruction, most importantly chronic thromboembolic pulmonary hypertension. Patients require evaluation for persistent or recurrent thromboembolism and may benefit from anticoagulation, pulmonary endarterectomy, balloon angioplasty, or specialist medical therapy.
...
\medterm{Group B Streptococcal Neonatal Sepsis} Serious bloodstream infection caused by Group B Streptococcus in neonates, typically acquired during birth. It can cause fever, lethargy, poor feeding, and breathing difficulty; treatment includes antibiotics and supportive care.

\synonyms
Early-Onset GBS Sepsis; Neonatal Streptococcus Agalactiae Sepsis

\medterm{Group B Streptococcal Infections in Newborns} Alternate name; see \textit{Group B Streptococcal Neonatal Sepsis}.

\medterm{Group B Streptococcal Septicemia of the Newborn} Alternate name; see \textit{Group B Streptococcal Neonatal Sepsis}.
...
\medterm{Grooved Tongue} Alternate name; see \textit{Fissured Tongue}.

\medterm{Grover's Disease} Alternate spelling; see \textit{Grover Disease}.
...
\medterm{Growth Hormone Deficiency in Adults} Inadequate growth-hormone secretion in adulthood, usually due to hypothalamic or pituitary disease or prior treatment. It may affect body composition, bone density, exercise capacity, lipids, and quality of life and requires confirmatory endocrine testing.

\medterm{GHD} Abbreviation; see \textit{Growth Hormone Deficiency}.
...
\medterm{Guinea Worm Infection} Alternate name; see \textit{Guinea Worm}.
...
\medterm{Guenther Porphyria} Alternate spelling; see \textit{Gunther Disease}.
...
\medterm{Guttate Scleroderma, Lichen Sclerosus Type} Alternate name; see \textit{Lichen Sclerosus}.
...
\medterm{Gynecologic Pain} Pain arising from the vulva, vagina, cervix, uterus, tubes, ovaries, pelvic floor, or related nerves and organs. Causes include infection, endometriosis, cysts, torsion, pregnancy complications, malignancy, musculoskeletal disease, and neuropathic or chronic pain.

\medterm{Gynecologic Tumor Markers} Blood or tissue measurements that may support diagnosis, staging, treatment selection, or monitoring of gynecologic tumors. They are not usually diagnostic alone because benign conditions and other cancers can also alter marker levels.
