...
\medterm{Graft Versus Host} Alternate index label; see \textit{Graft Versus Host Disease}.
...
\medterm{Graft-Versus-Host Disease} Alternate index label; see \textit{Graft Versus Host Disease}.
