...
\medterm{Lipid Profile} Alternate index label; see \textit{Lipid Panel}.

\medterm{Lipid Profile Test} Alternate index label; see \textit{Lipid Panel}.
...
\medterm{Lower Gastrointestinal Bleeding} Bleeding from the colon, rectum, or anus. It often appears as bright-red or maroon blood in stool, but the amount and appearance vary; heavy bleeding, dizziness, fainting, or weakness requires emergency care.
...
\medterm{Lower Segment Cesarean Section} Alternate index label; see \textit{Cesarean Section}.
\synonyms
...
\medterm{Lumbar Spondylosis} Alternate index label; see \textit{Spondylosis}.
...
\medterm{Lung Cancer - Small Cell} Alternate index label; see \textit{Small cell lung cancer}.
...
\medterm{Lupus Erythematosus (Systemic Lupus Erythematosus - SLE)} Alternate index label; see \textit{Systemic lupus erythematosus}.
...
\medterm{Lymphoma (Hodgkin's And Non-Hodgkin's)} Alternate combined term; see \textit{Lymphoma}.

\medterm{Lymphoma, Hodgkin} Alternate index label; see \textit{Hodgkin lymphoma}.
