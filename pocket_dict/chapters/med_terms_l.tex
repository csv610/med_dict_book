...
\medterm{Labbe Vein} The inferior anastomotic vein of the cerebral cortex that traverses the surface of the temporal lobe, establishing an anastomotic venous connection between the superficial middle cerebral vein (Sylvian vein) and the transverse dural venous sinus.
\synonyms
...
\medterm{Laceration Suture and Staple Care} Home-care instructions and wound hygiene protocols following wound closure with sutures or staples. Involves keeping the incision clean and dry for the initial 24--48 hours, daily inspection for signs of wound infection (erythema, purulent exudate, localized warmth), gentle cleansing, and scheduled removal by a clinician.

\synonyms
Suture Home Care; Staple Wound Management; Laceration Closure Care

\medterm{Lachman Sign} The main test for a torn knee ligament (ACL); with the knee slightly bent, the doctor pulls the shin forward to check if the joint is loose.
...
\medterm{Lacquer Poisoning} Harm from swallowing or breathing lacquer or its solvents. It may irritate the mouth and lungs, cause dizziness or drowsiness, and cause severe lung injury if liquid enters the lungs.
...
\medterm{Lacrimal Sac} A small sac at the inner corner of the eye that collects tears before they pass through the lacrimal duct into the nose.
...
\medterm{Lactase Deficiency} Alternate name; see \textit{Lactose Intolerance}.
...
\medterm{Lactation} The production and release of breast milk after childbirth. Early milk, called colostrum, is followed by mature milk; hormones help make and release the milk.

\synonyms
Milk Secretion; Galactopoiesis
...
\medterm{Lactation Mastitis} Alternate name; see \textit{Mastitis}.
...
\medterm{Lactiferous Duct} One of 15 to 20 excretory ducts in the female mammary gland that drains milk from glandular lobules toward the nipple, expanding into a lactiferous sinus beneath the areola before opening onto the nipple surface.

\synonyms
Galactophore; Mammary Duct
...
\medterm{Lacunar Infarct} A small stroke in a deep part of the brain caused by blockage of one of the small arteries supplying that area. It can affect movement, feeling, speech, or coordination, depending on the location.
\synonyms
Lacunar Stroke; Subcortical Small Vessel Infarction
...
\medterm{Lacunar Syndromes (Small-Vessel Strokes)} Clinical patterns caused by small deep cerebral infarcts in penetrating-artery territories. Recognized patterns include pure motor hemiparesis, pure sensory stroke, sensorimotor stroke, ataxic hemiparesis, and dysarthria–clumsy-hand syndrome.
...
\medterm{Lamina Cribrosa} A fenestrated, mesh-like collagenous sheet of the sclera through which unmyelinated axons of retinal ganglion cells exit the eye to form the optic nerve; the primary site of axonal injury and excavation in glaucoma.
...
\medterm{Lancet} A small, sterile, usually single-use device with a sharp point used to puncture the skin and obtain a capillary-blood sample. Lancets are commonly used for fingertip glucose testing and other point-of-care blood tests.

\synonyms
Blood Lancet; Fingerstick Lancet
...
\medterm{Lanolin Poisoning} Swallowing a small amount of lanolin, a wool-derived moisturizer, usually causes little more than stomach upset. Large amounts or products with added medicines can cause more serious poisoning.
...
\medterm{Laparoscopy} Keyhole surgery that uses a small camera and instruments through small cuts in the abdomen or pelvis. It can be used to look for a problem, take a sample, or treat conditions such as appendicitis, gallstones, endometriosis, or an ectopic pregnancy. Recovery is often easier than after open surgery, but risks and recovery time depend on the procedure.

\synonyms
Keyhole Surgery; Minimally Invasive Abdominal Surgery; Diagnostic Laparoscopy; Laparoscopic Surgery
...
\medterm{Laplace Law} A biophysical principle stating that the wall tension ($T$) in a hollow sphere or cylinder is directly proportional to the transmural pressure ($P$) times the radius ($r$) divided by wall thickness (or $2 \times$ thickness for a sphere), explaining ventricular wall stress in cardiac dilation and alveolar stability with surfactant.
...
\medterm{Large Bowel Obstruction} A blockage in the colon, commonly caused by cancer, twisting of the bowel, scar tissue, or diverticular disease. It can cause increasing swelling, cramping, vomiting, and inability to pass stool or gas.
...
\medterm{Luteinized Follicle Cyst} A usually harmless ovarian cyst that develops during pregnancy as hormone-sensitive ovarian tissue enlarges. It may be found by chance or as a pelvic mass and often settles after pregnancy.
...
\medterm{Laryngeal Papillomatosis} Benign papillomatous growths caused by HPV in the larynx or respiratory tract. They may cause hoarseness, stridor, or airway obstruction.
...
\medterm{Laryngomalacia} A birth condition in which soft tissue above an infant’s vocal cords partly collapses during breathing in, causing noisy breathing. It often improves with growth, but feeding trouble, pauses in breathing, or poor growth may occur.
...
\medterm{Laryngostenosis} Narrowing of the voice box, or larynx, that can restrict breathing. Causes include scarring after intubation, injury, inflammation, tumors, and congenital narrowing; noisy breathing or breathlessness may occur.

\medterm{Laryngotracheobronchitis} Alternate name; see \textit{Croup}.
...
\medterm{Larynx Cancer} Laryngeal cancer is a malignant tumor of the voice box and may cause persistent hoarseness, swallowing pain, neck mass, ear pain, cough, or breathing difficulty. Examination and biopsy are used for diagnosis; treatment depends on site and stage.

\synonyms
Laryngeal Carcinoma; Cancer of the Voice Box
...
\medterm{Lasegue Sign} A physical examination test for lumbosacral nerve root irritation (radiculopathy / sciatica, particularly L4, L5, or S1); with the patient supine, passive straight leg raising of the symptomatic leg provokes sharp radicular pain radiating down the posterior leg below the knee between 30 and 70 degrees of hip flexion.
\synonyms
...
\medterm{Late Decelerations} A repeated, gradual slowing of a baby’s heart rate that starts after a uterine contraction begins and recovers after the contraction ends. It can indicate reduced oxygen transfer through the placenta during labor.
...
\medterm{Late Preterm Birth} Births occurring from 34 weeks 0 days through 36 weeks 6 days of gestation. These infants have
...
\medterm{Lateral Cutaneous Nerve of the Thigh} A sensory nerve arising from the L2 and L3 ventral rami of the lumbar plexus that passes under the lateral end of the inguinal ligament to provide sensation to the anterolateral thigh; entrapment here causes meralgia paresthetica.
...
\medterm{Lateral Elbow Tendinopathy} Alternate name; see \textit{Tennis Elbow}.

\medterm{Lateral Epicondylitis} Alternate medical name; see \textit{Tennis Elbow}.

\synonyms
Lateral Epicondylitis (Tennis Elbow)

\medterm{Lateral Epicondylosis} Alternate name; see \textit{Tennis Elbow}.

\medterm{Lateral Geniculate Nucleus} A laminated thalamic sensory relay nucleus that receives visual information directly from retinal ganglion cell axons via the optic tract and projects through the optic radiations (geniculocalcarine tract) to the primary visual cortex (Brodmann area 17).

\synonyms
LGN; Lateral Geniculate Body

\medterm{Lateral Medullary Syndrome} A stroke in the outer part of the lower brainstem. It may cause dizziness, poor coordination, trouble swallowing or speaking, loss of feeling on one side of the face, and loss of pain or temperature sensation on the opposite side of the body.
\synonyms
...
\medterm{Lateral Pontine Syndrome} A stroke in the outer part of the bridge-like section of the brainstem. It may cause facial weakness, hearing loss, dizziness, poor coordination, and loss of pain or temperature sensation on the opposite side of the body.

\synonyms
Marie-Foix Syndrome; AICA Infarction Syndrome
...
\synonyms
Natural Rubber Latex Allergy; NRL Allergy
...
\medterm{Lattice Degeneration} A peripheral retinal degeneration characterized by elongated areas of retinal thinning, pigment changes, and abnormal vessels. It can increase the risk of retinal tears or detachment in some people.
...
\medterm{Laxative Overdose} Taking too much laxative can cause severe diarrhea, vomiting, dehydration, and abnormal body salts. Some products can disturb heart rhythms or damage the bowel, especially after large exposures or in children.

\medterm{Laxatives For Constipation} Laxatives relieve constipation through fiber and water retention, stool softening, osmotic effects, or increased bowel contractions. The suitable type depends on the cause, duration, age, medicines, kidney function, and risk of blockage; persistent bleeding, vomiting, or severe pain may indicate another condition.

\synonyms
Aperients; Cathartics; Purgatives
...
\medterm{LCIS} Abbreviation; see \textit{Lobular Carcinoma In Situ}.
...
\medterm{Leadless Pacemaker} A small pacemaker placed directly inside a heart chamber without a conventional chest pocket or transvenous lead. It provides pacing for selected slow or unreliable heart rhythms; device selection depends on the person’s cardiac anatomy and pacing needs.

\medterm{Lead Pipe Rigidity} Constant stiffness that gives the same resistance throughout a joint’s movement. It may occur in severe movement disorders, advanced Parkinson disease, or neuroleptic malignant syndrome.
\synonyms
Plastic Rigidity; Extrapyramidal Lead-Pipe Hypertonia

\medterm{Lead-Pipe Rigidity} Smooth, continuous muscle stiffness where an arm or leg resists movement evenly in every direction, like bending a lead pipe.
...
\medterm{Lead Toxicity and Nutrition} Nutritional strategies and dietary interventions aimed at minimizing intestinal absorption of ingested lead, particularly in young children. Adequate dietary intake of iron, calcium, zinc, and vitamin C competitively inhibits divalent metal transporter 1 (DMT1) uptake of lead.

\synonyms
Nutritional Lead Protection; Dietary Prevention of Lead Absorption
...
\medterm{Lecithin-Sphingomyelin Ratio} A laboratory ratio measured on amniotic fluid obtained via amniocentesis to evaluate fetal pulmonary maturity and the risk of neonatal respiratory distress syndrome. Lecithin (dipalmitoylphosphatidylcholine) concentrations rise sharply relative to constant sphingomyelin levels after 35 weeks of gestation; an L/S ratio of 2.0 or greater indicates adequate pulmonary surfactant production.

\synonyms
L/S Ratio; Amniotic Fluid Lecithin-Sphingomyelin Ratio
...
\medterm{Le Fort Fractures} A classical orthopedic and maxillofacial classification of traumatic midface fractures based on René Le Fort's lines of structural facial weakness. Subdivided into Le Fort I (horizontal maxillary fracture separating the dental arch from the upper midface), Le Fort II (pyramidal fracture extending through the nasal bones, ethmoid, and maxillary sinus walls), and Le Fort III (complete craniofacial disjunction separating the facial skeleton from the cranial base).

\synonyms
Le Fort Midface Fractures; Maxillofacial Le Fort System
...
\medterm{Left Anterior Fascicular Block} A cardiac intraventricular conduction defect caused by delay or block in the thin anterior fascicle of the left bundle branch, manifesting on electrocardiogram as marked left axis deviation (between -45 and -90 degrees), small Q waves in leads I and aVL, and small R waves in leads II, III, and aVF.
...
\medterm{Left Bundle Branch Block} Delay or interruption of electrical signals through the left bundle branch. It changes the ECG pattern and may reflect heart disease, although some people have no symptoms.
...
\medterm{Left Ventricular Assist Device} A pump placed in or near the heart to help the left side pump blood in advanced heart failure. A cable connects the pump to a controller and batteries outside the body. It may support someone while waiting for a transplant or provide long-term support when a transplant is not suitable. It can cause bleeding, infection, clots, or stroke and needs close follow-up.

\synonyms
LVAD; Left Ventricular Assist System; Mechanical Circulatory Support; Ventricular Assist Device
...
\medterm{Left Ventricular Non-Compaction} A genetic cardiomyopathy resulting from the arrest of normal embryonic myocardial compaction, characterized by prominent ventricular trabeculations and deep intertrabecular recesses ("spongy myocardium"), predisposing to heart failure, systemic thromboembolism, and ventricular arrhythmias.
...
\medterm{Leg Fracture} Alternate name; see \textit{Broken Leg}.
...
\medterm{Legionella Pneumonia} Pneumonia caused by Legionella bacteria, usually after inhaling contaminated water droplets. It can cause high fever, cough, breathlessness, diarrhea, confusion, and low oxygen.
...
\medterm{Legionnaire Disease And Pontiac Fever} Legionnaires disease is a severe pneumonia caused by Legionella, while Pontiac fever is a milder flu-like illness from the same bacteria. Exposure to contaminated water systems is typical; pneumonia, confusion, low oxygen, or high fever may occur in the more serious illness.

\synonyms
Legionellosis; Legionella Infection
...
\medterm{Legionnaires Disease} A severe pneumonia caused by Legionella, usually acquired by inhaling contaminated water aerosols or aspiration. Fever, cough, breathlessness, diarrhea, confusion, and low sodium may occur; laboratory testing and prompt active treatment are important because routine beta-lactams do not cover Legionella reliably.
...
\medterm{Leigh Syndrome} A rare inherited disorder of cellular energy production, usually beginning in infancy or childhood. It can damage the brainstem and deep brain areas, causing loss of developmental skills, movement problems, seizures, and breathing difficulties.
\synonyms
Subacute Necrotizing Encephalomyelopathy; Mitochondrial Leigh Disease
...
\medterm{Lenegre Disease} An idiopathic, sclerodegenerative process characterized by slowly progressive fibrocalcific degeneration and loss of conduction fibers within the His-Purkinje system, leading to bundle branch blocks, bifascicular block, and spontaneous complete atrioventricular block in middle-aged individuals.
\synonyms
Lenègre-Lev Disease; Primary Conduction System Sclerosis
...
\medterm{Lentigines} Alternate plural name; see \textit{Lentigo}.
...
\medterm{Leopold Maneuvers} A set of gentle abdominal examinations used to estimate the baby’s position and which part is presenting before birth. The findings help guide care but may be limited by body size, fluid level, or the baby’s movement and are confirmed with other assessment when needed.
...
\medterm{Leprosy} A long-term infection caused mainly by bacteria that affect the skin and cooler nerves in the arms, legs, and face. It can cause pale or reddish patches with reduced feeling, thickened nerves, weakness, and eye or nose problems. A skin sample or other tests may confirm it. Treatment uses several antibiotics, commonly rifampicin, dapsone, and clofazimine, to prevent lasting nerve damage and disability.
...
\medterm{Leptomeningeal Metastases} Spread of cancer cells to the pia and arachnoid membranes or cerebrospinal fluid. It may cause headache, nausea, cranial-nerve findings, radicular pain, weakness, sensory change, or bladder dysfunction; MRI and cerebrospinal-fluid testing support diagnosis.

\medterm{Leptomeningeal Metastasis} Spread of cancer to the thin membranes and fluid surrounding the brain and spinal cord. It can cause headache, vomiting, weakness, confusion, seizures, or changes in vision and is treated according to the cancer type and extent.
...
\medterm{Leptospirosis} A bacterial infection caused by spiral-shaped \textit{Leptospira} bacteria, usually spread when cut skin or eyes touch water, mud, or soil contaminated with the urine of infected animals, especially rats and farm animals. Symptoms often begin suddenly with fever, severe headache, intense calf and lower back muscle pain, and characteristic red eyes without discharge (conjunctival suffusion). A severe form, known as Weil's disease, can develop rapidly, causing yellow skin and eyes (jaundice), kidney failure, severe bleeding, and lung hemorrhage. Diagnosis is made through blood tests, antibody tests, or PCR. Mild cases are treated with oral antibiotics like doxycycline, while severe cases require intravenous penicillin or ceftriaxone in a hospital.

\synonyms
Canefield Fever; Canicola Fever; Seven-Day Fever; Weil's Disease

\synonyms
Weil's Disease; Leptospira Infection; Mud Fever; Canicola Fever
...
\medterm{Leri-Weill Dyschondrosteosis} A rare autosomal dominant pseudoautosomal skeletal dysplasia caused by haploinsufficiency of the short stature homeobox (SHOX) gene on the X and Y chromosomes, characterized by disproportionate mesomelic short stature, shortened forearms and lower legs, and bilateral Madelung wrist deformity.
\synonyms
Leri-Weill Syndrome; SHOX Deficiency Mesomelic Dysplasia
...
\medterm{Lesser Omentum} A fold of tissue that connects the liver to the lesser curvature of the stomach and the first part of the small intestine. It contains blood vessels, ducts, nerves, and lymph vessels.

\medterm{Lesser Peritoneal Cavity} The peritoneal recess behind the stomach and lesser omentum, also called the lesser sac or omental bursa. It communicates with the greater peritoneal cavity through the epiploic foramen.
...
\medterm{Lethal Triad} A dangerous combination of low body temperature, excess acid in the blood, and poor blood clotting. It can develop after severe injury or major bleeding, and each problem can worsen the others.

\medterm{Lethargy} Lethargy is reduced energy, alertness, or responsiveness; it may result from sleep loss, infection, metabolic disease, medicines, depression, or neurologic illness. Sudden marked lethargy can occur with serious illness.
...
\medterm{Letterer-Siwe Disease} An acute, disseminated, aggressive multisystem form of Langerhans cell histiocytosis occurring in infants and toddlers under 2 years of age, characterized by cutaneous seborrheic and purpuric eruptions, osteolytic bone lesions, hepatosplenomegaly, lymphadenopathy, and pancytopenia.
\synonyms
Acute Disseminated LCH; Multisystem Langerhans Histiocytosis
...
\medterm{Leucoplakia} A persistent white patch on a moist body lining, often inside the mouth, that cannot be wiped away. It may result from irritation and sometimes contains changes that can precede cancer.
...
\medterm{Leukaemia} Alternate spelling; see \textit{Leukemia}.
...
\medterm{Leukemia} Cancer that starts in blood-forming tissue, usually the bone marrow, and produces large numbers of abnormal blood cells. These cells can crowd out healthy white blood cells, red blood cells, and platelets, making it harder to fight infection, carry oxygen, and stop bleeding. This may cause tiredness, repeated infections, easy bruising, or bleeding. Leukemia usually does not form a solid tumor. It is grouped as acute or chronic according to how quickly it progresses and as lymphoid or myeloid according to the type of blood-forming cell involved.

\synonyms
Hematologic Malignancy; Blood Cancer

\medterm{Leukemia Cutis} A condition in which leukemia cells collect in the skin, causing firm red, purple, or brown bumps, nodules, or patches. It often accompanies acute myeloid leukemia and reflects the underlying blood cancer.
...
\medterm{Leukocoria} A white or pale reflection appearing in the pupil instead of the normal red reflection. It may result from cataract, retinal disease, infection, or a tumor such as retinoblastoma and is especially important in infants and children.
...
\medterm{Leukocytosis in Pregnancy} A mild rise in white blood cells can be normal during pregnancy, labor, or stress. Marked or persistent elevation with fever, pain, urinary or respiratory symptoms, or abnormal differential counts may indicate infection, inflammation, medication effect, or another disorder.

\medterm{Leukoderma} Loss of skin pigment producing sharply defined pale or white patches, usually because melanocytes have been destroyed or have stopped functioning.

\synonyms
Hypopigmentation; Achromoderma
...
\medterm{Leukonychia Striata} Longitudinal white bands running along the nail plate, usually caused by changes in the nail matrix. They may be inherited or follow repeated minor trauma, skin disease, or some medicines; persistent or widespread changes can be linked to other illness.

\medterm{Leukonychia Totalis} Uniform white discoloration involving most or all of one or more nail plates. It is often inherited but can occasionally be associated with illness or medication; persistent changes affecting many nails can occur with other conditions.
...
\medterm{Leukorrhea} Whitish vaginal discharge that may be normal, especially during hormonal changes, or may result from infection or inflammation. Foul odor, itching, pain, bleeding, or a new change may suggest an underlying condition.
...
\medterm{Leukotriene Modifiers} Medicines that reduce the production or effects of leukotrienes, inflammatory chemicals that narrow airways and cause allergy symptoms. They help prevent some asthma or allergy problems but do not usually relieve a sudden asthma attack.
...
\medterm{Levator Ani Muscle} A broad, symmetrical muscular sheet forming the major constituent of the pelvic diaphragm, composed of the puborectalis, pubococcygeus, and iliococcygeus muscles, which supports the pelvic viscera and maintains urinary and fecal continence.

\medterm{Levator Ani Syndrome} A chronic functional anorectal pain disorder characterized by episodic or continuous dull aching, fullness, or pressure sensation in the rectum and perineum that is aggravated by prolonged sitting, associated with tenderness and spasm of the levator ani and puborectalis muscle on digital rectal palpation.
\synonyms
Chronic Proctalgia; Levator Spasm Syndrome

\medterm{Lev Disease} An acquired degenerative disorder of the cardiac conduction system characterized by progressive idiopathic sclerosis and fibrocalcification of the fibrous cardiac skeleton, atrioventricular node, and proximal bundle branches, leading to high-grade atrioventricular block and syncope in elderly patients.

\synonyms
Lenegre-Lev Disease; Idiopathic Conduction System Sclerosis
...
\medterm{Levine Sign} A physical examination finding in which a patient instinctively places a clenched fist over the sternum when describing ischemic chest pain, serving as a classic nonverbal clinical indicator of angina pectoris or acute myocardial infarction.
\synonyms
Levine's Sign; Clenched Fist Chest Pain Sign
...
\medterm{Löfgren Syndrome} A sudden form of sarcoidosis causing swollen lymph nodes near the lungs, tender red lumps on the shins, and painful swollen ankles. It often improves over time; involvement of other organs can occur.
...
\medterm{Lhermitte-Duclos Disease} A rare, usually slow-growing abnormal area in the cerebellum, the part of the brain that helps control balance and movement. It may cause headache, dizziness, poor coordination, or seizures and can be associated with PTEN-related conditions, but it is not by itself proof of one diagnosis.
\synonyms
Dysplastic Gangliocytoma of the Cerebellum; Cerebellar Hamartoma

\medterm{Lhermitte Sign} A sudden electric shock-like sensation that travels down the neck and back into the arms or legs when bending the head forward, often seen in multiple sclerosis.
...
\medterm{Libman-Sacks Endocarditis} A sterile, nonbacterial endocardial valvulopathy with verrucous vegetations, most strongly associated with systemic lupus erythematosus and antiphospholipid syndrome. It usually affects the mitral or aortic valve and may cause regurgitation or systemic emboli; infective endocarditis must be excluded when vegetations or fever are present.

\synonyms
Marantic Endocarditis; Verrucous Endocarditis; Nonbacterial Verrucous Endocarditis
...
\medterm{Lice Infestation} Alternate term; see \textit{Lice}.

\medterm{Lice Infestations} Alternate plural form; see \textit{Lice}.
...
\medterm{Lichen Amyloidosis} A localized cutaneous amyloidosis causing intensely itchy, rough, hyperkeratotic papules, commonly on the shins or upper back. The deposited amyloid usually derives from damaged keratinocytes and remains confined to the skin.
...
\medterm{Lichen Myxedematosus} A group of rare disorders in which mucin accumulates in the skin, producing firm papules, plaques, or diffuse thickening. The generalized form may be associated with monoclonal gammopathy and internal-organ disease, whereas localized forms may remain confined to the skin.

\medterm{Lichen Nitidus} A benign inflammatory skin disorder causing numerous tiny, shiny, flat-topped, skin-colored or pink papules, commonly on the trunk, arms, genital area, or hands. It is often asymptomatic and may resolve spontaneously, although itch or extensive disease may need treatment.
...
\medterm{Lichen Planus} A noncontagious, immune-mediated inflammatory condition that can affect the skin, mouth, genitals, nails, scalp, or hair follicles. On the skin it often causes itchy, shiny, flat-topped red, purple, brown, or gray bumps, especially on the wrists, ankles, or lower back. In the mouth it may cause a lacy white pattern, soreness, or ulcers; genital disease may cause soreness or erosions; nail disease can cause ridges, thinning, splitting, or loss; and scalp disease can cause scarring hair loss. The exact cause is not known.

\synonyms
Lichen Ruber Planus; Cutaneous Lichen Planus

\medterm{Lichen Ruber Planus} Alternate name; see \textit{Lichen Planus}.
...
\medterm{Lichen Spinulosus} A benign follicular eruption of grouped, rough, spiny papules, often forming round or oval plaques on the trunk, buttocks, or limbs. It commonly begins in childhood or adolescence and may fade spontaneously.
...
\medterm{Licorice Poisoning} Excess glycyrrhizin from licorice inhibits 11-beta-hydroxysteroid dehydrogenase type 2 and produces apparent mineralocorticoid excess. Hypertension, hypokalemia, metabolic alkalosis, edema, weakness, and dysrhythmias may occur; stop the source and correct potassium and blood pressure under medical supervision.
...
\medterm{Ligamentum Flavum} A series of paired, thick elastic ligaments connecting the laminae of adjacent vertebrae from the axis to the sacrum, whose high elastin content imparts a characteristic yellow color and helps preserve the upright posture while preventing excessive spinal flexion.

\medterm{Ligamentum Teres Hepatis} The obliterated fibrous remnant of the embryonic left umbilical vein that carried oxygenated blood from the placenta to the fetus, running within the free inferior border of the falciform ligament from the umbilicus to the left branch of the portal vein.
...
\medterm{Light Chain-Associated Kidney Disease} Kidney injury caused by abnormal immunoglobulin light chains produced by a plasma-cell or B-cell clone. Light chains may cause cast nephropathy, amyloid, or other deposits, leading to proteinuria, acute kidney injury, or chronic kidney disease.

\medterm{Light-Chain Deposition Disease} A monoclonal plasma-cell disorder in which non-amyloid immunoglobulin light chains deposit along kidney and sometimes other organ structures. It commonly causes proteinuria, high blood pressure, declining kidney function, or nephrotic syndrome.
...
\medterm{Lighter Fluid Poisoning} Harm from swallowing or breathing lighter fluid, a hydrocarbon. The greatest danger is liquid entering the lungs, causing chemical pneumonia, cough, or breathing difficulty.
...
\medterm{Lightning Injuries} Injuries caused by direct or indirect lightning exposure, potentially affecting the heart, nervous system, skin, hearing, muscles, and lungs. Cardiac arrest, neurologic deficits, burns, trauma from falls, and temporary skin branching may occur.
...
\medterm{Lily Of The Valley Poisoning} Poisoning from eating lily-of-the-valley plant parts, which contain substances that can disrupt the heartbeat. Nausea, vomiting, dizziness, slow or irregular pulse, confusion, or fainting may occur.
...
\medterm{Limb-Length Discrepancy} A difference in the lengths of the two legs or, less commonly, the two arms. It may result from growth differences, injury, infection, surgery, or a developmental condition and can affect posture, walking, and joint loading.
...
\medterm{Lindsay's Nails} A distinctive nail abnormality in which the proximal forty to fifty percent of the nail bed is white and opaque while the distal fifty to sixty percent is pink, red, or brownish. It is strongly associated with chronic kidney disease and uraemia.
...
\medterm{Linea Alba} A dense, fibrous median collagenous band formed by the interlacing decussating aponeuroses of the external oblique, internal oblique, and transversus abdominis muscles, extending vertically from the xiphoid process to the pubic symphysis.
...
\medterm{Lines of Blaschko} Non-random developmental cutaneous pathways representing the routes of epidermal cell migration and clonal proliferation during embryogenesis, which become apparent in X-linked mosaic and cutaneous mosaic disorders (such as incontinentia pigmenti and linear epidermal nevi).
\synonyms
Blaschko Lines; Blaschko's Tracks

\medterm{Lines of Zahn} Microscopic and gross alternating pale and dark laminations seen in arterial and intracardiac thrombi formed in rapid pulsatile blood flow, composed of pale layers of platelets and fibrin mesh alternating with dark layers of trapped red blood cells, distinguishing antemortem thrombi from postmortem clots.
\synonyms
Zahn Lines; Laminations of Zahn
...
\medterm{Lip Cancer} Cancer developing in the tissue of the upper or lower lip. It may appear as a persistent sore, lump, crust, bleeding area, numbness, or color change.
...
\medterm{Lipid A} The part of a substance on the outer surface of some bacteria that triggers a strong immune reaction. Large amounts can contribute to widespread inflammation, shock, and abnormal clotting.
...
\medterm{Lipid Panel} A routine blood test measuring circulating blood fats to assess heart and blood vessel disease risk. It measures four key markers: total cholesterol, LDL cholesterol (often termed "bad" cholesterol because it contributes to artery-clogging plaque), HDL cholesterol ("good" cholesterol that helps clear excess fat from arteries), and triglycerides (stored fat used for energy). It evaluates risk for heart attacks and strokes, helps guide diet and lifestyle changes, and monitors response to cholesterol-lowering medicines such as statins.
\synonyms
Lipid Profile; Cholesterol Panel; Coronary Risk Panel; Lipid Profile Test

\medterm{Lipid Profile} Alternate name; see \textit{Lipid Panel}.

\medterm{Lipid Profile Test} Alternate name; see \textit{Lipid Panel}.
...
\medterm{Lip Infection} Infection of the lip caused by bacteria, viruses, fungi, or an infected wound. It may cause pain, redness, swelling, blisters, cracks, pus, or fever; rapidly spreading swelling or breathing difficulty may occur in a serious infection.

\medterm{Lipitor} Lipitor is a brand name for atorvastatin, a statin medicine that lowers low-density lipoprotein cholesterol and reduces the risk of heart attack and stroke. Muscle symptoms and liver-related effects are possible.
...
\medterm{Lipodermatosclerosis} A chronic fibrosing inflammatory panniculitis of the subcutaneous adipose tissue of the lower extremity secondary to severe chronic venous insufficiency, producing induration, hyperpigmentation, and the classic "inverted champagne bottle" leg appearance.
...
\medterm{Lipohypertrophy} A firm or lumpy buildup of fat under the skin, often at repeated insulin-injection sites. Injecting into these areas can change how insulin is absorbed.
...
\medterm{Lipoma} A common benign tumor made of mature fat cells. It is usually soft, movable, painless, and slow-growing beneath the skin of the trunk, neck, or limbs; a deep, firm, painful, or rapidly enlarging fatty lump needs assessment to distinguish it from other tumors.

\medterm{Lipomas} Plural of lipoma; see \textit{Lipoma}.

\medterm{Lipomastia} Alternate name; see \textit{Pseudogynecomastia}.
...
\medterm{Lipoprotein(a)} An independent, genetically determined causal risk factor for atherosclerotic cardiovascular disease and calcific aortic valve stenosis, consisting of an LDL-like particle covalently linked by a disulfide bond to a highly polymorphic, plasminogen-like glycoprotein called apolipoprotein(a).
...
\medterm{Lip Swelling} Enlargement of one or both lips caused by local injury, infection, inflammation, dental disease, medication, or angioedema. Sudden swelling with tongue or throat swelling, breathing difficulty, wheezing, faintness, or widespread hives may indicate a severe allergic reaction.
...
\medterm{Liquid Bandage for Lacerations} Application of topical cyanoacrylate tissue adhesives to seal minor, clean, low-tension superficial lacerations and abrasions. Provides a waterproof antimicrobial barrier that sloughs off naturally as epidermal re-epithelialization occurs over 5--10 days.

\synonyms
Tissue Adhesive Closure; Topical Skin Glue; Cyanoacrylate Liquid Bandage

\medterm{Liquid Biopsy} A non-invasive laboratory technique that analyzes tumor-derived biomarkers, including circulating tumor cells, cell-free circulating tumor DNA (ctDNA), and exosomes isolated from peripheral blood or other bodily fluids for cancer detection and genomic profiling.
...
\medterm{Lisfranc Fracture} A severe midfoot injury characterized by fracture, subluxation, or dislocation of the tarsometatarsal joints, classically involving disruption of the strong Lisfranc ligament connecting the medial cuneiform to the base of the second metatarsal bone.
\synonyms
Lisfranc Joint Complex Injury; Tarsometatarsal Fracture-Dislocation

\medterm{Lisfranc Injury} A spectrum of traumatic fracture-dislocations involving the tarsometatarsal articulation of the midfoot, typically disrupting the critical Lisfranc ligament extending between the medial cuneiform and the base of the second metatarsal.
...
\synonyms
Listeria Species; Listerial Infection
...
\medterm{Lithium Nephropathy} Kidney injury related to long-term or toxic lithium exposure, most often causing impaired urine concentration and excessive urination, and sometimes chronic tubulointerstitial scarring or hyperparathyroidism. Monitoring lithium levels, kidney function, and calcium helps reduce risk.

\medterm{Lithium Toxicity} Poisoning caused by too much lithium in the body, often after dehydration, illness, a dose change, or a medicine interaction. Nausea, diarrhea, worsening tremor, weakness, confusion, poor coordination, seizures, or reduced consciousness may occur.
...
\medterm{Lithotripsy} A medical procedure that breaks hard mineral stones located in the kidneys, ureters, bladder, or gallbladder into tiny, sand-like fragments so they can pass out of the body naturally in the urine or be removed. The most common form is Extracorporeal Shock Wave Lithotripsy (ESWL), a completely non-invasive technique that generates high-energy acoustic shock waves outside the body and focuses them through the skin and soft tissues onto the stone under X-ray or ultrasound guidance, shattering it into dust without cuts or incisions. When stones are very dense, stuck low in the ureter, or unsuitable for ESWL, intracorporeal or laser lithotripsy is used, where a thin endoscope is threaded up the urinary tract and a fine holmium laser fiber fragments the stone under direct camera visualization. Lithotripsy relieves the severe cramping flank pain (renal colic) and prevents kidney obstruction and recurrent urinary tract infections caused by large stones.

\synonyms
Extracorporeal Shock Wave Lithotripsy; ESWL; Laser Lithotripsy; Stone Fragmentation
...
\medterm{Liver Anatomy and Physiology} Alternate name; see \textit{Liver}.
...
\medterm{Liver Cancer} A malignant tumor involving the liver. Primary liver cancers begin in liver cells or bile-duct cells, with hepatocellular carcinoma the most common primary type in adults. Cancer that begins elsewhere and spreads to the liver is metastatic liver cancer and is more common than primary liver cancer. Risk factors for primary liver cancer include cirrhosis, chronic viral hepatitis, alcohol-related liver injury, fatty-liver inflammation, and some toxins.

\synonyms
Hepatic Malignancy; Hepatocellular Carcinoma; HCC
...
\medterm{Liver Disease and Pregnancy} Liver disorders may begin during pregnancy or predate it and can affect maternal health, fetal growth, medication choices, and timing of delivery. Abnormal liver tests, jaundice, severe itching, right-upper-abdominal pain, vomiting, or high blood pressure require prompt assessment.
...
\medterm{Liver Diseases} Disorders of the liver, including hepatitis, fatty liver, cirrhosis, tumors, and biliary disease, that can impair metabolism and detoxification.
...
\medterm{Liver Elastography} A noninvasive ultrasound- or MRI-based test that estimates liver stiffness. It helps assess scarring (fibrosis) and cirrhosis, but stiffness can also rise from inflammation, congestion, or other conditions and must be interpreted with other findings.
...
\medterm{Liver Function} Alternate name; see \textit{Liver Function Tests}.
...
\medterm{Liver Pain} Discomfort in the upper-right abdomen that may arise from the liver, gallbladder, bile ducts, stomach, muscles, or other organs. Persistent pain, jaundice, fever, vomiting, or confusion may indicate an underlying illness.
...
\medterm{Liver Spots} Alternate name; see \textit{Age Spots}.
...
\medterm{Livor Mortis} Post-mortem purplish-red discoloration of dependent body parts resulting from
gravitational settling of blood in uncompressed capillaries and small veins following
cessation of circulation.

\synonyms
Hypostasis; Postmortem Staining
...
\medterm{Lloyd-Davies Position} A modified lithotomy position in which the patient lies supine with lower-profile leg support (less hip flexion) combined with a Trendelenburg tilt. It is commonly used for pelvic and colorectal surgery, allowing simultaneous abdominal and perineal surgical access.
...
\medterm{Local Anesthesia} Temporary loss of sensation, especially pain, in a small, specific body area caused by a local anesthetic applied to the surface or injected nearby. The person usually remains conscious, although sedation may be added; excessive dosing or accidental injection into a blood vessel can cause seizures, heart problems, or other toxicity.
...
\medterm{Localized Lipodystrophy} Loss of subcutaneous fat in a limited body area, sometimes after injections, trauma, inflammation, pressure, or panniculitis. It may be cosmetic or reflect an underlying local or systemic disorder.
...
\synonyms
Pseudocoma; De-Efferented State

\medterm{Lockjaw} A serious neurologic illness caused by tetanospasmin produced by Clostridium tetani. It causes painful muscle stiffness and spasms, often beginning in the jaw.

\synonyms
Trismus; Clostridium Tetani Infection
...
\medterm{Locomotor Ataxia} A late manifestation of untreated tertiary syphilis (neurosyphilis) caused by infection
...
\synonyms
Syphilitic Myelopathy; Posterior Sclerosis
...
\medterm{Loeffler Endocarditis} Eosinophil-mediated endomyocardial disease, usually associated with hypereosinophilic syndrome, in which eosinophil infiltration and degranulation cause myocardial or endocardial injury, mural thrombus, and later endocardial fibrosis. It can produce restrictive physiology, valvular regurgitation, emboli, and heart failure; the disease may progress through necrotic, thrombotic, and fibrotic stages.
\synonyms
Eosinophilic Endomyocardial Fibrosis; Fibroplastic Parietal Endocarditis

\medterm{Loeffler Syndrome} A benign, self-limiting pulmonary syndrome characterized by transient migratory pulmonary infiltrates, peripheral blood eosinophilia, dry cough, and low-grade fever, classically triggered by the transpulmonary larval migration of helminth parasites such as Ascaris lumbricoides.
\synonyms
Simple Pulmonary Eosinophilia; Loeffler Pneumonia
...
\synonyms
LDS; TGF-Beta Receptor Vasculopathy

\medterm{Log Roll Test} A physical examination manoeuvre used to assess hip joint pathology. With the patient supine and the lower extremity in full extension, the examiner passively rolls the thigh internally and externally; pain elicited during rotation indicates intra-articular hip pathology, such as femoral neck fracture, labral tear, or synovitis.
...
\medterm{Lomotil Overdose} Taking too much diphenoxylate–atropine can cause extreme sleepiness, confusion, dry mouth, fast heartbeat, slowed breathing, coma, or delayed worsening, especially in children.
...
\medterm{Long-Acting Reversible Contraception} Extended-release contraceptive modalities that provide highly effective pregnancy prevention over months to years without requiring daily patient adherence, including subdermal progestin implants, copper and levonorgestrel intrauterine devices (IUDs), and injectable depot medroxyprogesterone acetate.

\synonyms
LARC; Long-Acting Contraception; Extended-Release Contraception
...
\medterm{Longitudinal Axis} An imaginary line running along the length of a body or body part, from one end to the other. Rotation around this line is called longitudinal rotation.
...
\medterm{Loose Body} A free-floating intra-articular fragment of bone, calcified hyaline cartilage, or fibrous tissue within a synovial joint space ('joint mouse'), arising from osteochondritis dissecans, osteoarthritis, or trauma, capable of causing abrupt painful mechanical joint locking.
\synonyms
Joint Mouse; Intra-Articular Loose Fragment

\medterm{Loperamide} Loperamide is a medicine that slows intestinal movement and reduces diarrhea. It may be unsafe in bloody or fever-related diarrhea, and excessive doses can cause severe abnormal heart rhythms.
...
\medterm{Loss of Bladder Control} Alternate name; see \textit{Urinary Incontinence}.
...
\medterm{Loss of Smell} Partial or complete inability to detect odors, commonly caused by nasal obstruction, infection, inflammation, head injury, neurologic disease, or certain medicines.
...
\medterm{Lou Gehrig's Disease} Alternate name; see \textit{Amyotrophic Lateral Sclerosis}.

\medterm{Louse} Singular form; see \textit{Lice}.
...
\medterm{Low Blood Oxygen} An abnormally low oxygen level in arterial blood, usually related to lung disease, impaired breathing, circulation problems, or reduced oxygen availability.
...
\medterm{Low Blood Pressure} A systolic blood pressure below $90\text{ mmHg}$ or diastolic blood pressure below $60\text{ mmHg}$, resulting in inadequate end-organ perfusion. Etiologies include hypovolemia, septic shock, cardiogenic impairment, adrenal insufficiency, orthostatic autonomic failure, and antihypertensive overdosage.

\synonyms
Low Blood Pressure; Hypotension; Orthostatic Hypotension

\medterm{Low Blood Pressure Causes} Alternate name; see \textit{Hypotension}.
...
\medterm{Low Body Temperature} Alternate name; see \textit{Hypothermia}.
...
\medterm{Lower Extremity Amputation Dressing Care} Systematic wound care, sterile dressing changes, and residual limb inspection following lower extremity amputation. Aims to promote healing, manage exudate, monitor for surgical site infection or flap ischemia, and prepare the residual limb with compression wrapping for prosthetic fitting.

\synonyms
Stump Dressing Change; Residual Limb Care; Amputation Wound Management

\medterm{Lower Extremity Arterial Bypass} A vascular surgical bypass operation (such as femoropopliteal or femorotibial bypass) utilizing an autologous saphenous vein or synthetic graft to detour arterial blood flow around a hemodynamically significant occlusion in the peripheral arteries of the leg.

\synonyms
Fem-Pop Bypass; Leg Arterial Bypass; Peripheral Vascular Bypass Graft

\medterm{Lower Extremity Peripheral Artery Disease} Atherosclerotic stenosis or occlusion of the arterial vascular tree supplying the lower extremities, leading to intermittent claudication, rest pain, non-healing ischemic ulcerations, and critical limb-threatening ischemia.

\synonyms
Lower Extremity PAD; Leg Arteriosclerosis Obliterans; Peripheral Vascular Disease of Legs
...
\medterm{Lower Gastrointestinal Bleeding} Bleeding that originates in the lower digestive tract, including the small intestine, colon, rectum, or anus. It most often appears as bright red or dark maroon blood passed with bowel movements, or as hidden blood leading to anemia; common causes include diverticular bleeding, hemorrhoids, polyps, colon cancer, and colitis. Heavy bleeding, dizziness, or fainting may occur.
\synonyms Lower GI bleeding; LGIB; Lower gastrointestinal hemorrhage; Hematochezia.
...
\medterm{Lower Segment Cesarean Section} Alternate name; see \textit{Cesarean Section}.
\synonyms
...
\medterm{Low Eye Tension} Alternate name; see \textit{Ocular Hypotony}.
...
\medterm{Low-Flow Priapism} Alternate name; see \textit{Priapism}.
...
\medterm{Low-Grade Astrocytoma} A usually slow-growing glioma composed of astrocytic cells, often arising in the brain or spinal cord. Symptoms depend on location and may include seizures, headache, weakness, or visual change; molecular classification and grade guide prognosis and care.
...
\medterm{Low HDL Cholesterol (Hypoalphalipoproteinemia)} A low concentration of high-density lipoprotein cholesterol, associated with metabolic disease, obesity, smoking, genetic disorders, or other causes. Cardiovascular risk is assessed from the entire lipid profile and clinical context rather than HDL alone.
...
\medterm{Low LDL Cholesterol (Hypobetalipoproteinemia)} An unusually low concentration of low-density lipoprotein cholesterol, often related to inherited apolipoprotein B disorders, other genetic traits, malabsorption, illness, or lipid-lowering treatment. The cause and associated liver or nutritional findings guide evaluation.
...
\medterm{Low-Molecular-Weight Heparin} A group of blood-thinning medicines, including enoxaparin and dalteparin, made from heparin. They reduce clot formation and usually have a more predictable effect than standard heparin, but bleeding and low platelets can occur.
...
\medterm{Low Neutrophil Count} Alternate name; see \textit{Neutropenia}.

\medterm{Lown-Ganong-Levine Syndrome} A cardiac pre-excitation syndrome mediated by an accessory atriofascicular bypass tract (James fibers) that bypasses the normal slow conduction of the upper AV node, characterized on ECG by a short PR interval (less than 120 ms) with normal narrow QRS duration and recurrent paroxysmal supraventricular tachycardias.
\synonyms
LGL Syndrome; Accelerated AV Conduction Syndrome
...
\medterm{Low Platelet Count} Alternate name; see \textit{Thrombocytopenia}.

\medterm{Low Potassium} An abnormally low potassium level in the blood, which can cause weakness, cramps, abnormal heart rhythms, or paralysis and may result from losses, medicines, or hormonal disorders.
...
\medterm{Low T} Alternate name; see \textit{Low Testosterone}.

\medterm{Low-Tension Glaucoma} Alternate name; see \textit{Normal-Tension Glaucoma}.

\medterm{Low Testosterone} A condition in which a person has symptoms of testosterone deficiency and repeatedly low morning testosterone levels. Causes may involve the testes, ovaries, pituitary gland, medicines, obesity, or another illness and need medical evaluation.
...
\medterm{Low White Cell Count in Cancer} A reduced number of infection-fighting blood cells in a person with cancer or receiving cancer treatment. The risk of serious infection depends on which cells are low and how severely they are reduced.
...
\medterm{LSD Substance Use} LSD is a potent hallucinogen that alters perception, mood, and thought and can cause panic, accidents, persistent perceptual symptoms, or psychosis in susceptible people.

\medterm{LSD Toxicity} Hallucinogen poisoning causing perceptual distortion, anxiety, panic, agitation, hallucinations, mydriasis, tachycardia, hypertension, and impaired judgment. Severe agitation, hyperthermia, seizures, trauma, or persistent psychosis can occur; use a calm environment, supportive care, and benzodiazepines when clinically indicated.

\medterm{L-theanine} An amino acid found mainly in tea leaves. It may influence relaxation and alertness, but supplements can interact with medicines and are not proven treatments for disease.
...
\medterm{Ludwig Angina} A rapidly spreading infection of the floor of the mouth and tissues under the jaw, usually arising from an infected lower molar. Tongue elevation, difficulty swallowing, drooling, and airway obstruction can develop rapidly.
...
\medterm{Lumbar Disk Replacement} Surgical replacement of a worn or herniated intervertebral disc in the lower back with an artificial prosthetic disc to relieve nerve pain while preserving spinal flexibility.

\synonyms
Artificial Disc Replacement; Total Disc Arthroplasty; Lumbar Arthroplasty

\medterm{Lumbar Hernia} A rare type of abdominal wall hernia in which abdominal or retroperitoneal contents (such as fat, intestine, or kidney) protrude through an anatomical defect in the posterolateral lumbar wall. These defects typically occur in the superior lumbar triangle (Grynfeltt-Lesshaft triangle, the most common site) or the inferior lumbar triangle (Petit's triangle). They may be congenital or acquired following flank surgery (such as kidney surgery), trauma, or severe muscular strain. Symptoms include a soft, reducible swelling in the lower back or flank that enlarges with coughing; surgical repair using mesh is typically indicated to prevent incarceration or bowel obstruction.

\synonyms
Grynfeltt-Lesshaft Hernia; Petit's Hernia; Flank Hernia; Dorsal Hernia

\medterm{Lumbar Lordosis} The normal anteriorly convex physiological curvature of the lumbar spine. Pathologic hyperlordosis (swayback) or hypolordosis (flatback) may develop secondary to muscular imbalances, obesity, pregnancy, spondylolisthesis, or neuromuscular disorders.

\synonyms
Lumbar Inward Curvature; Hyperlordosis; Swayback
...
\medterm{Lumbar Puncture Opening Pressure} The hydrostatic cerebrospinal fluid pressure measured using a vertical manometer with the patient in the relaxed lateral decubitus position during lumbar puncture, normally ranging between 10 and 20 cm H2O in adults; elevated in idiopathic intracranial hypertension and meningitis.
...
\medterm{Lumbar Spinal Stenosis} Alternate name; see \textit{Lumbar stenosis}.
...
\synonyms
L-Spine; Lower Vertebral Column
...
\medterm{Lumbar Spondylosis} Alternate name; see \textit{Spondylosis}.
...
\synonyms
LSS; Lumbar Spinal Stenosis; Neurogenic Claudication
...
\medterm{Lumbosacral Radiculopathy} Pain, sensory change, or weakness caused by irritation or compression of a nerve root in the lower lumbar or sacral spine. Symptoms often radiate from the back or buttock into the leg in a dermatomal pattern.
...
\medterm{Lunate Bone} A crescent-shaped carpal bone situated in the center of the proximal carpal row between the scaphoid and triquetrum, articulating with the distal radius; vulnerable to avascular necrosis (Kienbock disease) and anterior dislocation into the carpal tunnel.
...
\medterm{Lung Anatomy} Alternate name; see \textit{Lungs}.
...
\synonyms
Bronchogenic Carcinoma; Pulmonary Neoplasm
...
\medterm{Lung Collapse} Alternate name; see \textit{Atelectasis} and \textit{Pneumothorax}.
...
\medterm{Lung Diseases} Conditions affecting the airways, alveoli, pleura, or pulmonary circulation, including infection, asthma, COPD, fibrosis, and cancer.
...
\synonyms
Pulmonary Anatomy and Function; Respiratory Mechanics
...
tissues. Systemic lupus erythematosus is one form and may affect the skin, joints, kidneys,
blood cells, nervous system, and other organs.

\medterm{Lupus Anticoagulant} An antiphospholipid autoantibody directed against phospholipid-protein complexes that paradoxically prolongs in vitro phospholipid-dependent coagulation tests (such as the dilute Russell viper venom time or aPTT) while promoting a potent in vivo hypercoagulable state with arterial and venous thrombosis.

\synonyms
LA; LAC

\medterm{Lupus Band Test} A skin-biopsy test that looks for immune proteins along the junction between the skin's layers. The pattern may support lupus, but it must be interpreted with symptoms and other test results.
\synonyms
LBT; Dermoepidermal Junction Immunofluorescence
...
\medterm{Lupus Miliaris Disseminatus Faciei} A chronic granulomatous eruption of numerous red-brown or skin-colored papules, usually around the eyelids and central face. It may heal with small depressed scars; diagnosis often requires biopsy to distinguish it from acne, rosacea, sarcoidosis, and other granulomatous disorders.
...
\medterm{Luteal Phase Defect} A term used when the part of the menstrual cycle after ovulation may not provide enough progesterone or enough time for the uterine lining to support pregnancy. The diagnosis is uncertain and cannot be determined from cycle length alone.
...
\medterm{Luteinizing Hormone Deficiency} Inadequate luteinizing-hormone secretion from hypothalamic or pituitary disease, causing reduced gonadal steroid production, irregular or absent ovulation or menstruation, infertility, or delayed puberty.
...
\medterm{Lutembacher Syndrome} A rare congenital heart defect complex defined by the combination of an atrial septal defect (usually secundum type) and acquired or congenital mitral valve stenosis. The left-to-right atrial shunt partially decompresses the left atrium, reducing pulmonary venous congestion but markedly augmenting right ventricular volume overload and pulmonary arterial blood flow.
...
\medterm{Lyme Neuroborreliosis} Neurological manifestations of dissemination of the spirochete \textit{Borrelia burgdorferi} during early disseminated or late Lyme disease. The classic early disseminated presentation is Bannwarth syndrome, marked by painful radiculoneuritis, cranial neuropathy (frequently bilateral facial nerve palsy), and lymphocytic meningitis with intrathecal antibody production.

\synonyms
Neurological Lyme Disease; Bannwarth Syndrome
...
\medterm{Lymphadenopathy} Enlargement of one or more lymph nodes. It may be localized or widespread and can result from infection, inflammation, immune disease, medicines, or cancer. Persistent, hard, or unexplained nodes can have an important underlying cause.

\medterm{Lymphangiectasia} Dilatation of lymphatic vessels that can cause clear or blood-tinged vesicles, swelling, or leakage of lymph through the skin or mucosa. It may be primary or follow surgery, radiation, inflammation, infection, or obstruction of lymphatic drainage.
...
\medterm{Lymphatic Capillary} The smallest type of lymphatic vessel. It begins in body tissues, collects extra tissue fluid, and carries it into larger lymphatic vessels.

\medterm{Lymphatic Circulation} The movement of lymph from body tissues through lymphatic vessels and nodes back into the bloodstream.
...
\medterm{Lymphatic Drainage} The movement of lymph away from a body area through lymphatic vessels and lymph nodes.
...
\medterm{Lymphatic Malformation} A birth defect in which lymphatic vessels form abnormally. It may cause soft, fluid-filled spaces in the skin or deeper tissues.
...
\medterm{Lymphatic System} A network of lymph, lymphatic vessels, lymph nodes, and lymphoid organs and tissues, including the spleen, thymus, tonsils, and bone marrow. It returns excess tissue fluid to the bloodstream, transports absorbed dietary fats and fat-soluble nutrients, and supports immune-cell development, surveillance, and responses to infection.
...
\medterm{Lymphatic Trunk} A large lymphatic vessel formed by the joining of smaller lymphatic vessels. It drains a body region and empties into a lymphatic duct.

\medterm{Lymphatic Valve} A flap inside a lymphatic vessel that helps keep lymph moving in one direction.
...
\medterm{Lymphedema} Chronic swelling caused by a buildup of protein-rich lymph fluid when lymphatic vessels or lymph nodes cannot drain it normally. It most often affects an arm or leg, but may also involve the trunk, breast, face, or genitals. The affected area may feel heavy, tight, or uncomfortable and may develop inflammation, thickened skin, reduced movement, or repeated skin infections. Primary lymphedema results from abnormal lymphatic development or inherited changes; secondary lymphedema follows damage or blockage from causes such as surgery, radiation, cancer, infection, or injury.
...
\medterm{Lymphoblastic Lymphoma} An aggressive lymphoma of immature B- or T-cell precursors, closely related to acute lymphoblastic leukemia. It often presents with lymph-node, mediastinal, bone, skin, or marrow disease; immunophenotyping and marrow assessment help classify the extent.
...
\medterm{Lymphocytic Choriomeningitis} A rodent-borne viral infection caused by lymphocytic choriomeningitis virus (LCMV), an arenavirus naturally carried and excreted by the common house mouse (Mus musculus). Human infection acquired through inhalation or ingestion of contaminated dust or food typically follows a biphasic course, presenting with an initial flu-like illness followed in severe cases by aseptic meningitis, meningoencephalitis, or congenital infection causing hydrocephalus and chorioretinitis if acquired during pregnancy.

\synonyms
LCMV Infection; Lymphocytic Meningitis

\medterm{Lymphocytic Colitis} A form of microscopic colitis causing long-lasting, watery diarrhea. The colon may look normal during examination, but a biopsy shows increased immune cells in its lining; medicines, autoimmune disease, or other facts may contribute.

\synonyms
Microscopic Colitis; IEL-Predominant Colitis
...
\medterm{Lymphoedema} Alternate spelling; see \textit{Lymphedema}.
...
\medterm{Lymphoid Organs} Organs that contain lymphoid tissue and support the development, storage, or activity of immune cells. They include the bone marrow, thymus, lymph nodes, spleen, and tonsils.
...
\medterm{Lymphoma Overview} Alternate name; see \textit{Lymphoma}.

\medterm{Lymphomatoid Granulomatosis} A rare Epstein-Barr-virus-associated lymphoproliferative disorder that commonly involves the lungs and may also affect the skin, central nervous system, or kidneys. It can produce nodules, cough, breathlessness, or systemic symptoms and requires tissue diagnosis and specialist hematology care.

\medterm{Lymphomatoid Papulosis} Lymphomatoid papulosis is a chronic, recurring skin disorder with cancer-like immune cells. The bumps often heal on their own, but some people later develop lymphoma.
...
\medterm{Lymphoplasmacytic Lymphoma} Alternate name; see \textit{Waldenström Macroglobulinemia}.
...
\medterm{Lab Results} Measurements from blood, urine, tissue, or other specimens used with the history and examination to evaluate health, diagnose disease, monitor treatment, or assess risk; an abnormal result is not a diagnosis by itself.

\medterm{Labhart-Willi Syndrome} Alternate name; see \textit{Prader-Willi Syndrome}.

\medterm{Labor and Delivery} The process of uterine contractions, cervical dilation, birth of the baby, delivery of the placenta, and immediate postpartum care.

\medterm{Labor and Delivery Complications} Problems arising during labor, birth, or the immediate postpartum period, including abnormal fetal position, prolonged labor, excessive bleeding, infection, hypertensive emergencies, or fetal distress.

\medterm{Labyrinthine Positional Nystagmus} Involuntary rhythmic eye movements triggered by head position or movement because of abnormal vestibular signaling; evaluation distinguishes peripheral inner-ear causes from central neurologic causes.

\medterm{LAM} Abbreviation for lymphangioleiomyomatosis, a rare cystic lung disease; see \textit{Lymphangioleiomyomatosis}.

\medterm{Laxatives} Medicines or preparations that help relieve constipation by adding bulk, softening stool, drawing water into the bowel, or stimulating bowel movement. The choice depends on the cause and duration of constipation and the person's health.

\medterm{Lazy Eye (Amblyopia)} Alternate name; see \textit{Lazy Eye} and \textit{Amblyopia}.

\medterm{LCH} Abbreviation for Langerhans cell histiocytosis; see \textit{Langerhans Cell Histiocytosis}.

\medterm{LDL Cholesterol} Cholesterol carried in low-density lipoprotein particles; high levels contribute to atherosclerosis and cardiovascular risk. See \textit{LDL}.

\medterm{LGMD} Abbreviation for limb-girdle muscular dystrophy; see \textit{Limb-Girdle Muscular Dystrophies}.

\medterm{LGS} Abbreviation for Lennox-Gastaut syndrome; see \textit{Lennox-Gastaut Syndrome}.

\medterm{Lichen Annularis} Alternate name for granuloma annulare, a benign inflammatory ring-shaped skin eruption; see \textit{Granuloma Annulare}.

\medterm{Lichen Planus Sclerosus Atrophicus} Historical or combined name for lichen sclerosus, a chronic inflammatory disorder causing thin, pale, fragile skin, often in the genital or anal region; see \textit{Lichen Sclerosus}.

\medterm{Lichen Psoriasis} A descriptive or overlapping term for psoriasis with lichenified, thickened, scaly plaques; the diagnosis should distinguish psoriasis from lichen planus or chronic eczema.

\medterm{Lichen Urticatus} Alternate name for papular urticaria, an itchy hypersensitivity reaction to insect bites; see \textit{Papular Urticaria}.

\medterm{Life Support} Medical treatments that temporarily replace or support vital body functions, such as mechanical ventilation, dialysis, circulatory support, or artificial nutrition and hydration, when illness prevents adequate function.

\medterm{Lingua Fissurata} Alternate name for fissured tongue, in which grooves form on the tongue surface; see \textit{Fissured Tongue}.

\medterm{Lingua Nigra} Alternate name for black hairy tongue, a usually harmless dark or furry coating caused by elongation and discoloration of tongue papillae; see \textit{Black Hairy Tongue}.

\medterm{Linguofacial Dyskinesia} Involuntary repetitive movements of the tongue, lips, jaw, or face, often related to medication exposure or neurologic disease; evaluation depends on the pattern and cause.

\medterm{Liver Cancer Treatment} Treatment of liver cancer may include surgery, ablation, embolization, radiation, immunotherapy, targeted therapy, chemotherapy, or transplantation according to tumor type, stage, liver function, and overall health.

\medterm{Localized Epidermolysis Bullosa} An inherited or acquired blistering disorder limited mainly to particular areas of skin or mucosa; friction can cause blisters, erosions, pain, and infection, and the subtype determines management.

\medterm{Low Back Pain Deciding About MRI} The decision to obtain lumbar MRI depends on red flags, neurologic findings, duration, treatment response, and whether imaging would change management; routine early imaging is not useful for uncomplicated low back pain.

\medterm{Low Back Pain Exercises} Carefully selected movement and strengthening exercises may improve function in nonspecific low back pain; the program should be adapted to symptoms and stopped for progressive weakness, numbness, or other warning signs.

\medterm{Low Potassium Syndrome} Alternate name for hypokalemia, an abnormally low blood potassium level that can cause weakness, cramps, paralysis, or dangerous heart-rhythm changes; see \textit{Hypokalemia}.

\medterm{Low-Dose Aspirin Therapy} Regular small-dose aspirin used for selected cardiovascular or obstetric indications. It can cause bleeding and is not appropriate for everyone; primary-prevention use should be based on individualized medical advice.

\medterm{Lumbar Pain} Pain arising in the lower back, often from muscles, joints, discs, nerves, or other spinal or nonspinal causes; see \textit{Low Back Pain}.

\medterm{Lung Carcinoid Tumors} Neuroendocrine tumors arising in the lung, ranging from typical slow-growing tumors to atypical tumors with greater malignant potential; see \textit{Carcinoid Tumor}.

\medterm{Lung Disease/Respiratory Problems} Disorders affecting the airways, lung tissue, pleura, pulmonary blood vessels, or breathing control that may cause cough, shortness of breath, wheezing, chest discomfort, or low oxygen; see \textit{Lung Disease}.

\medterm{Lung Nocardiosis} Lung infection caused by Nocardia bacteria, usually in people with weakened immunity. It can cause cough, fever, chest pain, or nodules and may spread to the brain or other organs; see \textit{Nocardiosis}.

\medterm{Lymph Node Cancer} Cancer involving lymph nodes, either lymphoma arising in lymphatic tissue or cancer spread from another organ; diagnosis requires examination of tissue and staging.

\medterm{Lymphangioleimyomatosis} Alternate spelling; see \textit{Lymphangioleiomyomatosis}.

\medterm{Lymphoma, Non-Hodgkin's} Alternate name; see \textit{Non-Hodgkin Lymphoma}.
