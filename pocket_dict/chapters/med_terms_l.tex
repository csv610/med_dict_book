...
\medterm{Lactobacillus Oris} A lactic-acid-producing bacterium commonly found in the mouth. It is usually harmless but may rarely cause opportunistic infection in people with severe illness, weakened immunity, or damaged body barriers.
...
\medterm{Lanosterol} A sterol made during the body’s production of cholesterol. Enzymes convert it through several steps into cholesterol and other related substances needed for cell membranes, hormones, and bile acids.
...
\medterm{Laromustine} An experimental cancer medicine designed to damage DNA and kill tumor cells, studied in blood cancers but not established as routine treatment.
...
\medterm{Laser Capture Microdissection} A laboratory method that uses a focused laser to cut out selected cells from a tissue sample for genetic, molecular, or microscopic analysis.
\medterm{Laser Dentistry} Use of focused laser energy for selected dental procedures, including cavity detection, gum surgery, tooth whitening, and treatment of periodontal disease.
...
\medterm{Laser Hair Removal} A treatment that reduces hair by directing laser energy into pigment near the hair follicle. Several sessions are usually needed, and temporary redness, burns, scarring, or skin-color changes can occur.
...
\medterm{Late-Onset Hypogonadism} A condition in older men involving consistently low testosterone and related symptoms. Possible symptoms include reduced sexual desire, fewer morning erections, erection problems, tiredness, lower muscle strength, increased body fat, weak bones, or low mood. Diagnosis requires symptoms plus repeated low morning testosterone tests. Treatment may address sleep, weight, and other illnesses; testosterone treatment is considered carefully and requires blood and prostate monitoring.

\synonyms
LOH; Age-Related Testosterone Deficiency; Testosterone Deficiency Syndrome

\medterm{Late Gadolinium Enhancement} A cardiac MRI finding in which contrast material remains longer in damaged or scarred heart muscle. The pattern helps doctors identify causes of heart muscle injury.
\synonyms
...
\medterm{Lauric Acid} A saturated fatty acid found in coconut oil, palm-kernel oil, and breast milk. The body uses it as an energy source and to build cell membranes.
\medterm{Lauroleic Acid} An unsaturated fatty acid studied in lipid chemistry and metabolism. It is not a standard medicine, and its health effects depend on the amount and context of exposure.
...
\medterm{Leishmania Chagasi} A name formerly used for Leishmania infantum, a parasite that can cause visceral leishmaniasis. It is spread by sandflies and may cause prolonged fever, weight loss, enlarged organs, and reduced blood-cell production.
...
\medterm{Lelliottia Amnigena} A gram-negative bacterium found in water and soil that rarely causes opportunistic infection. When isolated from a patient, clinicians must compare the result with symptoms, the body site, and other test findings.
...
\medterm{Lerisetron} An investigational medicine blocking serotonin 5-HT3 receptors, studied for preventing nausea and vomiting but not established as routine treatment.
...
\medterm{Leu} The standard abbreviation for leucine, an essential branched-chain amino acid used to build proteins. The body obtains leucine from food and can use it as a signal affecting muscle protein production.
...
\medterm{Leucine Aminopeptidase - Urine} A urine measurement of an enzyme that can be released from kidney or other tissues. Increased activity may occur with some kidney or liver disorders, but the test is not specific and is interpreted with other findings.
...
\medterm{Leucomalacia} Softening or damage of body tissue, usually caused by injury, poor blood flow, infection, or inflammation. The term often describes injury to white matter around the brain’s fluid spaces in premature infants.
\medterm{Leuconostoc} A genus of lactic-acid-producing bacteria found in plants and fermented foods. It rarely causes human infection but can occasionally be recovered from blood or other clinical samples, especially in people with serious illness or weakened immunity.

\medterm{Leuconostoc Citreum} A lactic-acid-producing bacterium found mainly in plants and fermented foods. Human infection is very rare; a clinical isolate should be interpreted with the specimen source, repeated culture results, symptoms, and immune status.

\medterm{Leuconostoc Lactis} A bacterium associated with plants, dairy products, and fermented foods. It rarely causes opportunistic human infection, so recovery from a clinical specimen requires accurate identification and correlation with symptoms before treatment.

\medterm{Leuconostoc Mesenteroides} A lactic-acid-producing bacterium commonly found in plants and fermented foods. It can rarely cause bloodstream or other opportunistic infection, particularly in people with weakened immunity or medical devices.
...
\medterm{Lignans} Plant compounds found in seeds, grains, fruits, and vegetables that can act as antioxidants and weak hormone-like substances. Their health effects depend on food sources, metabolism, dose, and individual differences.

\medterm{Lignin} A tough plant substance that strengthens cell walls and forms part of dietary fiber. Humans do not digest it, but it contributes bulk to stool and may influence bowel movement.
\medterm{Lignocaine} The international nonproprietary name for lidocaine, a local anesthetic and antiarrhythmic drug.
\medterm{Lignoceric Acid} A long-chain saturated fatty acid found in small amounts in cell membranes and some plant oils. It is involved in lipid structure rather than routine treatment.
...
\medterm{Linear Energy Transfer} The energy deposited by radiation along each unit of its path through material. High-transfer radiation causes dense ionization and may produce more biological damage than lower-transfer radiation at equal dose.
effective.
...
\medterm{Linkage Disequilibrium} The nonrandom tendency for genetic variants at different DNA locations to be inherited together in a population. It helps researchers track disease-associated regions but does not prove that a variant causes disease.
...
\medterm{Lipid Droplet} A small fat-storage structure inside a cell. It stores energy and supplies lipids for membranes and signaling, but excessive accumulation can contribute to disease.
...
\medterm{Lipid Peroxidation} Chemical damage to fats caused by reactive oxygen molecules. It can alter cell membranes and contribute to inflammation and tissue injury.
\medterm{Lipid Peroxide} An oxidized fat molecule formed when lipids react with oxygen or free radicals. High levels can indicate oxidative damage to cells.
...
\medterm{Listeria Ivanovii} A species of Listeria that mainly infects animals and only rarely infects people. Human infection has been reported especially in people with weakened immune systems and must be confirmed by laboratory testing.
...
\medterm{Listeria Seeligeri} An environmental species of Listeria bacteria that rarely causes infection in people. When disease occurs, it is usually opportunistic and requires laboratory testing to distinguish it from related Listeria species.

\medterm{Listeria Welshimeri} An environmental and food-associated Listeria species that is not a usual human pathogen. Rare clinical isolates require correlation with symptoms, specimen quality, and laboratory confirmation.
...
\medterm{Liter} A metric unit of volume equal to one thousand milliliters or one cubic decimeter, commonly used for fluids, laboratory measurements, and medical dosing.
...
\medterm{Lobucavir} Lobucavir is an experimental antiviral medicine studied mainly against herpesvirus infections. It was investigated because it may slow viral copying, but it is not an approved routine treatment and remains a research drug.
...
\medterm{Losoxantrone} Losoxantrone is an experimental cancer medicine related to anthracenediones. It may damage cancer-cell DNA and slow cell growth, but its safety, effectiveness, and appropriate uses require clinical study rather than routine treatment.
...
\medterm{Low-Density Lipoprotein} A particle that carries cholesterol through the blood. Too much LDL cholesterol can collect in artery walls, forming fatty deposits that narrow arteries and increase the risk of heart attack and stroke. A blood test measures LDL cholesterol, and treatment may include lifestyle changes and cholesterol-lowering medicine.
...
\medterm{Lues} An older name for syphilis, an infection caused by the bacterium Treponema pallidum. An older name for syphilis, an infection caused by the bacterium \textbackslash\{\}textit\{Treponema pallidum\}.
...
\medterm{Luminescent} Giving off visible light without becoming hot or glowing from heat. In medicine and biology, luminescent substances can mark cells, germs, or chemicals so laboratory tests can detect and measure them.
...
\medterm{Lymphangiogenesis} The formation of new lymphatic vessels from existing ones. It helps repair tissues and regulate fluid but can also support tumor spread, chronic inflammation, or abnormal lymphatic swelling.
...
\medterm{Lymphatic Disease} A disorder of lymphatic vessels or lymph nodes that disrupts fluid drainage or immune function. Examples include lymphedema, lymph-node infection, lymphatic malformations, and lymphatic cancers.
