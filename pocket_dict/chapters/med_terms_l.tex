...
\medterm{Labyrinthitis} Alternate name; see \textit{Inner Ear Inflammation}.
...
\medterm{Lateral Epicondylitis} Alternate name; see \textit{Tennis Elbow}.
...
\medterm{Lazy Eye} Reduced vision in one or both eyes caused by abnormal visual development during childhood, often related to misalignment, unequal focusing, or visual obstruction.
...
\medterm{Legg-Calvé-Perthes Disease} A childhood disorder in which the blood supply to the femoral head is temporarily impaired, causing avascular necrosis, hip pain, stiffness, and possible deformity.
...
\medterm{Legionella Pneumonia} Alternate name; see \textit{Legionnaires' Disease}.
...
\medterm{Legionnaires' Disease} Alternate name; see \textit{Legionnaires' Disease}.
...
\medterm{Leukocyte} A blood cell that helps defend the body against infections, foreign substances, and abnormal cells; major types include lymphocytes, neutrophils, monocytes, eosinophils, and basophils.
...
\medterm{Leukorrhea} A whitish vaginal discharge that may be physiological or may result from infection, inflammation, or another genital disorder.
...
\medterm{Lipodystrophy} Alternate name; see \textit{Acquired Generalized Lipodystrophy}.
...
\medterm{Liver Function Tests} Blood tests assessing liver-cell injury, bile flow, and synthetic function, commonly including aminotransferases, alkaline phosphatase, bilirubin, albumin, and clotting measures.
...
\medterm{Locked-In Syndrome} Alternate name; see \textit{Locked-In Syndrome}.
...
\medterm{Low Testosterone} Alternate name; see \textit{Male Hypogonadism}.
...
\medterm{Lumbago} Alternate name; see \textit{Low Back Pain}.
...
\medterm{Lumbar Vertebrae} The five lumbar vertebrae in the lower back, numbered L1 through L5, between the thoracic spine and sacrum and bearing much of the body's load.
...
\medterm{Lupus} Alternate name; see \textit{Systemic Lupus Erythematosus}.
...
\medterm{Lymphatic Obstruction} Alternate name; see \textit{Lymphedema}.
...
\medterm{Lymphocytosis} An increased number of lymphocytes in the blood, often associated with infection, inflammation, or a lymphoproliferative disorder.
...
\medterm{Systemic Lupus Erythematosus} A chronic, multisystem autoimmune disease characterized by widespread immune complex deposition, antinuclear antibody (ANA) production, and tissue inflammation affecting joints, skin, kidneys, brain, lungs, and heart.
