...
\medterm{Fab Immunoglobulins} The part of an antibody that recognizes and binds a specific target. A laboratory-made Fab fragment can be used in tests or medicines to block or remove a harmful substance.
...
\medterm{Face Presentation} A birth position in which the fetus’s neck is extended and the face, rather than the top of the head, leads through the birth canal. The chin’s direction affects whether vaginal birth is possible.
...
\medterm{Facet Rhizotomy} A procedure that uses heat or another technique to interrupt small nerves carrying pain signals from spinal facet joints. It may reduce selected chronic neck or back pain, but relief can be temporary and complications are possible.
...
\medterm{Facklamia} A group of gram-positive bacteria that rarely causes human infection. Reported infections include bloodstream, urinary, wound, and other infections, usually in people with serious underlying illness.

\medterm{Facklamia Hominis} A rarely identified Facklamia species that can occasionally cause opportunistic infection. Its significance depends on the specimen, symptoms, repeated recovery, and the person’s underlying health.

\medterm{Factitious Disorder} A mental-health disorder in which a person deliberately produces, exaggerates, or falsifies illness to assume the sick role, without an obvious external reward. It requires nonjudgmental psychiatric and medical care and protection from unnecessary procedures.
...
\medterm{Factor Xii} Factor XII is a blood-clotting protein involved in laboratory activation of clotting. Deficiency can greatly prolong the activated partial-thromboplastin time but usually does not cause abnormal bleeding.
...
\medterm{Factor Xiii} Factor XIII is the clot-stabilizing protein that strengthens the fibrin mesh after a clot forms. Deficiency can cause delayed bleeding, poor wound healing, or repeated pregnancy loss despite initially normal routine clotting tests.

\medterm{Factorial Study} A research study that tests two or more interventions at the same time, allowing investigators to estimate each intervention’s effect and whether the interventions interact. The design requires careful analysis and adequate sample size.
...
\medterm{Faculty} The teaching, research, and clinical staff of an educational institution. Medical faculty teach students and trainees, supervise patient care, conduct research, and help set professional and academic standards.
...
\medterm{Faecalibacterium Prausnitzii} A common intestinal bacterium that produces butyrate, which can support the colon lining. Its relationship to inflammation and health is being studied, but supplements containing it are not established treatments.
...
\medterm{Fair Hair} Hair with relatively little pigment, appearing blond, light brown, or red. Color is mainly inherited and may change with age, hormones, sun exposure, illness, or some medicines.
...
\medterm{Falimarev} An investigational antibody studied for prevention or treatment of selected viral infections. It is not a general antiviral treatment; use, effectiveness, and safety depend on clinical-trial evidence and regulatory authorization.
...
\medterm{Familial Hypercholesterolemia} An inherited disorder causing persistently high LDL cholesterol because the body removes it from blood poorly. Family history, cholesterol levels, physical findings, and sometimes genetic testing support diagnosis and early treatment.
...
\medterm{Fat Body} An organ-like tissue in insects that stores fat and produces proteins involved in metabolism and immunity. It performs functions that partly resemble the combined roles of the liver and fat tissue in humans.
...
\medterm{Fatty Acids} Components of fats used for energy, cell membranes, and chemical signals. Their health effects depend on type and amount; replacing some saturated fats with unsaturated fats may improve cardiovascular risk.
...
\medterm{Fazarabine} An investigational cancer compound resembling a DNA building block that interferes with genetic-material production. It is not a routine treatment and may suppress bone marrow or cause other chemotherapy-related toxicities.
...
\medterm{Fear Of Age} An excessive or persistent fear of aging or older people that causes distress, avoidance, or interference with daily life. Treatment may include psychological therapy when the fear is part of an anxiety disorder.

\medterm{Fear Of Children} An excessive or persistent fear of children that causes substantial distress, avoidance, or difficulty functioning. It may be a specific phobia and can improve with structured psychological treatment.

\medterm{Fear Of Crossing Streets} An excessive fear of crossing roads that leads to avoidance or significant distress. It may be related to a specific phobia, panic, trauma, or broader anxiety and can limit independence and daily activities.

\medterm{Fear Of Demons} An excessive or persistent fear of demons or supernatural beings that causes distress, avoidance, or impaired functioning. When clinically significant, it may be treated as a specific phobia or another anxiety-related problem.
\medterm{Fear Of Drinking Alcohol} An excessive or persistent fear of drinking alcohol that causes distress or avoidance. It may follow a harmful past experience or occur with anxiety; treatment focuses on the cause and the person’s goals.

\medterm{Fear Of Dust} An excessive or persistent fear of dust causing distress, avoidance, or disruption of daily life. It may lead to excessive cleaning or avoidance and can be treated with exposure-based psychological therapy.
\medterm{Fear Of Feces} An excessive or persistent fear of feces or defecation that causes distress, avoidance, or difficulty with eating, toileting, or daily activities. It may occur as a specific phobia or with obsessive-compulsive symptoms.

\medterm{Fear Of Fur} An excessive or persistent fear of fur that causes distress, avoidance, or impaired functioning. It may be a specific phobia and can improve with psychological treatment that gradually reduces fear and avoidance.
\medterm{Fear Of Heat} An excessive or persistent fear of heat that causes distress, avoidance, or impaired functioning. It may be a specific phobia or reflect concern about a previous heat-related illness and can be treated psychologically.
\medterm{Fear Of Nudity} An excessive or persistent fear of being naked or seeing others naked that causes distress or avoidance. It may interfere with relationships, changing, examinations, or care and can respond to therapy.

\medterm{Fear Of Oneself} An excessive or persistent fear of one’s own thoughts, feelings, or actions that causes distress or avoidance. It may occur with anxiety, intrusive thoughts, or another mental-health condition and needs individualized assessment.

\medterm{Fear Of Worms (Parasitic)} An excessive or persistent fear of parasitic worms that causes distress, avoidance, or interference with daily life. It may be a specific phobia and can improve with structured psychological treatment.
...
\medterm{FEC} An abbreviation for Fuchs endothelial corneal dystrophy, an inherited or age-related disorder in which corneal cells fail to remove fluid effectively. It can cause morning blur, glare, and progressive vision loss; advanced disease may need transplantation.
...
\medterm{Femtogram} A unit of mass equal to one quadrillionth of a gram, or (10^{-15}) gram. It is used mainly in laboratory science to describe extremely small quantities.

\medterm{Femtoliter} A unit of volume equal to one quadrillionth of a liter, or (10^{-15}) liter. It is used mainly to describe very small laboratory or cellular volumes.
...
\medterm{Fenamiphos} An organophosphate pesticide used mainly against plant-parasitic worms, capable of causing nerve poisoning with sweating, vomiting, weakness, breathing problems, or seizures.
...
\medterm{Fenclonine} An experimental chemical that lowers the body's production of serotonin by blocking an enzyme needed to make it. It has mainly been used in research to study serotonin and is not a routine treatment for people.
...
\medterm{Fenretinide} A manufactured vitamin-A-related medicine studied for preventing or treating some cancers and other diseases. It is investigational in many settings, and its benefits, risks, and appropriate dose depend on clinical evidence.
...
\medterm{Ferredoxin} An iron-sulfur protein that transfers electrons in cells. It participates in energy production and the making of steroids and other molecules and is also studied in bacteria and plants.
...
\medterm{Fibrillation} Rapid, disorganized activity of muscle fibers. In the heart, atrial fibrillation causes an irregular rhythm and can lead to blood clots; ventricular fibrillation stops effective pumping and requires immediate resuscitation.
...
\medterm{Fibrinoid Necrosis} A pattern of severe blood-vessel wall injury in which immune proteins, fibrin, and plasma leak into the wall. It occurs in some inflammatory vessel diseases and is identified by tissue examination.
...
\medterm{Fibrocystic Breasts} Breasts with common noncancerous thickening, lumpiness, or cysts that may feel tender and change during the menstrual cycle. New, persistent, or unusual findings still require clinical evaluation.
...
\medterm{Fibromyalgi} A misspelling of fibromyalgia, a long-term condition causing widespread pain, fatigue, unrefreshing sleep, and difficulty concentrating. The condition does not involve a single area of tissue damage or inflammation.
...
\medterm{Ficusin} A naturally occurring chemical found in some plants of the fig genus. It has been studied in laboratory research, but it is not an established treatment or routinely used clinical medicine.
...
\medterm{Fields Disease} An extremely rare reported neuromuscular disorder associated with progressive muscle wasting and involuntary movements. Only very limited cases have been described, so its cause, diagnosis, and long-term course remain uncertain.
...
\medterm{Filaria Bancrofti} An obsolete name associated with Wuchereria bancrofti, a threadlike parasitic worm that causes lymphatic filariasis. Mosquitoes transmit its larvae, and infection can lead to recurrent inflammation, limb swelling, or hydrocele.

\medterm{Filaria Demarquayi} A historical name for a filarial worm reported in the Caribbean. Filarial worms are transmitted by insects and may affect skin, eyes, or lymphatic vessels; the name is rarely used in modern clinical practice.
...
\medterm{Filial} Relating to a child or the relationship between a child and a parent. In genetics, a filial generation is a group of offspring descended from a specified parental generation.
...
\medterm{Filterable Virus} An old term for an infectious agent small enough to pass through filters that trapped bacteria. It helped early scientists recognize viruses but is no longer a useful modern classification.
...
\medterm{Filtering Operations} Methods that remove or separate unwanted particles, cells, molecules, signals, or fluids. In healthcare, they are used in laboratory processing, dialysis, imaging, and electronic monitoring.
...
\medterm{Filtration Fraction} The percentage of blood plasma reaching the kidneys that passes into the kidney’s filtering units to form the first stage of urine. It is calculated from the filtration rate divided by renal plasma flow.
...
\medterm{Firmicutes} A broad group of bacteria that includes many common gram-positive species. Some are harmless or helpful in the gut, while others can cause infections; modern genetic classification has changed the group’s boundaries.
...
\medterm{Fistula (Pathology)} An abnormal passage between organs or between an organ and the skin. It may be present from birth or develop after infection, inflammation, surgery, injury, or cancer and can cause leakage, drainage, or recurrent infection.
...
\medterm{Flanged Needle} A needle with a widened edge that helps hold it in position or connect it to equipment during a medical procedure. Its design and use depend on the specific device and procedure.
...
\medterm{Flavin} A yellow plant- or microbe-derived compound that forms part of certain vitamins and helps enzymes carry out oxidation-reduction reactions. Flavins are important in cellular energy production.
...
\medterm{Flavodoxin} A small protein containing a flavin molecule that transfers electrons during chemical reactions in some bacteria, algae, and other organisms. It is mainly a biochemical and research term.

\medterm{Flavonifractor} A group of bacteria that can live without oxygen in the human intestine. Their role in health and disease is still being studied, and they are not established causes of common human infections.

\medterm{Flavonoid} A naturally occurring plant chemical found in foods such as fruits, vegetables, tea, and beans. Flavonoids contribute to color and taste, but laboratory findings do not prove that supplements prevent or treat disease.

\medterm{Flavonoids} Natural plant chemicals found in fruits, vegetables, tea, beans, and other foods. They contribute to color and taste; eating flavonoid-rich foods may be healthy, but supplements have not been proven to treat disease.

\medterm{Flavonol} A subgroup of flavonoids found in many plants, including onions, apples, berries, and tea. Flavonols are studied for possible biological effects, but they are not established medicines for preventing or treating disease.

\medterm{Flavopiridol} An experimental anticancer medicine that blocks enzymes controlling cell division. It has been studied in clinical trials, but it is not a routine treatment and can cause low blood counts and other serious effects.

\medterm{Flavor Enhancer} A food additive that strengthens an existing taste, often savory or umami flavor. Reactions are uncommon but can occur with particular ingredients; symptoms and risk depend on the substance and amount consumed.
...
\medterm{Fleshy Tab} An informal description of a small soft-tissue projection, often a skin tag or mucosal growth. Its meaning depends on its location and appearance; bleeding, rapid growth, or pain needs examination.
...
\medterm{Flocculation} The joining of small particles suspended in a liquid into larger loose clumps. It is used in laboratory testing, water treatment, and some pharmaceutical processes to help separate material.
...
\medterm{Florida Flu} An informal, nonmedical name for a flu-like illness. It does not identify a specific infection; the actual cause depends on symptoms, examination, exposure history, and sometimes testing.
...
\medterm{Flow} A state of deep concentration and involvement in an activity, often with reduced awareness of time. It is a psychological term rather than a disease or physical finding.
...
\medterm{Flu, Avian} Influenza infection mainly affecting birds and poultry. Some strains, including H5N1, can infect people after close contact with infected animals or contaminated materials and may cause severe respiratory illness.

\synonyms
Avian influenza; bird flu

\medterm{Flu, Bird} Another name for avian influenza, a virus infection mainly affecting birds. Certain strains can occasionally infect people and cause severe illness; avoiding infected animals and using appropriate protective measures reduces risk.
...
\medterm{Fluorescence Polarization} A laboratory measurement of how emitted light is oriented after a fluorescent label is excited. It can estimate molecular binding or size and is mainly used in biochemical and research testing.
...
\medterm{FND} Functional neurological disorder causes genuine weakness, abnormal movements, seizures, sensory symptoms, or other neurologic problems because nervous-system function is disrupted, without the structural damage expected for those symptoms. Diagnosis uses positive clinical findings.
...
\medterm{Follistatin} A protein that binds and regulates members of the transforming-growth-factor beta family, including activin. It influences reproductive function, muscle growth, and tissue repair and is mainly a research term.
...
\medterm{Food} Material eaten or drunk to provide energy, water, vitamins, minerals, protein, fat, and carbohydrates needed for body function, growth, repair, and health.
...
\medterm{Food Poisoning} Illness from eating food contaminated with germs, toxins, or harmful chemicals. Nausea, vomiting, diarrhea, cramps, and fever are common; dehydration, bloody diarrhea, severe pain, or high-risk patients need medical care.
...
\medterm{Foot And Mouth Disease} A highly contagious viral disease of cloven-hoofed animals that causes fever and blisters in the mouth and on the feet. It is not the same illness as hand, foot, and mouth disease in children.
...
\medterm{Forced Oscillation Technique} A breathing test that applies small pressure waves while a person breathes normally. It measures airway resistance and stiffness and can help assess lung disease when forceful breathing tests are difficult.
...
\medterm{Forelimb} An animal’s front limb, corresponding broadly to an arm in humans or a wing in birds. The term is mainly used in comparative anatomy and veterinary medicine.
...
\medterm{Forensic Entomology} The study of insects and other arthropods in legal investigations. Insect species and development can help estimate how long a body has been exposed and may provide information about movement or location.
...
\medterm{Foretinib} An investigational anticancer medicine that blocks several signals involved in tumor-cell growth and blood-vessel formation. It has been studied in advanced cancers but is not established routine treatment.
...
\medterm{Forssman Antigen} A sugar-containing molecule found in some animals and microorganisms that can be recognized by particular antibodies. It is mainly important in immunology and laboratory research rather than routine patient care.
...
\medterm{Fosbretabulin} An experimental anticancer medicine designed to disrupt small blood vessels supplying a tumor. It has been studied in trials but is not routine treatment and may affect healthy blood vessels, the heart, or blood pressure.
...
\medterm{Fossula} A small pit, groove, or depression in an anatomical structure. The exact meaning depends on its location and is mainly used in detailed anatomy.

\medterm{Fossus} A small pit or depression in a body structure; the term is an anatomical variant of “fossa.” Its clinical meaning depends on the named location.
...
\medterm{Fourth Disease} An obsolete and disputed name for a childhood rash illness once attributed to toxin-producing Staphylococcus aureus. It is not a recognized modern diagnosis; the actual cause should be identified from current clinical assessment.
...
\medterm{Fractional IPV} A vaccination schedule using a smaller intradermal dose of inactivated polio vaccine. It helps protect against poliovirus when included in an approved immunization program; the schedule and dose follow local public-health guidance.
...
\medterm{Freedman Test} An obsolete pregnancy test that injected urine into an animal to detect biological effects of pregnancy hormones. It has been replaced by accurate tests that measure human chorionic gonadotropin.
...
\medterm{Freeze Etching} A laboratory preparation method in which frozen material is broken and some ice is removed before microscopic examination. It reveals surface details of cells or membranes and is mainly used in research.

\medterm{Freeze Substitution} A laboratory method that replaces ice in a frozen specimen with a solvent at low temperature before the specimen is fixed and embedded. It helps preserve fine cellular structures for microscopy.
...
\medterm{Frei'S Test} An obsolete skin test for lymphogranuloma venereum using chlamydial material. It has been replaced by modern laboratory tests and is no longer used routinely.
...
\medterm{Fresolimumab} An experimental antibody medicine studied for conditions involving transforming-growth-factor beta. It is not an established routine treatment, and its benefits and risks depend on the clinical trial or indication.



\medterm{Freund'S Adjuvant} A laboratory substance made from mineral oil and, in its complete form, killed mycobacteria. It boosts immune responses in research animals but is not used as a routine human vaccine ingredient.
...
\medterm{Friedreichs Ataxia Syndrome} A usually recessively inherited disorder caused by reduced frataxin production, impairing cellular energy function. It causes progressive coordination and nerve problems and may affect the spine, heart, or blood sugar regulation.

\medterm{Friend Virus} A retrovirus that infects mice and is used in research on red-blood-cell cancers, immunity, and viral disease. It is not a usual cause of human infection.
...
\medterm{Frog Test} An obsolete pregnancy test in which urine was injected into a frog to look for an ovulation response. It has been replaced by tests that measure human chorionic gonadotropin.
...
\medterm{Frostbite} Freezing injury to skin and deeper tissue, causing numbness, pale or waxy skin, swelling, blisters, or tissue death. It needs urgent medical assessment and controlled rewarming; rubbing or direct heat can worsen injury.
...
\medterm{Fullerene} A carbon molecule shaped like a hollow ball, tube, or other cage. Fullerenes are studied in materials science and medicine, but most proposed medical uses remain experimental.
...
\medterm{Functional Neurologic Disorder/Conversion Disorder} Genuine neurologic symptoms, such as weakness, abnormal movements, seizures, or sensory loss, caused by altered nervous-system function rather than a structural lesion. Diagnosis is based on positive clinical findings.

\synonyms
Conversion Disorder

\medterm{Functional Neurological Disorder} Genuine weakness, abnormal movements, seizures, sensory loss, or other neurologic symptoms caused by altered nervous-system function. Diagnosis uses positive clinical signs and is not based only on normal scans or tests.

\medterm{Functional Neurological Symptom Disorder} A condition causing genuine weakness, abnormal movements, sensory symptoms, or seizure-like episodes because nervous-system function is altered. Symptoms cause distress or impairment and are not intentionally produced.

\medterm{Functional Neurological Symptom Disorder (Conversion Disorder)} A condition causing genuine weakness, paralysis, abnormal movements, sensory loss, gait or speech problems, or seizure-like episodes without the expected structural neurologic damage. Symptoms are not deliberately produced.
...
\medterm{Fungal Vaccines} Vaccines designed to prevent fungal infections. Most are still experimental and there are few routine human fungal vaccines; research aims to protect people at high risk of severe disease.
...
\medterm{Funiculus} A cord-like bundle of fibers or structures. In anatomy it may refer to a bundle in the spinal cord or the spermatic cord; its exact meaning depends on the location named.
...
\medterm{Furazolidone} An older antimicrobial medicine formerly used for selected bacterial or protozoal infections. It is restricted or unavailable in many settings because of serious side effects, interactions, and safer alternatives.
...
\medterm{Fusarium Chlamydosporum} A Fusarium mold found in soil and plants that has rarely caused human infections. Clinical significance depends on the specimen, body site, symptoms, and immune status; laboratory identification guides treatment.

\medterm{Fusarium Incarnatum} An environmental Fusarium mold that can rarely cause eye, skin, or invasive infection, particularly in people with weakened immunity. Diagnosis requires clinical correlation and laboratory identification.
...
\medterm{Fusobacterium Mortiferum} A Fusobacterium species that can occasionally contribute to oxygen-free infections, including wound, abdominal, or bloodstream infections. Its significance depends on symptoms, specimen quality, and other organisms present.

\medterm{Fusobacterium Naviforme} A rarely identified Fusobacterium species that may occur in mixed infections of wounds or other oxygen-poor tissues. Laboratory identification must be interpreted with the patient’s symptoms and specimen source.

\medterm{Fusobacterium Necrogenes} A Fusobacterium species occasionally found in mixed infections that grow without oxygen. It is uncommon in human disease, and its importance depends on the infected site and clinical findings.
...
\medterm{Fusobacterium Russii} A rarely reported Fusobacterium species that may be associated with human infection. Laboratory identification and antibiotic-susceptibility testing help determine whether it is clinically important and guide treatment.

\medterm{Fusobacterium Varium} A Fusobacterium species that grows without oxygen and may occur in mixed infections of the mouth, abdomen, skin, or bloodstream. Its significance depends on the infected site and overall clinical picture.
...
\medterm{Ferrofluid} A liquid containing tiny magnetic particles that moves in response to a magnetic field. It is mainly an engineering and research material; medical uses remain experimental and depend on safety and biocompatibility.
...
\medterm{Formoline} A proprietary weight-management product marketed with fiber or chitosan-based ingredients. Formulations and evidence vary; such products may affect absorption of medicines or nutrients and should not replace evidence-based weight care.
