...
\medterm{Fabry Disease} An inherited lysosomal storage disorder caused by reduced activity of alpha-galactosidase A because of a disease-causing variant in the \textit{GLA} gene. Globotriaosylceramide and related substances accumulate in cells, especially in blood vessels, the kidneys, heart, nerves, and skin. Features may include burning pain in the hands and feet, reduced sweating, small dark-red skin spots, kidney disease, heart disease, or stroke. The condition is usually X-linked and can affect people of any sex.

\medterm{Fabry's Disease} Alternate spelling; see \textit{Fabry Disease}.
...
\medterm{Face and Brow Presentation} Abnormal fetal head presentations in which the face or brow leads instead of the vertex. Labor progress and delivery safety depend on fetal position, flexion, pelvis, gestational age, and whether the presentation converts; persistent brow or mentum-posterior face presentation may obstruct vaginal birth.
...
\medterm{Facial Anatomy in Cutaneous Surgery} The layered arrangement of facial skin, fat, muscles, nerves, vessels, glands, and connective tissue that guides safe dermatologic and reconstructive procedures. Knowledge of relaxed skin tension lines and danger zones helps preserve function and appearance.
...
\medterm{Facial Colliculus} An anatomical elevation on the floor of the fourth ventricle in the dorsal pons, formed by motor fibers of the facial nerve (cranial nerve VII) looping over the underlying abducens nucleus (cranial nerve VI); a lesion produces ipsilateral facial paralysis and lateral gaze palsy.
...
\medterm{Facial Fractures} Breaks in one or more facial bones, such as the nasal, orbital, cheek, maxillary, or mandibular bones, usually caused by trauma. Pain, swelling, deformity, bleeding, double vision, malocclusion, or airway problems may occur.
...
\medterm{Facial Nerve Palsy From Birth Trauma} One-sided facial weakness in a newborn caused by pressure on the facial nerve during birth. It often improves as the nerve recovers, but eye protection, feeding, and other causes of weakness must be assessed.
...
\medterm{Facial Soft Tissue Injuries} Lacerations, abrasions, contusions, punctures, or avulsions involving the skin and underlying soft tissues of the face. Evaluation should consider injury to facial nerves, ducts, vessels, the eye, and deeper facial structures.
...
\medterm{Facies Hippocratica} The classic physical appearance of the face seen in patients near death, after severe prolonged exhaustion, or during terminal peritonitis, characterized by sunken hollow eyes, pinched nose, collapsed temples, cold clammy sweat, and a leaden, dusky or pallid complexion.
\synonyms
Hippocratic Facies; Hippocratic Face
...
\medterm{Facio-Scapulo-Humeral Dystrophy} Alternate name; see \textit{Facioscapulohumeral Muscular Dystrophy}.

\medterm{Factitious Disorder} A mental-health disorder in which a person deliberately creates, exaggerates, or falsely reports illness to assume the sick role, without a clear external reward.

\synonyms
Munchausen Syndrome; Pathomimicry

\medterm{Factitious Disorder Imposed on Another} A form of medical child abuse or caregiver falsification in which a parent or guardian deliberately exaggerates, fabricates, or directly induces physical or psychological symptoms in a dependent child, presenting the victim for repeated medical evaluations, invasive testing, or surgeries without apparent external gain other than assuming the role of a devoted caregiver.

\synonyms
Munchausen Syndrome by Proxy; MSBP; Pediatric Symptom Falsification

\medterm{Factitious Disorder by Proxy} Alternate name; see \textit{Factitious Disorder Imposed on Another}.

\medterm{Factitious Disorders} Alternate name; see \textit{Factitious Disorder}.
...
\medterm{Factor} A substance that contributes to a biological process or clinical result. In hematology, the term usually refers to blood-clotting proteins that work together to stop bleeding.
...
\medterm{Factor I Deficiency} An ambiguous term. In immunology, complement factor I deficiency causes uncontrolled alternative-pathway activation, low C3, recurrent pyogenic infections, and sometimes glomerulonephritis or atypical hemolytic uremic syndrome. In coagulation terminology, factor I is fibrinogen; congenital fibrinogen deficiency causes bleeding. The intended meaning must be specified.

\medterm{Factor II Assay} A blood test measuring factor II activity, which helps assess the clotting pathway and investigate abnormal bleeding, prolonged prothrombin time, or suspected prothrombin deficiency or inhibition.
...
\medterm{Factor V Leiden} An inherited variant in the \textit{F5} gene that makes factor V less responsive to activated protein C, a natural protein that normally limits clotting. This leaves clotting active for longer and increases the tendency to form clots in veins, especially deep-vein thrombosis and pulmonary embolism. Many people who carry one copy never develop a clot; having two copies generally increases the risk further. Other factors, such as family history, pregnancy, estrogen exposure, surgery, injury, smoking, obesity, and immobility, can also affect risk.

\medterm{Factor V Leiden Mutation} Alternate name; see \textit{Factor V Leiden}.
...
\medterm{Factor XII Deficiency} A deficiency of factor XII that can greatly prolong one laboratory clotting test but usually does not cause bleeding. It is often discovered unexpectedly during testing for another reason.
...
\medterm{Factor XIII Deficiency} A rare autosomal recessive bleeding disorder caused by a deficiency of plasma factor XIII (fibrin-stabilizing factor). Because standard coagulation tests (PT, PTT, platelet count) are completely normal, the disorder is diagnosed via abnormal clot solubility assays in 5M urea or quantitative factor XIII antigen assays; characteristically manifests with delayed umbilical stump hemorrhage, recurrent soft-tissue hematomas, and recurrent spontaneous miscarriages.

\synonyms
Fibrin-Stabilizing Factor Deficiency; FXIII Deficiency
...
\medterm{Faget Sign} The unusual clinical physical finding of fever accompanied by a paradoxically normal or slow pulse rate (sphygmothermic dissociation / relative bradycardia), classically seen in yellow fever, typhoid fever, Legionnaires' disease, and tularemia.
\synonyms
...
\medterm{Fahr's Disease} Alternate spelling; see \textit{Fahr Disease}.
...
\medterm{Fahr Syndrome} A rare neurological disorder characterized by abnormal, symmetrical, non-atherosclerotic calcification of the basal ganglia, thalamus, and cerebral cortex, leading to progressive parkinsonism, chorea, ataxia, and neuropsychiatric disturbances.
\synonyms
...
\synonyms
Syncope; Vasovagal Episode; Passing Out
...
\synonyms
Pes Planus; Flat Feet; Fallen Foot Arches

\medterm{Flatfoot (Pes Planus)} Alternate name; see \textit{Fallen Arches}.
...
\medterm{Familial Alobar Holoprosencephaly} An inherited or familial form of alobar holoprosencephaly, a severe developmental defect in which the embryonic forebrain fails to divide normally. It may be associated with major midline facial abnormalities and requires genetic and specialist evaluation.

\medterm{Familial Chordoma} A familial predisposition to chordoma, a rare malignant tumor arising from remnants of the embryonic notochord. A family history may warrant genetic counseling and evaluation for tumors involving the skull base or spine.

\medterm{Familial Congestive Cardiomyopathy} Alternate name; see \textit{Dilated Cardiomyopathy}.

\medterm{Familial Cutaneous Amyloidosis} An inherited tendency to develop amyloid deposits limited mainly to the skin, often producing itchy lichen or rippled macular lesions. The specific pattern and associated systemic risk require dermatologic assessment.

\medterm{Familial Dilated Cardiomyopathy (FDC)} Alternate name; see \textit{Dilated Cardiomyopathy}.

\medterm{Fallopian Tube Disorders} Disorders affecting the tubes that transport the ovum, including infection, inflammation, blockage, ectopic pregnancy, hydrosalpinx, torsion, endometriosis, and cancer. They may cause pelvic pain, infertility, abnormal bleeding, or acute abdominal symptoms.
...
\medterm{Falx Cerebelli} A small, triangular crescent-shaped fold of dura mater situated in the posterior cranial fossa inferior to the tentorium cerebelli, projecting vertically forward between the right and left cerebellar hemispheres.

\medterm{Falx Cerebri} A large, sickle-shaped vertical fold of dura mater that dips vertically into the longitudinal cerebral fissure between the right and left cerebral hemispheres, attaching anteriorly to the crista galli and frontal crest and posteriorly to the tentorium cerebelli and internal occipital protuberance.
...
\medterm{Familial Adenomatous Polyposis} An autosomal dominant inherited condition, usually caused by a disease-causing change in the \textit{APC} gene, causing numerous precancerous polyps in the colon and rectum. Without preventive treatment, colorectal cancer is very likely, so lifelong specialist screening and risk-reducing surgery are often needed.

\medterm{Familial Benign Pemphigus (Hailey-Hailey Disease)} An inherited disorder caused by impaired calcium handling between epidermal cells, producing recurrent fragile blisters, erosions, and painful fissures in skin folds. Heat, sweating, friction, and infection can trigger flares; it is not contagious.
...
\medterm{Familial Hypercholesterolemia} Usually an autosomal dominant inherited disorder causing persistently high LDL cholesterol because the body removes it from blood poorly. Family history, cholesterol levels, physical findings, and sometimes genetic testing support the diagnosis; rare severe forms may involve changes in both gene copies.
...
\medterm{Familial Mediterranean Fever} Usually an autosomal recessive inherited inflammatory disorder, often associated with changes in the \textit{MEFV} gene, causing repeated short attacks of fever with abdominal, chest, or joint pain. Without treatment, ongoing inflammation can damage the kidneys; preventive medicine can reduce attacks and complications.
...
\medterm{Familial Renal Amyloidosis} An inherited amyloidosis in which a variant protein, often transthyretin or another hereditary amyloid precursor, deposits in the kidneys and sometimes the nerves, heart, or other organs. Proteinuria and progressive kidney dysfunction may occur; genetic and specialist evaluation guides care.
...
\medterm{Fanconi-Bickel Syndrome} A rare autosomal recessive glycogen storage disease caused by mutations in the \textit{SLC2A2} gene encoding the GLUT2 glucose/galactose transporter, characterized by hepatomegaly, glycogen accumulation, proximal renal tubular dysfunction (renal Fanconi syndrome), and severe growth failure.
...
\medterm{Farmer Lung} A form of hypersensitivity pneumonitis (extrinsic allergic alveolitis) caused by repeated inhalation of thermophilic actinomycetes (such as Saccharopolyspora rectivirgula) spores from moldy hay or compost, presenting with acute or chronic dyspnea, dry cough, fever, and bilateral pulmonary infiltrates.
\synonyms
Farmer's Lung; Moldy Hay Hypersensitivity Pneumonitis
...
\medterm{Fascia Lata} The deep, dense fibrous connective tissue investing sheath of the thigh, which encloses thigh musculature and thickens laterally to form the iliotibial tract, continuous superiorly with the inguinal ligament and fascia of the gluteus maximus.
...
\medterm{Fasciculus Cuneatus} The lateral ascending white matter sensory tract of the posterior (dorsal) column of the spinal cord, present above thoracic level T6, carrying conscious proprioception, vibratory sense, and fine discriminative touch from the upper trunk, neck, and upper extremities to the nucleus cuneatus of the medulla.

\medterm{Fasciculus Gracilis} The medial ascending white matter sensory tract of the posterior (dorsal) column of the spinal cord, present throughout the entire length of the spinal cord, conveying conscious proprioception, vibration, and fine discriminative touch from the lower extremities and lower trunk to the nucleus gracilis of the medulla.
...
\synonyms
Lipid Panel; Blood Lipid Screen
...
\synonyms
Type II Muscle Fiber; Fast-Glycolytic Fiber
...
\medterm{Fatal Familial Insomnia} A very rare inherited prion disease, usually caused by a disease-causing variant in one copy of the \textit{PRNP} gene. Misfolded prion protein damages the thalamus and other brain areas involved in sleep and automatic body functions. It causes progressively severe loss of normal sleep, along with problems such as sweating, abnormal heart rate or blood pressure, temperature changes, weight loss, impaired movement, and changes in thinking. The disease usually begins in adulthood, progresses over time, and is fatal.
...
\medterm{Fat Embolism Syndrome} A severe, life-threatening systemic complication occurring 24 to 72 hours following long bone fractures (such as femur or tibia) or pelvic trauma, characterized by the clinical triad of acute respiratory distress with hypoxemia, neurological dysfunction (confusion, encephalopathy), and a petechial skin rash distributed across the anterior chest, neck, and axillae.
\synonyms
FES; Traumatic Fat Embolism
...
\medterm{Fatty Acid} An organic molecule with a hydrocarbon chain and a terminal carboxyl group. Fatty acids may circulate freely or be joined to glycerol and other molecules in fats and cell membranes; they can provide energy and serve as starting materials for signaling chemicals. They may be saturated, monounsaturated, or polyunsaturated.

\medterm{Fatty Acid Oxidation} The metabolic breakdown of fatty acids to acetyl-CoA and other products that can be used for energy production. Much of this process occurs through mitochondrial beta-oxidation, although other cellular pathways also contribute.

\synonyms
Beta-Oxidation

\medterm{Fatty Acids} A family of organic molecules that are components of fats and cell membranes and can also circulate freely in the body. They provide or store energy and serve as precursors for signaling molecules; their biological and dietary effects depend on their structure, type, and amount.
...
\medterm{Fatty Acid Synthesis} The metabolic production of fatty acids from smaller carbon-containing molecules, mainly through acetyl-CoA and malonyl-CoA. It supports the formation of energy stores, cell membranes, and signaling molecules.
...
\medterm{Fatty Liver} Alternate name; see \textit{Fatty Liver Disease}.

\medterm{Fatty Liver Disease} Excess fat stored in liver cells. It may be related to metabolic dysfunction, obesity, diabetes, abnormal cholesterol, alcohol use, medicines, or other causes. Metabolic dysfunction-associated steatotic liver disease (MASLD) is the current term for fatty liver associated with cardiometabolic risk factors; inflammation and cell injury are called metabolic dysfunction-associated steatohepatitis (MASH). Disease may remain mild or progress to fibrosis, cirrhosis, liver failure, or liver cancer.

\synonyms
Hepatic Steatosis; Steatotic Liver Disease; MASLD
...
\medterm{Favre-Racouchot Syndrome} A benign chronic-sun-damage disorder in which solar elastosis is accompanied by open or closed comedones and small epidermal cysts, usually around the temples, outer eyes, cheeks, or lateral neck. It is associated with photoaging and sometimes smoking.
...
\synonyms
Fever-Induced Seizure; Febrile Convulsion

\medterm{Febrile Seizure Cross-Reference} Alternate name; see \textit{Febrile seizure}.
...
\synonyms
Febrile Convulsions; Pyrexial Seizures
...
\medterm{FEC} Abbreviation; see \textit{FECD}.
...
\synonyms
Accidental Bowel Leakage; Encopresis (Pediatric)
...
\medterm{Fecal Lactoferrin} An iron-binding glycoprotein released by degranulating neutrophils in the intestinal mucosa; its elevated concentration in stool serves as a sensitive, non-invasive biomarker to detect active mucosal inflammation in inflammatory bowel disease (Crohn disease, ulcerative colitis) and differentiate it from irritable bowel syndrome.
...
\synonyms
Fuchs Dystrophy; Fuchs Endothelial Corneal Dystrophy
...
\medterm{Female Genital Sores} Painful or painless ulcers, blisters, or eroded lesions located on the vulva, vagina, cervix, or perineum. Common etiologies include sexually transmitted infections (herpes simplex virus, syphilis, chancroid, lymphogranuloma venereum), non-infectious inflammatory disorders (Behçet disease, lichen planus), contact dermatitis, trauma, or malignancy.

\synonyms
Female Genital Ulcers; Vulvar Lesions; Vulvar Ulcers

\synonyms
Female Genital Ulcers; Vulvar Ulcerations
...
\synonyms
Female Sterility; Subfertility in Women

\medterm{Female Orgasmic Disorder} Persistent or recurrent difficulty achieving orgasm that causes personal distress. It may be lifelong or acquired and can relate to health conditions, medicines, mood, trauma, sexual pain, stimulation, or relationship factors.
...
\medterm{Female Reproductive Organs} Female reproductive organs include the ovaries, fallopian tubes, uterus, cervix, vagina, and external genitalia, which support hormones, ovulation, menstruation, pregnancy, and birth.
...
\medterm{Female Self-Catheterization} Intermittent insertion and removal of a catheter through the female urethra to empty the bladder when normal urination is inadequate, reducing retention and protecting kidney function.

\medterm{Female Sexual Dysfunction} A broad term for persistent or recurrent difficulty with sexual desire, arousal, lubrication, orgasm, or pain that causes clinically significant distress. Medical conditions, medicines, mood, trauma, relationships, and life changes may contribute.

\synonyms
FSD; Hypoactive Sexual Desire Disorder
...
\medterm{Femoral Canal} The medial, smallest compartment of the femoral sheath, measuring approximately 1.3 cm in length, containing loose connective tissue, lymphatic vessels, and the deep inguinal lymph node of Cloquet; site of femoral herniation below the inguinal ligament.
...
\medterm{Femoral Nerve Stretch Test} A neurological examination manoeuvre used to assess for upper lumbar nerve root irritation (L2, L3, or L4) or femoral neuropathy. With the patient prone, the examiner passively flexes the knee and extends the hip; reproduction of pain radiating down the anterior thigh indicates a positive test.

\synonyms
Prone Knee Bending Test; Reverse Straight Leg Raise
...
\medterm{Femoral Sheath} A funnel-shaped fascial sleeve formed by downward prolongation of the transversalis fascia (anteriorly) and iliac fascia (posteriorly) beneath the inguinal ligament into the femoral triangle, compartmentalized into lateral (femoral artery), intermediate (femoral vein), and medial (femoral canal) spaces.
...
\medterm{Ferriman-Gallwey Score} A standardized clinical scoring system used to quantify the severity of hirsutism in women by visually grading terminal hair density from zero (absence) to four (extensive) across nine androgen-sensitive body areas, with a total score of eight or higher generally indicating clinical hirsutism.

\synonyms
Modified Ferriman-Gallwey Scale; mFG Score
...
\medterm{Fetal Alcohol Spectrum Disorder} A group of lifelong conditions that can occur after alcohol exposure before birth. Effects vary widely and may involve growth, physical development, brain development, learning, memory, attention, behavior, speech, coordination, or everyday functioning. Some people have characteristic facial features, birth defects, or problems with organs such as the heart or kidneys, but these are not present in everyone. The effects can occur even when the person does not have the facial features or growth problems associated with fetal alcohol syndrome.

\synonyms
FASD; Prenatal Alcohol Exposure Syndrome

\medterm{Fetal Alcohol Spectrum Disorders} Alternate plural form; see \textit{Fetal Alcohol Spectrum Disorder}.
...
\synonyms
FAS; Fetal Alcohol Spectrum Condition

\medterm{Fetal Anatomy Survey} A comprehensive second-trimester obstetric ultrasound examination typically performed between 18 and 22 weeks of gestation to systematically evaluate fetal organ anatomy, biometry, placental position, amniotic fluid volume, and detect congenital structural anomalies.
...
\medterm{Fetal Fibronectin} An extracellular matrix glycoprotein present at the decidual-chorionic interface; detection in cervicovaginal secretions between 22 and 34 weeks of gestation serves as a valuable negative predictive biomarker for imminent preterm labor and delivery within 7 to 14 days.
...
\medterm{Fetal Heart Monitoring} Continuous electronic or intermittent auscultatory surveillance of the fetal heart rate and its dynamic response to uterine contractions during labor and delivery (cardiotocography), evaluated for baseline rate, variability, accelerations, and decelerations (early, late, variable).
...
\medterm{Fetal Hydantoin Syndrome} A distinct pattern of congenital malformations resulting from maternal gestational exposure to hydantoin anticonvulsants (predominantly phenytoin). Hallmarks include craniofacial dysmorphism (cleft lip/palate, broad depressed nasal bridge, hypertelorism), hypoplasia of distal phalanges and nails, intrauterine growth restriction, microcephaly, and neurodevelopmental delay.

\synonyms
Dilantin Embryopathy; Phenytoin Syndrome
...
\medterm{Fetal Kick Counts} Observation and recording of fetal movements by a pregnant person. A noticeable reduction from the usual pattern should prompt timely obstetric advice.

\synonyms
Kick Counting; Fetal Activity Assessment
...
\medterm{Fetal Lung Maturity} The developmental state of the fetal pulmonary system characterized by sufficient production of pulmonary surfactant by type II pneumocytes to prevent neonatal respiratory distress syndrome; assessed in amniotic fluid via the lecithin-to-sphingomyelin (L/S) ratio or lamellar body count.
...
\medterm{Fetal Monitor} A device that records fetal heart rate and, when configured for electronic fetal monitoring, uterine contractions. An external Doppler ultrasound sensor detects the fetal heartbeat, while a tocodynamometer detects uterine contractions. In selected labor settings, a fetal scalp electrode can provide an internal fetal heart-rate signal.
...
\medterm{Fetal Pyelectasis} Mild widening of the urine-collecting area of a fetus’s kidney seen on an ultrasound scan. It may go away before birth or be linked to a urinary blockage or another condition, so follow-up depends on its size and other findings.
...
\medterm{Fetishism} A recurrent sexual interest in a nonliving object or a specific non-genital body part. The interest alone is not a mental disorder.

\medterm{Fetishistic Disorder} A mental-health disorder involving repeated, intense sexual arousal from a nonliving object or a specific non-genital body part, with clinically significant distress or impairment or involvement of harm or lack of consent.
...
\medterm{Fever} A regulated rise in body temperature caused by changes in the body's temperature-control system, commonly in response to infection or inflammation. It may also occur with certain medicines, cancers, autoimmune disorders, or other conditions. Fever differs from hyperthermia, in which body temperature rises without a normal change in the temperature set point.
...
\medterm{Fever Blister} Alternate name; see \textit{Cold Sore}.

\medterm{Fever-Induced Seizure} Alternate name; see \textit{Febrile seizures}.
...
\synonyms
VHF; Filovirus and Arenavirus Infections; Viral Hemorrhagic Syndromes
...
\medterm{Fibrillary Glomerulonephritis} A rare non-amyloid glomerular disease characterized by glomerular deposition of randomly arranged, non-branching fibrils (16 to 24 nm in diameter) that do not stain with Congo red, strongly positive for DNAJB9 by immunohistochemistry, presenting clinically with proteinuria, hematuria, and renal insufficiency.
\synonyms
FGN; DNAJB9 Glomerulopathy
...
\synonyms
Thrombolytic Therapy; Clot-Dissolving Therapy
...
\medterm{Fibrin Split Products} Soluble protein fragments released into the bloodstream during plasmin-mediated enzymatic cleavage and degradation of cross-linked fibrin polymers and fibrinogen, elevated in disseminated intravascular coagulation, deep vein thrombosis, and acute pulmonary embolism.
...
\medterm{Fibrocystic Breast Changes} Alternate name; see \textit{Fibrocystic Breast Changes}.

\medterm{Fibrocystic Breast Condition} Alternate name; see \textit{Fibrocystic Breast Changes}.

\medterm{Fibrocystic Breast Disease} Older term; see \textit{Fibrocystic breasts}.
...
\medterm{Fibrodysplasia Ossificans Progressiva} A rare inherited disorder in which muscles, tendons, ligaments, and other connective tissues gradually turn into bone. This extra bone forms outside the normal skeleton and can make joints stiff or fixed, restricting movement. Episodes of soft-tissue swelling and inflammation may be followed by permanent bone formation, and injury or invasive procedures can trigger these episodes. The disorder usually becomes noticeable in early childhood and may later limit opening of the mouth or expansion of the rib cage. Most cases are caused by a change in the \textit{ACVR1} gene. A characteristic feature present from birth is a malformed, shortened, or inward-turned big toe.

\synonyms
FOP; Stone Man Syndrome

\medterm{FOP} Abbreviation; see \textit{Fibrodysplasia Ossificans Progressiva}.
...
\medterm{Fibrolamellar Carcinoma} A rare primary liver cancer that usually affects adolescents and young adults without cirrhosis. It may cause abdominal pain, a mass, weight loss, or abnormal liver tests; imaging and biopsy establish diagnosis and resection is considered when feasible.
\medterm{Fibrolamellar Hepatocellular Carcinoma} A distinct primary malignant hepatic neoplasm occurring predominantly in adolescents and young adults without pre-existing cirrhosis or viral hepatitis, histologically characterized by large polygonal eosinophilic hepatocytes embedded within dense, lamellar collagenous stroma; associated with a DNAJB1-PRKACA fusion gene.
...
\medterm{Fibroma} A usually benign tumor made mainly of fibrous connective tissue. Fibromas can develop in skin, soft tissue, bone, or organs; their effects depend on their location and size, and some site-specific forms may recur or interfere with organ function.
...
\medterm{Fibromas} Plural of fibroma; see \textit{Fibroma}.
...
\medterm{Fibromyalgia} A long-term condition that causes widespread body pain and increased sensitivity to pain. It commonly causes fatigue, unrefreshing sleep, stiffness, and difficulty concentrating or remembering. The exact cause is not fully understood, but altered pain processing in the nervous system may contribute. Diagnosis is based mainly on the pattern of symptoms and examination; no single laboratory or imaging test confirms it.
...
\medterm{Fibrous Dysplasia Pathology} A fibro-osseous lesion containing irregular strands of woven bone in a cellular fibrous stroma, classically without prominent osteoblastic rimming. The lesion may be monostotic or polyostotic.

\medterm{Fibrous Joint} A joint in which bones are held together by strong connective tissue and have little or no movement. Skull sutures and syndesmoses are examples.
...
\synonyms
Erythema Infectiosum; Slapped Cheek Syndrome; Parvovirus B19 Infection
...
\medterm{Foot Pain (Plantar Fasciitis)} Alternate name; see \textit{Plantar Fasciitis}.

\medterm{Filarial Lymphedema} Chronic progressive swelling, dermal fibrosis, and non-pitting lymphedema of the limbs, genitalia, or breasts resulting from adult filarial worm infection (Wuchereria bancrofti, Brugia malayi) causing obstructive damage to the lymphatic drainage pathways, progressing to irreversible elephantiasis.
\synonyms
Lymphatic Filariasis; Elephantiasis Tropica
...
\medterm{Fine-Needle Aspiration} A biopsy in which a thin needle removes cells or fluid from a lump or cyst for laboratory examination. It may be guided by touch or imaging and is usually less invasive than a surgical biopsy.

\synonyms
FNA; Fine-Needle Aspiration Cytology; FNAC
...
\medterm{Finger-Nose Test} A clinical coordination test in which the patient alternately touches their own nose and the examiner's outstretched finger using the index finger. Dysmetria (overshooting or undershooting) or intention tremor during the movement indicates ipsilateral cerebellar hemisphere dysfunction.
...
\medterm{First Adult Seizure} The initial suspected unprovoked or provoked seizure in an adult, requiring assessment for immediate causes, recurrence risk, injury, medication or substance effects, and mimics such as syncope.
...
\medterm{First-Degree Atrioventricular Block} A cardiac conduction delay in which every atrial impulse is conducted to the ventricles but with a uniformly prolonged PR interval exceeding 200 milliseconds (0.20 seconds) on electrocardiogram, typically benign and asymptomatic.
...
\medterm{Fisher Syndrome} An acute autoimmune variant of Guillain-Barré syndrome characterized by the classic clinical triad of acute ophthalmoplegia, ataxia, and areflexia, strongly associated with anti-GQ1b IgG ganglioside antibodies following an upper respiratory or gastrointestinal infection.
\synonyms
...
\medterm{Fish Tank Granuloma} A chronic localized cutaneous mycobacterial infection caused by Mycobacterium marinum, contracted through contact of broken skin with non-chlorinated aquarium water or infected fish. It presents as persistent red-to-violaceous papules, nodules, or ulcers typically on the hands or fingers, occasionally ascending along lymphatic channels in a sporotrichoid pattern.

\synonyms
Aquarium Granuloma; Swimming Pool Granuloma
...
\medterm{Furrowed Tongue} Alternate name; see \textit{Fissured Tongue}.

\medterm{Fistula} An abnormal passage between two body parts, such as two organs, a blood vessel and another structure, or an organ and the skin. It may result from infection, inflammation, injury, surgery, or cancer. Symptoms and treatment depend on its location; some close with medical treatment, while others need a procedure or surgery.
\synonyms{Pathologic Fistula; Fistulous Tract; Abnormal Organ Tunnel}

\medterm{Fistula, Arteriovenous} Alternate name; see \textit{Arteriovenous Fistula}.
...
\medterm{Fistulotomy} Surgery that opens an anal fistula, an abnormal tunnel between the anal canal and nearby skin, so it can heal from the inside out. It is mainly used for simple fistulas. More complex fistulas may need another treatment to protect bowel control.

\synonyms
Anal Fistulotomy; Fistula-in-Ano Surgery; Laying Open of Fistula
...
\medterm{Fitz Hugh Curtis Syndrome} Alternate spelling; see \textit{Fitz-Hugh-Curtis Syndrome}.

\medterm{Five-Alpha Reductase} An enzyme that changes testosterone into dihydrotestosterone (DHT). DHT supports male sexual development and contributes to prostate growth and male-pattern hair loss. Medicines that block this enzyme are used for an enlarged prostate and some types of hair loss.
\synonyms{5-Alpha Reductase; 5-$\alpha$-Reductase; Steroid 5-Alpha Reductase}
...
\medterm{Fixator Muscle} A muscle that holds one part of the body steady while another part moves.

\medterm{Fixed Drug Eruptions} Recurrent sharply demarcated red or dusky patches caused by a medicine, often at the same sites each time exposure occurs. Lesions may blister or ulcerate and leave persistent dark pigmentation; stopping the culprit drug prevents recurrence.
...
\medterm{Flapping Tremor} An involuntary, irregular jerky movement (asterixis) characterized by brief, sudden lapses of posture in the dorsiflexed hands when the arms are held extended with the wrists hyperextended, characteristic of hepatic encephalopathy, uremic encephalopathy, and severe hypercapnia.
\synonyms
...
\synonyms
Pulicosis; Flea-Borne Dermatitis
...
\medterm{Fleischner Sign} A chest radiographic sign of acute pulmonary embolism consisting of a prominent, enlarged central pulmonary artery terminating abruptly, caused by distension of the vessel by a large impacted thromboembolus and downstream vasoconstriction.
\synonyms
Fleischner's Sign; Dilated Central Pulmonary Artery Sign
...
\medterm{Flesh-Eating Bacteria} Informal name for bacteria that can cause necrotizing fasciitis, a rapidly progressive deep soft-tissue infection. Severe pain, swelling, fever, skin discoloration, blisters, or serious illness requires emergency treatment.
...
\synonyms
Flexion; Joint Bending

\medterm{Flexed Breech} Alternate name; see \textit{Complete breech}.
...
\medterm{Flexor Tendon Anatomy} The arrangement and function of the tendons that bend the fingers, thumb, and wrist. Flexor tendons pass from forearm muscles through the wrist and hand in defined zones and sheaths; injury can impair finger flexion and requires assessment of tendon, nerve, and blood-vessel function.

\medterm{Flexor Tenosynovitis} A serious infection around a tendon that bends a finger, often after a cut or puncture. The finger may become swollen, stay partly bent, and hurt when straightened; urgent hand assessment and treatment are needed.

\synonyms
Suppurative Tenosynovitis; Kanavel Tenosynovitis
...
\synonyms
Sympathoadrenal Response; Acute Stress Response

\medterm{Floater} Alternate name; see \textit{Floaters}.
...
\synonyms
Oral Floor Squamous Cell Carcinoma; Sublingual Malignancy
...
\medterm{Flu (Influenza)} Alternate name; see \textit{Flu}.


\synonyms
Influenza; Grippe; Viral Flu
...
\medterm{Fluid in Lungs} Alternate name; see \textit{Pleural Effusion}.
...
\synonyms
Intravenous Fluid Therapy; Volume Resuscitation

\medterm{Fluid Wave} A physical test for fluid buildup in the belly (ascites); tapping one side of the stomach causes a ripple or wave that can be felt with the other hand on the opposite side.
...
\synonyms
FISH; Molecular Cytogenetic Assay
...
\medterm{Fluoride Toxicity} Poisoning that can cause corrosive gastrointestinal pain, vomiting, hypocalcemia, hyperkalemia, tetany, seizures, hypotension, and ventricular dysrhythmias. Serum calcium, potassium, magnesium, and ECG should be monitored; urgent treatment may include calcium replacement, airway support, and toxicology consultation.
...
\medterm{Fluoroquinolone-Associated Disability} A term used for disabling, sometimes long-lasting or potentially permanent adverse effects linked to fluoroquinolone antibiotics. Reported effects may involve tendons, muscles, joints, peripheral nerves, the central nervous system, or other organs and may occur together. It is not a formally established single diagnosis, so the individual adverse effects should be identified and recorded separately.

\synonyms
FQAD; Fluoroquinolone Toxicity Syndrome
...
\medterm{Flushable Reagent Stool Blood Test} Alternate name; see \textit{Fecal Occult Blood Test}.
...
\medterm{Focal Aware Seizures} Seizures arising from a localized brain network in which awareness is preserved during the event. Symptoms may be motor, sensory, autonomic, cognitive, emotional, or experiential.

\medterm{Focal Cortical Dysplasia} A localized congenital malformation of neocortical architecture and development characterized by disrupted cortical lamination, bizarre dysmorphic neurons, and abnormal balloon cells (in type IIb). It represents the most frequent histopathological etiology of medically refractory focal epilepsy in children and young adults requiring surgical resective therapy.

\synonyms
FCD; Taylor Dysplasia

\medterm{Focal Dermal Hypoplasia Syndrome} A rare X-linked disorder, usually in females, with thin or absent areas of skin following Blaschko lines and variable abnormalities of limbs, teeth, eyes, hair, and other organs. Management is multidisciplinary and tailored to the findings.
...
\medterm{Focal Impaired Awareness Seizures} Focal-onset seizures in which awareness is impaired during part or all of the seizure. Automatisms, behavioral arrest, confusion, and postictal amnesia may occur.

\medterm{Focal Neurological Deficit} An isolated, discrete impairment of central or peripheral nervous system function attributable to damage within a specific anatomical neuroaxis location, such as unilateral hemiparesis, localized sensory loss, cranial nerve palsy, or aphasia.
...
\medterm{Focused Assessment with Sonography for Trauma} A rapid bedside point-of-care ultrasonographic examination performed in acute trauma resuscitation to screen for free intraperitoneal blood (Morison pouch, splenorenal recess, pelvis) and hemopericardium (subxiphoid view).

\synonyms
FAST Exam; Trauma Ultrasound
...
\medterm{FODMAP} An abbreviation for fermentable oligosaccharides, disaccharides, monosaccharides, and polyols---short-chain carbohydrates that may be poorly absorbed and cause gas, bloating, pain, or diarrhea. A supervised reduction followed by gradual reintroduction may help some people with irritable bowel syndrome.
...
\medterm{Foetor Hepaticus} A distinctive, sweet, musty, or breath odor resembling rotten eggs and garlic, caused by the exhalation of volatile dimethyl sulfide and mercaptans that bypass hepatic metabolism due to portosystemic shunting and severe liver failure.
...
\medterm{Foix-Alajouanine Syndrome} A subacute necrotizing myelopathy caused by a slow-flow spinal dural arteriovenous fistula (dAVF), resulting in chronic spinal venous hypertension, progressive venous congestion, ischemic myelopathy, and lower-extremity paraparesis with sphincter impairment.
\synonyms
Subacute Necrotic Myelopathy; Spinal Dural AV Fistula Myelopathy
...
\medterm{Folate Deficiency Anemia} Anemia caused by too little folate, or vitamin B9. Red blood cells become unusually large and immature, causing fatigue, weakness, pale skin, shortness of breath, or a sore tongue. Blood tests help confirm the cause, and folate replacement is given after vitamin B12 deficiency is considered.

\synonyms
Vitamin B9 Deficiency Anemia; Megaloblastic Folate Anemia

\medterm{Folic Acid Deficiency Anemia} Alternate name; see \textit{Folate Deficiency Anemia}.

\medterm{Folate-Deficiency Anemia} Alternate spelling; see \textit{Folate Deficiency Anemia}.
...
\medterm{Folic Acid Test} A clinical laboratory blood test measuring serum or red blood cell folate concentrations to evaluate megaloblastic anemia, malnutrition, malabsorption syndromes, or dietary deficiency.

\synonyms
Serum Folate Test; RBC Folate Assay; Folate Blood Test

\medterm{Folie a Deux} A psychiatric syndrome in which a delusional belief or paranoid ideation is transmitted from an individual with an established primary psychotic disorder to one or more emotionally close, dependent individuals who share the delusion.

\synonyms
Shared Psychotic Disorder; Shared Delusional Disorder
...
\medterm{Follicle-Stimulating Hormone Abnormalities} Abnormally high or low FSH levels may reflect altered ovarian or testicular function, pituitary or hypothalamic disease, menopause, pregnancy, medicines, or a changing menstrual cycle. Interpretation requires age, sex, reproductive stage, and related hormone tests.
...
\medterm{Fong Disease} Alternate name; see \textit{Nail-Patella Syndrome}.

\medterm{Francois Dyscephaly Syndrome} Alternate name; see \textit{Hallermann's Syndrome}.
...
\synonyms
Egg Hypersensitivity; Ovomucoid Allergy

\synonyms
Cow's Milk Protein Allergy (CMPA); Dairy Hypersensitivity
...
\synonyms
Food Poisoning; Acute Alimentary Toxicosis
...
\medterm{Food Protein-Induced Allergic Proctocolitis} A non-IgE-mediated food reaction, usually in an infant, causing inflammation of the lower bowel and visible blood or mucus in otherwise well-appearing stools. Cow’s-milk or soy protein is often involved.

\medterm{Food Protein-Induced Enterocolitis Syndrome} A delayed, non-IgE-mediated food allergy that usually causes repeated vomiting, diarrhea, pallor, lethargy, or dehydration several hours after eating a trigger food. It is most common in infants and young children.
...
\synonyms
Peroneal Nerve Palsy; Steppage Gait
...
\synonyms
Metatarsal Fracture; Tarsal Fracture
...
\medterm{Footling Breech} A variation of incomplete breech presentation in which one or both feet (single or double footling) lie below the buttocks and present first at the maternal pelvic inlet. It carries the highest risk of umbilical cord prolapse and fetal head entrapment among all breech presentations, usually requiring delivery by cesarean section.
\synonyms Incomplete breech; Footling breech presentation.
...
\medterm{Foramen Lacerum} A triangular, irregular aperture in the middle cranial fossa base bounded by the sphenoid, apex of the petrous temporal, and basilar occipital bones, filled with fibrocartilage in life and crossed superiorly by the internal carotid artery as it enters the cavernous sinus.

\medterm{Foramen of Monro} A paired, crescent-shaped aperture situated between the column of the fornix and the anterior pole of the thalamus connecting each lateral cerebral ventricle with the midline third ventricle, permitting the physiological circulation of cerebrospinal fluid.
...
\medterm{Foramen Rotundum} A circular bony canal in the greater wing of the sphenoid bone that connects the middle cranial fossa with the pterygopalatine fossa, transmitting the maxillary division of the trigeminal nerve (cranial nerve V2).

\medterm{Foramen Spinosum} A small, round aperture located posterolateral to the foramen ovale in the greater wing of the sphenoid bone, transmitting the middle meningeal artery, middle meningeal vein, and the nervous spinosus (meningeal branch of CN V3) into the cranial cavity.
...
\medterm{Forbes-Albright Syndrome} A clinical syndrome characterized by hyperprolactinemia, galactorrhea, and amenorrhea in women in the absence of recent pregnancy, classically caused by a prolactin-secreting pituitary adenoma (prolactinoma).
...
\medterm{Forchheimer Spots} Small, pinhead-sized, reddish macules or petechiae appearing on the soft palate and uvula during the prodromal phase of rubella (German measles).
\synonyms
Forchheimer's Spots; Rubella Enanthem
...
\medterm{Fordyce Granules} Ectopic, asymptomatic sebaceous glands that appear as clusters of tiny, painless yellowish-white papules on the buccal mucosa and the vermilion border of the lips, representing a common normal anatomical variant.
...
\synonyms
Brow Lift; Corrugator Resection
...
\medterm{Foreign Body in Ear} Alternate name; see \textit{Ear Foreign Body}.
...
\medterm{Forensic Autopsy of Blunt Force Trauma} Postmortem examination of injuries caused by blunt impact, including abrasions, contusions, lacerations, fractures, and internal organ damage. Wound patterns, distribution, vitality, and associated evidence help reconstruct the event.

\medterm{Forensic Autopsy of Sharp Force Injuries} Postmortem examination of incised, stab, chop, or other sharp-force wounds. The examiner documents wound morphology, depth, direction, vital reaction, clothing damage, and associated injuries to help determine mechanism and manner of death.

\medterm{Forensic Defense Wounds} Injuries to the hands, arms, or other body areas that may occur when a person tries to protect against an assault. Their meaning must be assessed with the history and all other evidence.
\synonyms
...
\medterm{Forensic Laceration} A torn wound caused by blunt force, usually with irregular bruised edges and tissue strands crossing the wound. These features help distinguish it from a clean cut caused by a sharp object.

\synonyms
Blunt Force Tear; Tears and Ruptures
...
\medterm{Forensic Pathology of Firearm Wounds} Examination of firearm-related injuries, including entrance and exit wounds, soot, stippling, bullet paths, projectile effects, clothing damage, and range-of-fire findings, integrated with imaging, scene evidence, and recovered bullets.

\medterm{Forensic Pathology of Thermal Injuries} Examination of burns and other heat-related injuries, including burn depth and distribution, soot or airway injury, heat artifacts, and evidence of vital reaction. Findings are interpreted with scene information and toxicology.
...
\medterm{Foreskin} The fold of skin covering and protecting the head of the penis. It normally becomes retractable over time; forceful retraction can cause pain, tearing, or scarring.

\synonyms
Prepuce; Penile Prepuce
...
\medterm{Formoterol Fumarate} A long-acting inhaled medicine that relaxes airway muscles and helps prevent symptoms of asthma or chronic obstructive lung disease. It is not a rescue medicine for sudden severe breathing difficulty. When used for asthma, it should be combined with an inhaled corticosteroid rather than used alone.
...
\medterm{Forrest Classification} A standardized, internationally recognized endoscopic classification system used to stratify peptic ulcer hemorrhage into risk categories for rebleeding and determine the necessity of endoscopic hemostasis. Subdivided into active spurting hemorrhage (Ia), active oozing (Ib), visible non-bleeding vessel (IIa), adherent clot (IIb), pigmented flat spot (IIc), and clean-based ulcer (III).

\synonyms
Forrest Endoscopic Bleeding Criteria; Forrest Staging
...
\medterm{Fossa Navicularis} An expanded, boat-shaped anatomical dilation of the penile urethra situated within the glans penis immediately proximal to the external urethral meatus, lined by non-keratinized stratified squamous epithelium.
...
\medterm{Foster Kennedy Syndrome} A neuro-ophthalmic syndrome characterized by ipsilateral optic atrophy and anosmia (due to direct compression of the optic nerve and olfactory tract by an anterior cranial fossa tumor, such as an olfactory groove meningioma) and contralateral papilledema (due to raised intracranial pressure).
\synonyms
Kennedy Syndrome; Gowers-Paton-Kennedy Syndrome
...
\medterm{Fothergill Sign} A physical examination test used to differentiate an abdominal wall mass (such as a rectus sheath hematoma) from an intra-abdominal mass; a hematoma or mass within the rectus sheath does not cross the midline and remains fixed and palpable during contraction of the rectus abdominis muscles when the patient raises their head.
\synonyms
Fothergill's Sign; Rectus Sheath Hematoma Sign

\medterm{Foul-Smelling Stools} Strongly odorous feces that may result from diet, infection, bleeding, malabsorption, altered gut bacteria, or rapid transit; persistent change with weight loss or diarrhea warrants review.
...
\medterm{Fournier Disease} Alternate name; see \textit{Fournier Gangrene}.
...
\medterm{Fourth Heart Sound} An extra, low heart sound heard right before the main heartbeat, caused by the heart working harder to push blood into a stiff heart muscle.
...
\medterm{Foville Syndrome} An inferior medial pontine stroke syndrome typically resulting from occlusion of paramedian perforating branches of the basilar artery. Characterized by ipsilateral facial paralysis (cranial nerve VII), ipsilateral horizontal conjugate gaze palsy (abducens nucleus or PPRF), and contralateral hemiplegia of the upper and lower extremities (corticospinal tract).

\synonyms
Foville Inferior Pontine Syndrome
...
\medterm{Fractional Excretion of Urea} The percentage of filtered urea excreted in urine. It can support assessment of kidney blood flow when diuretics affect sodium testing, but infection, bleeding, nutrition, and chronic kidney disease also influence the result.

\synonyms
FEUrea; Urinary Urea Excretion Index

\medterm{Fractional Exhaled Nitric Oxide} A breath test that estimates type 2, often eosinophilic, airway inflammation. The result is interpreted with symptoms, age, treatment, and other clinical findings.

\synonyms
Fractional Exhaled Nitric Oxide; Exhaled NO Marker
...
\medterm{Fractional Shortening} An echocardiographic measurement of left ventricular systolic contractile function representing the percentage change in the left ventricular internal diameter between end-diastole (LVIDd) and end-systole (LVIDs). Calculated as the difference divided by end-diastolic diameter multiplied by 100 percent, with normal values typically ranging from 25 to 45 percent.
...
\synonyms
Nasal Bone Fracture; Nasal Trauma
...
\synonyms
Costal Fracture; Broken Ribs

\medterm{Fractures} Broken bones caused by injury, repeated stress, weakened bone, or disease. Assessment considers location, alignment, skin injury, blood supply, nerve function, and associated damage; treatment may include immobilization, reduction, or surgery.
...
\medterm{Fracture Malunion} Healing of a broken bone in an incorrect position, such as with angling, shortening, or rotation. It may cause deformity, pain, weakness, altered movement, or abnormal stress on nearby joints.

\medterm{Fracture Nonunion} Failure of a broken bone to heal within the expected time, with no continuing progress toward healing. Pain, movement at the fracture site, or persistent weakness may occur, and causes include poor blood supply, infection, instability, and smoking.
...
\medterm{Fragile X-Associated Tremor/Ataxia Syndrome} A late-onset progressive neurodegenerative disorder affecting premutation carriers (55 to 200 CGG repeats) of the \textit{FMR1} gene, typically manifesting in men older than fifty years. Characterized by progressive intention tremor, cerebellar gait ataxia, parkinsonism, cognitive executive decline, and symmetric hyperintensities of the middle cerebellar peduncles ("MCP sign") on T2-weighted MRI.

\synonyms
FXTAS

\medterm{Fragile X Syndrome} An X-linked inherited condition caused by a CGG-repeat expansion in the \textit{FMR1} gene. It can affect learning, speech, behavior, social development, and physical features and is a common inherited cause of intellectual disability; expression varies because of repeat size, methylation, and sex.

\medterm{FRAXA} Alternate genetic name; see \textit{Fragile X Syndrome}.
...
\medterm{Frank Breech} The most common breech presentation (accounting for 50--70\% of all breech births), in which the fetus is positioned with hips flexed and knees extended so that the feet lie near the head and the buttocks present first to the birth canal. Compared to complete or footling breech, it has the lowest risk of umbilical cord prolapse.
\synonyms Extended breech; Frank breech presentation.

\medterm{Frank Haemoptysis} Alternate form; see \textit{Haemoptysis}.

\medterm{Frank Sign} A diagonal skin crease running across the lobule of the ear from the tragus to the posterior margin of the auricle, recognized as an independent clinical physical sign associated with coronary artery disease and peripheral vascular atherosclerosis.
\synonyms
Frank's Sign; Diagonal Earlobe Crease

\medterm{Frank-Starling Law} The fundamental cardiac physiological principle stating that, within physiological limits, the stroke volume and contractile force of the ventricles increase in direct proportion to the volume of blood filling the heart at end-diastole (preload), resulting from optimized myocardial actin-myosin overlap.

\synonyms
Starling Law of the Heart; Heterometric Autoregulation
...
\synonyms
Sequestered Disc Fragment; Extruded Herniated Fragment
...
\medterm{Freiberg Disease} An idiopathic avascular necrosis (osteochondrosis) affecting the head of a metatarsal bone (most commonly the second metatarsal head), typically occurring in adolescent and young adult females, presenting with forefoot pain and stiffness exacerbated by weight-bearing.
\synonyms
Freiberg Infraction; Metatarsal Head Osteochondrosis
...
\medterm{Frenulum} A fold of skin or mucous membrane that anchors a body part and limits its movement. Examples include the tongue fold, lip folds, and penile frenulum.

\synonyms
Frenulum; Lingual or Labial Fold
...
\medterm{Fresh Frozen Plasma} A blood transfusion component prepared from whole blood or apheresis and frozen within eight hours of collection, containing all physiological coagulation factors and plasma proteins in normal physiological concentrations, used to treat complex coagulopathies and massive transfusion.
...
\medterm{Frey Syndrome} An abnormal gustatory sweating and facial flushing over the parotid and preauricular region occurring in response to mastication or tasting food, caused by aberrant misdirected regeneration of severed parasympathetic secretomotor fibers of the auriculotemporal nerve into sympathetic sweat glands following parotid gland surgery or trauma.
\synonyms
...
\medterm{Friction Blisters} Fluid-filled blisters caused by repeated rubbing or pressure, commonly on the feet or hands. Protecting the area, reducing friction, and keeping a ruptured blister clean helps healing; extensive, infected, or recurrent blisters need assessment.

\medterm{Friedlander Pneumonia} A severe, acute lobar pneumonia caused by \textit{Klebsiella pneumoniae}, classically presenting in alcohol-dependent or immunocompromised patients with high fever, dense upper lobe cavitary consolidation, and thick, gelatinous "current-jelly" bloody sputum.
...
\medterm{Froin Syndrome} The triad of clear xanthochromia, elevated protein content, and rapid spontaneous clotting of cerebrospinal fluid (CSF) obtained below a complete anatomical obstruction of the spinal subarachnoid space (e.g., from a compressive spinal cord tumor or severe spinal stenosis).
\synonyms
Froin's Syndrome; Spinal Subarachnoid Blockade Syndrome

\medterm{Froment Sign} A clinical sign of ulnar nerve palsy; when attempting to firmly pinch a piece of paper between the thumb and index finger, paralysis of the adductor pollicis forces the patient to compensate by flexing the interphalangeal joint of the thumb using the flexor pollicis longus (innervated by the anterior interosseous nerve).
\synonyms
Froment's Paper Sign; Ulnar Pinch Sign
...
\synonyms
FLE; Frontal Lobe Epilepsy Syndrome
...
\synonyms
Frontal Lobe Ictal Episodes; Hypermotor Seizures

\medterm{Frontal Lobe Syndrome} A clinical neuropsychiatric disorder resulting from traumatic, ischemic, or neurodegenerative injury to the frontal lobes, manifesting as executive dysfunction, behavioral disinhibition, apathy, abulia, impaired social judgment, utilization behavior, and loss of emotional control.
...
\synonyms
FTD; Pick Complex; Behavioral Variant FTD
...
\medterm{Fulminating Hyperpyrexia} Alternate name; see \textit{Malignant Hyperthermia}.

\medterm{Frotteuristic Disorder} A mental disorder involving persistent sexual arousal from touching or rubbing against a person without consent, with clinically significant distress or impairment or acting on the urges. Nonconsensual touching is sexual assault.
...
\synonyms
Adhesive Capsulitis; Periarthritis of Shoulder
...
\medterm{Fructose 1,6-Diphosphatase Deficiency} An inherited disorder of gluconeogenesis caused by deficient fructose-1,6-bisphosphatase. Fasting or illness can lead to low blood glucose, lactic acidosis, ketosis, vomiting, and marked weakness.
...
\medterm{Fuchs' Dystrophy} A usually inherited, slowly progressive disease of the inner layer of the cornea. The damaged endothelial cells cannot remove enough fluid, so the cornea becomes swollen and cloudy. It may cause blurred or hazy vision, glare, halos, light sensitivity, and vision that is worse in the morning. In advanced disease, painful blisters and corneal scarring may develop. It usually affects both eyes, although one eye may be worse than the other.
...
\medterm{Fuchs Endothelial Dystrophy} A progressive, bilateral, hereditary dystrophic disorder of the corneal endothelium characterized by accelerated endothelial cell loss and the formation of extracellular collagenous excrescences (guttae) on Descemet membrane. As endothelial pump function fails, the cornea develops progressive stromal edema, epithelial microcysts, painful bullae (bullous keratopathy), and painless loss of visual acuity, classically worse upon awakening.

\synonyms
FECD; Fuchs Corneal Dystrophy
...
\medterm{Fukuda Stepping Test} A bedside vestibular examination test in which the patient marches in place for 50 to 100 steps with eyes closed and arms extended; a rotation of greater than 30 to 45 degrees towards one side indicates an ipsilateral unilateral peripheral vestibular hypofunction.
\synonyms
Unterberger-Fukuda Test; Vestibular Stepping Test
...
\medterm{Functional Constipation} Long-lasting constipation without an identified blockage or other clear disease causing it. Stools may be hard or difficult to pass, or a person may feel that the bowel has not emptied fully. It may be related to diet, low fluid intake, inactivity, or regularly ignoring the urge to pass stool.

\medterm{Functional Decline} A reduction in a person’s ability to move, think, communicate, or perform daily activities compared with their previous level. In older adults it may result from illness, medicines, hospitalization, pain, poor nutrition, or lack of activity.

\medterm{Functional Diarrhea} Long-lasting loose or watery stools without an identified infection or other clear disease causing them. Unlike irritable bowel syndrome, belly pain is not the main symptom. Diet, medicines, stress, and changes in bowel movement can contribute.
...
\synonyms
Nonulcer Dyspepsia; Nonulcer Stomach Pain
...
\medterm{Functional Endoscopic Sinus Surgery} A minimally invasive surgical procedure performed through the nostrils to treat chronic rhinosinusitis, recurrent sinus infections, or nasal polyposis that fail to respond to medical treatment. Using specialized high-definition fiberoptic endoscopes and micro-debriding instruments, an ear, nose, and throat (ENT) surgeon visualizes the narrow paranasal sinus drainage pathways without making facial or external skin incisions. The surgeon gently widens the natural sinus openings (ostia), clears diseased mucosal tissue or obstructing polyps, and straightens anatomical obstructions. By restoring natural mucus clearance and airflow ventilation while preserving healthy normal mucous membranes, FESS relieves chronic facial pressure, nasal obstruction, and headache, allowing topical steroid rinses to reach the sinus cavities effectively.

\synonyms
FESS; Endoscopic Sinus Surgery; ESS; Functional Sinus Surgery
...
\synonyms
Disorders of Gut-Brain Interaction; FGIDs
...
\medterm{Functional Impairment} Difficulty performing usual work, study, self-care, relationships, or other daily activities because of symptoms, illness, injury, or treatment. The degree of impairment is considered separately from the diagnosis and may change over time.
...
\medterm{Functional Neurological Disorder} Alternate name; see \textit{Functional Neurologic Disorder}.

\medterm{Functional Neurological Symptom Disorder} Alternate name; see \textit{Functional Neurologic Disorder}.

\medterm{Functional Neurologic Disorder} A disorder in which altered nervous-system function causes genuine symptoms such as weakness, abnormal movements, functional seizures, or sensory changes. Diagnosis is based on characteristic positive clinical features showing incompatibility with recognized neurologic disease, rather than solely on the absence of structural abnormalities.
\synonyms
FND; Conversion Disorder; Functional Neurological Symptom Disorder

\medterm{Functional Neurologic Disorder/Conversion Disorder} Alternate name; see \textit{Functional Neurologic Disorder}.

\medterm{Functional Ovarian Cysts} Alternate name; see \textit{Cysts, Ovarian, Functional}.
...
\medterm{Functioning Carcinoid} Alternate name; see \textit{Carcinoid Tumor}.
...
\medterm{Fungal Corneal Ulcer} A serious fungal infection and open sore on the cornea, the clear front surface of the eye. It may follow an injury involving plant material, contaminated contact lenses, or prolonged steroid eye-drop use. Severe pain, redness, light sensitivity, blurred vision, or a cloudy spot may occur. Eye examination and testing of a corneal sample can support the diagnosis; urgent specialist treatment is needed to protect vision.

\synonyms
Fungal Keratitis; Keratomycosis; Mycotic Corneal Ulcer
...
\medterm{Fungal Infection} An illness caused by fungi---microscopic organisms such as yeasts and molds---entering, growing, or multiplying in or on the body. Fungi are distinct from both bacteria and viruses. Many harmless fungi live naturally in the environment (such as soil and plants) or quietly on human skin and mucous membranes. An infection happens when fungi overgrow or break through the body's defenses. Fungal infections generally fall into two main groups: superficial or mild infections (such as athlete's foot, ringworm, jock itch, fungal nail infections, and oral or vaginal thrush, which affect the outer skin, hair, nails, or mucous membranes and cause itching, redness, flaking, or white patches) and deep or invasive infections (such as aspergillosis, cryptococcal meningitis, or mucormycosis, where fungal spores enter the lungs or bloodstream and spread to vital organs like the brain, lungs, heart, or kidneys). Deep infections are life-threatening and primarily strike individuals with weakened immune systems, such as people undergoing cancer treatment, taking immunosuppressive drugs, or living with uncontrolled diabetes or HIV. Fungal infections do not respond to antibiotics or antivirals; they are treated with antifungal medicines applied topically or taken orally or intravenously. Keeping the skin clean, dry, and practicing good hygiene helps prevent many common fungal infections.

\synonyms
Mycosis; Mycotic Infection; Fungal Disease

\medterm{Fungal Nail Infection} A fungal infection of a fingernail or toenail causing thickening, discoloration, brittleness, or separation from the nail bed. Diagnosis may require testing because injury and skin disease can look similar.

\synonyms
Onychomycosis; Tinea Unguium; Nail Mycosis

\medterm{Fungal Nail Infections} Alternate name; see \textit{Fungal Nail Infection}.
...
\medterm{Fungal Pneumonia} Pneumonia caused by fungi, including endemic fungi, Aspergillus, Pneumocystis, and other opportunistic organisms. Risk depends on geography, immune status, neutropenia, transplantation, and inhaled exposures; diagnosis may require cultures, antigen or molecular tests, imaging, and bronchoscopy.
...
\medterm{Fused Teeth} Alternate name; see \textit{Dental Fusion}.
...
\medterm{Familial Emphysema} Emphysema caused or strongly predisposed by an inherited disorder, especially alpha-1 antitrypsin deficiency. It can occur at a younger age and may be worsened by smoking or occupational exposures.

\medterm{Familial Jaundice} Jaundice caused by an inherited disorder of bilirubin production, conjugation, transport, or excretion. Examples include Gilbert syndrome, Crigler-Najjar syndrome, Dubin-Johnson syndrome, and Rotor syndrome.

\medterm{Familial Lichen Amyloidosis (Type IX)} A hereditary form of primary localized cutaneous amyloidosis in which amyloid deposits in the skin cause intensely itchy, thickened, rippled, or hyperpigmented lesions, usually on the shins or upper back.

\medterm{Familial Multiple Polyposis} An older name for familial adenomatous polyposis, an inherited disorder causing numerous adenomatous colorectal polyps and a very high risk of colorectal cancer without appropriate surveillance and preventive treatment.

\medterm{Familial Primary Pulmonary Hypertension} Heritable pulmonary arterial hypertension caused by pathogenic variants, most often involving the \textit{BMPR2} pathway. Progressive narrowing of pulmonary arteries increases right-heart strain and can cause breathlessness, fainting, or right-heart failure.

\medterm{Fibrinoid Leukodystrophy} An older name associated with Alexander disease, a rare astrocyte disorder in which Rosenthal fibers accumulate and white matter is damaged. Clinical features vary by age and may include developmental regression, seizures, movement problems, or bulbar dysfunction.

\medterm{Fibrosing Cholangitis} Chronic inflammation and scarring of the bile ducts, most commonly referring to primary sclerosing cholangitis. It can cause cholestasis, itching, jaundice, recurrent bacterial cholangitis, cirrhosis, and increased risk of bile-duct cancer.

\medterm{Fibrous Cavernositis} Inflammation and fibrosis of the erectile tissue of the penis, which may cause pain, swelling, erectile dysfunction, or curvature. Infection, trauma, injections, and other inflammatory conditions can contribute.

\medterm{Fibrous Interstitial Pneumonia} A pattern of lung disease in which inflammation and scar tissue thicken the interstitium and impair oxygen transfer. Causes include idiopathic pulmonary fibrosis, autoimmune disease, medication toxicity, and environmental exposure.

\medterm{Fibrous Plaques of the Penis} Fibrous scar-like plaques within the penile tunica albuginea, characteristic of Peyronie disease. They may cause penile curvature, pain during erection, shortening, or difficulty with sexual activity.

\medterm{Fibrous Sclerosis of the Penis} Another descriptive name for Peyronie disease, a disorder in which fibrous plaques form in the erectile covering and may bend or shorten the penis.

\medterm{Field Fever} An older name for leptospirosis, a zoonotic bacterial infection acquired from water or soil contaminated with urine from infected animals. It may cause fever, muscle pain, headache, jaundice, kidney injury, or meningitis.

\medterm{Finger Sucking} Persistent sucking of a finger or thumb beyond early childhood. Prolonged habit can alter tooth position, the palate, bite, and facial growth; dental assessment may be useful when it persists or causes injury.

\medterm{Finnish Type Amyloidosis (Type V)} A hereditary gelsolin amyloidosis caused by variants in the \textit{GSN} gene. It commonly causes slowly progressive corneal lattice dystrophy, cranial-nerve weakness, and lax or aging-looking skin, with variable systemic involvement.

\medterm{First Menstrual Period} Menarche, the first menstrual bleeding, usually occurring during puberty. Timing varies, but absence by the expected developmental stage or bleeding with severe pain or other concerning symptoms warrants medical assessment.
