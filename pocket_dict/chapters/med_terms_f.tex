...
\medterm{Fabry's Disease} Alternate index label for Fabry Disease.
...
\medterm{Factitious Disorders} Alternate index label for Factitious Disorder.
...
\medterm{Fatty Liver (Steatosis)} Alternate index label; see \textit{Fatty Liver Disease}.

\medterm{Fatty Liver} Alternate index label; see \textit{Fatty Liver Disease}.
...
\medterm{Fibrocystic Breast Changes} Alternate index label; see \textit{Fibrocystic breasts}.

\medterm{Fibrocystic Breast Condition} Alternate index label; see \textit{Fibrocystic breasts}.
...
\medterm{Floater} Alternate index label for Floaters.
...
\medterm{Folate-Deficiency Anemia} Alternate index label; see \textit{Folate Deficiency Anemia}.
...
\medterm{Fetal Alcohol Spectrum Disorders (FASD)} Alternate plural form; see \textit{Fetal Alcohol Spectrum Disorder}.
