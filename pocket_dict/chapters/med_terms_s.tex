...
\medterm{Skin Cancer} Cancer that begins in skin cells. Common types include basal-cell cancer, squamous-cell cancer, and melanoma. A changing, bleeding, growing, or nonhealing spot should be examined. Limiting ultraviolet exposure and using sun protection reduce risk, but do not prevent every case.
\synonyms
Cancer, Skin
