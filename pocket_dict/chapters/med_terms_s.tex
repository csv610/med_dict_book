...
\medterm{S4 Gallop Pathology} An extra heart sound caused when the upper heart chamber pushes blood into a stiff lower chamber. It can occur with long-standing high blood pressure, a narrowed aortic valve, or thickened heart muscle. A new S4 needs assessment with the rest of the heart examination.
...
\medterm{Sacral Nerve Stimulation} A treatment that sends mild electrical pulses to nerves near the lower spine to improve bladder or bowel control. It may be considered for persistent urinary or fecal incontinence and selected urinary-retention or constipation problems when other treatments have not helped.
...
\medterm{Sentinel Lymph Node} The first lymph node or group of nodes most likely to receive drainage from a tumor. Doctors may remove and examine these nodes to look for early spread and help determine the cancer’s stage.
...
\medterm{Sleep Apnea (Dental)} A custom oral device worn during sleep to hold the lower jaw or tongue forward and keep the upper airway open. It may help selected people with obstructive sleep apnea, especially those who cannot use positive-airway-pressure treatment; dental and sleep follow-up is needed.
...
\medterm{Stool C Difficile Toxin} A stool test that detects toxins made by Clostridioides difficile, a bacterium that can cause antibiotic-associated diarrhea and colitis. A positive result supports active infection when compatible diarrhea is present; detection alone may reflect colonization.
