...
\medterm{Sacral Vertebrae} The five sacral vertebrae that fuse to form the sacrum, connect the spine to the pelvis, and provide foramina for sacral nerve roots.
...
\medterm{Sacroiliac Joint Pain} Pain or abnormal movement from the joint between the lower spine and pelvis. It may cause pain in the lower back, buttock, or thigh and can follow injury, pregnancy, arthritis, or changes in walking.
...
\medterm{Scarlatina} Alternate name; see \textit{Scarlet fever}.
...
\medterm{Scarlet Fever} Alternate name; see \textit{Scarlatina}.
...
\medterm{Seasonal Affective Disorder} Alternate name; see \textit{Depressive disorders}.
...
\medterm{Secondhand Smoke} Alternate name; see \textit{Secondhand smoke}.
...
\medterm{Septicemia} Alternate name; see \textit{Sepsis}.
...
\medterm{Sever Disease} Alternate name; see \textit{Sever condition}.
...
\medterm{Severe Acute Respiratory Syndrome} Alternate name; see \textit{SARS}.
...
\medterm{Severe Combined Immunodeficiency} A group of inherited disorders in which the immune system cannot make effective defenses against germs. Babies may develop repeated, severe infections, persistent diarrhea, or poor growth; early diagnosis and treatment can be lifesaving.
...
\medterm{Shaken Baby Syndrome} Alternate name; see \textit{Abusive head trauma}.
...
\medterm{Shingles} Alternate name; see \textit{Herpes zoster}.
...
\medterm{Sickle Cell Disease} Alternate name; see \textit{Sickle Cell}.
...
\medterm{Sleep Disorders} Health conditions that disturb how much a person sleeps, when they sleep, or how restful sleep is. They may involve insomnia, breathing pauses, unusual movements, excessive sleepiness, unusual nighttime behavior, or a body clock that is out of step.
...
\medterm{Small Intestinal Bacterial Overgrowth} Alternate name; see \textit{SIBO}.
...
\medterm{Social Anxiety Disorder} Alternate name; see \textit{Social phobia}.
...
\medterm{Soft Tissue Sarcoma} Alternate name; see \textit{Soft tissue sarcoma}.
...
\medterm{Sore Throat} Alternate name; see \textit{Pharyngitis}.
...
\medterm{Spinal Stenosis} Alternate name; see \textit{Spinal stenosis}.
...
\medterm{Staph Infection} Alternate name; see \textit{Staphylococcal infection}.
...
\medterm{Stomach Ulcer} Alternate name; see \textit{Peptic ulcer}.
...
\medterm{Streptococcus Pneumoniae} A gram-positive bacterium that can cause pneumonia, meningitis, sinusitis, otitis media, and bloodstream infection; vaccines reduce disease risk.
...
\medterm{Sudden Infant Death Syndrome} Sudden infant death syndrome is the sudden, unexplained death of an infant younger than one year, usually during sleep. Safe-sleep practices reduce risk: place babies on their backs on a firm, flat surface without loose bedding.
...
\medterm{Swimmer's Ear} Alternate name; see \textit{Otitis externa}.
...
\medterm{Systemic Sclerosis} Alternate name; see \textit{Scleroderma}.
