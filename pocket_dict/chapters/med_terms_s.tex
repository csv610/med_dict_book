...
\medterm{Sapporo Virus} Historical name; see \textit{Sapovirus}.
...
\medterm{Selective Serotonin Reuptake Inhibitor} A selective serotonin reuptake inhibitor is an antidepressant that increases serotonin signaling in the brain. Examples include fluoxetine, sertraline, and escitalopram.
...
\medterm{Senility} Historical term; see \textit{Cognitive Decline}.
...
\medterm{Sepsis} A life-threatening condition in which the body's response to an infection damages its own organs. It may cause confusion, very fast breathing or heartbeat, low blood pressure, reduced urine, or severe weakness.

\synonyms
Blood Poisoning; Systemic Inflammatory Response Syndrome
...
\medterm{Shift-Work Sleep Disorder} A circadian rhythm sleep-wake disorder affecting individuals who work non-traditional hours (night shifts, rotating shifts, or early mornings), characterized by excessive daytime sleepiness during waking working hours and insomnia during attempted daytime sleep.
...
\medterm{Shock Therapy} Historical and imprecise term; see \textit{Electroconvulsive Therapy} when that treatment is intended.
...
\medterm{Sun Poisoning} Alternate name; see \textit{Polymorphous light eruption}.
