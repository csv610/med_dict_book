...
\medterm{Sabarubicin} An experimental cancer medicine related to anthracyclines and studied for its ability to kill cancer cells. Its effectiveness, safety, possible uses, and long-term effects remain subjects of clinical research.
...
\medterm{Sacroileitis} A misspelling or variant spelling of sacroiliitis, inflammation of one or both joints between the spine and pelvis. It may cause low-back or buttock pain and stiffness and can result from arthritis, infection, injury, or inflammatory disease.
...
\medterm{Safety Of Drugs} The process of assessing and managing medicine benefits, risks, interactions, reasons not to use a drug, monitoring needs, and safe use. It includes checking the patient, dose, allergies, and other medicines.
...
\medterm{Salpingitis Isthmica Nodosa} Small nodules and outpouchings in the narrow part of a fallopian tube, often linked with previous inflammation. They can narrow the tube and increase the risk of infertility or pregnancy developing outside the uterus.
...
\medterm{Sano Shunt} A temporary tube connecting the right ventricle to the pulmonary artery during the first operation for some babies with severe left-sided heart defects. It directs blood to the lungs while the heart is reconstructed; blockage, excess or insufficient blood flow, and bleeding are serious risks.
...
\medterm{Satellite Virus} A small virus-like infectious agent that can multiply only when a separate helper virus is present. It depends on that helper for essential functions and may change how the helper infection behaves.
...
\medterm{Scanning Techniques} Methods that systematically examine a body region, organ, or sample using imaging, measurement, or other detection tools.
...
\medterm{Scatter Events} Photons deflected from original path. Corrected by energy windowing and scatter correction algorithms. Events in which radiation particles change direction after interacting with matter, reducing image accuracy and clarity.
...
\medterm{Schlemm’S Canal} A circular drainage channel around the edge of the cornea that carries fluid from the front of the eye into blood vessels. Poor drainage can raise eye pressure and contribute to glaucoma.
...
\medterm{Scirrhus} A hard, firm form of cancer containing unusually large amounts of fibrous tissue. The older term was used especially for breast or stomach cancers and describes texture rather than a separate cancer type.
...
\medterm{Sclerosing Mesenteritis} A rare condition causing inflammation and scar-like thickening in the mesentery, the tissue supporting the intestines. It may cause abdominal pain, nausea, weight loss, bowel blockage, or no symptoms at all.

\medterm{Sclerosing Peritonitis} Thickening and scarring of the peritoneum that can restrict movement of the intestines. Thickening and scarring of the abdominal lining that can restrict the intestines and cause pain or blockage.
...
\medterm{Seasonal Affective Disorder Syndrome} A recurring depression pattern linked to a particular season, often beginning in autumn or winter. Symptoms may include low mood, tiredness, oversleeping, increased appetite, withdrawal, and reduced interest in activities.
...
\medterm{Segmental Pressures} Blood-pressure readings taken at several levels of the arms and legs to compare blood flow. Differences between levels can help show where an artery is narrowed or blocked in peripheral artery disease.
...
\medterm{Senile Dementia} An outdated term formerly used for dementia in older adults. An outdated term formerly used for dementia in older adults; current diagnosis specifies the cause.
...
\medterm{Sensitisation} The process by which repeated exposure makes an immune, nerve, or behavioral response stronger than before.
...
\medterm{Sentinel Event} Unexpected occurrence involving death or serious physical/psychological injury. Requires root cause analysis. An unexpected event causing death or serious physical or psychological harm, requiring investigation to prevent recurrence.
...
\medterm{Seronegative Arthritis} Arthritis with negative rheumatoid factor and anti-CCP tests, including several inflammatory joint diseases with different symptoms and treatments.
...
\medterm{Sesamoiditis} Inflammation and pain around a small sesamoid bone, often beneath the big toe and worsened by pressure or activity.
...
\medterm{Sexual Dysfunction} Ongoing difficulty with sexual desire, arousal, erection, ejaculation, orgasm, or pain that causes distress or relationship problems. Causes may be physical, psychological, medication-related, hormonal, or linked with communication and life circumstances.
...
\medterm{Sexually Transmitted Diseases (STDs)} Infections mainly spread through sexual contact, including chlamydia, gonorrhea, syphilis, HIV, HPV, and others.
...
\medterm{Sexually Transmitted Infection} An infection spread mainly through sexual contact, including vaginal, anal, or oral sex. Examples include chlamydia, gonorrhea, syphilis, HIV, herpes, and human papillomavirus; many cause no early symptoms, so testing, treatment, and partner care are important.
...
\medterm{Sgarbossa Criteria} An ECG scoring system used to look for a heart attack when a left bundle branch block or paced rhythm makes the ECG difficult to interpret. It checks for ST-segment changes that match or strongly oppose the main heartbeat pattern. A high score supports an acute blocked coronary artery, but the result must be combined with symptoms, examination, and other tests. A modified version uses proportional ST changes.
...
\medterm{Sickle Cell Disease} See \textit{Sickle Cell}.
...
\medterm{Signal-To-Noise Ratio} Ratio of true counts to statistical noise. Improved by longer acquisition, higher activity. A measure comparing useful signal with background noise; higher values usually mean clearer measurements or images.
...
\medterm{Single Nucleotide Polymorphism} A common variation involving one DNA building block, useful in genetic studies and some medicine-response testing.
...
\medterm{Sinusoid} A small, wide, highly permeable blood vessel found especially in the liver, spleen, and bone marrow. Its loose walls allow blood to exchange cells, proteins, nutrients, and waste with nearby tissues.
...
\medterm{Sizofiran} Sizofiran is an investigational beta-glucan immunomodulator studied as an adjunct to cancer treatment. An experimental immune-modifying substance studied as an addition to cancer treatment; it is not routine therapy.
...
\medterm{SjöGren'S Syndrome} A chronic autoimmune disorder characterized by lymphocytic infiltration and destruction of exocrine glands, primarily the salivary and lacrimal glands, resulting in dry eyes (keratoconjunctivitis sicca) and dry mouth (xerostomia).
\synonyms
SjöGren's Disease
...
\medterm{Sleep} A naturally recurring physiological state characterized by altered consciousness, reduced sensory responsiveness, and distinct brain wave patterns that is essential for physical restoration, memory consolidation, and metabolic regulation.
\synonyms
...
\medterm{Sleeplessness} Ongoing difficulty falling asleep, staying asleep, or waking too early despite having enough opportunity to sleep. It may cause tiredness or problems with daytime activities.
...
\medterm{Small Eye} An eye smaller than expected because of abnormal development before birth; severe microphthalmia can reduce vision.
...
\medterm{Small Round Blue Cell Tumor} A group of tumors whose cells look small, round, and blue under a microscope; specialized testing identifies the cancer type.
...
\medterm{Social Medicine} The study and practice of how social conditions affect health, disease, and healthcare. It considers housing, income, education, work, discrimination, environment, access to care, and community factors influencing outcomes.
...
\medterm{Sodium Aurothiomalate} An injectable gold compound formerly used to treat rheumatoid arthritis. It is now rarely used because safer options are available and it can cause mouth sores, rash, kidney problems, or blood abnormalities.
...
\medterm{Sonographer} A healthcare professional trained to perform ultrasound scans (sonography). A healthcare professional trained to acquire diagnostic ultrasound images and document relevant findings for interpretation by an authorized clinician.
...
\medterm{Sore Throat} Pain, scratchiness, or irritation of the throat, most often caused by pharyngitis, typically viral but also bacterial, allergic, irritant, reflux, voice strain, traumatic, or neoplastic.
...
\medterm{Spatula} A flat, usually rounded instrument used to spread, mix, press, examine, or transfer material. In healthcare it may be used for medicines, dressings, laboratory work, or holding down the tongue during an examination.
...
\medterm{Specimen Container} Container for collecting specimens. Types: urine cup, stool container, sputum cup, biohazard bag. A suitable container used to collect, identify, protect, and transport a patient sample for laboratory testing.
...
\medterm{Spectral Analysis} Analysis of the energies in detected radiation or another signal. In medical imaging, it can separate useful signals from scattered radiation and improve material identification or image interpretation.
...
\medterm{Spinal Disease} A disorder of the vertebrae, discs, spinal cord, nerve roots, or supporting tissues. Any disorder affecting vertebrae, disks, spinal cord, nerve roots, or supporting tissues, potentially causing pain or weakness.
...
\medterm{Spinal Neoplasms} Tumors arising in the spinal cord, its coverings, vertebrae, or nearby tissues. They may cause back pain, weakness, numbness, walking problems, or bladder and bowel changes when they compress nerves or the cord.
...
\medterm{Spinous Process} The posterior bony projection of a vertebra to which muscles and ligaments attach. The backward-pointing bony projection of each vertebra where muscles and ligaments attach.
...
\medterm{Spirillum} A spiral-shaped bacterium; Spirillum minus can cause rat-bite fever. A spiral-shaped bacterium. Some organisms historically placed in this group, such as Spirillum minus, can cause rat-bite fever.
...
\medterm{Spore} A tough reproductive or survival structure made by fungi, bacteria, or plants, able to persist in the environment.
...
\medterm{Sprains} Sprains are ligament injuries caused by excessive stretching or tearing, producing pain, swelling, bruising, and variable joint instability. Injuries involving stretching or tearing of ligaments around a joint.
...
\medterm{St John'S Wort} Herbal supplement. CYP3A4 inducer, reduces efficacy of many drugs (oral contraceptives, warfarin, antiretrovirals). A herbal preparation from Hypericum perforatum used for mood symptoms but capable of serious drug interactions.
...
\medterm{St. John'S Wort} Herbal supplement. CYP3A4 inducer, reduces efficacy of many drugs (oral contraceptives, warfarin, antiretrovirals). An herbal product sometimes used for mood symptoms that can interact with medicines and reduce their effectiveness.
...
\medterm{Stammering} Alternate index label; see Stuttering. Another term for stuttering, a speech-fluency disorder involving repetitions, prolongations, or blocks that interrupt speaking. Speech-language therapy can help at any age.
...
\medterm{Standard Precautions} Precautions for all patient care. Examples: hand hygiene, PPE, safe injection, respiratory hygiene. Basic infection-control practices for every patient, including hand hygiene, protective equipment, safe injections, and respiratory etiquette.
...
\medterm{Staph Infection} Infections caused by Staphylococcus aureus (and coagulase-negative staphylococci), a gram-positive coccus in clusters. An infection caused by Staphylococcus bacteria, commonly affecting skin but sometimes blood, lungs, bones, or heart.
\synonyms
...
\medterm{Starch} A carbohydrate made by plants and found in foods such as potatoes, grains, beans, and rice. Digestion breaks starch into glucose for energy, although the amount and speed of this process vary with the food and its preparation.
...
\medterm{Sterility} Either inability to reproduce or complete absence of living microorganisms from an object or preparation. In healthcare, sterile equipment and medicines must remain free from contamination to prevent infection.
...
\medterm{Stiff Baby Syndrome} A nonspecific term for unusual stiffness or increased muscle tone in an infant. Causes range from temporary illness to brain, nerve, muscle, or genetic disorders; persistent stiffness, poor feeding, or breathing problems needs urgent evaluation.
...
\medterm{Stochastic Effects} Random radiation effects with no threshold. Cancer, genetic effects. Probability increases with dose. Random radiation effects, especially cancer, whose probability increases with dose and generally has no known safe threshold.
...
\medterm{Strabismus} Misalignment of the eyes so they do not point in the same direction. One eye may turn in, out, up, or down; it can cause double vision or reduced vision in one eye and is especially important to assess in children.
...
\medterm{Stress} A physiological and psychological response to perceived threats or demands that activates the sympathetic nervous system and the hypothalamic-pituitary-adrenal axis. A physiological or psychological response to perceived demands or threat.
...
\medterm{Stress Urinary Incontinence} Involuntary leakage of urine, significantly affecting psychological, social, and physical well-being. See urinary incontinence.
...
\medterm{Stroke} Stroke is sudden neurologic dysfunction from interrupted cerebral blood flow or bleeding, causing focal deficits and requiring urgent evaluation for reperfusion or hemorrhage management. neuronal death and neurological deficits.
...
\medterm{Subacute Combined Degeneration Of The Cord} Spinal cord damage usually from vitamin B12 deficiency, affecting pathways for position sense and movement.
...
\medterm{Subphrenic Abscess} A pocket of pus beneath the diaphragm, usually after abdominal infection or surgery, causing fever, pain, and serious illness.
...
\medterm{Succinate Dehydrogenase} An enzyme that works in both the energy-making cycle and respiratory chain inside mitochondria. It helps transfer electrons and produce cellular energy while converting succinate into fumarate.
...
\medterm{Sulfur Colloid Scan} A nuclear-medicine test using a small amount of technetium-labeled sulfur colloid. It shows activity in the liver, spleen, bone marrow, or lymph nodes and can help assess organ function or disease.
...
\medterm{Synthetic} Made through chemical or laboratory processes rather than taken directly from nature. Synthetic medicines, hormones, or materials may copy natural substances or be designed with new properties for diagnosis or treatment.
...
\medterm{Syringe} A device with a barrel and plunger used to draw up, measure, inject, or remove fluids.
...
\medterm{Systemic Lupus Erythematosus} A long-term illness in which the immune system mistakenly attacks the body’s tissues. It may affect the skin, joints, kidneys, blood, lungs, heart, or brain, causing rashes, joint pain, tiredness, fever, swelling, or organ problems. Symptoms often flare and improve. Treatment lowers inflammation and protects affected organs.
