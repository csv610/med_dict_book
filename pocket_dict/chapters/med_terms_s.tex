...
\medterm{Sacroileitis} Alternate index label; misspelling of \textit{Sacroiliitis}.
...
\medterm{Scrombotoxin Poisoning} Alternate index label; misspelling of \textit{Scombroid poisoning}.
...
\medterm{Sexual (Sex) Problems In Men} Alternate index label for sexual problems in men.
...
\medterm{Skin Cancer} Cancer that begins in skin cells. Common types include basal-cell cancer, squamous-cell cancer, and melanoma. It may appear as a changing, bleeding, growing, or nonhealing spot.
\synonyms
Cancer, Skin
...
\medterm{Spherocytos (Spherocytosis (Hereditary, HS))} Alternate index label; misspelling of \textit{Spherocytosis}.
...
\medterm{Stroke} A sudden loss of brain function caused by blocked blood flow or bleeding in the brain. It may cause facial drooping, arm weakness, speech trouble, vision loss, or confusion.
