...
\medterm{Schizophrenia} A serious mental-health disorder that can cause hallucinations, fixed false beliefs, disorganized thinking or behavior, reduced emotional expression, and difficulty functioning. Symptoms and severity vary, and treatment can reduce them.
...
\medterm{Sciatica} Pain, tingling, numbness, or weakness that travels from the lower back or buttock down the leg, usually because a nerve root is irritated by a disk problem or narrowing of the spine.
...
\medterm{Scleroderma} A group of autoimmune diseases that make skin thick and tight. In systemic sclerosis, scarring and blood-vessel changes can also damage the swallowing tube, lungs, kidneys, heart, and other organs.
...
\medterm{Scoliosis} A lasting sideways curve of the spine that may also twist the spine and rib cage. It may begin without a known cause, be present from birth, result from nerve or muscle disease, or develop with aging.
...
\medterm{Serotonin-Norepinephrine-Dopamine Reuptake Inhibitors} A proposed group of medicines that increase signaling by slowing the reuptake of serotonin, norepinephrine, and dopamine. The term is not a standard class for routine prescribing, and specific medicines and uses require careful definition.
...
\medterm{Sexual Sadism Disorder} A mental-health diagnosis involving repeated sexual arousal from another person’s physical or emotional suffering, when it causes significant distress or disrupts daily life, or involves acting with someone who has not freely consented.
...
\medterm{Sick Sinus Syndrome} A problem with the heart’s natural pacemaker that causes the heartbeat to become too slow, pause, or alternate between fast and slow. It may cause dizziness, fainting, tiredness, palpitations, or reduced exercise ability; some people need a pacemaker.
...
\medterm{Sjogren Syndrome} An autoimmune disease in which the body attacks glands that make tears and saliva, causing dry eyes and dry mouth. It may also affect joints, lungs, kidneys, nerves, or other organs, so persistent symptoms need medical assessment.
...
\medterm{SjöGren Syndrome} An autoimmune disease in which the immune system attacks glands that make tears and saliva, causing dry eyes and dry mouth. It may also affect joints, lungs, kidneys, nerves, or other organs and slightly raises lymphoma risk.

\medterm{SjöGren'S Disease} Alternate index label; see \textit{Sjögren's Syndrome}.

\medterm{SjöGren'S Syndrome} An autoimmune disease that damages the glands producing tears and saliva, causing persistent dry eyes and dry mouth. It can also affect other organs and may increase the risk of certain lymphomas.
\synonyms
SjöGren's Disease
...
\medterm{Sleep Apnea (Dental)} A custom mouth device worn during sleep that moves the lower jaw or tongue forward to keep the throat open. It may help selected people with obstructive sleep apnea, especially when positive-airway-pressure treatment is unsuitable; dental and sleep follow-up is needed.

\synonyms
Dental

\medterm{Sleep Apnea (Obstructive Sleep Apnea - OSA)} A sleep disorder in which the upper airway repeatedly narrows or closes during sleep, briefly reducing or stopping airflow. Snoring, choking or gasping, morning headache, poor concentration, and daytime sleepiness are common; untreated disease can affect blood pressure and heart health.
...
\medterm{Somatic Symptom Disorder} A condition in which physical symptoms cause significant distress or disrupt daily life, together with excessive worry, fear, or time spent dealing with them. The symptoms are real; assessment still looks for physical causes and offers support for both body and mind.
...
\medterm{Sphygmomanometer} The cuff-and-gauge device used to measure blood pressure. The cuff briefly squeezes the arm, and the device detects pressure as blood begins and continues to flow; correct cuff size and positioning improve accuracy.
...
\medterm{Spinal Anaesthesia} An injection of numbing medicine into the fluid around the spinal nerves in the lower back. It temporarily blocks pain and movement in the lower body while the person remains awake, although blood pressure, headache, infection, or nerve complications can occur.
...
\medterm{Staph Infection} An infection caused by Staphylococcus bacteria, most often Staphylococcus aureus. It commonly affects the skin but can also involve the blood, lungs, bones, joints, or heart valves; treatment depends on the site and antibiotic susceptibility.
\synonyms
...
\medterm{Staphylococcal Scalded Skin} A toxin-producing Staphylococcus aureus infection that causes the outer skin to separate, usually in infants or young children. Widespread redness, tenderness, and fragile blisters can leave painful areas resembling a burn and require prompt treatment.
...
\medterm{Stethoscope} An instrument used to listen to sounds from the heart, lungs, blood vessels, and abdomen. It has a chest piece, flexible tubing, and earpieces; different chest-piece surfaces emphasize different sound ranges.
...
\medterm{Stillbirth} The birth of a baby who has died before or during birth after the locally defined gestational-age or birth-weight threshold. Causes vary and may involve the placenta, infection, fetal conditions, or maternal illness; evaluation can help guide future care.
...
\medterm{Streptococcal Pharyngitis} A throat infection caused by group A Streptococcus. It often begins suddenly with a sore throat, painful swallowing, fever, red or swollen tonsils, and tender neck glands, usually without a cough.
...
\medterm{Stroke} A sudden loss of brain function caused by blocked blood flow or bleeding in the brain. It may cause facial drooping, arm weakness, speech trouble, vision loss, or confusion and requires emergency treatment.
...
\medterm{Substance Abuse Psychiatry} Medical care for people with substance-use disorders and coexisting mental-health conditions. Assessment considers the substance, withdrawal risk, physical health, mood, and safety; treatment addresses both substance use and mental health together.
...
\medterm{Substance Use Disorder} A pattern of alcohol or drug use that is difficult to control and causes health problems, unsafe behavior, or trouble at home, work, or school. It may cause cravings, tolerance, or withdrawal.
...
\medterm{Sudden Cardiac Arrest} An abrupt loss of effective heart pumping that causes collapse, unresponsiveness, and absent or abnormal breathing. Immediate emergency action includes calling for help, starting chest compressions, and using an automated defibrillator if available.
