...
\medterm{Sgarbossa Criteria} ECG findings used to look for a heart attack when a left bundle branch block or pacemaker rhythm makes the tracing difficult to interpret. A positive result supports, but does not prove, acute coronary blockage and must be considered with symptoms, examination, repeated ECGs, and blood tests.
...
\medterm{Skene Gland Cyst} A fluid-filled lump near the opening of the urethra, caused by blockage of a small gland beside it. Small cysts may cause no symptoms; larger or infected cysts can cause pain, painful urination, difficult urine flow, or pain during sex. Treatment may include drainage or removal.
...
\medterm{Specimen Cup} A clean container used to collect a sample such as urine, sputum, or stool for laboratory testing. The container should be labeled correctly, closed securely, and kept free from contamination.
