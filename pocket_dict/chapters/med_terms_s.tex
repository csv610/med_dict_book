...
\medterm{Acute Sinusitis} Alternate name; see \textit{Acute sinusitis}.

\medterm{Adolescent Schizophrenia} Alternate name; see \textit{Childhood schizophrenia}.
...
\medterm{Aortic Valve Stenosis} Alternate name; see \textit{Aortic valve stenosis}.

\medterm{Asperger Syndrome} Alternate name; see \textit{Asperger syndrome}.

\medterm{Atrioventricular Septal Defect} Alternate name; see \textit{Atrioventricular canal defect}.

\medterm{Bee Stings} Alternate name; see \textit{Bee sting}.

\medterm{Blood in Semen} Alternate name; see \textit{Hematospermia}.
...
\medterm{Central Sleep Apnea} Alternate name; see \textit{Central sleep apnea}.

\medterm{Cervical Spondylosis} Alternate name; see \textit{Cervical spondylosis}.
...
\medterm{Childhood Schizophrenia} Alternate name; see \textit{Childhood schizophrenia}.

\medterm{Chronic Sinusitis} Alternate name; see \textit{Chronic sinusitis}.
...
\medterm{Deviated Septum} Alternate name; see \textit{Nasal septum deviation}.
...
\medterm{Enlarged Spleen} Alternate name; see \textit{Splenomegaly}.

\medterm{Esophageal Stricture} Alternate name; see \textit{Schatzki ring}.

\medterm{Excessive Scarring} Alternate name; see \textit{Keloid}.

\medterm{Excessive Sweating} Alternate name; see \textit{Hyperhidrosis}.

\medterm{Febrile Seizure} Alternate name; see \textit{Febrile seizures}.
...
\medterm{Female Sexual Dysfunction} Alternate name; see \textit{Female sexual dysfunction}.
...
\medterm{Geriatric Screening} Checking older adults who have no symptoms for diseases or risks that may benefit from early detection. Decisions should consider expected benefit, possible harm, life expectancy, health goals, and preferences; examples include falls, depression, osteoporosis, and selected cancers.
...
\medterm{Gustatory Sweating} Sweating triggered by eating or smelling food, usually over the cheek or temple after parotid-nerve injury or surgery and known as Frey syndrome.
...
\medterm{Heel Spur} Alternate name; see \textit{Heel spurs}.

\medterm{Hereditary Spherocytosis} Alternate name; see \textit{Spherocytosis}.
...
\medterm{Loeys-Dietz Syndrome} Alternate name; see \textit{Loeys-Dietz syndrome}.

\medterm{Low Blood Sodium} Alternate name; see \textit{Hyponatremia}.
...
\medterm{Mitral Valve Stenosis} Alternate name; see \textit{Mitral valve stenosis}.

\medterm{Motion Sickness} Alternate name; see \textit{Motion sickness}.

\medterm{Multiple Sclerosis} Alternate name; see \textit{Multiple sclerosis}.
...
\medterm{Nontropical Sprue} Nontropical sprue is an older term for celiac disease, an immune reaction to gluten that damages the small-intestinal lining and impairs absorption.

\medterm{Obstructive Sleep Apnea} Alternate name; see \textit{Obstructive sleep apnea}.

\medterm{Obstructive Sleep Apnea Syndrome} Alternate name; see \textit{Obstructive sleep apnea}.

\medterm{Open Surgical Wound Care} Care of a surgical wound left partly or completely open to drain or heal gradually, usually with dressings and scheduled assessment for infection, bleeding, and healthy tissue growth.
...
\medterm{Pfeiffer Syndrome} Alternate name; see \textit{Pfeiffer syndrome}.
...
\medterm{Post-Polio Syndrome} New or worsening weakness, fatigue, muscle pain, breathing problems, or swallowing difficulty occurring years after recovery from polio. It reflects late effects on previously affected motor neurons and is managed with pacing, rehabilitation, and support.
...
\medterm{Pyloric Stenosis} Alternate name; see \textit{Pyloric stenosis}.

\medterm{Restless Legs Syndrome} Alternate name; see \textit{Restless leg syndrome}.
...
\medterm{Scalp Tenderness} Pain, cutaneous hyperesthesia, or allodynia provoked by gently touching or brushing the scalp or hair, serving as a classic and sensitive diagnostic symptom of giant cell arteritis (temporal arteritis) caused by transmural inflammation of cranial arterial branches.
\synonyms
...
\medterm{Seidel Test} An ophthalmologic slit-lamp examination used to detect full-thickness penetrating corneal or scleral lacerations; topical fluorescein dye applied to the suspected corneal defect is viewed under cobalt blue light; dilution and streaming of clear aqueous humor through the dark dye confirms a penetrating globe leak.
\synonyms
...
\medterm{Simmonds Test} A physical examination test (Thompson test) used to diagnose complete Achilles tendon rupture; with the patient prone and the feet hanging freely over the examination couch, manual squeezing of the calf muscle normally produces passive ankle plantarflexion; absence of plantarflexion confirms complete tendon rupture.
\synonyms
Thompson Test; Thompson-Simmonds Calf Squeeze Test

\medterm{Simmonds-Thompson Test} A clinical diagnostic test used to detect complete rupture of the Achilles tendon (calcaneal tendon). With the patient prone and the feet hanging over the edge of the bed, the examiner squeezes the calf muscle belly; an absence of passive plantar flexion of the foot indicates a torn Achilles tendon.
...
\medterm{Sportsman's Groin} A chronic, debilitating musculoskeletal condition causing groin and lower abdominal pain in athletes engaged in repetitive kicking, sprinting, twisting, or rapid directional changes. Despite the popular misnomer ``sports hernia,'' there is no true anatomical hernia defect or visceral protrusion. Instead, it is caused by repetitive microtears and strain at the attachment of the lower abdominal muscles (rectus abdominis and external oblique aponeurosis) and thigh muscles (adductor longus) onto the pubic bone. Symptoms include insidious, deep groin pain aggravated by resisted hip adduction, sit-ups, and kicking. Diagnosis is confirmed by pelvic MRI, and management ranges from structured core-strengthening physical therapy to surgical reinforcement of the inguinal wall or adductor tendon release for refractory cases.
...
\medterm{Temporal Lobe Seizure} Alternate name; see \textit{Temporal lobe seizure}.
...
\medterm{Vascular Sponge} A sterile absorbent material used during blood-vessel procedures to absorb blood, apply pressure, or protect delicate tissue. It must be counted and removed when required to prevent retained-material complications.
\synonyms
