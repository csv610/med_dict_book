...
\medterm{Substance Use Disorder} A pattern of alcohol or drug use that is difficult to control and continues despite health, social, legal, or work-related harm. Features may include strong cravings, unsuccessful efforts to reduce or stop use, spending substantial time obtaining or using the substance, impaired responsibilities, risky use, tolerance, or withdrawal; tolerance and withdrawal are not required for the disorder.
