...
\medterm{Sabre Tibia} A skeletal physical deformity characterized by prominent anterior bowing and cortical thickening of the tibia, classically resulting from congenital syphilis (chronic periostitis) or Paget disease of bone.
\synonyms
...
\medterm{Saccule} A small, fluid-filled membranous sac situated within the vestibule of the inner ear, containing a vertically oriented macula with hair cells and otoliths that detect linear vertical acceleration and gravity.
...
\medterm{Sacral Agenesis} A rare congenital neural tube and caudal developmental defect characterized by complete or partial absence of the sacrum and lower spine, strongly associated with poorly controlled maternal diabetes mellitus.
...
\synonyms
Pilonidal Dimple; Coccygeal Dimple
...
\medterm{Sacral Plexus} A network of spinal nerves in the pelvis that supplies the lower limbs, pelvis, and parts of the bladder, bowel, and reproductive organs.
...
\medterm{Sacroiliac Joint Dysfunction} Alternate name; see \textit{Sacroiliac joint pain}.

\medterm{Sacroiliac Joint Injury} Sprain, strain, or traumatic disruption of the ligaments and tissues supporting the sacroiliac joint. It can cause localized low-back or buttock pain that worsens with transfers, stairs, prolonged standing, or asymmetric loading.
...
\medterm{Saddle Anesthesia} Loss of cutaneous touch and pain sensation over the perineum, buttocks, anus, and medial upper thighs corresponding to spinal cord nerve roots S3 through S5 (the anatomical region that would contact a riding saddle), serving as a hallmark red-flag clinical sign of cauda equina syndrome.
\synonyms
Perineal Sensory Loss; S3-S5 Dermatomal Anesthesia

\medterm{Saddle Joint} A joint in which each bone has one rounded and one hollow surface, fitting together like a saddle. It allows movement in two main directions, as at the base of the thumb.

\medterm{Saddle Nose Deformity} A physical collapse and depression of the cartilaginous nasal dorsum resulting from destruction or ischemic necrosis of the nasal septal cartilage, seen in granulomatosis with polyangiitis (GPA), relapsing polychondritis, congenital syphilis, chronic intranasal cocaine use, and nasal trauma.
\synonyms
Pug Nose; Depressed Nasal Dorsum

\medterm{Saddle Pulmonary Embolism} A large blood clot lodged where the main artery from the heart divides toward both lungs. It can severely block blood flow, causing sudden breathlessness, chest pain, fainting, low blood pressure, or cardiac arrest.

\synonyms
Saddle Embolus; Bifurcation Pulmonary Embolism

\medterm{S-Adenosylmethionine} A substance made naturally in the body that helps chemical reactions involving cell membranes, genetic material, and brain chemicals. It is also sold as a supplement, but its benefits and interactions vary by condition.
...
\medterm{Sagittal Axis} An imaginary line running from front to back through the body or a body part. Side-to-side movements, such as moving a limb away from or toward the body, occur around this axis.
...
\medterm{Sagittal Sinus Thrombosis} A form of cerebral venous sinus thrombosis involving the superior sagittal sinus, presenting with headache, papilledema, seizures, bilateral motor deficits, and the "empty delta sign" on contrast neuroimaging.

\synonyms
Superior Sagittal Sinus Thrombosis; SSST

\medterm{Salaam Attacks} Brief repeated bending spasms or sudden head drops in infants. They may be seizures and can affect development if they continue.

\medterm{Salbutamol} A quick-relief inhaled medicine that relaxes tightened airway muscles in asthma and chronic obstructive lung disease. It eases wheezing and breathlessness but may cause shaking, a fast heartbeat, or palpitations and does not replace treatment that controls airway inflammation.
...
\medterm{Salicylate Toxicity} Poisoning caused by too much aspirin or another salicylate. It may cause vomiting, ringing in the ears, fever, sweating, fast or deep breathing, dehydration, confusion, seizures, or coma.
...
\synonyms
Salivary Neoplasms; Parotid Tumors
...
\medterm{Salmonella Food Poisoning} Alternate name; see \textit{Salmonellosis}.
...
\synonyms
Salmonella Enteritis; Salmonella Gastroenteritis
...
\medterm{Salpingostomy} An operation that opens a fallopian tube to remove an ectopic pregnancy while leaving the tube in place. It may preserve fertility in selected cases, but persistent pregnancy tissue, bleeding, scarring, or another ectopic pregnancy can occur.

\synonyms
Tubal Incision; Ectopic Tubostomy
...
\medterm{Salter-Harris Fractures} A pediatric orthopaedic classification system categorizing fractures involving the cartilaginous growth plate (physis): Type I (straight across physis), Type II (above physis into metaphysis), Type III (lower through epiphysis), Type IV (through metaphysis, physis, and epiphysis), and Type V (rammed/crushed physis).
...
\medterm{Samter Triad} A clinical symptom complex (aspirin-exacerbated respiratory disease / AERD) characterized by the triad of bronchial asthma, chronic rhinosinusitis with recurrent nasal polyposis, and acute severe bronchospasm or naso-ocular reactions following the ingestion of aspirin or nonsteroidal anti-inflammatory drugs (NSAIDs).
\synonyms
...
\medterm{Sandifer Syndrome} A pediatric paroxysmal dystonic movement disorder occurring in infants with severe gastroesophageal reflux disease (GERD) or hiatal hernia, characterized by episodes of spasmodic torticollis, lateral head tilting, and arching of the back (opisthotonos) during or shortly after feeding to alleviate heartburn.
\synonyms
Sandifer's Syndrome; Gastroesophageal Reflux Dystonia
...
\medterm{Sanguineous} Containing or resembling fresh blood. The word often describes bright-red drainage from a wound; a large or rapidly increasing amount after surgery may indicate active bleeding.
...
\medterm{Santorini Duct} An accessory pancreatic duct that drains the anterosuperior head of the pancreas directly into the duodenum via the minor duodenal papilla (located approximately 2 cm proximal to the major duodenal papilla of Vater).
\synonyms
...
\medterm{Saphenous Nerve} The largest cutaneous sensory terminal branch of the femoral nerve, descending through the adductor canal and piercing the deep fascia at the knee to travel alongside the great saphenous vein, supplying sensation to the medial lower leg, ankle, and medial foot arch.
...
\medterm{Sarcoptic Mange} Alternate name; see \textit{Scabies}.
...
\medterm{Sartorius Muscle} The longest muscle in the human body, a slender strap-like muscle of the anterior thigh originating from the anterior superior iliac spine (ASIS) and inserting into the pes anserinus on the proximal medial tibia; acts to flex, abduct, and laterally rotate the hip, and flex the knee ("tailor's muscle").

\medterm{Sassafras Oil Overdose} Poisoning from swallowing or otherwise being exposed to too much sassafras oil. It may cause nausea, vomiting, seizures, breathing problems, liver injury, or other serious effects.
...
\medterm{SBBO} Alternate name; see \textit{Small intestinal bacterial overgrowth}.
...
\synonyms
Sarcoptic Acariasis; Seven-Year Itch

\medterm{SCAD} Alternate name; see \textit{Spontaneous coronary artery dissection}.
...
\medterm{Scalded Mouth Syndrome} Alternate name; see \textit{Burning mouth syndrome}.

\medterm{Scalded Skin Syndrome} Alternate name; see \textit{Scalded-Skin Syndrome}.
...
\medterm{Scalene Muscles} A group of three paired cervical muscles (anterior, middle, and posterior scalenes) originating from cervical transverse processes and inserting onto the first and second ribs; the interscalene triangle between the anterior and middle scalenes transmits the brachial plexus roots and subclavian artery (site of thoracic outlet syndrome).
...
\medterm{Scalp and Body Ringworm} Alternate name; see \textit{Ringworm}.
...
\synonyms
Sebopsoriasis of Scalp; Scalp Plaque Psoriasis
...
\medterm{Scalp Tenderness} Pain when the scalp is touched or brushed. It can occur with giant cell arteritis, migraine, skin problems, nerve pain, or other conditions, so it is not diagnostic by itself.
\synonyms
Temporal Arteritis Scalp Allodynia; Cranial Hyperesthesia
...
\medterm{Scapholunate Advanced Collapse} The most common predictable pattern of wrist osteoarthritis, resulting from untreated chronic scapholunate ligament dissociation or chronic scaphoid nonunion. Pathological kinematics cause rotatory subluxation of the scaphoid with progressive articular cartilage wear progressing through three distinct stages: radial styloid-scaphoid impingement (stage I), complete scaphoid facet arthrosis (stage II), and capitolunate joint arthritis (stage III), while the radiolunate joint is characteristically spared.

\synonyms
SLAC Wrist; Scapholunate Collapse Arthropathy
...
\medterm{Scapular Winging} Prominence of the medial border of the scapula lifting away from the posterior thoracic wall during forward arm elevation or pushing against a wall, classically caused by paralysis of the serratus anterior muscle due to long thoracic nerve injury.
...
\synonyms
Lower Esophageal Mucosal Ring; B Ring
...
\synonyms
Schizoid Disorder; Asocial Personality
...
\synonyms
Schizotypal Disorder; STPD

\medterm{Schlemm Canal} A circular, endothelium-lined vessel situated in the iridocorneal angle of the anterior chamber, which drains aqueous humor from the trabecular meshwork into the collector channels and episcleral venous system.
\synonyms
...
\medterm{Schmorl Node} An intravertebral disc herniation characterized by the protrusion and displacement of nucleus pulposus cartilage through a defect in the cartilaginous vertebral endplate into the trabecular bone marrow of an adjacent vertebral body.
\synonyms
...
\medterm{School Sores} Alternate name; see \textit{Impetigo}.
...
\medterm{Sciatic Neuritis} Alternate name; see \textit{Sciatica}.
...
\medterm{Scleral Icterus} A yellow pigmentation of the ocular conjunctiva and sclera caused by the accumulation of bilirubin in tissues with high elastin content. It becomes clinically detectable when serum total bilirubin levels exceed 2.5 to 3.0 mg/dL (43 to 51 micromol/L) and serves as an early physical sign of jaundice and liver or biliary disease.

\medterm{Scleral Inflammation} Alternate name; see \textit{Scleritis}.

\medterm{Scleredema} A sclerosing skin disorder causing thick, hard, often waxy skin, classically on the neck, upper back, and shoulders. It may follow infection, occur with diabetes or a monoclonal gammopathy, or rarely be associated with other systemic disease.
...
\medterm{Scleritis} A severe, painful inflammation of the sclera (the tough, white outer wall of the eye). It is characterized by a deep, boring eye ache that often radiates to the forehead or temple and worsens at night, accompanied by intense redness with a bluish or purple hue. Unlike mild surface eye redness (episcleritis), scleritis affects the deeper protective coat of the eye and is frequently linked to autoimmune conditions such as rheumatoid arthritis or lupus. Severe or untreated inflammation can cause thinning of the eye wall and impair vision.

\synonyms
Deep Scleral Inflammation; Anterior Scleritis; Posterior Scleritis; Scleral Inflammation

\medterm{Sclerodactyly} A localized, progressive thickening, tightening, and induration of the skin of the fingers and toes, often resulting in tapered, shiny digits, loss of normal skin folds, and flexion contractures. It is a hallmark cutaneous feature of systemic sclerosis (scleroderma) and CREST syndrome.
...
\medterm{Scleroderma Renal Crisis} A life-threatening complication of systemic sclerosis (predominantly diffuse cutaneous subtype), characterized by the abrupt onset of severe accelerated hypertension, acute oliguric or anuric renal failure, microangiopathic hemolytic anemia, and thrombocytopenia. Driven by endothelial injury and dramatic renin-angiotensin-aldosterone axis hyperactivation; treated urgently with angiotensin-converting enzyme (ACE) inhibitors.

\synonyms
SRC; Systemic Sclerosis Renal Crisis
...
\medterm{Scombroid Poisoning} A foodborne intoxication caused by the ingestion of improperly refrigerated dark-flesh scombroid fish (such as tuna, mackerel, bonito, and mahi-mahi). Bacterial contamination by species possessing histidine decarboxylase converts endogenous muscular histidine into high levels of heat-stable histamine; manifests within minutes with a sharp, peppery taste, intense facial flushing, throbbing headache, palpitations, urticaria, and abdominal cramps.

\synonyms
Histamine Fish Poisoning; Scombrotoxism
...
\medterm{Scorpion Fish Sting} A painful injury from the venomous spines of a scorpion fish, causing severe local pain and swelling and sometimes whole-body symptoms. Spines or venom may remain in the injury.
...
\synonyms
Scorpion Envenomation; Scorpion Bite

\medterm{Scorpion Stings} Alternate name; see \textit{Scorpion sting}.
...
\medterm{Scotty Dog Sign} The normal radiological configuration of the posterior vertebral elements on oblique lumbar spine radiographs resembling a Scottish terrier dog; a radiolucent line crossing the neck of the dog indicates a defect or fracture in the pars interarticularis (spondylolysis).
\synonyms
Scottish Terrier Sign; Pars Interarticularis Collar Sign
...
\medterm{Scrotal Septum} A tissue wall that divides the scrotum into right and left compartments.
...
\medterm{Scrub Typhus} An infection spread by tiny mites called chiggers. It can cause high fever, headache, swollen lymph nodes, rash, and sometimes a dark sore at the bite site. Severe illness can affect the lungs, kidneys, heart, or brain and needs prompt treatment.
...
\medterm{Seabather's Eruption} An itchy papular or vesicular eruption caused by contact with stinging larvae in seawater, often beneath swimwear. Symptoms may begin after leaving the water and usually resolve over days, though severe reactions may need medical treatment.
...
\medterm{Seafood Poisoning} Clinical toxic syndromes resulting from the ingestion of seafood containing marine toxins or accumulated bio-toxins, including ciguatera fish poisoning, scombroid (histamine) toxicity, paralytic shellfish poisoning, and tetrodotoxin poisoning.

\synonyms
Marine Toxin Poisoning; Shellfish Toxicity; Ichthyosarcotoxism
...
\medterm{Seasonal Affective Disorder Syndrome} Alternate name; see \textit{Seasonal Affective Disorder}.

\medterm{Seasonal Allergies} An allergic reaction that occurs at specific times of the year when outdoor plants release tiny pollen grains into the air. In spring, tree pollen (such as oak, birch, and cedar) is the most common trigger; in summer, grass pollen causes symptoms; and in late summer and autumn, weed pollen (especially ragweed) and outdoor mold spores are common culprits. When a sensitized person inhales pollen, the immune system mistakenly identifies it as a threat, causing the release of histamine and other chemicals that inflame the nasal passages, sinuses, and eyes. Common symptoms include frequent sneezing, a congested or runny nose with clear drainage, an itchy throat or roof of the mouth, and red, itchy, watery eyes (allergic conjunctivitis). Treatment includes tracking pollen counts, keeping windows closed during high-pollen days, using daily corticosteroid nasal sprays, taking oral antihistamines to control itching and sneezing, and rinsing nasal passages with saline.
\synonyms
Hay Fever; Seasonal Allergic Rhinitis; Pollinosis; Seasonal Allergy
...
\medterm{Secobarbital Overdose} Poisoning from taking too much secobarbital, a sedative medicine. It can cause extreme sleepiness, confusion, slowed breathing, coma, or death.
...
\medterm{Secondary Brain Cancer} Alternate name; see \textit{Brain metastases}.
...
\medterm{Secondary Lymphoid Organs} Organs where mature lymphocytes meet foreign substances and begin immune responses. They include lymph nodes, the spleen, tonsils, and other lymphoid tissues.

\medterm{Secondary Osteoporosis} Bone loss caused by another illness, medication, or prolonged immobility.

\medterm{Secondary Osteosarcoma} An osteogenic sarcoma arising in previously abnormal or treated bone, such as bone affected by Paget disease, prior radiation, or chronic bone lesions; prognosis and treatment depend on stage and resectability.
...
\medterm{Secondary Peritonitis} Diffuse or localized acute bacterial or chemical inflammation of the peritoneal cavity resulting from direct breach of an intra-abdominal hollow viscus, such as a perforated peptic ulcer, ruptured appendix, ischemic bowel perforation, or anastomotic leak.

\synonyms
Perforated Viscus Peritonitis; Acute Secondary Peritoneal Inflammation; Surgical Peritonitis

\medterm{Secondary Polycythemia} An absolute increase in red blood cell mass driven by elevated circulating erythropoietin levels, either as an appropriate physiological response to chronic systemic hypoxia (chronic cyanotic lung/heart disease, high altitude, smoking) or pathologically from erythropoietin-secreting tumors (renal cell carcinoma, cerebellar hemangioblastoma, hepatocellular carcinoma).
\medterm{Secondary Postpartum Hemorrhage} Heavy or abnormal bleeding occurring more than 24 hours and up to 12 weeks after childbirth. Causes include retained placental tissue, infection, poor healing where the placenta was attached, or a bleeding disorder. Heavy bleeding, dizziness, fainting, fever, or severe pain may occur.

\synonyms
Late Postpartum Hemorrhage; Delayed PPH
...
\medterm{Secondary Shock} Circulatory failure occurring as a consequence of another condition, such as infection, trauma, bleeding, heart failure, allergy, or endocrine crisis, with inadequate tissue perfusion.
...
\medterm{Sedative, Hypnotic, Anxiolytic Use Disorders} A pattern of problematic use of sedative, hypnotic, or anxiolytic medicines causing impairment, distress, tolerance, withdrawal, or inability to control use.
...
\medterm{Segmental Innervation} The organization of nerve supply according to spinal cord segments. Each segment contributes to characteristic dermatomes, myotomes, and reflexes, so changes in sensation, strength, or reflexes can help localize a neurologic lesion.
...
\medterm{SEID} Alternate name; see \textit{Myalgic encephalomyelitis/chronic fatigue syndrome (ME/CFS)}.

\medterm{Seidel Test} An eye examination using fluorescein dye to look for leaking fluid from a full-thickness injury to the cornea or eye wall. Streaming or dilution of the dye suggests a leak, but a negative test does not rule out a serious eye injury.
\synonyms
Seidel's Test; Aqueous Humor Leakage Test
...
\medterm{Seizure Disorder} Alternate name; see \textit{Epilepsy}.
...
\medterm{Seizure Disorders in Pregnancy} Epilepsy and new-onset seizures during pregnancy require assessment of seizure type, medicine exposure, adherence, sleep, metabolic causes, and possible eclampsia. Management balances seizure control with fetal safety and includes coordinated neurology and obstetric care.
...
\medterm{Selective Serotonin-Reuptake Inhibitors} Antidepressants that increase the availability of serotonin, a chemical used for communication between nerve cells. They treat depression and anxiety disorders; nausea, sleep changes, sexual problems, and withdrawal symptoms can occur.

\medterm{Selective Serotonin Reuptake Inhibitor Toxicity} SSRI overdose is often mild, causing nausea, vomiting, tremor, drowsiness, or agitation, but interactions can produce serotonin syndrome with clonus, hyperreflexia, hyperthermia, and autonomic instability. Citalopram and escitalopram can prolong the QT interval; stop serotonergic drugs, obtain ECG monitoring, and provide supportive care and benzodiazepines when indicated.
...
\medterm{Selenium Deficiency} Low levels of selenium, a trace element needed for
antioxidant enzymes and thyroid hormone activity. It is uncommon in most regions and
usually subclinical, but severe deficiency contributes to Keshan disease, affecting heart
muscle, and Kashin-Beck disease in selenium-poor areas. Assessment and replacement are
...
\medterm{Self-Diagnosing Body Dysmorphic Disorder} Alternate name; see \textit{BDD}.
...
\medterm{Self Harming} Alternate name; see \textit{Self-injury/cutting}.
...
\synonyms
Support Group; Peer Support Group
...
\synonyms
Nonsuicidal Self-Injury; NSSI; Self-Harm
...
\medterm{Self-Retaining Retraction} Holding tissue away from an operative field with a retractor that remains in position without
continuous manual support.

\synonyms
Self-Retaining Retraction; Mechanical Retraction
...
\medterm{Seminal Fluid Analysis} A laboratory test of semen that measures the amount of fluid and the number, movement, and shape of sperm. It helps assess fertility and may check whether sperm remain after a vasectomy.
...
\medterm{Semont Maneuver} A rapid, side-to-side liberatory repositioning maneuver used in the clinical management of posterior semicircular canal benign paroxysmal positional vertigo (BPPV), designed to dislodge cupulolithiasis or canalithiasis debris into the utricle.
\synonyms
Semont Liberatory Maneuver; Liberatory Maneuver for BPPV
...
\medterm{Senile Purpura} Alternate name; see \textit{Actinic Purpura}.
...
\synonyms
Sensate Focus; Masters and Johnson Therapy
...
\medterm{Sentinel Loop} A localized, persistently gas-filled, dilated segment of small intestine visible on plain abdominal radiographs, reflecting focal paralytic ileus produced by adjacent acute intraperitoneal inflammation (most commonly acute pancreatitis or acute appendicitis).
\synonyms
Sentinel Loop Sign; Localized Adynamic Ileus
...
\medterm{Sentinel Node Biopsy} Alternate name; see \textit{sentinel lymph-node biopsy: removal and examination of the first draining node or nodes to which a tumor is likely to spread, used to assess regional metastasis}.
...
\medterm{Separated Cranial Sutures} Separated cranial sutures in an infant can reflect normal growth or increased intracranial pressure, hydrocephalus, prematurity, or other illness and require clinical assessment.
...
\medterm{Sepsis} Life-threatening organ dysfunction caused by a dysregulated host response to infection. Findings may include altered mental status, hypotension, fast breathing or heart rate, low urine output, elevated lactate, low oxygenation, or other organ injury; the infection source and organ dysfunction must be assessed urgently.

\synonyms
Systemic Inflammatory Response Syndrome

\medterm{Sepsis Syndrome} A range of severe responses to infection, from infection-related organ dysfunction to septic shock and failure of several organs. The condition can worsen quickly and may damage several organs.
...
\medterm{Septal Hematoma} A collection of blood inside the wall dividing the two sides of the nose, usually after an injury. It causes blockage and painful swelling and can destroy cartilage and deform the nose if untreated.
...
\synonyms
Infected Abortion; Postabortal Sepsis
...
\synonyms
Infectious Arthritis; Pyogenic Arthritis; Bacterial Arthritis; Non-Gonococcal Bacterial Arthritis
...
\medterm{Septic Pulmonary Infarction} Death of part of the lung after infected clots or other infected material block small lung arteries. It may cause fever, chest pain worse with breathing, cough, coughing blood, and lung abscesses.

\medterm{Septic Shock} A life-threatening complication of sepsis in which infection causes dangerously low blood pressure and poor blood flow to organs, even after initial fluids. Treatment may include antibiotics, fluids, and medicines to support circulation.

\medterm{Septic Shock Criteria} Clinical diagnostic criteria defined by consensus Sepsis-3 guidelines: persistent sepsis-induced hypotension requiring vasopressor therapy to maintain a mean arterial pressure of at least 65 mmHg, accompanied by a serum lactate level exceeding 2 mmol/L despite adequate fluid resuscitation.

\medterm{Septic Thrombophlebitis} Infected thrombosis within a vein, causing local inflammation and possible bloodstream infection or septic emboli. It may complicate intravenous devices, pelvic infection, skin infection, or deep soft-tissue infection.
...
\medterm{Serious Health Problems Symptoms} Alternate name; see \textit{Symptoms of serious disease}.
...
\medterm{Serotonin Syndrome} A potentially life-threatening toxic reaction caused by excessive serotonin activity, usually after combining, increasing, or overdosing on serotonergic medicines. It often begins within minutes to hours and may cause agitation, sweating, diarrhea, tremor, overactive reflexes or clonus, muscle stiffness, fever, fast heart rate, blood-pressure changes, or confusion; severe cases require urgent medical care.
...
\medterm{Serous Cystadenoma of Pancreas} Alternate name; see \textit{Pancreatic Cysts}.
...
\medterm{Sertoli Cell} A support cell inside the seminiferous tubules that helps sperm develop and forms part of the blood-testis barrier.

\medterm{Sertoli Cells} Somatic "nurse" cells spanning the full thickness of the seminiferous tubule epithelium that physically support and nourish developing germ cells, form the blood-testis barrier via tight junctions, and secrete androgen-binding protein, inhibin B, and anti-Müllerian hormone.
...
\medterm{Sertoli-Leydig Tumor} Alternate form; see \textit{Sertoli-Leydig Cell Tumor}.
...
\medterm{Serum Albumin Test} A quantitative clinical blood assay measuring serum albumin levels to assess hepatic protein synthetic capacity, nutritional status, and oncotic pressure, as well as renal protein loss in nephrotic syndrome.
...
\medterm{Serum Uric Acid} A blood test measuring uric acid, a purine-breakdown product. The result helps assess gout, kidney stones, kidney function, or effects of some cancer treatments.
...
\medterm{Severe Brain Injury Coma} Alternate name; see \textit{Coma}.
...
\synonyms
Class III Obesity; Morbid Obesity; Extreme Obesity
...
\medterm{Sex Cord-Stromal Ovarian Tumor} Pathologic evaluation of ovarian tumors derived from granulosa, theca, Sertoli, Leydig, or related stromal cells. Patterns, hormone production, nuclear features, and immunohistochemistry help distinguish the tumor type and malignant potential.
...
\medterm{Sexual Addiction} Legacy label; see \textit{Compulsive Sexual Behavior Disorder}.
...
\synonyms
Nonconsensual Sexual Contact; Sexual Violence
...
\medterm{Sexual Dysfunction Disorders} Alternate name; see \textit{Sexual Dysfunction}.
...
\medterm{Sexual Intercourse} Sexual activity involving penetration, most commonly penile-vaginal, but sometimes penile-anal or other forms depending on the people involved. It may be for pleasure, intimacy, or reproduction and requires freely given consent.

\synonyms
Copulation; Coition; Sexual Union

\medterm{Sexually Transmitted Disease} A sexually transmitted disease is an infection spread mainly through sexual contact. The term sexually transmitted infection is also used because some infections cause no symptoms.

\medterm{Sexually Transmitted Diseases} Alternate name; see \textit{Sexually Transmitted Infections}.

\medterm{Sexually Transmitted Diseases in Pregnancy} Alternate name; see \textit{Sexually transmitted infections}.

\medterm{Sexually Transmitted Diseases in Women} Alternate name; see \textit{Sexually transmitted infections}.

\medterm{Sexually Transmitted Disease Treatments} Alternate name; see \textit{Sexually Transmitted Infections}.

\medterm{Sexually Transmitted Infection} Alternate name; see \textit{Sexually Transmitted Infections}.
...
\medterm{Sexual Obsession} Alternate name; see \textit{Compulsive sexual behavior}.
...
\medterm{Sezary Disease} Alternate name; see \textit{Sezary syndrome}.
...
\synonyms
Sezary Disease; Mycosis Fungoides Variant
...
\medterm{Shampoo Ingestion} Accidental swallowing of a small amount of shampoo usually causes mouth or stomach irritation; larger or concentrated exposures may cause vomiting or breathing problems and warrant poison-control advice.
...
\medterm{Sharp-Force Defense Wounds} Cuts or other injuries on the hands or forearms that may occur when a person attempts to protect against an attack.
...
\synonyms
Defensive Wounds; Defense Injuries
...
\medterm{Sheehan Syndrome} Permanent injury to the pituitary gland caused by severe bleeding or very low blood pressure during or after childbirth. Because the gland makes several hormones, symptoms may include inability to breastfeed, low blood pressure, fatigue, and menstrual or fertility problems.

\synonyms
Simmonds Disease; Postpartum Hypopituitarism

\medterm{Shellac Poisoning} Poisoning from swallowing or inhaling shellac, a coating product that may contain alcohol or other solvents. It can cause irritation, vomiting, dizziness, drowsiness, or lung injury if it enters the lungs.
...
\synonyms
Crustacean Hypersensitivity; Shellfish Hypersensitivity
...
\medterm{Shifting Dullness} A change in the sound made when tapping the belly as a person turns onto their side, showing that extra fluid is shifting with gravity inside the stomach cavity.

\medterm{Shift Work Sleep Disorder} A circadian rhythm sleep-wake disorder caused by a recurring work schedule that overlaps the usual sleep period, producing insomnia and/or excessive sleepiness, reduced sleep, and impaired functioning. Symptoms persist in association with the schedule, typically for at least 3 months.
...
\medterm{Shock and Pregnancy} Life-threatening inadequate tissue perfusion during pregnancy or after birth, caused by hemorrhage, sepsis, cardiogenic disease, embolism, anaphylaxis, or other processes. Rapid maternal resuscitation, hemorrhage or infection control, and fetal assessment are essential.
...
\medterm{Shortness Of Breath} Alternate name; see \textit{Dyspnea}.
...
\medterm{Shoulder Impingement Syndrome} Mechanical compression and irritation of the rotator cuff tendons (principally the supraspinatus) and subacromial bursa beneath the coracoacromial arch during shoulder abduction and forward elevation, presenting with anterolateral shoulder pain and a painful arc between 60 and 120 degrees.

\synonyms
Subacromial Impingement Syndrome; Neer Impingement
...
\medterm{Shulman Syndrome} Alternate name; see \textit{Eosinophilic fasciitis}.
...
\medterm{Shy-Drager Syndrome} Alternate name; see \textit{Multiple system atrophy}.
...
\medterm{Sialidosis (Mucolipidosis Type I)} A rare inherited lysosomal storage disorder caused by deficient alpha-neuraminidase, usually because of \textit{NEU1} variants. It may cause coarse facial features, skeletal or eye abnormalities, myoclonus, ataxia, developmental impairment, or vision problems, with severity varying by type.
...
\medterm{SIBO} Alternate name; see \textit{Small intestinal bacterial overgrowth}.
...
\medterm{Sickle Cell Disease} A group of autosomal recessive inherited hemoglobin disorders involving hemoglobin S, which can make red blood cells rigid and prone to sickling. Sickling and red-cell breakdown can cause anemia, episodes of blocked blood flow, and damage to organs; forms include hemoglobin SS, hemoglobin SC, and hemoglobin S\/beta-thalassemia.
...
\medterm{Sievert} A unit used to estimate how much biological harm ionizing radiation could cause. It accounts for the type of radiation and the sensitivity of different tissues and is used when discussing radiation risk.

\synonyms
Equivalent Radiation Dose Unit; Sv Unit
...
\medterm{Sign of Leser-Trelat} The sudden appearance or rapid increase of numerous seborrheic keratoses, sometimes reported as a paraneoplastic sign. Most seborrheic keratoses are harmless and common, so the pattern is not diagnostic by itself and should prompt clinical context rather than automatic cancer conclusions.
...
\synonyms
Unrecognized Myocardial Infarction; Silent MI
...
\medterm{Silent Myocardial Infarction} An acute ischemic myocardial infarction that occurs in the absence of classic chest pain or associated typical symptoms, recognized retrospectively on routine electrocardiogram (pathological Q waves) or echocardiography; prevalent in elderly individuals, diabetics (due to autonomic neuropathy), and women.

\synonyms
Painless MI; Silent Ischemia
...
\medterm{Silk Road Disease} Alternate name; see \textit{Behcet syndrome}.
...
\medterm{Simmonds Test} A calf-squeeze test for a possible torn Achilles tendon. If squeezing the calf does not make the foot point downward, a tear is suspected, but examination and sometimes imaging are needed.
\synonyms
Thompson Test; Thompson-Simmonds Calf Squeeze Test

\medterm{Simmonds-Thompson Test} Another name for the calf-squeeze test used when an Achilles tendon tear is suspected. A missing downward movement of the foot supports the diagnosis but does not replace a full assessment.
...
\medterm{Simpson Test} A bedside fatigability test used to assess neuromuscular transmission in suspected ocular myasthenia gravis. The patient is asked to maintain upward gaze for one minute; progressive worsening of ptosis or the development of diplopia constitutes a positive test result.
...
\medterm{Single-Photon Emission Computed Tomography/Computed Tomography} A combined scan that uses a radioactive tracer to show organ function and CT to show detailed body structure. The two sets of images are matched to help locate abnormal areas.
...
\medterm{Sin Nombre Virus Infection} Alternate name; see \textit{Hantavirus pulmonary syndrome}.

\medterm{Sinoatrial Block} A cardiac conduction disturbance in which electrical impulses generated by the sinoatrial node are delayed or blocked from exiting the node to depolarize the surrounding atrial myocardium, manifesting on electrocardiogram as intermittent dropped P waves and pauses in sinus rhythm.
...
\medterm{Sinus Arrest} Transient failure of the sinoatrial node pacemaker cells to spontaneously generate an electrical impulse, producing a pause on electrocardiogram that is not an exact mathematical multiple of the baseline PP interval, lasting from seconds to several seconds before an escape pacemaker emerges.
...
\medterm{Sinusitis And Sinus Problems} Alternate name; see \textit{Sinusitis}.
...
\medterm{Sinusoidal Obstruction Syndrome} Injury and blockage of the small blood vessels in the liver, most often after high-dose chemotherapy given before a stem-cell transplant. It can cause painful liver enlargement, jaundice, fluid buildup, swelling of the abdomen, and rapid weight gain.

\synonyms
Hepatic Veno-Occlusive Disease; VOD/SOS

\medterm{Sinusoids} Specialized, low-pressure microvascular blood vessels featuring wide, irregular lumens, fenestrated or discontinuous endothelial cells, and an incomplete or absent basement membrane, found in the liver, spleen, and bone marrow to facilitate unrestricted transcellular exchange of macromolecules and blood cells.
...
\medterm{Sit-to-Stand Postural Drift} A tendency to lose balance or move away from a stable position while standing up from a chair. It may reflect weakness, poor coordination, dizziness, or impaired balance and should be interpreted with the full examination.

\synonyms
Postural Instability on Rising; Chair Rise Imbalance
...
\medterm{Sixth Disease} Alternate name; see \textit{Roseola}.

\medterm{Sixth Nerve Palsy} Dysfunction of the abducens nerve (cranial nerve VI) producing weakness or paralysis of the ipsilateral lateral rectus muscle, characterized by convergent strabismus (esotropia) and horizontal binocular diplopia worsening on gaze toward the paretic side; frequently caused by microvascular ischemia or elevated intracranial pressure.
...
\medterm{SjöGren's Disease} Alternate name; see \textit{Sjögren disease}.
...
\medterm{Sjogren-Larsson Syndrome} A rare autosomal recessive neurocutaneous disorder caused by mutations in the ALDH3A2 gene encoding fatty aldehyde dehydrogenase (FALDH), characterized by the clinical triad of congenital ichthyosis, spastic diplegia or tetraplegia, and severe intellectual disability with retinal glistening white dots.
\synonyms
SLS; Fatty Aldehyde Dehydrogenase Deficiency
...
\medterm{SJS} Alternate name; see \textit{Stevens-Johnson syndrome}.
...
\synonyms
Cutaneous Malignancy; Non-Melanoma Skin Cancer
...
\medterm{Skin Diseases} Conditions affecting skin, hair, nails, glands, or subcutaneous tissue, including infection, inflammation, neoplasia, and genetic disorders.
...
\medterm{Skin Mycosis} A fungal infection of the skin, hair, or nails, also called cutaneous mycosis or dermatomycosis. It may be superficial or extend deeper into the skin and can cause scaling, itching, inflammation, discoloration, or lesions; diagnosis depends on the appearance and, when needed, microscopy or culture.
...
\medterm{Skin Tag} A small, harmless (benign) growth of soft skin that hangs from a narrow stalk (peduncle). Commonly appearing in body folds and friction areas—such as the neck, armpits, groin, eyelids, and under the breasts—they consist of loose collagen fibers and small blood vessels. While medically harmless, they are frequently associated with skin friction, aging, pregnancy, obesity, or insulin resistance, and can be easily removed if irritated or for appearance.

\synonyms
Acrochordon; Fibroepithelial Polyp; Cutaneous Papilloma

\medterm{Skin Test} Alternate name; see \textit{diagnostic or immunologic skin tests, including prick, patch, and tuberculin testing}.
...
\medterm{Skipped Heartbeats} Alternate name; see \textit{Palpitation}.
...
\medterm{Slapped Cheek Disease} Alternate name; see \textit{Parvovirus infection}.
...
\medterm{Sleep Apnoea} Alternate name; see \textit{Sleep Apnea}.
...
\medterm{Sleep Disorder} Alternate name; see \textit{Sleep Disorders}.
...
\medterm{Sleep Studies} Overnight tests that record brain activity, eye movements, heart rate, breathing, blood oxygen, body position, and limb movements. They help identify sleep apnea, unusual movements, seizures during sleep, and other sleep disorders.

\synonyms
Sleep Diagnostic Study; Nocturnal Somnography
...
\synonyms
Herniated Disc; Intervertebral Disc Prolapse
...
\medterm{Slit-Lamp Biomicroscope} Alternate name; see \textit{Slit Lamp}.
...
\medterm{Slit-Lamp Exam} Alternate name; see \textit{Slit Lamp Biomicroscopy}.

\medterm{Slit Lamp Examination} A fundamental ophthalmological diagnostic procedure utilizing a specialized high-intensity light source focused through a slit aperture paired with a binocular biomicroscope to examine the anterior segment of the eye (cornea, anterior chamber, iris, crystalline lens) and vitreous under high magnification.

\synonyms
Biomicroscopy

\medterm{Slit-Lamp Examination} A diagnostic ophthalmologic procedure utilizing a binocular biomicroscope paired with an adjustable, high-intensity slit-beam light source, allowing detailed optical sectioning and high-magnification stereoscopic examination of the eyelids, cornea, anterior chamber, iris, lens, and anterior vitreous.
\synonyms
Slit-Lamp Biomicroscopy; Anterior Segment Biomicroscopy

\medterm{SLL} Alternate name; see \textit{Small lymphocytic lymphoma}.
...
\synonyms
Type I Muscle Fiber; Red Muscle Fiber
...
\synonyms
Deep Sleep; Delta Sleep; Stage N3 Sleep
...
\medterm{Small Bowel Prolapse} Alternate name; see \textit{Small bowel prolapse (enterocele)}.
...
\medterm{Small-Bowel Volvulus} Twisting of the small intestine that can block its contents and cut off its blood supply. It may cause severe abdominal pain, vomiting, swelling, and inability to pass stool or gas.

\medterm{Small Calorie} A small calorie is a unit of heat energy; food labels usually use a kilocalorie, written Calorie with a capital C, equal to 1,000 small calories.
...
\medterm{Small Cell Lung Carcinoma} An aggressive, high-grade neuroendocrine malignancy of the lung strongly linked to heavy cigarette smoking, characterized histologically by small sheets of cells with scant cytoplasm, granular nuclear chromatin ("salt-and-pepper"), absence of nucleoli, high mitotic rates, and frequent paraneoplastic syndromes (SIADH, Lambert-Eaton).
...
\medterm{Small-Intestinal Cancer} Malignant tumors arising in the small intestine,
classified mainly as adenocarcinoma, neuroendocrine tumors, lymphomas, or sarcomas. They
are far less common than colorectal cancer and often present late with vague abdominal
pain, bleeding, obstruction, or weight loss; risk is increased in some inherited
syndromes, celiac disease, and Crohn disease. Diagnosis uses endoscopy, capsule
endoscopy, or imaging, and treatment depends on the tumor type and stage.
...
\medterm{Small Intestinal Mucosa} The inner lining of the small intestine. Its folds, villi, and microvilli greatly increase the area available for digestion and nutrient absorption.
...
\medterm{Small Intestine Cancer} A malignant tumor arising in the small intestine. Types include adenocarcinoma, neuroendocrine tumor, lymphoma, and sarcoma; symptoms and treatment depend on the tumor type and extent.

\medterm{Small Intestine Prolapse} Alternate name; see \textit{Small bowel prolapse (enterocele)}.
...
\synonyms
Coronary Microvascular Disease; Microangiopathy

\medterm{Small-Vessel Vasculitis (Leukocytoclastic Vasculitis)} Inflammation and destruction of small blood vessels, usually in the skin, producing palpable purpura, petechiae, blisters, ulcers, or systemic symptoms. Causes include medicines, infections, autoimmune disease, and malignancy; kidney, nerve, joint, or gastrointestinal involvement requires evaluation.
...
\synonyms
SMART Criteria; Specific Measurable Goals
...
\medterm{Smith Fracture} An extra-articular fracture of the distal radius with volar (palmar) displacement and angulation of the distal fracture fragment ('reverse Colles fracture'), typically caused by a direct fall onto a flexed wrist.
\synonyms
Reverse Colles Fracture; Volar Distal Radius Fracture
...
\medterm{Smoker Keratosis} Alternate name; see \textit{Leukoplakia}.

\medterm{Smoker Lung} Alternate name; see \textit{Chronic obstructive pulmonary disease}.
...
\synonyms
Asymptomatic Myeloma; Indolent Myeloma; SMM
...
\medterm{Snake Bite} Snake bites can cause puncture wounds, tissue injury, bleeding, paralysis, or venom-related effects on clotting, nerves, muscles, kidneys, or the heart. Venomous bites can become life-threatening, and cutting, sucking, icing, or applying a tourniquet can worsen injury.

\synonyms
Snake Envenomation; Ophidism

\medterm{Snake-Bite} A wound from a snake that may cause local injury, envenomation, infection, or systemic toxicity.

\medterm{Snake Bites} Wounds caused by a snake's teeth; venomous bites may cause pain, swelling, bleeding, tissue damage, paralysis, abnormal clotting, or shock. Cutting, sucking, icing, or applying a tourniquet can worsen injury.
...
\medterm{Social Phobia} Alternate name; see \textit{Social anxiety disorder (social phobia)}.
...
\medterm{Sodium Bisulfate Poisoning} Poisoning from sodium bisulfate, an acidic chemical used in some cleaners and pool products. It can burn the skin, eyes, mouth, and digestive tract; fumes may irritate breathing passages.
...
\medterm{Sodium Carbonate Poisoning} Poisoning from sodium carbonate, an alkaline chemical found in some cleaning products. It may irritate or burn the eyes, skin, mouth, and digestive tract; vomiting can worsen injury after swallowing it.
...
\medterm{Sodium-Potassium Pump} A ubiquitous, electrogenic P-type ATPase enzyme complex in eukaryotic plasma membranes that hydrolyzes one molecule of ATP to export three sodium ions from the cell in exchange for importing two potassium ions, maintaining intracellular ion gradients, resting membrane potential, and cellular osmotic volume.
...
\synonyms
Soft-Tissue Malignancy; Musculoskeletal Sarcoma
...
\medterm{Solanine Plant Poisoning} Toxic ingestion of glycoalkaloids (primarily solanine and chaconine) present in high concentrations in green potato tubers, potato sprouts, and green nightshade foliage, causing acute gastrointestinal and neurological symptoms.

\synonyms
Potato Glycoalkaloid Toxicity; Green Potato Poisoning; Solanine Intoxication
...
\medterm{Solar Keratosis} Alternate name; see \textit{Actinic Keratosis}.

\medterm{Solar Lentigines} Alternate name; see \textit{Age Spots}.
...
\medterm{Solar Purpura} Alternate name; see \textit{Actinic Purpura}.
...
\medterm{Solid Pseudopapillary Pancreatic Tumor} Alternate name; see \textit{Pancreatic Cysts}.
...
\medterm{Solvent Abuse} Harmful inhalation or ingestion of volatile solvents, which can cause neurologic, cardiac, liver, kidney, or respiratory injury.
...
\medterm{Somatic Nervous System} The part of the peripheral nervous system that carries sensory information from the skin, muscles, and joints to the central nervous system and controls voluntary movement of skeletal muscles. Its functions also include reflexes that may occur without conscious control.
...
\medterm{Somniloquy} Talking, laughing, or making sounds during sleep without knowing it. It is usually harmless, but frequent or disruptive episodes may occur with sleepwalking, nightmares, breathing problems during sleep, medicines, or other sleep disorders.

\synonyms
Nocturnal Vocalization; Sleep Utterance; Parasomnia Vocalization
...
\medterm{Somogyi Effect} A rebound hyperglycemia occurring in the early morning in response to an unrecognized, nocturnal episode of hypoglycemia (typically occurring between 2:00 AM and 3:00 AM) in patients with diabetes mellitus treated with insulin. Hypoglycemia triggers a surge of counterregulatory stress hormones (epinephrine, glucagon, cortisol, and growth hormone) stimulating hepatic gluconeogenesis and glycogenolysis; distinguished from the dawn phenomenon by checking 3:00 AM blood glucose levels.

\synonyms
Somogyi Phenomenon; Rebound Hyperglycemia

\medterm{Somogyi Phenomenon} A proposed pattern of morning hyperglycemia following unrecognized overnight hypoglycemia, with counterregulatory hormone release. Continuous or overnight glucose measurements are needed to distinguish it from the more common dawn phenomenon before changing therapy.
...
\synonyms
Valved Holding Chamber; Aerosol Spacer
...
\medterm{Spastic Colon} Alternate name; see \textit{Irritable bowel syndrome}.

\medterm{Spastic Diplegia} A clinical subtype of cerebral palsy historically associated with prematurity and periventricular leukomalacia, characterized by symmetrical spastic hypertonia affecting the lower extremities significantly more than the upper extremities, producing a characteristic "scissor gait" with hip adduction and internal rotation.

\medterm{Spastic Gait} An abnormal walking pattern characterized by stiff, dragging legs, internal rotation of the foot, plantar flexion, and a semicircular circumduction movement of the affected lower limb during the swing phase. It is caused by unilateral or bilateral corticospinal tract (upper motor neuron) damage, such as in cerebral palsy, stroke, or multiple sclerosis.
...
\medterm{Specific Reading Disability} Alternate name; see \textit{Dyslexia}.
...
\medterm{Speckled Lentiginous Nevus (Nevus Spilus)} A flat tan or brown patch containing multiple darker macules or papules. It is usually benign, but changing, enlarging, or atypical components should be examined because melanoma can rarely arise within a melanocytic nevus.
...
\medterm{SPECT Scan} A nuclear-medicine scan that uses a small radioactive tracer and a rotating camera to create three-dimensional pictures of blood flow or organ function. It can examine the heart, brain, bones, kidneys, or other organs.

\synonyms
SPECT Imaging; Single-Photon Emission Tomography
...
\synonyms
Speech Discrimination Testing; Speech Audiometric Evaluation
...
\medterm{Sperm} Mature male gametes produced in the testes. Each normally carries 23 chromosomes and has a head containing genetic material, a midpiece that supplies energy, and a tail that helps it move; semen contains sperm plus fluids from reproductive glands.
...
\medterm{Sperm Cell} Alternate name; see \textit{Sperm}.
...
\synonyms
Sperm Extraction; TESE; PESA; Surgical Sperm Recovery
...
\medterm{Spider Angioma} Alternate name; see \textit{Spider Naevi}.
...
\medterm{Spider Bites} Alternate name; see \textit{Black widow and brown recluse bites}.

\medterm{Spider Naevi} Vascular cutaneous lesions characterized by a central, pulsating red arteriole from which fine, radiating telangiectatic capillaries branch outward like spider legs. Digital pressure blanches the lesion, and upon release it refills rapidly from the center outwards; multiple spider naevi in the superior vena cava distribution (face, neck, upper chest) are classic physical signs of hyperestrogenic states in chronic liver disease, cirrhosis, and pregnancy.

\synonyms
Spider Angioma; Spider Naevus; Spider Telangiectasia; Nevus Araneus; Vascular Spider

\medterm{Spider Naevus} Alternate name; see \textit{Spider Naevi}.

\medterm{Spider Telangiectasia} Alternate name; see \textit{Spider Naevi}.

\medterm{Spigelian Hernia} A ventral abdominal wall hernia protruding through a defect in the Spigelian aponeurosis along the semilunar line (between the lateral border of the rectus abdominis muscle and the transversus abdominis aponeurosis), most frequently located below the arcuate line.
\synonyms
Lateral Ventral Hernia; Spigelian Aponeurosis Hernia
...
\medterm{Spinal Cord and Spine Disorders} Diseases or injuries affecting the spinal bones, discs, ligaments, spinal cord, or nerve roots. They may cause pain, weakness, numbness, balance problems, deformity, or changes in bladder and bowel function.

\medterm{Spinal Cord Compression} Pressure on the spinal cord or its nerve roots, often from a tumor, infection, bleeding, fracture, or slipped disc. It can cause severe back pain, weakness, numbness, walking difficulty, or loss of bladder or bowel control.
...
\medterm{Spinal Cord Infarction} Injury to the spinal cord caused by interruption of its blood supply, often involving the anterior spinal artery or aortic circulation. It typically produces sudden back or limb pain followed by weakness, sensory loss, and bladder or bowel dysfunction.

\medterm{Spinal Cord Injuries} Traumatic damage to the spinal cord that can cause temporary or permanent motor, sensory, autonomic, respiratory, or bowel and bladder dysfunction. Severity depends on the level and completeness of injury.
...
\medterm{Spinal Curvature} Alternate name; see \textit{Scoliosis}.
...
\medterm{Spinal Epidural Abscess} A collection of pus between the covering of the spinal cord and the surrounding bone, usually caused by infection. Severe back pain, fever, weakness, numbness, difficulty walking, or loss of bladder or bowel control may occur.

\medterm{Spinal Fluid Leak} Alternate name; see \textit{CSF leak (Cerebrospinal fluid leak)}.
...
\medterm{Spinal Injury} Damage to the spinal cord, vertebrae, discs, ligaments, or nearby nerves caused by trauma or another disease. It may cause pain, weakness, numbness, paralysis, or bladder and bowel problems and can be life-threatening when severe.

\medterm{Spinal Metastasis} Spread of a cancer to the vertebrae, spinal canal, or nearby epidural tissues. Back pain, weakness, numbness, gait change, or bowel or bladder dysfunction may signal spinal cord or nerve compression and requires urgent assessment.

\medterm{Spinal Muscular Atrophy} Usually an autosomal recessive inherited disorder causing progressive loss of motor neurons and muscle weakness, often beginning in infancy
...
\medterm{Spinal Reflex} A fast, automatic response that is processed through the spinal cord. It can occur before the brain becomes aware of the stimulus.
...
\synonyms
Vertebral Canal Stenosis; Lumbar Spinal Narrowing

\medterm{Spinal Stenosis Lumbar} Alternate name; see \textit{Lumbar stenosis}.

\medterm{Spinal Tap} Alternate name; see \textit{Lumbar puncture}.
...
\medterm{Spinocerebellar Ataxia} Alternate name; see \textit{Spinocerebellar Ataxias}.
...
\medterm{Spinothalamic Tract} The primary ascending somatic sensory pathway conveying pain, thermal sensation, and crude non-discriminative touch from peripheral free nerve endings through the spinal cord (decussating within 1 to 2 segments in the anterior white commissure) to the ventral posterolateral (VPL) nucleus of the thalamus.
...
\medterm{Spitz Nevus Pathology} A usually benign melanocytic proliferation composed of epithelioid or spindle cells, often symmetrical and well circumscribed, with maturation, Kamino bodies, and characteristic epidermal changes. Some lesions overlap morphologically with melanoma.
...
\medterm{Spleen Diseases} Disorders affecting splenic structure or function, including splenomegaly, infarction, infection, cysts, abscess, rupture, vascular disease, and hematologic or infiltrative disorders.
...
\medterm{Split-Thickness Skin Grafts} Grafts containing the epidermis and part of the dermis, used to cover burns, wounds, ulcers, or surgical defects. They take more readily than full-thickness grafts but may contract, differ in color or texture, and leave a donor-site wound.
...
\medterm{Spontaneous Abortion} Unintentional loss of a pregnancy before fetal viability. Causes include chromosomal abnormalities, uterine or cervical problems, infection, and maternal medical conditions.

\synonyms
Early Pregnancy Loss; Spontaneous Pregnancy Loss
...
\medterm{Spontaneous Bacterial Peritonitis Diagnostic Criteria} The diagnostic consensus criteria for spontaneous bacterial peritonitis (SBP), defined as an acute bacterial infection of ascitic fluid in patients with advanced cirrhosis in the absence of a surgically treatable intra-abdominal source. Established on diagnostic paracentesis when the ascitic fluid absolute neutrophil count (ANC) equals or exceeds 250 cells per cubic millimeter (0.25 $\times 10^9$/L).

\synonyms
SBP Diagnostic Criteria; Ascitic Neutrophil Cutoff
...
\medterm{Sportsman's Groin} Long-lasting groin or lower-abdominal pain related to repeated sports activity, especially kicking, sprinting, twisting, or quick changes of direction. It is often called sports hernia, although there may be no true hernia. Examination and sometimes imaging help identify the cause; treatment may include rest, guided exercises, and, in selected persistent cases, surgery.

\synonyms
Athletic Pubalgia; Sports Hernia; Gilmore's Groin; Inguinal Disruption; Core Muscle Injury
...
\medterm{Spring Fever Henoch-Schonlein} Alternate name; see \textit{Henoch-Schonlein purpura}.
...
\medterm{Spur Cell} Alternate name; see \textit{Acanthocyte}.
...
\medterm{Spurling Test} A clinical provocative test for cervical radiculopathy; with the patient seated, the neck is extended and laterally rotated toward the affected side, and gentle downward axial pressure is applied to the vertex of the skull; reproduction of sharp radiating dermatomal pain down the arm indicates nerve root compression.
\synonyms
Spurling's Maneuver; Cervical Foraminal Compression Test
...
\synonyms
Stable Ischemic Heart Disease; Chronic Coronary Syndrome
...
\medterm{Stage 4 Prostate Cancer} Alternate name; see \textit{Metastatic (stage 4) prostate cancer}.
...
\synonyms
Transtheoretical Model; Prochaska Model

\medterm{Stages of Labor} The three sequential stages of childbirth: the first stage extends from the onset of labor to complete cervical dilation and includes latent and active phases; the second stage extends from complete dilation to birth of the baby; and the third stage extends from birth to delivery of the placenta.
...
\synonyms
Staph Infection; Staphylococcal Disease
...
\medterm{Staphylococcal Scalded Skin} Alternate name; see \textit{Staphylococcal Scalded Skin Syndrome}.
...
\medterm{Starling Equation} A mathematical physical equation describing the transcapillary fluid filtration rate ($J_v$) as a function of the hydraulic conductance and the balance between hydrostatic pressure gradients (capillary minus interstitial) and oncotic pressure gradients (capillary minus interstitial) across microvascular endothelia.
...
\medterm{Statin Drugs} A group of medicines that lowers LDL (“bad”) cholesterol by reducing cholesterol production in the liver. Statins lower the risk of heart attack and stroke; muscle symptoms and liver abnormalities can occur.
...
\medterm{Status Epilepticus} A seizure lasting long enough or recurring often enough that recovery does not occur between seizures, creating a persistent seizure state and neurologic emergency. Operational treatment thresholds are about 5 minutes for generalized tonic-clonic seizures, 10 minutes for focal seizures, and 10 to 15 minutes for absence seizures; status may be convulsive or nonconvulsive.
...
\medterm{STDs} Alternate name; see \textit{Sexually transmitted diseases (STDs)}.
...
\medterm{Steatocystoma Multiplex} A disorder producing multiple sebum-filled cysts arising from the pilosebaceous units, commonly on the trunk, chest, arms, or face. Lesions are usually skin-colored and painless but may become inflamed; treatment depends on symptoms and extent.
...
\medterm{Steatotic Liver Disease (SLD)} A group of liver disorders characterized by excess fat accumulation in liver cells. Causes include metabolic dysfunction, alcohol, medicines, and other conditions; inflammation, fibrosis, cirrhosis, or liver cancer may develop in some people.
\medterm{Steele-Richardson-Olszewski Syndrome} Alternate name; see \textit{Progressive supranuclear palsy}.

\medterm{Stein-Leventhal Syndrome} Alternate name; see \textit{Polyendocrine metabolic ovarian syndrome}.
...
\medterm{Stem Cell} An unspecialized cell with two defining abilities: self-renewal, or making more stem cells, and differentiation, or developing into specialized cells. The range of possible cell types depends on the stem cell’s potency; adult stem cells are often tissue-restricted, while embryonic and induced pluripotent stem cells can form many cell types.
...
\medterm{Stem Cells} Cells that can self-renew and produce specialized cell types within a range determined by their potency. They help maintain or repair some tissues, and blood-forming stem-cell transplantation is an established clinical use; many other stem-cell applications remain investigational.
...
\medterm{Stenosing Tenosynovitis} Alternate name; see \textit{Trigger finger}.
...
\medterm{Stenosis of the LAD} Narrowing of a major artery supplying the front of the heart. Reduced blood flow may cause chest pain during exertion or a heart attack if the narrowing becomes severe or the artery suddenly blocks.
...
\medterm{Stensen Duct} The main excretory duct of the parotid gland that traverses the masseter muscle and opens into the oral cavity through a small papilla on the buccal mucosa opposite the second maxillary molar.
...
\medterm{Stereotactic Breast Biopsy} A minimally invasive percutaneous core-needle biopsy procedure utilizing digital mammographic triangulation from angled X-ray views to precisely target and sample nonpalpable microcalcifications or architectural distortions.
...
\medterm{Sternal Angle} The ridge where the manubrium joins the body of the sternum. It marks the level where the second ribs attach and helps locate structures inside the chest.
...
\medterm{Sternal Fracture} A break in the breastbone, most often caused by direct chest impact or compression. It may cause localized pain and tenderness and can accompany cardiac, pulmonary, or mediastinal injury.

\medterm{Sternal Line} An imaginary vertical line along the outer edge of the breastbone. It is used as a surface landmark when describing the location of chest structures or physical findings.
...
\medterm{Sternocostal Joint} A joint where a rib or its cartilage meets the breastbone. These joints help form the front of the chest wall.
...
\medterm{Stewart-Treves Syndrome} An angiosarcoma arising in long-standing lymphedema, classically after mastectomy but also after congenital lymphedema, radiation, infection, or other lymphatic damage. New bruised, purple, nodular, or ulcerated areas in chronically swollen skin need urgent biopsy.

\medterm{STI} Alternate name; see \textit{Sexually Transmitted Infections}.
...
\medterm{Stilboestrol} Historical name; see \textit{Diethylstilbestrol}.
...
\synonyms
Systemic Juvenile Idiopathic Arthritis; Adult-Onset Still Disease; AOSD
...
\medterm{Stippling} Patterned dermal abrasions and punctate hemorrhages surrounding a firearm entrance
...
\synonyms
Gastric Carcinoma; Gastric Neoplasm
...
\medterm{Stomach Diseases} Disorders affecting the stomach, including inflammation, ulcers, movement problems, blockage, bleeding, and tumors. Symptoms may include pain, nausea, vomiting, early fullness, weight loss, indigestion, or blood in vomit or stool.
...
\medterm{Stomatodynia} Alternate name; see \textit{Burning mouth syndrome}.
...
\medterm{Stonefish Sting} A puncture injury from the venomous spines of a stonefish, causing severe pain, swelling, bleeding, and sometimes weakness, breathing problems, or shock. Hot-water immersion may reduce pain, but severe poisoning can affect breathing and circulation.
...
\synonyms
Fecal Analysis; Stool Test; Coprology
...
\medterm{Stool Holding} Alternate name; see \textit{Encopresis}.

\medterm{Stool Occult Blood Test} Alternate name; see \textit{Fecal occult blood test}.
...
\medterm{Straddle Injury} A direct blunt compressive trauma to the perineum occurring when a patient falls astride a hard, rigid object (such as a bicycle crossbar, fence, or beam), frequently causing crushing rupture of the anterior bulbous urethra beneath the pubic symphysis.

\medterm{Straight Leg Raise Test} A provocative physical examination test for lumbosacral nerve root irritation (L4-S1, typically due to herniated intervertebral disc), in which the patient lies supine and the examiner passively elevates the extended lower extremity; reproduction of electric shooting radicular pain down the leg between 30 and 70 degrees indicates a positive result.

\synonyms
Lasegue Sign; SLR Test
...
\medterm{Strawberry Hemangioma} Alternate name; see \textit{Hemangioma}.

\medterm{Strawberry Tongue} A tongue that looks bright red and bumpy like a strawberry, often seen in childhood illnesses like scarlet fever or Kawasaki disease.
...
\medterm{Streptococcal Pharyngitis} Alternate name; see \textit{Strep Throat}.
...
\medterm{Striae Distensae (Stretch Marks)} Linear bands caused by stretching and structural change in the dermis during growth, pregnancy, rapid weight change, muscle gain, or corticosteroid exposure. They may begin red or purple and later become pale and atrophic.
...
\medterm{Stricture} An abnormal narrowing of a passage in the body, such as the esophagus, intestine, bile duct, or urethra. Scarring, inflammation, injury, surgery, or cancer may cause blockage and symptoms related to the affected organ.

\medterm{Stridor} A harsh, high-pitched breathing sound caused by air squeezing through a narrowed windpipe or voice box. It is heard loudest over the neck and usually happens while breathing in. This makes it different from wheezing, which comes from inside the lungs when breathing out. In babies and young children, common causes include croup, an object stuck in the throat, or floppy airway cartilage. In adults, causes include severe allergic swelling, vocal-cord problems, infections, or growths in the neck. Doctors find the cause by checking oxygen levels, taking neck X-rays, or looking into the throat with a tiny camera.

\medterm{String Sign} A very narrow, thread-like passage seen on an imaging test of the digestive tract. It may occur with narrowing from Crohn disease or with narrowing at the stomach outlet in an infant, but it is not specific to one condition.
...
\medterm{Stripping of Membranes} A procedure performed during a cervical exam where the examiner inserts a finger through
...
\medterm{Stucco Keratosis} Multiple small, rough, whitish or gray-brown keratotic papules, usually on the lower legs and sometimes the arms or trunk of older adults. They are benign and may be treated for cosmetic or symptomatic reasons.
...
\medterm{Stump Pain} Alternate name; see \textit{Residual limb pain}.
...
\medterm{Sty} Alternate name; see \textit{Stye}.
...
\medterm{Subacute Cutaneous Lupus Erythematosus (SCLE)} A photosensitive form of cutaneous lupus causing annular or papulosquamous red scaly lesions on sun-exposed skin. It may be associated with anti-Ro/SSA antibodies, medicines, or systemic lupus features and needs sun protection and medical evaluation.
...
\medterm{Subarachnoid Cisterns} Anatomical enlargements and pools of the subarachnoid space formed where the arachnoid membrane bridges over deep depressions between the brain and skull, filled with cerebrospinal fluid, including the cisterna magna, interpeduncular cistern, ambient cistern, and chiasmatic cistern.
...
\medterm{Subclavian Vein Thrombosis} A blood clot in the large vein beneath the collarbone. It may be related to a central venous catheter or pacemaker lead, or to repeated strenuous arm activity and compression at the thoracic outlet (Paget-Schroetter syndrome). It can cause arm or neck swelling, pain, bluish discoloration, and pulmonary embolism.
...
\medterm{Subclinical Hypothyroidism} An early biochemical state of mild thyroid failure defined by an elevated serum thyroid-stimulating hormone (TSH) concentration in the presence of strictly normal circulating free thyroxine (free $T_4$) and free triiodothyronine (free $T_3$) levels. It represents a compensatory pituitary response that maintains euthyroid peripheral hormone concentrations. Although often asymptomatic and discovered incidentally on routine blood tests, patients may exhibit subtle symptoms (mild fatigue, cold intolerance, constipation), atherogenic dyslipidemia (elevated LDL cholesterol), and a heightened risk of progression to overt primary hypothyroidism, particularly when antithyroid peroxidase (anti-TPO) autoantibodies are present.
\synonyms{Mild Thyroid Failure; Subclinical Thyroid Failure; Compensated Hypothyroidism}
...
\medterm{Subconjunctival Hemorrhage} A small blood vessel broken beneath the clear surface of the eye, causing a sharply demarcated red patch that usually resolves without treatment.

\synonyms
Hyposphagma; Eye Capillary Bleed
...
\medterm{Subfertility} Alternate name; see \textit{Infertility}.

\medterm{Subgaleal Hematoma} A dangerous collection of blood within the loose areolar connective tissue space between the epicranial aponeurosis (galea aponeurotica) and the cranial periosteum, capable of crossing suture lines and expanding massively across the entire cranial vault, causing hypovolemic shock in neonates following vacuum-assisted delivery.
...
\synonyms
Drug Addiction; Chemical Dependency; Substance Abuse Disorder
...
\medterm{Substantia Nigra} A crescent-shaped basal ganglia midbrain structure containing dopaminergic neurons in the dorsal pars compacta (which project to the striatum and degenerate in Parkinson disease) and GABAergic output neurons in the ventral pars reticulata.
...
\medterm{Subtalar Joint} The joint between the talus and heel bone beneath the ankle. It helps the foot tilt inward and outward.
...
\medterm{Succussion Splash} A splashing sound auscultated over the epigastrium or thorax while gently shaking the patient's torso. In the abdomen, a splash heard more than three to four hours after a meal indicates delayed gastric emptying or gastric outlet obstruction; in the chest, it indicates hydropneumothorax.
...
\medterm{Sudden Natural Death Pathology} Postmortem evaluation of an unexpected death from natural disease, commonly involving coronary artery disease, myocardial infarction, cardiomyopathy, myocarditis, pulmonary embolism, epilepsy, or intracranial disease. The cause may remain indeterminate despite complete examination.
...
\medterm{Sudden Visual Loss} Rapid loss or marked reduction of vision in one or both eyes caused by retinal, optic-nerve, vascular, inflammatory, traumatic, or neurologic disease. It requires urgent localization and evaluation.

\medterm{Sudeck Atrophy} An acute post-traumatic or post-surgical manifestation of complex regional pain syndrome type I (CRPS-I) characterized by severe burning neuropathic pain, autonomic vasomotor and sudomotor dysfunction, localized edema, and rapid patchy radiographic osteopenia of the affected limb.
\synonyms
Sudeck's Dystrophy; Post-Traumatic Osteoporosis
...
\medterm{Sudorifics} Medicines or other treatments that increase sweating. They have limited specific medical uses; excessive sweating caused by a treatment can lead to dehydration, overheating, or abnormal body salts.
...
\medterm{Sugar Substitutes} Sugar substitutes provide sweetness with little or no sugar; types differ in energy, digestion, aftertaste, and effects on glucose and gastrointestinal symptoms.
...
\medterm{Suicidal Intent} The degree to which a person expects or wants to die as a result of suicidal thoughts or behavior. It is assessed with the person’s own account, planning, preparation, access to means, and other clinical information.

\medterm{Suicidality} The presence or risk of suicidal thoughts, intent, plans, or behavior. The term describes a clinical domain rather than a diagnosis and requires assessment of immediacy, access to means, past behavior, protective factors, and safety.

\medterm{Suicidal Plan} A stated or considered method, timing, place, or other preparation for ending one’s own life. A plan is an important risk indicator and requires immediate professional safety assessment.
...
\medterm{Suicide Attempt} An act in which a person intentionally tries to end their own life but does not die. A suicide attempt can cause serious injury even when the person did not expect to die and requires prompt medical and mental-health assessment.
...
\medterm{Sulfite Oxidase Deficiency} A rare inherited metabolic disorder in which sulfite cannot be adequately converted to sulfate. Toxic sulfite and related compounds can cause neonatal seizures, feeding difficulty, abnormal muscle tone, developmental impairment, and progressive brain injury.
...
\medterm{Sunken Chest} Alternate name; see \textit{Pectus excavatum}.

\medterm{Sunken Fontanelle} A noticeable inward depression of an infant's soft spot, which is a classic physical sign of moderate to severe dehydration or significant malnutrition requiring prompt fluid replacement.

\synonyms
Depressed Fontanelle; Sunken Soft Spot; Dehydration Sign in Infants

\medterm{Sun Protection} Measures that reduce exposure to ultraviolet radiation, including shade, protective clothing, sunglasses, and broad-spectrum sunscreen. They help prevent sunburn, premature skin aging, eye damage, and ultraviolet-related skin cancers.

\synonyms
UV Protection; Solar Defense

\medterm{Sunscreens} Topical products that absorb, scatter, or reflect ultraviolet radiation to reduce sunburn and cumulative ultraviolet skin damage. They may be chemical, mineral, or combined formulations and are commonly described by their broad-spectrum protection and sun-protection factor (SPF).
...
\synonyms
Subcutaneous Tissue; Hypodermis; Camper and Scarpa Fascia
...
\medterm{Superior Mediastinum} The upper part of the mediastinum, above the level of the sternal angle. It contains the thymus, major blood vessels, trachea, esophagus, nerves, and lymph nodes.
...
\medterm{Supernumerary Digit} An extra finger or toe present from birth, ranging from a small skin tag to a well-formed digit with bone and joints. It may occur alone or with a genetic syndrome and is evaluated for function, circulation, and associated anomalies.

\medterm{Supernumerary Nipple} An additional nipple or areolar structure along the embryonic milk line, usually harmless and sometimes mistaken for a mole. It may darken or enlarge with hormonal changes and generally needs treatment only if symptomatic or diagnostically uncertain.
...
\medterm{Supranuclear Palsy} Alternate name; see \textit{Progressive supranuclear palsy}.
...
\medterm{Suprarenal Glands} Two small glands above the kidneys. Their outer layer makes hormones that regulate salt, blood pressure, stress, and metabolism; their inner layer makes adrenaline and related hormones.
...
\medterm{Suprascapular Neuropathy} Dysfunction of the suprascapular nerve from compression, traction, trauma, or an adjacent lesion. It may cause deep shoulder pain, weakness of abduction or external rotation, and wasting of the supraspinatus or infraspinatus muscles.

\medterm{Supraspinatus Muscle} The most frequently injured muscle of the rotator cuff, originating from the supraspinous fossa of the scapula and passing beneath the acromion to insert onto the superior facet of the greater tubercle of the humerus, responsible for initiating the first 15 degrees of shoulder abduction.

\medterm{Suprasternal Notch} The shallow dip at the upper border of the manubrium, between the inner ends of the collarbones.
...
\medterm{Sural Nerve} A sensory nerve formed mainly from branches of the tibial and common fibular nerves. It supplies sensation to the posterolateral lower leg and lateral border of the foot.
...
\medterm{Surgical Abortion} A procedure that removes a pregnancy from the uterus to end a pregnancy or treat an early pregnancy loss. Common methods include vacuum aspiration and dilation and evacuation; the method depends on how far the pregnancy has progressed.

\synonyms
Vacuum Aspiration; Suction Curettage; Induced Abortion
...
\medterm{Surgical Forceps} Handheld instruments used during surgery to hold, grasp, move, or manipulate tissue, sutures, dressings, or other materials. Their shape and pressure are selected to limit tissue injury.

\synonyms
Surgical Grasping Forceps; Tissue Forceps
...
\medterm{Surgical Retractor} A surgical instrument used to hold tissues apart, giving doctors a clearer and safer view of the operating area.

\synonyms
Tissue Retractor; Wound Retractor
...
\medterm{Surgical Scissors} Surgical instruments designed to cut tissue, sutures, dressings, or other materials. Different shapes and blade types are selected for delicate, deep, curved, or heavy-duty work.
\synonyms
Surgical Scissors; Operating Shears
...
\medterm{Susceptibility-Weighted Imaging} An MRI technique that is especially sensitive to small veins, blood products, iron, and some calcium deposits in tissue, particularly in the brain.
...
\medterm{SVT} Alternate name; see \textit{Supraventricular tachycardia}.
...
\medterm{Swan-Ganz Catheterization} A procedure in which a thin catheter is passed through the right side of the heart into a lung artery to measure heart pressures and blood flow. It is used selectively in critically ill patients because bleeding, infection, rhythm problems, or vessel injury can occur.

\medterm{Swan Neck Deformity} A characteristic joint deformity of the hand in which there is hyperextension of the proximal interphalangeal (PIP) joint accompanied by compensatory flexion of the distal interphalangeal (DIP) joint. It is classically seen in advanced rheumatoid arthritis, systemic lupus erythematosus, and chronic tendon imbalance.

\medterm{Swan-Neck Deformity} A finger shape problem where the middle joint bends backward and the fingertip curls down, commonly caused by rheumatoid arthritis.
...
\synonyms
Diaphoresis and Bromhidrosis; Perspiration and Osmidrosis
...
\synonyms
Peripheral Dependent Edema; Pedal Edema

\medterm{Swollen Glands} Lymph nodes that are larger than usual, often because the immune system is responding to infection or inflammation. They may be tender, but hard, fixed, enlarging, or unexplained nodes require medical assessment.

\synonyms
Lymphadenomegaly; Adenopathy

\medterm{Swollen Gums} Pathologic enlargement, edema, or hypertrophy of the gingival tissue. Etiologies include plaque-induced gingivitis, periodontal disease, acute oral infections, hormonal fluctuations during pregnancy, nutritional deficiencies (such as scurvy), leukemia, or drug-induced gingival hyperplasia from medications like calcium channel blockers, phenytoin, and cyclosporine.

\synonyms
Gingival Swelling; Gingival Hyperplasia; Gingival Enlargement; Enlarged Gums

\synonyms
Gingival Hyperplasia; Gingival Enlargement

\medterm{Swollen Lymph Glands} Enlarged lymph nodes, usually caused by infection or inflammation and less often by cancer. They commonly occur in the neck, armpits, or groin; persistent, hard, fixed, or unexplained swelling needs medical assessment.
...
\synonyms
Lymphadenopathy; Adenopathy; Bubo

\medterm{Swollen Lymph Nodes Entry} Alternate name; see \textit{Swollen Lymph Nodes}.
...
\medterm{Swyer Syndrome} A form of pure 46,XY gonadal dysgenesis resulting from mutations in the \textit{SRY} gene or related sex-determining pathways, presenting as a phenotypic female with normal external female genitalia, streak gonads, absent puberty, and primary amenorrhea, carrying a high risk of gonadoblastoma in the streak gonads.
...
\medterm{Sympathomimetic Syndrome} Alternate name; see \textit{Sympathomimetic Toxidrome}.

\medterm{Sympathomimetic Toxicity} Excess catecholamine activity causing agitation, mydriasis, diaphoresis, tachycardia, hypertension, hyperthermia, chest pain, seizures, stroke, or rhabdomyolysis. Unlike anticholinergic toxicity, sweating is usually prominent; benzodiazepines, active cooling, ECG monitoring, and treatment of ischemia, hypertension, and complications are central.
...
\medterm{Synchondroses} Cartilage-based joints in which bones are joined by hyaline cartilage and allow little or no movement. Growth plates and the joint between the first rib and the breastbone are examples.
...
\medterm{Syncope} A brief loss of consciousness and muscle control caused by a temporary reduction in blood flow to the brain, followed by spontaneous recovery. Common causes include reflex fainting, a sudden blood-pressure drop, dehydration, and heart disease; prolonged confusion may suggest another cause.

\synonyms
Passing Out; Temporary Loss of Consciousness; Swoon
...
\medterm{Syndesmoses} Fibrous joints in which two bones are held together by strong ligaments or a sheet of connective tissue. They allow little movement; the joint between the lower leg bones near the ankle is one example.
...
\medterm{Syndrome of Inappropriate Antidiuresis (SIAD)} Excessive vasopressin activity causes retention of free water, inappropriately concentrated urine, and usually low serum sodium despite no appropriate physiologic stimulus. Causes include medicines, lung or brain disease, cancer, and postoperative stress; severe hyponatremia can cause seizures or coma.
...
\medterm{Syndrome X} Alternate name; see \textit{Metabolic syndrome}.
...
\medterm{Synostoses} Fusions between two bones in which bone tissue joins them together. They may be present from birth or develop later and can limit growth or movement depending on their location.
...
\medterm{Synovial Joints} Freely movable joints in which the connecting bone surfaces are separated by a small fluid-filled space and enclosed by a joint capsule. Examples include the knee, hip, shoulder, and elbow.
...
\medterm{Syphilis Serology} Blood tests used to screen for syphilis and monitor response to treatment. A reactive result usually needs confirmation with a different test and interpretation alongside symptoms, examination, and treatment history.

\synonyms
Non-Treponemal Antibodies; RPR and VDRL Tests
...
\medterm{Systematic Desensitization} A behavioral therapy technique that pairs gradual, planned exposure to a feared situation with relaxation or other coping skills. It is used mainly for phobias and anxiety and is adapted to the person’s response.
...
\medterm{Systemic Dermatoses} Skin manifestations that arise as secondary signs of internal medical diseases, such as endocrine disorders, autoimmune conditions, internal malignancies, or nutritional deficiencies.

\synonyms
Cutaneous Manifestations of Systemic Disease; Systemic Skin Signs
...
\medterm{Systemic Exertional Intolerance Disease} Alternate name; see \textit{Myalgic encephalomyelitis/chronic fatigue syndrome (ME/CFS)}.
...
\medterm{Systemic Lupus Erythematosus (SLE) and Pregnancy} SLE can affect fertility, kidneys, blood counts, blood vessels, placenta, and fetal growth, while pregnancy can trigger disease activity. Preconception planning, compatible medicines, antibody testing, blood-pressure and kidney monitoring, and maternal-fetal surveillance are important.
...
\medterm{Systolic Murmur} An abnormal heart sound auscultated during ventricular systole (between the first and second heart sounds, S1 and S2). It may be midsystolic/ejection (as in aortic or pulmonary stenosis) or holosystolic/pansystolic (as in mitral or tricuspid regurgitation, or ventricular septal defect).
...
\medterm{Sacrococcygeal Chordoma} A malignant tumor arising from remnants of the embryonic notochord at the base of the spine. It may cause tailbone pain, a mass, bowel or bladder symptoms, or nerve problems and is assessed with imaging and biopsy.

\medterm{SAD (Seasonal Affective Disorder)} Alternate name; see \textit{Seasonal Affective Disorder}.

\medterm{SAM-e} Abbreviation; see \textit{S-Adenosylmethionine}.

\medterm{Sarcoid Of Boeck} Historical name for sarcoidosis, an inflammatory disease in which clusters of immune cells form in organs such as the lungs, lymph nodes, skin, or eyes.

\medterm{SARS (Severe Acute Respiratory Syndrome)} Alternate name; see \textit{Severe Acute Respiratory Syndrome}.

\medterm{Scarring Bullosa} A group of blistering disorders in which repeated inflammation and blistering heal with scarring, potentially affecting skin, mucous membranes, eyes, mouth, or the airway. Diagnosis and treatment depend on the specific disorder.

\medterm{Schereshevkii-Turner Syndrome} Alternate name; see \textit{Turner Syndrome}.

\medterm{Secondary Psychosis} Psychotic symptoms caused or contributed to by a medical illness, medicine, substance, or neurologic disorder rather than a primary psychotic disorder. New hallucinations, delusions, or confusion require urgent assessment for reversible causes.

\medterm{Severe Hearing Loss} Hearing loss that substantially limits access to speech or environmental sound. It may be conductive, sensorineural, or mixed and may require hearing aids, cochlear implantation, communication support, or treatment of an underlying cause.

\medterm{Skin Cancer, Melanoma} Alternate name; see \textit{Melanoma}.

\medterm{Skin Cancer, Squamous Cell Type} Alternate name; see \textit{Squamous Cell Carcinoma of the Skin}.

\medterm{Skin Rash} A visible change in the skin, such as redness, scaling, bumps, blisters, or discoloration. Causes include infection, allergy, inflammation, medicines, heat, and systemic disease; rapid spread, skin pain, blistering, fever, or mucosal involvement needs prompt care.

\medterm{Skin Tags} Soft, usually harmless skin growths attached by a narrow stalk, often in skin folds. They can catch on clothing or become irritated; a changing, bleeding, painful, or atypical lesion should be examined before removal.

\medterm{Sleep Epilepsy} Epilepsy in which seizures occur predominantly during sleep or transitions between sleep and wakefulness. Events may be subtle or involve movements, vocalizations, confusion, or injury and require neurologic evaluation.

\medterm{Slipped Disc} A common lay term for a herniated or prolapsed intervertebral disk, in which disk material extends beyond its normal boundary and may irritate a nearby nerve, causing back or neck pain, numbness, or weakness.

\medterm{Small Lymphocytic Lymphoma} A usually slow-growing B-cell non-Hodgkin lymphoma that is closely related to chronic lymphocytic leukemia. It commonly causes enlarged lymph nodes and is diagnosed with tissue examination and immunophenotyping.

\medterm{Spastic Dysphonia} A voice disorder caused by involuntary spasms of the muscles used for speaking, also called spasmodic dysphonia. The voice may sound strained, broken, breathy, or weak; assessment distinguishes it from structural and neurologic causes.

\medterm{Spermatocele (Epididymal Cyst)} A usually benign, fluid-filled cyst arising in the epididymis near the testicle. It may cause a painless scrotal lump or heaviness and is distinguished from tumors, hydrocele, infection, and other causes by examination and ultrasound.

\medterm{Spherocytic Anemia} Anemia caused by fragile, sphere-shaped red blood cells that are removed early by the spleen. It is often inherited as hereditary spherocytosis and may cause jaundice, gallstones, fatigue, or an enlarged spleen.

\medterm{Spinal Arachnoiditis} Chronic inflammation and scarring of the arachnoid membrane around spinal nerves. It may cause persistent burning pain, tingling, weakness, or bowel and bladder problems after infection, surgery, trauma, bleeding, or chemical irritation.

\medterm{Spinal Chordoma} A malignant notochord-derived tumor arising along the spine, often in the sacrum. It can produce progressive pain, a mass, weakness, numbness, or bowel and bladder dysfunction and requires specialist imaging and treatment.

\medterm{Spinal Meningitis} Inflammation or infection of the membranes surrounding the spinal cord, often occurring with meningitis involving the brain. Fever, severe headache, neck or back stiffness, confusion, rash, or neurologic changes require emergency evaluation.

\medterm{Spinal Muscular Atrophy (SMA)} Alternate name; see \textit{Spinal Muscular Atrophy}.

\medterm{Splenomegaly With Rheumatoid Arthritis} Enlargement of the spleen occurring with rheumatoid arthritis, classically in Felty syndrome and sometimes with low white blood-cell counts. Infection risk and other causes of spleen enlargement require assessment.

\medterm{Stevens Johnson Syndrome} Alternate spelling; see \textit{Stevens-Johnson Syndrome}.

\medterm{Subcortical Dementia} Cognitive decline associated predominantly with disease of structures beneath the cerebral cortex, often causing slowed thinking, executive dysfunction, mood change, gait problems, and impaired attention. Causes include small-vessel disease and some neurodegenerative disorders.

\medterm{Subcortical Ischemic Vascular Disease} Chronic small-vessel disease causing reduced blood flow and tissue injury in deep brain structures. It may contribute to slowed thinking, gait difficulty, mood symptoms, urinary problems, and vascular dementia.

\medterm{Subendocardial Sclerosis} Fibrous thickening of the inner lining of the heart, often involving the ventricles or valves. Its significance depends on the cause and may include effects on filling, conduction, or cardiac function.

\medterm{Sucrose Intolerance} Inability to digest or absorb sucrose adequately, often because of congenital or acquired sucrase-isomaltase deficiency. Eating sucrose may cause bloating, cramps, gas, and diarrhea; diagnosis and dietary management should avoid unnecessary restriction.

\medterm{Suppurative Arthritis} A joint infection producing pus and inflammation, usually caused by bacteria. It can rapidly destroy cartilage and cause fever, severe joint pain, swelling, and limited movement, requiring urgent drainage and antimicrobial treatment.

\medterm{Symmastia} An abnormal connection or loss of the normal separation between the breasts across the midline of the chest, sometimes occurring after breast surgery or reconstruction. Management depends on symptoms, anatomy, and cause.

\medterm{Symptomatic Porphyria} Porphyria causing clinical attacks or ongoing symptoms from abnormal heme production. Manifestations may include severe abdominal pain, neurologic or psychiatric symptoms, blistering or sun-sensitive skin, or liver complications depending on the type.

\medterm{Syphilis, Congenital} Syphilis transmitted from a pregnant person to the fetus or newborn. It may cause no early symptoms or may produce rash, jaundice, bone abnormalities, anemia, hearing or vision problems, and neurologic disease; screening and timely treatment during pregnancy help prevent it.

\medterm{Spider Veins} Small visible red, blue, or purple superficial veins, usually on the legs or face. They are generally harmless but may be associated with venous insufficiency; sudden pain, swelling, skin ulceration, or one-sided change requires assessment.

\medterm{Sphingomyelinase Deficiency} Deficiency of acid sphingomyelinase caused by variants in the \textit{SMPD1} gene. It causes Niemann-Pick disease types A, A/B, or B, with lipid accumulation affecting the spleen, liver, lungs, brain, or other organs.

\medterm{Spielmeyer-Vogt Disease} An older name for neuronal ceroid lipofuscinosis, a group of inherited lysosomal disorders causing progressive loss of vision, seizures, movement problems, and cognitive decline.

\medterm{Spielmeyer-Vogt-Batten Syndrome} Alternate historical name for juvenile neuronal ceroid lipofuscinosis, commonly called Batten disease. It usually begins in childhood with vision loss followed by seizures, developmental regression, movement problems, and dementia.

\medterm{Synergistic Necrotizing Fasciitis} A rapidly progressive necrotizing soft-tissue infection caused by mixed aerobic and anaerobic organisms acting together. Severe pain, swelling, skin discoloration, fever, toxicity, or rapid progression requires immediate surgery, antibiotics, and critical care.

\medterm{Systemic Aleukemic Reticuloendotheliosis} A historical name for a leukemic reticuloendothelial disorder, most often referring to the aleukemic form of hairy-cell leukemia. It may cause low blood counts, an enlarged spleen, infections, fatigue, or bleeding and is diagnosed by blood, marrow, and immunophenotypic studies.
