...
\medterm{Ullrich Congenital Muscular Dystrophy} A severe congenital muscular dystrophy belonging to the collagen VI deficiency spectrum, inherited in an autosomal recessive (or dominant de novo) pattern caused by mutations in \textit{COL6A1}, \textit{COL6A2}, or \textit{COL6A3}. Characterized from birth or early infancy by profound generalized muscle weakness and hypotonia, accompanied by a pathognomonic combination of proximal joint contractures (involving the hips, knees, and elbows) and striking distal joint hyperlaxity (hyperextensibility of the fingers, wrists, and ankles), congenital torticollis, prominent calcaneal protrusion, and progressive early respiratory failure due to severe diaphragm weakness, often requiring nocturnal non-invasive ventilation before the second decade of life.
...
\medterm{Umbilical Granuloma} The most common umbilical lesion in newborns and young infants, presenting as a soft, moist, vascular, beefy-red or pink pedunculated or sessile mass of excess granulation tissue at the base of the umbilicus after umbilical cord separation. It may produce persistent serous or serosanguineous discharge and mild local periumbilical skin irritation without signs of systemic infection or purulence (distinguishing it from omphalitis). Standard treatment is topical application of silver nitrate (with protection of surrounding skin) or topical salt application.
...
\medterm{Ungual} Pertaining to, situated near, or affecting the nail (\textit{unguis}) or the entire functional nail apparatus of a digit (comprising the hard keratinized nail plate, nail matrix, nail bed, hyponychium, eponychium, and lateral nail folds). Clinically utilized in dermatology and podiatry to describe anatomical landmarks (subungual space beneath the nail plate, periungual tissue surrounding the nail border) and pathological conditions, such as subungual hematoma (blood collection following crush injury), subungual melanoma (requiring biopsy of pigmented longitudinal melanonychia), and periungual verrucae (warts).
...
\medterm{Unicornuate Uterus} A congenital uterine malformation resulting from the complete or near-complete failure of development of one Müllerian duct, producing an elongated, banana-shaped hemi-uterus that communicates with a single fallopian tube. Frequently accompanied by a contralateral rudimentary horn (which can be cavitary or non-cavitary, communicating or non-communicating); a non-communicating cavitary horn carries a severe risk of ectopic rudimentary horn pregnancy and rupture, necessitating elective laparoscopic resection.
...
\medterm{Urea Breath Test (UBT)} A noninvasive test for active Helicobacter pylori infection: the person drinks labeled urea, and labeled carbon dioxide in exhaled breath indicates bacterial urease activity.
...
\medterm{Urinal} A specialized, portable, graduated medical receptacle made of molded medical-grade plastic, designed for bedbound, non-ambulatory, or mobility-impaired patients (particularly male patients) to void urine while remaining in bed or seated in a wheelchair without requiring full transfer to a commode or bathroom. Features an anatomically angled neck and wide opening to prevent spillage, volume graduation markings along the transparent plastic body for accurate fluid balance charting (intake and output [I\&O] monitoring), and a fitted cap to control odors and reduce surface contamination.
...
\medterm{Utero-Ovarian Ligament} A round, cord-like fibromuscular band extending from the lower, medial (uterine) pole of the ovary to the superolateral angle of the uterus (uterine cornu), immediately posterior and inferior to the insertion of the fallopian tube. Lies enclosed within the leaves of the broad ligament and anchors the ovary to the uterus without containing significant vascular structures.

\synonyms
Ovarian Ligament; Proper Ovarian Ligament

\medterm{Uterosacral Ligament} Paired strong fibromuscular condensations of pelvic endopelvic fascia extending posterolaterally from the supravaginal cervix and upper vaginal fornices, curving around the rectum, to insert into the presacral fascia overlying the second to fourth sacral vertebrae ($S_2\text{--}S_4$). Provides vital apical support to keep the cervix in its normal posterior position; represents an essential anatomical structure targeted in surgical apical suspension for uterine prolapse, and a frequent site for painful deep infiltrating endometriosis nodules.
...
\medterm{Uterus Didelphys} A congenital Müllerian anomaly resulting from the complete failure of fusion of the two paramesonephric ducts during early embryogenesis. Produces two completely separate, symmetrical uterine bodies (hemi-uteruses), each possessing its own cervix, and almost invariably accompanied by a longitudinal vaginal septum (double uterus and double vagina). Associated with an increased risk of preterm labor, malpresentation, and cesarean delivery, though fertile pregnancies can occur in either or both horns.
