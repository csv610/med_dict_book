...
\medterm{Jakob-Creutzfeldt Disease} Alternate name; see \textit{Creutzfeldt-Jakob Disease}.

\medterm{Jakob's Disease} Alternate name; see \textit{Creutzfeldt-Jakob Disease}.

\medterm{Jansen Disease} Alternate name for PTH1R-related Jansen metaphyseal chondrodysplasia, a rare inherited skeletal disorder with short-limb stature, abnormal metaphyses, and parathyroid-hormone-independent hypercalcemia; see \textit{Jansen Metaphyseal Chondrodysplasia}.

\medterm{Jansen Metaphyseal Chondrodysplasia} A rare autosomal dominant skeletal disorder caused by activating variants in \textit{PTH1R}. It causes short-limb short stature, metaphyseal bone abnormalities, joint swelling, and often hypercalcemia, hypercalciuria, or nephrocalcinosis.

\medterm{Japanese B Encephalitis} Alternate name; see \textit{Japanese Encephalitis}.

\medterm{Jaundice in Newborns (Hyperbilirubinemia)} Alternate name for neonatal jaundice caused by increased bilirubin; very early, rapidly worsening, or severe jaundice requires prompt assessment to prevent bilirubin-related brain injury.

\medterm{Jonston's Alopecia} Historical or misspelled index form for alopecia, meaning hair loss; see \textit{Alopecia}.

\medterm{JRA Juvenile Rheumatoid Arthritis} Older name for juvenile idiopathic arthritis, an inflammatory arthritis beginning in childhood; see \textit{Juvenile Idiopathic Arthritis}.

\medterm{Jumping Frenchmen of Maine} A rare historical startle disorder characterized by an exaggerated response to sudden stimuli, sometimes with involuntary jumping or other abrupt movements.

\medterm{Juvenile Diabetes} Older name for type 1 diabetes, which usually requires lifelong insulin replacement; see \textit{Type 1 Diabetes}.

\medterm{Juvenile Retinoschisis} An inherited retinal disorder, usually X-linked, in which layers of the retina split and impair central or peripheral vision; see \textit{Retinoschisis}.

\medterm{Juvenile Rheumatoid Arthritis} Older name for juvenile idiopathic arthritis, a group of inflammatory joint diseases beginning before age 16; see \textit{Juvenile Idiopathic Arthritis}.
