...
\medterm{Water Soluble Toxins} Poisons that dissolve readily in water and may spread through body fluids. Their effects and removal depend on the substance, dose, route of exposure, metabolism, kidney function, and whether a specific antidote or dialysis is useful.
...
\medterm{Wickerhamiella Pararugosa} A yeast rarely recovered from clinical samples and usually considered contamination rather than a cause of human infection. Its significance should be judged by the specimen, symptoms, repeated recovery, and immune status.
\medterm{Widal Reaction} An older blood test that looks for antibodies reacting with Salmonella Typhi or paratyphoid antigens. It has limited accuracy because antibodies may reflect past infection or vaccination, so culture or molecular testing is usually preferred.
