...
\medterm{Waddell Signs} A standardized group of physical examination signs evaluated during back assessment to identify non-organic or behavioral components contributing to lower back pain. Signs include superficial tenderness, simulation testing, distraction maneuvers, regional sensory or motor deficits inconsistent with neuroanatomy, and overreaction during examination.

\synonyms
Waddell Non-Organic Signs; Waddell Score
...
\medterm{Wait List} A list of candidates registered to receive an organ transplant. Placement and allocation priority are determined by the applicable transplant system and may consider medical urgency, expected benefit, blood or tissue compatibility, organ size, waiting time, and other policy-based factors; it is not necessarily a simple first-come, first-served queue.

\synonyms
Waiting List; Transplant Waiting List; Transplant Waitlist
...
\medterm{Waldeyer Ring} An annular anatomical arrangement of lymphoid tissue surrounding the opening of the pharynx and nasal cavity, consisting of the pharyngeal tonsils (adenoids), tubal tonsils, palatine tonsils, and lingual tonsils. It functions as the first line of immune defense against ingested or inhaled pathogens.

\synonyms
Waldeyer Lymphatic Ring; Pharyngeal Lymphoid Ring
...
\medterm{Walking Pneumonia} An informal clinical term for a mild, atypical community-acquired pneumonia (most frequently caused by \textit{Mycoplasma pneumoniae} or \textit{Chlamydia pneumoniae}), in which the patient presents with persistent dry cough, low-grade fever, and prominent radiographic interstitial infiltrates while remaining ambulatory and non-toxic.
...
\medterm{Wallenberg Syndrome} A neurological condition caused by infarction of the lateral medulla oblongata, most commonly resulting from occlusion of the posterior inferior cerebellar artery (PICA) or vertebral artery. Manifestations include ipsilateral facial sensory loss, Horner syndrome, ataxia, dysphagia, hoarseness, and contralateral loss of pain and temperature sensation in the trunk and limbs.

\synonyms
Lateral Medullary Syndrome; PICA Syndrome; Posterior Inferior Cerebellar Artery Syndrome
...
\medterm{Warburg Effect} A hallmark metabolic phenotype of malignant neoplastic cells in which cells preferentially convert glucose to lactate via aerobic glycolysis even in the presence of abundant oxygen, rather than utilizing mitochondrial oxidative phosphorylation, generating glycolytic intermediates for rapid cell proliferation.
...
\medterm{Warfarin and Superwarfarin Toxicity} Excess anticoagulation from warfarin or long-acting rodenticides, causing an elevated INR and potentially delayed bleeding, including gastrointestinal or intracranial hemorrhage. Serial coagulation testing is essential; vitamin K reverses the effect, while life-threatening bleeding may require four-factor prothrombin complex concentrate and prolonged treatment for superwarfarins.

\medterm{Warfarin-Induced Skin Necrosis} A rare, catastrophic thrombotic complication occurring 2 to 5 days after starting warfarin without heparin bridging, caused by the rapid initial decline in the short-half-life natural anticoagulant protein C before procoagulant factors fall, triggering microvascular thrombosis and cutaneous infarction in breasts, buttocks, and thighs.
...
\synonyms
wAIHA; Warm Antibody Hemolytic Anemia
...
\medterm{Wart} A usually harmless rough skin growth caused by human papillomavirus. Warts may spread by contact and often disappear over time. Common types include common, plantar, and flat warts; appearance and symptoms vary by site.
...
\medterm{Water Birth} Delivery of a baby while the birthing person remains in a tub or pool of warm water.
...
\synonyms
Aquatic Delivery; Water Labor and Birth
...
\medterm{Water Hammer Pulse} A physical sign of severe chronic aortic regurgitation or high-output states characterized by a bounding, hyperdynamic peripheral pulse with an abrupt, forceful systolic upstroke followed by a rapid, precipitous diastolic collapse.

\synonyms
Corrigan Pulse; Collapsing Pulse

\medterm{Water-Hammer Pulse} A pulse that feels forceful at first and then suddenly collapses. It is often associated with severe leakage of the aortic valve or other causes of a wide pulse pressure.

\synonyms
Corrigan's Pulse; Collapsing Pulse; Cannon Pulse
...
\medterm{Water On The Knee} Alternate name; see \textit{Swollen knee}.
...
\medterm{Watershed Infarction} An ischemic cerebral or intestinal infarct occurring at the border zones between the terminal distal capillary distributions of two non-anastomosing major arterial territories (e.g., between ACA and MCA in the brain, or at the splenic flexure / Griffiths point in the colon), provoked by systemic hypoperfusion and severe hypotension.
...
\medterm{Waterston Shunt} A historical palliative surgical systemic-to-pulmonary shunt created between the ascending aorta and the right pulmonary artery to increase pulmonary blood flow in infants with cyanotic congenital heart defects. It has largely been replaced by the modified Blalock-Taussig shunt due to lower complication rates.

\synonyms
Waterston-Cooley Anastomosis; Ascending Aorta to Right Pulmonary Artery Shunt
...
\medterm{Weber Syndrome} A brainstem stroke syndrome caused by occlusion of paramedian branches of the posterior cerebral artery affecting the anterior midbrain. It is characterized by ipsilateral oculomotor (cranial nerve III) palsy and contralateral spastic hemiparesis of the upper and lower extremities.

\synonyms
Superior Alternating Hemiplegia; Ventral Midbrain Syndrome
...
\medterm{Weight-Bearing As Tolerated} An orthopaedic postoperative rehabilitation prescription allowing the patient to place as much weight and mechanical force on an injured or operated lower extremity as is comfortable and tolerated without severe pain, typically using crutches or a walker for support.
...
\medterm{Weight-Loss Medicines} Alternate name; see \textit{Weight Loss Medications}.
...
\medterm{Weil Disease} Alternate name; see \textit{Leptospirosis}.

\medterm{Weil-Felix Reaction} A historical agglutination serological test for rickettsial infections (such as typhus and spotted fevers) that utilizes cross-reacting somatic O-antigens of \textit{Proteus vulgaris} strains (OX-19, OX-2, and OX-K) to detect serum anti-rickettsial antibodies.

\medterm{Weil-Felix Test} A classic serological agglutination assay that utilizes antigens from cross-reacting \textit{Proteus vulgaris} strains (OX-19, OX-2, OX-K) to detect serum antibodies against various \textit{Rickettsia} species responsible for typhus and spotted fever infections.

\synonyms
Weil-Felix Agglutination Reaction; Proteus Agglutination Test

\medterm{Weill-Marchesani Syndrome} A rare inherited systemic connective tissue disorder characterized by the constellation of brachydactyly (short fingers and toes), short stature, joint stiffness, microspherophakia (small spherical lenses), and ectopia lentis with high predisposition to secondary pupillary block angle-closure glaucoma. Caused by autosomal recessive mutations in \textit{ADAMTS10} or autosomal dominant mutations in \textit{FBN1}.

\synonyms
WMS; Spherophakia-Brachymorphia Syndrome
...
\medterm{Wells Score} A validated clinical prediction rule used to estimate the probability that a patient has a dangerous blood clot, specifically deep vein thrombosis (DVT) in the legs or pulmonary embolism (PE) in the lungs. By calculating points for clinical risk factors (including active cancer, recent surgery or bed rest, localized leg swelling or tenderness, fast heart rate, coughing blood, and prior clots), patients are categorized as ``unlikely'' (low risk) or ``likely'' (high risk). In low-risk patients, a normal/negative D-dimer blood test safely rules out a clot without scans; high-risk patients proceed directly to imaging (leg compression ultrasound for DVT or CT pulmonary angiography for PE).
\synonyms{Wells Criteria; Wells Clinical Score; Wells Rule for DVT and PE}

\medterm{Wells Score For Pulmonary Embolism} Alternate name; see \textit{Wells Score}.

\medterm{Wells Syndrome (Eosinophilic Cellulitis)} A recurrent inflammatory skin disorder with itchy or burning red plaques, swelling, and tissue eosinophils that can mimic bacterial cellulitis. It is not usually an infection; biopsy helps diagnosis and systemic corticosteroids may be used for severe flares.
...
\medterm{Wen} A common, usually harmless lump beneath the skin filled with a soft protein called keratin. It may become swollen, painful, or infected and can be removed if necessary.

\synonyms
Infundibular Cyst; Epidermal Inclusion Cyst; Sebaceous Wen

\medterm{Wenckebach Phenomenon} A heart-rhythm pattern in which each heartbeat takes slightly longer to pass from the upper to lower chambers until one beat is missed. It may be harmless or reflect heart disease, depending on the setting.

\synonyms
Second-Degree AV Block Type 1; Mobitz I Block

\medterm{Wens} Alternate name; see \textit{Epidermoid cyst}.
...
\medterm{Wermer's Syndrome} Alternate name; see \textit{Multiple endocrine neoplasia, type 1 (MEN 1)}.

\medterm{Wermer Syndrome} Alternate name; see \textit{Multiple endocrine neoplasia, type 1 (MEN 1)}.
...
\medterm{Wernicke Aphasia} A fluent receptive aphasic syndrome resulting from an ischemic stroke or lesion in the posterior portion of the superior temporal gyrus of the dominant hemisphere (Brodmann area 22), characterized by fluent, effortless speech that lacks semantic meaning ("word salad"), accompanied by profound impairment in language comprehension and repetition.
...
\medterm{Wernicke-Korsakoff Encephalopathy} A spectrum of neurocognitive impairment caused by severe thiamine (vitamin B1) deficiency (most commonly in chronic alcohol use disorder), progressing from the acute reversible triad of Wernicke encephalopathy (confusion, ataxia, ophthalmoplegia) to the chronic irreversible Korsakoff syndrome (anterograde amnesia, confabulation).
...
\synonyms
Wernicke's Speech Area; Sensory Speech Area
...
\medterm{Westergren Method} The reference laboratory procedure used to determine the erythrocyte sedimentation rate (ESR). Anticoagulated whole blood is placed in an upright, calibrated Westergren tube for one hour, measuring the distance in millimeters that red blood cells settle under gravity to assess systemic inflammation.

\synonyms
Westergren ESR; Westergren Sedimentation Technique
...
\medterm{Western Blot} A laboratory test that separates proteins and uses antibodies to find a specific protein. It can help study infections, immune reactions, or genetic and research problems, depending on the test.
...
\medterm{West Nile Neuroinvasive Disease} A severe, potentially fatal manifestation of mosquito-borne West Nile virus infection affecting less than 1 percent of infected individuals, presenting as aseptic meningitis, encephalitis (with tremors and parkinsonism), or acute flaccid paralysis resembling poliomyelitis (anterior horn cell loss).
...
\medterm{Wet Age-Related Macular Degeneration} Alternate name; see \textit{Wet macular degeneration}.

\medterm{Wet AMD} Alternate name; see \textit{Wet macular degeneration}.

\medterm{Wet Beriberi} The predominantly cardiovascular form of severe thiamine deficiency. It can cause a fast heartbeat, enlarged or weakened heart, fluid retention, swelling, and high-output heart failure.
...
\synonyms
Neovascular AMD; Exudative Age-Related Macular Degeneration; Wet AMD

\medterm{Wet-to-Dry Dressing} A mechanical wound debridement technique in which saline-moistened gauze is applied directly to an open wound bed, allowed to dry, and subsequently removed. Dead tissue and exudate adhering to the dried dressing are pulled away during dressing changes.

\synonyms
Wet-to-Dry Debridement; Mechanical Gauze Dressing

\medterm{Wharton Duct} The primary excretory duct of the submandibular salivary gland, approximately 5 cm in length, that courses anteromedially along the floor of the mouth to empty through the sublingual caruncle at the base of the lingual frenulum; the most frequent anatomical site of salivary sialolithiasis.
...
\synonyms
Wheat Hypersensitivity; Cereal Grain Allergy

\medterm{Wheelchairs} Alternate name; see \textit{Wheelchair}.
...
\synonyms
Cervical Acceleration-Deceleration Injury; CAD Injury; Neck Sprain

\medterm{Whiplash Injury} Alternate name; see \textit{Whiplash}.
...
\synonyms
Tropheryma Whipplei Infection; Whipple Disease
...
\medterm{Whipple Triad for Insulinoma} Three findings that support that symptoms are caused by low blood sugar: symptoms occur, blood sugar is low at the same time, and the symptoms improve when blood sugar rises. Doctors use this pattern with other tests to find the cause, including a possible insulinoma.

\medterm{Whipple Triad of Hypoglycemia} The three cardinal clinical criteria required to substantiate a clinical diagnosis of genuine hypoglycemia: symptoms and signs consistent with hypoglycemia (such as diaphoresis, tremor, tachycardia, confusion); a documented low plasma glucose concentration (typically below 55 mg/dL [3.0 mmol/L]) at the exact time of symptoms; and prompt resolution of symptoms following administration of exogenous glucose.

\synonyms
Whipple Hypoglycemic Triad
...
\medterm{Whipworm Infection} Intestinal infection caused by the soil-transmitted helminth Trichuris trichiura
...
\medterm{White Clot Syndrome} A severe arterial or venous thrombotic complication associated with heparin-induced thrombocytopenia (HIT). It is characterized by platelet-dense, fibrin-rich arterial thrombi (white thrombi) that can lead to limb ischemia, stroke, or myocardial infarction.

\synonyms
HIT-Associated Thrombosis; Heparin-Associated White Thrombus Syndrome

\medterm{White Coat Hypertension} A clinical blood pressure pattern characterized by persistently elevated blood pressure readings recorded in a medical office or clinic setting in an individual whose out-of-office automated ambulatory or home blood pressure monitoring readings are consistently normotensive.

\synonyms
White Coat Effect; Isolated Clinic Hypertension
...
\synonyms
White-Coat Syndrome; Isolated Clinic Hypertension
...
\synonyms
Anemic Infarction; Pale Infarction
...
\medterm{White Matter Hyperintensities} Areas of increased signal intensity on T2-weighted and FLAIR brain magnetic resonance imaging scans located in the deep periventricular and subcortical white matter, representing microvascular lipohyalinosis, chronic ischemia, and demyelination from cerebral small vessel disease.
...
\medterm{White Spot Disease} Alternate name; see \textit{Lichen sclerosus}.
...
\medterm{Whitlow} An infection of the fingertip or tissues around a finger or toenail, often involving the nail fold. It may be bacterial, fungal, or caused by herpes simplex virus; painful grouped blisters suggest herpetic whitlow, whereas pus and a localized abscess suggest bacterial infection.

\medterm{Whitlows} Plural of whitlow; see \textit{Whitlow}.

\medterm{WHO Classification of Vitamin A Deficiency} A standardized clinical grading system established by the World Health Organization (WHO) to stage eye damage (xerophthalmia) caused by vitamin A deficiency:
\begin{itemize}
  \item \textbf{XN}: Night blindness (inability to see in dim light or darkness).
  \item \textbf{X1A}: Conjunctival xerosis (dryness and lack of shine on the white of the eye).
  \item \textbf{X1B}: Bitot's spots (foamy, silvery-white patches on the white of the eye).
  \item \textbf{X2}: Corneal xerosis (hazy, dry surface on the clear front of the eye).
  \item \textbf{X3A}: Corneal ulceration or keratomalacia involving less than one-third of the cornea.
  \item \textbf{X3B}: Severe corneal melting (keratomalacia) involving one-third or more of the cornea, causing permanent blindness.
  \item \textbf{XS}: Corneal scars (permanent scarring left by healed ulcers).
  \item \textbf{XF}: Xerophthalmic fundus (small pale spots on the back of the eye/retina).
\end{itemize}

\synonyms
WHO Xerophthalmia Classification; Vitamin A Deficiency Eye Grading; WHO Vitamin A Staging
...
\medterm{Whole-Body Magnetic Resonance Imaging} An MRI examination that produces images of much or all of the body without using X-rays. It is used in selected cases to look for widespread disease, tumors, or problems affecting several body areas.
...
\medterm{Whole Bowel Irrigation} A gastrointestinal decontamination technique in acute clinical toxicology in which large volumes of an isosmotic polyethylene glycol electrolyte solution are administered orally or via nasogastric tube until the rectal effluent is clear, indicated for toxic ingestions of sustained-release medications, enteric-coated tablets, iron, or illicit drug packets ("body packers").
...
\medterm{Whooping-Cough} Alternate name; see \textit{Whooping Cough}.

\medterm{Whorled Pattern} A characteristic histological or clinical swirling, spiraling architectural configuration. In pathology, it describes swirling arrangements of spindle cells seen in meningiomas, fibromas, or leiomyomas; in dermatology, it describes patterns along the lines of Blaschko.

\synonyms
Whorled Architecture; Storiform-Whorled Pattern

\medterm{Wickham Striae} Fine, lacy white reticular lines and arborizing patterns seen on the surface of papules and mucosal plaques in lichen planus, classically observed on the buccal mucosa.
...
\medterm{Widal Test} A historical presumptive serological agglutination test for enteric (typhoid and paratyphoid) fever that detects agglutinating serum antibodies against the somatic O and flagellar H antigens of \textit{Salmonella enterica} serovar Typhi.
...
\medterm{Widened Mediastinum} A radiographic finding on an upright posterior-anterior chest X-ray defined as mediastinal width exceeding 8 cm (or greater than twenty-five percent of thoracic width). It warrants urgent evaluation for acute aortic dissection, mediastinal hematoma, mediastinitis, or mass lesions.

\synonyms
Mediastinal Widening; Mediastinal Enlargement

\medterm{Widened Pulse Pressure} A pulse pressure (difference between systolic and diastolic blood pressure) greater than 60 mmHg or greater than fifty percent of the systolic value. It is commonly observed in aortic regurgitation, severe arteriosclerosis, thyrotoxicosis, fever, sepsis, and arteriovenous malformations.

\medterm{Wide Splitting of S2} An abnormal prolongation of the interval between the aortic (A2) and pulmonic (P2) components of the second heart sound that varies physiologically with respiration but remains distinctly separated in expiration. It occurs due to delayed right ventricular emptying (such as right bundle branch block or pulmonary stenosis) or early aortic valve closure.

\medterm{Wilkie Syndrome} Vascular compression of the third (horizontal) segment of the duodenum between the abdominal aorta and the overlying superior mesenteric artery (SMA). It leads to partial or complete duodenal obstruction, characterized by postprandial abdominal pain, early satiety, nausea, and vomiting.

\synonyms
Superior Mesenteric Artery Syndrome; SMA Syndrome; Arteriomesenteric Duodenal Compression
...
\synonyms
Nephroblastoma; Pediatric Renal Adenosarcoma
...
\medterm{Wilson Disease} An autosomal recessive disorder usually caused by disease-causing variants in the \textit{ATP7B} gene, which encodes a protein needed to transport copper and excrete excess copper into bile. Copper accumulates in the liver and may later affect the brain, eyes, kidneys, blood, and other tissues. Manifestations include hepatitis, cirrhosis, acute or chronic liver failure, tremor, dystonia, poor coordination, speech changes, mood or behavior changes, and Kayser--Fleischer rings around the cornea.

\medterm{Wilson's Disease} Alternate name; see \textit{Wilson Disease}.

\medterm{Winchester Syndrome} A very rare inherited skeletal dysplasia with progressive osteolysis, short stature, joint contractures, and characteristic facial or skin findings. It requires genetic, orthopedic, and multidisciplinary evaluation.
\medterm{Windkessel Effect} The hemodynamic property of large elastic arteries, particularly the aorta, which expand during ventricular systole to store a portion of stroke volume and recoil during diastole. This elastic recoil sustains downstream blood flow and maintains organ perfusion throughout diastole.

\synonyms
Windkessel Function; Arterial Elastic Reservoir Effect
...
\medterm{Winged Scapula} An abnormal musculoskeletal prominence of the medial border and inferior angle of the scapula protruding posteriorly from the thoracic cage, most commonly caused by traction injury, surgical damage, or neuropathy of the long thoracic nerve of Bell paralyzing the serratus anterior muscle.

\synonyms
Scapula Alata

\medterm{Winterbottom Sign} Prominent enlargement of the posterior cervical lymph nodes that serves as a classic clinical physical sign of early-stage African trypanosomiasis (sleeping sickness), caused by Trypanosoma brucei.

\synonyms
Winterbottom's Sign

\medterm{Winter Formula} An established physiological mathematical equation used to assess whether respiratory compensation is appropriate in a patient with pure metabolic acidosis. Calculated as $\text{Expected } PaCO_2 = (1.5 \times [\text{HCO}_3^-]) + 8 \pm 2$; a measured $PaCO_2$ higher than the calculated expected range signifies a concomitant primary respiratory acidosis (ventilatory failure), whereas a measured $PaCO_2$ lower than expected indicates an accompanying primary respiratory alkalosis.

\synonyms
Winter's Compensation Formula; Acid-Base Compensation Equation

\medterm{Winter's Formula} A clinical physiological equation used to calculate expected respiratory compensation (arterial partial pressure of carbon dioxide, $\mathrm{PCO}_2$) in response to metabolic acidosis: $\mathrm{PCO}_2 = (1.5 \times [\mathrm{HCO}_3^-]) + 8 \pm 2$. If measured $\mathrm{PCO}_2$ is higher or lower than calculated, a coexisting respiratory acidosis or alkalosis is present.

\synonyms
Winter Formula; Metabolic Acidosis Compensation Formula
...
\medterm{Wirsung Duct} The main excretory duct of the pancreas, extending from the tail through the body and head of the gland, joining the common bile duct at the hepatopancreatic ampulla of Vater to empty digestive enzymes into the second part of the duodenum at the major duodenal papilla.
...
\medterm{Wisdom Tooth} The last molar in each dental quadrant, usually erupting in late adolescence or early adulthood. Impaction may cause pain, infection, or damage to adjacent teeth.

\synonyms
Dens Serotinus; Wisdom Teeth
...
\medterm{Wiskott-Aldrich Syndrome Protein} A cytoplasmic actin-regulatory protein encoded by the \textit{WAS} gene on the X chromosome that coordinates actin cytoskeleton remodeling in hematopoietic cells and immune synapse formation; loss-of-function mutations cause Wiskott-Aldrich syndrome and X-linked thrombocytopenia.
...
\synonyms
Abstinence Syndrome; Substance Withdrawal Syndrome
...
\medterm{Withdrawal Syndromes} Physical and psychological symptoms that occur when regular exposure to an addictive substance is reduced or stopped. Severity and treatment depend on the substance, duration of use, comorbidities, and risk of seizures, delirium, or autonomic instability.

\medterm{Wolff-Chaikoff Effect} An autoregulatory mechanism whereby exposure to high levels of inorganic iodide temporarily inhibits organification and thyroid hormone synthesis within the thyroid gland. This effect typically lasts about 10 to 14 days before escape occurs, preventing iodine-induced hyperthyroidism.

\synonyms
Wolff-Chaikoff Block; Iodide Organification Inhibition
...
\medterm{Wolff-Parkinson-White Accessory Pathway-Related Tachycardia} Alternate name; see \textit{Wolff-Parkinson-White syndrome}.

\medterm{Wolff-Parkinson-White Syndrome} Alternate name; see \textit{Pre-excitation syndrome}.
...
\medterm{Womb Growths} Alternate name; see \textit{Uterine fibroids}.

\medterm{Women Health} Alternate name; see \textit{Women's health}.
...
\synonyms
Gynecological and Obstetric Health; Female Health Care
...
\medterm{Wood-Unit} A clinical unit of vascular resistance calculated by dividing the pressure gradient across a vascular bed (in mmHg) by cardiac output (in L/min). One Wood unit equals approximately $80\text{ dyn}\cdot\text{s}/\text{cm}^5$, commonly used in evaluating pulmonary hypertension.

\synonyms
Wood Resistance Unit; Hybrid Resistance Unit (HRU)
...
\medterm{Woolly Hair} A rare structural anomaly of scalp hair characterized by tightly coiled, fine, spiraled curls in individuals of non-African descent. It may be inherited in autosomal dominant or recessive patterns and can occur as an isolated trait or part of syndromic disorders such as Naxos disease or Carvajal syndrome.

\synonyms
Woolly Hair Syndrome; Hereditary Woolly Hair

\medterm{Woolsorters' Disease} A form of inhaled anthrax acquired by breathing spores of \textit{Bacillus anthracis}, historically associated with handling contaminated wool or animal products. It can cause severe breathing illness and requires urgent treatment.

\synonyms
Inhalation Anthrax; Pulmonary Anthrax; Ragpicker's Disease
...
\medterm{Word Deafness} An acquired inability to understand spoken words even though ordinary hearing is intact. It usually results from damage to brain areas that connect hearing with language, such as after a stroke or head injury.

\synonyms
Pure Word Deafness; Auditory Agnosia for Speech
...
\medterm{Wound Debridement} The surgical, enzymatic, autolytic, or mechanical removal of foreign material, necrotic non-viable tissue, cellular debris, and infected slough from a wound bed to eliminate bacterial burden, reduce infection risk, and promote healthy granulation tissue formation.
...
\medterm{Wound Vacuum} A therapeutic wound management system that applies localized controlled subatmospheric (negative) pressure to a sealed wound dressing via an open-cell polyurethane foam sponge, facilitating continuous fluid drainage, reducing tissue edema, increasing microvascular blood flow, and accelerating granulation tissue formation.

\synonyms
Negative Pressure Wound Therapy; NPWT; Vacuum-Assisted Closure; VAC

\medterm{Wright Hyperabduction Test} A clinical physical examination maneuver used to assess neurovascular compression in thoracic outlet syndrome, specifically involving the pectoralis minor space and retropectoral tunnel. With the patient seated, the examiner palpates the radial pulse while passively hyperabducting and externally rotating the arm beyond 90 degrees; a substantial diminution or complete obliteration of the radial pulse accompanied by paresthesias constitutes a positive test.
...
\medterm{Wright Test} A clinical physical examination maneuver used in the assessment of thoracic outlet syndrome. The examiner palpates the radial pulse while the patient's arm is hyperabducted and externally rotated overhead; a marked diminution or obliteration of the radial pulse suggests neurovascular compression under the pectoralis minor tendon.

\synonyms
Wright Maneuver; Hyperabduction Test

\medterm{Wrinkle Test} A simple clinical bedside test to evaluate peripheral sympathetic autonomic nerve function in the digits. Denervated skin fails to develop normal physiological wrinkling when submerged in warm water for 10 to 30 minutes, indicating loss of sympathetic vasoconstrictor tone.

\synonyms
Digital Wrinkling Test; Water Immersion Wrinkle Test
...
\synonyms
Carpal Pain; Radiocarpal Joint Discomfort
...
\medterm{Wuhan Coronavirus} Alternate name; see \textit{SARS-CoV-2}.

\medterm{Wandering Rash Tongue} A common name for geographic tongue, a benign inflammatory condition in which smooth red patches with pale borders move across the tongue. It is not contagious and may cause sensitivity to spicy or acidic foods.

\medterm{Warts and Plantar Warts} Warts are noncancerous skin growths caused by human papillomavirus. Plantar warts occur on the soles of the feet and may be painful when standing or walking because pressure pushes them inward.

\medterm{Warts, Genital (Human Papillomavirus)} Soft, flesh-colored or cauliflower-like growths on the genital or anal skin caused by certain types of human papillomavirus (HPV). They are sexually transmissible; evaluation also considers other sexually transmitted infections and appropriate HPV prevention.

\medterm{WBS} Abbreviation for Williams-Beuren syndrome, a genetic disorder associated with characteristic facial features, developmental differences, cardiovascular disease, and sometimes high blood calcium.

\medterm{Weight Management} Long-term care of body weight through nutrition, physical activity, behavior change, medicines, or bariatric procedures when appropriate. Goals should account for health, function, metabolic risk, and sustainable habits rather than weight alone.

\medterm{Weir-Mitchell Disease} An older name for restless legs syndrome, a neurologic disorder causing an urge to move the legs with uncomfortable sensations that are worse at rest and in the evening and improve temporarily with movement.

\medterm{Werlhof Disease} An older name for immune thrombocytopenia (immune thrombocytopenic purpura), in which immune destruction of platelets can cause bruising, petechiae, nosebleeds, heavy menstrual bleeding, or other bleeding.

\medterm{West Nile Fever} A febrile illness caused by West Nile virus, usually transmitted by mosquitoes. Most infections cause no symptoms or a flu-like illness; a small proportion causes neuroinvasive disease such as meningitis, encephalitis, or acute flaccid paralysis.

\medterm{Whooping Cough (Pertussis)} Alternate name for whooping cough, a highly contagious respiratory infection caused by \textit{Bordetella pertussis}. Prolonged coughing fits may cause vomiting or a whoop; infants may instead have pauses in breathing.

\medterm{WHS} Abbreviation for Wolf-Hirschhorn syndrome, a rare chromosome 4 deletion disorder that may cause poor growth, distinctive facial features, developmental disability, seizures, and congenital abnormalities.

\medterm{Williams-Beuren Syndrome} Alternate name for Williams syndrome, a chromosome 7 microdeletion disorder associated with characteristic facial features, supravalvular aortic stenosis and other cardiovascular findings, developmental differences, and hypercalcemia in some people.

\medterm{Wisdom Tooth Problems} Problems involving third molars, including impaction, infection, gum inflammation, decay, cysts, or damage to nearby teeth. Pain, swelling, fever, difficulty opening the mouth, or trouble swallowing needs dental assessment.

\medterm{Wisdom Tooth Removal} Dental extraction of one or more third molars, commonly performed when they are impacted, repeatedly infected, decayed, or damaging adjacent teeth. Risks include pain, infection, bleeding, dry socket, and temporary or rarely persistent nerve symptoms.

\medterm{Wolf Hirschhorn Syndrome} Alternate spelling of Wolf-Hirschhorn syndrome, a rare disorder caused by deletion of part of chromosome 4 and associated with growth restriction, seizures, developmental disability, and distinctive facial features.

\medterm{Wolf Syndrome} Alternate name for Wolf-Hirschhorn syndrome, a chromosome 4 deletion disorder affecting growth, development, and multiple organ systems.

\medterm{WPW Syndrome} Abbreviation for Wolff-Parkinson-White syndrome, a pre-excitation disorder in which an extra electrical pathway can cause episodes of supraventricular tachycardia. Palpitations, fainting, chest pain, or severe breathlessness require prompt assessment.

\medterm{Wells Syndrome} Eosinophilic cellulitis, an uncommon inflammatory skin disorder causing itchy or burning red plaques, swelling, blisters, or a cellulitis-like eruption without typical bacterial infection. Blood eosinophilia and a skin biopsy may support the diagnosis, and recurrences are possible.

\medterm{Wolff-Parkinson-White Syndrome} A heart-rhythm disorder caused by an extra electrical connection between the atria and ventricles. It can produce episodes of supraventricular tachycardia, palpitations, dizziness, fainting, or, rarely, dangerous ventricular rhythms; catheter ablation can often eliminate the pathway.
