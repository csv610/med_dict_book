...
\medterm{Ventricular Fibrillation} A chaotic heart rhythm in which the lower chambers quiver instead of pumping blood. It causes cardiac arrest and is immediately life-threatening.
...
\medterm{Virchow Node} An enlarged, firm, non-tender left supraclavicular lymph node that receives lymphatic drainage from the thoracic duct, representing classical physical evidence of metastatic gastrointestinal adenocarcinoma (particularly gastric carcinoma) or other pelvic/abdominal malignancies.

\synonyms
Signal Node; Troisier Sign
