...
\medterm{Vitamin B1 (Thiamine)} Alternate index label; see \textit{Vitamin B1}.
...
\medterm{Vitamin B12 (Cobalamin)} Alternate index label; see \textit{Vitamin B12}.
...
\medterm{Vitamin B2 (Riboflavin)} Alternate index label; see \textit{Vitamin B2}.
