...
\medterm{VRE Infection} An infection caused by vancomycin-resistant enterococci, bacteria that commonly live in the intestine but can cause urinary-tract, wound, bloodstream, heart-valve, or other infections. Treatment depends on the infection site and susceptibility testing because usual antibiotics may not work.

\medterm{Visceral Pain} Pain arising from internal organs, often felt as pressure, cramping, aching, or poorly localized discomfort rather than sharp surface pain. It may result from stretching, inflammation, reduced blood flow, obstruction, or injury of an organ.
...
\medterm{Vocal Cord Disorders} Disorders affecting the vocal folds or their nerves, including nodules, polyps, cysts, inflammation, paralysis, spasmodic dysphonia, and paradoxical vocal-fold movement. They may cause hoarseness, voice loss, throat discomfort, noisy breathing, or difficulty breathing and swallowing.

\medterm{Vocal Cord Dysfunction} Inappropriate closing or narrowing of the vocal folds, especially during inhalation, causing sudden throat tightness, noisy breathing, cough, or shortness of breath that can resemble asthma. It is also called inducible laryngeal obstruction and needs assessment when breathing is difficult.

\medterm{Vocal Nodules} Benign callus-like growths on the vocal folds caused by repeated voice strain. They can produce hoarseness, a rough or breathy voice, vocal fatigue, and loss of range; voice therapy and reducing strain are common treatments.

\medterm{Varicose Veins (Spider Veins)} Alternate name; see \textit{Varicose Veins} and \textit{Spider Veins}.
