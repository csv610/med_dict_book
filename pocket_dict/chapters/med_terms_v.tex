...
\medterm{Vaginal Yeast Infection} Alternate index label for Vulvovaginal Candidiasis.
...
\medterm{Verruca} Alternate index label for Wart.
...
\medterm{Viral Gastroenteritis} Alternate index label for Stomach Flu.

\medterm{Viral Gastroenteritis (Stomach Flu)} Alternate index label for Stomach Flu.
