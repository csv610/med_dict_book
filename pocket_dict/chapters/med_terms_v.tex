...
\medterm{Vagal Maneuver} Physical maneuvers that stimulate parasympathetic vagal output to the sinoatrial and atrioventricular (AV) nodes via baroreceptor activation (including carotid sinus massage, Valsalva maneuver, and cold facial immersion), utilized to evaluate or abruptly terminate paroxysmal supraventricular tachycardias (PSVT).
\synonyms
...
\medterm{Vascular Endothelial Growth Factor} A key homodimeric heparin-binding signaling glycoprotein (VEGF-A) that stimulates vasculogenesis, angiogenesis, and endothelial cell permeability via VEGFR-1 and VEGFR-2 receptor tyrosine kinases, targeted by therapeutic inhibitors (e.g., bevacizumab, ranibizumab, aflibercept) in wet age-related macular degeneration and various malignancies.
\synonyms
...
\medterm{Vertebral Artery Dissection} A tear in the intimal lining of the vertebral artery leading to intramural hematoma formation and vessel stenosis or pseudoaneurysm, typically caused by cervical spine trauma, chiropractic manipulation, or connective tissue disease, presenting with acute occipital headache, neck pain, and posterior circulation ischemic stroke (lateral medullary syndrome).
\synonyms
...
\medterm{Virchow Triad} The classic pathophysiological triad of primary factors that contribute to venous thrombosis and intravascular clot formation: endothelial injury (vessel wall damage), stasis of blood flow (altered hemodynamics), and hypercoagulability (altered blood composition).
\synonyms
...
\medterm{Visual Evoked Potential} A neurophysiological diagnostic test measuring the electrical potential recorded from the occipital scalp in response to visual stimulation (e.g., checkerboard pattern reversal), used to evaluate the functional integrity and conduction velocity of the visual pathways (optic nerve, chiasm, and optic radiations), showing delayed P100 latency in optic neuritis and multiple sclerosis.
\synonyms
...
\medterm{Von Graefe Sign} An ophthalmologic physical examination sign of Graves ophthalmopathy and thyrotoxicosis characterized by 'lid lag,' in which the upper eyelid lags behind the downward movement of the globe when the patient slowly tracks an object moving from superior to inferior gaze, exposing the white sclera above the cornea.
\synonyms
