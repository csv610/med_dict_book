...
\medterm{Ebola Hemorrhagic Fever (Ebola HF)} Alternate index label; see \textit{Ebola Virus Disease}.
...
\medterm{Epinephrin (Adrenaline)} Alternate index label; the standard spelling is \textit{epinephrine}.
...
\synonyms
Dental erosion; erosive tooth wear
