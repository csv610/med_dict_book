...
\medterm{E. Coli O157:H7} Alternate name; see \textit{Escherichia Coli O157:H7}.
...
\medterm{Earwax} Alternate spelling; see \textit{Cerumen}.
...
\medterm{Eczema} Alternate name; see \textit{Atopic Dermatitis}.
...
\medterm{Edema, Pulmonary} Alternate name; see \textit{Pulmonary Edema}.
...
\medterm{EGD} Alternate name; see \textit{Esophagogastroduodenoscopy}.
...
\medterm{Root Canal Therapy} Treatment that removes infected or dead tissue from inside a tooth, cleans and seals the root canals, and restores the tooth. It can treat irreversible pulp inflammation or infection and may avoid extraction.
...
\medterm{Gynecomastia} Enlargement of breast gland tissue in a male, often from a changed balance between estrogen and testosterone. Medicines, puberty, aging, substance use, liver or kidney disease, and tumors can contribute.
...
\medterm{Splenomegaly} An increase in spleen size caused by infection, liver disease, blood-cell disorders, inflammation, or cancer. It may cause fullness or pain under the left ribs and can increase the risk of rupture or low blood counts.
...
\medterm{Enteric Fever} A severe bacterial infection of the digestive tract and bloodstream caused by \textit{Salmonella} Typhi (typhoid fever) or \textit{Salmonella} Paratyphi (paratyphoid fever), spread by swallowing food or water contaminated with feces from an infected person or carrier. Symptoms develop slowly and include a step-ladder rising fever, headache, stomach pain, constipation or ``pea-soup'' diarrhea, a slow heart rate relative to the high fever, and faint pink spots on the chest and abdomen (rose spots). In the third week of untreated illness, swollen lymph patches in the small intestine can ulcerate, causing severe internal bleeding or bowel perforation. Diagnosis is confirmed by blood or bone marrow cultures. Treatment requires specific antibiotics such as ceftriaxone or azithromycin.
...
\medterm{Epididymo-Orchitis} Acute inflammation of both the epididymis and the testicle, almost always resulting from the retrograde ascent of pathogens from the urethra, prostate, or bladder. In sexually active men under 35 years of age, it is predominantly caused by sexually transmitted pathogens (\textit{Chlamydia trachomatis} and \textit{Neisseria gonorrhoeae}); in men over 35 years, it is usually caused by enteric urinary tract bacteria (such as \textit{Escherichia coli}) secondary to urinary tract obstruction or instrumentation. Patients present with unilateral scrotal pain, erythema, swelling, dysuria, and fever. On examination, testicular elevation often relieves the discomfort (positive Prehn's sign) with an intact cremasteric reflex. Emergency color Doppler ultrasound is essential to differentiate it from testicular torsion by demonstrating increased testicular blood flow (hyperemia). Treatment includes targeted antimicrobial therapy, scrotal elevation, analgesics, and cold compresses.
...
\medterm{Dental Erosion} Gradual loss of tooth enamel or dentin caused by acids rather than bacteria. Sources include acidic foods, drinks, stomach reflux, or repeated vomiting; sensitivity and further damage can be reduced with dental care.
...
\medterm{Erythema Infectiosum} Alternate name; see \textit{Fifth Disease}.
...
\medterm{Hypersensitivity Pneumonitis} Lung inflammation caused by repeated inhalation of particles that trigger an immune reaction, such as mold, bird proteins, or contaminated farm dust. Ongoing exposure can cause cough, breathlessness, scarring, and permanent lung damage.
