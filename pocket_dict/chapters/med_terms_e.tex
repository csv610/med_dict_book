...
\medterm{Early Pregnancy Loss} Loss of a pregnancy in the first trimester, most often because of chromosomal abnormalities in the embryo. Evaluation and treatment depend on symptoms, ultrasound, bleeding, infection risk, pregnancy location, and the person’s preferences.

\medterm{Early Fetal Ultrasound, Deciding About} Alternate name; see \textit{Fetal Ultrasound}.
...
\medterm{Eating Disorder, Pica Type} Alternate name; see \textit{Pica}.
...
\medterm{Ebola Virus Infection} A severe viral infection caused by Ebola virus, characterized by fever and systemic illness that may progress to gastrointestinal symptoms, vascular leak, shock, bleeding, and multiorgan failure. Diagnosis and infection control require specialized care.

\medterm{E-D Syndrome} Alternate name; see \textit{Ehlers-Danlos Syndrome}.
...
\medterm{Eccrine Carcinoma} A rare malignant tumor arising from eccrine sweat-gland structures. It often presents as a slowly growing plaque or nodule, but may invade nearby tissue or recur; biopsy is required and treatment usually involves complete surgical removal.
...
\medterm{E. coli Infection} Alternate spelling; see \textit{E Coli Infection}.
...
\medterm{Ectodermal Dysplasia, Rapp-Hodgkin Type} A TP63-related ectodermal dysplasia characterized by abnormalities of the hair, teeth, nails, skin, and sweat glands, often with cleft lip or palate. It is also called Rapp-Hodgkin syndrome and requires individualized genetic and specialist care.
...
\medterm{Ectodermosis Erosiva Pluriorificialis} Historical name for Stevens-Johnson syndrome, a severe mucocutaneous reaction with painful skin and mucosal erosions, blistering, or peeling. Suspected cases require emergency medical assessment.
...
\medterm{Ectropion (Drooping Eyelids)} Alternate name; see \textit{Ectropion}.
...
\medterm{Edema, Idiopathic} Persistent swelling, usually of the legs, occurring without an identified heart, kidney, liver, venous, lymphatic, or medication-related cause. The diagnosis is one of exclusion and requires evaluation for more common causes before treatment.
...
\medterm{Edward's Syndrome} Alternate spelling; see \textit{Edwards Syndrome}.
...
\medterm{Effusive-Constrictive Pericarditis} A form of pericardial disease in which fluid around the heart coexists with constrictive physiology. Signs that the heart remains restricted after the fluid is drained support the diagnosis.
...
\medterm{Ekman-Lobstein Disease} Alternate name; see \textit{Osteogenesis Imperfecta}.
...
\medterm{Elbow Dislocation} Displacement of the radius and ulna from their normal alignment with the humerus, usually after a fall or forceful injury. It causes severe pain, deformity, and loss of motion and requires prompt neurovascular assessment.
...
\medterm{Electrolyte Panel} A blood test measuring selected electrolytes, commonly sodium, potassium, chloride, and bicarbonate, and sometimes related minerals. It helps assess fluid balance, kidney function, acid-base disorders, and causes of weakness or confusion.
...
\medterm{Elejalde Syndrome} A very rare autosomal-recessive neurocutaneous disorder characterized by silvery or gray hair, abnormal melanin distribution, and severe neurologic disease such as seizures, hypotonia, and developmental impairment. It requires specialist genetic and neurologic evaluation.
...
\medterm{Embryonal CNS Tumor} A highly cellular malignant pediatric CNS tumor with primitive or embryonal morphology. Diagnosis depends on integrated histologic and molecular classification, and treatment usually combines surgery, radiation when appropriate, and chemotherapy.
...
\medterm{EDMD} Abbreviation; see \textit{Emery-Dreifuss Muscular Dystrophy}.
...
\medterm{Endocrine Myopathies} Muscle disorders caused by hormonal disease, such as thyroid, adrenal, parathyroid, or pituitary dysfunction. Weakness, exercise intolerance, cramps, or muscle pain may improve when the underlying endocrine disorder is treated.
...
\medterm{Endogenous Cushing Syndrome} Hypercortisolism caused by internal overproduction of cortisol or its stimulatory hormones, including pituitary, adrenal, or ectopic sources. Features may include central weight gain, hypertension, diabetes, proximal weakness, bruising, and bone loss.
...
\medterm{Endovascular Aortic Aneurysm Repair} A minimally invasive procedure in which an expandable fabric-covered stent graft is deployed within the diseased aortic segment via femoral or iliac arterial access to exclude the aneurysm sac from systemic arterial pressure and prevent rupture.
...
\medterm{Eosinophilia-Myalgia Syndrome} A potentially severe illness characterized by intense muscle pain and increased eosinophils, historically associated with contaminated L-tryptophan supplements. It may also cause rash, swelling, nerve symptoms, breathing problems, or internal-organ injury.
...
\medterm{Eosinophilic Esophagitis Pathology} Esophageal mucosal disease with increased intraepithelial eosinophils, basal-zone hyperplasia, spongiosis, and sometimes lamina-propria fibrosis. Histologic findings are interpreted with symptoms and endoscopic features.
...
\medterm{Eosinophilic Granuloma (Pulmonary Histiocytosis X)} Historical or imprecise label; see \textit{Pulmonary Langerhans Cell Histiocytosis}.
...
\medterm{Eosinophilic Pneumonia Pathology} Lung inflammation rich in eosinophils involving alveolar spaces, interstitium, or both. Additional findings may include organizing pneumonia, edema, and eosinophilic infiltrates around vessels or airways.
...
\medterm{Epidemic Cerebrospinal Meningitis} Historical name for meningococcal meningitis, an acute bacterial infection of the membranes around the brain and spinal cord caused by \textit{Neisseria meningitidis}. It is a medical emergency requiring immediate treatment.

\medterm{Epidemic Cholera} Alternate name; see \textit{Cholera}.
...
\medterm{Epidermal Nevus Syndrome} A group of mosaic developmental disorders in which extensive or systematized epidermal nevi occur with abnormalities of the brain, eyes, skeleton, limbs, or other organs. Evaluation is guided by the distribution of the nevi and associated neurologic, ocular, or musculoskeletal findings.
...
\medterm{Epidermodysplasia Verruciformis} A rare inherited or acquired disorder of cutaneous immunity in which susceptibility to specific beta-human papillomaviruses causes persistent flat wart-like or pityriasis-versicolor-like lesions. Sun-exposed lesions can develop actinic keratosis and cutaneous squamous-cell carcinoma, so lifelong skin surveillance and sun protection are important.
...
\medterm{Epidermolysis Bullosa} A group of inherited disorders in which fragile skin blisters or tears after minor rubbing or injury because of defects in proteins that join skin layers. Severity varies; some forms heal without scars, while others cause scarring, tight joints, poor nutrition, infection, or increased skin-cancer risk.
\synonyms
Bullosa Hereditaria; Hereditary Epidermolysis Bullosa

\medterm{EB} Alternate name; see \textit{Epidermolysis Bullosa}.

\medterm{Epidermolysis Bullosa Acquisita} An uncommon autoimmune blistering disease in which antibodies target type VII collagen, a protein anchoring the epidermis to the dermis. Tense blisters and erosions develop after minor trauma, often heal with scarring or milia, and may affect mucous membranes.

\medterm{Epidermolytic Ichthyosis} An inherited keratinization disorder, usually caused by variants in KRT1 or KRT10, in which newborns may have widespread redness and superficial blistering that later evolves into thick, scaling skin and sometimes palmoplantar keratoderma.
\synonyms
...
\medterm{Epilepsy and Seizures} Alternate name; see \textit{Epilepsy}.
...
\medterm{Eruptive Vellus Hair Cysts} Benign follicular cysts containing fine vellus hairs that appear as multiple small, smooth, red-brown or skin-colored papules, often on the chest, abdomen, or limbs. They may be inherited or sporadic and usually need treatment only for symptoms or cosmetic reasons.
...
\medterm{Erythema Dyschromicum Perstans} An acquired pigmentary disorder causing slowly spreading, sharply defined gray or blue-gray macules and patches, often on the face, neck, and trunk. Early lesions may have a reddish raised border; biopsy may help distinguish it from other causes of dermal hyperpigmentation, and treatment is often difficult.
...
\medterm{Erythema Induratum} A form of nodular vasculitis causing recurrent tender, sometimes ulcerating nodules on the backs of the lower legs. Biopsy shows lobular panniculitis with vasculitis; tuberculosis and other infections, inflammatory disease, venous problems, and medicines may be associated, so the cause should be investigated.


\medterm{Erythema Infectiosum} A usually mild infection caused by parvovirus B19, also called fifth disease. A short flu-like prodrome may be followed by bright-red cheeks and a lacy rash on the trunk and limbs; adults may have joint pain, while infection can cause severe anemia in people with certain blood disorders or immunosuppression and complications in pregnancy.

\medterm{Erythema Infectiosum (Fifth Disease)} Alternate name; see \textit{Erythema Infectiosum}.
...
\medterm{Erythrocyte Alloimmunization and Pregnancy} Maternal antibodies directed against fetal red-cell antigens, commonly RhD, can cross the placenta and cause fetal or newborn hemolytic anemia. Blood-group screening, antibody testing, fetal surveillance, and preventive anti-D immunoglobulin when indicated reduce risk.
...
\medterm{Erythroderma} Intense redness, warmth, and usually scaling affecting about 90% or more of the skin. Causes include psoriasis, eczema, medicines, infection, or lymphoma; fluid and protein loss, temperature dysregulation, infection, and high-output heart failure make severe cases potentially life-threatening.
...
\medterm{Erythrokeratodermia Variabilis et Progressiva} A rare inherited keratinization disorder characterized by persistent, often symmetrical red and thickened scaly plaques together with more variable migrating erythematous patches. Onset is usually in infancy or childhood, and treatment aims to reduce scaling and inflammation with emollients, keratolytics, or specialist-directed retinoids.

\medterm{Erythroleukemia} A rare acute myeloid leukemia characterized by prominent abnormal erythroid precursors in the bone marrow, often with dysplastic or immature myeloid cells. Diagnosis requires blood and marrow evaluation with immunophenotypic and genetic classification.
...
\medterm{Esophageal Leiomyoma} A usually benign smooth-muscle tumor arising in the esophageal wall. It may cause difficulty swallowing, chest discomfort, or no symptoms and is distinguished from other submucosal tumors with imaging, endoscopy, and tissue assessment when needed.
...
\medterm{Essential Thrombocytosis} A chronic myeloproliferative neoplasm with persistent overproduction of platelets, often driven by JAK2, CALR, or MPL mutations. It can cause thrombosis, bleeding, microvascular symptoms, or splenomegaly.
...
\medterm{Estimation of Fetal Weight} An ultrasound-based estimate of fetal size using measurements such as head, abdominal, and femur dimensions. It helps assess growth and delivery planning but has an important margin of error and is interpreted with gestational age and clinical findings.
...
\medterm{Ethylene Glycol Toxicity} Toxic alcohol poisoning that progresses from inebriation to high-anion-gap metabolic acidosis and then acute kidney injury from calcium oxalate deposition. An osmolar gap, hypocalcemia, and urinary oxalate crystals may support the diagnosis; give fomepizole promptly and use hemodialysis for severe acidosis, renal failure, or significant toxic burden.
...
\medterm{Euthyroid Hyperthyroxinemia} Elevated circulating thyroxine with an otherwise euthyroid clinical state. Binding-protein changes, inherited transport abnormalities, assay interference, or medication effects can produce the laboratory pattern without true thyroid hormone excess.
...
\medterm{Evaluation of Fetal Death} Assessment after suspected or confirmed fetal death includes ultrasound confirmation, maternal examination, laboratory testing, review of medical and pregnancy history, and discussion of placental or fetal examination when appropriate. Care also addresses delivery, bleeding or infection risk, grief, and future-pregnancy planning.
...
\medterm{Ewing's Family of Tumors} Alternate name; see \textit{Ewing Sarcoma}.

\medterm{Expanded Rubella Syndrome} Alternate name; see \textit{Congenital Rubella Syndrome}.
...
\medterm{Excoriation Disorder} An obsessive-compulsive and related disorder involving recurrent skin picking that causes lesions, scarring, infection, or other tissue damage. Repeated attempts to reduce or stop the picking are unsuccessful, and the behavior causes significant distress or impairment; it is not better explained by a skin disease, substance, or another mental disorder.
...
\medterm{Exercise-Induced Anaphylaxis} A rare form of anaphylaxis triggered by physical exertion, sometimes only when exercise follows ingestion of a specific food or medicine. Symptoms may include flushing, hives, swelling, wheezing, gastrointestinal symptoms, low blood pressure, or collapse.
...
\synonyms
Exercise-Induced Asthma; Exercise-Induced Bronchoconstriction (Exercise-Induced Asthma)
...
\medterm{Exercise Prescription} An individualized physical-activity plan specifying the type, frequency, intensity, duration, and progression of exercise. It is adapted to a person's goals, fitness, medical conditions, symptoms, and safety needs.
...
\medterm{Extragonadal Germ Cell Tumors} Germ-cell tumors arising outside the ovaries or testes, commonly in the mediastinum, retroperitoneum, or central nervous system. They may be seminomatous or nonseminomatous and are evaluated with imaging, tumor markers, pathology, and assessment for a gonadal primary.
...
\medterm{Extranodal Marginal Zone Lymphoma} A usually slow-growing cancer of B lymphocytes arising in tissues such as the stomach, salivary glands, thyroid, lungs, or eye. Symptoms depend on the organ involved and treatment may include observation, infection treatment, or cancer therapy.
...
\medterm{Eye Retraction Syndrome} Alternate name; see \textit{Duane Retraction Syndrome}.
...
\medterm{Eczema, Atopic} A chronic, relapsing inflammatory skin disorder causing itch, dryness, redness, scaling, and sometimes oozing or thickening. It often begins in childhood and reflects interactions among skin-barrier dysfunction, immune activity, genes, and environmental triggers.

\medterm{EHBA} Abbreviation for extrahepatic biliary atresia, a serious infant disorder in which the bile ducts outside the liver are absent, scarred, or blocked, causing persistent jaundice and progressive liver injury.

\medterm{Encephalofacial Angiomatosis} Sturge-Weber syndrome, a congenital neurocutaneous disorder involving capillary malformations of the face and leptomeninges. It may cause seizures, glaucoma, stroke-like episodes, headaches, and developmental or visual problems.

\medterm{Epicondylitis (Tennis Elbow)} Overuse-related pain at the outer elbow, usually involving tendons that attach forearm muscles to the lateral epicondyle. Despite the name, it is generally tendinopathy rather than acute inflammation and may cause pain with gripping or wrist extension.

\medterm{Ewing’s Family of Tumors} A group of aggressive small round-cell cancers, including Ewing sarcoma of bone and soft tissue, most often affecting children, adolescents, and young adults. Treatment commonly combines chemotherapy with surgery and/or radiation.

\medterm{Eyelid Problems} Disorders affecting eyelid skin, glands, muscles, nerves, position, or movement, including blepharitis, styes, chalazia, ptosis, entropion, ectropion, and tumors. Pain, vision change, severe swelling, or sudden onset requires prompt assessment.
