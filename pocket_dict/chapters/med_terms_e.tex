...
\medterm{Edema (Historically Dropsy)} An old term for swelling caused by an abnormal buildup of fluid in body tissues or body spaces.
...
\medterm{Effective Reproduction Number (Rt)} The average number of people one infected person infects at a particular time, taking account of immunity, behavior, and control measures. Continued spread generally occurs when the number is above 1.
...
\medterm{Ejection Fraction} The percentage of blood pumped out of a heart chamber with each beat. It describes pumping strength, but a normal value does not rule out heart failure; symptoms and other tests are also needed.
