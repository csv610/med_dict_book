...
\medterm{E. Coli 0157:H7} A strain of Escherichia coli that produces Shiga toxin and can cause severe cramps, diarrhea, and bloody stools. It may lead to hemolytic uremic syndrome, especially in children; some treatments can increase complications and need medical guidance.

\medterm{E. Coli Infection} Infection caused by Escherichia coli bacteria, which may produce diarrhea, urinary infection, wound infection, or more serious abdominal or bloodstream illness depending on the strain and body site.
...
\medterm{Ear Cleaning (By A Doctor)} Removal of excess or impacted earwax by a clinician after examining the ear. Instruments, gentle suction, or irrigation may be used when safe; inserting objects at home can cause injury or push wax deeper.
...
\medterm{Ear Infection} Infection or inflammation of the ear canal or middle ear. It may cause ear pain, fever, discharge, reduced hearing, or irritability in children; treatment depends on the location, cause, severity, and age.

\synonyms
otitis.
Otitis (Ear Infection)

\medterm{Ear Infection (Middle Ear)} Infection or inflammation in the space behind the eardrum. It often follows a cold and may cause ear pain, fever, temporary hearing loss, fluid behind the eardrum, or irritability in children.

\medterm{Ear Infection - Acute} A rapid-onset infection or inflammation of the middle ear, often after a cold. It can cause ear pain, fever, reduced hearing, or a bulging eardrum; treatment depends on age, severity, and likely cause.

\medterm{Ear Infection - Chronic} Persistent or repeated infection or inflammation of the ear canal or middle ear. It may cause ongoing drainage, hearing loss, eardrum perforation, or structural damage and needs examination to identify the cause.
...
\medterm{Ear, Low-Set} An ear positioned lower on the head than usual. It may be a harmless family feature or one finding in a genetic or congenital condition, especially when other physical differences are present.
...
\medterm{Ear-Trumpet} An old hearing device shaped like a funnel that collected sound and directed it into the ear canal. It is an historical term rather than a modern medical diagnosis.


\medterm{Earache} Pain felt in or around the ear. Causes include ear infection, wax blockage, injury, dental or jaw problems, and throat disease; persistent, severe, or discharge-associated pain should be medically assessed.

\medterm{Earache (Otalgia)} Pain felt in the ear or nearby area. It may arise inside the ear or be referred from the teeth, jaw, throat, or neck; identifying the source requires an examination when pain persists or is severe.
...
\medterm{Eat} To take food into the mouth, chew, swallow, and digest it. Safe eating depends on age, health, nutrition needs, appetite, and swallowing ability; difficulty eating may lead to dehydration or poor nutrition.

\medterm{Eating Disorder} A group of mental-health conditions involving harmful eating patterns, distress about food or body shape, or both. Examples include anorexia nervosa, bulimia nervosa, binge-eating disorder, and avoidant or restrictive food intake disorder.

\medterm{Eating Disorders} Mental-health conditions involving harmful eating behaviors, distress about food or body shape, or both. They can cause malnutrition, weight changes, electrolyte problems, organ damage, and serious emotional distress but are treatable.
...
\medterm{Eating Extra Calories When Sick - Adults} Some illnesses increase energy needs or reduce appetite, making adequate calories important for healing. Foods should be nutrient-dense and adapted to symptoms; forcing food is unsafe when swallowing is difficult or vomiting persists.


\medterm{Eating Habits And Behaviors} Patterns of food choice, meal timing, appetite, restriction, overeating, and responses to hunger or emotions. These habits affect nutrition and health and may be influenced by culture, access to food, illness, or stress.

\medterm{Eating Out} Eating food prepared at a restaurant, workplace, or other place outside the home. Healthy choices may require attention to portions, nutrition, food allergies, food safety, and dietary restrictions.
...
\medterm{Ebola} A severe infection caused by Ebola viruses and spread mainly through direct contact with the blood or body fluids of an infected person or animal. It can cause fever, weakness, vomiting, diarrhea, bleeding, shock, and organ failure.
...
\medterm{Ebola Virus Disease} A severe infection caused by Ebola viruses. It may begin with fever, weakness, headache, vomiting, or diarrhea and progress to bleeding, shock, organ failure, or death; urgent isolation and specialist care are required.
...
\medterm{Ecdysone} A hormone in insects and other arthropods that controls molting and transformation into the adult form. It is mainly relevant to biology and research and is not a normal human hormone or routine human treatment.
...
\medterm{Echinocandins} A group of antifungal medicines that block formation of the fungal cell wall. They are given mainly for serious Candida infections and selected Aspergillus infections, usually by injection; liver reactions and infusion effects can occur.
...
\medterm{Echinocytes (Burr Cells)} Red blood cells with many small, evenly spaced projections around their edges. They may reflect kidney disease or an inherited blood disorder, but can also be created by improper storage or preparation of the blood sample.

\synonyms
Burr Cells

\medterm{Echinodermata} The animal group that includes starfish, sea urchins, and sea cucumbers. Some species can injure people or cause toxin exposure, but the term is mainly used in zoology and marine biology.

\medterm{Echinomycin} An experimental compound that binds DNA and can interfere with gene activity and cell growth. It has been studied as an anticancer substance but is not a routine approved treatment.
...
\medterm{Echocardiogram - Children} An ultrasound examination of a child’s heart that assesses chambers, valves, pumping movement, blood flow, and structural abnormalities without ionizing radiation. It can identify congenital defects and acquired heart disease.

\medterm{Echocardiography} Ultrasound imaging of the heart. It shows the chambers, valves, pumping action, and blood flow; the probe may scan through the chest or, for closer views, be passed into the esophagus.
...
\medterm{Echolocation} Detecting objects by producing sounds and interpreting returning echoes. Bats and some marine animals use it; the same basic principle helps explain how medical ultrasound creates images.
...
\medterm{Echothiophate Iodide} An older eye medicine that lowers pressure in glaucoma by increasing drainage of fluid from the eye. It can produce prolonged pupil constriction and dangerous whole-body cholinergic effects and is rarely used today.
...
\medterm{Eclosion} Emergence from a protective covering or developmental stage, such as hatching from an egg or leaving a pupal case. The term is mainly used in biology and is not a usual human medical diagnosis.
...
\medterm{Economy Class Syndrome} An informal term for a deep-vein clot or pulmonary embolism associated with prolonged sitting during travel. Risk is not limited to economy-class seats; movement, hydration, and individualized prevention may help.

\medterm{Ecotoxicology} The study of how chemicals, pollutants, and other environmental hazards affect plants, animals, microorganisms, ecosystems, and human health.
...
\medterm{Ectasia} Abnormal widening or dilation of a blood vessel, duct, tube, or organ. Its importance depends on the structure involved and may include a risk of bleeding, blockage, pressure, or rupture.
...
\medterm{Ectomesenchymoma} A rare cancer containing both nerve-related and connective-tissue components, usually occurring in children. Diagnosis requires microscopic examination, and treatment is planned by specialist pediatric oncology teams.

\medterm{Ectop Parasite} An organism such as a louse, flea, tick, or mite that lives on the outside of a host and feeds on blood, skin, or tissue. It may cause itching, inflammation, skin injury, or spread infection.
...
\medterm{Ectoplasm} The outer portion of the cytoplasm in some cells, especially in older descriptions of amoebas. Claims that ectoplasm is a supernatural substance have no scientific basis.

\medterm{Ectrodactyly} A birth defect in which one or more central fingers or toes are missing, leaving a deep cleft in the hand or foot. It may occur alone or with other limb or genetic differences and can affect function.

\medterm{Ectromelia} Absence or severe underdevelopment of one or more limbs present at birth. The term can also describe a viral disease of laboratory mice, so the intended meaning depends on context.
...
\medterm{Eculizumab} An antibody medicine that blocks a part of the immune system called complement. It treats selected blood, kidney, and nerve disorders but greatly increases the risk of meningococcal and other serious infections, requiring vaccination and monitoring.
...
\medterm{Edotecarin} An experimental cancer medicine designed to block topoisomerase I, an enzyme needed for copying DNA, thereby damaging rapidly dividing tumor cells.

\medterm{Edrecolomab} An experimental antibody medicine designed to recognize a protein found on some cancer cells. It was studied mainly for colorectal cancer but is not a routine standard treatment.

\medterm{Edrophonium} A short-acting medicine that increases acetylcholine, formerly used to help diagnose myasthenia gravis or reverse some muscle relaxants. It can dangerously slow the heartbeat, tighten the airways, or increase secretions and is rarely used today.
...
\medterm{Edward Syndrome} Another name for trisomy 18, a chromosome condition involving an extra copy of chromosome 18. It can cause severe developmental impairment, poor growth, feeding difficulty, heart defects, and other organ abnormalities; survival and severity vary.
...
\medterm{Edwardsiella Hoshinae} A bacterial species mainly associated with fish and aquatic environments. Human infection is rare but may occur opportunistically, especially in people with underlying illness or weakened immunity.

\medterm{Edwardsiella Ictaluri} A bacterium that causes enteric septicemia in farmed catfish. It is not a common human pathogen, although laboratory identification can distinguish it from related bacteria.
...
\medterm{Efalizumab} An antibody medicine formerly used for psoriasis by blocking immune-cell signaling. It was withdrawn because of a risk of progressive multifocal leukoencephalopathy, a rare but often fatal brain infection.

\medterm{Efaproxiral} An investigational compound designed to make hemoglobin release more oxygen to tissues. It has been studied in cancer and other settings but is not an established routine treatment.
...
\medterm{Effective Dose} A radiation-safety estimate that combines exposure to different organs into one number. It helps compare approximate risks between imaging procedures but does not predict an individual person’s exact risk.

\medterm{Effective Half-Life} The time needed for the amount of a radioactive substance in the body or a tissue to fall by half through both radioactive decay and removal by the body. It helps estimate how long radiation exposure lasts.

\medterm{Effective Reproduction Number (Rt)} The average number of people one infected person infects at a particular time, considering immunity, behavior, and control measures. Sustained spread generally occurs when the number is above 1.
...
\medterm{EGD - Esophagogastroduodenoscopy} An upper endoscopy using a flexible camera to inspect the esophagus, stomach, and duodenum. It can identify inflammation, ulcers, bleeding, or growths and can obtain tissue samples or provide selected treatment.
...
\medterm{Eggerthella Lenta} An anaerobic bacterium found in the intestine that rarely causes human infection. In vulnerable people it can enter the bloodstream or contribute to abdominal, liver, or other opportunistic infections.
...
\medterm{Ego} A historical psychoanalytic concept describing mental functions involved in decision-making, reality testing, and managing impulses. It is not a modern psychiatric diagnosis or a direct measure of a person’s mental health.
...
\medterm{Eicosadienoic Acid} A 20-carbon fatty acid with two double bonds, found in some cell membranes and studied in lipid and inflammatory pathways. It is mainly a biochemical research term rather than a routine clinical measurement.

\medterm{Eicosanoid} A signaling substance made from certain fatty acids that helps regulate inflammation, blood-vessel diameter, platelet activity, pain, and smooth-muscle contraction. Prostaglandins, leukotrienes, and thromboxanes are examples.

\medterm{Eicosanoid Degradation} Enzymatic breakdown and inactivation of eicosanoids. This limits how long and how strongly these signaling substances affect inflammation, blood vessels, platelets, airways, and other smooth muscles.
...
\medterm{Eicosapentaenoic Acid} The omega-3 fatty acid EPA, found in oily fish and some supplements. It forms part of cell membranes and can produce signaling substances that generally promote less inflammation than those made from arachidonic acid.
...
\medterm{Eicosatrienoic Acid} A 20-carbon fatty acid with three double bonds that can be part of cell membranes or serve as a precursor for biologically active lipid signals. It is mainly a biochemical research term.

\medterm{Eicosenoic Acid} A 20-carbon fatty acid with one double bond, found in some plant and marine oils. It is incorporated into dietary and cell lipids and is mainly studied in nutrition and biochemistry.
...
\medterm{Eisenmenger Complex} Severe lung-vessel disease caused by a long-standing congenital heart defect that sends excess blood to the lungs. Rising lung pressure can eventually reverse the abnormal flow and reduce oxygen in the blood.

\medterm{Eisenmenger Syndrome} Advanced lung-vessel disease caused by an untreated congenital heart opening or abnormal vessel connection. High lung pressure reverses blood flow, causing low oxygen, blue coloring, breathlessness, fainting, and complications in many organs.

\medterm{Eisenmenger'S Syndrome} Advanced lung-vessel disease caused by a long-standing congenital heart defect. Increased lung pressure reverses the abnormal blood flow and lowers blood oxygen, causing blue coloring and other complications.
...
\medterm{Ejection Fraction} The percentage of blood pumped out of a ventricle with each contraction. It helps describe heart-pumping function, but a normal value does not exclude heart failure and the result must be interpreted with symptoms, imaging, and other tests.
...
\medterm{Elbow, Cellulitis Of The} A bacterial infection of the skin and soft tissues around the elbow causing redness, warmth, swelling, pain, and tenderness. It can spread quickly or enter the bloodstream and requires prompt treatment.

\medterm{Elbow, Tip Of The} The olecranon, the bony point at the back of the elbow formed by the upper end of the ulna. It provides attachment for the triceps and can be injured or inflamed.
...
\medterm{Elderly} An older person, often defined in healthcare as age 65 or above. Older adults differ greatly in health, function, preferences, and support needs, so age alone should not determine treatment or ability.
...
\medterm{Elesclomol Sodium} An experimental anticancer compound that binds copper and may increase damaging oxidative stress inside cancer cells. It has been studied in clinical trials but is not a routine approved treatment.
...
\medterm{Elinafide} An experimental anticancer compound designed to bind DNA and interfere with cancer-cell growth. It has been studied in research trials but is not an established routine treatment.
...
\medterm{Ellagic Acid} A plant chemical found in foods such as berries, nuts, and pomegranates. It shows antioxidant effects in laboratory studies, but foods or supplements containing it have not been proved to prevent or treat a specific disease.
...
\medterm{Embolectomy} Removal of a traveling clot or other blockage from a blood vessel using surgery or a catheter. It may restore circulation in a threatened limb or selected pulmonary embolism cases; bleeding and vessel injury are possible.

\medterm{Embolectomy (Vascular)} Removal of a traveling blood clot or other blockage from a blood vessel with surgery or a catheter procedure to restore blood flow. It may be urgent when a limb or organ is threatened.
...
\medterm{Embolic Stroke} A stroke caused by a clot or other material traveling from elsewhere in the body and blocking an artery in the brain. Sudden weakness, speech trouble, facial droop, or vision loss requires emergency treatment.

\medterm{Embolic Stroke (Brain Embolism)} A stroke caused by a clot or other material traveling to and blocking an artery that supplies the brain. Emergency treatment may restore blood flow and limit permanent brain injury.
...
\medterm{Embolization (Vascular)} Intentional blockage of a blood vessel with material delivered through a catheter. It may stop bleeding, reduce blood flow to a tumor, or close an aneurysm or abnormal vessel connection.
...
\medterm{Emetine} A plant-derived alkaloid formerly used to induce vomiting and treat some protozoal infections. It can damage the heart and muscles, especially at high doses, and is not routinely used today.
...
\medterm{Emitefur} An experimental anticancer compound related to fluoropyrimidine medicines. It interferes with processes needed to make DNA and RNA but may also injure healthy rapidly dividing cells and is not a routine treatment.
...
\medterm{Empedobacter} A group of environmental bacteria that rarely infect people. When infection occurs, it is usually in someone with serious illness, a wound, a medical device, or weakened immune defenses.

\medterm{Empedobacter Brevis} An environmental bacterium that rarely causes human infection. It may act opportunistically in people with serious illness or weakened immunity and is identified by laboratory testing.

\medterm{Empedobacter Falsenii} An environmental bacterium rarely associated with opportunistic human infection. Its significance depends on the specimen, symptoms, repeated isolation, and the person’s immune status.
...
\medterm{Emphysematous Aortitis Due To Clostridium Septicum} A rare, life-threatening infection of the aortic wall that produces gas within the artery. It may cause severe back or abdominal pain, sepsis, bleeding, or an abnormal connection with the intestine and needs emergency treatment.
...
\medterm{Enclomiphene} An investigational medicine studied to stimulate the body’s own testosterone production in selected men with low testosterone. Its effectiveness and long-term safety depend on clinical evidence and remain under evaluation.
...
\medterm{Encopresis} Repeated soiling or passage of stool in inappropriate places by a child old enough to use the toilet. It is often related to long-term constipation and retained stool but may have other medical or emotional contributors.
...
\medterm{End-Stage COPD: Signs, Symptoms, And Prognosis} Advanced COPD may cause severe breathlessness, limited activity, frequent flare-ups, weight loss, low oxygen, or respiratory failure. Outlook varies; treatment may include inhaled medicines, rehabilitation, oxygen when indicated, advance planning, and comfort-focused care.
...
\medterm{Endamoeba} An older biological name for certain amoebas living inside animals. It is uncommon in modern medical writing, and its significance depends on the specific species identified.
...
\medterm{Endocardial Cushion Defect} A birth defect in which the central part of the heart and the valves between its chambers do not form normally. It can allow abnormal blood flow and cause heart failure, lung-vessel disease, poor growth, or breathing difficulty.
...
\medterm{Endocarditis} Infection or inflammation of the heart’s inner lining, usually involving a valve. It can cause fever, fatigue, a new or changed murmur, stroke or other emboli, valve destruction, heart failure, and death without prompt treatment.
...
\medterm{Endocrine System} The network of glands and hormone-producing tissues that release chemical messengers into the blood. These hormones regulate growth, metabolism, reproduction, stress, sleep, blood pressure, and fluid balance.
...
\medterm{Endocytosis} The process by which a cell takes material inside by folding its outer membrane around it and forming a small internal sac. Cells use it to absorb nutrients, remove particles, and regulate surface receptors.
...
\medterm{Endodontic Therapy (Root Canal)} Treatment that removes infected or dead tissue from inside a tooth, cleans and seals the root canals, and restores the tooth. It can treat irreversible pulp inflammation or infection and may avoid extraction.
...
\medterm{Endogenous Retrovirus} A DNA sequence in the human genome inherited from an ancient retrovirus that infected a reproductive cell. Most are inactive, although some can influence gene regulation or normal development.
...
\medterm{Endometrial Receptivity Analysis} A test that examines gene activity in a sample of the uterine lining to estimate when it may best support embryo implantation. Its ability to improve pregnancy rates is uncertain, so results should be interpreted by a fertility specialist.
...
\medterm{Endometriosis} A chronic inflammatory condition in which tissue resembling the uterine lining grows outside the uterus. It may cause painful periods, pelvic pain, pain during sex, infertility, bowel or bladder symptoms, scar tissue, or ovarian cysts; some people have no symptoms.
...
\medterm{Endomorph} An old body-build label describing a relatively round shape or tendency to store body fat. It is not a medical diagnosis and does not reliably predict health, metabolism, or body composition.
...
\medterm{Endothelin Receptor Antagonists} Medicines that block endothelin signals and relax or prevent narrowing of lung blood vessels. They are used for selected pulmonary arterial hypertension; liver injury, anemia, swelling, and serious fetal harm are important risks.
...
\medterm{Enervate} To weaken, exhaust, or reduce strength and energy. It is a descriptive word rather than a specific medical diagnosis.

\medterm{Enflurane} An inhaled anesthetic formerly used to maintain general anesthesia. It is now uncommon and can affect breathing, blood pressure, heart rhythm, and brain activity, especially at excessive concentrations.
...
\medterm{Eniluracil} An investigational medicine that blocks breakdown of uracil and changes how fluoropyrimidine cancer medicines are processed. It has been studied to improve cancer treatment but is not a routine treatment.
...
\medterm{Enlarged Breasts In Men (Gynecomastia)} Enlargement of breast gland tissue in a male, often from a changed balance between estrogen and testosterone. Medicines, puberty, aging, substance use, liver or kidney disease, and tumors can contribute.
...
\medterm{Enlarged Liver} Alternate index label; see \textit{Hepatomegaly}.

\synonyms
Liver, Enlarged

\medterm{Enlarged Prostate} Increase in prostate size, usually from benign growth, that can press on the urethra and cause a weak stream, hesitancy, frequent or urgent urination, nighttime urination, incomplete emptying, or retention.
...
\medterm{Enlarged Spleen (Splenomegaly)} An increase in spleen size caused by infection, liver disease, blood-cell disorders, inflammation, or cancer. It may cause fullness or pain under the left ribs and can increase the risk of rupture or low blood counts.
...
\medterm{Enrichment} Adding nutrients to food after processing removed some of them. Enriched flour, for example, commonly has certain B vitamins and iron added back to help prevent nutritional deficiencies.
vitamins.
...
\medterm{Enteric-Coated} Covered with a protective layer that resists breakdown in the stomach and dissolves in the small intestine. This can protect the stomach or protect a medicine from stomach acid; such tablets should not usually be crushed.
...
\medterm{Enterobacter Asburiae} A Gram-negative bacterium found in the environment that rarely causes opportunistic human infection. When it does, illness may affect the urine, lungs, wounds, abdomen, or bloodstream in vulnerable people.

\medterm{Enterobacter Cancerogenus} A Gram-negative environmental bacterium that rarely causes human infection. It may infect a wound, urinary tract, lungs, abdomen, or bloodstream, especially in seriously ill people or those with medical devices.
...
\medterm{Enterococcus Avium} A species of intestinal bacteria that rarely causes human infection. In vulnerable people it may infect the urine, wounds, abdomen, bloodstream, or heart valves.

\medterm{Enterococcus Dispar} A rarely encountered Enterococcus species identified mainly in microbiology studies or clinical specimens. Its significance depends on repeated isolation, symptoms, the specimen site, and the person’s health.
...
\medterm{Enterococcus Gallinarum} An Enterococcus species that naturally has low-level resistance to vancomycin and can rarely cause human infection. It may affect the bloodstream, urine, wounds, or other sites in vulnerable people.

\medterm{Enterococcus Hirae} A rarely encountered intestinal bacterium that can cause opportunistic infection in seriously ill or immunocompromised people. Reported infections include bloodstream, urinary, wound, and heart-valve infections.

\medterm{Enterococcus Malodoratus} A rarely encountered Enterococcus species that can occasionally cause opportunistic infection, especially in people with serious illness, weakened immunity, or invasive devices. Its significance depends on the specimen and symptoms.

\medterm{Enterococcus Mundtii} An uncommon Enterococcus species that can rarely cause human infection, usually in vulnerable people. Clinical significance depends on the body site, symptoms, repeated isolation, and laboratory identification.

\medterm{Enterococcus Pseudoavium} A rarely encountered Enterococcus species that may occasionally cause opportunistic infection in people with weakened immunity or serious illness. Laboratory identification helps distinguish it from related bacteria.

\medterm{Enterococcus Raffinosus} An Enterococcus species that rarely causes infection, usually in seriously ill people or those with devices or weakened immunity. Resistance to several antibiotics can occur, so laboratory susceptibility testing guides treatment.

\medterm{Enterococcus Thailandicus} A rarely encountered Enterococcus species that may occasionally cause opportunistic human infection. Accurate laboratory identification is important because it resembles related bacteria and treatment depends on susceptibility testing.
...
\medterm{Enterohepatic Circulation} Movement of a substance from the liver into bile and intestine and then back to the liver through the gut and bloodstream. This recycling can prolong the effects of some medicines and body chemicals.
...
\medterm{Entinostat} An experimental medicine that blocks histone deacetylase enzymes and can change gene activity. It has been studied alone and with other cancer treatments but is not a routine approved therapy.
...
\medterm{Enucleation} Surgical removal of the eyeball while leaving the eyelids, eye muscles, and most tissues of the eye socket in place. It may be needed for severe injury, painful blind eye, or certain eye cancers.

\medterm{Enucleation Procedure} Surgery to remove the eyeball while preserving the eyelids and most of the eye socket. A space-occupying implant may be placed; pain, infection, bleeding, movement differences, and emotional effects are possible.
...
\medterm{Enuresis (Bedwetting)} Repeated wetting during sleep in a child old enough to remain dry. It may be lifelong or recur after a dry period; assessment considers constipation, infection, diabetes, sleep, development, stress, and urinary symptoms.
...
\medterm{Enzootic} Regularly present or persistently maintained in a particular animal population or region. It is the animal-population equivalent of endemic disease and may matter when infections can spread from animals to people.
...
\medterm{Eosine Yellowish} A red or pink laboratory dye used to stain cells and tissues, often with hematoxylin. It is mainly a histology term; health effects depend on the product and the route and amount of exposure.
...
\medterm{Eosinophil Count - Absolute} The number of eosinophils in a given volume of blood, calculated from the total white-cell count and eosinophil percentage. A high count may occur with allergy, parasites, medicines, autoimmune disease, or blood disorders.
...
\medterm{Eosinophilic Granuloma} A localized form of Langerhans-cell disease in which abnormal immune cells accumulate, often in bone or skin. Bone lesions can cause pain, swelling, or fractures and may require imaging and tissue examination.

\medterm{Eosinophilic Granulomatosis With Polyangiitis} A rare blood-vessel inflammation associated with asthma and high eosinophils. It can damage the lungs, skin, nerves, heart, kidneys, or digestive organs and requires specialist treatment.
...
\medterm{Ependymoblastoma} A rare, aggressive childhood brain tumor made of primitive cells. Microscopic and molecular testing determines its current classification, prognosis, and treatment.
...
\medterm{Ephrins} Cell-surface proteins that bind Eph receptors and guide cell position, nerve-fiber growth, blood-vessel development, and tissue organization during development and disease.

\medterm{Epiblast} A layer of cells in the early embryo that forms the three main embryonic layers and ultimately gives rise to most body tissues.
...
\medterm{Epidural Anaesthesia} Regional anesthesia produced by injecting numbing medicine into the epidural space near the spinal nerves. It reduces pain while the person may remain awake; low blood pressure, headache, infection, or nerve injury can rarely occur.
...
\medterm{Epidural Block - Pregnancy} Regional anesthesia delivered through a small catheter in the lower back to numb pain during labor or a cesarean birth while the parent remains awake. Temporary low blood pressure, itching, fever, headache, incomplete numbness, or infection can occur.
...
\medterm{Epigallocatechin Gallate} A chemical in green tea and some supplements that has antioxidant effects in laboratory studies. High-dose extracts can injure the liver, and benefits for most diseases have not been established.
...
\medterm{Epigastrium} The upper middle region of the abdomen, between the right and left upper abdominal areas and above the navel.
...
\medterm{Epigenomics} The study of gene-regulating chemical changes across the genome and how they influence development, disease, environmental responses, and response to treatment.
...
\medterm{Epilepsy} A brain disorder causing a lasting tendency to have unprovoked seizures. Seizures may begin in one area or involve both sides of the brain; causes include genetic, structural, metabolic, infectious, immune, or unknown factors.
...
\medterm{Epilepsy In Children} A brain disorder causing recurrent unprovoked seizures or a recognized seizure syndrome in a child. Causes, seizure types, development, treatment, and outlook vary widely and require age-appropriate neurologic assessment.
...
\medterm{Epilepticus, Status} A seizure lasting five minutes or longer, or repeated seizures without recovery of awareness between them. It is a medical emergency because prolonged seizures can injure the brain and body.
...
\medterm{Epinephrin (Adrenaline)} Another spelling of epinephrine, a hormone and emergency medicine that increases heart activity, opens the airways, and narrows many blood vessels. It is used for anaphylaxis and selected life-threatening conditions.

\synonyms
Adrenaline

\medterm{Epinephrine} A hormone, neurotransmitter, and emergency medicine that increases heart rate and pumping, opens the airways, and narrows many blood vessels. It is essential treatment for anaphylaxis and used in selected emergencies.
\synonyms
Adrenaline

\medterm{Epinephrine (Adrenaline)} A hormone and neurotransmitter released during stress that increases heart activity, opens the airways, and narrows many blood vessels. As a medicine, it treats anaphylaxis and selected cardiac or breathing emergencies.
...
\medterm{Epistaxis} Bleeding from the nose, usually from fragile blood vessels near the front of the nasal septum. Dryness, nose picking, injury, infection, medicines, or high blood pressure may contribute; persistent or heavy bleeding needs medical care.
...
\medterm{Epitope Mapping} Laboratory methods used to identify the parts of an antigen recognized by antibodies or immune cells. The results help explain immune responses and support development of vaccines, diagnostic tests, and antibody-based treatments.

\medterm{Epizootic} An outbreak in which many animals in a population or area develop the same disease during a limited period. Some animal infections can spread to people, so control may protect both animal and human health.
...
\medterm{Epoprostenol} A short-acting medicine resembling prostacyclin that widens lung blood vessels and reduces platelet clumping. Continuous intravenous infusion treats severe pulmonary arterial hypertension; interruption can cause rapid worsening.

\medterm{Epothilon} A family of compounds that stabilize microtubules, structures needed for cell division. They have been studied as cancer medicines, but an individual compound’s approval, effectiveness, and safety depend on clinical evidence.
\medterm{Epothilone B} A compound that stabilizes microtubules and can stop dividing cells. It has been investigated as an anticancer medicine; research use does not mean that it is an approved or routinely available treatment.

\medterm{Epothilone D} A compound that stabilizes microtubules, which can interfere with cancer-cell division. It has been studied experimentally, but its clinical usefulness and safety require evidence from well-designed human trials.

\medterm{Epoxide Hydrolase} An enzyme that converts reactive epoxide chemicals into less reactive substances by adding water. It helps process some medicines, toxins, and natural fats and can influence chemical effects and tissue injury.
...
\medterm{Erdheim-Chester Disease} A rare disorder in which abnormal immune cells accumulate in tissues. It commonly affects the long bones and may involve the kidneys, heart, blood vessels, lungs, brain, or tissues behind the abdominal lining.

\medterm{Erdheim–Chester Disease} A rare disorder in which abnormal immune cells accumulate in tissues. It commonly affects both sides of the long bones and may involve the kidneys, heart, blood vessels, lungs, brain, or tissues behind the abdominal lining.

\medterm{Erectile Disorder} A persistent or recurring inability to achieve or maintain an erection firm enough for satisfactory sexual activity, causing distress. Causes may include blood-vessel, nerve, hormonal, medication-related, psychological, or relationship factors.
...
\medterm{Erection Problems} Difficulty getting or keeping an erection firm enough for sexual activity. Causes include blood-vessel disease, diabetes, nerve or hormonal disorders, medicines, stress, depression, anxiety, or relationship problems; persistent symptoms deserve evaluation.
...
\medterm{Erosion (Tooth)} Gradual loss of tooth enamel or dentin caused by acids rather than bacteria. Sources include acidic foods, drinks, stomach reflux, or repeated vomiting; sensitivity and further damage can be reduced with dental care.
...
\medterm{Erythroblastosis Fetalis} A condition in which maternal antibodies destroy a fetus’s or newborn’s red blood cells. It can cause anemia, jaundice, fluid swelling, heart failure, or death and is often prevented by pregnancy blood-group screening and preventive treatment.

\medterm{Erythroblastosis Foetalis} Severe destruction of fetal or newborn red blood cells by maternal antibodies. The resulting anemia can cause jaundice, fluid accumulation, heart failure, or death without monitoring and treatment.
...
\medterm{Erythrocyte Enzyme Deficiency} An inherited or acquired lack of an enzyme that red blood cells need for energy or protection. Cells may break down too early, causing hemolytic anemia; examples include G6PD and pyruvate-kinase deficiency.
...
\medterm{Erythrocyte Sedimentation Rate} A blood test measuring how quickly red blood cells settle in a tube over one hour. It is a nonspecific sign of inflammation and must be interpreted with symptoms and other tests; anemia, age, pregnancy, and other factors affect it.
...
\medterm{Erythropoiesis-Stimulating Agents} Medicines that stimulate the bone marrow to make red blood cells. They are used for selected anemias, including some caused by kidney disease or cancer treatment, but may increase blood pressure and clot risk.
...
\medterm{Erythropoietin Deficiency} Too little erythropoietin or an inadequate response to it, causing the bone marrow to make too few red blood cells. It commonly contributes to anemia in chronic kidney disease.
...
\medterm{ESBL} An enzyme made by some bacteria that breaks down many penicillin and cephalosporin antibiotics. ESBL-producing infections are harder to treat and require laboratory susceptibility testing to select effective antibiotics.
...
\medterm{Eskimo Lung} An outdated or nonstandard term whose meaning is unclear without its source. It should not be used as a diagnosis; the specific lung finding or disease should be named instead.
...
\medterm{Esophageal PH Monitoring} A test that records acid exposure in the esophagus, usually for 24 hours, using a small tube or wireless sensor. It helps determine whether reflux explains persistent symptoms when the diagnosis is uncertain.
...
\medterm{Esophageal Stricture - Benign} A noncancerous narrowing of the esophagus that can cause food to stick, regurgitation, or difficulty swallowing. Reflux, caustic injury, inflammation, radiation, and procedures may cause it; endoscopy can diagnose and widen the narrowed area.
...
\medterm{Esophagectomy - Minimally Invasive} Removal of part or all of the esophagus through small chest or abdominal openings, sometimes with robotic instruments, followed by reconstruction. It may reduce wound injury but still carries substantial risks such as leakage, infection, and breathing problems.

\medterm{Esophagectomy - Open} Removal of part or all of the esophagus through larger chest, abdominal, or neck incisions, followed by reconstruction. It is used for selected disease and may cause leakage, infection, breathing problems, swallowing changes, or nutritional difficulties.

\medterm{Esophagitis} Inflammation or injury of the esophageal lining. Reflux, infection, medicines, allergies, swallowed irritants, or radiation may cause painful swallowing, heartburn, chest pain, or bleeding.
...
\medterm{Esophagogastroduodenoscopy} An examination of the esophagus, stomach, and first part of the small intestine using a flexible camera passed through the mouth. It can identify disease, stop some bleeding, remove objects, widen narrowing, and collect tissue samples.
...
\medterm{Esophagus (Esophagus)} The muscular swallowing tube connecting the throat to the stomach, about 25 centimeters long in adults. Its coordinated contractions move food downward, and its lower valve helps prevent stomach contents from flowing backward.
...
\medterm{Esterification} A chemical reaction that joins an acid and an alcohol to form an ester, usually producing water as a by-product. The reaction is used in medicines, laboratory testing, food chemistry, and industrial materials.
...
\medterm{Esthetician} A person trained to provide cosmetic skin-care services such as cleansing, waxing, or superficial treatments. Estheticians do not diagnose disease or perform medical procedures unless they hold the required additional license.
...
\medterm{Estimated Glomerular Filtration Rate} An estimate of how well the kidneys filter blood, calculated mainly from blood creatinine and other factors. It helps assess chronic kidney disease and adjust medicines but is less reliable during rapidly changing illness or unusual body size.

\medterm{Estivation} A period of reduced activity or dormancy that helps some animals survive hot or dry conditions. The term is mainly biological rather than a human medical diagnosis.
...
\medterm{Estrus} The phase of an animal’s reproductive cycle when the female is sexually receptive and ovulation may occur. The timing and signs differ among species.
...
\medterm{Etanidazole} An experimental nitroimidazole compound studied as a radiation-sensitizing cancer treatment. It is not a routine approved medicine in many settings, and its usefulness and risks depend on clinical-trial evidence.

\medterm{Etaracizumab} An investigational antibody designed to block an integrin involved in blood-vessel formation and tumor spread. It has been studied in cancer research but is not a standard treatment outside appropriate clinical trials.
...
\medterm{Ethambutol} An antibiotic used with other medicines to treat tuberculosis and selected mycobacterial infections. It can damage the optic nerve, causing blurred vision or difficulty distinguishing colors, so vision testing and dose adjustment are important.
...
\medterm{Ethchlorvynol} An older sedative medicine formerly used for insomnia. It can slow brain activity and breathing, impair coordination, cause dependence, and produce dangerous overdose; it is rarely used today.
...
\medterm{Ethidium} A laboratory dye that can bind to DNA and fluoresce under particular light. Ethidium compounds are useful for detecting genetic material but may be hazardous, so laboratory handling and disposal precautions are required.
...
\medterm{Ethyl Methanesulfonate} A laboratory chemical used to create mutations in experimental organisms and cells. It can damage DNA and is harmful if inhaled, swallowed, or absorbed through skin. Laboratory handling requires appropriate containment and protective equipment; suspected exposure should be assessed by poison-control or occupational-health services.
...
\medterm{Ethylenethiourea} An industrial chemical used in making rubber and in some fungicides. Exposure can affect the thyroid and may be harmful to reproduction or development in experimental studies. People exposed at work should follow safety controls and obtain occupational-health advice after significant contact.
...
\medterm{Etiocholanolone} A breakdown product of steroid hormones, especially male hormones, sometimes measured in endocrine testing or studied in research about hormone metabolism.
...
\medterm{Etretinate} An oral vitamin-A-related medicine formerly used for severe psoriasis. It remains in body fat for a long time and can cause severe birth defects, so pregnancy must be avoided for an extended period after exposure.
...
\medterm{Eubacterium Ventriosum} A bacterium that may live in the human intestine without causing disease. It rarely causes opportunistic infection, mainly in people with serious illness, weakened immunity, or damaged body barriers.
...
\medterm{Euglena} A group of single-celled organisms found mainly in water. They are studied in biology and are not normally human pathogens, although health significance depends on the specific species and exposure.

\medterm{Eukaryote} An organism whose cells contain a membrane-bound nucleus and other enclosed structures. Humans, animals, plants, fungi, and many single-celled organisms are eukaryotes.

\medterm{Eukaryotic Cell} A cell containing a membrane-bound nucleus and specialized internal structures. Human, animal, plant, fungal, and many protist cells are eukaryotic and can carry out complex, organized functions.

\medterm{Eunuch} A historical term for a person assigned male at birth who was castrated, often referring to social roles in past societies. It is not a current medical diagnosis; specific anatomy or hormone status should be described instead.
...
\medterm{Europium} A rare-earth chemical element used in electronics, lighting, and research. Health effects depend on the compound and exposure route; dust or soluble compounds may irritate tissues or cause toxicity.

\medterm{Eurotium} A group of environmental molds in the Aspergillus family that can grow in dry, salty, or sugary materials. They are mainly environmental organisms, but mold exposure may matter to people with allergy or weakened immunity.
...
\medterm{Euthyroid Sick Syndrome} Temporary changes in thyroid blood tests during severe illness, starvation, or major surgery without primary thyroid disease. Treatment usually focuses on the underlying illness rather than thyroid hormone unless a separate thyroid disorder is present.
...
\medterm{Evans Syndrome} A rare autoimmune disorder in which the immune system destroys red blood cells and platelets, at the same time or at different times. It can cause anemia, jaundice, bruising, bleeding, or blood clots.
...
\medterm{Ewingella} A group of environmental bacteria that rarely infect humans. Reported infections may affect blood, lungs, wounds, or eyes, usually in people with serious illness or weakened immunity; laboratory results require clinical correlation.

\medterm{Ewingella Americana} A rare environmental bacterium that can occasionally cause infection, usually in people with serious underlying illness or weakened immunity. The significance of finding it depends on the specimen, symptoms, and repeated testing.

\medterm{Ewings Sarcoma} A rare aggressive cancer of bone or soft tissue, usually affecting children, teenagers, or young adults. It often has a characteristic gene rearrangement and can cause pain, swelling, fever, or fracture.
...
\medterm{Exaggerated Placental Site} A benign overgrowth of pregnancy-related cells where the placenta attaches to the uterus. It can resemble a pregnancy-related cancer under the microscope, so diagnosis requires careful tissue examination and clinical context.
...
\medterm{Exatecan Mesylate} An investigational cancer compound related to camptothecin that blocks an enzyme needed for DNA copying and repair. It is not a routine treatment and may also injure healthy rapidly dividing cells.
...
\medterm{Excessive Crying In Infants} Prolonged or difficult-to-soothe crying in a baby. Colic is common, but pain, illness, injury, hunger, reflux, or feeding problems can also cause it; urgent care is needed if the baby is weak, feverish, or breathing poorly.
...
\medterm{Excessive Or Unwanted Hair In Women} More hair growth than expected or hair in unwanted areas. Coarse facial or body hair may reflect androgen excess, while generalized excess hair can result from medicines, inherited traits, or other conditions.
...
\medterm{Excoriation Disorder} A mental-health disorder involving repeated skin picking that causes wounds, distress, or interference with daily life. People often try to stop but cannot; behavioral therapy and sometimes medicine can help.
...
\medterm{Exercising And Asthma At School} Planning that allows a student with asthma to exercise safely, including a written action plan, prescribed reliever medicine, warm-up, symptom recognition, and staff guidance for emergencies.

\medterm{Exercising On A Budget} Safe physical activity using low-cost options such as walking, stairs, home strength exercises, or community facilities. The type and intensity should fit health status, fitness, surroundings, and injury risk.
...
\medterm{Exhaled Nitric Oxide} A breath test estimating eosinophil-related airway inflammation. A raised result can support asthma assessment and predict steroid responsiveness, but smoking, infection, allergies, and current treatment can affect interpretation.
...
\medterm{Exhibitionistic Disorder} A mental-health disorder involving repeated sexual arousal from exposing the genitals to an unsuspecting person, with action on the urges or significant distress or impairment. Treatment may include specialized psychotherapy and carefully selected medicines.
...
\medterm{Exiguobacterium} A group of bacteria found in soil, water, and harsh environments. Human infection is rare and usually opportunistic; the significance of a laboratory result depends on symptoms and the specimen source.
...
\medterm{Exocrine Pancreatic Insufficiency} Failure of the pancreas to release enough digestive enzymes, causing poor digestion and absorption. It may lead to greasy stools, bloating, weight loss, and vitamin deficiency; pancreatic enzyme replacement and nutritional care may help.
...
\medterm{Exocrine Pancreatic Insufficiency EPI} A condition in which too few pancreatic digestive enzymes reach the intestine. It can cause greasy stools, bloating, weight loss, and deficiencies of fat-soluble vitamins; treatment often includes enzyme replacement and nutritional monitoring.

\synonyms
Exocrine Pancreatic Insufficiency (Exocrine Pancreatic Insufficiency EPI)

\medterm{Exocytosis} The process by which a cell releases substances when small internal sacs join the cell membrane and empty their contents outside. Cells use it to release hormones, neurotransmitters, digestive enzymes, and other proteins.

\medterm{Exodeoxyribonuclease} An enzyme that removes DNA building blocks from the end of a DNA strand. It helps copy, repair, or break down DNA in cells and is also used in genetic laboratory methods.
...
\medterm{Exonuclease} An enzyme that removes genetic building blocks one at a time from the end of a DNA or RNA strand. It participates in genetic-material repair, copying, breakdown, and laboratory testing.

\medterm{Exopeptidase} An enzyme that removes amino acids from the end of a protein or peptide chain. Digestive exopeptidases help break dietary proteins into smaller units that the intestine can absorb.
...
\medterm{Exophiala Dermatitidis} A darkly pigmented yeast found in the environment that can rarely cause skin, lung, or brain infection, mainly in people with weakened immunity. Diagnosis requires culture or other laboratory identification.
...
\medterm{Exophthalmos} Forward bulging of the eyeball, most often from thyroid eye disease. Inflammation and swelling behind the eye can cause dryness, pain, double vision, difficulty closing the eyelids, or vision-threatening pressure.
...
\medterm{Experience Sampling} A research method that asks people to report briefly on their activities, symptoms, thoughts, or feelings at selected times. It captures experiences close to when they occur and reduces reliance on later recall.
...
\medterm{Expressed Sequence Tag} A short DNA sequence copied from messenger RNA that helps identify or locate a gene being used by a cell. It is mainly a research tool for studying gene activity and genome structure.
...
\medterm{External Cephalic Version} A procedure in which a clinician applies pressure to the pregnant abdomen to turn a breech or sideways fetus head-down. It is performed with monitoring because contractions, bleeding, or fetal distress can rarely occur.
...
\medterm{Extraocular Muscles} Six muscles outside each eyeball that move it: four straight muscles and two oblique muscles. Their coordinated action allows looking up, down, inward, outward, and rotating the eyes.
...
\medterm{Extravasation} Leakage of urine from the urinary tract into surrounding tissues, usually after injury, surgery, or blockage. It can cause pain, swelling, infection, or tissue damage and may require drainage, a catheter, or repair.
...
\medterm{Extrinsic Allergic Alveolitis (Hypersensitivity Pneumonitis)} Lung inflammation caused by repeated inhalation of particles that trigger an immune reaction, such as mold, bird proteins, or contaminated farm dust. Ongoing exposure can cause cough, breathlessness, scarring, and permanent lung damage.
...
\medterm{Extroversion} Outward turning of a body structure, sometimes used interchangeably with eversion. In psychology, extroversion describes a tendency toward social engagement and outward-focused activity.
...
\medterm{Eye - Foreign Object In} Material lodged on or inside the eye, such as dust, metal, glass, or a contact-lens fragment. Do not rub or remove an embedded object; cover the eye and seek urgent medical care.

\medterm{Eye Allergy} An immune reaction to allergens causing itchy, red, watery eyes and swollen eyelids. Avoiding triggers, cool compresses, lubricants, and appropriate allergy treatment may help; significant pain or vision loss needs urgent assessment.
...
\medterm{Eye Care} Practices that protect vision, including appropriate examinations, protective eyewear, ultraviolet protection, control of diabetes and blood pressure, safe contact-lens hygiene, and prompt assessment of new vision changes or eye pain.
...
\medterm{Eye Floaters} Moving spots, threads, or cobweb-like shapes caused by shadows from changes in the gel inside the eye. Sudden new floaters, flashes, or a curtain-like shadow may signal retinal tearing or detachment and require urgent assessment.
...
\medterm{Eyeball (Globe)} The roughly spherical organ of vision containing the cornea, sclera, iris, lens, retina, internal fluids, and other tissues. It focuses light onto the retina, which sends visual signals through the optic nerve.
...
\medterm{Eyelid Drooping} Alternate index label; see \textit{Ptosis}.
...
\medterm{Eyelid Lift} Alternate index label; see \textit{Blepharoplasty}.
...
\medterm{Eyelid Twitch} Alternate index label; see \textit{Eye Twitching}.
...
\medterm{Eyes - Bulging} Forward displacement of one or both eyes, often called proptosis. Thyroid eye disease, inflammation, infection, bleeding, or a growth behind the eye may cause it; sudden onset, pain, fever, or vision change requires urgent care.

\medterm{Eyes, Flashing Lights In The} Brief flashes or streaks of light, often caused by movement or pulling of the gel inside the eye. Sudden new flashes with floaters or a curtain-like shadow may signal retinal tearing or detachment and need urgent care.

\medterm{Eyesight} The ability to see and interpret light, shapes, colors, movement, and detail. It depends on the eyes, optic nerves, and visual areas of the brain; disease or injury can impair any part of this pathway.

\medterm{Eyesight (Vision)} The ability to detect and interpret light, shape, color, movement, and detail through the eyes and visual pathways of the nervous system. Vision problems may affect sharpness, fields, depth, color, or alignment.
...
\medterm{ECMO} Temporary life support that pumps blood outside the body through an artificial lung to add oxygen and remove carbon dioxide, with or without heart support. It may be used for severe reversible heart or lung failure and carries bleeding, clotting, infection, and stroke risks.
...
\medterm{Edward's Syndrome} A genetic condition caused by an extra copy of chromosome 18. It commonly causes severe developmental impairment, poor growth, and abnormalities of the heart, brain, kidneys, and other organs; many affected pregnancies or infants do not survive.

\medterm{Elderberry} Fruit from certain Sambucus plants, used in foods and supplements. Raw or unripe fruit and other plant parts can cause poisoning; evidence that elderberry supplements prevent or treat infections remains limited.
