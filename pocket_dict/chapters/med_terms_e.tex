...
\medterm{Early Afterdepolarization} An abnormal electrical depolarization occurring during phase 2 or phase 3 of the cardiac ventricular action potential, triggered by prolonged action potential duration (prolonged QT interval) and excessive intracellular calcium influx, predisposing to triggered arrhythmias such as polymorphic ventricular tachycardia (torsades de pointes).
\synonyms
...
\medterm{Early Repolarization Pattern} A benign electrocardiographic finding characterized by J-point elevation of 0.1 mV or greater in two or more contiguous inferior or lateral leads, frequently accompanied by notching or slurring of the terminal QRS complex and concave ST-segment elevation.
\synonyms
...
\medterm{Eaton-Lambert Syndrome} A paraneoplastic autoimmune disorder of the neuromuscular junction characterized by autoantibodies directed against presynaptic P/Q-type voltage-gated calcium channels, leading to proximal muscle weakness that improves paradoxically with repetitive muscle activation, diminished deep tendon reflexes, and autonomic dysfunction, strongly associated with small cell lung carcinoma.
\synonyms
...
\medterm{Ellsworth-Howard Test} A diagnostic endocrinology test used to assess renal tubular end-organ responsiveness to exogenous parathyroid hormone (PTH) by measuring urinary cyclic AMP (cAMP) and phosphate excretion, distinguishing pseudohypoparathyroidism (blunted urinary cAMP response) from primary hypoparathyroidism (normal brisk response).
\synonyms
...
\medterm{Erythrocyte Casts} Microscopic cylindrical structures composed of packed red blood cells embedded within a Tamm-Horsfall mucoprotein matrix formed in the distal renal tubules, visible on urinary sediment examination, serving as a diagnostic hallmark of active glomerulonephritis or renal vasculitis.
\synonyms
...
\medterm{Exanthem Subitum} A common benign acute viral illness of infants and toddlers caused by human herpesvirus 6 (HHV-6) or human herpesvirus 7 (HHV-7), characterized by 3 to 5 days of high fever that resolves abruptly by crisis, followed immediately by the appearance of a rose-pink maculopapular exanthem starting on the trunk.
\synonyms
...
\medterm{Extramedullary Hematopoiesis} The formation and maturation of cellular blood elements outside the bone marrow cavity (principally within the liver, spleen, and lymph nodes), occurring as a compensatory response to chronic myelofibrosis, severe hemoglobinopathies (such as thalassemia major), or extensive marrow replacement.
\synonyms
...
\medterm{Extravascular Hemolysis} The premature destruction and phagocytosis of abnormal, damaged, or antibody-coated red blood cells by macrophages within the reticuloendothelial system (primarily the spleen and liver), leading to unconjugated hyperbilirubinemia, jaundice, and splenomegaly.
\synonyms
