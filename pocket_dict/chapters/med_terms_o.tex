...
\medterm{Odontoblast} An odontoblast is a cell lining the tooth pulp that produces dentin during tooth formation and repair. A cell that produces dentin during tooth development and repair.
...
\medterm{Operation} A planned surgical procedure performed to diagnose, repair, remove, replace, or improve part of the body. The word can also mean an action or process more generally, so its exact meaning depends on the medical context.
...
\medterm{Oxygen Enhancement Ratio} Ratio of dose under hypoxic vs. aerobic conditions. Higher for low LET radiation. A radiation therapy measure comparing doses needed under low-oxygen and normal-oxygen conditions to produce the same effect.
