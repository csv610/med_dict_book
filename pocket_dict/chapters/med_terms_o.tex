...
\medterm{Obstructive Shock} A life-threatening form of circulatory shock caused by a physical or mechanical barrier that impairs the filling of the heart's chambers or prevents blood from being pumped out into the circulation, leading to a critical drop in cardiac output and severe tissue hypoperfusion. Major causes include tension pneumothorax, cardiac tamponade, massive pulmonary embolism, and constrictive pericarditis. Clinical signs include severe low blood pressure, rapid heart rate, cold clammy skin, and distended neck veins (elevated jugular venous pressure). It is a medical emergency requiring immediate mechanical relief of the obstruction, such as needle decompression, pericardiocentesis, or thrombolytic therapy.
...
\medterm{Ocular Bobbing} A rapid, involuntary conjugate downward movement of both eyes followed by a slow, sluggish return to the horizontal midposition, pathognomonic for severe destructive lesions of the pons (such as central pontine myelinolysis or pontine hemorrhage).
\synonyms
...
\medterm{Opening Snap} A sharp, high-pitched, early diastolic heart sound generated by the sudden, abrupt opening and tensing of rigid but pliable mitral valve leaflets shortly after the aortic component of the second heart sound (A2-OS interval), pathognomonic for rheumatic mitral stenosis.
\synonyms
...
\medterm{Orbital Varix} A congenital, low-flow venous malformation consisting of abnormally dilated, thin-walled, distensible venous plexus channels within the orbit that communicate directly with the systemic venous circulation. Its pathognomonic hallmark is intermittent, positional, non-pulsatile proptosis that rapidly appears or enlarges during maneuvers that raise head and neck venous pressure---such as the Valsalva maneuver, bending forward, straining, or coughing---and swiftly recedes when upright. Complications include sudden intraorbital hemorrhage, acute thrombosis causing severe orbital pain, and optic nerve compression. Diagnosis is confirmed by dynamic orbital ultrasound, CT, or MRI performed during a Valsalva maneuver. Management ranges from observation to endovascular sclerotherapy or surgical excision for complicated lesions.
...
\medterm{Ortolani Maneuver} A clinical screening examination in infants for developmental dysplasia of the hip (DDH); with the infant supine and hips flexed to 90 degrees, the clinician abducts the thighs while applying gentle anterior force on the greater trochanters; a palpable 'clunk' confirms reduction of a dislocated femoral head into the acetabulum.
\synonyms
