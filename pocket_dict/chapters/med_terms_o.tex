...
\medterm{Ophthalmoscope} A lighted instrument used to examine the inside of the eye, including the retina, optic nerve, and blood vessels. It can help identify changes related to diabetes, high blood pressure, glaucoma, infection, inflammation, or other eye and nervous-system disorders.
...
\medterm{Osborn Wave} A notch or extra upward deflection at the junction between the main ventricular signal and the next segment on an electrocardiogram. It is classically seen during hypothermia but can occur in other conditions; the tracing must be interpreted with the temperature, symptoms, and other findings.
