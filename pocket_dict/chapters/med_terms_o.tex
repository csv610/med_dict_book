...
\medterm{Onychocryptosis} Alternate medical name; see \textit{Ingrown Toenail}.
...
\medterm{Onychomycosis} Alternate medical name; see \textit{Fungal Nail Infection}.
...
\medterm{Oophorectomy} Surgery to remove one or both ovaries. It may treat ovarian disease or reduce cancer risk. Removing both ovaries before natural menopause causes permanent loss of ovarian hormone production.
...
\medterm{Osteitis Deformans} Alternate name; see \textit{Paget's Disease of Bone}.
...
\medterm{Osteomalacia} Alternate name; see \textit{Rickets}.
