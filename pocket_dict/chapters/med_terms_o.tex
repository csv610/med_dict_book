\medterm{OAB} Abbreviation; see \textit{Overactive Bladder}.

\medterm{Ober Test} An orthopedic examination maneuver used to detect tightness or contracture of the tensor fasciae latae and iliotibial (IT) band; with the patient in a lateral decubitus position, the examiner abducts and extends the upper leg at the hip and releases it; failure of the thigh to adduct smoothly toward the examination table indicates a positive test.
\synonyms
Ober's Test; Iliotibial Band Tightness Test
...
\medterm{Objects Or Insects In Ear} An object or insect in the ear canal can cause pain, hearing loss, bleeding, discharge, or a sensation of movement. Deep, sharp, chemical, or eardrum-near objects can damage the ear and may need professional removal.

\synonyms
Aural Foreign Body; Foreign Body in Ear
...
\medterm{Obsessive Compulsive Disorder} Alternate spelling; see \textit{Obsessive-Compulsive Disorder}.
...
\medterm{Obstetric Cholestasis} Alternate name; see \textit{Intrahepatic Cholestasis of Pregnancy}.

\medterm{Obstetric Epidural Anesthesia} A regional neuraxial analgesic technique in which a local anesthetic and opioid are continuously infused through a catheter into the lumbar epidural space to provide pain relief during labor and delivery.

\synonyms
Epidural Analgesia in Labor; Labor Epidural; Obstetric Epidural
...
\medterm{Obstipation} Severe constipation with inability to pass stool or gas. It can occur with a blockage in the intestine and may cause abdominal swelling, pain, vomiting, or serious illness.

\medterm{Obstructed Infected Urinary System} A blocked urinary tract with an infection behind the blockage. It is a medical emergency because infection can spread quickly and the blockage may need urgent relief.
...
\medterm{Obstructive Shock} A life-threatening form of shock caused by a blockage that prevents the heart from filling or pumping blood properly. Causes include tension pneumothorax, cardiac tamponade, massive pulmonary embolism, and severe constrictive pericarditis. Signs may include very low blood pressure, fast heartbeat, cold clammy skin, and swollen neck veins. Treatment removes or bypasses the blockage.
...
\medterm{Obtunded} Having reduced alertness and slowed responses but still responding to a loud voice or touch. It can result from medicines, illness, metabolic problems, poisoning, or brain disease.
...
\medterm{Obturator Canal} A narrow fibro-osseous tunnel in the superior aspect of the obturator foramen bounded by the obturator groove of the pubic bone and the upper margin of the obturator membrane, transmitting the obturator nerve, artery, and vein from the pelvis into the medial thigh compartment.

\medterm{Obturator Foramen} A large anatomical aperture in the pelvic bone bounded by the ischium and pubis, almost completely closed in life by the fibrous obturator membrane except at its anterosuperior margin (the obturator canal).
...
\medterm{Obturator Nerve} A nerve from the lumbar plexus that supplies muscles responsible for bringing the thigh inward and carries sensation from part of the inner thigh.

\medterm{Obturator Sign} A physical examination finding in acute appendicitis or pelvic peritonitis; with the patient supine, passive internal rotation of the flexed right hip stretches the obturator internus muscle against the inflamed pelvic appendix, provoking acute right lower quadrant or pelvic pain.
\synonyms
Cope's Obturator Test; Obturator Internus Sign
...
\medterm{Occipital Hematoma} A collection of blood in the scalp or tissues over the back of the head, often after trauma. A rapidly enlarging swelling or associated neurologic symptoms may indicate a serious injury.
...
\medterm{Occult Blood Screen} Alternate name; see \textit{Fecal Occult Blood Test}.

\medterm{Occult Gastrointestinal Bleeding} Slow or intermittent bleeding somewhere in the digestive tract that cannot be seen in the stool. It may cause iron-deficiency anemia, tiredness, or a positive stool blood test and can have many possible sources.

\medterm{Occult Primary Cancer} Alternate name; see \textit{Carcinoma of Unknown Primary}.
...
\medterm{Ocular Bobbing} A repeated downward movement of both eyes followed by a slower return to the normal position. It can signal a serious problem in the lower brain.
\synonyms
Fast Downward Ocular Movement; Pontine Ocular Bobbing

\medterm{Ocular Burns and Chemical Injuries} Injuries to the eye from chemicals, heat, radiation, or other agents. Damage may involve the conjunctiva, cornea, limbus, eyelids, or deeper structures and can threaten vision.

\medterm{Ocular Cicatricial Pemphigoid} A chronic, progressive autoimmune blistering disease mediated by autoantibodies targeting basement membrane components in mucosal tissues, presenting with recurrent conjunctival inflammation, subepithelial fibrosis, symblepharon formation, trichiasis, and progressive blinding corneal opacity.
\synonyms
Mucous Membrane Pemphigoid; Cicatricial Conjunctivitis
...
\medterm{Ocular Flutter} An involuntary ocular motility disorder characterized by rapid, conjugate, horizontal saccadic oscillations without an intersaccadic pause around the point of visual fixation, occurring in paraneoplastic syndromes, viral encephalitis, and cerebellar dysfunction.
\synonyms
Opsoclonus Variant; Horizontal Saccadic Flutter

\medterm{Ocular Foreign Body} A foreign particle, such as dust, metal, wood, or glass, lodged on the cornea, conjunctiva, or within the eye globe, causing pain, redness, tearing, and foreign body sensation.

\synonyms
Foreign Body in Eye; Corneal Foreign Body; Intraocular Foreign Body
...
\medterm{Ocular Hypotony} An abnormally low intraocular pressure, typically defined as five to six millimetres of mercury or lower. It can result from decreased aqueous humour production by the ciliary body or excessive outflow from surgical filtering blebs, cyclodialysis clefts, or wound leaks, potentially causing hypotony maculopathy, chorioretinal folds, or choroidal detachment.

\synonyms
Hypotony, Ocular; Ocular Hypotension; Low Eye Tension
...
\medterm{Ocular Larva Migrans} Eye infection caused by migrating larvae of \textit{Toxocara} roundworms, usually affecting one eye. It can cause inflammation inside the eye, a white pupil, reduced vision, crossed eyes, or retinal damage. Diagnosis uses the eye findings, exposure history, and sometimes blood tests.
...
\medterm{Ocular Myiasis} Infestation of the eye or nearby tissues by fly larvae. It can cause pain, irritation, tearing, and vision problems.
...
\medterm{Oculocephalic Reflex} A brainstem reflex sometimes tested in an unconscious person by carefully moving the head. In people who cannot focus their eyes, the eyes normally move opposite to the head movement. The response may suggest that some brainstem pathways are working, but the test has safety limits and must be interpreted with the full examination.
...
\medterm{Oculocutaneous Albinism} Alternate name; see \textit{Albinism}.
...
\medterm{Oculosympathetic Palsy} Alternate name; see \textit{Horner's Syndrome}.

\medterm{Oculovestibular Reflex} A brainstem reflex evaluated by cold caloric stimulation in which ice-cold water irrigated into the external auditory canal of a comatose patient with intact brainstem function produces slow conjugate tonic deviation of both eyes toward the irrigated side (mediated by cranial nerves III, VI, and VIII).
\synonyms
Cold Caloric Test; Caloric Vestibulo-Ocular Reflex

\medterm{ODD} Abbreviation; see \textit{Oppositional Defiant Disorder}.
...
\medterm{Odontogenic Keratocyst Pathology} An odontogenic cyst typically lined by a thin, uniform parakeratinized stratified squamous epithelium with a palisaded basal layer. Satellite cysts and a tendency to recur may be present.
...
\medterm{Odontogenic Tumors and Cysts} Alternate name; see \textit{Jaw Tumors and Cysts}.
...
\medterm{Oesophagitis} Alternate spelling; see \textit{Esophagitis}.
...
\medterm{Off-Label Use} Use of an approved medicine for a condition, dose, route, or age group not specifically included in its official approval. A clinician may choose it when evidence and expected benefits support its use.
...
\medterm{Ofloxacin} A fluoroquinolone antibiotic used for selected susceptible bacterial infections. It can cause serious tendon, nerve, heart-rhythm, and other adverse effects.
...
\medterm{OHSS} Abbreviation; see \textit{Ovarian Hyperstimulation Syndrome}.
...
\medterm{Oleander Poisoning} Poisoning from eating oleander, which contains toxins that affect the heart. Nausea, vomiting, dizziness, confusion, slow or irregular heartbeat, fainting, or seizures may occur.

\medterm{Olecranon} The prominent bony process at the proximal end of the ulna forming the point of the elbow.

\medterm{Olecranon Bursitis} Inflammation of the subcutaneous synovial bursa overlying the olecranon process of the ulna, presenting with fluctuant, localized swelling over the posterior elbow, provoked by repetitive trauma ("student's elbow"), gout, or bacterial infection (septic bursitis).

\synonyms
Student Elbow; Miner Elbow

\medterm{Olecranon Fossa} A deep triangular depression on the posterior surface of the distal humerus superior to the trochlea that accommodates the curved olecranon process of the ulna during full elbow extension.
...
\medterm{Ollier Disease} A rare, non-hereditary skeletal dysplasia characterized by multiple benign cartilaginous enchondromas developing predominantly in the metaphyses and diaphyses of long bones with marked asymmetrical skeletal involvement and significant risk of malignant chondrosarcoma transformation.
\synonyms
Multiple Enchondromatosis; Dyschondroplasia
...
\medterm{OLP} Abbreviation; see \textit{Oral Lichen Planus}.
...
\synonyms
n-6 Fatty Acids; Omega-6 Polyunsaturated Fatty Acids
...
\medterm{Omega Sign} A characteristic facial expression observed in patients with severe melancholic depression, produced by tonic contraction of the corrugator supercilii and procerus muscles forming wrinkles and furrows on the forehead resembling the Greek letter omega.
\synonyms
Veraguth's Fold; Depressive Facial Omega
...
\medterm{Omental Caking} The radiographic (CT) and macroscopic surgical appearance of a thickened, diffuse, infiltrative nodular mass replacing the greater omentum, resulting from extensive peritoneal carcinomatosis (most commonly originating from ovarian, gastric, pancreatic, or colonic adenocarcinomas).
\synonyms
Peritoneal Carcinomatosis; Metastatic Omental Thickening
...
\medterm{Omphalitis} Infection of a newborn’s umbilical stump, usually during the first weeks of life. Redness spreading onto the skin, swelling, pus, bad smell, fever, poor feeding, or unusual sleepiness may occur, and infection can spread rapidly.
...
\medterm{Oncogenic Osteomalacia} A rare acquired paraneoplastic metabolic bone disorder caused by small, benign mesenchymal tumors that oversecrete fibroblast growth factor 23 (FGF23), which induces renal phosphate wasting, severe hypophosphatemia, suppressed 1,25-dihydroxyvitamin D production, and defective osteoid mineralization.
...
\medterm{Oncology Nutrition} Nutritional care for people with cancer, addressing intake, symptoms, treatment effects, weight, muscle mass, and personal goals.

\synonyms
Cancer Nutrition Support; Oncology Nutrition
...
\medterm{Ondine Curse} A life-threatening autonomic disorder of respiratory control (congenital central hypoventilation syndrome) caused by mutations in the PHOX2B gene, characterized by absent or severely blunted autonomic ventilatory responses to hypercapnia and hypoxemia, resulting in severe sleep-induced respiratory failure.
\synonyms
...
\synonyms
OPU; Egg Retrieval; Follicular Aspiration
...
\medterm{Open Abdominal Aortic Aneurysm Repair} Open surgery to repair a widened, weakened area of the abdominal aorta. The surgeon reaches the aorta through the abdomen and replaces the damaged section with a strong artificial tube.
...
\medterm{Open Esophagectomy} Conventional surgical resection of the esophagus performed through larger open thoracic and abdominal incisions (such as an Ivor Lewis or McKeown approach) for advanced esophageal tumors.

\synonyms
Open Esophageal Resection; Transthoracic Esophagectomy
...
\medterm{Open Fractures} Broken bones associated with a wound that connects the fracture to the outside air. They have a high risk of infection and tissue damage; treatment includes cleaning, antibiotics, and specialist care.
...
\medterm{Opening Snap} A sharp sound heard soon after the heart starts to relax, caused by a stiff mitral valve opening. It suggests mitral valve narrowing and must be interpreted with the rest of the heart examination.
\synonyms
Mitral Opening Snap; OS Sound
...
\medterm{Ophthalmia Neonatorum} Inflammation or infection of a newborn baby's eye during the first weeks of life. It may be caused by bacteria passed during birth, other infections, or chemical irritation; redness, swelling, or pus may occur and can threaten the cornea and vision.
...
\medterm{Opiate Overdose} A life-threatening amount of an opioid medicine or drug that slows brain and breathing activity. Extreme sleepiness, pinpoint pupils, slow or absent breathing, blue lips, or inability to wake may occur. Naloxone can sometimes restore breathing.

\medterm{Opiate Overdose Triad} The common combination of extreme sleepiness or unconsciousness, very slow or stopped breathing, and very small pupils after an opioid overdose. Not every person has all three signs. Naloxone may restore breathing.
...
\medterm{Opioid Intoxication} Opioid intoxication can cause euphoria, drowsiness, slowed breathing, pinpoint pupils, impaired coordination, coma, and death.
...
\medterm{Opioid Poisoning} Alternate name; see \textit{Opioid Toxicity}.
...
\medterm{Opioid Use Disorder} A problematic pattern of opioid use that causes clinically significant impairment or distress. It is diagnosed when at least two of 11 symptoms occur within 12 months, such as inability to cut down, craving, hazardous use, or continued use despite harm. It may involve prescribed or illicit opioids; tolerance or withdrawal alone does not establish the disorder when opioids are taken solely under appropriate medical supervision. Effective treatment includes medication, such as buprenorphine, methadone, or naltrexone, with counseling or other recovery support as needed.
...
\medterm{Opisthotonos} A severe, abnormal posture characterized by extreme hyperextension and rigid backward arching of the head, neck, and spine due to sustained, violent spasm of the axial extensor muscles. In severe cases, the back bridges off the bed so that the body rests entirely on the back of the head and the heels. It results from severe neurological injury or loss of normal central nervous system motor inhibition (such as disinhibition of spinal motor neurons). Hallmark causes include generalized tetanus (due to tetanospasmin blocking inhibitory GABA and glycine release), strychnine poisoning, severe bacterial meningitis, kernicterus (acute bilirubin encephalopathy in newborns), severe brainstem injury, rabies, and acute neuroleptic-induced dystonic reactions. Management requires immediate airway protection, muscle relaxation (such as high-dose benzodiazepines or neuromuscular blockade), and targeted treatment of the underlying cause.

\synonyms
Opisthotonus; Opisthotonic Posturing; Arc de Cercle; Tetanic Posturing
...
\medterm{Oppenheim Sign} A pathological neurological reflex elicited by firmly stroking down the anterior medial aspect of the tibia with the examiner's thumb and knuckles, provoking extension (dorsiflexion) of the great toe and fanning of the other toes in corticospinal upper motor neuron dysfunction.
\synonyms
Oppenheim Reflex; Oppenheim's Sign
...
\medterm{Opportunistic Pathogen} An infectious microorganism (bacterium, fungus, virus, or parasite) that rarely causes disease in an immunocompetent host with intact natural defense mechanisms, but causes severe, life-threatening infection when host immune defenses are compromised (such as \textit{Pneumocystis jirovecii} in advanced HIV infection).
...
\medterm{Opsoclonus-Myoclonus-Ataxia Syndrome} A rare, devastating neuro-inflammatory condition characterized by the sudden onset of chaotic, involuntary, conjugate, multidirectional saccadic eye movements without intersaccadic intervals (opsoclonus), combined with widespread myoclonic muscle jerking of the limbs and trunk, cerebellar ataxia, and severe encephalopathy. In pediatric patients, it occurs in approximately 50 percent of cases as a paraneoplastic manifestation of an occult neuroblastoma.

\synonyms
Dancing Eye-Dancing Feet Syndrome; Kinsbourne Syndrome; OMS
...
\medterm{Optical Coherence Tomography Angiography} A scan that uses optical coherence tomography to show blood flow in small vessels of the retina and the layer beneath it, without injecting a dye.
...
\medterm{Optic Disc Drusen} Calcified, hyaline, extracellular proteinaceous globular deposits located within the pre-laminar optic nerve head, which exhibit autofluorescence on fundus imaging and produce elevation of the optic disc margin that can mimic true papilledema (pseudopapilledema).
\synonyms
Optic Nerve Head Drusen; Pseudopapilledema Drusen
...
\synonyms
Optic Pathway Glioma; Optic Nerve Glioma
...
\medterm{Optic Nerve Glioma} Alternate name; see \textit{Optic Glioma}.
...
\medterm{Optic Pathway Glioma} Alternate name; see \textit{Optic Glioma}.
...
\medterm{Optokinetic Nystagmus} Rhythmic eye movements produced when a person views a large moving visual scene, consisting of a slow tracking phase followed by a rapid resetting phase.
...
\medterm{Oral Antidiabetic Agents} Alternate name; see \textit{Antidiabetic Agents, Oral}.
...
\medterm{Oral Burn} Thermal, chemical, or electrical injury to the oral mucosal lining, palate, tongue, or lips, resulting in acute pain, erythema, epithelial desquamation, ulceration, and potential upper airway compromise.
...
\medterm{Oral Cutaneous Fistulas} Abnormal channels connecting the mouth or an oral structure with the skin surface, often caused by dental infection, salivary-gland disease, trauma, surgery, or inflammatory disease. Persistent drainage or swelling requires dental, oral-surgery, or medical evaluation.
...
\medterm{Oral Fibromas and Fibromatoses} Benign fibrous overgrowths in the mouth or jaw region. A solitary oral fibroma is often a firm response to chronic irritation, whereas fibromatoses can infiltrate nearby tissue and recur; persistent lesions may need biopsy.

\medterm{Oral Glucose Tolerance Test} A test in which a person drinks a measured sugar solution and has blood sugar checked afterward. It helps assess diabetes, prediabetes, or gestational diabetes when other tests do not give a clear answer.

\medterm{Oral Hairy Leukoplakia} A benign, painless, non-malignant mucocutaneous lesion occurring on the lateral borders of the tongue in immunocompromised individuals (predominantly HIV-positive patients), caused by opportunistic Epstein-Barr virus (EBV) replication, presenting as white, corrugated, non-scrapable vertical folds.
...
\medterm{Oral Hemangiomas} Benign blood-vessel lesions of the lips, tongue, gums, or other oral tissues that may appear red, blue, or purple and bleed after trauma. Evaluation distinguishes them from vascular malformations and other tumors; treatment depends on symptoms and risk.
...
\medterm{Oral Leukoplakia and Erythroplakia Pathology} Histopathologic evaluation of persistent white or red oral mucosal lesions for hyperkeratosis, epithelial dysplasia, carcinoma in situ, or invasive squamous cell carcinoma. The clinical appearance alone does not determine the diagnosis.
...
\medterm{Oral Pyogenic Granuloma} A rapidly growing, friable vascular overgrowth of the gums or other oral mucosa, often related to irritation, trauma, or pregnancy. It bleeds easily and may recur unless the lesion and its local cause are treated.
...
\medterm{Oral Sex Practices} Oral stimulation of the genitals for sexual pleasure. Fellatio: oral stimulation of the
penis. Cunnilingus: oral stimulation of the vulva and clitoris. Analingus (rimming):
oral stimulation of the anus.

\synonyms
Oral-Genital Stimulation; Fellatio and Cunnilingus
...
\medterm{Orbital Apex Syndrome} A clinical syndrome resulting from compressive, neoplastic, or inflammatory lesions located at the orbital apex involving both the superior orbital fissure and the optic canal, characterized by combined palsies of cranial nerves III, IV, V1, and VI (complete ophthalmoplegia, ptosis, and forehead sensory loss) associated with optic nerve (CN II) atrophy and vision loss.
\synonyms
Apex Orbitae Syndrome; Combined Superior Orbital Fissure and Optic Canal Syndrome
...
\medterm{Orbital Cavity} The bony space in the skull that contains and protects the eye, its muscles, nerves, blood vessels, and supporting tissues.

\medterm{Orbital Cellulitis} A serious infection in the tissues around and behind the eye. It can cause eyelid swelling, fever, pain with eye movement, double vision, or reduced vision and can spread to the brain.
...
\medterm{Orbital Floor Fracture} A traumatic 'blowout' fracture of the thin bony orbital floor (maxillary bone) caused by sudden blunt impact to the globe and orbit, presenting with enophthalmos, periorbital ecchymosis, infraorbital nerve (V2) paresthesias, and vertical diplopia due to mechanical entrapment of the inferior rectus muscle.
\synonyms
Blowout Fracture of the Orbit; Orbital Floor Blowout
...
\medterm{Orbital Tumors} Benign or malignant growths arising within or around the eye socket. They may cause a visible mass, proptosis, double vision, pain, impaired eye movements, or vision loss; examination and orbital imaging guide biopsy and treatment.

\medterm{Orbital Varix} An enlarged, flexible vein in the eye socket. The eye may bulge more when a person bends, coughs, or strains and then return to normal when upright. It can rarely bleed, clot, or press on the optic nerve; imaging helps confirm the diagnosis.

\synonyms
Orbital Venous Malformation; Intermittent Proptosis; Orbital Phlebectasia; Orbital Venous Anomaly
...
\medterm{Orchialgia} Pain in one or both testicles. Sudden severe pain, swelling, nausea, or a high-riding testicle may indicate twisting of the testicle. Longer-lasting pain can result from infection, injury, varicocele, nerve pain, or other causes.
...
\medterm{Orf} A zoonotic skin infection caused by orf virus, a parapoxvirus of sheep and goats. Humans acquire it through contact with infected animals or contaminated fomites; a painful or tender nodular, ulcerating lesion usually develops on the hand or finger and often resolves without treatment.
...
\medterm{Organ of Corti} The specialized sensory receptor organ for auditory transduction situated upon the basilar membrane within the cochlear duct of the inner ear, containing inner hair cells (the primary auditory transducers) and outer hair cells (electromotile cochlear amplifiers) innervated by the cochlear nerve.
...
\medterm{Organophosphate Poisoning} A serious poisoning caused by pesticides or nerve agents that excessively stimulate nerves and muscles. It may cause sweating, drooling, vomiting, diarrhea, pinpoint pupils, muscle twitching, wheezing, weakness, seizures, or breathing failure.

\medterm{Organophosphate Toxicity} Acetylcholinesterase inhibition causing a cholinergic toxidrome: miosis, sweating, salivation, lacrimation, vomiting, diarrhea, bronchorrhea, bronchospasm, bradycardia, fasciculations, weakness, seizures, and respiratory failure. Immediate decontamination, airway support, atropine, and early pralidoxime are key treatments; delayed neuromuscular weakness can occur.
...
\medterm{Orgasmic Dysfunction in Women} Alternate name; see \textit{Orgasmic Dysfunction}.
...
\medterm{Orolabial Herpes Simplex} Alternate name; see \textit{Oral Herpes}.
...
\medterm{Oropharyngeal Cancer} Alternate name; see \textit{Oropharyngeal Carcinoma}.
...
\medterm{Oropouche Fever} An emerging arboviral disease caused by the Oropouche virus, an orthobunyavirus transmitted to humans primarily by biting midges (Culicoides paraensis) and mosquitoes in South and Central America. It manifests as an acute febrile syndrome characterized by abrupt high fever, severe retro-orbital headache, chills, photophobia, arthralgias, and myalgias, with frequent symptom recrudescence within 1 to 2 weeks and occasional progression to aseptic meningitis.

\synonyms
Oropouche Virus Disease; Oropouche Fever Arbovirus Infection
...
\medterm{Orthodontic Treatment} Treatment that uses braces, wires, aligners, or other appliances to move teeth and guide jaw development. It can improve bite, spacing, and cleaning access; treatment requires assessment and long-term retention.
...
\medterm{Orthodromic AVRT} The most common form of atrioventricular reentrant tachycardia in Wolff-Parkinson-White syndrome, in which the electrical cardiac impulse conducts antegradely down the normal atrioventricular node and His-Purkinje system (yielding a narrow QRS complex) and retrogradely up the accessory pathway (bundle of Kent) back to the atria.
...
\synonyms
Orthopedic Surgeon; Orthopedist Surgeon
...
\medterm{Orthostatic Hypotension and Autonomic Failure} Disorders in which autonomic nerves or their central pathways cannot maintain blood pressure and other automatic body functions. They may cause orthostatic hypotension, faintness, urinary or bowel dysfunction, sweating abnormalities, sexual dysfunction, or impaired heart-rate responses.
...
\medterm{Ortolani Maneuver} A hip examination in infants used to look for developmental hip dislocation. The clinician gently moves the bent leg outward and feels for a shift of the hip back into place. A clunk can support the finding, but the examination and ultrasound or X-ray are considered together.
\synonyms
Ortolani's Sign; Hip Reduction Maneuver

\medterm{Ortolani Sign} A reassuring click or clunk felt when a doctor gently spreads an infant's hips outward, showing that a dislocated hip has slid back into its socket.
...
\medterm{Osler Triad} A historical clinical triad (Austrian syndrome) characterized by the simultaneous co-occurrence of pneumococcal pneumonia, pneumococcal endocarditis (classically involving the aortic valve), and pneumococcal meningitis, carrying high mortality in patients with asplenia or chronic alcohol dependence.

\medterm{Osler-Weber-Rendu Disease} An autosomal dominant vascular dysplasia (hereditary hemorrhagic telangiectasia) caused by mutations in the ENG or ACVRL1 genes, characterized clinically by recurrent epistaxis, widespread mucocutaneous telangiectasias, and visceral arteriovenous malformations (AVMs) in the lungs, brain, liver, and gastrointestinal tract.
\synonyms
...
\medterm{Osmolal Gap} The difference between measured serum osmolality (via freezing point depression osmometry) and calculated serum osmolality ($2 \times [\text{Na}^+] + [\text{Glucose}]/18 + [\text{BUN}]/2.8$), where a gap exceeding $10\text{ mOsm/kg}$ indicates the presence of unmeasured exogenous osmotically active substances (such as toxic alcohols: methanol, ethylene glycol, or isopropanol).
...
\medterm{Ossicular Prosthesis} An artificial replacement or support for one or more middle-ear ossicles, used during ear surgery to restore sound transmission in selected conductive hearing loss.
...
\medterm{Osteitis Fibrosa Cystica} A severe skeletal complication of advanced, untreated hyperparathyroidism characterized by massive parathyroid hormone-driven osteoclastic bone resorption, replacement of marrow with fibrous tissue, microfractures, and the formation of cystic 'brown tumors' filled with vascularized fibrous stroma and hemosiderin.
\synonyms
von Recklinghausen Disease of Bone; Hyperparathyroid Bone Disease

\medterm{Osteitis Pubis} A usually noninfectious inflammation or stress-related disorder of the pubic symphysis and nearby tissues, causing pain in the groin or lower abdomen. It may follow athletic overuse, pelvic surgery, pregnancy, or childbirth.
...
\medterm{Osteoclastoma} A benign but locally aggressive and destructive osteolytic bone neoplasm occurring predominantly in the epiphyses of long tubular bones (distal femur, proximal tibia) in young adults aged 20 to 40 years, histologically characterized by sheets of multinucleated osteoclast-type giant cells interspersed within mononuclear stromal cells.
...
\medterm{Osteonecrosis} Death of bone tissue after its blood supply is reduced, most often affecting the hip, knee, shoulder, or ankle. It can cause pain and collapse of the joint and may follow injury, prolonged steroid use, heavy alcohol use, blood disorders, or other conditions.

\synonyms
Aseptic Necrosis; Ischemic Bone Necrosis; AVN
...
\medterm{Otalgia} The medical term for earache or ear pain. It is divided into two main types: primary and referred. Primary ear pain originates directly inside the ear, most often caused by middle ear infections, swimmer's ear (infection of the outer ear canal), buildup of earwax, pressure changes, or eardrum injury. Referred ear pain comes from nearby body parts that share the same sensory nerves with the ear, including tooth decay, jaw joint problems (temporomandibular joint issues), throat infections, or neck strain. Doctors find the cause by inspecting the ear canal and eardrum with a lighted scope (otoscope) and checking the teeth, mouth, and jaw when the ear looks healthy.
...
\medterm{Otolithiasis} The displacement of microscopic calcium carbonate crystals (otoconia) from the macula of the utricle into one or more fluid-filled semicircular canals of the inner ear (most frequently the posterior semicircular canal). Free-floating otolith debris deflects the cupula during rapid head position changes, causing transient, paroxysmal, rotational vertigo and torsional nystagmus characteristic of benign paroxysmal positional vertigo (BPPV).

\synonyms
Canalithiasis; Cupulolithiasis; Otoconial Displacement
...
\medterm{Otomycosis} A superficial fungal infection of the external auditory canal, most commonly caused by Aspergillus niger, Aspergillus fumigatus, or Candida albicans, presenting with intense aural pruritus, otalgia, conductive hearing loss, and white or black cotton-like fungal debris filling the external ear canal.
\synonyms
Fungal Otitis Externa; Mycotic Otitis
...
\medterm{Otosalpingitis} Inflammation, mucosal edema, and catarrhal obstruction of the Eustachian tube connecting the middle ear to the nasopharynx, predisposing to negative middle ear pressure, tympanic membrane retraction, and serous otitis media.

\synonyms
Eustachian Salpingitis; Tubotympanitis
...
\synonyms
Ear Toxicity; Vestibulotoxicity; Cochleotoxicity

\medterm{Ottawa Ankle Rules} A highly sensitive clinical decision-making algorithm used in acute emergency settings to determine whether radiography is required following acute ankle or midfoot trauma based on localized bony tenderness (posterior edge of distal malleoli, navicular bone, or base of fifth metatarsal) and inability to bear weight.
...
\medterm{Outer Ear Infection} Alternate name; see \textit{Swimmer's Ear}.
...
\medterm{Ovarian (Adnexal) Torsion} Twisting of an ovary, often together with its fallopian tube, around its blood supply. Sudden unilateral pelvic pain, nausea, or vomiting may occur; it is a surgical emergency because prolonged torsion can cause ovarian necrosis.
...
\synonyms
Malignant Ovarian Neoplasm; Ovarian Malignancy

\medterm{Ovarian Carcinoid} Alternate form; see \textit{Ovarian Neuroendocrine Tumor}.

\medterm{Ovarian Cyst} Alternate singular form; see \textit{Ovarian Cysts}.

\medterm{Ovarian Cyst Rupture} Breakage of an ovarian cyst that may cause sudden pelvic pain and internal bleeding or, if the cyst is infected, fever and inflammation. Assessment depends on vital signs, pregnancy testing, ultrasound, blood loss, and the severity and persistence of symptoms.
...
\synonyms
Ovarian Fluid-Filled Sacs; Adnexal Cysts

\medterm{Ovarian Dysgerminomas} Malignant ovarian germ-cell tumors that occur most often in adolescents and young adults. They may present as a rapidly enlarging pelvic mass or pain; treatment commonly involves fertility-sparing surgery with staging and, when indicated, chemotherapy.
...
\medterm{Ovarian Insufficiency} Reduced ovarian hormone production or follicular function, which may cause irregular or absent menstruation, infertility, hot flashes, vaginal symptoms, and reduced bone density. The cause, age at onset, pregnancy goals, and associated autoimmune or genetic findings guide evaluation.
...
\medterm{Ovarian Neuroendocrine Tumor} A rare ovarian tumor arising from cells with neuroendocrine features. It may be a primary ovarian tumor or part of a tumor arising elsewhere, and its behavior ranges from well-differentiated to aggressive disease.
...
\medterm{Ovarian Reserve Testing} Clinical and laboratory assessment of a woman's remaining primordial follicle pool and reproductive potential, measured primarily using early follicular phase serum anti-Müllerian hormone (AMH) concentration, day-3 follicle-stimulating hormone (FSH) with estradiol, and transvaginal ultrasound antral follicle count (AFC).
...
\medterm{Ovarian Thecoma} Alternate form; see \textit{Thecoma}.

\medterm{Ovarian Torsion} Twisting of an ovary, often together with its fallopian tube, that can cut off blood flow. It causes sudden one-sided pelvic pain, often with nausea or vomiting, and is a gynecologic emergency that is usually treated with surgery.
...
\synonyms
OAB; Urgency Frequency Syndrome

\medterm{Overactive Bladder Syndrome} A symptom complex characterized by urinary urgency, with or without urgency urinary incontinence, usually accompanied by daytime frequency and nocturia in the complete absence of a proven urinary tract infection or other obvious local pathological condition.
...
\medterm{Overflow Incontinence} Involuntary leakage of urine occurring when the intravesical pressure exceeds the outlet resistance in a chronically overdistended, poorly contracting bladder, caused by mechanical bladder outlet obstruction (e.g., benign prostatic hyperplasia) or an acontractile detrusor muscle in diabetic or neurogenic bladder.
\synonyms
Paradoxical Incontinence; Overdistension Incontinence
...
\medterm{Overlapping Autoimmune Syndrome} A rheumatological or hepatological disorder in which an individual patient simultaneously meets full clinical, serological, and histological diagnostic criteria for two or more distinct established autoimmune diseases (such as autoimmune hepatitis overlapping with primary biliary cholangitis).
...
\medterm{Overuse Syndrome} Alternate name; see \textit{Repetitive Strain Injury}.
...
\medterm{Ovotesticular Disorder of Sexual Development} A difference of sex development in which a person has both ovarian and testicular tissue, in the same or different gonads. Evaluation is multidisciplinary and considers anatomy, hormones, chromosomes, genetics, fertility, wellbeing, and the person’s preferences.
...
\medterm{Ovulation Induction} Pharmacological stimulation of the ovaries to promote the development, maturation, and release of one or more mature fertilizable oocytes in women suffering from anovulation or oligo-ovulation (such as in polycystic ovary syndrome), utilizing agents such as letrozole, clomiphene citrate, or exogenous gonadotropins.

\medterm{Ovum} A mature female gamete; in humans, the cell released at ovulation is usually a secondary oocyte, which completes its final meiotic division when a sperm enters. The resulting genetic material combines with the sperm’s to form a zygote, the first cell of a developing embryo.
...
\medterm{Oxalate Nephropathy} Renal tubular injury and interstitial fibrosis resulting from the intrarenal precipitation and deposition of insoluble calcium oxalate crystals within renal tubular lumens, seen in enteric hyperoxaluria (due to fat malabsorption, Crohn disease, or bariatric surgery) and ethylene glycol intoxication.
...
\medterm{Oxalic Acid Poisoning} Swallowing oxalic acid can burn the digestive tract and bind calcium, causing muscle cramps, abnormal heart rhythms, seizures, kidney injury, or shock. It is a medical emergency.
...
\medterm{Oxazepam Overdose} Taking too much oxazepam, a sedative medicine, can cause severe sleepiness, confusion, poor coordination, slowed breathing, coma, or death, especially with alcohol or other sedatives.
...
\medterm{Oxidative Phosphorylation} A process mainly occurring at the inner mitochondrial membrane in which electron transfer drives a proton gradient that powers ATP synthase to produce ATP. It is linked to, but distinct from, the earlier pathways that generate the electron carriers.
...
\medterm{Oxybuprocaine} A local anaesthetic eye drop that briefly numbs the surface of the eye. It may be used for examinations or short procedures. Repeated use can delay healing and damage the cornea.
...
\medterm{Oxygen Dissociation Curve} A sigmoidal physiological graph relating the percentage saturation of hemoglobin with oxygen ($S_aO_2$) to the partial pressure of oxygen ($P_aO_2$), whose position is modulated by temperature, arterial pH, carbon dioxide tension, and 2,3-bisphosphoglycerate concentration.

\synonyms
Oxygen-Hemoglobin Dissociation Curve; Oxyhemoglobin Dissociation Curve
...
\medterm{Oxyphil Cell Carcinoma} Alternate name; see \textit{Hürthle Cell Carcinoma}.
...
\medterm{Oral Allergy Syndrome} An itchy or tingling reaction of the mouth, lips, tongue, or throat after eating certain raw fruits, vegetables, or nuts, usually in people with pollen allergy. Cooking often prevents the reaction, but swelling, breathing trouble, vomiting, or widespread symptoms require urgent assessment because a more serious allergic reaction is possible.

\medterm{Opioid Dependence} A state in which the body adapts to repeated opioid exposure and withdrawal symptoms occur when the medicine or drug is reduced or stopped. Physical dependence can occur during appropriate pain treatment and is different from opioid use disorder, which involves problematic use and loss of control.

\medterm{Opioid Addiction} Alternate name; see \textit{Opioid Use Disorder}.

\medterm{Optic Nerve Swelling} Swelling of the optic nerve head where the nerve enters the eye. It may be caused by raised pressure inside the skull, inflammation, reduced blood supply, infection, or other eye or nerve disease; new swelling with headache or vision change needs prompt evaluation.
