...
\medterm{Aging Population}-- See \hyperlink{Demographics}{demographics}.
...
\medterm{Funeral}-- Grief after loss. See \hyperlink{Bereavement}{bereavement}.
...
\medterm{Happiness}-- See \hyperlink{Well-Being}{well-being}.
...
\medterm{Insurance}-- Ability to obtain needed care. See \hyperlink{Healthcare Access}{healthcare access}.
...
\medterm{Legacy}-- Discussion of future healthcare preferences. See \hyperlink{Advance Care Planning}{advance care planning}.
...
\medterm{Life Satisfaction}-- See \hyperlink{Well-Being}{well-being}.
...
\medterm{Long-Term Care Insurance}-- Assistance with ADLs/IADLs for extended period. See \hyperlink{Long-Term Care}{long-term care}.
...
\medterm{Meaning}-- See \hyperlink{Well-Being}{well-being}.

\medterm{Medicaid}-- Ability to obtain needed care. See \hyperlink{Healthcare Access}{healthcare access}.

\medterm{Medicare}-- Ability to obtain needed care. See \hyperlink{Healthcare Access}{healthcare access}.
...
\medterm{Motivation}-- Modification of health-related behaviors. See \hyperlink{Behavior Change}{behavior change}.
...
\medterm{Purpose}-- See \hyperlink{Well-Being}{well-being}.

\medterm{Quality of Life}-- Perception of well-being including physical, psychological, social, spiritual domains.

\medterm{Religion}-- See \hyperlink{Spirituality}{spirituality}.
...
\medterm{Wisdom}-- Cognitive engagement throughout life. See \hyperlink{Lifelong Learning}{lifelong learning}.
