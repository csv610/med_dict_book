...
\medterm{Behavior Change}-- Modification of health-related behaviors.
...
\medterm{Cultural Competence}-- Exchange of information between provider and patient. See \hyperlink{Communication}{communication}.
...
\medterm{Ethics}-- Moral principles guiding practice.
...
\medterm{Interpreter}-- Exchange of information between provider and patient. See \hyperlink{Communication}{communication}.
...
\medterm{Language Barrier}-- Exchange of information between provider and patient. See \hyperlink{Communication}{communication}.
...
\medterm{Research Ethics}-- Moral principles guiding practice. See \hyperlink{Ethics}{ethics}.
