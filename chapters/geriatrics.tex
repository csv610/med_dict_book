...
\medterm{Advance Care Planning}-- Discussion of future healthcare preferences.
...
\medterm{Elder Abuse}-- Intentional or neglectful act causing harm to older person.
...
\medterm{Frailty}-- Clinical syndrome of decreased reserve and resilience to stressors.
...
\medterm{Hospice}-- Palliative care for terminal illness with prognosis <6 months.
...
\medterm{Mortality}-- Death from disease.
...
\medterm{Nutritional Screening}-- Quick assessment of malnutrition risk.
...
\medterm{Osteoporosis}-- Systemic skeletal disease characterized by low bone mass and microarchitectural deterioration.
...
\medterm{Palliative Care}-- Specialized medical care for serious illness focusing on symptom relief and quality of life.
...
\medterm{Polypharmacy}-- Use of multiple medications (usually 5+).
...
\medterm{Sarcopenia}-- Age-related loss of muscle mass and function.
...
\medterm{Urinary Retention}-- Inability to empty bladder completely.
