...
\medterm{Coronary Artery Disease}-- See cardiology.
...
\medterm{Critical Care}-- See intensive care medicine.
...
\medterm{Factitious Disorder}-- See psychiatry.
...
\medterm{Infection}-- See infection control.
...
\medterm{Malingering}-- See psychiatry.
...
\medterm{Pain}-- See pain management.
...
\medterm{Plague}-- See infectious disease.
...
\medterm{Rabies}-- See infectious disease.
...
\medterm{Toxic Shock Syndrome}-- See infectious disease.
...
\medterm{Botulism}-- See infectious disease.

\medterm{Cat Scratch Disease}-- See infectious disease.

\medterm{Carbon Monoxide Poisoning}-- See toxicology.
...
\medterm{Compartment Syndrome}-- See compartment syndrome.

\medterm{Craniocerebral Injury}-- See head injury.
...
\medterm{Dengue Fever}-- See infectious disease.
...
\medterm{Eclampsia}-- See obstetrics_gynecology.

\medterm{Encephalitis}-- See infectious disease.

\medterm{Ethylene Glycol Poisoning}-- See toxicology.
...
\medterm{Hospital-Acquired Pneumonia}-- See infectious disease.
...
\medterm{Leptospirosis}-- See infectious disease.

\medterm{Lyme Disease}-- See infectious disease.

\medterm{Meningitis}-- See infectious disease.

\medterm{Migraine with Aura}-- See neurology.

\medterm{Narrow-Complex Tachycardia}-- See cardiology.

\medterm{Opioid Overdose}-- See toxicology.

\medterm{Organophosphate Poisoning}-- See cholinergic crisis.
...
\medterm{Preeclampsia}-- See obstetrics_gynecology.

\medterm{Ruptured Abdominal Aortic Aneurysm}-- See vascular surgery.

\medterm{Salicylate Toxicity}-- See toxicology.

\medterm{Serotonin Syndrome}-- See pharmacology.

\medterm{Spontaneous Pneumothorax}-- See tension pneumothorax.
...
\medterm{Tetanus}-- See infectious disease.
...
\medterm{Ventricular Tachycardia}-- See cardiology.

\medterm{Wernicke's Encephalopathy}-- See toxicology.

\medterm{Xylitol Toxicity}-- See toxicology.

\medterm{Yellow Fever}-- See infectious disease.

\medterm{Zika Virus}-- See infectious disease.
