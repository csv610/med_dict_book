...
\medterm{Hydrocele}-- Fluid collection in tunica vaginalis. Congenital (patent processus vaginalis) or acquired (infection, trauma, tumor). Transilluminates. Treatment: observation in infants, surgical repair if persistent.

\medterm{Spermatocele}-- See spermatocele.
...
\medterm{Varicocele}-- See varicocele.
...
\medterm{Erectile Dysfunction}-- See erectile dysfunction.

\medterm{Urinary Tract Infection}-- See urinary tract infection.

\medterm{Kidney Stone}-- See nephrolithiasis.
...
\medterm{Stress Urinary Incontinence}-- See urinary incontinence.

\medterm{Urge Urinary Incontinence}-- See urinary incontinence.

\medterm{Mixed Urinary Incontinence}-- See urinary incontinence.

\medterm{Overflow Urinary Incontinence}-- See urinary incontinence.
...
\medterm{Cystometrogram}-- See urodynamic testing.

\medterm{Pressure-Flow Study}-- See urodynamic testing.

\medterm{Urethral Pressure Profile}-- Measurement of urethral closure pressure along urethra. Used in incontinence evaluation.

\medterm{Electromyography}-- See urodynamic testing.

\medterm{Nerve Conduction Study}-- See urology.

\medterm{Urodynamics}-- See urodynamic testing.

\medterm{Uroflow}-- See uroflowmetry.

\medterm{Cystometry}-- See cystometrogram.

\medterm{Urethral Pressures}-- See urethral pressure profile.

\medterm{Emphasis}-- Not a urological term.
...
\medterm{Fistula}-- Abnormal connection between urinary tract and another organ. Vesicovaginal, rectourethral, enterovesical. Causes: surgery, radiation, trauma, infection. Treatment: surgical repair.

\medterm{Gland}-- Prostate gland, seminal vesicles, bulbourethral glands. See prostate.

\medterm{Hematuria}-- See hematuria.
...
\medterm{Quadrant}-- Not applicable in urology.
...
\medterm{Xanthogranulomatous}-- See xanthogranulomatous pyelonephritis.

\medterm{Yield}-- Not applicable.

\medterm{Zoon}-- Coronafossula, small depression at urethral meatus. Clinical significance in urethroscopy.
