...
\medterm{Haemoptysis}-- Coughing up blood or blood-stained sputum from the lower respiratory tract. See hematology.
...
\medterm{Windpipe}-- The windpipe, a 10-12 cm fibrocartilaginous tube from the larynx (C6) to the carina (T4/T5) where it bifurcates into main bronchi. See Trachea.
