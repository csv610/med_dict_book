...
\medterm{Air bronchogram}-- A recognized medical diagnosis or clinical finding.
\medterm{Chronic eosinophilic pneumonia}-- A recognized medical diagnosis or clinical finding.
\medterm{Eosinophilic bronchitis}-- A recognized medical diagnosis or clinical finding.
\medterm{Hydropneumothorax}-- A recognized medical diagnosis or clinical finding.
\medterm{Mycoplasma pneumoniae-associated mucositis}-- A recognized medical diagnosis or clinical finding.
\medterm{Oleothorax}-- A recognized medical diagnosis or clinical finding.
\medterm{Plastic bronchitis}-- A recognized medical diagnosis or clinical finding.
\medterm{Pleural perforation}-- A recognized medical diagnosis or clinical finding.
\medterm{Pneumocephalus}-- A recognized medical diagnosis or clinical finding.
\medterm{Reexpansion pulmonary edema}-- A recognized medical diagnosis or clinical finding.
