...
\medterm{Asbestosis}-- See public_health.
...
\medterm{Haemoptysis}-- See hematology.
...
\medterm{Methacholine Challenge Test}-- See medical_tests.
...
\medterm{Bronchoscopy}-- See medical_tests.
...
\medterm{Community-Acquired Pneumonia}-- See infectious_disease.
...
\medterm{D-Dimer}-- See medical_tests.
...
\medterm{Foreign Body Aspiration}-- See emergency_medicine.
...
\medterm{Pulmonary Embolism}-- See emergency_medicine.
...
\medterm{Tension Pneumothorax}-- See emergency_medicine.
