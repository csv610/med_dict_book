...
\medterm{Advance Care Planning}-- Discussion of future healthcare preferences. See geriatrics.
...
\medterm{In Situ Carcinoma}-- Full-thickness dysplasia without invasion through basement membrane. See carcinoma in situ.
...
\medterm{Leukemia}-- A group of hematological malignancies characterized by the clonal proliferation of abnormal white blood cells (blasts) in the bone marrow and peripheral blood. See leukemia.
...
\medterm{Lymphoma}-- A malignancy of lymphocytes, divided into Hodgkin lymphoma (HL—Reed-Sternberg cells, cervical/supraclavicular nodes, B symptoms, younger adults) and non-Hodgkin lymphoma (NHL—heterogeneous, more common, aggressive or indolent). See lymphoma.
...
\medterm{Metastasis}-- Spread of cancer cells from primary site to distant locations. See metastasis.
...
\medterm{Prevention}-- Preventing cancer development. See primary prevention.
...
\medterm{Remission}-- Decrease or disappearance of cancer signs. See remission.
...
\medterm{Sarcoma}-- Malignant tumor of mesenchymal origin (bone, cartilage, fat, muscle, blood vessels). See sarcoma.
