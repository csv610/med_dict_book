...
\medterm{Arthrography}-- Contrast injected into joint for imaging.
...
\medterm{Artifacts}-- Image distortions not representing true anatomy.
...
\medterm{Consolidation}-- Lung parenchyma filled with fluid, detected on imaging.
...
\medterm{Elastography}-- Imaging tissue stiffness.
...
\medterm{Hydronephrosis}-- Dilation of renal collecting system proximal to obstruction.
...
\medterm{Hysterosalpingography}-- Contrast imaging of uterus and fallopian tubes.
...
\medterm{Interventional Radiology}-- Image-guided minimally invasive procedures. See medical instruments.

\medterm{Interventional Radiology}-- Image-guided minimally invasive procedures.
...
\medterm{Lymphangiography}-- Contrast imaging of lymphatic vessels.
...
\medterm{Sialography}-- Contrast imaging of salivary ducts.
...
\medterm{Stress Echocardiography}-- Echocardiography during exercise or pharmacological stress.
