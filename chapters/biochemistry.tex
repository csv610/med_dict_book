...
\medterm{ADP (Adenosine Diphosphate)}-- A nucleotide composed of adenine, ribose, and two phosphate groups. Formed by hydrolysis of ATP (ATP -> ADP + Pi, \DeltaG° = -30.5 kJ/mol). Serves as the immediate precursor for ATP synthesis via oxidative phosphorylation (mitochondrial ATP synthase), substrate-level phosphorylation (glycolysis, TCA cycle), and photophosphorylation. The ADP/ATP ratio regulates cellular energy state: high ADP stimulates catabolic pathways (glycolysis, beta-oxidation, TCA cycle) and inhibits anabolic pathways.
