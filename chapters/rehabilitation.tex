...
\medterm{Aquatic Therapy}-- Exercise in water using buoyancy, resistance, warmth. See \hyperlink{Hydrotherapy}{hydrotherapy}.
...
\medterm{Bladder Retraining}-- See \hyperlink{Urology}{urology}.

\medterm{Bowel Program}-- See \hyperlink{Gastroenterology}{gastroenterology}.
...
\medterm{Case Management}-- See \hyperlink{Geriatrics}{geriatrics}.
...
\medterm{Disability Insurance}-- See \hyperlink{Occupational Medicine}{occupational medicine}.
...
\medterm{Fall Prevention}-- See \hyperlink{Geriatrics}{geriatrics}.
...
\medterm{Geriatric Rehabilitation}-- See \hyperlink{Geriatrics}{geriatrics}.
...
\medterm{Home Rehabilitation}-- Therapy provided at home. See \hyperlink{Home Health Rehabilitation}{home health rehabilitation}.
...
\medterm{Inpatient Rehabilitation}-- Intensive inpatient rehabilitation (3+ hours therapy/day) for acute conditions: stroke, spinal cord injury, traumatic brain injury, major trauma. See \hyperlink{Acute Rehabilitation}{acute rehabilitation}.
...
\medterm{Joint Replacement Rehabilitation}-- See \hyperlink{orthopedics}{orthopedics}.
...
\medterm{Rehabilitation Motivation}-- Patient factors that influence participation in rehabilitation, including intrinsic and extrinsic motivation and engagement with therapeutic goals.
...
\medterm{Occupational Rehabilitation}-- See \hyperlink{Occupational Medicine}{occupational medicine}.
...
\medterm{Occupational Therapy Assessment}-- OT helps patients perform daily activities (ADLs, IADLs) through therapeutic activities, adaptive equipment, environmental modification. See \hyperlink{Occupational Therapy}{occupational therapy}.
...
\medterm{Orthopedic Rehabilitation}-- See \hyperlink{orthopedics}{orthopedics}.
...
\medterm{Physiatrist}-- Physician specialty focusing on function, quality of life for patients with impairment, disability. See \hyperlink{Rehabilitation Medicine}{rehabilitation medicine}.
...
\medterm{Pressure Ulcer Prevention}-- See \hyperlink{Geriatrics}{geriatrics}.
...
\medterm{Reasonable Accommodation}-- See \hyperlink{Occupational Medicine}{occupational medicine}.
...
\medterm{Return to Work}-- See \hyperlink{Occupational Medicine}{occupational medicine}.
...
\medterm{Transitional Care}-- See \hyperlink{Geriatrics}{geriatrics}.

\medterm{Ultrasound Therapy}-- Therapeutic ultrasound for tissue healing, pain, scar tissue.

\medterm{Urinary Retraining}-- See \hyperlink{Urology}{urology}.
...
\medterm{Workers Compensation}-- See \hyperlink{Occupational Medicine}{occupational medicine}.

\medterm{Workplace Assessment}-- Evaluate job demands, worker capabilities, modify job or environment.

\medterm{Activities of Daily Living (ADLs)}-- Basic self-care activities such as bathing, dressing, toileting, eating, grooming, and transferring. ADL performance is a core measure of independence and rehabilitation need.

\medterm{Instrumental Activities of Daily Living (IADLs)}-- More complex activities required for independent community living, including medication management, shopping, cooking, finances, communication, transportation, and household tasks.

\medterm{Functional Capacity}-- The maximum level of physical, cognitive, communication, or self-care performance a person can safely achieve under specified conditions. It is assessed in relation to activities, participation, environment, and personal goals.

\medterm{Rehabilitation Potential}-- The expected capacity to improve function, independence, participation, or quality of life through rehabilitation. It depends on diagnosis, prognosis, cognition, motivation, comorbidity, social support, and environmental resources.

\medterm{Goal Attainment Scaling}-- An individualized outcome method in which patient-specific goals are defined with graded levels of expected attainment and scored after intervention. It captures meaningful changes that standardized measures may miss.

\medterm{Patient-Reported Outcome Measure (PROM)}-- A validated questionnaire completed directly by a patient to assess symptoms, function, health status, or quality of life without clinician interpretation of the response.

\medterm{Motor Learning}-- A relatively lasting change in the ability to perform a motor skill resulting from practice, experience, feedback, and adaptation. Rehabilitation uses task-specific repetition and meaningful practice to promote motor learning.

\medterm{Energy Conservation}-- Strategies that reduce unnecessary energy expenditure and fatigue during daily activities, such as pacing, prioritizing, planning, positioning, and using adaptive equipment.

\medterm{Pacing}-- Planned regulation of activity, rest, and intensity to avoid symptom exacerbation while gradually increasing tolerance. It is used in fatigue, chronic pain, cardiopulmonary disease, and post-viral conditions.

\medterm{Orthosis}-- An externally applied device that supports, aligns, prevents deformity, protects, or assists movement of a body segment. It differs from a prosthesis, which replaces a missing body part.

\medterm{Residual Limb}-- The portion of a limb remaining after amputation. Care includes edema control, skin inspection, shaping, strengthening, desensitization, contracture prevention, and prosthetic preparation.

\medterm{Wheelchair Seating and Positioning}-- Assessment and configuration of a wheelchair, cushion, supports, and posture to optimize stability, propulsion, comfort, function, pressure distribution, and prevention of musculoskeletal deformity.

\medterm{Pressure Injury}-- Localized damage to skin and underlying tissue, usually over a bony prominence, caused by pressure or pressure combined with shear. Prevention requires risk assessment, repositioning, skin care, nutrition, and pressure redistribution.

\medterm{Contracture}-- Permanent or semi-permanent limitation of passive joint range of motion caused by shortening or structural change in muscle, tendon, capsule, fascia, skin, or other periarticular tissue. Prevention and treatment depend on cause and stage.

\medterm{Spasticity}-- A velocity-dependent increase in muscle tone caused by hyperexcitability of the stretch reflex after an upper motor-neuron lesion. It may impair movement, hygiene, positioning, comfort, gait, and function.

\medterm{Functional Electrical Stimulation (FES)}-- Application of electrical impulses to peripheral nerves or muscles to produce purposeful contraction during a functional task, such as foot clearance during gait or cycling after neurologic injury.
