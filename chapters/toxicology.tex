...
\medterm{Carboxyhemoglobin}-- Toxicity from inhalation of carbon monoxide (CO), a colorless, odorless gas binding hemoglobin ~200-300 times more avidly than oxygen, forming carboxyhemoglobin (COHb) and reducing oxygen delivery. See carbon monoxide poisoning.
...
\medterm{Charcoal}-- Fine black powder produced by controlled pyrolysis of organic materials, processed to yield a massive micro-porous surface area (500-1500 m2/g). See activated charcoal.
...
\medterm{Cholecystokinin}-- CCK is a peptide hormone produced by I-cells in the duodenal and jejinal mucosa in response to fatty acids (long-chain fatty acids are the most potent stimuli) and amino acids in the chyme. See physiology.
...
\medterm{CO Poisoning}-- Toxicity from inhalation of carbon monoxide (CO), a colorless, odorless gas binding hemoglobin ~200-300 times more avidly than oxygen, forming carboxyhemoglobin (COHb) and reducing oxygen delivery. See carbon monoxide poisoning.
...
\medterm{Controlled Substance}-- A drug or chemical whose manufacture, possession, and use are regulated by government authorities due to its potential for abuse, dependence, or harm. See pharmacology.
...
\medterm{Dependence}-- A chronic, relapsing brain disorder characterized by compulsive substance use or behavior despite harmful consequences. See addiction.
...
\medterm{Diabetic Ketoacidosis}-- An acute, life-threatening complication of diabetes mellitus, more common in type 1. See endocrinology.
...
\medterm{Drug Testing}-- Urine, blood, hair testing for substances of abuse. See drug screening.
...
\medterm{Epidemiology}-- Study of disease distribution and determinants in populations. See public health.
...
\medterm{Food Poisoning}-- Illness caused by consuming food contaminated with bacteria, viruses, parasites, or their toxins. See infectious disease.
...
\medterm{Gastroenteritis}-- Inflammation of the stomach and intestinal mucosa, most commonly caused by viral infections (norovirus, rotavirus, adenovirus), bacterial pathogens (E. See gastroenterology.
...
\medterm{Hepatic Encephalopathy}-- Neuropsychiatric syndrome from liver failure. See geriatrics.
...
\medterm{Insulin}-- Peptide hormone (51 amino acids) produced by beta cells of pancreatic islets. See endocrinology.
...
\medterm{Mortality Rate}-- Deaths from disease in population. See public health.
...
\medterm{Odynophagia}-- Painful swallowing, characterized by a burning, squeezing, or sticking sensation behind the sternum during deglutition. See gastroenterology.
...
\medterm{Opportunistic Infection}-- Infection in immunocompromised host. Examples: PCP, toxoplasmosis, candidiasis. See infectious disease.
...
\medterm{Pathology}-- Study of disease. See pathology.
...
\medterm{Pharmacodynamics}-- The study of the biochemical and physiological effects of drugs on the body and their mechanisms of action, describing what the drug does to the body. See pharmacology.

\medterm{Pharmacokinetics}-- The study of drug movement through the body, describing what the body does to the drug, defined by four processes: Absorption — the process by which a drug enters the systemic circulation from its site of administration (oral, IV, IM, subcutaneous, topical, inhalation); Distribution — the movement of drug from the circulation to body tissues, determined by blood flow, protein binding, tissue affinity, and barriers (blood-brain barrier, placental barrier); Metabolism — the chemical modification of drugs by enzymes (primarily hepatic CYP450) through Phase I (oxidation, reduction, hydrolysis) and Phase II (conjugation) reactions; and Excretion — the elimination of drugs and their metabolites from the body, primarily through the kidneys (glomerular filtration, tubular secretion, reabsorption) and also through bile, feces, lungs, and sweat. See pharmacology.
...
\medterm{Plasma Concentration}-- The study of drug movement through the body, describing what the body does to the drug, defined by four processes: Absorption — the process by which a drug enters the systemic circulation from its site of administration (oral, IV, IM, subcutaneous, topical, inhalation); Distribution — the movement of drug from the circulation to body tissues, determined by blood flow, protein binding, tissue affinity, and barriers (blood-brain barrier, placental barrier); Metabolism — the chemical modification of drugs by enzymes (primarily hepatic CYP450) through Phase I (oxidation, reduction, hydrolysis) and Phase II (conjugation) reactions; and Excretion — the elimination of drugs and their metabolites from the body, primarily through the kidneys (glomerular filtration, tubular secretion, reabsorption) and also through bile, feces, lungs, and sweat. See pharmacokinetics.
...
\medterm{Prescription Drug}-- A medication that can only be dispensed with a valid prescription from a licensed healthcare provider, requiring professional oversight due to the drug's complexity, toxicity, or potential for harm. See pharmacology.

\medterm{Prevention}-- Measures to prevent disease. See toxicology.
...
\medterm{Prognosis}-- Identification of disease. See diagnosis.

\medterm{Prophylaxis}-- Measures to prevent disease. See prevention.
...
\medterm{Proton Pump Inhibitor}-- A class of medications that irreversibly inhibit the gastric H+/K+ ATPase (proton pump) in parietal cells, the final common pathway of gastric acid secretion, producing profound and sustained suppression of both basal and stimulated acid production. See gastroenterology.
...
\medterm{Referred Pain}-- An unpleasant sensory and emotional experience associated with actual or potential tissue damage, serving as a protective alerting system but becoming maladaptive when chronic (lasting >3 months). See pain.

\medterm{Relative Risk}-- Study of disease distribution and determinants in populations. See epidemiology.
...
\medterm{Risk Factor}-- Study of disease distribution and determinants in populations. See epidemiology.
...
\medterm{Sexual Dysfunction}-- Persistent difficulty in sexual activity causing distress. See pharmacology.
...
\medterm{Specificity}-- Proportion of true negatives correctly identified. See pharmacology.
...
\medterm{Substance Abuse}-- A chronic, relapsing brain disorder characterized by compulsive substance use or behavior despite harmful consequences. See addiction.

\medterm{Substance Dependence}-- A chronic, relapsing brain disorder characterized by compulsive substance use or behavior despite harmful consequences. See addiction.

\medterm{Substance Use Disorder}-- A chronic, relapsing brain disorder characterized by compulsive substance use or behavior despite harmful consequences. See addiction.

\medterm{Sulfa Drugs}-- A class of bacteriostatic antibiotics that competitively inhibit dihydropteroate synthase, an enzyme essential for folic acid synthesis in bacteria. See sulfonamides.

\medterm{Sulfonamide}-- A class of antibiotics (sulfamethoxazole, sulfadiazine, sulfasalazine) that inhibit bacterial dihydropteroate synthase, blocking folate synthesis—bacteriostatic. See pharmacology.
...
\medterm{Syncope}-- Transient loss of consciousness due to cerebral hypoperfusion. See cardiology.
...
\medterm{Therapeutic Window}-- Ratio of toxic dose to therapeutic dose. See therapeutic index.

\medterm{Therapy}-- Medical intervention for disease. See treatment.

\medterm{Thiamine}-- See biochemistry.

\medterm{Thrombocytopenia}-- A reduced platelet count (<150,000/µL), causing bleeding risk when severe (<10-20,000). See hematology.

\medterm{Tidal Volume}-- The volume of air inspired or expired during each normal breath, approximately 500 mL (6-8 mL/kg) in a resting adult. See physiology.

\medterm{Tissue Distribution}-- The study of drug movement through the body, describing what the body does to the drug, defined by four processes: Absorption — the process by which a drug enters the systemic circulation from its site of administration (oral, IV, IM, subcutaneous, topical, inhalation); Distribution — the movement of drug from the circulation to body tissues, determined by blood flow, protein binding, tissue affinity, and barriers (blood-brain barrier, placental barrier); Metabolism — the chemical modification of drugs by enzymes (primarily hepatic CYP450) through Phase I (oxidation, reduction, hydrolysis) and Phase II (conjugation) reactions; and Excretion — the elimination of drugs and their metabolites from the body, primarily through the kidneys (glomerular filtration, tubular secretion, reabsorption) and also through bile, feces, lungs, and sweat. See pharmacokinetics.

\medterm{Tobacco}-- See nicotine.

\medterm{Tolerance}-- A decreased response to a drug after repeated administration, requiring dose escalation to achieve the same effect. See pharmacology.
...
\medterm{Vaccine}-- A biological preparation that induces protective immunity against a specific pathogen, administered before exposure (prophylactic) or therapeutically (e.g., rabies, some cancer vaccines). See pharmacology.
...
\medterm{Venom}-- A biological poison produced by a microorganism, plant, or animal that damages host tissues at low concentrations. See toxin.
...
\medterm{Xanax}-- A class of drugs that enhance the effect of the inhibitory neurotransmitter gamma-aminobutyric acid at the GABA-A receptor, increasing the frequency of chloride channel opening and producing anxiolytic, sedative, anticonvulsant, and muscle relaxant effects. See benzodiazepines.
